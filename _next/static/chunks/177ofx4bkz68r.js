...
export const eventsData: ScheduleEventData[] = ${JSON.stringify(C,null,2)};`,language:"tsx"}]},I={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:s,mode:"static"})},code:[{code:`
import { MonthView } from '@mantine/schedule';
import { events } from './data';
