...
`};var P=(0,t.__exportAll)({controlled:()=>b,dragDrop:()=>k,eventForm:()=>I,eventResize:()=>V,externalDragDrop:()=>W,staticMode:()=>Y,usage:()=>x,viewProps:()=>T,weekView:()=>R});e.s(["ResourcesScheduleDemos",0,P],853905)}]);