...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},h={defaultExpanded:!1,type:"code",component:function(){return(0,D.jsx)(v.DayView,{date:new Date,events:o,withCurrentTimeIndicator:!0,withCurrentTimeBubble:!0})},code:[{code:`
import { DayView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:c,language:"tsx",fileName:"data.ts"}]},b={defaultExpanded:!1,type:"code",component:function(){return(0,D.jsx)(v.DayView,{date:new Date,events:o,startTime:"08:00:00",endTime:"18:00:00",slotHeight:80,allDaySlotHeight:60})},code:[{code:`
import { DayView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]},j={defaultExpanded:!1,type:"code",component:function(){return(0,D.jsx)(v.DayView,{date:new Date,events:o,startTime:"08:00:00",endTime:"18:00:00",withHeader:!1})},code:[{code:`
import { DayView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]},C={defaultExpanded:!1,type:"code",component:function(){return(0,D.jsx)(v.DayView,{date:new Date,events:o,startTime:"08:00:00",endTime:"18:00:00",headerFormat:"dddd, MMMM D"})},code:[{code:`
import { DayView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]},H={defaultExpanded:!1,type:"code",component:function(){return(0,D.jsx)(v.DayView,{date:new Date,events:o,startTime:"08:00:00",endTime:"18:00:00",slotLabelFormat:"h:mm A"})},code:[{code:`
import { DayView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]},V={defaultExpanded:!1,type:"code",component:function(){return(0,D.jsx)(v.DayView,{date:new Date,events:o,startTime:"08:00:00",endTime:"18:00:00",radius:0})},code:[{code:`
import { DayView } from '@mantine/schedule';
import { events } from './data';
...
`},B=(0,a.default)().format("YYYY-MM-DD"),R=[{id:1,title:"Morning Standup",start:`${B} 09:00:00`,end:`${B} 09:30:00`,color:"blue"},{id:2,title:"Team Meeting",start:`${B} 11:00:00`,end:`${B} 12:00:00`,color:"green"},{id:3,title:"Code Review",start:`${B} 14:00:00`,end:`${B} 15:00:00`,color:"violet"}],G={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(R);return(0,D.jsx)(v.DayView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventResize:!0,onEventResize:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))}})},code:`
import { useState } from 'react';
import dayjs from 'dayjs';
import { DayView, ScheduleEventData } from '@mantine/schedule';
...
`};var U=e.i(593612),J=e.i(554166),W=e.i(725695),Q=e.i(883364);let K=(0,a.default)().format("YYYY-MM-DD"),_=[{id:1,title:"Morning Standup",start:`${K} 09:00:00`,end:`${K} 09:30:00`,color:"blue",payload:{location:"Room A"}},{id:2,title:"Client Meeting",start:`${K} 11:00:00`,end:`${K} 12:00:00`,color:"green",payload:{location:"Video Call"}},{id:3,title:"Lunch Break",start:`${K} 12:30:00`,end:`${K} 13:30:00`,color:"orange",payload:{location:"Cafeteria"}}],q={defaultExpanded:!1,type:"code",component:function(){return(0,D.jsx)(v.DayView,{date:new Date,events:_,startTime:"08:00:00",endTime:"18:00:00",renderEventBody:e=>(0,D.jsxs)(W.Group,{children:[(0,D.jsx)(Q.Text,{fz:12,fw:500,children:e.title}),(0,D.jsxs)(W.Group,{gap:4,children:[(0,D.jsx)(U.ClockIcon,{size:12}),(0,D.jsx)(Q.Text,{fz:10,lh:1,children:(0,a.default)(e.start).format("h:mm A")})]}),e.payload?.location&&(0,D.jsxs)(W.Group,{gap:4,children:[(0,D.jsx)(J.MapPinIcon,{size:12}),(0,D.jsx)(Q.Text,{fz:10,children:e.payload.location})]})]})})},code:`
import dayjs from 'dayjs';
...
export const eventsData: ScheduleEventData[] = ${JSON.stringify(ea,null,2)};`,language:"tsx"}]},eo={defaultExpanded:!1,type:"code",component:function(){return(0,D.jsx)(v.DayView,{date:new Date,events:o,startTime:"08:00:00",endTime:"18:00:00",mode:"static"})},code:[{code:`
import { DayView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]};var ed=e.i(485108);let ei={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,D.jsxs)("div",{children:[(0,D.jsxs)(W.Group,{mb:"md",children:[(0,D.jsx)(ed.Button,{onClick:()=>t((0,a.default)(e).subtract(1,"day").format("YYYY-MM-DD HH:mm:ss")),children:"Previous Day"}),(0,D.jsx)(Q.Text,{fw:500,children:(0,a.default)(e).format("MMMM D, YYYY")}),(0,D.jsx)(ed.Button,{onClick:()=>t((0,a.default)(e).add(1,"day").format("YYYY-MM-DD HH:mm:ss")),children:"Next Day"})]}),(0,D.jsx)(v.DayView,{date:e,onDateChange:t,events:o,startTime:"08:00:00",endTime:"18:00:00"})]})},code:[{code:`
import { useState } from 'react';
import dayjs from 'dayjs';
import { DayView } from '@mantine/schedule';
...
}`,language:"tsx",fileName:"Demo.tsx"},{code:el._eventFormCode,language:"tsx",fileName:"EventForm.tsx"},{code:s,language:"tsx",fileName:"events.ts"}]},ec={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(o);return(0,D.jsx)(v.DayView,{date:new Date,events:e,startScrollTime:"09:00:00",scrollAreaProps:{mah:500},withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))}})},code:[{code:`
import { useState } from 'react';
import { DayView, ScheduleEventData } from '@mantine/schedule';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]};var eu=e.i(232471),eD=e.i(20035);let ev=(0,a.default)().format("YYYY-MM-DD"),ep=[{title:"Quick Sync",duration:30,color:"teal"},{title:"Workshop",duration:120,color:"orange"},{title:"One-on-One",duration:60,color:"violet"}],ef={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)([]),n=(0,u.useRef)(1);return(0,D.jsxs)(eD.Grid,{children:[(0,D.jsxs)(eD.Grid.Col,{span:{base:12,sm:3},children:[(0,D.jsx)(Q.Text,{fw:500,mb:"xs",children:"Drag to schedule"}),ep.map(e=>(0,D.jsxs)(eu.Box,{draggable:!0,onDragStart:t=>{t.dataTransfer.setData("text/plain",JSON.stringify(e)),t.dataTransfer.effectAllowed="copy"},style:{padding:"8px 12px",marginBottom:8,borderRadius:4,cursor:"grab",backgroundColor:`var(--mantine-color-${e.color}-light)`,color:`var(--mantine-color-${e.color}-light-color)`},children:[(0,D.jsx)(Q.Text,{size:"sm",fw:500,children:e.title}),(0,D.jsxs)(Q.Text,{size:"xs",children:[e.duration," min"]})]},e.title))]}),(0,D.jsx)(eD.Grid.Col,{span:{base:12,sm:9},children:(0,D.jsx)(v.DayView,{date:ev,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))},onExternalEventDrop:(e,o)=>{let r=e.getData("text/plain");if(!r)return;let d=JSON.parse(r),i=(0,a.default)(o),s=i.add(d.duration,"minutes");t(e=>[...e,{id:n.current++,title:d.title,start:i.format("YYYY-MM-DD HH:mm:ss"),end:s.format("YYYY-MM-DD HH:mm:ss"),color:d.color}])}})})]})},code:`
...
`},eh=(0,a.default)().format("YYYY-MM-DD"),eY=[{id:"daily-sync-series",title:"Daily sync (series)",start:`${(0,a.default)(eh).subtract(2,"day").format("YYYY-MM-DD")} 09:00:00`,end:`${(0,a.default)(eh).subtract(2,"day").format("YYYY-MM-DD")} 09:30:00`,color:"blue",recurrence:{rrule:"FREQ=DAILY;COUNT=10",exdate:[`${eh} 09:00:00`]}},{id:"daily-sync-override",title:"Daily sync (moved today)",start:`${eh} 14:00:00`,end:`${eh} 14:30:00`,color:"grape",recurringEventId:"daily-sync-series",recurrenceId:`${eh} 09:00:00`},{id:"one-off-day",title:"One-off planning",start:`${eh} 11:00:00`,end:`${eh} 12:00:00`,color:"green"}],ex={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(eh);return(0,D.jsx)(v.DayView,{date:e,onDateChange:t,events:eY,startTime:"08:00:00",endTime:"18:00:00",intervalMinutes:30})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { DayView } from '@mantine/schedule';
...
`},eM=(0,a.default)().format("YYYY-MM-DD"),e$=[{id:"blocked-time",title:"Blocked",start:`${eM} 12:00:00`,end:`${eM} 14:00:00`,color:"red",display:"background"},{id:"team-meeting",title:"Team meeting",start:`${eM} 10:00:00`,end:`${eM} 11:00:00`,color:"violet"},{id:"code-review",title:"Code review",start:`${eM} 15:00:00`,end:`${eM} 16:00:00`,color:"green"}],eb={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(e$);return(0,D.jsx)(v.DayView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",intervalMinutes:30,withEventsDragAndDrop:!0,onEventDrop:({eventId:a,newStart:n,newEnd:o})=>{e.some(e=>"background"===e.display&&n<e.end&&o>e.start)||t(e=>e.map(e=>e.id===a?{...e,start:n,end:o}:e))},styles:{dayViewBackgroundEvent:{background:`repeating-linear-gradient(
            -45deg,
            transparent,
            transparent 10px,
...
`}]};var ej=e.i(428127);let eC={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,D.jsxs)("div",{children:[(0,D.jsxs)(ej.ScheduleHeader,{children:[(0,D.jsx)(ej.ScheduleHeader.Previous,{onClick:()=>t((0,a.default)(e).subtract(1,"day").format("YYYY-MM-DD"))}),(0,D.jsx)(ej.ScheduleHeader.Control,{interactive:!1,miw:200,children:(0,a.default)(e).format("dddd, MMMM D, YYYY")}),(0,D.jsx)(ej.ScheduleHeader.Next,{onClick:()=>t((0,a.default)(e).add(1,"day").format("YYYY-MM-DD"))}),(0,D.jsx)(ej.ScheduleHeader.Today,{onClick:()=>t((0,a.default)().format("YYYY-MM-DD"))}),(0,D.jsx)(ej.ScheduleHeader.Control,{style:{marginInlineStart:"auto"},onClick:()=>window.print(),children:"Print"})]}),(0,D.jsx)(v.DayView,{date:e,onDateChange:t,events:o,startTime:"08:00:00",endTime:"18:00:00",withHeader:!1})]})},code:[{code:`
import dayjs from 'dayjs';
import { useState } from 'react';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]};var ek=(0,t.__exportAll)({allDayEvents:()=>g,backgroundEvents:()=>eT,backgroundEventsCustomStyle:()=>eb,bidirectionalDragDrop:()=>ew,businessHours:()=>$,canDragEvent:()=>A,canResizeEvent:()=>P,controlledDate:()=>ei,currentTimeIndicator:()=>h,customHeader:()=>eC,dragDrop:()=>N,eventForm:()=>em,eventResize:()=>G,externalDragDrop:()=>ef,getTimeSlotProps:()=>eV,headerFormat:()=>C,intervalMinutes:()=>y,labels:()=>er,localization:()=>eH,overlappingEvents:()=>w,radius:()=>V,recurringEvents:()=>ex,renderEvent:()=>en,renderEventBody:()=>q,slotHeight:()=>b,slotLabelFormat:()=>H,startScrollTime:()=>ec,staticMode:()=>eo,timeRange:()=>f,timezone:()=>M,usage:()=>p,viewChange:()=>es,withoutHeader:()=>j});e.s(["DayViewDemos",0,ek],7834)}]);