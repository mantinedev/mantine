...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},Y={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:s,firstDayOfWeek:0})},code:[{code:`
import { MonthView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},h={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:s,weekdayFormat:"ddd"})},code:[{code:`
import { MonthView } from '@mantine/schedule';
import { events } from './data';
...
`};var O=e.i(19683),H=e.i(369974),C=e.i(284629);let $=(0,a.default)().startOf("month"),V=[{id:1,title:"Team Standup",start:$.add(2,"day").hour(9).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:$.add(2,"day").hour(9).minute(30).format("YYYY-MM-DD HH:mm:ss"),color:"blue",payload:{description:"Daily team sync meeting",attendees:["Alice","Bob","Charlie"],location:"Conference Room A"}},{id:2,title:"Design Workshop",start:$.add(5,"day").hour(10).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:$.add(5,"day").hour(12).minute(0).format("YYYY-MM-DD HH:mm:ss"),color:"grape",payload:{description:"Collaborative design thinking session",attendees:["Diana","Eve","Frank"],location:"Creative Space"}},{id:3,title:"Client Presentation",start:$.add(10,"day").hour(14).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:$.add(10,"day").hour(15).minute(30).format("YYYY-MM-DD HH:mm:ss"),color:"green",payload:{description:"Q4 progress presentation to client",attendees:["Grace","Henry"],location:"Zoom"}},{id:4,title:"Sprint Planning",start:$.add(15,"day").hour(10).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:$.add(15,"day").hour(12).minute(0).format("YYYY-MM-DD HH:mm:ss"),color:"orange",payload:{description:"Plan next sprint tasks and priorities",attendees:["Alice","Charlie","Bob"],location:"Dev Lab"}},{id:5,title:"Code Review",start:$.add(18,"day").hour(16).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:$.add(18,"day").hour(17).minute(0).format("YYYY-MM-DD HH:mm:ss"),color:"cyan",payload:{description:"Review pull requests from this week",attendees:["Alice","Charlie"],location:"Dev Lab"}},{id:6,title:"Tech Conference",start:$.add(22,"day").format("YYYY-MM-DD 00:00:00"),end:$.add(22,"day").format("YYYY-MM-DD 23:59:59"),color:"pink",payload:{description:"Annual tech conference",attendees:["All Team"],location:"Convention Center"}}],k={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,y.useState)(V);return(0,c.jsx)(u.MonthView,{date:new Date,events:e,withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:n,newEnd:o})=>{t(t=>t.map(t=>t.id===e?{...t,start:(0,a.default)(n).format("YYYY-MM-DD HH:mm:ss"),end:(0,a.default)(o).format("YYYY-MM-DD HH:mm:ss")}:t))},renderEvent:(e,t)=>(0,c.jsxs)(H.HoverCard,{width:280,position:"right",closeDelay:0,transitionProps:{duration:0},children:[(0,c.jsx)(H.HoverCard.Target,{children:(0,c.jsx)(C.UnstyledButton,{...t})}),(0,c.jsx)(H.HoverCard.Dropdown,{children:(0,c.jsx)(O.EventDetails,{event:e})})]})})},code:[{fileName:"Demo.tsx",code:`
import { useState } from 'react';
import dayjs from 'dayjs';
...
export const eventsData: ScheduleEventData[] = ${JSON.stringify(V,null,2)};`,language:"tsx"}]},T={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:s,mode:"static"})},code:[{code:`
import { MonthView } from '@mantine/schedule';
import { events } from './data';
...
}`,language:"tsx",fileName:"Demo.tsx"},{code:N._eventFormCode,language:"tsx",fileName:"EventForm.tsx"},{code:l,language:"tsx",fileName:"events.ts"}]};var A=e.i(232471),R=e.i(20035),B=e.i(883364);let W=[{title:"Team Offsite",color:"teal"},{title:"Release Day",color:"orange"},{title:"All Hands",color:"violet"}],F={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,y.useState)([]),n=(0,y.useRef)(1);return(0,c.jsxs)(R.Grid,{children:[(0,c.jsxs)(R.Grid.Col,{span:{base:12,sm:3},children:[(0,c.jsx)(B.Text,{fw:500,mb:"xs",children:"Drag to schedule"}),W.map(e=>(0,c.jsx)(A.Box,{draggable:!0,onDragStart:t=>{t.dataTransfer.setData("text/plain",JSON.stringify(e)),t.dataTransfer.effectAllowed="copy"},style:{padding:"8px 12px",marginBottom:8,borderRadius:4,cursor:"grab",backgroundColor:`var(--mantine-color-${e.color}-light)`,color:`var(--mantine-color-${e.color}-light-color)`},children:(0,c.jsx)(B.Text,{size:"sm",fw:500,children:e.title})},e.title))]}),(0,c.jsx)(R.Grid.Col,{span:{base:12,sm:9},children:(0,c.jsx)(u.MonthView,{date:new Date,events:e,withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))},onExternalEventDrop:(e,o)=>{let r=e.getData("text/plain");if(!r)return;let d=JSON.parse(r),s=(0,a.default)(o),i=s.endOf("day");t(e=>[...e,{id:n.current++,title:d.title,start:s.format("YYYY-MM-DD HH:mm:ss"),end:i.format("YYYY-MM-DD HH:mm:ss"),color:d.color}])}})})]})},code:`
...
export const events: ScheduleEventData[] = ${JSON.stringify(es,null,2)};`,language:"tsx"}]};var el=(0,t.__exportAll)({backgroundEvents:()=>Q,bidirectionalDragDrop:()=>P,consistentWeeks:()=>g,customHeader:()=>_,dragDrop:()=>b,eventForm:()=>I,externalDragDrop:()=>F,firstDayOfWeek:()=>Y,highlightToday:()=>M,localization:()=>ee,manyEvents:()=>E,maxEventsPerDay:()=>X,radius:()=>et,recurringEvents:()=>L,renderEvent:()=>k,staticMode:()=>T,timedEvents:()=>ei,usage:()=>f,weekdayFormat:()=>h,withAgenda:()=>er,withWeekNumbers:()=>D,withoutHeader:()=>x,withoutOutsideDays:()=>w,withoutWeekDays:()=>v,withoutWeekendDays:()=>p});e.s(["MonthViewDemos",0,el],791941)}]);