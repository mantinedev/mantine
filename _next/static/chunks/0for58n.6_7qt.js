...
`),component:()=>{let[t,l]=(0,r.useState)(null);return(0,a.jsx)(e,{label:"Pick date",placeholder:"Pick date",value:t,onChange:l})}},multiple:{type:"code",centered:!0,maxWidth:400,code:(i=e.displayName.replace("@mantine/dates/",""),`
import { useState } from 'react';
...
`),component:()=>{let[t,l]=(0,r.useState)([]);return(0,a.jsx)(e,{type:"multiple",label:"Pick dates",placeholder:"Pick dates",value:t,onChange:l})}},range:{type:"code",centered:!0,maxWidth:400,code:(s=e.displayName.replace("@mantine/dates/",""),`
import { useState } from 'react';
...
`),component:()=>{let[t,l]=(0,r.useState)([]);return(0,a.jsx)(e,{label:"Pick 2 dates or more",placeholder:"Pick 2 dates or more",value:t,onChange:l,type:"multiple",valueFormatter:n})}}}}],70530)},986451,e=>{"use strict";var a=e.i(337976),t=e.i(164036),r=e.i(831474),l={yearPickerRoot:"m_d01e596f",presetsList:"m_52a6b4b0",presetButton:"m_b0d93233"},n=e.i(191788),o=e.i(391398),i=e.i(232471),s=e.i(284629),c=e.i(481178),d=e.i(275519),u=e.i(433512),p=e.i(44091),m=e.i(62904),h=e.i(391466);let f=(0,c.createVarsResolver)((e,{size:a})=>({yearPickerRoot:{"--preset-font-size":(0,u.getFontSize)(a)}})),y={type:"default"},Y=(0,d.factory)(e=>{let c=(0,p.useProps)("YearPicker",y,e),{classNames:d,styles:u,vars:Y,type:g,defaultValue:x,value:b,onChange:j,__staticSelector:P,getYearControlProps:k,allowSingleDateInRange:D,allowDeselect:M,onMouseLeave:v,onYearSelect:V,__updateDateOnYearSelect:S,__onPresetSelect:w,__stopPropagation:I,presets:E,className:H,style:A,unstyled:C,size:F,attributes:Z,...L}=c,{calendarProps:_,others:O}=(0,r.pickCalendarProps)(L),N=(0,n.useRef)(null),R=(0,n.useRef)(null),W=(0,h.useStyles)({name:P||"YearPicker",classes:l,props:c,className:H,style:A,classNames:d,styles:u,unstyled:C,attributes:Z,rootSelector:E?"yearPickerRoot":void 0,varsResolver:f,vars:Y}),{onDateChange:$,onRootMouseLeave:z,onHoveredDateChange:T,getControlProps:B,setValue:U}=(0,a.useDatesState)({type:g,level:"year",allowDeselect:M,allowSingleDateInRange:D,value:b,defaultValue:x,onChange:j,onMouseLeave:v}),{resolvedClassNames:X,resolvedStyles:K}=(0,m.useResolvedStylesApi)({classNames:d,styles:u,props:c}),G=(0,o.jsx)(t.Calendar,{classNames:X,styles:K,size:F,..._,...!E?O:{},minLevel:"decade",__updateDateOnYearSelect:S??!1,__staticSelector:P||"YearPicker",onMouseLeave:z,onYearMouseEnter:(e,a)=>T(a),onYearSelect:e=>{$(e),V?.(e)},getYearControlProps:e=>({...B(e),...k?.(e)}),__setDateRef:N,__setLevelRef:R,__stopPropagation:I,attributes:Z,...!E?{className:H,style:A}:{}});if(!E)return G;let q=E.map((e,a)=>(0,o.jsx)(s.UnstyledButton,{...W("presetButton"),onClick:()=>{var a;let t;void 0!==(t=Array.isArray(a=e.value)?a[0]:a)&&(N.current?.(t),R.current?.("decade"),w?w(a):U(a))},onMouseDown:e=>e.preventDefault(),"data-mantine-stop-propagation":I||void 0,children:e.label},a));return(0,o.jsxs)(i.Box,{...W("yearPickerRoot"),size:F,...O,children:[(0,o.jsx)("div",{...W("presetsList"),children:q}),G]})});Y.classes={...t.Calendar.classes,...l},Y.varsResolver=f,Y.displayName="@mantine/dates/YearPicker",e.s(["YearPicker",0,Y],986451)},182123,e=>{"use strict";var a=e.i(391398),t=e.i(38856),r=e.i(648863),l=e.i(70530),n=e.i(931882),o=e.i(671640),i=e.i(568827),s=e.i(782681),c=e.i(878166),d=e.i(831474),u=e.i(986451),p=e.i(275519),m=e.i(44091),h=e.i(62904);let f={type:"default",size:"sm",valueFormat:"YYYY",closeOnChange:!0,sortDates:!0,dropdownType:"popover"},y=(0,p.factory)(e=>{let t=(0,m.useProps)(["Input","InputWrapper","YearPickerInput"],f,e),{type:r,value:l,defaultValue:n,onChange:o,valueFormat:p,labelSeparator:y,locale:Y,classNames:g,styles:x,unstyled:b,closeOnChange:j,size:P,variant:k,dropdownType:D,sortDates:M,minDate:v,maxDate:V,vars:S,valueFormatter:w,presets:I,attributes:E,...H}=t,{resolvedClassNames:A,resolvedStyles:C}=(0,h.useResolvedStylesApi)({classNames:g,styles:x,props:t}),{calendarProps:F,others:Z}=(0,d.pickCalendarProps)(H),{_value:L,setValue:_,formattedValue:O,dropdownHandlers:N,dropdownOpened:R,onClear:W,shouldClear:$}=(0,c.useDatesInput)({type:r,value:l,defaultValue:n,onChange:o,locale:Y,format:p,labelSeparator:y,closeOnChange:j,sortDates:M,valueFormatter:w});return(0,a.jsx)(s.PickerInputBase,{formattedValue:O,dropdownOpened:R,dropdownHandlers:N,classNames:A,styles:C,unstyled:b,onClear:W,shouldClear:$,value:L,size:P,variant:k,dropdownType:D,...Z,type:r,__staticSelector:"YearPickerInput",attributes:E,children:(0,a.jsx)(u.YearPicker,{...F,size:P,variant:k,type:r,value:L,defaultDate:F.defaultDate||(Array.isArray(L)?L[0]||(0,i.getDefaultClampedDate)({maxDate:V,minDate:v}):L||(0,i.getDefaultClampedDate)({maxDate:V,minDate:v})),onChange:_,locale:Y,classNames:A,styles:C,unstyled:b,__staticSelector:"YearPickerInput",__stopPropagation:"popover"===D,minDate:v,maxDate:V,presets:I,attributes:E})})});y.classes={...s.PickerInputBase.classes,...u.YearPicker.classes},y.displayName="@mantine/dates/YearPickerInput";let Y={type:"code",component:function(){return(0,a.jsxs)(o.Stack,{children:[(0,a.jsx)(y,{label:"clearSectionMode='both' (default)",placeholder:"Pick year",defaultValue:new Date,clearable:!0,rightSection:(0,a.jsx)(n.CaretDownIcon,{size:16}),clearSectionMode:"both"}),(0,a.jsx)(y,{label:"clearSectionMode='rightSection'",placeholder:"Pick year",defaultValue:new Date,clearable:!0,rightSection:(0,a.jsx)(n.CaretDownIcon,{size:16}),clearSectionMode:"rightSection"}),(0,a.jsx)(y,{label:"clearSectionMode='clear'",placeholder:"Pick year",defaultValue:new Date,clearable:!0,rightSection:(0,a.jsx)(n.CaretDownIcon,{size:16}),clearSectionMode:"clear"})]})},code:`
...
`,maxWidth:340,centered:!0},g={type:"code",centered:!0,maxWidth:400,component:function(){return(0,a.jsx)(y,{valueFormat:"YY",type:"multiple",label:"Pick year",placeholder:"Pick year"})},code:`
import { YearPickerInput } from '@mantine/dates';
...
`},x={type:"code",centered:!0,maxWidth:400,component:function(){return(0,a.jsx)(y,{valueFormat:"YY",type:"multiple",label:"Disabled",placeholder:"Pick year",disabled:!0})},code:`
import { YearPickerInput } from '@mantine/dates';
...
`};var b=e.i(191788);let j={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,b.useState)(null);return(0,a.jsx)(y,{label:"Pick year",placeholder:"Pick year",value:e,onChange:t,minDate:new Date(2021,1),maxDate:new Date(2028,1)})},code:`
import { useState } from 'react';
import { YearPickerInput } from '@mantine/dates';
...
`};var P=e.i(494834);let k=e=>(0,P.default)(e).year()===new Date().getFullYear()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:(0,P.default)(e).year()===new Date().getFullYear()+1?{disabled:!0}:{},D={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,b.useState)(null);return(0,a.jsx)(y,{label:"Pick year",placeholder:"Pick year",value:e,onChange:t,getYearControlProps:k})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
...
`},M={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,b.useState)(null);return(0,a.jsx)(y,{yearsListFormat:"YY",label:"Pick year",placeholder:"Pick year",value:e,onChange:t})},code:`
import { useState } from 'react';
import { YearPickerInput } from '@mantine/dates';
...
`},v={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,b.useState)(null);return(0,a.jsx)(y,{decadeLabelFormat:"YY",label:"Pick year",placeholder:"Pick year",value:e,onChange:t})},code:`
import { useState } from 'react';
import { YearPickerInput } from '@mantine/dates';
...
`},V={type:"code",centered:!0,maxWidth:400,component:function(){return(0,a.jsx)(y,{label:"With presets",placeholder:"Select year",presets:[{value:(0,P.default)().startOf("year").format("YYYY-MM-DD"),label:"This year"},{value:(0,P.default)().add(1,"year").startOf("year").format("YYYY-MM-DD"),label:"Next year"},{value:(0,P.default)().subtract(1,"year").startOf("year").format("YYYY-MM-DD"),label:"Last year"},{value:(0,P.default)().add(5,"year").startOf("year").format("YYYY-MM-DD"),label:"In 5 years"},{value:(0,P.default)().subtract(5,"year").startOf("year").format("YYYY-MM-DD"),label:"5 years ago"}]})},code:`
import dayjs from 'dayjs';
import { YearPickerInput } from '@mantine/dates';
