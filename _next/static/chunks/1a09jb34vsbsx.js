(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,648863,e=>{"use strict";var n=Object.defineProperty;e.s(["__exportAll",0,(e,t)=>{let r={};for(var o in e)n(r,o,{get:e[o],enumerable:!0});return t||n(r,Symbol.toStringTag,{value:"Module"}),r}])},722757,e=>{"use strict";var n=e.i(391398),t=e.i(38856),r=e.i(648863),o=e.i(232471),l=e.i(485108),i=e.i(725695),c=e.i(470743),s=e.i(883364),a=e.i(133613),u=e.i(779861),d=e.i(191788);function h({duration:e=1250,axis:n="y",onScrollFinish:t,onScrollCancel:r,easing:o,offset:l=0,cancelable:i=!0,isList:c=!1}={}){let s=(0,d.useRef)(0),x=(0,d.useRef)(0),m=(0,d.useRef)(!1),[p,g]=(0,d.useState)(!1),j=(0,d.useRef)(null),w=(0,d.useRef)(null),b=(0,u.useReducedMotion)(),y=o??f,v=()=>{s.current&&(cancelAnimationFrame(s.current),s.current=0,g(!1))},T=(0,d.useCallback)(({alignment:o="start"}={})=>{m.current=!1,s.current&&v();let i=function({axis:e,parent:n}){if(!n&&"u"<typeof document)return 0;let t="y"===e?"scrollTop":"scrollLeft";if(n)return n[t];let{body:r,documentElement:o}=document;return r[t]+o[t]}({parent:j.current,axis:n})??0,a=function({axis:e,target:n,parent:t,alignment:r,offset:o,isList:l}){if(!n||!t&&"u"<typeof document)return 0;let i=!!t,c=(t||document.body).getBoundingClientRect(),s=n.getBoundingClientRect(),a=e=>s[e]-c[e];if("y"===e){let e=a("top");if(0===e)return 0;if("start"===r){let n=e-o;return n<=!l*s.height||!l?n:0}let n=i?c.height:window.innerHeight;if("end"===r){let t=e+o-n+s.height;return t>=-s.height*!l||!l?t:0}return"center"===r?e-n/2+s.height/2:0}if("x"===e){let e=a("left");if(0===e)return 0;if("start"===r){let n=e-o;return n<=s.width||!l?n:0}let n=i?c.width:window.innerWidth;if("end"===r){let t=e+o-n+s.width;return t>=-s.width||!l?t:0}if("center"===r)return e-n/2+s.width/2}return 0}({parent:j.current,target:w.current,axis:n,alignment:o,offset:l,isList:c})-(j.current?0:i);g(!0),!function o(){0===x.current&&(x.current=performance.now());let l=performance.now()-x.current,c=b||0===e?1:l/e,u=i+a*y(c);(function({axis:e,parent:n,distance:t}){if(!n&&"u"<typeof document)return;let r="y"===e?"scrollTop":"scrollLeft";if(n)n[r]=t;else{let{body:e,documentElement:n}=document;e[r]=t,n[r]=t}})({parent:j.current,axis:n,distance:u}),!m.current&&c<1?s.current=requestAnimationFrame(o):(m.current?"function"==typeof r&&r():"function"==typeof t&&t(),x.current=0,s.current=0,g(!1),v())}()},[n,e,y,c,l,t,r,b]),S=()=>{i&&(m.current=!0)};return(0,a.useWindowEvent)("wheel",S,{passive:!0}),(0,a.useWindowEvent)("touchmove",S,{passive:!0}),(0,d.useEffect)(()=>v,[]),{scrollableRef:j,targetRef:w,scrollIntoView:T,cancel:v,scrolling:p}}function f(e){return e<.5?2*e*e:-1+(4-2*e)*e}let x={type:"code",code:`
