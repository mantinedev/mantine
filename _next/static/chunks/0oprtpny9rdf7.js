...
export const events: ScheduleEventData[] = ${JSON.stringify(ei,null,2)};`,language:"tsx"}]};var el=(0,t.__exportAll)({backgroundEvents:()=>z,bidirectionalDragDrop:()=>G,consistentWeeks:()=>g,customHeader:()=>Q,dragDrop:()=>k,eventForm:()=>N,externalDragDrop:()=>F,firstDayOfWeek:()=>p,highlightToday:()=>M,localization:()=>ee,manyEvents:()=>S,maxEventsPerDay:()=>X,radius:()=>et,recurringEvents:()=>U,renderEvent:()=>$,staticMode:()=>I,timedEvents:()=>es,usage:()=>f,weekdayFormat:()=>y,withAgenda:()=>eo,withWeekNumbers:()=>D,withoutHeader:()=>x,withoutOutsideDays:()=>w,withoutWeekDays:()=>h,withoutWeekendDays:()=>v});e.s(["MonthViewDemos",0,el],599466)}]);