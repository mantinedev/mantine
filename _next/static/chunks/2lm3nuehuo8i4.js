...
`};var J=e.i(593612),Q=e.i(554166),K=e.i(725695),q=e.i(883364);let X=(0,a.default)().format("YYYY-MM-DD"),Z=[{id:1,title:"Morning Standup",start:`${X} 09:00:00`,end:`${X} 09:30:00`,color:"blue",payload:{location:"Room A"}},{id:2,title:"Client Meeting",start:`${X} 11:00:00`,end:`${X} 12:00:00`,color:"green",payload:{location:"Video Call"}},{id:3,title:"Lunch Break",start:`${X} 12:30:00`,end:`${X} 13:30:00`,color:"orange",payload:{location:"Cafeteria"}}],ee={defaultExpanded:!1,type:"code",component:function(){return(0,v.jsx)(D.DayView,{date:new Date,events:Z,startTime:"08:00:00",endTime:"18:00:00",renderEventBody:e=>(0,v.jsxs)(K.Group,{children:[(0,v.jsx)(q.Text,{fz:12,fw:500,children:e.title}),(0,v.jsxs)(K.Group,{gap:4,children:[(0,v.jsx)(J.ClockIcon,{size:12}),(0,v.jsx)(q.Text,{fz:10,lh:1,children:(0,a.default)(e.start).format("h:mm A")})]}),e.payload?.location&&(0,v.jsxs)(K.Group,{gap:4,children:[(0,v.jsx)(Q.MapPinIcon,{size:12}),(0,v.jsx)(q.Text,{fz:10,children:e.payload.location})]})]})})},code:`
import dayjs from 'dayjs';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]};var el=e.i(485108);let ec={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,v.jsxs)("div",{children:[(0,v.jsxs)(K.Group,{mb:"md",children:[(0,v.jsx)(el.Button,{onClick:()=>t((0,a.default)(e).subtract(1,"day").format("YYYY-MM-DD HH:mm:ss")),children:"Previous Day"}),(0,v.jsx)(q.Text,{fw:500,children:(0,a.default)(e).format("MMMM D, YYYY")}),(0,v.jsx)(el.Button,{onClick:()=>t((0,a.default)(e).add(1,"day").format("YYYY-MM-DD HH:mm:ss")),children:"Next Day"})]}),(0,v.jsx)(D.DayView,{date:e,onDateChange:t,events:o,startTime:"08:00:00",endTime:"18:00:00"})]})},code:[{code:`
import { useState } from 'react';
import dayjs from 'dayjs';
import { DayView } from '@mantine/schedule';
...
`};var eB=(0,t.__exportAll)({allDayEvents:()=>Y,backgroundEvents:()=>ej,backgroundEventsCustomStyle:()=>eH,bidirectionalDragDrop:()=>ex,businessHours:()=>C,canDragEvent:()=>_,canResizeEvent:()=>W,controlledDate:()=>ec,currentTimeIndicator:()=>E,customHeader:()=>eV,dragDrop:()=>A,eventForm:()=>ev,eventResize:()=>G,externalDragDrop:()=>eh,getTimeSlotProps:()=>eI,headerFormat:()=>V,intervalMinutes:()=>y,labels:()=>es,localization:()=>eR,overlappingEvents:()=>x,radius:()=>I,recurringEvents:()=>eT,renderEvent:()=>ei,renderEventBody:()=>ee,slotHeight:()=>H,slotLabelFormat:()=>R,startScrollTime:()=>eD,staticMode:()=>ed,subHourGridLines:()=>w,timeRange:()=>f,timezone:()=>$,usage:()=>p,viewChange:()=>em,withAgenda:()=>eA,withoutHeader:()=>k});e.s(["DayViewDemos",0,eB],7834)}]);