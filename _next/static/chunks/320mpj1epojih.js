...
`,language:"tsx"},{fileName:"data.ts",code:a,language:"tsx"}]},E={type:"code",component:function(){return(0,n.jsx)(v,{data:o,startDate:"2024-02-16",endDate:"2025-02-16",withMonthLabels:!0,withWeekdayLabels:!0,monthLabelsPosition:"bottom"})},centered:!0,overflow:"hidden",code:[{fileName:"Demo.tsx",code:`
import { Heatmap } from '@mantine/charts';
import { data } from './data';
...
`},Y={type:"code",centered:!0,component:function(){return(0,n.jsx)(r.DatePicker,{withNativeLevelSelect:!0,yearsSelectRange:[2020,2035]})},code:`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker withNativeLevelSelect yearsSelectRange={[2020, 2035]} />;
}
`};var E=(0,t.__exportAll)({controlProps:()=>m,controlledDate:()=>l,defaultDate:()=>u,defaultLevel:()=>v,deselect:()=>I,excludeDate:()=>M,firstDayOfWeek:()=>w,fullWidth:()=>L,headerControlsOrder:()=>V,hideOutsideDates:()=>k,hideWeekdays:()=>T,labelFormat:()=>p,listFormat:()=>h,locale:()=>f,maxLevel:()=>x,minMax:()=>b,multiple:()=>Z,nativeLevelSelect:()=>Y,numberOfColumns:()=>z,presets:()=>C,presetsRange:()=>A,range:()=>N,renderDay:()=>P,singleRange:()=>_,sizeConfigurator:()=>F,usage:()=>H,weekendDays:()=>y,withWeekNumbers:()=>S});let{usage:H,multiple:Z,deselect:I,range:N,singleRange:_,numberOfColumns:z,sizeConfigurator:F}=(0,o.getSharedPickerDemos)(r.DatePicker);e.s(["DatePickerDemos",0,E],341921)},79040,e=>{"use strict";var t=e.i(648863),o=e.i(391398),a=e.i(577824);let n=`
...
`},v={type:"code",maxWidth:400,centered:!0,component:function(){return(0,o.jsx)(a.DateTimePicker,{label:"Pick date and time",placeholder:"Pick date and time",withNativeLevelSelect:!0})},code:`
import { DateTimePicker } from '@mantine/dates';
...
`};var w=(0,t.__exportAll)({clearSectionMode:()=>u,clearable:()=>c,configurator:()=>l,disabled:()=>f,format:()=>p,formatFunction:()=>h,modal:()=>i,nativeLevelSelect:()=>v,presets:()=>x,range:()=>b,timePickerProps:()=>g,usage:()=>n,withSeconds:()=>r});e.s(["DateTimePickerDemos",0,w],851567)},869921,e=>{"use strict";var t=e.i(648448);e.s(["getTimeRange",0,function({startTime:e,endTime:o,interval:a}){let n=[],r=(0,t.timeToSeconds)(e),i=(0,t.timeToSeconds)(o),l=(0,t.timeToSeconds)(a);for(let e=r;e<=i;e+=l)n.push((0,t.secondsToTime)(e).timeString);return n}])},497275,e=>{"use strict";var t=e.i(648863),o=e.i(391398),a=e.i(779893);let n={type:"code",component:function(){return(0,o.jsx)(a.TimePicker,{label:"Enter time"})},code:`
...
`,centered:!0,maxWidth:360},S={type:"code",component:function(){return(0,o.jsx)(j,{data:(0,P.getTimeRange)({startTime:"09:00",endTime:"11:45",interval:"00:15"}),disableTime:["10:45","11:00","11:30"]})},code:`
import { getTimeRange, TimeGrid } from '@mantine/dates';
...
`,centered:!0,maxWidth:360},C={type:"code",component:function(){return(0,o.jsx)(j,{data:(0,P.getTimeRange)({startTime:"09:00",endTime:"22:00",interval:"01:00"}),format:"12h",amPmLabels:{am:"पूर्वाह्न",pm:"अपराह्न"}})},code:`
import { getTimeRange, TimeGrid } from '@mantine/dates';
