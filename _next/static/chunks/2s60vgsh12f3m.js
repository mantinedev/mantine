...
`,centered:!0};var O=(0,t.__exportAll)({arrow:()=>a,configurator:()=>r,controlled:()=>s,delay:()=>x,floating:()=>y,group:()=>b,inline:()=>w,multiline:()=>p,nested:()=>D,offset:()=>g,offsetAxis:()=>k,target:()=>P,transitions:()=>h,usage:()=>T});e.s(["TooltipDemos",0,O],882151)},777101,e=>{"use strict";var t=e.i(648863),o=e.i(191788),n=e.i(232471),i=e.i(485108),r=e.i(470743),l=e.i(34515),s=e.i(391398),a=e.i(196072);let p={in:{opacity:1,transform:"scaleY(1)"},out:{opacity:0,transform:"scaleY(0)"},common:{transformOrigin:"top"},transitionProperty:"transform, opacity"},c={type:"code",code:`
import { useState } from 'react';
