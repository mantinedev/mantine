...
`},h=(0,a.default)().subtract((0,a.default)().day(),"day").format("YYYY-MM-DD"),w=(0,a.default)(h).add(1,"day").format("YYYY-MM-DD"),k=(0,a.default)(h).add(2,"day").format("YYYY-MM-DD"),M=[{id:1,title:"Morning Standup",start:`${h} 09:00:00`,end:`${h} 09:30:00`,color:"blue"},{id:2,title:"Team Meeting",start:`${w} 10:00:00`,end:`${w} 11:30:00`,color:"green"},{id:3,title:"Code Review",start:`${k} 14:00:00`,end:`${k} 15:00:00`,color:"violet"}],S={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.WeekView,{date:new Date,events:M,startTime:"08:00:00",endTime:"18:00:00",firstDayOfWeek:0})},code:[{code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},B={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00",weekLabelFormat:"MMMM D, YYYY"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},eB=(0,a.default)().subtract(((0,a.default)().day()+6)%7,"day").format("YYYY-MM-DD"),ez=(0,a.default)(eB).add(1,"day").format("YYYY-MM-DD"),eN=(0,a.default)(eB).add(2,"day").format("YYYY-MM-DD"),eL=[{id:1,title:"Conference Day",start:`${eB} 00:00:00`,end:(0,a.default)(eB).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"red"},{id:2,title:"Holiday",start:`${ez} 00:00:00`,end:(0,a.default)(ez).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"pink"},{id:3,title:"Team Building",start:`${eB} 00:00:00`,end:(0,a.default)(eN).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"orange"},{id:4,title:"Morning Standup",start:`${eB} 09:00:00`,end:`${eB} 09:30:00`,color:"blue"},{id:5,title:"Code Review",start:`${ez} 14:00:00`,end:`${ez} 15:00:00`,color:"violet"}],eF={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,c.jsx)(u.WeekView,{date:e,onDateChange:t,events:eL,startTime:"08:00:00",endTime:"18:00:00"})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { WeekView, ScheduleEventData } from '@mantine/schedule';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},e2=(0,a.default)().format("YYYY-MM-DD"),e8=(0,a.default)().startOf("week").add(1,"day").format("YYYY-MM-DD"),e4=[{id:"standup",title:"Morning Standup",start:`${e2} 09:00:00`,end:`${e2} 09:30:00`,color:"blue"},{id:"team-meeting",title:"Team Meeting",start:`${e2} 10:00:00`,end:`${e2} 11:30:00`,color:"green"},{id:"daily-sync-series",title:"Daily sync",start:`${(0,a.default)(e8).subtract(3,"day").format("YYYY-MM-DD")} 14:00:00`,end:`${(0,a.default)(e8).subtract(3,"day").format("YYYY-MM-DD")} 14:30:00`,color:"grape",recurrence:{rrule:"FREQ=DAILY;COUNT=14"}},{id:"weekly-review-series",title:"Weekly review",start:`${e8} 16:00:00`,end:`${e8} 17:00:00`,color:"orange",recurrence:{rrule:"FREQ=WEEKLY;COUNT=8"}}],e3={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)(e2);return(0,c.jsx)(u.WeekView,{date:e,onDateChange:t,events:e4,withAgenda:!0})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { WeekView } from '@mantine/schedule';
...
`};var e6=(0,t.__exportAll)({allDayEvents:()=>eF,backgroundEvents:()=>eM,backgroundEventsCustomStyle:()=>eT,bidirectionalDragDrop:()=>eg,businessHours:()=>L,businessHoursPerDay:()=>F,canDragEvent:()=>e_,canResizeEvent:()=>eK,controlledDate:()=>eX,currentTimeIndicator:()=>b,customHeader:()=>eb,dragDrop:()=>J,eventForm:()=>el,eventResize:()=>X,externalDragDrop:()=>eD,firstDayOfWeek:()=>S,forceCurrentTimeIndicator:()=>j,getTimeSlotProps:()=>e1,highlightToday:()=>T,intervalMinutes:()=>D,localization:()=>ej,overlappingEvents:()=>Z,radius:()=>eW,recurringEvents:()=>eh,renderEvent:()=>ei,renderEventBody:()=>eR,slotHeight:()=>N,slotLabelFormat:()=>z,startScrollTime:()=>em,staticMode:()=>ed,subHourGridLines:()=>y,timeRange:()=>v,timezone:()=>A,usage:()=>f,viewChange:()=>e0,weekLabelFormat:()=>B,weekdayFormat:()=>E,withAgenda:()=>e3,withoutAllDaySlots:()=>I,withoutHeader:()=>R,withoutWeekNumber:()=>$,withoutWeekendDays:()=>x});e.s(["WeekViewDemos",0,e6],953813)}]);