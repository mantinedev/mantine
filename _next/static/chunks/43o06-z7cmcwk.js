...
`,language:"tsx"}]};var c=e.i(841209);let s={type:"code",component:function(){return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(c.TextInput,{size:"xs",hiddenFrom:"sm",label:"My input",placeholder:"My input"}),(0,a.jsx)(c.TextInput,{size:"xl",visibleFrom:"sm",label:"My input",placeholder:"My input"})]})},code:[{fileName:"Demo.tsx",code:`
...
`},b={type:"code",component:function(){return(0,a.jsx)(n.Box,{w:{base:200,sm:400,lg:500},py:{base:"xs",sm:"md",lg:"xl"},bg:{base:"blue.7",sm:"red.7",lg:"green.7"},c:"#fff",ta:"center",mx:"auto",children:"Box with responsive style props"})},code:`
import { Box } from '@mantine/core';
...
`};var v=e.i(169972),A=e.i(387136),I=e.i(658109),y=e.i(323283);let j={type:"code",component:function(){let{toggleDirection:e,dir:t,setDirection:n}=(0,y.useDirection)();return(0,x.useEffect)(()=>()=>n("ltr"),[]),(0,a.jsx)(I.ActionIcon,{onClick:()=>e(),variant:"default",size:"lg",children:"rtl"===t?(0,a.jsx)(v.TextAlignLeftIcon,{}):(0,a.jsx)(A.TextAlignRightIcon,{})})},centered:!0,code:`
...
`},z={type:"code",component:function(){return(0,a.jsx)("div",{className:"m_7bd29d5a",children:"Demo"})},code:[{fileName:"Demo.module.css",code:`
.demo {
  text-align: center;
  color: var(--mantine-color-white);
  padding: var(--mantine-spacing-md);
...
`,language:"tsx"}]};var H={root:"m_8b35c16f",section:"m_27c75738"},Z=e.i(858508);function M(e){return(0,a.jsx)(d.Button,{...e,classNames:H})}let w={type:"code",component:function(){return(0,a.jsxs)(r.Group,{children:[(0,a.jsx)(M,{leftSection:"12",rightSection:(0,a.jsx)(Z.ArrowRightIcon,{size:18}),children:"Send files"}),(0,a.jsx)(M,{leftSection:"3",rightSection:(0,a.jsx)(Z.ArrowRightIcon,{size:18}),disabled:!0,children:"Send files"})]})},centered:!0,code:[{fileName:"Demo.module.css",code:`
.root {
...
`,language:"tsx"}]};var E=e.i(383312);let T={type:"code",component:function(){return(0,a.jsxs)(E.Tabs,{defaultValue:"chat",unstyled:!0,children:[(0,a.jsxs)(E.Tabs.List,{children:[(0,a.jsx)(E.Tabs.Tab,{value:"chat",children:"Chat"}),(0,a.jsx)(E.Tabs.Tab,{value:"gallery",children:"Gallery"}),(0,a.jsx)(E.Tabs.Tab,{value:"account",children:"Account"})]}),(0,a.jsx)(E.Tabs.Panel,{value:"chat",children:"Chat panel"}),(0,a.jsx)(E.Tabs.Panel,{value:"gallery",children:"Gallery panel"}),(0,a.jsx)(E.Tabs.Panel,{value:"account",children:"Account panel"})]})},code:`
...
`,C=(e,t)=>"xxl"===t.size?{root:{"--button-height":"60px","--button-padding-x":"30px","--button-fz":"24px"}}:"xxs"===t.size?{root:{"--button-height":"24px","--button-padding-x":"10px","--button-fz":"10px"}}:{root:{}};d.Button.extend({vars:(e,t)=>"xxl"===t.size?{root:{"--button-height":"60px","--button-padding-x":"30px","--button-fz":"24px"}}:"xxs"===t.size?{root:{"--button-height":"24px","--button-padding-x":"10px","--button-fz":"10px"}}:{root:{}}});let F={type:"code",component:function(){return(0,a.jsxs)(r.Group,{children:[(0,a.jsx)(d.Button,{vars:C,size:"xxl",children:"XXL Button"}),(0,a.jsx)(d.Button,{vars:C,size:"xxs",children:"XXS Button"})]})},centered:!0,code:[{code:L,language:"tsx",fileName:"MantineProvider.tsx"},{code:D,language:"tsx",fileName:"Inline.tsx"}]};var S={input:"m_93131372"},k=e.i(294788);let V={type:"code",component:function(){return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(k.Input,{classNames:S,variant:"underline",placeholder:"Underline input"}),(0,a.jsx)(k.Input,{classNames:S,variant:"filled",placeholder:"Filled input",mt:"md"})]})},maxWidth:360,centered:!0,code:[{fileName:"Demo.tsx",code:`
...
`,_=(0,N.createTheme)({components:{Input:k.Input.extend({classNames:{wrapper:"m_b4c95450",input:"m_2be5f2c7"}})}}),R={type:"code",component:function(){return(0,a.jsxs)(B.MantineThemeProvider,{theme:_,children:[(0,a.jsx)(k.Input,{placeholder:"Size XXL",size:"xxl"}),(0,a.jsx)(k.Input,{placeholder:"Size XXS",size:"xxs",mt:"md"})]})},maxWidth:360,centered:!0,code:[{language:"tsx",code:G,fileName:"Demo.tsx"},{language:"scss",code:P,fileName:"Demo.module.css"}]};var X=e.i(56206);let q=`
import cx from 'clsx';
...
`},j={type:"code",component:function(){return(0,r.jsx)(o.ActionIcon,{size:"xl",loading:!0,"aria-label":"Loading...",loaderProps:{type:"dots"}})},centered:!0,code:`
import { ActionIcon } from '@mantine/core';

function Demo() {
  return <ActionIcon size="xl" loading loaderProps={{ type: 'dots' }} aria-label="Loading..." />;
}
`};var z=e.i(951254),H=e.i(530514);let Z=`
...
`,w=(0,H.createTheme)({components:{ActionIcon:o.ActionIcon.extend({classNames:{root:"m_6f3d7427"}})}}),E={type:"code",component:function(){return(0,r.jsx)(z.MantineThemeProvider,{theme:w,children:(0,r.jsxs)(p.Group,{justify:"center",children:[(0,r.jsx)(o.ActionIcon,{size:"xl",variant:"danger","aria-label":"Danger variant",children:(0,r.jsx)(c.HeartIcon,{})}),(0,r.jsx)(o.ActionIcon,{size:"xl",variant:"primary","aria-label":"Primary variant",children:(0,r.jsx)(c.HeartIcon,{})})]})})},centered:!0,code:[{fileName:"Demo.tsx",code:Z,language:"tsx"},{fileName:"Demo.module.css",code:M,language:"scss"}]},T=`
...
`,L=(0,H.createTheme)({components:{ActionIcon:o.ActionIcon.extend({classNames:{root:"m_2be4ed51"}})}}),C={type:"code",component:function(){return(0,r.jsx)(z.MantineThemeProvider,{theme:L,children:(0,r.jsxs)(p.Group,{justify:"center",children:[(0,r.jsx)(o.ActionIcon,{size:"xxs","aria-label":"Custom xxs size",children:(0,r.jsx)(c.HeartIcon,{size:10})}),(0,r.jsx)(o.ActionIcon,{size:"xxl","aria-label":"Custom xxl size",children:(0,r.jsx)(c.HeartIcon,{size:32})})]})})},code:[{fileName:"Demo.tsx",code:T,language:"tsx"},{fileName:"Demo.module.css",code:D,language:"scss"}]};var F=e.i(500954),S=e.i(799678),k=e.i(4518),V=e.i(649069),B=e.i(670989),N=e.i(744335);let G=e=>{let t=(0,V.defaultVariantColorsResolver)(e),n=(0,B.parseThemeColor)({color:e.color||e.theme.primaryColor,theme:e.theme});return n.isThemeColor&&"lime"===n.color&&"filled"===e.variant?{...t,color:"var(--mantine-color-black)",hoverColor:"var(--mantine-color-black)"}:"light"===e.variant?{background:(0,N.rgba)(n.value,.1),hover:(0,N.rgba)(n.value,.15),border:`1px solid ${n.value}`,color:(0,k.darken)(n.value,.1)}:"danger"===e.variant?{background:"var(--mantine-color-red-9)",hover:"var(--mantine-color-red-8)",color:"var(--mantine-color-white)",border:"none"}:t},P={type:"code",component:function(){return(0,r.jsx)(z.MantineThemeProvider,{theme:{variantColorResolver:G},children:(0,r.jsxs)(p.Group,{children:[(0,r.jsx)(o.ActionIcon,{color:"lime.4",variant:"filled",size:"lg","aria-label":"Photo",children:(0,r.jsx)(s.ImageIcon,{size:20})}),(0,r.jsx)(o.ActionIcon,{color:"orange",variant:"light",size:"lg","aria-label":"FingerprintIcon",children:(0,r.jsx)(F.FingerprintIcon,{size:20})}),(0,r.jsx)(o.ActionIcon,{variant:"danger",size:"lg","aria-label":"Error 404",children:(0,r.jsx)(S.WarningIcon,{size:20})})]})})},centered:!0,defaultExpanded:!1,code:`
...
`,centered:!0};var R=e.i(841209);let X={type:"code",component:function(){return(0,r.jsxs)(p.Group,{children:[(0,r.jsx)(R.TextInput,{placeholder:"sm size input",size:"sm"}),(0,r.jsx)(o.ActionIcon,{size:"input-sm",variant:"default","aria-label":"ActionIcon the same size as inputs",children:"SM"})]})},code:`
