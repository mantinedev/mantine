...
`};var i=(0,t.__exportAll)({usage:()=>s});e.s(["UseThrottledValueDemos",0,i],708258)},117924,e=>{"use strict";var t=e.i(648863),n=e.i(191788),r=e.i(883364),a=e.i(841209),o=e.i(391398),l=e.i(726435);let s={type:"code",component:function(){let[e,t]=(0,n.useState)(""),s=(0,l.useThrottledCallback)(e=>t(e),1e3);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(a.TextInput,{placeholder:"Search",onChange:e=>s(e.currentTarget.value)}),(0,o.jsxs)(r.Text,{children:["Throttled value: ",e||"–"]})]})},code:`
import { Text, TextInput } from '@mantine/core';
...
`};var d=(0,t.__exportAll)({usage:()=>c});e.s(["UseSetDemos",0,d],766185)},290516,e=>{"use strict";var t=e.i(648863),n=e.i(191788),r=e.i(935769),a=e.i(883364),o=e.i(841209),l=e.i(391398),s=e.i(609205);let i={type:"code",component:function(){let[e,t]=(0,n.useState)(""),[i,c]=(0,n.useState)([]),[d,u]=(0,n.useState)(!1),h=(0,s.useDebouncedCallback)(async e=>{u(!0),c(await new Promise(t=>{setTimeout(()=>{t(""===e.trim()?[]:[,,,,,].fill(0).map((t,n)=>({id:n,title:`${e} ${n+1}`})))},1e3)})),u(!1)},500);return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(o.TextInput,{value:e,onChange:e=>{t(e.currentTarget.value),h(e.currentTarget.value)},placeholder:"Search...",rightSection:d&&(0,l.jsx)(r.Loader,{size:20})}),i.map(e=>(0,l.jsx)(a.Text,{size:"sm",children:e.title},e.id))]})},code:`
import { useState } from 'react';
