...
`},m={type:"code",component:function(){return(0,l.jsx)(a.MultiSelect,{label:"Your favorite libraries",placeholder:"Pick value",data:[{group:"Frontend",items:["React","Angular"]},{group:"Backend",items:["Express","Django"]}]})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},y=({options:e,search:t})=>{let a=e.filter(e=>e.label.toLowerCase().trim().includes(t.toLowerCase().trim()));return a.sort((e,t)=>e.label.localeCompare(t.label)),a},V={type:"code",component:function(){return(0,l.jsx)(a.MultiSelect,{label:"Your favorite libraries",placeholder:"Pick values",data:["4 – React","1 – Angular","3 – Vue","2 – Svelte"],filter:y,searchable:!0})},code:`
import { MultiSelect, ComboboxItem, OptionsFilter } from '@mantine/core';
...
`,maxWidth:340,centered:!0};var C=e.i(931882),E=e.i(671640);let H={type:"code",component:function(){return(0,l.jsxs)(E.Stack,{children:[(0,l.jsx)(a.MultiSelect,{label:"clearSectionMode='both' (default)",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],defaultValue:["React"],clearable:!0,rightSection:(0,l.jsx)(C.CaretDownIcon,{size:16}),clearSectionMode:"both"}),(0,l.jsx)(a.MultiSelect,{label:"clearSectionMode='rightSection'",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],defaultValue:["React"],clearable:!0,rightSection:(0,l.jsx)(C.CaretDownIcon,{size:16}),clearSectionMode:"rightSection"}),(0,l.jsx)(a.MultiSelect,{label:"clearSectionMode='clear'",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],defaultValue:["React"],clearable:!0,rightSection:(0,l.jsx)(C.CaretDownIcon,{size:16}),clearSectionMode:"clear"})]})},code:`
...
`,centered:!0,component:function(){return(0,l.jsxs)(_.Popover,{width:300,position:"bottom",withArrow:!0,shadow:"md",children:[(0,l.jsx)(_.Popover.Target,{children:(0,l.jsx)(O.Button,{children:"Toggle popover"})}),(0,l.jsx)(_.Popover.Dropdown,{children:(0,l.jsx)(a.MultiSelect,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{withinPortal:!1}})})]})}};var N={dropdown:"m_a9824888",input:"m_f5487eb3"};let $={type:"code",component:function(){return(0,l.jsx)(a.MultiSelect,{label:"Your favorite library",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],classNames:N,comboboxProps:{position:"bottom",middlewares:{flip:!1,shift:!1},offset:0}})},code:[{fileName:"Demo.tsx",code:`
import { MultiSelect } from '@mantine/core';
