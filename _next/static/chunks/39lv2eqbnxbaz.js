...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]};var B=e.i(892791);let L=(0,o.default)().format("YYYY-MM-DD"),U=(0,o.default)().add(1,"day").format("YYYY-MM-DD"),_=(0,o.default)().add(2,"day").format("YYYY-MM-DD"),G=[{id:1,title:"Design workshop",start:`${L} 08:00:00`,end:`${L} 12:00:00`,color:"blue",resourceId:"tokyo"},{id:2,title:"Client onboarding",start:`${L} 10:00:00`,end:`${L} 14:00:00`,color:"violet",resourceId:"paris"},{id:3,title:"Hackathon",start:`${L} 13:00:00`,end:`${L} 19:00:00`,color:"pink",resourceId:"london"},{id:4,title:"Sprint review",start:`${U} 09:00:00`,end:`${U} 11:00:00`,color:"cyan",resourceId:"new-york"},{id:5,title:"Strategy offsite",start:`${U} 14:00:00`,end:`${U} 18:00:00`,color:"green",resourceId:"tokyo"},{id:6,title:"Security audit",start:`${U} 08:00:00`,end:`${U} 13:00:00`,color:"orange",resourceId:"paris"},{id:7,title:"Onboarding training",start:`${_} 10:00:00`,end:`${_} 16:00:00`,color:"grape",resourceId:"london"},{id:8,title:"Interviews",start:`${_} 12:00:00`,end:`${_} 14:00:00`,color:"teal",resourceId:"new-york"}],K={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,c.useState)(L),[o,a]=(0,c.useState)("240");return(0,u.jsxs)(x.Stack,{children:[(0,u.jsx)(B.SegmentedControl,{value:o,onChange:a,data:[{label:"1 hour",value:"60"},{label:"2 hours",value:"120"},{label:"4 hours",value:"240"}]}),(0,u.jsx)(m.ResourcesWeekView,{date:e,onDateChange:t,resources:d,events:G,startTime:"08:00:00",endTime:"20:00:00",intervalMinutes:Number(o),startScrollDateTime:`${L} 08:00:00`})]})},code:[{code:`
import dayjs from 'dayjs';
import { useState } from 'react';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]};var J=e.i(664894),X=e.i(53157);o.default.extend(X.default),o.default.extend(J.default);let Z=["UTC","America/New_York","Europe/Berlin","Asia/Kolkata","Asia/Tokyo"],q=[{id:"tokyo",label:"Meeting room: Tokyo"},{id:"paris",label:"Meeting room: Paris"},{id:"new-york",label:"Meeting room: New York"}],ee={type:"code",component:function(){let[e,t]=(0,c.useState)("UTC"),a=()=>(0,o.default)().tz(e).format("YYYY-MM-DD HH:mm:ss"),r=a().split(" ")[0];return(0,u.jsxs)(x.Stack,{children:[(0,u.jsx)(k.Select,{label:"Display timezone",data:Z,value:e,onChange:e=>t(e),allowDeselect:!1}),(0,u.jsx)(m.ResourcesWeekView,{date:r,resources:q,events:[{id:1,title:"Team Standup",start:`${r} 09:00:00`,end:`${r} 09:30:00`,color:"blue",resourceId:"tokyo"},{id:2,title:"Client Call",start:`${r} 12:00:00`,end:`${r} 13:00:00`,color:"teal",resourceId:"paris"},{id:3,title:"Workshop",start:`${r} 15:00:00`,end:`${r} 17:00:00`,color:"grape",resourceId:"new-york"}],startScrollDateTime:(0,o.default)(a()).subtract(2,"hour").format("YYYY-MM-DD HH:mm:ss"),getCurrentTime:a})]})},code:[{code:`
import { useState } from 'react';
import dayjs from 'dayjs';
...
`,language:"tsx",fileName:"data.ts"}]},et={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,c.useState)((0,o.default)().format("YYYY-MM-DD"));return(0,u.jsx)(m.ResourcesWeekView,{date:e,onDateChange:t,resources:d,events:i,startTime:"08:00:00",endTime:"18:00:00",firstDayOfWeek:0,withWeekendDays:!0,weekdayFormat:"dddd D"})},code:[{code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { ResourcesWeekView } from '@mantine/schedule';
import { events, resources } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},eo={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,c.useState)((0,o.default)().format("YYYY-MM-DD"));return(0,u.jsx)(m.ResourcesWeekView,{date:e,onDateChange:t,resources:d,events:i,startTime:"08:00:00",endTime:"18:00:00",renderWeekLabel:({weekStart:e,weekEnd:t})=>`Week of ${(0,o.default)(e).format("MMM D")} – ${(0,o.default)(t).format("MMM D, YYYY")}`})},code:[{code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { ResourcesWeekView } from '@mantine/schedule';
import { events, resources } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},ea=(0,o.default)().format("YYYY-MM-DD"),er=[{id:"tokyo",label:"Meeting room: Tokyo"},{id:"paris",label:"Meeting room: Paris"}],es=[{id:1,title:"Team Standup",start:`${ea} 09:00:00`,end:`${ea} 10:00:00`,color:"blue",resourceId:"tokyo"},{id:2,title:"Sprint Planning",start:`${ea} 09:00:00`,end:`${ea} 10:30:00`,color:"green",resourceId:"tokyo"},{id:3,title:"Code Review",start:`${ea} 09:30:00`,end:`${ea} 10:00:00`,color:"violet",resourceId:"tokyo"},{id:4,title:"1:1 Meeting",start:`${ea} 09:15:00`,end:`${ea} 10:15:00`,color:"orange",resourceId:"tokyo"},{id:5,title:"Client Call",start:`${ea} 09:00:00`,end:`${ea} 10:00:00`,color:"cyan",resourceId:"paris"},{id:6,title:"Design Review",start:`${ea} 09:00:00`,end:`${ea} 10:00:00`,color:"pink",resourceId:"paris"},{id:7,title:"Architecture Review",start:`${ea} 09:00:00`,end:`${ea} 10:00:00`,color:"red",resourceId:"paris"}],en={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,c.useState)((0,o.default)().format("YYYY-MM-DD"));return(0,u.jsx)(m.ResourcesWeekView,{date:e,onDateChange:t,resources:er,events:es,startTime:"08:00:00",endTime:"18:00:00",startScrollDateTime:`${ea} 08:00:00`,maxEventsPerTimeSlot:2})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
...
`},ed=(0,o.default)().format("YYYY-MM-DD"),ei=[{id:"tokyo",label:"Meeting room: Tokyo"},{id:"paris",label:"Meeting room: Paris"}],el=[{id:"daily-sync-series",title:"Daily sync (series)",start:`${(0,o.default)(ed).subtract(2,"day").format("YYYY-MM-DD")} 09:00:00`,end:`${(0,o.default)(ed).subtract(2,"day").format("YYYY-MM-DD")} 11:00:00`,color:"blue",resourceId:"tokyo",recurrence:{rrule:"FREQ=DAILY;COUNT=10",exdate:[`${ed} 09:00:00`]}},{id:"daily-sync-override",title:"Daily sync (moved today)",start:`${ed} 14:00:00`,end:`${ed} 16:00:00`,color:"grape",resourceId:"tokyo",recurringEventId:"daily-sync-series",recurrenceId:`${ed} 09:00:00`},{id:"one-off",title:"One-off planning",start:`${ed} 11:00:00`,end:`${ed} 13:00:00`,color:"green",resourceId:"paris"}],ec={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,c.useState)(ed);return(0,u.jsx)(m.ResourcesWeekView,{date:e,onDateChange:t,resources:ei,events:el,startTime:"08:00:00",endTime:"18:00:00",startScrollDateTime:`${ed} 08:00:00`})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { ResourcesWeekView } from '@mantine/schedule';
...
`},eu=[{id:"tokyo",label:"Meeting room: Tokyo"},{id:"paris",label:"Meeting room: Paris"},{id:"new-york",label:"Meeting room: New York"},{id:"london",label:"Meeting room: London"},{id:"overflow",label:"Overflow room"}],em=[{label:"Floor 1",resourceIds:["tokyo","paris"]},{label:"Floor 2",resourceIds:["new-york","london"]}],eD={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,c.useState)((0,o.default)().format("YYYY-MM-DD"));return(0,u.jsx)(m.ResourcesWeekView,{date:e,onDateChange:t,resources:eu,events:i,groups:em,startTime:"08:00:00",endTime:"18:00:00",startScrollDateTime:`${(0,o.default)().format("YYYY-MM-DD")} 08:00:00`})},code:[{code:`
import dayjs from 'dayjs';
import { useState } from 'react';
...
`,language:"tsx",fileName:"Demo.tsx"}]};var ef=(0,t.__exportAll)({allDayEvents:()=>v,businessHours:()=>$,currentTimeIndicator:()=>Q,dragDrop:()=>g,eventForm:()=>w,eventResize:()=>S,firstDayOfWeek:()=>et,localization:()=>A,maxEventsPerTimeSlot:()=>en,multiHourIntervals:()=>K,radius:()=>P,recurringEvents:()=>ec,renderEvent:()=>H,renderResourceLabel:()=>j,renderWeekLabel:()=>eo,resourceGroups:()=>eD,scrollAreaProps:()=>z,startScrollDateTime:()=>F,staticMode:()=>h,timeRange:()=>O,timezone:()=>ee,usage:()=>D,withoutWeekendDays:()=>T});e.s(["ResourcesWeekViewDemos",0,ef],913839)}]);