...
`},p={type:"code",component:function(){return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(r.TextInput,{label:"Boolean error",placeholder:"Boolean error",error:!0}),(0,o.jsx)(r.TextInput,{mt:"md",label:"With error message",placeholder:"With error message",error:"Invalid name"})]})},maxWidth:340,centered:!0,code:`
import { TextInput } from '@mantine/core';
...
`},u={type:"code",component:function(){return(0,o.jsx)(r.TextInput,{label:"Text Input",placeholder:"Text Input",success:"Looks good!"})},code:`
import { TextInput } from '@mantine/core';

function Demo() {
  return <TextInput label="Text Input" placeholder="Text Input" success="Looks good!" />;
}
`,maxWidth:340,centered:!0},c={type:"code",component:function(){return(0,o.jsx)(r.TextInput,{disabled:!0,label:"Disabled input",placeholder:"Disabled input"})},maxWidth:340,centered:!0,code:`
import { TextInput } from '@mantine/core';

function Demo() {
  return <TextInput disabled label="Disabled input" placeholder="Disabled input" />;
}
`};var d=e.i(473638);let m=`
import { AtIcon } from '@phosphor-icons/react';
import { TextInput } from '@mantine/core';
...
`,x={type:"styles-api",data:d.TextInputStylesApi,component:function(e){return(0,o.jsx)(r.TextInput,{label:"Label",placeholder:"TextInput",description:"Description",error:"Error",withAsterisk:!0,leftSection:(0,o.jsx)(i.AtIcon,{size:18}),...e})},code:m,centered:!0,maxWidth:340},h={type:"code",component:function(){return(0,o.jsx)(r.TextInput,{placeholder:"Your email",loading:!0})},code:`
import { TextInput } from '@mantine/core';

function Demo() {
  return <TextInput placeholder="Your email" loading />;
}
`,centered:!0,maxWidth:340};var I=(0,t.__exportAll)({disabled:()=>c,error:()=>p,loading:()=>h,sections:()=>s,stylesApi:()=>x,success:()=>u,type:()=>l,usage:()=>a});e.s(["TextInputDemos",0,I],576840)},828749,e=>{"use strict";var t=e.i(391398),n=e.i(38856),r=e.i(576840);e.i(603441);var o=e.i(62558);e.i(457450);var a=e.i(418026);let l=(0,o.Layout)(a.MDX_DATA.TextInput);function i(e){let o={code:"code",h2:"h2",p:"p",pre:"pre",...(0,n.useMDXComponents)(),...e.components},{Demo:a,GetElementRef:l,InputAccessibility:i,InputFeatures:p,InputSections:u,StylesApiSelectors:c}=o;return a||s("Demo",!0),l||s("GetElementRef",!0),i||s("InputAccessibility",!0),p||s("InputFeatures",!0),u||s("InputSections",!0),c||s("StylesApiSelectors",!0),(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(o.h2,{id:"usage",children:"Usage"}),"\n",(0,t.jsx)(p,{component:"TextInput",element:"input"}),"\n",(0,t.jsx)(a,{data:r.TextInputDemos.usage}),"\n",(0,t.jsx)(o.h2,{id:"loading-state",children:"Loading state"}),"\n",(0,t.jsxs)(o.p,{children:["Set ",(0,t.jsx)(o.code,{children:"loading"})," prop to display a loading indicator. By default, the loader is displayed on the right side of the input.\nYou can change the position with the ",(0,t.jsx)(o.code,{children:"loadingPosition"})," prop to ",(0,t.jsx)(o.code,{children:"'left'"})," or ",(0,t.jsx)(o.code,{children:"'right'"}),". This is useful for async operations like API calls, searches, or validations:"]}),"\n",(0,t.jsx)(a,{data:r.TextInputDemos.loading}),"\n",(0,t.jsx)(o.h2,{id:"controlled",children:"Controlled"}),"\n",(0,t.jsx)(o.pre,{children:(0,t.jsx)(o.code,{className:"language-tsx",children:"import { useState } from 'react';\nimport { TextInput } from '@mantine/core';\n\nfunction Demo() {\n  const [value, setValue] = useState('');\n  return (\n    <TextInput\n      value={value}\n      onChange={(event) => setValue(event.currentTarget.value)}\n    />\n  );\n}\n"})}),"\n",(0,t.jsx)(o.h2,{id:"uncontrolled",children:"Uncontrolled"}),"\n",(0,t.jsxs)(o.p,{children:[(0,t.jsx)(o.code,{children:"TextInput"})," can be used with uncontrolled forms the same way as a native ",(0,t.jsx)(o.code,{children:'input[type="text"]'}),".\nSet the ",(0,t.jsx)(o.code,{children:"name"})," attribute to include text input value in ",(0,t.jsx)(o.code,{children:"FormData"})," object on form submission.\nTo control the initial value in uncontrolled forms, use the ",(0,t.jsx)(o.code,{children:"defaultValue"})," prop."]}),"\n",(0,t.jsxs)(o.p,{children:["Example usage of uncontrolled ",(0,t.jsx)(o.code,{children:"TextInput"})," with ",(0,t.jsx)(o.code,{children:"FormData"}),":"]}),"\n",(0,t.jsx)(o.pre,{children:(0,t.jsx)(o.code,{className:"language-tsx",children:"import { TextInput } from '@mantine/core';\n\nfunction Demo() {\n  return (\n    <form\n      onSubmit={(event) => {\n        event.preventDefault();\n        const formData = new FormData(event.currentTarget);\n        console.log('Text input value:', formData.get('name'));\n      }}\n    >\n      <TextInput label=\"Enter your name\" name=\"name\" />\n      <button type=\"submit\">Submit</button>\n    </form>\n  );\n}\n"})}),"\n",(0,t.jsx)(u,{component:"TextInput"}),"\n",(0,t.jsx)(a,{data:r.TextInputDemos.sections}),"\n",(0,t.jsx)(o.h2,{id:"error-state",children:"Error state"}),"\n",(0,t.jsx)(a,{data:r.TextInputDemos.error}),"\n",(0,t.jsx)(o.h2,{id:"success-state",children:"Success state"}),"\n",(0,t.jsx)(a,{data:r.TextInputDemos.success}),"\n",(0,t.jsx)(o.h2,{id:"disabled-state",children:"Disabled state"}),"\n",(0,t.jsx)(a,{data:r.TextInputDemos.disabled}),"\n",(0,t.jsx)(c,{component:"TextInput"}),"\n",(0,t.jsx)(a,{data:r.TextInputDemos.stylesApi}),"\n",(0,t.jsx)(l,{component:"TextInput",refType:"input"}),"\n",(0,t.jsx)(i,{component:"TextInput"})]})}function s(e,t){throw Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}e.s(["default",0,function(e={}){return(0,t.jsx)(l,{...e,children:(0,t.jsx)(i,{...e})})}])},939992,(e,t,n)=>{let r="/core/text-input";(window.__NEXT_P=window.__NEXT_P||[]).push([r,()=>e.r(828749)]),t.hot&&t.hot.dispose(function(){window.__NEXT_P.push([r])})},648761,e=>{e.v(t=>Promise.all(["static/chunks/22379_btw709h.js"].map(t=>e.l(t))).then(()=>t(493594)))},828805,e=>{e.v(t=>Promise.all(["static/chunks/4558t_0mgc5j4.js"].map(t=>e.l(t))).then(()=>t(879466)))}]);