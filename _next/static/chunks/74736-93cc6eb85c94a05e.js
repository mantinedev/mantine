...
`,centered:!0,maxWidth:340}},42697:function(e,t,r){r.d(t,{Y:function(){return A}});var n=r(52322),o=r(2784),u=r(40489),a=r(9462),i=r(9341),l=r(82692),c=r(70837),m=r(91482),s=r(11200),f=r(51477),d=r(46690),p=r(38483),g=r(82027),b=r(73063),h=r(63409);function y({direction:e,style:t,...r}){return(0,n.jsx)("svg",{style:{width:"var(--ni-chevron-size)",height:"var(--ni-chevron-size)",transform:"up"===e?"rotate(180deg)":void 0,...t},viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",...r,children:(0,n.jsx)("path",{d:"M3.13523 6.15803C3.3241 5.95657 3.64052 5.94637 3.84197 6.13523L7.5 9.56464L11.158 6.13523C11.3595 5.94637 11.6759 5.95657 11.8648 6.15803C12.0536 6.35949 12.0434 6.67591 11.842 6.86477L7.84197 10.6148C7.64964 10.7951 7.35036 10.7951 7.15803 10.6148L3.15803 6.86477C2.95657 6.67591 2.94637 6.35949 3.13523 6.15803Z",fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd"})})}var v={root:"m_e2f5cd4e",controls:"m_95e17d22",control:"m_80b4b171"};let N=/^(0\.0*|-0(\.0*)?)$/,w=/^-?0\d+(\.\d+)?\.?$/;function j(e){return"string"==typeof e&&""!==e&&!Number.isNaN(Number(e))}function I(e){return"number"==typeof e?e<Number.MAX_SAFE_INTEGER:""===e||j(e)&&Number(e)<Number.MAX_SAFE_INTEGER}function k(e,t,r){return void 0===e||(void 0===t||e>=t)&&(void 0===r||e<=r)}let x={step:1,clampBehavior:"blur",allowDecimal:!0,allowNegative:!0,withKeyboardEvents:!0,allowLeadingZeros:!0,trimLeadingZeroesOnBlur:!0,startValue:0},E=(0,s.Z)((e,{size:t})=>({controls:{"--ni-chevron-size":(0,m.ap)(t,"ni-chevron-size")}})),A=(0,g.d5)((e,t)=>{let r=(0,p.w)("NumberInput",x,e),{className:m,classNames:s,styles:g,unstyled:A,vars:P,onChange:_,onValueChange:O,value:D,defaultValue:F,max:S,min:R,step:M,hideControls:V,rightSection:T,isAllowed:z,clampBehavior:C,onBlur:B,allowDecimal:Y,decimalScale:L,onKeyDown:G,onKeyDownCapture:U,handlersRef:Z,startValue:q,disabled:J,rightSectionPointerEvents:W,allowNegative:X,readOnly:$,size:K,rightSectionWidth:H,stepHoldInterval:Q,stepHoldDelay:ee,allowLeadingZeros:et,withKeyboardEvents:er,trimLeadingZeroesOnBlur:en,...eo}=r,eu=(0,d.y)({name:"NumberInput",classes:v,props:r,classNames:s,styles:g,unstyled:A,vars:P,varsResolver:E}),{resolvedClassNames:ea,resolvedStyles:ei}=(0,f.h)({classNames:s,styles:g,props:r}),[el,ec]=(0,i.C)({value:D,defaultValue:F,finalValue:"",onChange:_}),em=void 0!==ee&&void 0!==Q,es=(0,o.useRef)(null),ef=(0,o.useRef)(null),ed=(0,o.useRef)(0),ep=e=>{let t=String(e).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);return t?Math.max(0,(t[1]?t[1].length:0)-(t[2]?+t[2]:0)):0},eg=e=>{es.current&&void 0!==e&&es.current.setSelectionRange(e,e)},eb=(0,o.useRef)();eb.current=()=>{let e;if(!I(el))return;let t=Math.max(ep(el),ep(M)),r=10**t;if(!j(el)&&("number"!=typeof el||Number.isNaN(el)))e=(0,l.u)(q,R,S);else if(void 0!==S){let t=(Math.round(Number(el)*r)+Math.round(M*r))/r;e=t<=S?t:S}else e=(Math.round(Number(el)*r)+Math.round(M*r))/r;let n=e.toFixed(t);ec(parseFloat(n)),O?.({floatValue:parseFloat(n),formattedValue:n,value:n},{source:"increment"}),setTimeout(()=>eg(es.current?.value.length),0)};let eh=(0,o.useRef)();eh.current=()=>{let e;if(!I(el))return;let t=void 0!==R?R:X?Number.MIN_SAFE_INTEGER:0,r=Math.max(ep(el),ep(M)),n=10**r;if(!j(el)&&"number"!=typeof el||Number.isNaN(el))e=(0,l.u)(q,t,S);else{let r=(Math.round(Number(el)*n)-Math.round(M*n))/n;e=void 0!==t&&r<t?t:r}let o=e.toFixed(r);ec(parseFloat(o)),O?.({floatValue:parseFloat(o),formattedValue:o,value:o},{source:"decrement"}),setTimeout(()=>eg(es.current?.value.length),0)},(0,c.kR)(Z,{increment:eb.current,decrement:eh.current});let ey=e=>{e?eb.current():eh.current(),ed.current+=1},ev=e=>{if(ey(e),em){let t="number"==typeof Q?Q:Q(ed.current);ef.current=window.setTimeout(()=>ev(e),t)}},eN=(e,t)=>{e.preventDefault(),es.current?.focus(),ey(t),em&&(ef.current=window.setTimeout(()=>ev(t),ee))},ew=()=>{ef.current&&window.clearTimeout(ef.current),ef.current=null,ed.current=0},ej=(0,n.jsxs)("div",{...eu("controls"),children:[(0,n.jsx)(h.k,{...eu("control"),tabIndex:-1,"aria-hidden":!0,disabled:J||"number"==typeof el&&void 0!==S&&el>=S,mod:{direction:"up"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{eN(e,!0)},onPointerUp:ew,onPointerLeave:ew,children:(0,n.jsx)(y,{direction:"up"})}),(0,n.jsx)(h.k,{...eu("control"),tabIndex:-1,"aria-hidden":!0,disabled:J||"number"==typeof el&&void 0!==R&&el<=R,mod:{direction:"down"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{eN(e,!1)},onPointerUp:ew,onPointerLeave:ew,children:(0,n.jsx)(y,{direction:"down"})})]});return(0,n.jsx)(b.M,{component:a.h3,allowNegative:X,className:(0,u.Z)(v.root,m),size:K,...eo,readOnly:$,disabled:J,value:el,getInputRef:(0,c.Yx)(t,es),onValueChange:(e,t)=>{var r,n;"event"===t.source&&ec((r=e.floatValue,n=e.value,("number"==typeof r?!(r<Number.MAX_SAFE_INTEGER):!!Number.isNaN(Number(r)))||Number.isNaN(r)||!(14>n.toString().replace(".","").length)||""===n||N.test(e.value)||et&&w.test(e.value))?e.value:e.floatValue),O?.(e,t)},rightSection:V||$||!I(el)?T:T||ej,classNames:ea,styles:ei,unstyled:A,__staticSelector:"NumberInput",decimalScale:Y?L:0,onKeyDown:e=>{G?.(e),!$&&er&&("ArrowUp"===e.key&&(e.preventDefault(),eb.current()),"ArrowDown"===e.key&&(e.preventDefault(),eh.current()))},onKeyDownCapture:e=>{if(U?.(e),"Backspace"===e.key){let t=es.current;0===t.selectionStart&&t.selectionStart===t.selectionEnd&&(e.preventDefault(),window.setTimeout(()=>eg(0),0))}},rightSectionPointerEvents:W??(J?"none":void 0),rightSectionWidth:H??`var(--ni-right-section-width-${K||"sm"})`,allowLeadingZeros:et,onBlur:e=>{if(B?.(e),"blur"===C&&"number"==typeof el&&(0,l.u)(el,R,S)!==el&&ec((0,l.u)(el,R,S)),en&&"string"==typeof el&&15>ep(el)){let e=el.replace(/^0+/,""),t=parseFloat(e);ec(Number.isNaN(t)||t>Number.MAX_SAFE_INTEGER?e:(0,l.u)(t,R,S))}},isAllowed:e=>"strict"===C?z?z(e)&&k(e.floatValue,R,S):k(e.floatValue,R,S):!z||z(e)})});A.classes={...b.M.classes,...v},A.displayName="@mantine/core/NumberInput"},73846:function(e,t,r){r.d(t,{m:function(){return n}});function n({min:e,max:t},r){let n=r||!0;return r=>{if("number"!=typeof r)return n;let o=!0;return"number"==typeof e&&r<e&&(o=!1),"number"==typeof t&&r>t&&(o=!1),o?null:n}}},3095:function(e,t,r){r.d(t,{U:function(){return n}});function n(e){let t=e||!0;return e=>"string"==typeof e?e.trim().length>0?null:t:Array.isArray(e)?e.length>0?null:t:null==e||!1===e?t:null}}}]);