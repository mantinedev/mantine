...
`,centered:!0,controls:[{type:"segmented",prop:"textWrap",initialValue:"wrap",libraryValue:"__",data:[{value:"wrap",label:"wrap"},{value:"balance",label:"balance"}]}]};var d=(0,t.__exportAll)({lineClamp:()=>i,size:()=>o,textWrap:()=>s,usage:()=>n});e.s(["TitleDemos",0,d],27905)},436100,e=>{"use strict";var t=e.i(648863);let a=[{name:"USA",value:400,color:"indigo.6"},{name:"India",value:300,color:"yellow.6"},{name:"Japan",value:300,color:"teal.6"},{name:"Other",value:200,color:"gray.6"}],r=`
export const data = [
...
`;var n=e.i(391398),o=e.i(520916),l={root:"m_cd8943fd"},i=e.i(232471),s=e.i(481178),d=e.i(275519),c=e.i(317477),u=e.i(779177),m=e.i(951254),p=e.i(44091),h=e.i(62904),f=e.i(391466),x=e.i(865749),y=e.i(586536),g=e.i(723451),D=e.i(694713);let v={withTooltip:!1,withLabelsLine:!0,paddingAngle:0,size:160,strokeWidth:1,startAngle:0,endAngle:360,tooltipDataSource:"all",labelsPosition:"outside",labelsType:"value"},b=(0,s.createVarsResolver)((e,{strokeColor:t,labelColor:a,withLabels:r,size:n,labelsPosition:o})=>({root:{"--chart-stroke-color":t?(0,c.getThemeColor)(t,e):void 0,"--chart-labels-color":a?(0,c.getThemeColor)(a,e):void 0,"--chart-size":r&&"outside"===o?(0,u.rem)(n+80):(0,u.rem)(n)}})),k=(e,t,a,r,n)=>"name"===e?r:"percent"===e&&"number"==typeof a?`${(100*a).toFixed(0)}%`:"function"==typeof n&&"number"==typeof t?n(t):t,j=(0,d.factory)(e=>{let t,a,r=(0,p.useProps)("PieChart",v,e),{classNames:s,className:d,style:u,styles:j,unstyled:P,vars:M,data:Y,withTooltip:w,tooltipAnimationDuration:C,tooltipProps:_,pieProps:I,paddingAngle:S,withLabels:V,withLabelsLine:T,size:A,strokeWidth:L,startAngle:N,endAngle:H,tooltipDataSource:W,children:F,pieChartProps:E,labelsPosition:z,valueFormatter:Z,labelsType:R,strokeColor:O,attributes:B,cellProps:$,...q}=r,U=(0,m.useMantineTheme)(),G=(0,f.useStyles)({name:"PieChart",classes:l,props:r,className:d,style:u,classNames:s,styles:j,unstyled:P,attributes:B,vars:M,varsResolver:b}),{resolvedClassNames:J,resolvedStyles:X}=(0,h.useResolvedStylesApi)({classNames:s,styles:j,props:r}),K=Y.map(e=>({...e,fill:(0,c.getThemeColor)(e.color,U),stroke:"var(--chart-stroke-color, var(--mantine-color-body))",strokeWidth:L,..."function"==typeof $?$(e):$}));return(0,n.jsx)(i.Box,{size:A,...G("root"),...q,children:(0,n.jsx)(g.ResponsiveContainer,{children:(0,n.jsxs)(y.PieChart,{...E,children:[(0,n.jsx)(x.Pie,{data:K,innerRadius:0,outerRadius:A/2,dataKey:"value",isAnimationActive:!1,paddingAngle:S,startAngle:N,endAngle:H,label:!!V&&("inside"===z?(t=R||"value",({cx:e,cy:a,midAngle:r,innerRadius:o,outerRadius:i,value:s,percent:d,name:c})=>{let u=Math.PI/180,m=Number(o)+(Number(i)-Number(o))*.5,p=Number(e)+m*Math.cos(-(r||0)*u);return(0,n.jsx)("text",{x:p,y:Number(a)+m*Math.sin(-(r||0)*u),textAnchor:p>Number(e)?"start":"end",dominantBaseline:"central",className:l.label,children:k(t,Number(s),Number(d),c,Z)})}):(a=R||"value",({x:e,y:t,cx:r,cy:o,percent:l,value:i,name:s})=>(0,n.jsx)("text",{x:e,y:t,cx:r,cy:o,textAnchor:e>Number(r)?"start":"end",fill:"var(--chart-labels-color, var(--mantine-color-dimmed))",fontFamily:"var(--mantine-font-family)",fontSize:12,children:(0,n.jsx)("tspan",{x:e,children:k(a,Number(i),Number(l),s,Z)})}))),labelLine:!!T&&"outside"===z&&{stroke:"var(--chart-label-color, var(--mantine-color-dimmed))",strokeWidth:1},...I}),w&&(0,n.jsx)(D.Tooltip,{animationDuration:C,isAnimationActive:!1,content:({payload:e})=>(0,n.jsx)(o.ChartTooltip,{payload:Y,classNames:J,styles:X,type:"radial",segmentId:"segment"===W?e?.[0]?.name:void 0,valueFormatter:Z,attributes:B}),..._}),F]})})})});j.displayName="@mantine/charts/PieChart",j.classes=l,j.varsResolver=b;let P={type:"code",component:function(){return(0,n.jsx)(j,{data:a})},code:[{code:`
...
`,language:"tsx",fileName:"Demo.tsx"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},M={type:"code",component:function(){return(0,n.jsx)(j,{data:a,startAngle:180,endAngle:0})},code:[{code:`
import { PieChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},Y={type:"configurator",component:function(e){return(0,n.jsx)(j,{...e,data:[{name:"USA",value:400,color:e.color},{name:"Other",value:200,color:"gray.6"}]})},code:e=>`
import { PieChart } from '@mantine/charts';
...
`,centered:!0,controls:[{type:"color",prop:"color",initialValue:"blue",libraryValue:"__"}]},w={type:"code",component:function(){return(0,n.jsx)(j,{data:a,withTooltip:!0})},code:[{code:`
import { PieChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},C={type:"configurator",component:function(e){return(0,n.jsx)(j,{...e,data:a,mih:300})},code:[{fileName:"Demo.tsx",code:`
import { PieChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx"},{fileName:"data.ts",code:r,language:"tsx"}],centered:!0,controls:[{type:"number",prop:"size",initialValue:160,min:80,max:300,step:1,libraryValue:"__"}]},_={type:"code",component:function(){return(0,n.jsx)("div",{className:"m_e00fbef3",children:(0,n.jsx)(j,{data:a,strokeColor:"var(--card-bg)"})})},code:[{code:`
import { PieChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"scss",fileName:"Demo.module.css"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},I={type:"configurator",component:function(e){return(0,n.jsx)(j,{...e,data:a})},code:[{fileName:"Demo.tsx",code:`
import { PieChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx"},{fileName:"data.ts",code:r,language:"tsx"}],centered:!0,controls:[{type:"number",prop:"strokeWidth",initialValue:1,min:0,max:2,step:.1,libraryValue:"__"}]};var S=e.i(725695),V=e.i(883364);let T={type:"code",component:function(){return(0,n.jsxs)(S.Group,{gap:50,children:[(0,n.jsxs)("div",{children:[(0,n.jsx)(V.Text,{fz:"xs",mb:"sm",ta:"center",children:"Data only for hovered segment"}),(0,n.jsx)(j,{data:a,withTooltip:!0,tooltipDataSource:"segment",mx:"auto"})]}),(0,n.jsxs)("div",{children:[(0,n.jsx)(V.Text,{fz:"xs",mb:"sm",ta:"center",children:"Data only for all segments"}),(0,n.jsx)(j,{data:a,withTooltip:!0,mx:"auto"})]})]})},code:[{code:`
...
`,language:"tsx",fileName:"Demo.tsx"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},A={type:"configurator",component:function(e){return(0,n.jsx)(j,{...e,withLabels:!0,data:a,miw:300})},code:[{fileName:"Demo.tsx",code:`
import { PieChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx"},{fileName:"data.ts",code:r,language:"tsx"}],centered:!0,controls:[{type:"boolean",prop:"withLabelsLine",initialValue:!0,libraryValue:"__"},{type:"segmented",prop:"labelsPosition",initialValue:"outside",libraryValue:"__",data:["inside","outside"]},{type:"segmented",prop:"labelsType",initialValue:"value",libraryValue:"__",data:["value","percent","name"]}]},L={type:"code",component:function(){return(0,n.jsx)(j,{data:a,withLabelsLine:!0,labelsPosition:"outside",labelsType:"name",withLabels:!0})},code:[{code:`
import { PieChart } from '@mantine/charts';
import { data } from './data';
...
`};var D=e.i(393353);let v=e=>{let t=(0,c.default)(e).date();return(0,o.jsx)(D.Indicator,{size:6,color:"red",offset:-5,disabled:16!==t,children:(0,o.jsx)("div",{children:t})})},b={type:"code",centered:!0,maxWidth:400,component:function(){return(0,o.jsx)(l.DatePickerInput,{label:"Pick date",placeholder:"Pick date",renderDay:v})},code:`
import dayjs from 'dayjs';
...
`},C={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,p.useState)(null);return(0,o.jsx)(l.DatePickerInput,{monthsListFormat:"MM",yearsListFormat:"YY",label:"Pick date",placeholder:"Pick date",value:e,onChange:t})},code:`
import { useState } from 'react';
import { DatePickerInput } from '@mantine/dates';
...
`},_={type:"code",centered:!0,maxWidth:400,component:function(){return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(l.DatePickerInput,{maxLevel:"year",label:"Year max level",placeholder:"Year max level",mb:"md"}),(0,o.jsx)(l.DatePickerInput,{maxLevel:"month",label:"Month max level",placeholder:"Month max level"})]})},code:`
import { DatePickerInput } from '@mantine/dates';
...
`},I={type:"code",centered:!0,maxWidth:400,component:function(){return(0,o.jsx)(l.DatePickerInput,{weekendDays:[1,2],label:"Weekend days are Monday and Tuesday",placeholder:"Pick date"})},code:`
import { DatePickerInput } from '@mantine/dates';
...
`};var T=(0,t.__exportAll)({clearSectionMode:()=>i,clearable:()=>E,configurator:()=>H,controlProps:()=>g,defaultLevel:()=>j,disabled:()=>d,excludeDate:()=>k,firstDayOfWeek:()=>Y,headerControlsOrder:()=>V,hideOutsideDates:()=>P,hideWeekdays:()=>M,icon:()=>F,labelFormat:()=>w,listFormat:()=>C,maxLevel:()=>_,minMax:()=>h,modal:()=>W,multiple:()=>L,presets:()=>u,presetsRange:()=>m,range:()=>N,renderDay:()=>b,usage:()=>A,valueFormat:()=>s,valueFormatter:()=>z,weekendDays:()=>I,withWeekNumbers:()=>S});let{usage:A,multiple:L,range:N,configurator:H,modal:W,icon:F,clearable:E,valueFormatter:z}=(0,a.getSharedPickerInputDemos)(l.DatePickerInput);e.s(["DatePickerInputDemos",0,T],403360)},337904,e=>{"use strict";var t=e.i(337976),a=e.i(164036),r=e.i(831474),n={monthPickerRoot:"m_53c9e871",presetsList:"m_cccb8ff3",presetButton:"m_7b4fbf50"},o=e.i(191788),l=e.i(391398),i=e.i(232471),s=e.i(284629),d=e.i(481178),c=e.i(275519),u=e.i(433512),m=e.i(44091),p=e.i(62904),h=e.i(391466);let f=(0,d.createVarsResolver)((e,{size:t})=>({monthPickerRoot:{"--preset-font-size":(0,u.getFontSize)(t)}})),x={type:"default"},y=(0,c.factory)(e=>{let d=(0,m.useProps)("MonthPicker",x,e),{classNames:c,styles:u,vars:y,type:g,defaultValue:D,value:v,onChange:b,__staticSelector:k,getMonthControlProps:j,allowSingleDateInRange:P,allowDeselect:M,onMouseLeave:Y,onMonthSelect:w,__updateDateOnMonthSelect:C,__onPresetSelect:_,__stopPropagation:I,presets:S,className:V,style:T,unstyled:A,size:L,attributes:N,onLevelChange:H,...W}=d,{calendarProps:F,others:E}=(0,r.pickCalendarProps)(W),z=(0,o.useRef)(null),Z=(0,o.useRef)(null),R=(0,h.useStyles)({name:k||"MonthPicker",classes:n,props:d,className:V,style:T,classNames:c,styles:u,unstyled:A,attributes:N,rootSelector:S?"monthPickerRoot":void 0,varsResolver:f,vars:y}),{onDateChange:O,onRootMouseLeave:B,onHoveredDateChange:$,getControlProps:q,setValue:U}=(0,t.useDatesState)({type:g,level:"month",allowDeselect:M,allowSingleDateInRange:P,value:v,defaultValue:D,onChange:b,onMouseLeave:Y}),{resolvedClassNames:G,resolvedStyles:J}=(0,p.useResolvedStylesApi)({classNames:c,styles:u,props:d}),X=(0,l.jsx)(a.Calendar,{classNames:G,styles:J,size:L,...F,...!S?E:{},minLevel:"year",__updateDateOnMonthSelect:C??!1,__staticSelector:k||"MonthPicker",onMouseLeave:B,onMonthMouseEnter:(e,t)=>$(t),onMonthSelect:e=>{O(e),w?.(e)},getMonthControlProps:e=>({...q(e),...j?.(e)}),onLevelChange:H,__setDateRef:z,__setLevelRef:Z,__stopPropagation:I,attributes:N,...!S?{className:V,style:T}:{}});if(!S)return X;let K=S.map((e,t)=>(0,l.jsx)(s.UnstyledButton,{...R("presetButton"),onClick:()=>{var t;let a;void 0!==(a=Array.isArray(t=e.value)?t[0]:t)&&(z.current?.(a),Z.current?.("year"),_?_(a):U(t))},onMouseDown:e=>e.preventDefault(),"data-mantine-stop-propagation":I||void 0,children:e.label},t));return(0,l.jsxs)(i.Box,{...R("monthPickerRoot"),size:L,...E,children:[(0,l.jsx)("div",{...R("presetsList"),children:K}),X]})});y.classes={...a.Calendar.classes,...n},y.varsResolver=f,y.displayName="@mantine/dates/MonthPicker",e.s(["MonthPicker",0,y],337904)},215126,e=>{"use strict";var t=e.i(568827),a=e.i(782681),r=e.i(878166),n=e.i(831474),o=e.i(337904),l=e.i(391398),i=e.i(275519),s=e.i(44091),d=e.i(62904);let c={type:"default",size:"sm",valueFormat:"MMMM YYYY",closeOnChange:!0,sortDates:!0,dropdownType:"popover"},u=(0,i.factory)(e=>{let i=(0,s.useProps)(["Input","InputWrapper","MonthPickerInput"],c,e),{type:u,value:m,defaultValue:p,onChange:h,valueFormat:f,labelSeparator:x,locale:y,classNames:g,styles:D,unstyled:v,closeOnChange:b,size:k,variant:j,dropdownType:P,sortDates:M,minDate:Y,maxDate:w,vars:C,valueFormatter:_,presets:I,attributes:S,...V}=i,{resolvedClassNames:T,resolvedStyles:A}=(0,d.useResolvedStylesApi)({classNames:g,styles:D,props:i}),{calendarProps:L,others:N}=(0,n.pickCalendarProps)(V),{_value:H,setValue:W,formattedValue:F,dropdownHandlers:E,dropdownOpened:z,onClear:Z,shouldClear:R}=(0,r.useDatesInput)({type:u,value:m,defaultValue:p,onChange:h,locale:y,format:f,labelSeparator:x,closeOnChange:b,sortDates:M,valueFormatter:_});return(0,l.jsx)(a.PickerInputBase,{formattedValue:F,dropdownOpened:z,dropdownHandlers:E,classNames:T,styles:A,unstyled:v,onClear:Z,shouldClear:R,value:H,size:k,variant:j,dropdownType:P,...N,attributes:S,type:u,__staticSelector:"MonthPickerInput",children:(0,l.jsx)(o.MonthPicker,{...L,size:k,variant:j,type:u,value:H,defaultDate:L.defaultDate||(Array.isArray(H)?H[0]||(0,t.getDefaultClampedDate)({maxDate:w,minDate:Y}):H||(0,t.getDefaultClampedDate)({maxDate:w,minDate:Y})),onChange:W,locale:y,classNames:T,styles:A,unstyled:v,__staticSelector:"MonthPickerInput",__stopPropagation:"popover"===P,minDate:Y,maxDate:w,presets:I,attributes:S})})});u.classes={...a.PickerInputBase.classes,...o.MonthPicker.classes},u.displayName="@mantine/dates/MonthPickerInput",e.s(["MonthPickerInput",0,u])},198277,e=>{"use strict";var t=e.i(648863),a=e.i(391398),r=e.i(267073),n=e.i(135140),o=e.i(215126);e.i(39167);let l={type:"code",component:function(){return(0,a.jsxs)(n.DatesProvider,{settings:{locale:"ru",firstDayOfWeek:0,weekendDays:[0]},children:[(0,a.jsx)(o.MonthPickerInput,{label:"Pick month",placeholder:"Pick month"}),(0,a.jsx)(r.DatePickerInput,{mt:"md",label:"Pick date",placeholder:"Pick date"})]})},code:`
...
`;var n=e.i(391398),o=e.i(520916),l={root:"m_a410e613",label:"m_ddb0bfe3"},i=e.i(232471),s=e.i(481178),d=e.i(275519),c=e.i(317477),u=e.i(779177),m=e.i(951254),p=e.i(44091),h=e.i(62904),f=e.i(391466),x=e.i(865749),y=e.i(586536),g=e.i(723451),D=e.i(694713);let v={withTooltip:!0,withLabelsLine:!0,paddingAngle:0,thickness:20,size:160,strokeWidth:1,startAngle:0,endAngle:360,labelsType:"value",tooltipDataSource:"all"},b=(0,s.createVarsResolver)((e,{strokeColor:t,labelColor:a,withLabels:r,size:n})=>({root:{"--chart-stroke-color":t?(0,c.getThemeColor)(t,e):void 0,"--chart-labels-color":a?(0,c.getThemeColor)(a,e):void 0,"--chart-size":r?(0,u.rem)(n+80):(0,u.rem)(n)}})),k=(0,d.factory)(e=>{let t,a=(0,p.useProps)("DonutChart",v,e),{classNames:r,className:s,style:d,styles:u,unstyled:k,vars:j,data:P,withTooltip:M,tooltipAnimationDuration:Y,tooltipProps:w,pieProps:C,paddingAngle:_,withLabels:I,withLabelsLine:S,size:V,thickness:T,strokeWidth:A,startAngle:L,endAngle:N,tooltipDataSource:H,chartLabel:W,children:F,pieChartProps:E,valueFormatter:z,strokeColor:Z,labelsType:R,attributes:O,cellProps:B,...$}=a,q=(0,m.useMantineTheme)(),U=(0,f.useStyles)({name:"DonutChart",classes:l,props:a,className:s,style:d,classNames:r,styles:u,unstyled:k,attributes:O,vars:j,varsResolver:b}),{resolvedClassNames:G,resolvedStyles:J}=(0,h.useResolvedStylesApi)({classNames:r,styles:u,props:a}),X=P.map(e=>({...e,fill:(0,c.getThemeColor)(e.color,q),stroke:"var(--chart-stroke-color, var(--mantine-color-body))",strokeWidth:A,..."function"==typeof B?B(e):B}));return(0,n.jsx)(i.Box,{size:V,...U("root"),...$,children:(0,n.jsx)(g.ResponsiveContainer,{children:(0,n.jsxs)(y.PieChart,{...E,children:[(0,n.jsx)(x.Pie,{data:X,innerRadius:V/2-T,outerRadius:V/2,dataKey:"value",isAnimationActive:!1,paddingAngle:_,startAngle:L,endAngle:N,label:!!I&&(t=R||"value",({x:e,y:a,cx:r,cy:o,percent:l,value:i,name:s})=>{var d,c;return(0,n.jsx)("text",{x:e,y:a,cx:r,cy:o,textAnchor:e>Number(r)?"start":"end",fill:"var(--chart-labels-color, var(--mantine-color-dimmed))",fontFamily:"var(--mantine-font-family)",fontSize:12,children:(0,n.jsx)("tspan",{x:e,children:(d=Number(i),c=Number(l),"name"===t?s:"percent"===t?`${(100*(c||0)).toFixed(0)}%`:"function"==typeof z?z(d||0):d)})})}),labelLine:!!S&&{stroke:"var(--chart-label-color, var(--mantine-color-dimmed))",strokeWidth:1},...C}),W&&(0,n.jsx)("text",{x:"50%",y:"50%",textAnchor:"middle",dominantBaseline:"middle",...U("label"),children:W}),M&&(0,n.jsx)(D.Tooltip,{animationDuration:Y,isAnimationActive:!1,content:({payload:e})=>(0,n.jsx)(o.ChartTooltip,{payload:P,classNames:G,styles:J,type:"radial",segmentId:"segment"===H?e?.[0]?.name:void 0,valueFormatter:z,attributes:O}),...w}),F]})})})});k.displayName="@mantine/charts/DonutChart",k.classes=l,k.varsResolver=b;let j={type:"code",component:function(){return(0,n.jsx)(k,{data:a})},code:[{code:`
...
`,language:"tsx",fileName:"Demo.tsx"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},P={type:"configurator",component:function(e){return(0,n.jsx)(k,{...e,withLabels:!0,data:a})},code:[{fileName:"Demo.tsx",code:`
import { DonutChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx"},{fileName:"data.ts",code:r,language:"tsx"}],centered:!0,controls:[{type:"boolean",prop:"withLabelsLine",initialValue:!0,libraryValue:"__"},{type:"segmented",prop:"labelsType",initialValue:"value",libraryValue:"__",data:["value","percent","name"]}]},M={type:"configurator",component:function(e){return(0,n.jsx)(k,{...e,data:a,mih:300})},code:[{fileName:"Demo.tsx",code:`
import { DonutChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx"},{fileName:"data.ts",code:r,language:"tsx"}],centered:!0,controls:[{type:"number",prop:"paddingAngle",initialValue:10,min:0,max:30,step:1,libraryValue:"__"}]},w={type:"configurator",component:function(e){return(0,n.jsx)(k,{...e,data:[{name:"USA",value:400,color:e.color},{name:"Other",value:200,color:"gray.6"}]})},code:e=>`
import { DonutChart } from '@mantine/charts';
...
`,centered:!0,controls:[{type:"color",prop:"color",initialValue:"blue",libraryValue:"__"}]};var C=e.i(725695),_=e.i(883364);let I={type:"code",component:function(){return(0,n.jsxs)(C.Group,{gap:50,children:[(0,n.jsxs)("div",{children:[(0,n.jsx)(_.Text,{fz:"xs",mb:"sm",ta:"center",children:"Data only for hovered segment"}),(0,n.jsx)(k,{data:a,tooltipDataSource:"segment",mx:"auto"})]}),(0,n.jsxs)("div",{children:[(0,n.jsx)(_.Text,{fz:"xs",mb:"sm",ta:"center",children:"Data only for all segments"}),(0,n.jsx)(k,{data:a,mx:"auto"})]})]})},code:[{code:`
import { Group, Text } from '@mantine/core';
import { DonutChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},S={type:"configurator",component:function(e){return(0,n.jsx)(k,{...e,data:a})},code:[{fileName:"Demo.tsx",code:`
import { DonutChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx"},{fileName:"data.ts",code:r,language:"tsx"}],centered:!0,controls:[{type:"number",prop:"strokeWidth",initialValue:1,min:0,max:5,step:.1,libraryValue:"__"}]},V={type:"code",component:function(){return(0,n.jsx)(k,{data:a,startAngle:180,endAngle:0})},code:[{code:`
import { DonutChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},T={type:"code",component:function(){return(0,n.jsx)(k,{data:a,chartLabel:"Users by country"})},code:[{code:`
import { DonutChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},A={type:"code",component:function(){return(0,n.jsx)(k,{data:a,withTooltip:!1})},code:[{code:`
import { DonutChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},L={type:"code",component:function(){return(0,n.jsx)("div",{className:"m_3e09cb9d",children:(0,n.jsx)(k,{data:a,strokeColor:"var(--card-bg)"})})},code:[{code:`
import { DonutChart } from '@mantine/charts';
import { data } from './data';
import classes from './Demo.module.css';
...
`,language:"scss",fileName:"Demo.module.css"},{code:r,language:"tsx",fileName:"data.ts"}],centered:!0},N={type:"code",component:function(){return(0,n.jsx)(k,{data:a,withLabelsLine:!0,labelsType:"name",withLabels:!0})},code:[{code:`
import { DonutChart } from '@mantine/charts';
import { data } from './data';
