...
`};var u=(0,t.__exportAll)({usage:()=>c});e.s(["UseSetDemos",0,u],766185)},986470,e=>{"use strict";var t=e.i(648863),n=e.i(37930),r=e.i(823439),o=e.i(658109),s=e.i(725695),a=e.i(245745),l=e.i(391398),i=e.i(266181),c=e.i(191788);let u={type:"code",component:function(){var e;let t,u,d=(e=[["/hooks/use-media-query",4124],["/hooks/use-clipboard",8341],["/hooks/use-fetch",9001]],t=(0,c.useRef)(new Map(e)),u=(0,i.useForceUpdate)(),t.current.set=(...e)=>(Map.prototype.set.apply(t.current,e),u(),t.current),t.current.clear=(...e)=>{Map.prototype.clear.apply(t.current,e),u()},t.current.delete=(...e)=>{let n=Map.prototype.delete.apply(t.current,e);return u(),n},t.current),h=Array.from(d.entries()).map(([e,t])=>(0,l.jsxs)(a.Table.Tr,{children:[(0,l.jsx)(a.Table.Td,{children:e}),(0,l.jsx)(a.Table.Td,{children:t}),(0,l.jsx)(a.Table.Td,{children:(0,l.jsxs)(s.Group,{children:[(0,l.jsx)(o.ActionIcon,{variant:"default",onClick:()=>d.set(e,t+1),fw:500,children:(0,l.jsx)(n.PlusIcon,{size:18})}),(0,l.jsx)(o.ActionIcon,{variant:"default",onClick:()=>d.delete(e),c:"red",children:(0,l.jsx)(r.TrashIcon,{size:18})})]})})]},e));return(0,l.jsxs)(a.Table,{layout:"fixed",children:[(0,l.jsx)(a.Table.Thead,{children:(0,l.jsxs)(a.Table.Tr,{children:[(0,l.jsx)(a.Table.Th,{children:"Page"}),(0,l.jsx)(a.Table.Th,{children:"Views last month"}),(0,l.jsx)(a.Table.Th,{})]})}),(0,l.jsx)(a.Table.Tbody,{children:h})]})},code:`
...
`};var d=(0,t.__exportAll)({usage:()=>u});e.s(["UseMapDemos",0,d],986470)},290516,e=>{"use strict";var t=e.i(648863),n=e.i(191788),r=e.i(935769),o=e.i(883364),s=e.i(841209),a=e.i(391398),l=e.i(609205);let i={type:"code",component:function(){let[e,t]=(0,n.useState)(""),[i,c]=(0,n.useState)([]),[u,d]=(0,n.useState)(!1),h=(0,l.useDebouncedCallback)(async e=>{d(!0),c(await new Promise(t=>{setTimeout(()=>{t(""===e.trim()?[]:[,,,,,].fill(0).map((t,n)=>({id:n,title:`${e} ${n+1}`})))},1e3)})),d(!1)},500);return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(s.TextInput,{value:e,onChange:e=>{t(e.currentTarget.value),h(e.currentTarget.value)},placeholder:"Search...",rightSection:u&&(0,a.jsx)(r.Loader,{size:20})}),i.map(e=>(0,a.jsx)(o.Text,{size:"sm",children:e.title},e.id))]})},code:`
import { useState } from 'react';
