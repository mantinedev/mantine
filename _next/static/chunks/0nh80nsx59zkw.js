...
`};var x=e.i(393353);let P=e=>{let t=(0,s.default)(e).date();return(0,l.jsx)(x.Indicator,{size:6,color:"red",offset:-5,disabled:16!==t,children:(0,l.jsx)("div",{children:t})})},b={type:"code",centered:!0,maxWidth:400,component:function(){return(0,l.jsx)(o.DatePickerInput,{label:"Pick date",placeholder:"Pick date",renderDay:P})},code:`
import dayjs from 'dayjs';
...
`},v={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,m.useState)(null);return(0,l.jsx)(o.DatePickerInput,{hideOutsideDates:!0,label:"Pick date",placeholder:"Pick date",value:e,onChange:t})},code:`
import { useState } from 'react';
import { DatePickerInput } from '@mantine/dates';
...
`},g={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,m.useState)(null);return(0,l.jsx)(o.DatePickerInput,{label:"Pick date",placeholder:"Pick date",value:e,onChange:t,hideWeekdays:!0})},code:`
import { useState } from 'react';
import { DatePickerInput } from '@mantine/dates';
...
`},L={type:"code",centered:!0,maxWidth:400,component:function(){return(0,l.jsx)(o.DatePickerInput,{defaultDate:new Date(2022,1),headerControlsOrder:["level","previous","next"],styles:{calendarHeaderLevel:{justifyContent:"flex-start",paddingInlineStart:8}},label:"Header controls order",placeholder:"Header controls order"})},code:`
import { DatePickerInput } from '@mantine/dates';
