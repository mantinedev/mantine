...
`};var L=e.i(485108),T=e.i(841209);let B={type:"code",component:function(){return(0,r.jsxs)("div",{children:[(0,r.jsxs)(m.Group,{children:[(0,r.jsx)(a.Pagination,{total:45,size:"sm"}),(0,r.jsx)(L.Button,{size:"sm",children:"sm button"}),(0,r.jsx)(T.TextInput,{size:"sm",placeholder:"sm input"})]}),(0,r.jsxs)(m.Group,{mt:"md",children:[(0,r.jsx)(a.Pagination,{total:45,size:"input-sm"}),(0,r.jsx)(L.Button,{size:"sm",children:"sm button"}),(0,r.jsx)(T.TextInput,{size:"sm",placeholder:"sm input"})]})]})},code:`
...
`,component:function(){return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(n.Text,{mb:"xs",children:"Pages 5–15 (startValue=5, total=15)"}),(0,r.jsx)(a.Pagination,{total:15,startValue:5,defaultValue:5})]})}};var E=(0,t.__exportAll)({autoContrast:()=>Y,boundaries:()=>i,composition:()=>p,configurator:()=>o,icons:()=>D,links:()=>M,siblings:()=>l,size:()=>B,startValue:()=>H,stylesApi:()=>u,usage:()=>s,withContent:()=>V,withPages:()=>I});e.s(["PaginationDemos",0,E],806205)},975419,e=>{"use strict";var t=e.i(648863),a=e.i(37541),r=e.i(391398);let o={type:"configurator",component:e=>(0,r.jsx)(a.Checkbox,{...e,defaultChecked:!0}),code:`
...
`,language:"scss"}]},T={type:"code",component:function(){return(0,r.jsx)(a.Checkbox,{defaultChecked:!0,color:"lime.4",iconColor:"dark.8",size:"md",label:"Bright lime checkbox"})},code:`
import { Checkbox } from '@mantine/core';
...
`,centered:!0};var B=e.i(431868);let H={type:"code",component:function(){return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(B.Tooltip,{label:"Checkbox with tooltip",children:(0,r.jsx)(a.Checkbox,{label:"Tooltip on checkbox only"})}),(0,r.jsx)(B.Tooltip,{label:"Checkbox with tooltip",refProp:"rootRef",children:(0,r.jsx)(a.Checkbox,{label:"Tooltip the entire element",mt:"md"})})]})},code:`
...
`,centered:!0};var E=e.i(951254),Z=e.i(530514);let R=`.root {
...
`};var H=e.i(485108),E=e.i(541772);let Z={type:"code",component:function(){let[e,{toggle:t}]=(0,E.useDisclosure)();return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(H.Button,{onClick:t,mb:"md",children:"Toggle dropdown"}),(0,r.jsx)(a.MultiSelect,{label:"Your favorite library",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],dropdownOpened:e})]})},code:`
...
`,maxWidth:340,centered:!0},R={type:"code",component:function(){return(0,r.jsx)(a.MultiSelect,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{position:"top",middlewares:{flip:!1,shift:!1}}})},code:`
import { MultiSelect } from '@mantine/core';
...
`,centered:!0,component:function(){return(0,r.jsxs)(N.Popover,{width:300,position:"bottom",withArrow:!0,shadow:"md",children:[(0,r.jsx)(N.Popover.Target,{children:(0,r.jsx)(H.Button,{children:"Toggle popover"})}),(0,r.jsx)(N.Popover.Dropdown,{children:(0,r.jsx)(a.MultiSelect,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{withinPortal:!1}})})]})}};var G={dropdown:"m_a9824888",input:"m_f5487eb3"};let O={type:"code",component:function(){return(0,r.jsx)(a.MultiSelect,{label:"Your favorite library",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],classNames:G,comboboxProps:{position:"bottom",middlewares:{flip:!1,shift:!1},offset:0}})},code:[{fileName:"Demo.tsx",code:`
import { MultiSelect } from '@mantine/core';
import classes from './Demo.module.css';
...
`,centered:!0,maxWidth:340};var eu=(0,t.__exportAll)({checkIcon:()=>c,clearSectionMode:()=>L,clearable:()=>Y,configurator:()=>d,disabled:()=>u,disabledOptions:()=>m,dragReorder:()=>en,dropdownAnimation:()=>z,dropdownOffset:()=>O,dropdownOpened:()=>Z,dropdownPadding:()=>F,dropdownPosition:()=>R,dropdownShadow:()=>W,dropdownWidth:()=>el,error:()=>p,fuzzySearch:()=>ec,groups:()=>h,hidePickedOptions:()=>i,limit:()=>x,loading:()=>ed,maxValues:()=>l,nothingFound:()=>s,readOnly:()=>v,renderOption:()=>J,renderPill:()=>er,scrollArea:()=>w,search:()=>k,searchable:()=>n,sections:()=>B,sort:()=>M,stylesApi:()=>V,usage:()=>o,withinPopover:()=>_});e.s(["MultiSelectDemos",0,eu],131022)},501345,e=>{"use strict";var t=e.i(648863),a=e.i(485108),r=e.i(981377),o=e.i(391398),n=e.i(556457),l=e.i(541772);let i={type:"code",component:function(){let[e,t]=(0,l.useDisclosure)(!1),{getCollapseProps:i}=(0,n.useCollapse)({expanded:e});return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(a.Button,{onClick:t.toggle,mb:"md",children:e?"Collapse":"Expand"}),(0,o.jsx)("div",{...i(),children:(0,o.jsx)(r.Typography,{bg:"var(--mantine-color-blue-light)",p:"xs",bdrs:"md",children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."})})]})},code:`
...
`};var c=(0,t.__exportAll)({usage:()=>s});e.s(["UseHorizontalCollapseDemos",0,c],281383)},94922,e=>{"use strict";var t=e.i(648863),a=e.i(754067),r=e.i(391398);let o={type:"configurator",component:function(e){return(0,r.jsx)(a.Highlight,{maw:400,mx:"auto",...e})},code:`
...
`,component:function(){return(0,r.jsx)(a.Highlight,{highlight:["this","that"],children:"Highlight this and also that"})}},l={type:"code",code:`
import { Highlight } from '@mantine/core';
...
`,component:function(){return(0,r.jsx)(a.Highlight,{ta:"center",highlight:["highlighted","default"],highlightStyles:{backgroundImage:"linear-gradient(45deg, var(--mantine-color-cyan-5), var(--mantine-color-indigo-5))",fontWeight:700,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"},children:"You can change styles of highlighted part if you do not like default styles"})}},i={type:"code",code:`
import { Highlight } from '@mantine/core';
...
`,centered:!0,component:function(){return(0,r.jsx)(a.Highlight,{component:"a",href:"https://mantine.dev",target:"_blank",highlight:"mantine",fw:500,c:"var(--mantine-color-anchor)",children:"Mantine website"})}},s={type:"code",code:`
import { Highlight } from '@mantine/core';
...
`,component:function(){return(0,r.jsx)(a.Highlight,{highlight:[{text:"error",color:"red"},{text:"warning",color:"yellow"},{text:"success",color:"green"}],children:"Error: Invalid input. Warning: Check this field. Success: All tests passed."})}};var c=e.i(671640),d=e.i(883364);let u={type:"code",code:`
...
`,component:function(){return(0,r.jsxs)(c.Stack,{gap:"md",children:[(0,r.jsxs)("div",{children:[(0,r.jsxs)(d.Text,{size:"sm",fw:500,mb:5,children:["With whole word matching (wholeWord=","{","true","}",")"]}),(0,r.jsx)(a.Highlight,{highlight:"the",wholeWord:!0,children:"The theme is there"})]}),(0,r.jsxs)("div",{children:[(0,r.jsx)(d.Text,{size:"sm",fw:500,mb:5,children:"Without whole word matching (default)"}),(0,r.jsx)(a.Highlight,{highlight:"the",children:"The theme is there"})]})]})}};var m=(0,t.__exportAll)({colors:()=>s,multiple:()=>n,props:()=>i,styles:()=>l,usage:()=>o,wholeword:()=>u});e.s(["HighlightDemos",0,m],94922)},550218,e=>{"use strict";var t=e.i(648863),a=e.i(960831),r=e.i(841209),o=e.i(391398);let n={type:"configurator",component:function(e){return(0,o.jsx)(r.TextInput,{...e,placeholder:"Input placeholder"})},code:`
...
`,language:"tsx"},{fileName:"data.ts",code:r,language:"tsx"}]};var L=(0,t.__exportAll)({autoContrast:()=>C,barColor:()=>M,barGap:()=>S,barHeight:()=>D,customColors:()=>V,getBarProps:()=>Y,labels:()=>w,minBarSize:()=>k,renderBar:()=>I,usage:()=>b,valueFormatter:()=>y});e.s(["BarsListDemos",0,L],695009)},130096,e=>{"use strict";var t=e.i(648863);let a=["Apple","Banana","Cherry","Date","Elderberry","Fig","Grape","Honeydew","Indian Fig","Jackfruit","Kiwi","Lemon","Mango","Nectarine","Orange","Papaya"],r=`export const data = [
  'Apple',
  'Banana',
  'Cherry',
  'Date',
