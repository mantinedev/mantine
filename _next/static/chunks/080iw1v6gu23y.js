...
`,maxWidth:340,centered:!0},$={type:"code",component:function(){return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(m.TextInput,{placeholder:"Success as boolean",label:"Success as boolean",success:!0}),(0,r.jsx)(m.TextInput,{mt:"md",placeholder:"Success as react node",label:"Success as react node",success:"Username is available"})]})},code:`
import { TextInput } from '@mantine/core';
...
`,centered:!0,maxWidth:340};var _=e.i(837048),$=e.i(661426),W=e.i(433506),G=e.i(169972),U=e.i(387136),K=e.i(725695);let q=`
import { useState } from 'react';
import {
  CheckIcon,
  TextAlignCenterIcon,
...
`,J={color:"currentColor",opacity:.6,size:18},Q={left:(0,j.jsx)(G.TextAlignLeftIcon,{...J}),center:(0,j.jsx)($.TextAlignCenterIcon,{...J}),right:(0,j.jsx)(U.TextAlignRightIcon,{...J}),justify:(0,j.jsx)(W.TextAlignJustifyIcon,{...J})},X=({option:e,checked:t})=>(0,j.jsxs)(K.Group,{flex:"1",gap:"xs",children:[Q[e.value],e.label,t&&(0,j.jsx)(_.CheckIcon,{style:{marginInlineStart:"auto"},...J})]}),ee={type:"code",component:function(){let[e,t]=(0,a.useState)(null);return(0,j.jsx)(H,{data:[{value:"left",label:"Left"},{value:"center",label:"Center"},{value:"right",label:"Right"},{value:"justify",label:"Justify"}],value:e,onChange:t,renderOption:X,children:(0,j.jsx)(H.Target,{children:(0,j.jsx)(n.Button,{variant:"default",miw:200,children:e||"Select alignment"})})})},code:q,centered:!0,defaultExpanded:!1},et=`
import { Button, ComboboxPopover } from '@mantine/core';
