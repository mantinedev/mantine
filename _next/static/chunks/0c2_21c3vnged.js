...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},p={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:s,withWeekendDays:!1})},code:[{code:`
import { MonthView } from '@mantine/schedule';
import { events } from './data';
...
`},M={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:s,highlightToday:!1})},code:[{code:`
import { MonthView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},x={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:s,withHeader:!1})},code:[{code:`
import { MonthView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},E={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:i})},code:[{code:`
import { MonthView } from '@mantine/schedule';
import { events } from './data';
...
`};var H=e.i(19683),O=e.i(369974),C=e.i(284629);let V=(0,a.default)().startOf("month"),$=[{id:1,title:"Team Standup",start:V.add(2,"day").hour(9).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:V.add(2,"day").hour(9).minute(30).format("YYYY-MM-DD HH:mm:ss"),color:"blue",payload:{description:"Daily team sync meeting",attendees:["Alice","Bob","Charlie"],location:"Conference Room A"}},{id:2,title:"Design Workshop",start:V.add(5,"day").hour(10).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:V.add(5,"day").hour(12).minute(0).format("YYYY-MM-DD HH:mm:ss"),color:"grape",payload:{description:"Collaborative design thinking session",attendees:["Diana","Eve","Frank"],location:"Creative Space"}},{id:3,title:"Client Presentation",start:V.add(10,"day").hour(14).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:V.add(10,"day").hour(15).minute(30).format("YYYY-MM-DD HH:mm:ss"),color:"green",payload:{description:"Q4 progress presentation to client",attendees:["Grace","Henry"],location:"Zoom"}},{id:4,title:"Sprint Planning",start:V.add(15,"day").hour(10).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:V.add(15,"day").hour(12).minute(0).format("YYYY-MM-DD HH:mm:ss"),color:"orange",payload:{description:"Plan next sprint tasks and priorities",attendees:["Alice","Charlie","Bob"],location:"Dev Lab"}},{id:5,title:"Code Review",start:V.add(18,"day").hour(16).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:V.add(18,"day").hour(17).minute(0).format("YYYY-MM-DD HH:mm:ss"),color:"cyan",payload:{description:"Review pull requests from this week",attendees:["Alice","Charlie"],location:"Dev Lab"}},{id:6,title:"Tech Conference",start:V.add(22,"day").format("YYYY-MM-DD 00:00:00"),end:V.add(22,"day").format("YYYY-MM-DD 23:59:59"),color:"pink",payload:{description:"Annual tech conference",attendees:["All Team"],location:"Convention Center"}}],k={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,y.useState)($);return(0,c.jsx)(u.MonthView,{date:new Date,events:e,withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:n,newEnd:o})=>{t(t=>t.map(t=>t.id===e?{...t,start:(0,a.default)(n).format("YYYY-MM-DD HH:mm:ss"),end:(0,a.default)(o).format("YYYY-MM-DD HH:mm:ss")}:t))},renderEvent:(e,t)=>(0,c.jsxs)(O.HoverCard,{width:280,position:"right",closeDelay:0,transitionProps:{duration:0},children:[(0,c.jsx)(O.HoverCard.Target,{children:(0,c.jsx)(C.UnstyledButton,{...t})}),(0,c.jsx)(O.HoverCard.Dropdown,{children:(0,c.jsx)(H.EventDetails,{event:e})})]})})},code:[{fileName:"Demo.tsx",code:`
import { useState } from 'react';
import dayjs from 'dayjs';
...
`,language:"tsx"},{fileName:"EventDetails.tsx",code:H._eventDetailsCode,language:"tsx"},{fileName:"events.ts",code:`import { ScheduleEventData } from '@mantine/schedule';

export const eventsData: ScheduleEventData[] = ${JSON.stringify($,null,2)};`,language:"tsx"}]},T={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:s,mode:"static"})},code:[{code:`
import { MonthView } from '@mantine/schedule';
import { events } from './data';
...
}`,language:"tsx",fileName:"Demo.tsx"},{code:N._eventFormCode,language:"tsx",fileName:"EventForm.tsx"},{code:l,language:"tsx",fileName:"events.ts"}]};var A=e.i(232471),B=e.i(20035),R=e.i(883364);let W=[{title:"Team Offsite",color:"teal"},{title:"Release Day",color:"orange"},{title:"All Hands",color:"violet"}],F={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,y.useState)([]),n=(0,y.useRef)(1);return(0,c.jsxs)(B.Grid,{children:[(0,c.jsxs)(B.Grid.Col,{span:{base:12,sm:3},children:[(0,c.jsx)(R.Text,{fw:500,mb:"xs",children:"Drag to schedule"}),W.map(e=>(0,c.jsx)(A.Box,{draggable:!0,onDragStart:t=>{t.dataTransfer.setData("text/plain",JSON.stringify(e)),t.dataTransfer.effectAllowed="copy"},style:{padding:"8px 12px",marginBottom:8,borderRadius:4,cursor:"grab",backgroundColor:`var(--mantine-color-${e.color}-light)`,color:`var(--mantine-color-${e.color}-light-color)`},children:(0,c.jsx)(R.Text,{size:"sm",fw:500,children:e.title})},e.title))]}),(0,c.jsx)(B.Grid.Col,{span:{base:12,sm:9},children:(0,c.jsx)(u.MonthView,{date:new Date,events:e,withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))},onExternalEventDrop:(e,o)=>{let r=e.getData("text/plain");if(!r)return;let d=JSON.parse(r),s=(0,a.default)(o),i=s.endOf("day");t(e=>[...e,{id:n.current++,title:d.title,start:s.format("YYYY-MM-DD HH:mm:ss"),end:i.format("YYYY-MM-DD HH:mm:ss"),color:d.color}])}})})]})},code:`
...
`},L=(0,a.default)().format("YYYY-MM-DD"),z=[{id:"company-offsite",title:"Company offsite",start:`${(0,a.default)(L).startOf("week").add(1,"day").format("YYYY-MM-DD")} 00:00:00`,end:`${(0,a.default)(L).startOf("week").add(3,"day").format("YYYY-MM-DD")} 23:59:59`,color:"blue",display:"background"},{id:"team-meeting",title:"Team meeting",start:`${L} 10:00:00`,end:`${L} 11:00:00`,color:"violet"},{id:"code-review",title:"Code review",start:`${(0,a.default)(L).add(1,"day").format("YYYY-MM-DD")} 14:00:00`,end:`${(0,a.default)(L).add(1,"day").format("YYYY-MM-DD")} 15:00:00`,color:"green"}],K={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,y.useState)(z);return(0,c.jsx)(u.MonthView,{date:new Date,events:e,withEventsDragAndDrop:!0,onEventDrop:({eventId:a,newStart:n,newEnd:o})=>{e.some(e=>"background"===e.display&&n<e.end&&o>e.start)||t(e=>e.map(e=>e.id===a?{...e,start:n,end:o}:e))}})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { MonthView, ScheduleEventData } from '@mantine/schedule';
...
`};var Q=e.i(428127);let _={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,y.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,c.jsxs)("div",{children:[(0,c.jsxs)(Q.ScheduleHeader,{children:[(0,c.jsx)(Q.ScheduleHeader.Previous,{onClick:()=>t((0,a.default)(e).subtract(1,"month").startOf("month").format("YYYY-MM-DD"))}),(0,c.jsx)(Q.ScheduleHeader.MonthYearSelect,{yearValue:(0,a.default)(e).year(),monthValue:(0,a.default)(e).month(),onYearChange:n=>t((0,a.default)(e).year(n).startOf("month").format("YYYY-MM-DD")),onMonthChange:n=>t((0,a.default)(e).month(n).startOf("month").format("YYYY-MM-DD"))}),(0,c.jsx)(Q.ScheduleHeader.Next,{onClick:()=>t((0,a.default)(e).add(1,"month").startOf("month").format("YYYY-MM-DD"))}),(0,c.jsx)(Q.ScheduleHeader.Today,{onClick:()=>t((0,a.default)().format("YYYY-MM-DD"))}),(0,c.jsx)(Q.ScheduleHeader.Control,{style:{marginInlineStart:"auto"},onClick:()=>window.print(),children:"Print"})]}),(0,c.jsx)(u.MonthView,{date:e,onDateChange:t,events:s,withHeader:!1})]})},code:[{code:`
import dayjs from 'dayjs';
import { useState } from 'react';
...
`};e.i(27355);let ee={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:s,locale:"es",labels:{day:"Día",week:"Semana",month:"Mes",year:"Año",today:"Hoy",previous:"Anterior",next:"Siguiente",more:"Más",moreLabel:e=>`+${e} m\xe1s`}})},code:[{code:`
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},et={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.MonthView,{date:new Date,events:s,radius:0})},code:[{code:`
import { MonthView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},ea=(0,a.default)().format("YYYY-MM-DD"),en=(0,a.default)().startOf("month").format("YYYY-MM-DD"),eo=[{id:"team-meeting",title:"Team Meeting",start:`${en} 09:00:00`,end:`${en} 10:30:00`,color:"blue"},{id:"client-call",title:"Client Call",start:`${ea} 14:00:00`,end:`${ea} 15:00:00`,color:"green"},{id:"weekly-review-series",title:"Weekly review",start:`${en} 16:00:00`,end:`${en} 17:00:00`,color:"orange",recurrence:{rrule:"FREQ=WEEKLY;COUNT=8"}}],er={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,y.useState)(ea);return(0,c.jsx)(u.MonthView,{date:e,onDateChange:t,events:eo,withAgenda:!0})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { MonthView } from '@mantine/schedule';
...
export const events: ScheduleEventData[] = ${JSON.stringify(es,null,2)};`,language:"tsx"}]};var el=(0,t.__exportAll)({backgroundEvents:()=>K,bidirectionalDragDrop:()=>P,consistentWeeks:()=>g,customHeader:()=>_,dragDrop:()=>b,eventForm:()=>I,externalDragDrop:()=>F,firstDayOfWeek:()=>h,highlightToday:()=>M,localization:()=>ee,manyEvents:()=>E,maxEventsPerDay:()=>X,radius:()=>et,recurringEvents:()=>J,renderEvent:()=>k,staticMode:()=>T,timedEvents:()=>ei,usage:()=>f,weekdayFormat:()=>Y,withAgenda:()=>er,withWeekNumbers:()=>D,withoutHeader:()=>x,withoutOutsideDays:()=>w,withoutWeekDays:()=>v,withoutWeekendDays:()=>p});e.s(["MonthViewDemos",0,el],599466)}]);