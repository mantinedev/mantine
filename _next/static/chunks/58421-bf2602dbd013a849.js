...
`,i=t=>`import { ${t} } from '@mantine/dates';
...
`;function h(t){return{usage:{type:"code",centered:!0,maxWidth:400,code:d(t.displayName.replace("@mantine/dates/","")),component:()=>{let[e,n]=(0,r.useState)(null);return r.createElement(t,{label:"Pick date",placeholder:"Pick date",value:e,onChange:n})}},multiple:{type:"code",centered:!0,maxWidth:400,code:c(t.displayName.replace("@mantine/dates/","")),component:()=>{let[e,n]=(0,r.useState)([]);return r.createElement(t,{type:"multiple",label:"Pick dates",placeholder:"Pick dates",value:e,onChange:n})}},range:{type:"code",centered:!0,maxWidth:400,code:f(t.displayName.replace("@mantine/dates/","")),component:()=>{let[e,n]=(0,r.useState)([null,null]);return r.createElement(t,{type:"range",label:"Pick dates range",placeholder:"Pick dates range",value:e,onChange:n})}},configurator:{type:"configurator",component:t,centered:!0,maxWidth:400,code:i(t.displayName.replace("@mantine/dates/","")),controls:[{prop:"placeholder",type:"string",initialValue:"Pick date",libraryValue:"__"},{prop:"label",type:"string",initialValue:"Pick date",libraryValue:""},{prop:"description",type:"string",initialValue:"",libraryValue:""},{prop:"error",type:"string",initialValue:"",libraryValue:""},{prop:"variant",type:"select",data:[{label:"default",value:"default"},{label:"filled",value:"filled"},{label:"unstyled",value:"unstyled"}],initialValue:"default",libraryValue:"default"},{prop:"radius",type:"size",initialValue:"sm",libraryValue:"sm"},{prop:"size",type:"size",initialValue:"sm",libraryValue:"sm"},{prop:"disabled",type:"boolean",initialValue:!1,libraryValue:!1},{prop:"withAsterisk",type:"boolean",initialValue:!0,libraryValue:!1}]},modal:{type:"code",centered:!0,maxWidth:400,code:l(t.displayName.replace("@mantine/dates/","")),component:()=>{let[e,n]=(0,r.useState)(null);return r.createElement(t,{dropdownType:"modal",label:"Pick date",placeholder:"Pick date",value:e,onChange:n})}},icon:{type:"code",centered:!0,maxWidth:400,code:o(t.displayName.replace("@mantine/dates/","")),component:()=>{let[e,n]=(0,r.useState)(null);return r.createElement(t,{leftSection:r.createElement(s.Z,{style:{width:(0,u.h)(18),height:(0,u.h)(18)},stroke:1.5}),leftSectionPointerEvents:"none",label:"Pick date",placeholder:"Pick date",value:e,onChange:n})}},clearable:{type:"code",centered:!0,maxWidth:400,code:a(t.displayName.replace("@mantine/dates/","")),component:()=>r.createElement(t,{clearable:!0,defaultValue:new Date,label:"Pick date",placeholder:"Pick date"})}}}}}]);