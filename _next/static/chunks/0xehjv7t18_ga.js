...
`,centered:!0,component:function(){return(0,r.jsxs)(a.Popover,{width:260,shadow:"md",position:"bottom-start",offset:0,children:[(0,r.jsx)(a.Popover.ContextMenu,{children:(0,r.jsxs)(H.Paper,{withBorder:!0,p:"xl",radius:"md",style:{userSelect:"none",textAlign:"center"},children:[(0,r.jsx)(n.Text,{fw:500,children:"Right-click anywhere inside this area"}),(0,r.jsx)(n.Text,{c:"dimmed",size:"sm",mt:4,children:"A popover will open at the cursor position"})]})}),(0,r.jsx)(a.Popover.Dropdown,{children:(0,r.jsxs)(k.Stack,{gap:"xs",children:[(0,r.jsxs)(T.Group,{gap:"sm",wrap:"nowrap",children:[(0,r.jsx)(P.Avatar,{radius:"xl",color:"blue",children:"JD"}),(0,r.jsxs)("div",{children:[(0,r.jsx)(n.Text,{size:"sm",fw:500,children:"Jane Doe"}),(0,r.jsx)(n.Text,{size:"xs",c:"dimmed",children:"jane@example.com"})]})]}),(0,r.jsxs)(T.Group,{grow:!0,gap:"xs",children:[(0,r.jsx)(o.Button,{size:"xs",variant:"default",children:"Message"}),(0,r.jsx)(o.Button,{size:"xs",children:"Follow"})]})]})})]})}};var E=(0,t.__exportAll)({arrow:()=>x,clickOutsideEvents:()=>b,contextMenu:()=>L,disabled:()=>v,form:()=>s,hideDetached:()=>V,hover:()=>d,inline:()=>p,offset:()=>g,offsetAxis:()=>f,overlay:()=>C,portalChildren:()=>D,sameWidth:()=>m,usage:()=>i});e.s(["PopoverDemos",0,E],224331)},508780,e=>{"use strict";var t=e.i(648863),o=e.i(391398),a=e.i(577824);let n=`
...
`};var P=e.i(883364),T=e.i(297800),k=e.i(481178),M=e.i(275519),C=e.i(433512),S=e.i(317477),A=e.i(44091),V=e.i(391466);let H=(0,k.createVarsResolver)((e,{background:t,radius:o})=>({inlineCodeHighlight:{"--ch-background":t?(0,S.getThemeColor)(t,e):void 0,"--ch-radius":void 0!==o?(0,C.getRadius)(o):void 0}})),L=(0,M.factory)(e=>{let t=(0,A.useProps)("InlineCodeHighlight",null,e),{classNames:n,className:r,style:i,styles:l,unstyled:s,vars:c,attributes:d,ref:m,...u}=t,p=(0,V.useStyles)({name:"InlineCodeHighlight",classes:T.default,props:t,className:r,style:i,classNames:n,styles:l,unstyled:s,attributes:d,vars:c,varsResolver:H,rootSelector:"inlineCodeHighlight"});return(0,o.jsx)(a.CodeHighlight,{...u,ref:m,...p("inlineCodeHighlight"),__inline:!0})});L.displayName="@mantine/code-highlight/InlineCodeHighlight",L.classes=T.default,L.varsResolver=H;let E={type:"code",component:function(){return(0,o.jsxs)(P.Text,{children:["You can highlight code inline:"," ",(0,o.jsx)(L,{code:'<InlineCodeHighlight code="" language="tsx" />',language:"tsx",withBorder:!0}),". Is that not cool?"]})},code:`
...
`,B={type:"code",component:function(){return(0,o.jsx)(a.CodeHighlight,{code:R,language:"tsx",withLineNumbers:!0})},code:`
import { CodeHighlight } from '@mantine/code-highlight';
...
}`,language:"scss"},{fileName:"data.ts",code:a,language:"tsx"}]},H={type:"code",component:function(){return(0,n.jsx)(v,{data:o,startDate:"2024-02-16",endDate:"2025-02-16",withMonthLabels:!0,splitMonths:!0})},centered:!0,overflow:"hidden",code:[{fileName:"Demo.tsx",code:`
import { Heatmap } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx"},{fileName:"data.ts",code:a,language:"tsx"}]},L={type:"code",component:function(){return(0,n.jsx)(v,{data:o,startDate:"2024-02-16",endDate:"2025-02-16",withMonthLabels:!0,withWeekdayLabels:!0,withLegend:!0})},centered:!0,overflow:"hidden",code:[{fileName:"Demo.tsx",code:`
import { Heatmap } from '@mantine/charts';
import { data } from './data';
...
`},H={type:"code",centered:!0,maxWidth:600,component:function(){let[e,t]=(0,a.useState)(null);return(0,n.jsx)(r.DatePicker,{fullWidth:!0,value:e,onChange:t})},code:`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`};var L=(0,t.__exportAll)({controlProps:()=>m,controlledDate:()=>l,defaultDate:()=>u,defaultLevel:()=>v,deselect:()=>Y,excludeDate:()=>M,firstDayOfWeek:()=>w,fullWidth:()=>H,headerControlsOrder:()=>V,hideOutsideDates:()=>k,hideWeekdays:()=>T,labelFormat:()=>p,listFormat:()=>h,locale:()=>f,maxLevel:()=>x,minMax:()=>b,multiple:()=>Z,numberOfColumns:()=>N,presets:()=>S,presetsRange:()=>A,range:()=>I,renderDay:()=>P,singleRange:()=>F,sizeConfigurator:()=>z,usage:()=>E,weekendDays:()=>y,withWeekNumbers:()=>C});let{usage:E,multiple:Z,deselect:Y,range:I,singleRange:F,numberOfColumns:N,sizeConfigurator:z}=(0,o.getSharedPickerDemos)(r.DatePicker);e.s(["DatePickerDemos",0,L],271706)},896399,e=>{"use strict";var t=e.i(648863),o=e.i(391398),a=e.i(288034);let n={type:"code",centered:!0,maxWidth:400,component:function(){return(0,o.jsx)(a.DateTimePicker,{label:"Pick date and time",placeholder:"Pick date and time"})},code:`
...
`,centered:!0,maxWidth:340},H={type:"code",component:function(){return(0,o.jsx)(a.TimePicker,{label:"Enter time",withDropdown:!0,withSeconds:!0,format:"12h",popoverProps:{width:"target"}})},code:`
import { TimePicker } from '@mantine/dates';
...
`,centered:!0,maxWidth:340},L={type:"code",component:function(){return(0,o.jsx)(a.TimePicker,{label:"Enter time",withSeconds:!0,hoursPlaceholder:"09",minutesPlaceholder:"50",secondsPlaceholder:"11"})},code:`
import { TimePicker } from '@mantine/dates';
...
`,centered:!0,maxWidth:340},E={type:"code",component:function(){return(0,o.jsx)(a.TimePicker,{label:"Enter duration",type:"duration",withSeconds:!0})},code:`
import { TimePicker } from '@mantine/dates';
...
`,centered:!0,maxWidth:340};var Y=(0,t.__exportAll)({amPmLabels:()=>g,clearSectionMode:()=>s,clearable:()=>r,configurator:()=>k,controlledDropdown:()=>w,disabled:()=>c,dropdownPosition:()=>V,dropdownWidth:()=>H,duration:()=>E,format12h:()=>u,minHoursDigits:()=>Z,minMax:()=>p,pasteSplit:()=>T,presets:()=>M,presetsGroups:()=>C,presetsRange:()=>A,readOnly:()=>d,steps:()=>f,usage:()=>n,withDropdown:()=>h,withPlaceholders:()=>L,withSeconds:()=>m});e.s(["TimePickerDemos",0,Y],969233)},635487,e=>{"use strict";var t=e.i(648863),o=e.i(883364),a=e.i(391398),n=e.i(866373);let r={type:"code",component:function(){return(0,a.jsxs)("div",{children:[(0,a.jsxs)(o.Text,{children:["24h format: ",(0,a.jsx)(n.TimeValue,{value:"18:45:34"})]}),(0,a.jsxs)(o.Text,{children:["12h format: ",(0,a.jsx)(n.TimeValue,{value:"18:45:34",format:"12h"})]})]})},code:`
import { Text } from '@mantine/core';
