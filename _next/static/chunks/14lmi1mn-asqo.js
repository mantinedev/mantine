...
`},p=(0,a.default)().subtract((0,a.default)().day(),"day").format("YYYY-MM-DD"),g=(0,a.default)(p).add(1,"day").format("YYYY-MM-DD"),h=(0,a.default)(p).add(2,"day").format("YYYY-MM-DD"),y=[{id:1,title:"Morning Standup",start:`${p} 09:00:00`,end:`${p} 09:30:00`,color:"blue"},{id:2,title:"Team Meeting",start:`${g} 10:00:00`,end:`${g} 11:30:00`,color:"green"},{id:3,title:"Code Review",start:`${h} 14:00:00`,end:`${h} 15:00:00`,color:"violet"}],w={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:y,startTime:"08:00:00",endTime:"18:00:00",firstDayOfWeek:0})},code:[{code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"data.ts"}]},Y={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00",weekdayFormat:"dd"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},k={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00",withWeekendDays:!1})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},S={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00",highlightToday:!0})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},M={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00",withWeekNumber:!1})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},E={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:i,withCurrentTimeIndicator:!0,withCurrentTimeBubble:!0})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},x={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:"2030-06-10",events:i,withCurrentTimeIndicator:!0,forceCurrentTimeIndicator:!0})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},V={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00",withHeader:!1})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},H={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00",weekLabelFormat:"MMMM D, YYYY"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},A={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00",slotLabelFormat:"h A"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},I={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00",slotHeight:80,allDaySlotHeight:60})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},R={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:s,highlightBusinessHours:!0,businessHours:["09:00:00","17:00:00"]})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},B={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:s,highlightBusinessHours:!0,businessHours:{1:["09:00:00","17:00:00"],2:["09:00:00","17:00:00"],3:["09:00:00","17:00:00"],4:["09:00:00","17:00:00"],5:["09:00:00","13:00:00"]},startTime:"07:00:00",endTime:"20:00:00"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},z={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:d,startTime:"08:00:00",endTime:"18:00:00"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`};var L=e.i(441058);let N=(0,a.default)().format("YYYY-MM-DD"),F=(0,a.default)().add(1,"day").format("YYYY-MM-DD"),Z=[{id:1,title:"Morning Standup",start:`${N} 09:00:00`,end:`${N} 09:30:00`,color:"blue"},{id:2,title:"Team Meeting",start:`${F} 11:00:00`,end:`${F} 12:00:00`,color:"green"},{id:3,title:"Code Review",start:`${N} 14:00:00`,end:`${N} 15:00:00`,color:"violet"},{id:4,title:"Company Holiday",start:(0,a.default)((0,L.getStartOfWeek)({date:N,firstDayOfWeek:1})).format("YYYY-MM-DD HH:mm:ss"),end:(0,a.default)((0,L.getStartOfWeek)({date:N,firstDayOfWeek:1})).add(2,"day").format("YYYY-MM-DD HH:mm:ss"),color:"red"},{id:5,title:"Release Day",start:(0,a.default)((0,L.getStartOfWeek)({date:N,firstDayOfWeek:1})).format("YYYY-MM-DD HH:mm:ss"),end:(0,a.default)((0,L.getStartOfWeek)({date:N,firstDayOfWeek:1})).add(2,"day").format("YYYY-MM-DD HH:mm:ss"),color:"orange"}],_={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(Z);return(0,c.jsx)(m.WeekView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))}})},code:`
import { useState } from 'react';
import dayjs from 'dayjs';
...
`},P=(0,a.default)().format("YYYY-MM-DD"),G=(0,a.default)().add(1,"day").format("YYYY-MM-DD"),U=[{id:1,title:"Morning Standup",start:`${P} 09:00:00`,end:`${P} 09:30:00`,color:"blue"},{id:2,title:"Team Meeting",start:`${G} 11:00:00`,end:`${G} 12:00:00`,color:"green"},{id:3,title:"Code Review",start:`${P} 14:00:00`,end:`${P} 15:00:00`,color:"violet"}],J={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(U);return(0,c.jsx)(m.WeekView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventResize:!0,onEventResize:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))}})},code:`
import { useState } from 'react';
import dayjs from 'dayjs';
import { WeekView, ScheduleEventData } from '@mantine/schedule';
...
`};var K=e.i(19683),Q=e.i(369974),q=e.i(284629);let X=(0,a.default)(),ee=X.subtract((X.day()+6)%7,"day"),et=[{id:1,title:"Team Standup",start:ee.add(1,"day").hour(9).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:ee.add(1,"day").hour(9).minute(30).format("YYYY-MM-DD HH:mm:ss"),color:"blue",payload:{description:"Daily team sync meeting",attendees:["Alice","Bob","Charlie"],location:"Conference Room A"}},{id:2,title:"Design Workshop",start:ee.add(2,"day").hour(10).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:ee.add(2,"day").hour(12).minute(0).format("YYYY-MM-DD HH:mm:ss"),color:"grape",payload:{description:"Collaborative design thinking session",attendees:["Diana","Eve","Frank"],location:"Creative Space"}},{id:3,title:"Client Presentation",start:ee.add(3,"day").hour(14).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:ee.add(3,"day").hour(15).minute(30).format("YYYY-MM-DD HH:mm:ss"),color:"green",payload:{description:"Q4 progress presentation to client",attendees:["Grace","Henry"],location:"Zoom"}},{id:4,title:"Sprint Planning",start:ee.add(4,"day").hour(10).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:ee.add(4,"day").hour(12).minute(0).format("YYYY-MM-DD HH:mm:ss"),color:"orange",payload:{description:"Plan next sprint tasks and priorities",attendees:["Alice","Charlie","Bob"],location:"Dev Lab"}},{id:5,title:"All Day Conference",start:ee.add(5,"day").format("YYYY-MM-DD 00:00:00"),end:ee.add(5,"day").format("YYYY-MM-DD 23:59:59"),color:"pink",payload:{description:"Annual tech conference",attendees:["All Team"],location:"Convention Center"}}],ea={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(et);return(0,c.jsx)(m.WeekView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:n,newEnd:r})=>{t(t=>t.map(t=>t.id===e?{...t,start:(0,a.default)(n).format("YYYY-MM-DD HH:mm:ss"),end:(0,a.default)(r).format("YYYY-MM-DD HH:mm:ss")}:t))},renderEvent:(e,t)=>(0,c.jsxs)(Q.HoverCard,{width:280,position:"right",closeDelay:0,transitionProps:{duration:0},children:[(0,c.jsx)(Q.HoverCard.Target,{children:(0,c.jsx)(q.UnstyledButton,{...t})}),(0,c.jsx)(Q.HoverCard.Dropdown,{children:(0,c.jsx)(K.EventDetails,{event:e})})]})})},code:[{fileName:"Demo.tsx",code:`
import { useState } from 'react';
import dayjs from 'dayjs';
...
`,language:"tsx"},{fileName:"EventDetails.tsx",code:K._eventDetailsCode,language:"tsx"},{fileName:"events.ts",code:`import { ScheduleEventData } from '@mantine/schedule';

export const eventsData: ScheduleEventData[] = ${JSON.stringify(et,null,2)};`,language:"tsx"}]},en={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(m.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00",mode:"static"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
}`,language:"tsx",fileName:"Demo.tsx"},{code:er._eventFormCode,language:"tsx",fileName:"EventForm.tsx"},{code:l,language:"tsx",fileName:"events.ts"}]},ei={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(i);return(0,c.jsx)(m.WeekView,{date:new Date,events:e,startScrollTime:"09:00:00",scrollAreaProps:{mah:500},withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))}})},code:[{code:`
import { useState } from 'react';
import { WeekView, ScheduleEventData } from '@mantine/schedule';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]};var ed=e.i(232471),es=e.i(20035),el=e.i(883364);let eu=[{title:"Quick Sync",duration:30,color:"teal"},{title:"Workshop",duration:120,color:"orange"},{title:"One-on-One",duration:60,color:"violet"}],ec={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)([]),n=(0,u.useRef)(1);return(0,c.jsxs)(es.Grid,{children:[(0,c.jsxs)(es.Grid.Col,{span:{base:12,sm:3},children:[(0,c.jsx)(el.Text,{fw:500,mb:"xs",children:"Drag to schedule"}),eu.map(e=>(0,c.jsxs)(ed.Box,{draggable:!0,onDragStart:t=>{t.dataTransfer.setData("text/plain",JSON.stringify(e)),t.dataTransfer.effectAllowed="copy"},style:{padding:"8px 12px",marginBottom:8,borderRadius:4,cursor:"grab",backgroundColor:`var(--mantine-color-${e.color}-light)`,color:`var(--mantine-color-${e.color}-light-color)`},children:[(0,c.jsx)(el.Text,{size:"sm",fw:500,children:e.title}),(0,c.jsxs)(el.Text,{size:"xs",children:[e.duration," min"]})]},e.title))]}),(0,c.jsx)(es.Grid.Col,{span:{base:12,sm:9},children:(0,c.jsx)(m.WeekView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))},onExternalEventDrop:(e,r)=>{let o=e.getData("text/plain");if(!o)return;let i=JSON.parse(o),d=(0,a.default)(r),s=d.add(i.duration,"minutes");t(e=>[...e,{id:n.current++,title:i.title,start:d.format("YYYY-MM-DD HH:mm:ss"),end:s.format("YYYY-MM-DD HH:mm:ss"),color:i.color}])}})})]})},code:`
...
`},ev=(0,a.default)((0,L.getStartOfWeek)({date:new Date,firstDayOfWeek:1})).format("YYYY-MM-DD"),eD=[{id:"weekly-sync-series",title:"Weekly sync (series)",start:`${ev} 10:00:00`,end:`${ev} 11:00:00`,color:"blue",recurrence:{rrule:"FREQ=WEEKLY;BYDAY=MO,WE;COUNT=12",exdate:[`${(0,a.default)(ev).add(2,"day").format("YYYY-MM-DD")} 10:00:00`]}},{id:"weekly-sync-override",title:"Weekly sync (moved this week)",start:`${(0,a.default)(ev).add(2,"day").format("YYYY-MM-DD")} 15:00:00`,end:`${(0,a.default)(ev).add(2,"day").format("YYYY-MM-DD")} 16:00:00`,color:"grape",recurringEventId:"weekly-sync-series",recurrenceId:`${(0,a.default)(ev).add(2,"day").format("YYYY-MM-DD")} 10:00:00`},{id:"one-off-week",title:"One-off interview",start:`${(0,a.default)(ev).add(1,"day").format("YYYY-MM-DD")} 13:00:00`,end:`${(0,a.default)(ev).add(1,"day").format("YYYY-MM-DD")} 14:00:00`,color:"green"}],ep={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(ev);return(0,c.jsx)(m.WeekView,{date:e,onDateChange:t,events:eD,startTime:"08:00:00",endTime:"20:00:00",intervalMinutes:60})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
...
`},eg=(0,a.default)().format("YYYY-MM-DD"),eh=[{id:"lunch-block",title:"Lunch break",start:`${eg} 12:00:00`,end:`${eg} 13:00:00`,color:"gray",display:"background"},{id:"focus-time",title:"Focus time",start:`${eg} 14:00:00`,end:`${eg} 16:00:00`,color:"blue",display:"background"},{id:"team-meeting",title:"Team meeting",start:`${eg} 10:00:00`,end:`${eg} 11:00:00`,color:"violet"},{id:"code-review",title:"Code review",start:`${eg} 14:30:00`,end:`${eg} 15:30:00`,color:"green"}],ey={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(eg);return(0,c.jsx)(m.WeekView,{date:e,onDateChange:t,events:eh,startTime:"08:00:00",endTime:"18:00:00"})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { WeekView } from '@mantine/schedule';
...
`},ew=(0,a.default)((0,L.getStartOfWeek)({date:new Date,firstDayOfWeek:1})),eY=Array.from({length:5},(e,t)=>ew.add(t,"day").format("YYYY-MM-DD")),ek=[...eY.map((e,t)=>({id:`lunch-${t}`,title:"Lunch break",start:`${e} 12:00:00`,end:`${e} 13:00:00`,color:"red",display:"background"})),{id:"team-meeting",title:"Team meeting",start:`${eY[0]} 10:00:00`,end:`${eY[0]} 11:00:00`,color:"violet"},{id:"code-review",title:"Code review",start:`${eY[2]} 15:00:00`,end:`${eY[2]} 16:00:00`,color:"green"}],eS={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(ek);return(0,c.jsx)(m.WeekView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventsDragAndDrop:!0,onEventDrop:({eventId:a,newStart:n,newEnd:r})=>{e.some(e=>"background"===e.display&&n<e.end&&r>e.start)||t(e=>e.map(e=>e.id===a?{...e,start:n,end:r}:e))},styles:{weekViewBackgroundEvent:{background:`repeating-linear-gradient(
            -45deg,
            transparent,
            transparent 10px,
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},eT={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,c.jsx)(m.WeekView,{date:e,onDateChange:t,events:i,startTime:"08:00:00",endTime:"18:00:00",radius:0})},code:[{code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]};var eb=e.i(593612),e$=e.i(554166),eW=e.i(725695);let ej=(0,a.default)().subtract(((0,a.default)().day()+6)%7,"day").format("YYYY-MM-DD"),eC=(0,a.default)(ej).add(1,"day").format("YYYY-MM-DD"),eO=[{id:1,title:"Morning Standup",start:`${ej} 09:00:00`,end:`${ej} 09:30:00`,color:"blue",payload:{location:"Room A"}},{id:2,title:"Client Meeting",start:`${ej} 11:00:00`,end:`${ej} 12:00:00`,color:"green",payload:{location:"Video Call"}},{id:3,title:"Lunch Break",start:`${eC} 12:30:00`,end:`${eC} 13:30:00`,color:"orange",payload:{location:"Cafeteria"}}],eV={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,c.jsx)(m.WeekView,{date:e,onDateChange:t,events:eO,startTime:"08:00:00",endTime:"18:00:00",renderEventBody:e=>(0,c.jsxs)(eW.Group,{children:[(0,c.jsx)(el.Text,{fz:12,fw:500,children:e.title}),(0,c.jsxs)(eW.Group,{gap:4,children:[(0,c.jsx)(eb.ClockIcon,{size:12}),(0,c.jsx)(el.Text,{fz:10,lh:1,children:(0,a.default)(e.start).format("h:mm A")})]}),e.payload?.location&&(0,c.jsxs)(eW.Group,{gap:4,children:[(0,c.jsx)(e$.MapPinIcon,{size:12}),(0,c.jsx)(el.Text,{fz:10,children:e.payload.location})]})]})})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
...
`},eH=(0,a.default)().subtract(((0,a.default)().day()+6)%7,"day").format("YYYY-MM-DD"),eA=(0,a.default)(eH).add(1,"day").format("YYYY-MM-DD"),eI=(0,a.default)(eH).add(2,"day").format("YYYY-MM-DD"),eR=[{id:1,title:"Conference Day",start:`${eH} 00:00:00`,end:(0,a.default)(eH).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"red"},{id:2,title:"Holiday",start:`${eA} 00:00:00`,end:(0,a.default)(eA).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"pink"},{id:3,title:"Team Building",start:`${eH} 00:00:00`,end:(0,a.default)(eI).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"orange"},{id:4,title:"Morning Standup",start:`${eH} 09:00:00`,end:`${eH} 09:30:00`,color:"blue"},{id:5,title:"Code Review",start:`${eA} 14:00:00`,end:`${eA} 15:00:00`,color:"violet"}],eB={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,c.jsx)(m.WeekView,{date:e,onDateChange:t,events:eR,startTime:"08:00:00",endTime:"18:00:00"})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { WeekView, ScheduleEventData } from '@mantine/schedule';
...
`};var eU=e.i(485108);let eJ={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)((0,a.default)().format("YYYY-MM-DD")),n=(0,a.default)(e).subtract(((0,a.default)(e).day()+6)%7,"day");return(0,c.jsxs)("div",{children:[(0,c.jsxs)(eW.Group,{mb:"md",children:[(0,c.jsx)(eU.Button,{onClick:()=>t((0,a.default)(e).subtract(1,"week").format("YYYY-MM-DD HH:mm:ss")),children:"Previous Week"}),(0,c.jsxs)(el.Text,{fw:500,children:[n.format("MMM D")," – ",n.add(6,"day").format("MMM D, YYYY")]}),(0,c.jsx)(eU.Button,{onClick:()=>t((0,a.default)(e).add(1,"week").format("YYYY-MM-DD HH:mm:ss")),children:"Next Week"})]}),(0,c.jsx)(m.WeekView,{date:e,onDateChange:t,events:i,startTime:"08:00:00",endTime:"18:00:00"})]})},code:[{code:`
import { useState } from 'react';
import dayjs from 'dayjs';
import { WeekView } from '@mantine/schedule';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},eK={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)((0,a.default)().format("YYYY-MM-DD")),[n,r]=(0,u.useState)("week");return(0,c.jsxs)("div",{children:[(0,c.jsxs)(el.Text,{mb:"md",children:["Selected view: ",n]}),(0,c.jsx)(m.WeekView,{date:e,onDateChange:t,events:i,startTime:"08:00:00",endTime:"18:00:00",onViewChange:r})]})},code:[{code:`
import { useState } from 'react';
import dayjs from 'dayjs';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]};var eq=(0,t.__exportAll)({allDayEvents:()=>eB,backgroundEvents:()=>ey,backgroundEventsCustomStyle:()=>eS,bidirectionalDragDrop:()=>ef,businessHours:()=>R,businessHoursPerDay:()=>B,canDragEvent:()=>eF,canResizeEvent:()=>eG,controlledDate:()=>eJ,currentTimeIndicator:()=>E,customHeader:()=>eE,dragDrop:()=>_,eventForm:()=>eo,eventResize:()=>J,externalDragDrop:()=>ec,firstDayOfWeek:()=>w,forceCurrentTimeIndicator:()=>x,getTimeSlotProps:()=>eQ,highlightToday:()=>S,intervalMinutes:()=>D,localization:()=>ex,overlappingEvents:()=>z,radius:()=>eT,recurringEvents:()=>ep,renderEvent:()=>ea,renderEventBody:()=>eV,slotHeight:()=>I,slotLabelFormat:()=>A,startScrollTime:()=>ei,staticMode:()=>en,timeRange:()=>v,timezone:()=>C,usage:()=>f,viewChange:()=>eK,weekLabelFormat:()=>H,weekdayFormat:()=>Y,withoutAllDaySlots:()=>O,withoutHeader:()=>V,withoutWeekNumber:()=>M,withoutWeekendDays:()=>k});e.s(["WeekViewDemos",0,eq],953813)}]);