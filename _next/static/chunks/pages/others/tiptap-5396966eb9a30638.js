(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5348],{98685:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/others/tiptap",function(){return n(71502)}])},71502:function(e,t,n){"use strict";n.r(t),n.d(t,{default:function(){return Z}});var o=n(85893),i=n(11151),r=n(19905),l=n(9904),c=n(34589),a=n(67294),s=n(57840),d=n(49947),h=n(86873),p=n(86422);let x=`
...
`;T.$.registerLanguage("ts",C.Z);let R=`// Valid braces Kata \u2013 https://www.codewars.com/kata/5277c8a221e209d3f6000b56
...
export function validBraces(braces: string) {
  ...
  return opened.length === 0;
}`.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),L={type:"code",component:function(){let e=(0,d.jE)({extensions:[h.Z.configure({codeBlock:!1}),f.Z.configure({lowlight:T.$})],content:`<p>Regular paragraph</p><pre><code>${R}</code></pre>`});return a.createElement(s.L,{editor:e},a.createElement(s.L.Toolbar,null,a.createElement(s.L.ControlsGroup,null,a.createElement(s.L.CodeBlock,null))),a.createElement(s.L.Content,null))},code:k};var w=n(7851);let y=`
...
`,B={type:"code",component:function(){let e=(0,d.jE)({extensions:[h.Z,w.r],content:"<p>Enter a new line to see floating menu</p>"});return a.createElement(s.L,{editor:e},e&&a.createElement(d.AH,{editor:e},a.createElement(s.L.ControlsGroup,null,a.createElement(s.L.H1,null),a.createElement(s.L.H2,null),a.createElement(s.L.BulletList,null))),a.createElement(s.L.Content,null))},code:v};var I=n(75410),P=n(48112);let H=`
import { useEditor } from '@tiptap/react';
import StarterKit from '@tiptap/starter-kit';
...
`;function A(){let{editor:e}=(0,I.Y)();return a.createElement(s.L.Control,{onClick:()=>null==e?void 0:e.commands.insertContent("⭐"),"aria-label":"Insert star emoji",title:"Insert star emoji"},a.createElement(P.Z,{stroke:1.5,size:"1rem"}))}let F={type:"code",component:function(){let e=(0,d.jE)({extensions:[h.Z],content:"<p>Click control to insert star emoji</p>"});return a.createElement(s.L,{editor:e},a.createElement(s.L.Toolbar,null,a.createElement(A,null)),a.createElement(s.L.Content,null))},code:H};var U=n(52025),q=n(4014);let D=`
import { useEditor } from '@tiptap/react';
import StarterKit from '@tiptap/starter-kit';
import { RichTextEditor } from '@mantine/tiptap';
