...
export function validBraces(braces: string) {
  ...
  return opened.length === 0;
}`.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),R={type:"code",component:function(){let e=(0,a.jE)({extensions:[s.Z.configure({codeBlock:!1}),g.Z.configure({lowlight:T})],content:`<p>Regular paragraph</p><pre><code>${k}</code></pre>`});return l.createElement(d.L,{editor:e},l.createElement(d.L.Toolbar,null,l.createElement(d.L.ControlsGroup,null,l.createElement(d.L.CodeBlock,null))),l.createElement(d.L.Content,null))},code:C};var L=n(16541);let y=`
...
`,w={type:"code",component:function(){let e=(0,a.jE)({extensions:[s.Z,L.r],content:"<p>Select some text to see bubble menu</p>"});return l.createElement(d.L,{editor:e},e&&l.createElement(a.NM,{editor:e},l.createElement(d.L.ControlsGroup,null,l.createElement(d.L.Bold,null),l.createElement(d.L.Italic,null),l.createElement(d.L.Link,null))),l.createElement(d.L.Content,null))},code:y},S=`
...
`,v={type:"code",component:function(){let e=(0,a.jE)({extensions:[s.Z,L.r],content:"<p>Enter a new line to see floating menu</p>"});return l.createElement(d.L,{editor:e},e&&l.createElement(a.AH,{editor:e},l.createElement(d.L.ControlsGroup,null,l.createElement(d.L.H1,null),l.createElement(d.L.H2,null),l.createElement(d.L.BulletList,null))),l.createElement(d.L.Content,null))},code:S};var B=n(48112),I=n(47986);let P=`
import { useEditor } from '@tiptap/react';
import StarterKit from '@tiptap/starter-kit';
...
`;function H(){let{editor:e}=(0,I.Y)();return l.createElement(d.L.Control,{onClick:()=>e?.commands.insertContent("⭐"),"aria-label":"Insert star emoji",title:"Insert star emoji"},l.createElement(B.Z,{stroke:1.5,size:"1rem"}))}let A={type:"code",component:function(){let e=(0,a.jE)({extensions:[s.Z],content:"<p>Click control to insert star emoji</p>"});return l.createElement(d.L,{editor:e},l.createElement(d.L.Toolbar,null,l.createElement(H,null)),l.createElement(d.L.Content,null))},code:P};var F=n(52025),U=n(4014);let q=`
import { useEditor } from '@tiptap/react';
import StarterKit from '@tiptap/starter-kit';
import { RichTextEditor } from '@mantine/tiptap';
