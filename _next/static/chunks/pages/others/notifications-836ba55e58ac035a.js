...
}`,y={type:"code",code:g,centered:!0,component:function(){return c.createElement(l.z,{variant:"outline",onClick:()=>{Array(10).fill(0).forEach((i,n)=>{setTimeout(()=>{r.N9.show({title:`Notification ${n+1}`,message:"Most notifications are added to queue"})},200*n)})}},"Show 10 notifications")}},w=`
