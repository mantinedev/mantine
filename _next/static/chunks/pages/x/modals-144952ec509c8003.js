(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[49409],{27775:function(e,o,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/x/modals",function(){return n(15171)}])},15171:function(e,o,n){"use strict";n.r(o),n.d(o,{default:function(){return T}});var t=n(52322),l=n(45392),a=n(2784),Text=n(8582),i=n(17115),r=n(2807),d=n(60048);let s=`
...
`,c={type:"code",centered:!0,component:function(){return a.createElement(i.z,{onClick:()=>r.qk.openConfirmModal({modalId:"test-id",title:"Please confirm your action",children:a.createElement(Text.x,{size:"sm"},"This action is so important that you are required to confirm it with a modal. Please click one of these buttons to proceed."),onCancel:()=>d.N9.show({title:"Canceled",message:"Confirm modal was canceled",color:"gray"}),onConfirm:()=>d.N9.show({title:"Confirmed",message:"Confirm modal was confirmed",color:"teal"})})},"Open confirm modal")},code:s},m=`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
...
`,u={type:"code",centered:!0,component:function(){return a.createElement(i.z,{onClick:()=>r.qk.openConfirmModal({title:"Delete your profile",centered:!0,children:a.createElement(Text.x,{size:"sm"},"Are you sure you want to delete your profile? This action is destructive and you will have to contact support to restore your data."),labels:{confirm:"Delete account",cancel:"No don't delete it"},confirmProps:{color:"red"},onCancel:()=>d.N9.show({title:"Canceled",message:"Delete modal was canceled",color:"gray"}),onConfirm:()=>d.N9.show({title:"Deleted",message:"Delete modal was confirmed",color:"red"})}),color:"red"},"Delete account")},code:m},p=`
...
`,h={type:"code",centered:!0,component:function(){return a.createElement(i.z,{onClick:()=>r.qk.openContextModal({modal:"demonstration",title:"Test modal from context",innerProps:{modalBody:"This modal was defined in ModalsProvider, you can open it anywhere in you app with useModals hook"}})},"Open demonstration context modal")},code:p};var f=n(74770);let x=`
...
`,C={type:"code",centered:!0,component:function(){return a.createElement(i.z,{onClick:()=>{r.qk.open({title:"Subscribe to newsletter",children:a.createElement(a.Fragment,null,a.createElement(f.o,{label:"Your email",placeholder:"Your email","data-autofocus":!0}),a.createElement(i.z,{fullWidth:!0,onClick:()=>r.qk.closeAll(),mt:"md"},"Submit"))})}},"Open content modal")},code:x},j=`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
...
`,y={type:"code",centered:!0,component:function(){return a.createElement(i.z,{onClick:()=>r.qk.openConfirmModal({title:"Please confirm your action",closeOnConfirm:!1,labels:{confirm:"Next modal",cancel:"Close modal"},children:a.createElement(Text.x,{size:"sm"},"This action is so important that you are required to confirm it with a modal. Please click one of these buttons to proceed."),onConfirm:()=>r.qk.openConfirmModal({title:"This is modal at second layer",labels:{confirm:"Close modal",cancel:"Back"},closeOnConfirm:!1,children:a.createElement(Text.x,{size:"sm"},"When this modal is closed modals state will revert to first modal"),onConfirm:r.qk.closeAll})})},"Open multiple steps modal")},code:j},M=`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
