(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[771],{90963:(e,t,n)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/x/code-highlight",function(){return n(23067)}])},23067:(e,t,n)=>{"use strict";n.r(t),n.d(t,{default:()=>q});var o=n(31085),i=n(71184),s=n(73868),a=n(30587);let r=`
function Button() {
  return <button>Click me</button>;
}
`,d={type:"code",component:function(){return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(a.q,{code:`// Custom copy label${r}`,language:"tsx",copyLabel:"Copy button code",copiedLabel:"Copied!",radius:"md"}),(0,o.jsx)(a.q,{code:`// Without copy button${r}`,language:"tsx",withCopyButton:!1,mt:"md",radius:"md"})]})},code:`
...
`,g={type:"code",component:function(){return(0,o.jsx)(h.o,{radius:"md",code:[{fileName:"Demo.tsx",code:l,language:"tsx"},{fileName:"Demo.module.css",code:c,language:"scss"}]})},code:[{fileName:"Demo.tsx",code:`
...
`,language:"tsx"}]};var p=n(6464),u=n(54948);let m=`
function Button() {
  return <button>Click me</button>;
}
`,x=`
...
`,f={type:"code",component:function(){return(0,o.jsx)(h.o,{radius:"md",code:[{fileName:"Button.tsx",code:m,language:"tsx",icon:(0,o.jsx)(p.$,{size:14})},{fileName:"Button.module.css",code:x,language:"scss",icon:(0,o.jsx)(u.R,{size:14})}]})},code:`
import { CodeHighlightTabs } from '@mantine/code-highlight';
...
`,k={type:"code",component:function(){return(0,o.jsx)(h.o,{withExpandButton:!0,defaultExpanded:!1,expandCodeLabel:"Show full code",collapseCodeLabel:"Show less",code:[{fileName:"Demo.tsx",code:v,language:"tsx"},{fileName:"Demo.module.css",code:j,language:"scss"}]})},code:[{fileName:"Demo.tsx",code:`
import { CodeHighlightTabs } from '@mantine/code-highlight';
import { tsxCode, cssCode } from './code';
...
export const cssCode = \`${j}\`;
`,language:"tsx"}]};var C=n(73366),b=(0,C.A)("outline","brand-codesandbox","IconBrandCodesandbox",[["path",{d:"M20 7.5v9l-4 2.25l-4 2.25l-4 -2.25l-4 -2.25v-9l4 -2.25l4 -2.25l4 2.25z",key:"svg-0"}],["path",{d:"M12 12l4 -2.25l4 -2.25",key:"svg-1"}],["path",{d:"M12 12l0 9",key:"svg-2"}],["path",{d:"M12 12l-4 -2.25l-4 -2.25",key:"svg-3"}],["path",{d:"M20 12l-4 2v4.75",key:"svg-4"}],["path",{d:"M4 12l4 2l0 4.75",key:"svg-5"}],["path",{d:"M8 5.25l4 2.25l4 -2.25",key:"svg-6"}]]),H=(0,C.A)("outline","message-2","IconMessage2",[["path",{d:"M8 9h8",key:"svg-0"}],["path",{d:"M8 13h6",key:"svg-1"}],["path",{d:"M9 18h-3a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 -3h12a3 3 0 0 1 3 3v8a3 3 0 0 1 -3 3h-3l-3 3l-3 -3z",key:"svg-2"}]]),M=n(88575);let A=`
function greet() {
  return 'Hello, World!';
}
...
`};var T=n(7098),I=n(51606),S=n(33450),N=n(6754),B=n(29686),P=n(69564),D=n(17386);let L={},E=(0,T.V)((e,{background:t,radius:n})=>({inlineCodeHighlight:{"--ch-background":t?(0,I.r)(t,e):void 0,"--ch-radius":void 0!==n?(0,S.nJ)(n):void 0}})),$=(0,N.P9)((e,t)=>{let n=(0,B.Y)("InlineCodeHighlight",L,e),{classNames:i,className:s,style:r,styles:d,unstyled:h,vars:l,...c}=n,g=(0,P.I)({name:"InlineCodeHighlight",classes:D.A,props:n,className:s,style:r,classNames:i,styles:d,unstyled:h,vars:l,varsResolver:E,rootSelector:"inlineCodeHighlight"});return(0,o.jsx)(a.q,{...c,ref:t,...g("inlineCodeHighlight"),__inline:!0})});$.displayName="@mantine/code-highlight/InlineCodeHighlight",$.classes=D.A;var z=n(93065);let _={type:"code",component:function(){return(0,o.jsxs)(z.E,{children:["You can highlight code inline:"," ",(0,o.jsx)($,{code:'<InlineCodeHighlight code="" language="tsx" />',language:"tsx",withBorder:!0}),". Is that not cool?"]})},code:`
...
`;function h(e){return e.endsWith(".ts")||e.endsWith(".tsx")?(0,o.jsx)(s.$,{size:14}):e.endsWith(".css")?(0,o.jsx)(a.R,{size:14}):null}let l={type:"code",component:function(){return(0,o.jsx)(i.o,{getFileIcon:h,radius:"md",code:[{fileName:"Button.tsx",code:r,language:"tsx"},{fileName:"Button.module.css",code:d,language:"scss"}]})},code:`
import { CodeHighlightTabs } from '@mantine/code-highlight';
import { TypeScriptIcon, CssIcon } from '@mantinex/dev-icons';
...
`}},73868:(e,t,n)=>{"use strict";n.d(t,{C:()=>a});var o=n(31085),i=n(30587);let s=`
...
`}}},e=>{var t=t=>e(e.s=t);e.O(0,[18675,90636,46593,38792],()=>t(90963)),_N_E=e.O()}]);