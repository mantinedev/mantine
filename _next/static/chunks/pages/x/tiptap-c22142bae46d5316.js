...
`};var m=o(93911),j=o(43448);let T=(0,o(25502).$)(),b=`
import { RichTextEditor } from '@mantine/tiptap';
import { useEditor } from '@tiptap/react';
import StarterKit from '@tiptap/starter-kit';
...
`}},14631:(t,e,o)=>{"use strict";o.d(e,{N:()=>i});let i=o(35864).Ay.extend({addKeyboardShortcuts:()=>({"Mod-k":()=>(window.dispatchEvent(new Event("edit-link")),!0)})}).configure({openOnClick:!1})}},t=>{var e=e=>t(t.s=e);t.O(0,[90401,59573,16576,8084,87522,24920,18675,32200,90636,46593,38792],()=>e(70951)),_N_E=t.O()}]);