(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[58267],{74179:function(t,e,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/x/tiptap",function(){return n(34972)}])},34972:function(t,e,n){"use strict";n.r(e),n.d(e,{default:function(){return z}});var o=n(52322),i=n(45392),r=n(53348),l=n(2784),c=n(37585),a=n(13635),s=n(31981),d=n(76124);let p=`
...
export function validBraces(braces: string) {
  ...
  return opened.length === 0;
}`.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),C={type:"code",component:function(){let t=(0,a.jE)({extensions:[s.Z.configure({codeBlock:!1}),b.Z.configure({lowlight:k})],content:`<p>Regular paragraph</p><pre><code>${R}</code></pre>`});return l.createElement(d.L,{editor:t},l.createElement(d.L.Toolbar,null,l.createElement(d.L.ControlsGroup,null,l.createElement(d.L.CodeBlock,null))),l.createElement(d.L.Content,null))},code:j};var L=n(66556),y=n(67778);let w=`
