(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[45811],{32548:function(i,n,o){(window.__NEXT_P=window.__NEXT_P||[]).push(["/x/notifications",function(){return o(15393)}])},15393:function(i,n,o){"use strict";o.r(n),o.d(n,{default:function(){return b}});var e=o(52322),t=o(45392),s=o(17115),c=o(60048);let a={type:"code",code:`
...
}`,centered:!0,component:function(){return(0,e.jsx)(s.z,{onClick:()=>c.N9.show({title:"Default notification",message:"Hey there, your code is awesome! \uD83E\uDD25"}),children:"Show notification"})}};var l=o(27445),r=o(93010),d={root:"m_45c99571",description:"m_436b008d",title:"m_73829fa9",closeButton:"m_979213db"};let u={type:"code",centered:!0,component:function(){return(0,e.jsxs)(r.Z,{justify:"center",children:[(0,e.jsx)(s.z,{onClick:()=>c.N9.show({title:"Notification with custom styles",message:"It is default blue",classNames:d}),children:"Default notification"}),(0,e.jsx)(s.z,{color:"red",onClick:()=>c.N9.show({color:"red",title:"Notification with custom styles",message:"It is red",classNames:d}),children:"Error notification"})]})},code:[{fileName:"Demo.tsx",code:`
...
`,language:"scss"}]},h={type:"code",code:`
import { Button } from '@mantine/core';
import { notifications } from '@mantine/notifications';
...
}`,centered:!0,component:function(){return(0,e.jsx)(s.z,{onClick:()=>{Array(10).fill(0).forEach((i,n)=>{setTimeout(()=>{c.N9.show({title:`Notification ${n+1}`,message:"Most notifications are added to queue"})},200*n)})},children:"Show 10 notifications"})}},f={type:"code",code:`
...
}`,component:function(){return(0,e.jsxs)(r.Z,{justify:"center",children:[(0,e.jsx)(s.z,{onClick:()=>{Array(10).fill(0).forEach((i,n)=>{c.N9.show({title:`Notification ${n+1}`,message:"Most notifications are added to queue",autoClose:!1})})},children:"Show 10 notifications"}),(0,e.jsx)(s.z,{color:"gray",onClick:()=>c.N9.cleanQueue(),children:"Clean queue"}),(0,e.jsx)(s.z,{color:"red",onClick:()=>c.N9.clean(),children:"Clean all"})]})}};var m=o(9705),p=o(58898);let x={type:"code",code:`
