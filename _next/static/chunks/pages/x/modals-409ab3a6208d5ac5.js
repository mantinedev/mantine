(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[49409],{71420:function(e,o,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/x/modals",function(){return n(94951)}])},94951:function(e,o,n){"use strict";n.r(o),n.d(o,{default:function(){return T}});var t=n(24246),l=n(71670),i=n(27378),Text=n(26569),a=n(8671),d=n(41788),r=n(59269);let s=`
...
`,c={type:"code",centered:!0,component:function(){return i.createElement(a.z,{onClick:()=>d.qk.openConfirmModal({modalId:"test-id",title:"Please confirm your action",children:i.createElement(Text.x,{size:"sm"},"This action is so important that you are required to confirm it with a modal. Please click one of these buttons to proceed."),onCancel:()=>r.N9.show({title:"Canceled",message:"Confirm modal was canceled",color:"gray"}),onConfirm:()=>r.N9.show({title:"Confirmed",message:"Confirm modal was confirmed",color:"teal"})})},"Open confirm modal")},code:s},m=`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
...
`,p={type:"code",centered:!0,component:function(){return i.createElement(a.z,{onClick:()=>d.qk.openConfirmModal({title:"Delete your profile",centered:!0,children:i.createElement(Text.x,{size:"sm"},"Are you sure you want to delete your profile? This action is destructive and you will have to contact support to restore your data."),labels:{confirm:"Delete account",cancel:"No don't delete it"},confirmProps:{color:"red"},onCancel:()=>r.N9.show({title:"Canceled",message:"Delete modal was canceled",color:"gray"}),onConfirm:()=>r.N9.show({title:"Deleted",message:"Delete modal was confirmed",color:"red"})}),color:"red"},"Delete account")},code:m},u=`
...
`,h={type:"code",centered:!0,component:function(){return i.createElement(a.z,{onClick:()=>d.qk.openContextModal({modal:"demonstration",title:"Test modal from context",innerProps:{modalBody:"This modal was defined in ModalsProvider, you can open it anywhere in you app with useModals hook"}})},"Open demonstration context modal")},code:u};var f=n(7033);let x=`
...
`,C={type:"code",centered:!0,component:function(){return i.createElement(a.z,{onClick:()=>{d.qk.open({title:"Subscribe to newsletter",children:i.createElement(i.Fragment,null,i.createElement(f.o,{label:"Your email",placeholder:"Your email","data-autofocus":!0}),i.createElement(a.z,{fullWidth:!0,onClick:()=>d.qk.closeAll(),mt:"md"},"Submit"))})}},"Open content modal")},code:x},j=`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
...
`,y={type:"code",centered:!0,component:function(){return i.createElement(a.z,{onClick:()=>d.qk.openConfirmModal({title:"Please confirm your action",closeOnConfirm:!1,labels:{confirm:"Next modal",cancel:"Close modal"},children:i.createElement(Text.x,{size:"sm"},"This action is so important that you are required to confirm it with a modal. Please click one of these buttons to proceed."),onConfirm:()=>d.qk.openConfirmModal({title:"This is modal at second layer",labels:{confirm:"Close modal",cancel:"Back"},closeOnConfirm:!1,children:i.createElement(Text.x,{size:"sm"},"When this modal is closed modals state will revert to first modal"),onConfirm:d.qk.closeAll})})},"Open multiple steps modal")},code:j},M=`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
