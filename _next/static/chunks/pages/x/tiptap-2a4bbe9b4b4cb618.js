(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[58267],{29604:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/x/tiptap",function(){return n(5008)}])},5008:function(e,t,n){"use strict";n.r(t),n.d(t,{default:function(){return O}});var o=n(24246),i=n(71670),r=n(53456),l=n(27378),c=n(86422),a=n(49947),s=n(47955),d=n(78053);let h=`
...
`,p={type:"code",component:function(){let e=(0,a.jE)({extensions:[s.Z,c.Z.configure({placeholder:"This is placeholder"})],content:""});return l.createElement(d.L,{editor:e},l.createElement(d.L.Content,null))},code:h};var x=n(40903),u=n(71493),m=n(51655);let E=`
import { useEditor } from '@tiptap/react';
...
`;T.register("ts",j.Z);let k=`// Valid braces Kata \u2013 https://www.codewars.com/kata/5277c8a221e209d3f6000b56
...
export function validBraces(braces: string) {
  ...
  return opened.length === 0;
}`.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),R={type:"code",component:function(){let e=(0,a.jE)({extensions:[s.Z.configure({codeBlock:!1}),g.Z.configure({lowlight:T})],content:`<p>Regular paragraph</p><pre><code>${k}</code></pre>`});return l.createElement(d.L,{editor:e},l.createElement(d.L.Toolbar,null,l.createElement(d.L.ControlsGroup,null,l.createElement(d.L.CodeBlock,null))),l.createElement(d.L.Content,null))},code:C};var L=n(16541);let w=`
...
`,y={type:"code",component:function(){let e=(0,a.jE)({extensions:[s.Z,L.r],content:"<p>Select some text to see bubble menu</p>"});return l.createElement(d.L,{editor:e},e&&l.createElement(a.NM,{editor:e},l.createElement(d.L.ControlsGroup,null,l.createElement(d.L.Bold,null),l.createElement(d.L.Italic,null),l.createElement(d.L.Link,null))),l.createElement(d.L.Content,null))},code:w},v=`
...
`,S={type:"code",component:function(){let e=(0,a.jE)({extensions:[s.Z,L.r],content:"<p>Enter a new line to see floating menu</p>"});return l.createElement(d.L,{editor:e},e&&l.createElement(a.AH,{editor:e},l.createElement(d.L.ControlsGroup,null,l.createElement(d.L.H1,null),l.createElement(d.L.H2,null),l.createElement(d.L.BulletList,null))),l.createElement(d.L.Content,null))},code:v};var B=n(48112),I=n(47986);let P=`
import { useEditor } from '@tiptap/react';
import StarterKit from '@tiptap/starter-kit';
...
`;function H(){let{editor:e}=(0,I.Y)();return l.createElement(d.L.Control,{onClick:()=>e?.commands.insertContent("⭐"),"aria-label":"Insert star emoji",title:"Insert star emoji"},l.createElement(B.Z,{stroke:1.5,size:"1rem"}))}let A={type:"code",component:function(){let e=(0,a.jE)({extensions:[s.Z],content:"<p>Click control to insert star emoji</p>"});return l.createElement(d.L,{editor:e},l.createElement(d.L.Toolbar,null,l.createElement(H,null)),l.createElement(d.L.Content,null))},code:P};var U=n(52025),F=n(4014);let q=`
import { useEditor } from '@tiptap/react';
import StarterKit from '@tiptap/starter-kit';
import { RichTextEditor } from '@mantine/tiptap';
