(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[11988],{45813:function(e,n,o){(window.__NEXT_P=window.__NEXT_P||[]).push(["/x/dropzone",function(){return o(32513)}])},32513:function(e,n,o){"use strict";o.r(n),o.d(n,{default:function(){return ej}});var r=o(52322),t=o(45392);let i={png:"image/png",gif:"image/gif",jpeg:"image/jpeg",svg:"image/svg+xml",webp:"image/webp",avif:"image/avif",heic:"image/heic",mp4:"video/mp4",zip:"application/zip",csv:"text/csv",pdf:"application/pdf",doc:"application/msword",docx:"application/vnd.openxmlformats-officedocument.wordprocessingml.document",xls:"application/vnd.ms-excel",xlsx:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",ppt:"application/vnd.ms-powerpoint",pptx:"application/vnd.openxmlformats-officedocument.presentationml.presentation",exe:"application/vnd.microsoft.portable-executable"},c=[i.png,i.gif,i.jpeg,i.svg,i.webp,i.avif,i.heic],s=[i.pdf],l=[i.doc,i.docx],a=[i.xls,i.xlsx],d=[i.ppt,i.pptx];i.exe;var p=o(58752),m=o(5858),u=o(82408),h=o(93010),f=o(58898),Text=o(8582),x=o(4096),j=o(11200),g=o(91482),v=o(82027),z=o(38483),y=o(46690),D=o(28559),b=o(20992),E=o(70837),w=o(89106);let[k,I]=(0,w.R)("Dropzone component was not found in tree");var _=o(2784),M=o(98399),S=o(75751);function T(e){let n=n=>{let{children:o,...t}=(0,z.w)(`Dropzone${(0,S.j)(e)}`,{},n),i=I(),c=(0,M.k)(o)?o:(0,r.jsx)("span",{children:o});return i[e]?(0,_.cloneElement)(c,t):null};return n.displayName=`@mantine/dropzone/${(0,S.j)(e)}`,n}let R=T("accept"),P=T("reject"),A=T("idle");var G={root:"m_d46a4834",inner:"m_b85f7144",fullScreen:"m_96f6e9ad",dropzone:"m_7946116d"};let N={loading:!1,multiple:!0,maxSize:1/0,autoFocus:!1,activateOnClick:!0,activateOnDrag:!0,dragEventsBubbling:!0,activateOnKeyboard:!0,useFsAccessApi:!0,variant:"light",rejectColor:"red"},O=(0,j.Z)((e,{radius:n,variant:o,acceptColor:r,rejectColor:t})=>{let i=e.variantColorResolver({color:r||e.primaryColor,theme:e,variant:o}),c=e.variantColorResolver({color:t||"red",theme:e,variant:o});return{root:{"--dropzone-radius":(0,g.H5)(n),"--dropzone-accept-color":i.color,"--dropzone-accept-bg":i.background,"--dropzone-reject-color":c.color,"--dropzone-reject-bg":c.background}}}),C=(0,v.d)((e,n)=>{let o=(0,z.w)("Dropzone",N,e),{classNames:t,className:i,style:c,styles:s,unstyled:l,vars:a,radius:d,disabled:p,loading:m,multiple:u,maxSize:h,accept:f,children:j,onDropAny:g,onDrop:v,onReject:w,openRef:I,name:_,maxFiles:M,autoFocus:S,activateOnClick:T,activateOnDrag:R,dragEventsBubbling:P,activateOnKeyboard:A,onDragEnter:C,onDragLeave:L,onDragOver:Y,onFileDialogCancel:F,onFileDialogOpen:U,preventDropOnDocument:B,useFsAccessApi:Z,getFilesFromEvent:X,validator:H,rejectColor:W,acceptColor:q,enablePointerEvents:K,loaderProps:$,inputProps:V,mod:J,...Q}=o,ee=(0,y.y)({name:"Dropzone",classes:G,props:o,className:i,style:c,classNames:t,styles:s,unstyled:l,vars:a,varsResolver:O}),{getRootProps:en,getInputProps:eo,isDragAccept:er,isDragReject:et,open:ei}=(0,x.uI)({onDrop:g,onDropAccepted:v,onDropRejected:w,disabled:p||m,accept:Array.isArray(f)?f.reduce((e,n)=>({...e,[n]:[]}),{}):f,multiple:u,maxSize:h,maxFiles:M,autoFocus:S,noClick:!T,noDrag:!R,noDragEventsBubbling:!P,noKeyboard:!A,onDragEnter:C,onDragLeave:L,onDragOver:Y,onFileDialogCancel:F,onFileDialogOpen:U,preventDropOnDocument:B,useFsAccessApi:Z,validator:H,...X?{getFilesFromEvent:X}:null});(0,E.kR)(I,ei);let ec=!er&&!et;return(0,r.jsx)(k,{value:{accept:er,reject:et,idle:ec},children:(0,r.jsxs)(D.x,{...en(),...ee("root",{focusable:!0}),...Q,mod:[{accept:er,reject:et,idle:ec,loading:m,"activate-on-click":T},J],children:[(0,r.jsx)(b.f,{visible:m,overlayProps:{radius:d},unstyled:l,loaderProps:$}),(0,r.jsx)("input",{...eo(V),name:_}),(0,r.jsx)("div",{...ee("inner"),ref:n,"data-enable-pointer-events":K||void 0,children:j})]})})});C.classes=G,C.displayName="@mantine/dropzone/Dropzone",C.Accept=R,C.Idle=A,C.Reject=P;var L=o(97263),Y=o(51477),F=o(71517),U=o(3900);let B={loading:!1,maxSize:1/0,activateOnClick:!1,activateOnDrag:!0,dragEventsBubbling:!0,activateOnKeyboard:!0,active:!0,zIndex:(0,L.w)("max"),withinPortal:!0},Z=(0,v.d)((e,n)=>{let o=(0,z.w)("DropzoneFullScreen",B,e),{classNames:t,className:i,style:c,styles:s,unstyled:l,vars:a,active:d,onDrop:p,onReject:m,zIndex:u,withinPortal:h,portalProps:f,...x}=o,j=(0,y.y)({name:"DropzoneFullScreen",classes:G,props:o,className:i,style:c,classNames:t,styles:s,unstyled:l,rootSelector:"fullScreen"}),{resolvedClassNames:g,resolvedStyles:v}=(0,Y.h)({classNames:t,styles:s,props:o}),[b,E]=(0,_.useState)(0),[w,{open:k,close:I}]=(0,U.q)(!1),M=e=>{e.dataTransfer?.types.includes("Files")&&(E(e=>e+1),k())},S=()=>{E(e=>e-1)};return(0,_.useEffect)(()=>{0===b&&I()},[b]),(0,_.useEffect)(()=>{if(d)return document.addEventListener("dragenter",M,!1),document.addEventListener("dragleave",S,!1),()=>{document.removeEventListener("dragenter",M,!1),document.removeEventListener("dragleave",S,!1)}},[d]),(0,r.jsx)(F.q,{...f,withinPortal:h,children:(0,r.jsx)(D.x,{...j("fullScreen",{style:{opacity:w?1:0,pointerEvents:w?"all":"none",zIndex:u}}),ref:n,children:(0,r.jsx)(C,{...x,classNames:g,styles:v,unstyled:l,className:G.dropzone,onDrop:e=>{p?.(e),I(),E(0)},onReject:e=>{m?.(e),I(),E(0)}})})})});function X(){return(0,r.jsxs)(h.Z,{justify:"center",gap:"xl",mih:220,style:{pointerEvents:"none"},children:[(0,r.jsx)(C.Accept,{children:(0,r.jsx)(p.Z,{style:{width:(0,f.h)(52),height:(0,f.h)(52),color:"var(--mantine-color-blue-6)"},stroke:1.5})}),(0,r.jsx)(C.Reject,{children:(0,r.jsx)(m.Z,{style:{width:(0,f.h)(52),height:(0,f.h)(52),color:"var(--mantine-color-red-6)"},stroke:1.5})}),(0,r.jsx)(C.Idle,{children:(0,r.jsx)(u.Z,{style:{width:(0,f.h)(52),height:(0,f.h)(52),color:"var(--mantine-color-dimmed)"},stroke:1.5})}),(0,r.jsxs)("div",{children:[(0,r.jsx)(Text.x,{size:"xl",inline:!0,children:"Drag images here or click to select files"}),(0,r.jsx)(Text.x,{size:"sm",c:"dimmed",inline:!0,mt:7,children:"Attach as many files as you like, each file should not exceed 5mb"})]})]})}function H(e){return(0,r.jsx)(C,{onDrop:e=>console.log("accepted files",e),onReject:e=>console.log("rejected files",e),maxSize:5242880,accept:c,...e,children:(0,r.jsx)(X,{})})}Z.classes=G,Z.displayName="@mantine/dropzone/DropzoneFullScreen",C.FullScreen=Z;let W=`
...
`,$={type:"code",component:function(){return(0,r.jsx)(H,{loading:!0})},code:K},V=`
.disabled {
...
`,Q={type:"code",component:function(){return(0,r.jsx)(H,{disabled:!0,className:"m_f79e9eba"})},code:[{fileName:"Demo.tsx",code:J,language:"tsx"},{fileName:"Demo.module.css",code:V,language:"scss"}]};var ee=o(17115);let en=`
...
`,eo={type:"code",component:function(){let e=(0,_.useRef)(null);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(H,{openRef:e}),(0,r.jsx)(h.Z,{justify:"center",mt:"md",children:(0,r.jsx)(ee.z,{onClick:()=>e.current?.(),children:"Select files"})})]})},code:en},er=`
import { useRef } from 'react';
import { Button, Group } from '@mantine/core';
import { Dropzone } from '@mantine/dropzone';
...
`,et={type:"code",component:function(){let e=(0,_.useRef)(null);return(0,r.jsx)(C,{openRef:e,onDrop:()=>{},activateOnClick:!1,children:(0,r.jsx)(h.Z,{justify:"center",children:(0,r.jsx)(ee.z,{onClick:()=>e.current?.(),style:{pointerEvents:"all"},children:"Select files"})})})},code:er},ei=`
.root {
  min-height: 120px;
  display: flex;
...
`,es={type:"code",component:function(){return(0,r.jsx)(C,{onDrop:()=>{},accept:c,className:"m_ad28dbef",children:(0,r.jsx)(Text.x,{ta:"center",children:"Drop images here"})})},code:[{fileName:"Demo.tsx",code:ec,language:"tsx"},{fileName:"Demo.module.css",code:ei,language:"scss"}]};var Image=o(43076),el=o(26802);let ea=`
...
`,ed={type:"code",component:function(){let[e,n]=(0,_.useState)([]),o=e.map((e,n)=>{let o=URL.createObjectURL(e);return(0,r.jsx)(Image.E,{src:o,onLoad:()=>URL.revokeObjectURL(o)},n)});return(0,r.jsxs)("div",{children:[(0,r.jsx)(C,{accept:c,onDrop:n,children:(0,r.jsx)(Text.x,{ta:"center",children:"Drop images here"})}),(0,r.jsx)(el.M,{cols:{base:1,sm:4},mt:o.length>0?"xl":0,children:o})]})},code:ea},ep=`
import { useState } from 'react';
