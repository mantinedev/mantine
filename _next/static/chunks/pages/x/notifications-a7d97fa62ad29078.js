(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[45811],{21287:function(i,e,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/x/notifications",function(){return n(53459)}])},53459:function(i,e,n){"use strict";n.r(e),n.d(e,{default:function(){return I}});var o=n(24246),t=n(71670),s=n(27378),c=n(8671),a=n(59269);let l=`
...
}`,r={type:"code",code:l,centered:!0,component:function(){return s.createElement(c.z,{onClick:()=>a.N9.show({title:"Default notification",message:"Hey there, your code is awesome! \uD83E\uDD25"})},"Show notification")}};var d=n(29367),u=n(22971),f={root:"m-45c99571",description:"m-436b008d",title:"m-73829fa9",closeButton:"m-979213db"};let h=`
...
}`,w={type:"code",code:g,component:function(){return s.createElement(u.Z,{justify:"center"},s.createElement(c.z,{onClick:()=>{Array(10).fill(0).forEach((i,e)=>{a.N9.show({title:`Notification ${e+1}`,message:"Most notifications are added to queue",autoClose:!1})})}},"Show 10 notifications"),s.createElement(c.z,{color:"gray",onClick:()=>a.N9.cleanQueue()},"Clean queue"),s.createElement(c.z,{color:"red",onClick:()=>a.N9.clean()},"Clean all"))}};var y=n(16659),N=n(71078);let b=`
