...
`,B={type:"code",component:function(){return l.createElement(l.Fragment,null,l.createElement(E,{code:`// Custom copy label${w}`,language:"tsx",copyLabel:"Copy button code",copiedLabel:"Copied!"}),l.createElement(E,{code:`// Without copy button${w}`,language:"tsx",withCopyButton:!1,mt:"md"}))},code:N};var k=n(61209);let T=`
...
`,S={type:"code",component:function(){return l.createElement(k.Q,{code:[{fileName:"Demo.tsx",code:T,language:"tsx"},{fileName:"Demo.module.css",code:I,language:"scss"}]})},code:L};var M=n(8858),P=n(96850);let D=`
function Button() {
  return <button>Click me</button>;
}
`,V=`
...
`,z={type:"code",component:function(){return l.createElement(k.Q,{code:[{fileName:"Button.tsx",code:D,language:"tsx",icon:l.createElement(M.K,{size:18})},{fileName:"Button.module.css",code:V,language:"scss",icon:l.createElement(P.L,{size:18})}]})},code:_};var F=n(110);let $=`
import { Group, Button, MantineProvider, createTheme } from '@mantine/core';
import classes from './Demo.module.css';
...
`,A={type:"code",component:function(){return l.createElement(k.Q,{withExpandButton:!0,defaultExpanded:!1,expandCodeLabel:"Show full code",collapseCodeLabel:"Show less",code:[{fileName:"Demo.tsx",code:$,language:"tsx"},{fileName:"Demo.module.css",code:W,language:"scss"}]})},code:Z};var G=n(37127),Text=n(26569);let Q=`
