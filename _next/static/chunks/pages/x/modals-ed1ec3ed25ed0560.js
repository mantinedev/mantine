...
`};var x=n(92123);let y={type:"code",centered:!0,component:function(){return(0,t.jsx)(a.$,{onClick:()=>{let e=s.jQ.openContextModal({modalKey:"asyncDemonstration",title:"Processing...",closeOnEscape:!1,closeOnClickOutside:!1,closeButtonProps:{disabled:!0},innerProps:{modalBody:"You cannot close this modal until 2 seconds have passed.",loading:!0}});setTimeout(()=>{s.jQ.updateContextModal({modalKey:"asyncDemonstration",modalId:e,title:"Processing Complete!",closeOnEscape:!0,closeOnClickOutside:!0,closeButtonProps:{disabled:!1},innerProps:{modalBody:"You can now close the modal.",loading:!1}})},2e3)},children:"Open updating context modal"})},code:`
