(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[40021],{88271:(o,e,n)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/x/modals",function(){return n(59244)}])},59244:(o,e,n)=>{"use strict";n.r(e),n.d(e,{default:()=>T});var t=n(31085),l=n(71184),d=n(93065),a=n(52022),i=n(92587),s=n(48727);let r={type:"code",centered:!0,component:function(){return(0,t.jsx)(a.$,{onClick:()=>i.jQ.openConfirmModal({modalId:"test-id",title:"Please confirm your action",children:(0,t.jsx)(d.E,{size:"sm",children:"This action is so important that you are required to confirm it with a modal. Please click one of these buttons to proceed."}),onCancel:()=>s.$e.show({title:"Canceled",message:"Confirm modal was canceled",color:"gray"}),onConfirm:()=>s.$e.show({title:"Confirmed",message:"Confirm modal was confirmed",color:"teal"})}),children:"Open confirm modal"})},code:`
...
`},c={type:"code",centered:!0,component:function(){return(0,t.jsx)(a.$,{onClick:()=>i.jQ.openConfirmModal({title:"Delete your profile",centered:!0,children:(0,t.jsx)(d.E,{size:"sm",children:"Are you sure you want to delete your profile? This action is destructive and you will have to contact support to restore your data."}),labels:{confirm:"Delete account",cancel:"No don't delete it"},confirmProps:{color:"red"},onCancel:()=>s.$e.show({title:"Canceled",message:"Delete modal was canceled",color:"gray"}),onConfirm:()=>s.$e.show({title:"Deleted",message:"Delete modal was confirmed",color:"red"})}),color:"red",children:"Delete account"})},code:`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
...
`};var p=n(90275);let u={type:"code",centered:!0,component:function(){return(0,t.jsx)(a.$,{onClick:()=>{i.jQ.open({title:"Subscribe to newsletter",children:(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(p.k,{label:"Your email",placeholder:"Your email","data-autofocus":!0}),(0,t.jsx)(a.$,{fullWidth:!0,onClick:()=>i.jQ.closeAll(),mt:"md",children:"Submit"})]})})},children:"Open content modal"})},code:`
...
`},h={type:"code",centered:!0,component:function(){return(0,t.jsx)(a.$,{onClick:()=>i.jQ.openConfirmModal({title:"Please confirm your action",closeOnConfirm:!1,labels:{confirm:"Next modal",cancel:"Close modal"},children:(0,t.jsx)(d.E,{size:"sm",children:"This action is so important that you are required to confirm it with a modal. Please click one of these buttons to proceed."}),onConfirm:()=>i.jQ.openConfirmModal({title:"This is modal at second layer",labels:{confirm:"Close modal",cancel:"Back"},closeOnConfirm:!1,children:(0,t.jsx)(d.E,{size:"sm",children:"When this modal is closed modals state will revert to first modal"}),onConfirm:i.jQ.closeAll})}),children:"Open multiple steps modal"})},code:`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
...
`},f={type:"code",centered:!0,component:function(){return(0,t.jsx)(a.$,{onClick:()=>i.jQ.openConfirmModal({modalId:"test-id",title:"Please confirm your action",size:"sm",radius:"md",withCloseButton:!1,children:(0,t.jsx)(d.E,{size:"sm",children:"This action is so important that you are required to confirm it with a modal. Please click one of these buttons to proceed."}),onCancel:()=>s.$e.show({title:"Canceled",message:"Confirm modal was canceled",color:"gray"}),onConfirm:()=>s.$e.show({title:"Confirmed",message:"Confirm modal was confirmed",color:"teal"})}),children:"Open confirm modal"})},code:`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
...
`};var x=n(94082);let C={type:"code",centered:!0,component:function(){return(0,t.jsx)(a.$,{onClick:()=>{let o=i.jQ.openContextModal({modal:"asyncDemonstration",title:"Processing...",closeOnEscape:!1,closeOnClickOutside:!1,closeButtonProps:{disabled:!0},innerProps:{modalBody:"You cannot close this modal until 2 seconds have passed.",loading:!0}});setTimeout(()=>{i.jQ.updateContextModal({modalId:o,title:"Processing Complete!",closeOnEscape:!0,closeOnClickOutside:!0,closeButtonProps:{disabled:!1},innerProps:{modalBody:"You can now close the modal.",loading:!1}})},2e3)},children:"Open updating context modal"})},code:`
...
`}}},o=>{var e=e=>o(o.s=e);o.O(0,[67456,39699,68831,90636,46593,38792],()=>e(88271)),_N_E=o.O()}]);