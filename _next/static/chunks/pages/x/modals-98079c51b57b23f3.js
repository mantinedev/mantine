(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[49409],{27775:function(o,e,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/x/modals",function(){return n(15171)}])},15171:function(o,e,n){"use strict";n.r(e),n.d(e,{default:function(){return k}});var t=n(52322),l=n(45392),Text=n(8582),i=n(17115),d=n(2807),a=n(60048);let r=`
...
`,s={type:"code",centered:!0,component:function(){return(0,t.jsx)(i.z,{onClick:()=>d.qk.openConfirmModal({modalId:"test-id",title:"Please confirm your action",children:(0,t.jsx)(Text.x,{size:"sm",children:"This action is so important that you are required to confirm it with a modal. Please click one of these buttons to proceed."}),onCancel:()=>a.N9.show({title:"Canceled",message:"Confirm modal was canceled",color:"gray"}),onConfirm:()=>a.N9.show({title:"Confirmed",message:"Confirm modal was confirmed",color:"teal"})}),children:"Open confirm modal"})},code:r},c=`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
...
`,m={type:"code",centered:!0,component:function(){return(0,t.jsx)(i.z,{onClick:()=>d.qk.openConfirmModal({title:"Delete your profile",centered:!0,children:(0,t.jsx)(Text.x,{size:"sm",children:"Are you sure you want to delete your profile? This action is destructive and you will have to contact support to restore your data."}),labels:{confirm:"Delete account",cancel:"No don't delete it"},confirmProps:{color:"red"},onCancel:()=>a.N9.show({title:"Canceled",message:"Delete modal was canceled",color:"gray"}),onConfirm:()=>a.N9.show({title:"Deleted",message:"Delete modal was confirmed",color:"red"})}),color:"red",children:"Delete account"})},code:c},u=`
...
`,p={type:"code",centered:!0,component:function(){return(0,t.jsx)(i.z,{onClick:()=>d.qk.openContextModal({modal:"demonstration",title:"Test modal from context",innerProps:{modalBody:"This modal was defined in ModalsProvider, you can open it anywhere in you app with useModals hook"}}),children:"Open demonstration context modal"})},code:u};var h=n(74770);let f=`
...
`,x={type:"code",centered:!0,component:function(){return(0,t.jsx)(i.z,{onClick:()=>{d.qk.open({title:"Subscribe to newsletter",children:(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(h.o,{label:"Your email",placeholder:"Your email","data-autofocus":!0}),(0,t.jsx)(i.z,{fullWidth:!0,onClick:()=>d.qk.closeAll(),mt:"md",children:"Submit"})]})})},children:"Open content modal"})},code:f},j=`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
...
`,C={type:"code",centered:!0,component:function(){return(0,t.jsx)(i.z,{onClick:()=>d.qk.openConfirmModal({title:"Please confirm your action",closeOnConfirm:!1,labels:{confirm:"Next modal",cancel:"Close modal"},children:(0,t.jsx)(Text.x,{size:"sm",children:"This action is so important that you are required to confirm it with a modal. Please click one of these buttons to proceed."}),onConfirm:()=>d.qk.openConfirmModal({title:"This is modal at second layer",labels:{confirm:"Close modal",cancel:"Back"},closeOnConfirm:!1,children:(0,t.jsx)(Text.x,{size:"sm",children:"When this modal is closed modals state will revert to first modal"}),onConfirm:d.qk.closeAll})}),children:"Open multiple steps modal"})},code:j},y=`
import { Button, Text } from '@mantine/core';
import { modals } from '@mantine/modals';
