...
`,l={type:"code",centered:!0,component:function(){let[t,e]=(0,c.useState)([]),n=n=>{let r=t.some(t=>u(n).isSame(t,"date"));r?e(t=>t.filter(t=>!u(t).isSame(n,"date"))):t.length<3&&e(t=>[...t,n])};return(0,r.jsx)(i.f,{getDayProps:e=>({selected:t.some(t=>u(e).isSame(t,"date")),onClick:()=>n(e)})})},code:d},f=`
import { useState } from 'react';
import { Calendar } from '@mantine/dates';
import dayjs from 'dayjs';
...
`;function h(t){let e=t.getDay();return 0===e?6:e-1}function m(t,e){return!!e&&u(t).isBefore(u(new Date(e.getFullYear(),e.getMonth(),e.getDate()+(6-h(e)))).endOf("date").toDate())&&u(t).isAfter(new Date(e.getFullYear(),e.getMonth(),e.getDate()-h(e)-1))}let $={type:"code",centered:!0,component:function(){let[t,e]=(0,c.useState)(null),[n,a]=(0,c.useState)(null);return(0,r.jsx)(i.f,{withCellSpacing:!1,getDayProps:r=>{let i=m(r,t),s=m(r,n),o=i||s;return{onMouseEnter:()=>e(r),onMouseLeave:()=>e(null),inRange:o,firstInRange:o&&1===r.getDay(),lastInRange:o&&0===r.getDay(),selected:s,onClick:()=>a(r)}}})},code:f};var p=n(77566);let g=`
