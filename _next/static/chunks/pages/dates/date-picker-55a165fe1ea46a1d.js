...
`,x={type:"code",centered:!0,component:function(){let[e,t]=(0,i.useState)(null);return(0,a.jsx)(o.M,{defaultDate:new Date(2015,1),value:e,onChange:t})},code:f},y=`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`,j={type:"code",centered:!0,component:function(){let[e,t]=(0,i.useState)([null,null]),[n,r]=(0,i.useState)(new Date);return(0,a.jsx)(o.M,{date:n,onDateChange:r,type:"range",value:e,onChange:e=>{null!==e[0]&&null===e[1]&&r(e=>new Date(e.getFullYear(),e.getMonth()+1)),t(e)}})},code:y};var D=n(93010);let g=`
...
`,v={type:"code",component:function(){return(0,a.jsxs)(D.Z,{justify:"center",children:[(0,a.jsx)(o.M,{defaultLevel:"decade"}),(0,a.jsx)(o.M,{defaultLevel:"year"})]})},code:g},_=`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker hideOutsideDates />;
}
`,k={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.M,{hideOutsideDates:!0})},code:_},w=`
import { Group } from '@mantine/core';
import { DatePicker } from '@mantine/dates';
...
`,b={type:"code",component:function(){return(0,a.jsxs)(D.Z,{justify:"center",children:[(0,a.jsx)(o.M,{firstDayOfWeek:0}),(0,a.jsx)(o.M,{firstDayOfWeek:6})]})},code:w},P=`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker hideWeekdays />;
}
`,M={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.M,{hideWeekdays:!0})},code:P},Y=`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker weekendDays={[1, 2]} />;
}
`,S={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.M,{weekendDays:[1,2]})},code:Y};var L=n(77566);let C=`
...
`,F=e=>{let t=e.getDate();return(0,a.jsx)(L.z,{size:6,color:"red",offset:-5,disabled:16!==t,children:(0,a.jsx)("div",{children:t})})},z={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.M,{renderDay:F})},code:C},N=`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`,W={type:"code",centered:!0,component:function(){let[e,t]=(0,i.useState)(null);return(0,a.jsx)(o.M,{value:e,onChange:t,defaultDate:new Date(2022,1),minDate:new Date(2022,1,10),maxDate:new Date(2022,1,25)})},code:N},O=`
import { useState } from 'react';
import { DatePicker, DatePickerProps } from '@mantine/dates';
...
`,A=e=>5===e.getDay()&&13===e.getDate()?{style:{backgroundColor:"var(--mantine-color-red-filled)",color:"var(--mantine-color-white)"}}:{},I=e=>e.getFullYear()===new Date().getFullYear()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:e.getFullYear()===new Date().getFullYear()+1?{disabled:!0}:{},T=e=>1===e.getMonth()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:5===e.getMonth()?{disabled:!0}:{},V={type:"code",centered:!0,component:function(){let[e,t]=(0,i.useState)(null);return(0,a.jsx)(o.M,{value:e,onChange:t,defaultDate:new Date(2021,7),getDayProps:A,getYearControlProps:I,getMonthControlProps:T})},code:O},E=`
import { Group } from '@mantine/core';
import { DatePicker } from '@mantine/dates';
...
`,G={type:"code",component:function(){return(0,a.jsxs)(D.Z,{justify:"center",children:[(0,a.jsx)(o.M,{maxLevel:"year"}),(0,a.jsx)(o.M,{maxLevel:"month"})]})},code:E},U=`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker monthsListFormat="MM" yearsListFormat="YY" />;
}
`,H={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.M,{monthsListFormat:"MM",yearsListFormat:"YY"})},code:U},R=`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`,$={type:"code",centered:!0,component:function(){let[e,t]=(0,i.useState)(null);return(0,a.jsx)(o.M,{defaultLevel:"decade",decadeLabelFormat:"YY",yearLabelFormat:"YYYY [year]",monthLabelFormat:"MM/YY",value:e,onChange:t})},code:R};n(61389);let Z=`
