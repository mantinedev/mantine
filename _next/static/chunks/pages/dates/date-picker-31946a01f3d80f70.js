...
`};var g=n(35376);let v={type:"code",component:function(){return(0,a.jsxs)(y.Z,{justify:"center",children:[(0,a.jsx)(o.M,{firstDayOfWeek:0}),(0,a.jsx)(o.M,{firstDayOfWeek:6})]})},code:`
import { Group } from '@mantine/core';
import { DatePicker } from '@mantine/dates';
...
`},_={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.M,{hideWeekdays:!0})},code:`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker hideWeekdays />;
}
`},k={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.M,{weekendDays:[1,2]})},code:`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker weekendDays={[1, 2]} />;
}
`};var b=n(77566);let w=e=>{let t=e.getDate();return(0,a.jsx)(b.z,{size:6,color:"red",offset:-5,disabled:16!==t,children:(0,a.jsx)("div",{children:t})})},P={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.M,{renderDay:w})},code:`
...
`},M={type:"code",centered:!0,component:function(){let[e,t]=(0,i.useState)(null);return(0,a.jsx)(o.M,{value:e,onChange:t,defaultDate:new Date(2022,1),minDate:new Date(2022,1,10),maxDate:new Date(2022,1,25)})},code:`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`},Y=e=>5===e.getDay()&&13===e.getDate()?{style:{backgroundColor:"var(--mantine-color-red-filled)",color:"var(--mantine-color-white)"}}:{},S=e=>e.getFullYear()===new Date().getFullYear()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:e.getFullYear()===new Date().getFullYear()+1?{disabled:!0}:{},L=e=>1===e.getMonth()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:5===e.getMonth()?{disabled:!0}:{},C={type:"code",centered:!0,component:function(){let[e,t]=(0,i.useState)(null);return(0,a.jsx)(o.M,{value:e,onChange:t,defaultDate:new Date(2021,7),getDayProps:Y,getYearControlProps:S,getMonthControlProps:L})},code:`
import { useState } from 'react';
import { DatePicker, DatePickerProps } from '@mantine/dates';
...
`},F={type:"code",component:function(){return(0,a.jsx)(o.M,{excludeDate:e=>5!==e.getDay()})},code:`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker excludeDate={(date) => date.getDay() !== 5} />;
}
`,centered:!0},N={type:"code",component:function(){return(0,a.jsxs)(y.Z,{justify:"center",children:[(0,a.jsx)(o.M,{maxLevel:"year"}),(0,a.jsx)(o.M,{maxLevel:"month"})]})},code:`
import { Group } from '@mantine/core';
import { DatePicker } from '@mantine/dates';
...
`},W={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.M,{monthsListFormat:"MM",yearsListFormat:"YY"})},code:`
import { DatePicker } from '@mantine/dates';
...
`};n(61389);let O={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.M,{locale:"ru"})},code:`
