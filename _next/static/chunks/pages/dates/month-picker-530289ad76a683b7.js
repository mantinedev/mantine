...
`,f={type:"code",centered:!0,component:function(){let[e,t]=(0,s.useState)(null);return(0,a.jsx)(r.l,{defaultDate:new Date(2015,1),value:e,onChange:t})},code:x},j=`
import { useState } from 'react';
import { MonthPicker } from '@mantine/dates';
...
`,g={type:"code",centered:!0,component:function(){let[e,t]=(0,s.useState)([null,null]),[n,o]=(0,s.useState)(new Date);return(0,a.jsx)(r.l,{date:n,onDateChange:o,type:"range",value:e,onChange:e=>{null!==e[0]&&null===e[1]&&o(e=>new Date(e.getFullYear()+1,1)),t(e)}})},code:j},y=`
import { useState } from 'react';
import { MonthPicker } from '@mantine/dates';
...
`,_={type:"code",centered:!0,component:function(){let[e,t]=(0,s.useState)(null);return(0,a.jsx)(r.l,{value:e,onChange:t,defaultDate:new Date(2022,1),minDate:new Date(2022,1,1),maxDate:new Date(2022,8,1)})},code:y},M=`
import { useState } from 'react';
...
`,D=e=>e.getFullYear()===new Date().getFullYear()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:e.getFullYear()===new Date().getFullYear()+1?{disabled:!0}:{},v=e=>1===e.getMonth()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:5===e.getMonth()?{disabled:!0}:{},b={type:"code",centered:!0,component:function(){let[e,t]=(0,s.useState)(null);return(0,a.jsx)(r.l,{value:e,onChange:t,getYearControlProps:D,getMonthControlProps:v})},code:M},w=`
import { MonthPicker } from '@mantine/dates';

function Demo() {
  return <MonthPicker maxLevel="year" />;
}
`,Y={type:"code",centered:!0,component:function(){return(0,a.jsx)(r.l,{maxLevel:"year"})},code:w},k=`
import { MonthPicker } from '@mantine/dates';

function Demo() {
  return <MonthPicker monthsListFormat="MM" yearsListFormat="YY" />;
}
`,P={type:"code",centered:!0,component:function(){return(0,a.jsx)(r.l,{monthsListFormat:"MM",yearsListFormat:"YY"})},code:k},C=`
import { useState } from 'react';
import { MonthPicker } from '@mantine/dates';
...
`,S={type:"code",centered:!0,component:function(){let[e,t]=(0,s.useState)(null);return(0,a.jsx)(r.l,{decadeLabelFormat:"YY",yearLabelFormat:"YYYY [year]",value:e,onChange:t})},code:C};n(61389);let L=`
