(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[77395],{15682:function(e,n,t){(window.__NEXT_P=window.__NEXT_P||[]).push(["/dates/year-picker",function(){return t(20223)}])},20223:function(e,n,t){"use strict";t.r(n),t.d(n,{default:function(){return V}});var a=t(52322),r=t(45392),l=t(98071),o=t(49640),s=t(2784);t(28879);let{usage:d,multiple:i,deselect:c,range:u,singleRange:h,numberOfColumns:p,sizeConfigurator:m}=(0,o.$)(l.q),x=`
...
`,j={type:"code",centered:!0,component:function(){let[e,n]=(0,s.useState)(null);return(0,a.jsx)(l.q,{defaultDate:new Date(2040,1),value:e,onChange:n})},code:x},f=`
import { useState } from 'react';
import { YearPicker } from '@mantine/dates';
...
`,g={type:"code",centered:!0,component:function(){let[e,n]=(0,s.useState)([null,null]),[t,r]=(0,s.useState)(new Date);return(0,a.jsx)(l.q,{date:t,onDateChange:r,type:"range",value:e,onChange:e=>{null!==e[0]&&null===e[1]&&r(e=>new Date(e.getFullYear()+20,1)),n(e)}})},code:f},y=`
import { useState } from 'react';
import { YearPicker } from '@mantine/dates';
...
`,D={type:"code",centered:!0,component:function(){let[e,n]=(0,s.useState)(null);return(0,a.jsx)(l.q,{value:e,onChange:n,minDate:new Date(2021,1),maxDate:new Date(2028,1)})},code:y},w=`
import { useState } from 'react';
...
`,Y=e=>e.getFullYear()===new Date().getFullYear()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:e.getFullYear()===new Date().getFullYear()+1?{disabled:!0}:{},b={type:"code",centered:!0,component:function(){let[e,n]=(0,s.useState)(null);return(0,a.jsx)(l.q,{value:e,onChange:n,getYearControlProps:Y})},code:w},v=`
import { useState } from 'react';
import { YearPicker } from '@mantine/dates';
...
`,k={type:"code",centered:!0,component:function(){let[e,n]=(0,s.useState)(null);return(0,a.jsx)(l.q,{yearsListFormat:"YY",value:e,onChange:n})},code:v},P=`
import { useState } from 'react';
import { YearPicker } from '@mantine/dates';
