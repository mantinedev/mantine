...
`;function h(t){let e=t.getDay();return 0===e?6:e-1}function m(t,e){return!!e&&c(t).isBefore(c(new Date(e.getFullYear(),e.getMonth(),e.getDate()+(6-h(e)))).endOf("date").toDate())&&c(t).isAfter(new Date(e.getFullYear(),e.getMonth(),e.getDate()-h(e)-1))}let $={type:"code",centered:!0,component:function(){let[t,e]=(0,i.useState)(null),[n,r]=(0,i.useState)(null);return i.createElement(s.f,{withCellSpacing:!1,getDayProps:a=>{let i=m(a,t),s=m(a,n),o=i||s;return{onMouseEnter:()=>e(a),onMouseLeave:()=>e(null),inRange:o,firstInRange:o&&1===a.getDay(),lastInRange:o&&0===a.getDay(),selected:s,onClick:()=>r(a)}}})},code:f};var p=n(87121);let g=`
