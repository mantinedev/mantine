...
`,x={type:"code",centered:!0,component:function(){let[e,t]=(0,i.useState)([null,null]),[n,a]=(0,i.useState)(new Date);return i.createElement(o.M,{date:n,onDateChange:a,type:"range",value:e,onChange:e=>{null!==e[0]&&null===e[1]&&a(e=>new Date(e.getFullYear(),e.getMonth()+1)),t(e)}})},code:D};var j=n(22971);let g=`
...
`,S={type:"code",centered:!0,component:function(){return i.createElement(o.M,{weekendDays:[1,2]})},code:Y};var L=n(87121);let C=`
...
`,$={type:"code",centered:!0,component:function(){let[e,t]=(0,i.useState)(null);return i.createElement(o.M,{defaultLevel:"decade",decadeLabelFormat:"YY",yearLabelFormat:"YYYY [year]",monthLabelFormat:"MM/YY",value:e,onChange:t})},code:R};n(64381);let Z=`
