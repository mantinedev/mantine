...
`,H={type:"code",centered:!0,component:function(){return i.createElement(o.M,{monthsListFormat:"MM",yearsListFormat:"YY"})},code:U},$=`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`,R={type:"code",centered:!0,component:function(){let[e,t]=(0,i.useState)(null);return i.createElement(o.M,{defaultLevel:"decade",decadeLabelFormat:"YY",yearLabelFormat:"YYYY [year]",monthLabelFormat:"MM/YY",value:e,onChange:t})},code:$};n(64381);let Z=`
