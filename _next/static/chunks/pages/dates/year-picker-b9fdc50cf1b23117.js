...
`,f={type:"code",centered:!0,component:function(){let[e,n]=(0,s.useState)(null);return s.createElement(l.q,{defaultDate:new Date(2040,1),value:e,onChange:n})},code:x},j=`
import { useState } from 'react';
import { YearPicker } from '@mantine/dates';
...
`,g={type:"code",centered:!0,component:function(){let[e,n]=(0,s.useState)([null,null]),[t,a]=(0,s.useState)(new Date);return s.createElement(l.q,{date:t,onDateChange:a,type:"range",value:e,onChange:e=>{null!==e[0]&&null===e[1]&&a(e=>new Date(e.getFullYear()+20,1)),n(e)}})},code:j},y=`
import { useState } from 'react';
import { YearPicker } from '@mantine/dates';
...
`,D={type:"code",centered:!0,component:function(){let[e,n]=(0,s.useState)(null);return s.createElement(l.q,{value:e,onChange:n,minDate:new Date(2021,1),maxDate:new Date(2028,1)})},code:y},w=`
import { useState } from 'react';
...
`,Y=e=>e.getFullYear()===new Date().getFullYear()?{style:{color:"var(--mantine-color-blue-filled)",fontWeight:700}}:e.getFullYear()===new Date().getFullYear()+1?{disabled:!0}:{},b={type:"code",centered:!0,component:function(){let[e,n]=(0,s.useState)(null);return s.createElement(l.q,{value:e,onChange:n,getYearControlProps:Y})},code:w},v=`
import { useState } from 'react';
import { YearPicker } from '@mantine/dates';
...
`,k={type:"code",centered:!0,component:function(){let[e,n]=(0,s.useState)(null);return s.createElement(l.q,{yearsListFormat:"YY",value:e,onChange:n})},code:v},P=`
import { useState } from 'react';
import { YearPicker } from '@mantine/dates';
