...
`}},17592:(e,t,n)=>{"use strict";n.d(t,{B:()=>y});var r=n(31085);n(14041);var o=n(33450),s=n(7098),i=n(29686),a=n(69564),l=n(34056),c=n(6754);let[d,m]=(0,n(59852).F)("List component was not found in tree");var p={root:"m_abbac491",item:"m_abb6bec2",itemWrapper:"m_75cd9f71",itemIcon:"m_60f83e5b"};let u={},h=(0,c.P9)((e,t)=>{let{classNames:n,className:o,style:s,styles:a,vars:c,icon:d,children:p,mod:h,...f}=(0,i.Y)("ListItem",u,e),v=m(),y=d||v.icon,g={classNames:n,styles:a};return(0,r.jsx)(l.a,{...v.getStyles("item",{...g,className:o,style:s}),component:"li",mod:[{"with-icon":!!y,centered:v.center},h],ref:t,...f,children:(0,r.jsxs)("div",{...v.getStyles("itemWrapper",g),children:[y&&(0,r.jsx)("span",{...v.getStyles("itemIcon",g),children:y}),(0,r.jsx)("span",{...v.getStyles("itemLabel",g),children:p})]})})});h.classes=p,h.displayName="@mantine/core/ListItem";let f={type:"unordered"},v=(0,s.V)((e,{size:t,spacing:n})=>({root:{"--list-fz":(0,o.ny)(t),"--list-lh":(0,o.ks)(t),"--list-spacing":(0,o.GY)(n)}})),y=(0,c.P9)((e,t)=>{let n=(0,i.Y)("List",f,e),{classNames:o,className:s,style:c,styles:m,unstyled:u,vars:h,children:y,type:g,withPadding:x,icon:j,spacing:b,center:k,listStyleType:w,mod:N,...M}=n,P=(0,a.I)({name:"List",classes:p,props:n,className:s,style:c,classNames:o,styles:m,unstyled:u,vars:h,varsResolver:v});return(0,r.jsx)(d,{value:{center:k,icon:j,getStyles:P},children:(0,r.jsx)(l.a,{...P("root",{style:{listStyleType:w}}),component:"unordered"===g?"ul":"ol",mod:[{"with-padding":x},N],ref:t,...M,children:y})})});y.classes=p,y.displayName="@mantine/core/List",y.Item=h},84097:(e,t,n)=>{"use strict";function r(e){let t=e||!0;return e=>"string"==typeof e?e.trim().length>0?null:t:Array.isArray(e)?e.length>0?null:t:null==e||!1===e?t:null}n.d(t,{h:()=>r})}},e=>{var t=t=>e(e.s=t);e.O(0,[18675,23719,90636,46593,38792],()=>t(96037)),_N_E=e.O()}]);