...
`,l={type:"code",component:function(){return r.createElement(o.Z,null,r.createElement(a.z,{color:"oklch-blue"},"Filled"),r.createElement(a.z,{color:"oklch-blue",variant:"outline"},"Outline"),r.createElement(a.z,{color:"oklch-blue",variant:"light"},"Light"))},code:i,centered:!0}},8132:function(e,n,t){"use strict";t.d(n,{v:function(){return S}});var r=t(2784),o=t(171),a=t(30840),i=t(18205),l=t(80739),s=t(55734),c=t(25556),d=t(81224),h=t(3131),p=t(55484),m=t(21154),u=t(11200),x=t(13588),f=t(82027),j=t(38483),g=t(68755),b=t(51477),v=t(62378),y=t(28559),w=t(46293),k=t(50425),A=t(7064);function C(e){return`${(100*e).toFixed(0)}%`}let E={withXAxis:!0,withYAxis:!0,withTooltip:!0,tooltipAnimationDuration:0,fillOpacity:1,tickLine:"y",strokeDasharray:"5 5",gridAxis:"x",type:"default"},T=(0,u.Z)((e,{textColor:n,gridColor:t,cursorFill:r})=>({root:{"--chart-text-color":n?(0,x.p)(n,e):void 0,"--chart-grid-color":t?(0,x.p)(t,e):void 0,"--chart-cursor-fill":r?(0,x.p)(r,e):void 0}})),S=(0,f.d)((e,n)=>{let t=(0,j.w)("BarChart",E,e),{classNames:u,className:f,style:S,styles:M,unstyled:L,vars:I,data:B,withLegend:z,legendProps:N,series:q,onMouseLeave:O,dataKey:P,withTooltip:D,withXAxis:V,withYAxis:F,gridAxis:_,tickLine:H,xAxisProps:K,yAxisProps:G,unit:R,tooltipAnimationDuration:W,strokeDasharray:Z,gridProps:$,tooltipProps:Q,referenceLines:Y,fillOpacity:X,barChartProps:J,type:U,orientation:ee,dir:en,valueFormatter:et,children:er,barProps:eo,xAxisLabel:ea,yAxisLabel:ei,...el}=t,es=(0,g.rZ)(),[ec,ed]=(0,r.useState)(null),eh=null!==ec,ep="stacked"===U||"percent"===U,{resolvedClassNames:em,resolvedStyles:eu}=(0,b.h)({classNames:u,styles:M,props:t}),ex=(0,v.y)({name:"BarChart",classes:A.Z,props:t,className:f,style:S,classNames:u,styles:M,unstyled:L,vars:I,varsResolver:T}),ef=q.map(e=>{let n=(0,x.p)(e.color,es),t=eh&&ec!==e.name;return r.createElement(o.$,{...ex("bar"),key:e.name,name:e.name,dataKey:e.name,fill:n,stroke:n,isAnimationActive:!1,fillOpacity:t?.1:X,strokeOpacity:t?.2:0,stackId:ep?"stack":void 0,..."function"==typeof eo?eo(e):eo})}),ej=Y?.map((e,n)=>{let t=x.p(e.color,es);return r.createElement(a.d,{key:n,stroke:e.color?t:"var(--chart-grid-color)",strokeWidth:1,...e,label:{value:e.label,fill:e.color?t:"currentColor",fontSize:12,position:e.labelPosition??"insideBottomLeft"},...ex("referenceLine")})});return r.createElement(y.x,{ref:n,...ex("root"),onMouseLeave:e=>{ed(null),O?.(e)},dir:en||"ltr",...el},r.createElement(i.h,{...ex("container")},r.createElement(l.v,{data:B,stackOffset:"percent"===U?"expand":void 0,layout:ee,margin:{bottom:ea?30:void 0,left:ei?10:void 0,right:ei?5:void 0},...J},z&&r.createElement(s.D,{verticalAlign:"top",content:e=>r.createElement(w.Q,{payload:e.payload,onHighlight:ed,legendPosition:N?.verticalAlign||"top",classNames:em,styles:eu,series:q}),height:44,...N}),r.createElement(c.K,{hide:!V,..."vertical"===ee?{type:"number"}:{dataKey:P},tick:{transform:"translate(0, 10)",fontSize:12,fill:"currentColor"},stroke:"",interval:"preserveStartEnd",tickLine:!!("none"!==_&&("x"===H||"xy"===H))&&{stroke:"currentColor"},minTickGap:5,...ex("axis"),...K},ea&&r.createElement(d._,{position:"insideBottom",offset:-20,fontSize:12,...ex("axisLabel")},ea),K?.children),r.createElement(h.B,{hide:!F,axisLine:!1,..."vertical"===ee?{dataKey:P,type:"category"}:{type:"number"},tickLine:!!("none"!==_&&("y"===H||"xy"===H))&&{stroke:"currentColor"},tick:{transform:"translate(-10, 0)",fontSize:12,fill:"currentColor"},allowDecimals:!0,unit:R,tickFormatter:"percent"===U?C:et,...ex("axis"),...G},ei&&r.createElement(d._,{position:"insideLeft",angle:-90,textAnchor:"middle",fontSize:12,offset:-5,...ex("axisLabel")},ei),G?.children),r.createElement(p.q,{strokeDasharray:Z,vertical:"y"===_||"xy"===_,horizontal:"x"===_||"xy"===_,...ex("grid"),...$}),D&&r.createElement(m.u,{animationDuration:W,isAnimationActive:0!==W,position:{y:0},cursor:{stroke:"var(--chart-grid-color)",strokeWidth:1,strokeDasharray:Z,fill:"var(--chart-cursor-fill)"},content:({label:e,payload:n})=>r.createElement(k.h,{label:e,payload:n,unit:R,classNames:em,styles:eu,series:q,valueFormatter:et}),...Q}),ef,ej,er)))});S.displayName="@mantine/charts/BarChart",S.classes=A.Z},65602:function(e,n,t){"use strict";t.d(n,{w:function(){return T}});var r=t(2784),o=t(63004),a=t(30840),i=t(18205),l=t(32908),s=t(55734),c=t(25556),d=t(81224),h=t(3131),p=t(55484),m=t(21154),u=t(11200),x=t(13588),f=t(82027),j=t(38483),g=t(68755),b=t(51477),v=t(62378),y=t(28559),w=t(46293),k=t(50425),A=t(7064);let C={withXAxis:!0,withYAxis:!0,withTooltip:!0,tooltipAnimationDuration:0,fillOpacity:1,tickLine:"y",strokeDasharray:"5 5",gridAxis:"x",withDots:!0,connectNulls:!0,strokeWidth:2,curveType:"monotone"},E=(0,u.Z)((e,{textColor:n,gridColor:t})=>({root:{"--chart-text-color":n?(0,x.p)(n,e):void 0,"--chart-grid-color":t?(0,x.p)(t,e):void 0}})),T=(0,f.d)((e,n)=>{let t=(0,j.w)("LineChart",C,e),{classNames:u,className:f,style:T,styles:S,unstyled:M,vars:L,data:I,withLegend:B,legendProps:z,series:N,onMouseLeave:q,dataKey:O,withTooltip:P,withXAxis:D,withYAxis:V,gridAxis:F,tickLine:_,xAxisProps:H,yAxisProps:K,unit:G,tooltipAnimationDuration:R,strokeDasharray:W,gridProps:Z,tooltipProps:$,referenceLines:Q,withDots:Y,dotProps:X,activeDotProps:J,strokeWidth:U,lineChartProps:ee,connectNulls:en,fillOpacity:et,curveType:er,orientation:eo,dir:ea,valueFormatter:ei,children:el,lineProps:es,xAxisLabel:ec,yAxisLabel:ed,...eh}=t,ep=(0,g.rZ)(),[em,eu]=(0,r.useState)(null),ex=null!==em,{resolvedClassNames:ef,resolvedStyles:ej}=(0,b.h)({classNames:u,styles:S,props:t}),eg=(0,v.y)({name:"LineChart",classes:A.Z,props:t,className:f,style:T,classNames:u,styles:S,unstyled:M,vars:L,varsResolver:E}),eb=N.map(e=>{let n=(0,x.p)(e.color,ep),t=ex&&em!==e.name;return r.createElement(o.x,{...eg("line"),key:e.name,name:e.name,dataKey:e.name,dot:!!Y&&{fillOpacity:t?0:1,strokeOpacity:t?0:1,...X},activeDot:!!Y&&{fill:n,stroke:n,...J},fill:n,stroke:n,strokeWidth:U,isAnimationActive:!1,fillOpacity:t?0:et,strokeOpacity:t?.5:et,connectNulls:en,type:er,strokeDasharray:e.strokeDasharray,..."function"==typeof es?es(e):es})}),ev=Q?.map((e,n)=>{let t=x.p(e.color,ep);return r.createElement(a.d,{key:n,stroke:e.color?t:"var(--chart-grid-color)",strokeWidth:1,...e,label:{value:e.label,fill:e.color?t:"currentColor",fontSize:12,position:e.labelPosition??"insideBottomLeft"},...eg("referenceLine")})});return r.createElement(y.x,{ref:n,...eg("root"),onMouseLeave:e=>{eu(null),q?.(e)},dir:ea||"ltr",...eh},r.createElement(i.h,{...eg("container")},r.createElement(l.w,{data:I,layout:eo,margin:{bottom:ec?30:void 0,left:ed?10:void 0,right:ed?5:void 0},...ee},B&&r.createElement(s.D,{verticalAlign:"top",content:e=>r.createElement(w.Q,{payload:e.payload,onHighlight:eu,legendPosition:z?.verticalAlign||"top",classNames:ef,styles:ej,series:N}),height:44,...z}),r.createElement(c.K,{hide:!D,..."vertical"===eo?{type:"number"}:{dataKey:O},tick:{transform:"translate(0, 10)",fontSize:12,fill:"currentColor"},stroke:"",interval:"preserveStartEnd",tickLine:!!("none"!==F&&("x"===_||"xy"===_))&&{stroke:"currentColor"},minTickGap:5,...eg("axis"),...H},ec&&r.createElement(d._,{position:"insideBottom",offset:-20,fontSize:12,...eg("axisLabel")},ec),H?.children),r.createElement(h.B,{hide:!V,axisLine:!1,..."vertical"===eo?{dataKey:O,type:"category"}:{type:"number"},tickLine:!!("none"!==F&&("y"===_||"xy"===_))&&{stroke:"currentColor"},tick:{transform:"translate(-10, 0)",fontSize:12,fill:"currentColor"},allowDecimals:!0,unit:G,tickFormatter:ei,...eg("axis"),...K},ed&&r.createElement(d._,{position:"insideLeft",angle:-90,textAnchor:"middle",fontSize:12,offset:-5,...eg("axisLabel")},ed),K?.children),r.createElement(p.q,{strokeDasharray:W,vertical:"y"===F||"xy"===F,horizontal:"x"===F||"xy"===F,...eg("grid"),...Z}),P&&r.createElement(m.u,{animationDuration:R,isAnimationActive:0!==R,position:{y:0},cursor:{stroke:"var(--chart-grid-color)",strokeWidth:1,strokeDasharray:W},content:({label:e,payload:n})=>r.createElement(k.h,{label:e,payload:n,unit:G,classNames:ef,styles:ej,series:N,valueFormatter:ei}),...$}),eb,ev,el)))});T.displayName="@mantine/charts/LineChart",T.classes=A.Z},77533:function(e,n,t){"use strict";t.d(n,{b:function(){return j}});var r=t(2784),o=t(18205),a=t(50603),i=t(81073),l=t(11200),s=t(13588),c=t(82027),d=t(38483),h=t(62378),p=t(28559),m=t(32125);let u={},x={withGradient:!0,connectNulls:!0,fillOpacity:.6,strokeWidth:2,curveType:"linear"},f=(0,l.Z)((e,{color:n,data:t,trendColors:r})=>({root:{"--chart-color":r?(0,s.p)(function(e,n){let t=e[0],r=e[e.length-1];return t<r?n.positive:t>r?n.negative:n.neutral||n.positive}(t,r),e):n?(0,s.p)(n,e):void 0}})),j=(0,c.d)((e,n)=>{let t=(0,d.w)("Sparkline",x,e),{classNames:l,className:s,style:c,styles:j,unstyled:g,vars:b,data:v,withGradient:y,fillOpacity:w,curveType:k,strokeWidth:A,trendColors:C,connectNulls:E,areaProps:T,...S}=t,M=(0,h.y)({name:"Sparkline",classes:u,props:t,className:s,style:c,classNames:l,styles:j,unstyled:g,vars:b,varsResolver:f}),L=(0,r.useId)(),I=(0,r.useMemo)(()=>v.map((e,n)=>({value:e,index:n})),[v]);return r.createElement(p.x,{ref:n,...M("root"),...S,dir:"ltr"},r.createElement(o.h,null,r.createElement(a.T,{data:I},r.createElement(i.u,{dataKey:"value",type:k,fill:`url(#${L})`,stroke:"var(--chart-color, var(--mantine-color-blue-filled))",isAnimationActive:!1,connectNulls:E,strokeWidth:A,fillOpacity:1,...T}),r.createElement("defs",null,r.createElement(m.v,{id:L,color:"var(--chart-color, var(--mantine-color-blue-filled))",fillOpacity:w,withGradient:y})))))});j.displayName="@mantine/charts/Sparkline",j.classes=u}},function(e){e.O(0,[57938,16717,9462,50603,62662,17454,47747,88320,47889,45083,49774,92888,40179],function(){return e(e.s=42974)}),_N_E=e.O()}]);