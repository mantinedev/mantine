...
`,w=e=>{let n=(0,o.B)(e),r=(0,s.E)({color:e.color||e.theme.primaryColor,theme:e.theme});return r.isThemeColor&&"lime"===r.color&&"filled"===e.variant?v(b({},n),{color:"var(--mantine-color-black)",hoverColor:"var(--mantine-color-white)"}):"light"===e.variant?{background:(0,l.m)(r.value,.1),hover:(0,l.m)(r.value,.15),border:`${(0,i.h)(1)} solid ${r.value}`,color:(0,a._)(r.value,.1)}:"danger"===e.variant?{background:"var(--mantine-color-red-9)",hover:"var(--mantine-color-red-8)",color:"var(--mantine-color-white)",border:"none"}:n},S={type:"code",component:function(){return t.createElement(c.M2,{theme:{variantColorResolver:w}},t.createElement(d.Z,null,t.createElement(h.z,{color:"lime.4",variant:"filled"},"Lime filled button"),t.createElement(h.z,{color:"orange",variant:"light"},"Orange light button"),t.createElement(h.z,{variant:"danger"},"Danger button")))},centered:!0,code:y}}},function(e){e.O(0,[4136,213,8992,178,4391,6430,1300,9774,2888,179],function(){return e(e.s=84744)}),_N_E=e.O()}]);