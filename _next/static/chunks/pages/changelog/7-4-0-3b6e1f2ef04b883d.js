...
`,centered:!0,maxWidth:340}},43084:function(e,n,t){"use strict";t.d(n,{w:function(){return l}});var r=t(52322),a=t(2784),o=t(74770),i=t(42697),s=t(405);let l={type:"code",component:function(){let e=(0,s.c)({mode:"uncontrolled",initialValues:{name:"",age:""},enhanceGetInputProps:e=>"name"===e.options.fieldType?{label:"Your name",placeholder:"Your name",withAsterisk:!0,description:"Your personal information is stored securely. (Just kidding!)"}:{}});return(0,r.jsxs)(r.Fragment,{children:[(0,a.createElement)(o.o,{...e.getInputProps("name",{fieldType:"name"}),key:e.key("name")}),(0,a.createElement)(i.Y,{...e.getInputProps("age"),key:e.key("age"),label:"Age",placeholder:"Age",mt:"md"})]})},code:`
import { NumberInput, TextInput } from '@mantine/core';
import { useForm } from '@mantine/form';
