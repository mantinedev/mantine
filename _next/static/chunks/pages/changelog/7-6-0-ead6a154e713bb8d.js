...
`,s={type:"code",component:function(){return(0,r.jsx)(a.v,{h:200,data:i.a,dataKey:"month",orientation:"vertical",yAxisProps:{width:80},barProps:{radius:10},series:[{name:"Smartphones",color:"blue.6"}]})},code:[{code:o,language:"tsx",fileName:"Demo.tsx"},{code:i.o,language:"tsx",fileName:"data.ts"}]}},9404:function(e,t,n){"use strict";n.d(t,{a:function(){return r},o:function(){return a}});let r=[{month:"January",Smartphones:1200,Laptops:900,Tablets:200},{month:"February",Smartphones:1900,Laptops:1200,Tablets:400},{month:"March",Smartphones:400,Laptops:1e3,Tablets:200},{month:"April",Smartphones:1e3,Laptops:200,Tablets:800},{month:"May",Smartphones:800,Laptops:1400,Tablets:1200},{month:"June",Smartphones:750,Laptops:600,Tablets:1e3}],a=`
export const data = [
...
`},88442:function(e,t,n){"use strict";n.d(t,{r:function(){return s}});var r=n(52322),a=n(38840),i=n(10301);let o=`
...
`,s={type:"configurator",component:function(e){return(0,r.jsx)(a.u,{...e,withLabels:!0,data:i.a,miw:300})},code:[{fileName:"Demo.tsx",code:o,language:"tsx"},{fileName:"data.ts",code:i.o,language:"tsx"}],centered:!0,controls:[{type:"boolean",prop:"withLabelsLine",initialValue:!0,libraryValue:"__"},{type:"segmented",prop:"labelsPosition",initialValue:"outside",libraryValue:"__",data:["inside","outside"]},{type:"segmented",prop:"labelsType",initialValue:"value",libraryValue:"__",data:["value","percent"]}]}},10301:function(e,t,n){"use strict";n.d(t,{a:function(){return r},o:function(){return a}});let r=[{name:"USA",value:400,color:"indigo.6"},{name:"India",value:300,color:"yellow.6"},{name:"Japan",value:300,color:"teal.6"},{name:"Other",value:200,color:"gray.6"}],a=`
export const data = [
...
`},21988:function(e,t,n){"use strict";n.d(t,{m:function(){return s}});var r=n(52322),a=n(22309),i=n(47550);let o=`
...
`,s={type:"code",component:function(){return(0,r.jsx)(a.H,{h:300,data:i.qH,dataKey:"product",withPolarRadiusAxis:!0,series:[{name:"sales_january",color:"lime.4",opacity:.1},{name:"sales_february",color:"cyan.4",opacity:.1}]})},code:[{code:o,language:"tsx",fileName:"Demo.tsx"},{code:i.gv,language:"tsx",fileName:"data.ts"}]}},47550:function(e,t,n){"use strict";n.d(t,{aT:function(){return r},gv:function(){return o},op:function(){return a},qH:function(){return i}});let r=[{product:"Apples",sales:120},{product:"Oranges",sales:98},{product:"Tomatoes",sales:86},{product:"Grapes",sales:99},{product:"Bananas",sales:85},{product:"Lemons",sales:65}],a=`
export const data = [
  {
    product: 'Apples',
    sales: 120,
...
];`},8672:function(e,t,n){"use strict";n.d(t,{A:function(){return h}});var r=n(52322),a=n(77533),i=n(65438),o=n(8582);let s=[10,20,40,20,40,10,50],l=[50,40,20,40,20,40,10],c=[10,20,40,20,40,10,50,5,10],d=`
...
`,l={Apples:{emoji:"\uD83C\uDF4E",description:"Crisp and juicy snacking delight"},Bread:{emoji:"\uD83C\uDF5E",description:"Freshly baked daily essential"},Bananas:{emoji:"\uD83C\uDF4C",description:"Perfect for a healthy breakfast"},Eggs:{emoji:"\uD83E\uDD5A",description:"Versatile protein source for cooking"},Broccoli:{emoji:"\uD83E\uDD66",description:"Nutrient-rich green vegetable"}},c=({option:e})=>(0,r.jsxs)(a.Z,{children:[(0,r.jsx)(i.x,{span:!0,fz:24,children:l[e.value].emoji}),(0,r.jsxs)("div",{children:[(0,r.jsx)(i.x,{children:e.value}),(0,r.jsx)(i.x,{size:"xs",opacity:.5,children:l[e.value].description})]})]}),d={type:"code",component:function(){return(0,r.jsx)(o.B,{data:["Apples","Bread","Bananas","Eggs","Broccoli"],renderOption:c,label:"Groceries",placeholder:"Pick tag from list or type to add new",maxDropdownHeight:300})},code:s,centered:!0,maxWidth:340,defaultExpanded:!1}},25985:function(e,t,n){"use strict";n.d(t,{c:function(){return o}});var r=n(52322);let a=`.root {
  min-width: 200px;
  max-width: 100%;
  min-height: 120px;
