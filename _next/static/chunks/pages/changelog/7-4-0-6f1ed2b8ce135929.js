...
`,l={type:"code",component:function(){return r.createElement(o.Z,null,r.createElement(a.z,{color:"oklch-blue"},"Filled"),r.createElement(a.z,{color:"oklch-blue",variant:"outline"},"Outline"),r.createElement(a.z,{color:"oklch-blue",variant:"light"},"Light"))},code:i,centered:!0}},95829:function(e,n,t){"use strict";t.d(n,{v:function(){return M}});var r=t(27378),o=t(88058),a=t(97879),i=t(9911),l=t(24849),s=t(32529),c=t(26299),d=t(69972),h=(0,l.z)({chartName:"BarChart",GraphicalChild:o.$,defaultTooltipEventType:"axis",validateTooltipEventTypes:["axis","item"],axisComponents:[{axisType:"xAxis",AxisComp:s.K},{axisType:"yAxis",AxisComp:c.B}],formatAxisMap:d.t9}),p=t(46246),m=t(38616),u=t(44460),x=t(83453),f=t(89738),j=t(20410),g=t(96739),b=t(2256),v=t(5564),y=t(6231),w=t(56589),k=t(3525),A=t(96688),C=t(51010);function E(e){return`${(100*e).toFixed(0)}%`}let T={withXAxis:!0,withYAxis:!0,withTooltip:!0,tooltipAnimationDuration:0,fillOpacity:1,tickLine:"y",strokeDasharray:"5 5",gridAxis:"x",type:"default"},S=(0,x.Z)((e,{textColor:n,gridColor:t,cursorFill:r})=>({root:{"--chart-text-color":n?(0,f.p)(n,e):void 0,"--chart-grid-color":t?(0,f.p)(t,e):void 0,"--chart-cursor-fill":r?(0,f.p)(r,e):void 0}})),M=(0,j.d)((e,n)=>{let t=(0,g.w)("BarChart",T,e),{classNames:l,className:d,style:x,styles:j,unstyled:M,vars:I,data:L,withLegend:B,legendProps:N,series:q,onMouseLeave:z,dataKey:O,withTooltip:P,withXAxis:D,withYAxis:V,gridAxis:F,tickLine:H,xAxisProps:K,yAxisProps:G,unit:_,tooltipAnimationDuration:R,strokeDasharray:W,gridProps:Z,tooltipProps:$,referenceLines:Q,fillOpacity:Y,barChartProps:X,type:J,orientation:U,dir:ee,valueFormatter:en,...et}=t,er=(0,b.rZ)(),[eo,ea]=(0,r.useState)(null),ei=null!==eo,el="stacked"===J||"percent"===J,{resolvedClassNames:es,resolvedStyles:ec}=(0,v.h)({classNames:l,styles:j,props:t}),ed=(0,y.y)({name:"BarChart",classes:C.Z,props:t,className:d,style:x,classNames:l,styles:j,unstyled:M,vars:I,varsResolver:S}),eh=q.map(e=>{let n=(0,f.p)(e.color,er),t=ei&&eo!==e.name;return r.createElement(o.$,{...ed("bar"),key:e.name,name:e.name,dataKey:e.name,fill:n,stroke:n,isAnimationActive:!1,fillOpacity:t?.1:Y,strokeOpacity:t?.2:0,stackId:el?"stack":void 0})}),ep=Q?.map((e,n)=>{let t=f.p(e.color,er);return r.createElement(a.d,{key:n,stroke:e.color?t:"var(--chart-grid-color)",strokeWidth:1,...e,label:{value:e.label,fill:e.color?t:"currentColor",fontSize:12,position:e.labelPosition??"insideBottomLeft"},...ed("referenceLine")})});return r.createElement(w.x,{ref:n,...ed("root"),onMouseLeave:e=>{ea(null),z?.(e)},dir:ee||"ltr",...et},r.createElement(i.h,{...ed("container")},r.createElement(h,{data:L,stackOffset:"percent"===J?"expand":void 0,layout:U,...X},B&&r.createElement(p.D,{verticalAlign:"top",content:e=>r.createElement(k.Q,{payload:e.payload,onHighlight:ea,legendPosition:N?.verticalAlign||"top",classNames:es,styles:ec,series:q}),height:44,...N}),r.createElement(s.K,{hide:!D,..."vertical"===U?{type:"number"}:{dataKey:O},tick:{transform:"translate(0, 10)",fontSize:12,fill:"currentColor"},stroke:"",interval:"preserveStartEnd",tickLine:!!("none"!==F&&("x"===H||"xy"===H))&&{stroke:"currentColor"},minTickGap:5,...ed("axis"),...K}),r.createElement(c.B,{hide:!V,axisLine:!1,..."vertical"===U?{dataKey:O,type:"category"}:{type:"number"},tickLine:!!("none"!==F&&("y"===H||"xy"===H))&&{stroke:"currentColor"},tick:{transform:"translate(-10, 0)",fontSize:12,fill:"currentColor"},allowDecimals:!0,unit:_,tickFormatter:"percent"===J?E:en,...ed("axis"),...G}),r.createElement(m.q,{strokeDasharray:W,vertical:"y"===F||"xy"===F,horizontal:"x"===F||"xy"===F,...ed("grid"),...Z}),P&&r.createElement(u.u,{animationDuration:R,isAnimationActive:0!==R,position:{y:0},cursor:{stroke:"var(--chart-grid-color)",strokeWidth:1,strokeDasharray:W,fill:"var(--chart-cursor-fill)"},content:({label:e,payload:n})=>r.createElement(A.h,{label:e,payload:n,unit:_,classNames:es,styles:ec,series:q,valueFormatter:en}),...$}),eh,ep)))});M.displayName="@mantine/charts/BarChart",M.classes=C.Z},45875:function(e,n,t){"use strict";t.d(n,{w:function(){return E}});var r=t(27378),o=t(54446),a=t(97879),i=t(9911),l=t(75885),s=t(46246),c=t(32529),d=t(26299),h=t(38616),p=t(44460),m=t(83453),u=t(89738),x=t(20410),f=t(96739),j=t(2256),g=t(5564),b=t(6231),v=t(56589),y=t(3525),w=t(96688),k=t(51010);let A={withXAxis:!0,withYAxis:!0,withTooltip:!0,tooltipAnimationDuration:0,fillOpacity:1,tickLine:"y",strokeDasharray:"5 5",gridAxis:"x",withDots:!0,connectNulls:!0,strokeWidth:2,curveType:"monotone"},C=(0,m.Z)((e,{textColor:n,gridColor:t})=>({root:{"--chart-text-color":n?(0,u.p)(n,e):void 0,"--chart-grid-color":t?(0,u.p)(t,e):void 0}})),E=(0,x.d)((e,n)=>{let t=(0,f.w)("LineChart",A,e),{classNames:m,className:x,style:E,styles:T,unstyled:S,vars:M,data:I,withLegend:L,legendProps:B,series:N,onMouseLeave:q,dataKey:z,withTooltip:O,withXAxis:P,withYAxis:D,gridAxis:V,tickLine:F,xAxisProps:H,yAxisProps:K,unit:G,tooltipAnimationDuration:_,strokeDasharray:R,gridProps:W,tooltipProps:Z,referenceLines:$,withDots:Q,dotProps:Y,activeDotProps:X,strokeWidth:J,lineChartProps:U,connectNulls:ee,fillOpacity:en,curveType:et,orientation:er,dir:eo,valueFormatter:ea,...ei}=t,el=(0,j.rZ)(),[es,ec]=(0,r.useState)(null),ed=null!==es,{resolvedClassNames:eh,resolvedStyles:ep}=(0,g.h)({classNames:m,styles:T,props:t}),em=(0,b.y)({name:"LineChart",classes:k.Z,props:t,className:x,style:E,classNames:m,styles:T,unstyled:S,vars:M,varsResolver:C}),eu=N.map(e=>{let n=(0,u.p)(e.color,el),t=ed&&es!==e.name;return r.createElement(o.x,{...em("line"),key:e.name,name:e.name,dataKey:e.name,dot:!!Q&&{fillOpacity:t?0:1,strokeOpacity:t?0:1,...Y},activeDot:!!Q&&{fill:n,stroke:n,...X},fill:n,stroke:n,strokeWidth:J,isAnimationActive:!1,fillOpacity:t?0:en,strokeOpacity:t?.5:en,connectNulls:ee,type:et,strokeDasharray:e.strokeDasharray})}),ex=$?.map((e,n)=>{let t=u.p(e.color,el);return r.createElement(a.d,{key:n,stroke:e.color?t:"var(--chart-grid-color)",strokeWidth:1,...e,label:{value:e.label,fill:e.color?t:"currentColor",fontSize:12,position:e.labelPosition??"insideBottomLeft"},...em("referenceLine")})});return r.createElement(v.x,{ref:n,...em("root"),onMouseLeave:e=>{ec(null),q?.(e)},dir:eo||"ltr",...ei},r.createElement(i.h,{...em("container")},r.createElement(l.w,{data:I,layout:er,...U},L&&r.createElement(s.D,{verticalAlign:"top",content:e=>r.createElement(y.Q,{payload:e.payload,onHighlight:ec,legendPosition:B?.verticalAlign||"top",classNames:eh,styles:ep,series:N}),height:44,...B}),r.createElement(c.K,{hide:!P,..."vertical"===er?{type:"number"}:{dataKey:z},tick:{transform:"translate(0, 10)",fontSize:12,fill:"currentColor"},stroke:"",interval:"preserveStartEnd",tickLine:!!("none"!==V&&("x"===F||"xy"===F))&&{stroke:"currentColor"},minTickGap:5,...em("axis"),...H}),r.createElement(d.B,{hide:!D,axisLine:!1,..."vertical"===er?{dataKey:z,type:"category"}:{type:"number"},tickLine:!!("none"!==V&&("y"===F||"xy"===F))&&{stroke:"currentColor"},tick:{transform:"translate(-10, 0)",fontSize:12,fill:"currentColor"},allowDecimals:!0,unit:G,tickFormatter:ea,...em("axis"),...K}),r.createElement(h.q,{strokeDasharray:R,vertical:"y"===V||"xy"===V,horizontal:"x"===V||"xy"===V,...em("grid"),...W}),O&&r.createElement(p.u,{animationDuration:_,isAnimationActive:0!==_,position:{y:0},cursor:{stroke:"var(--chart-grid-color)",strokeWidth:1,strokeDasharray:R},content:({label:e,payload:n})=>r.createElement(w.h,{label:e,payload:n,unit:G,classNames:eh,styles:ep,series:N,valueFormatter:ea}),...Z}),eu,ex)))});E.displayName="@mantine/charts/LineChart",E.classes=k.Z},28535:function(e,n,t){"use strict";t.d(n,{b:function(){return j}});var r=t(27378),o=t(9911),a=t(290),i=t(68871),l=t(83453),s=t(89738),c=t(20410),d=t(96739),h=t(6231),p=t(56589),m=t(65923);let u={},x={withGradient:!0,fillOpacity:.6,strokeWidth:2,curveType:"linear"},f=(0,l.Z)((e,{color:n})=>({root:{"--chart-color":n?(0,s.p)(n,e):void 0}})),j=(0,c.d)((e,n)=>{let t=(0,d.w)("Sparkline",x,e),{classNames:l,className:s,style:c,styles:j,unstyled:g,vars:b,data:v,withGradient:y,fillOpacity:w,curveType:k,strokeWidth:A,...C}=t,E=(0,h.y)({name:"Sparkline",classes:u,props:t,className:s,style:c,classNames:l,styles:j,unstyled:g,vars:b,varsResolver:f}),T=(0,r.useId)(),S=(0,r.useMemo)(()=>v.map((e,n)=>({value:e,index:n})),[v]);return r.createElement(p.x,{ref:n,...E("root"),...C,dir:"ltr"},r.createElement(o.h,null,r.createElement(a.T,{data:S},r.createElement(i.u,{dataKey:"value",type:k,fill:`url(#${T})`,stroke:"var(--chart-color, var(--mantine-color-blue-filled))",isAnimationActive:!1,connectNulls:!0,strokeWidth:A,fillOpacity:1}),r.createElement("defs",null,r.createElement(m.v,{id:T,color:"var(--chart-color, var(--mantine-color-blue-filled))",fillOpacity:w,withGradient:y})))))});j.displayName="@mantine/charts/Sparkline",j.classes=u}},function(e){e.O(0,[30370,62740,60898,290,94014,15819,2775,56926,7654,3242,49774,92888,40179],function(){return e(e.s=90363)}),_N_E=e.O()}]);