...
`,centered:!0,component:function(){let[e,{open:t,close:n}]=(0,l.j)(!1);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(s.a,{opened:e,onClose:n,title:"Focus demo",children:[(0,r.jsx)(a.s.InitialFocus,{}),(0,r.jsx)(i.k,{label:"First input",placeholder:"First input"}),(0,r.jsx)(i.k,{"data-autofocus":!0,label:"Input with initial focus",placeholder:"It has data-autofocus attribute",mt:"md"})]}),(0,r.jsx)(o.$,{variant:"default",onClick:t,children:"Open modal"})]})}}},61492:(e,t,n)=>{"use strict";n.d(t,{l:()=>v});var r=n(6029),s=n(55729),a=n(2011),i=n(7798),o=n(72854),l=n(38757),c=n(38919),d=n(8411),h=n(1374),p=n(11660),u=n(2061),m=n(19341),x=n(28425),j=n(51718);let f={withCheckIcon:!0,allowDeselect:!0,checkIconPosition:"left",openOnFocus:!0},v=(0,d.P9)((e,t)=>{let n=(0,c.Y)("Select",f,e),{classNames:d,styles:v,unstyled:g,vars:y,dropdownOpened:b,defaultDropdownOpened:w,onDropdownClose:k,onDropdownOpen:S,onFocus:C,onBlur:T,onClick:I,onChange:P,data:A,value:O,defaultValue:F,selectFirstOptionOnChange:M,selectFirstOptionOnDropdownOpen:E,onOptionSubmit:R,comboboxProps:N,readOnly:D,disabled:L,filter:_,limit:G,withScrollArea:B,maxDropdownHeight:z,size:H,searchable:V,rightSection:q,checkIconPosition:J,withCheckIcon:W,withAlignedLabels:Y,nothingFoundMessage:U,name:K,form:Z,searchValue:$,defaultSearchValue:X,onSearchChange:Q,allowDeselect:ee,error:et,rightSectionPointerEvents:en,id:er,clearable:es,clearButtonProps:ea,hiddenInputProps:ei,renderOption:eo,onClear:el,autoComplete:ec,scrollAreaProps:ed,__defaultRightSection:eh,__clearSection:ep,__clearable:eu,chevronColor:em,autoSelectOnBlur:ex,openOnFocus:ej,attributes:ef,...ev}=n,eg=(0,s.useMemo)(()=>(0,h.d)(A),[A]),ey=(0,s.useRef)({}),eb=(0,s.useMemo)(()=>(0,p.D)(eg),[eg]),ew=(0,a.B)(er),[ek,eS,eC]=(0,i.Z)({value:O,defaultValue:F,finalValue:null,onChange:P}),eT="string"==typeof ek?ek in eb?eb[ek]:ey.current[ek]:void 0,eI=(0,o.Z)(eT),[eP,eA,eO]=(0,i.Z)({value:$,defaultValue:X,finalValue:eT?eT.label:"",onChange:Q}),eF=(0,x.B)({opened:b,defaultOpened:w,onDropdownOpen:()=>{S?.(),E?eF.selectFirstOption():eF.updateSelectedOptionIndex("active",{scrollIntoView:!0})},onDropdownClose:()=>{k?.(),setTimeout(eF.resetSelectedOption,0)}}),eM=e=>{eA(e),eF.resetSelectedOption()},{resolvedClassNames:eE,resolvedStyles:eR}=(0,l.Y)({props:n,styles:v,classNames:d});(0,s.useEffect)(()=>{M&&eF.selectFirstOption()},[M,eP]),(0,s.useEffect)(()=>{null===O&&eM(""),"string"==typeof O&&eT&&(eI?.value!==eT.value||eI?.label!==eT.label)&&eM(eT.label)},[O,eT]),(0,s.useEffect)(()=>{eC||eO||eM("string"==typeof ek?ek in eb?eb[ek]?.label:ey.current[ek]?.label||"":"")},[eb,ek]),(0,s.useEffect)(()=>{ek&&ek in eb&&(ey.current[ek]=eb[ek])},[eb,ek]);let eN=(0,r.jsx)(u.G.ClearButton,{...ea,onClear:()=>{eS(null,null),eM(""),el?.()}}),eD=es&&!!ek&&!L&&!D;return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(u.G,{store:eF,__staticSelector:"Select",classNames:eE,styles:eR,unstyled:g,readOnly:D,size:H,attributes:ef,keepMounted:ex,onOptionSubmit:e=>{R?.(e);let t=ee&&eb[e].value===ek?null:eb[e],n=t?t.value:null;n!==ek&&eS(n,t),eC||eM("string"==typeof n&&t?.label||""),eF.closeDropdown()},...N,children:[(0,r.jsx)(u.G.Target,{targetType:V?"input":"button",autoComplete:ec,children:(0,r.jsx)(j.O,{id:ew,ref:t,__defaultRightSection:(0,r.jsx)(u.G.Chevron,{size:H,error:et,unstyled:g,color:em}),__clearSection:eN,__clearable:eD,rightSection:q,rightSectionPointerEvents:en||"none",...ev,size:H,__staticSelector:"Select",disabled:L,readOnly:D||!V,value:eP,onChange:e=>{eM(e.currentTarget.value),eF.openDropdown(),M&&eF.selectFirstOption()},onFocus:e=>{ej&&V&&eF.openDropdown(),C?.(e)},onBlur:e=>{ex&&eF.clickSelectedOption(),V&&eF.closeDropdown();let t="string"==typeof ek&&(ek in eb?eb[ek]:ey.current[ek]);eM(t&&t.label||""),T?.(e)},onClick:e=>{V?eF.openDropdown():eF.toggleDropdown(),I?.(e)},classNames:eE,styles:eR,unstyled:g,pointer:!V,error:et,attributes:ef})}),(0,r.jsx)(m.i,{data:eg,hidden:D||L,filter:_,search:eP,limit:G,hiddenWhenEmpty:!U,withScrollArea:B,maxDropdownHeight:z,filterOptions:!!V&&eT?.label!==eP,value:ek,checkIconPosition:J,withCheckIcon:W,withAlignedLabels:Y,nothingFoundMessage:U,unstyled:g,labelId:ev.label?`${ew}-label`:void 0,"aria-label":ev.label?void 0:ev["aria-label"],renderOption:eo,scrollAreaProps:ed})]}),(0,r.jsx)(u.G.HiddenInput,{value:ek,name:K,form:Z,disabled:L,...ei})]})});v.classes={...j.O.classes,...u.G.classes},v.displayName="@mantine/core/Select"},70291:(e,t,n)=>{"use strict";n.d(t,{O:()=>v});var r=n(6029),s=n(55729),a=n(40684),i=n(56721),o=n(13297),l=n(33987),c=n(21351),d=n(8411),h=n(38919),p=n(15583),u=n(76320),m=n(34483);let x={},j={withGradient:!0,connectNulls:!0,fillOpacity:.6,strokeWidth:2,curveType:"linear"},f=(0,l.V)((e,{color:t,data:n,trendColors:r})=>({root:{"--chart-color":r?(0,c.r)(function(e,t){let n=e[0],r=e[e.length-1];return null===n||null===r?t.neutral||t.positive:n<r?t.positive:n>r?t.negative:t.neutral||t.positive}(n,r),e):t?(0,c.r)(t,e):void 0}})),v=(0,d.P9)((e,t)=>{let n=(0,h.Y)("Sparkline",j,e),{classNames:l,className:c,style:d,styles:v,unstyled:g,vars:y,data:b,withGradient:w,fillOpacity:k,curveType:S,strokeWidth:C,trendColors:T,connectNulls:I,areaProps:P,attributes:A,...O}=n,F=(0,p.I)({name:"Sparkline",classes:x,props:n,className:c,style:d,classNames:l,styles:v,unstyled:g,attributes:A,vars:y,varsResolver:f}),M=(0,s.useId)(),E=(0,s.useMemo)(()=>b.map((e,t)=>({value:e,index:t})),[b]);return(0,r.jsx)(u.a,{ref:t,...F("root"),...O,dir:"ltr",children:(0,r.jsx)(a.u,{children:(0,r.jsxs)(i.Q,{data:E,children:[(0,r.jsx)(o.G,{dataKey:"value",type:S,fill:`url(#${M})`,stroke:"var(--chart-color, var(--mantine-color-blue-filled))",isAnimationActive:!1,connectNulls:I,strokeWidth:C,fillOpacity:1,...P}),(0,r.jsx)("defs",{children:(0,r.jsx)(m.s,{id:M,color:"var(--chart-color, var(--mantine-color-blue-filled))",fillOpacity:k,withGradient:w})})]})})})});v.displayName="@mantine/charts/Sparkline",v.classes=x},71752:(e,t,n)=>{"use strict";n.d(t,{w:()=>c});var r=n(6029),s=n(57414),a=n(45208),i=n(4218);let o={Apples:{emoji:"\uD83C\uDF4E",description:"Crisp and juicy snacking delight"},Bread:{emoji:"\uD83C\uDF5E",description:"Freshly baked daily essential"},Bananas:{emoji:"\uD83C\uDF4C",description:"Perfect for a healthy breakfast"},Eggs:{emoji:"\uD83E\uDD5A",description:"Versatile protein source for cooking"},Broccoli:{emoji:"\uD83E\uDD66",description:"Nutrient-rich green vegetable"}},l=({option:e})=>(0,r.jsxs)(s.Y,{children:[(0,r.jsx)(a.E,{span:!0,fz:24,children:o[e.value].emoji}),(0,r.jsxs)("div",{children:[(0,r.jsx)(a.E,{children:e.value}),(0,r.jsx)(a.E,{size:"xs",opacity:.5,children:o[e.value].description})]})]}),c={type:"code",component:function(){return(0,r.jsx)(i.u,{data:["Apples","Bread","Bananas","Eggs","Broccoli"],renderOption:l,label:"Groceries",placeholder:"Pick tag from list or type to add new",maxDropdownHeight:300})},code:`
