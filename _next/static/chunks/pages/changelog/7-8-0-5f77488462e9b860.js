...
`,m={type:"code",component:function(){let e=(0,c.c)({mode:"uncontrolled",initialValues:{name:"",email:""},validate:{name:(0,i.d)({min:3},"Must be at least 3 characters"),email:(0,u.J)("Invalid email")}}),[t,n]=(0,r.useState)(null);return r.createElement("form",{onSubmit:e.onSubmit(n)},r.createElement(o.o,{...e.getInputProps("name"),key:e.key("name"),label:"Name",placeholder:"Name"}),r.createElement(o.o,{...e.getInputProps("email"),key:e.key("email"),mt:"md",label:"Email",placeholder:"Email"}),r.createElement(a.z,{type:"submit",mt:"md"},"Submit"),r.createElement(l.x,{mt:"md"},"Form values:"),r.createElement(s.E,{block:!0},JSON.stringify(e.values,null,2)),r.createElement(l.x,{mt:"md"},"Submitted values:"),r.createElement(s.E,{block:!0},t?JSON.stringify(t,null,2):"–"))},code:d,maxWidth:500,centered:!0,defaultExpanded:!1}},1383:function(e,t,n){"use strict";n.d(t,{Y:function(){return s}});var r=n(2784),o=n(74770),a=n(59259);let l=`
...
`,s={type:"code",component:function(){let e=(0,a.c)({mode:"uncontrolled",initialValues:{name:"",email:""}});return e.watch("name",({previousValue:e,value:t,touched:n,dirty:r})=>{console.log({previousValue:e,value:t,touched:n,dirty:r})}),r.createElement("div",null,r.createElement(o.o,{label:"Name",placeholder:"Name",key:e.key("name"),...e.getInputProps("name")}),r.createElement(o.o,{mt:"md",label:"Email",placeholder:"Email",key:e.key("email"),...e.getInputProps("email")}))},code:l,centered:!0,maxWidth:340}},50091:function(e,t,n){"use strict";n.d(t,{A:function(){return i}});var r=n(2784),o=n(74770),a=n(12491),l=n(8582),s=n(64006);let c=`
import { useState } from 'react';
