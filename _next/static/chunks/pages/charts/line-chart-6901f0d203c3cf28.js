...
`,E={type:"code",component:function(){return r.createElement(l.w,{h:300,data:i.aT,dataKey:"date",className:"m_91e7a08d",series:[{name:"Apples",color:"var(--line-color)"}]})},code:[{code:N,language:"tsx",fileName:"Demo.tsx"},{code:k,language:"scss",fileName:"Demo.module.css"},{code:i.op,language:"tsx",fileName:"data.ts"}]},K=`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,S={type:"code",component:function(){return r.createElement(l.w,{h:300,data:i.aT,dataKey:"date",className:"m_8fdc5499",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:M,language:"scss",fileName:"Demo.module.css"},{code:P,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},_=`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,I={type:"code",component:function(){return r.createElement(l.w,{h:300,data:i.aT,dataKey:"date",tooltipAnimationDuration:200,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:_,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},V=`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,U={type:"code",component:function(){return r.createElement(l.w,{h:300,data:i.aT,dataKey:"date",unit:"$",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:V,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]};var B=t(1198),Text=t(8582);let F=`
import { LineChart } from '@mantine/charts';
