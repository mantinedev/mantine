(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[63902],{82493:function(e,a,t){(window.__NEXT_P=window.__NEXT_P||[]).push(["/charts/scatter-chart",function(){return t(18574)}])},18574:function(e,a,t){"use strict";t.r(a),t.d(a,{default:function(){return $}});var n=t(52322),o=t(45392),r=t(89882),i=t(63098),s=t(48944);let l=`
...
`,d={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.bI,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI"})},code:[{code:l,language:"tsx",fileName:"Demo.tsx"},{code:s.KX,language:"tsx",fileName:"data.ts"}]},g=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,c={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.bI,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",withLegend:!0})},code:[{code:g,language:"tsx",fileName:"Demo.tsx"},{code:s.KX,language:"tsx",fileName:"data.ts"}]},m=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,h={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.bI,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",withLegend:!0,legendProps:{verticalAlign:"bottom",height:20}})},code:[{code:m,language:"tsx",fileName:"Demo.tsx"},{code:s.KX,language:"tsx",fileName:"data.ts"}]},p=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,x={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.aT,tickLine:"xy",yAxisProps:{tickMargin:15,orientation:"right"},xAxisProps:{tickMargin:15,orientation:"top"},dataKey:{x:"age",y:"BMI"}})},code:[{code:p,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},u=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,y={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.Vl,dataKey:{x:"age",y:"average_monthly_spending"},yAxisProps:{domain:[800,3400]},valueFormatter:{x:e=>`${e} years`,y:e=>`$${new Intl.NumberFormat("en-US").format(e)}`}})},code:[{code:u,language:"tsx",fileName:"Demo.tsx"},{code:s.mA,language:"tsx",fileName:"data.ts"}]},I=`
.root {
  @mixin light {
...
`,M={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.aT,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",className:"m_f09a294f"})},code:[{code:I,language:"scss",fileName:"Demo.module.css"},{code:B,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},f=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,_={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.aT,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",strokeDasharray:"15 15"})},code:[{code:f,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},v=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,j={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.Vl,dataKey:{x:"age",y:"average_monthly_spending"},yAxisProps:{domain:[800,3500]},unit:{y:"$"},labels:{x:"Age",y:"Spending"}})},code:[{code:v,language:"tsx",fileName:"Demo.tsx"},{code:s.mA,language:"tsx",fileName:"data.ts"}]},b=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,A={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.aT,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",labels:{x:"Age",y:"Body mass index"}})},code:[{code:b,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]};var L=t(1198),Text=t(8582);let C=`
import { ScatterChart } from '@mantine/charts';
...
`;function S({payload:e}){return e?(0,n.jsx)(L.X,{px:"md",py:"sm",withBorder:!0,shadow:"md",radius:"md",children:e.map(e=>(0,n.jsxs)(Text.x,{fz:"sm",children:[e.name,": ",e.value]},e.name))}):null}let w={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.aT,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",tooltipProps:{content:({payload:e})=>(0,n.jsx)(S,{payload:e})}})},code:[{code:C,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},D=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,N={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.aT,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",withTooltip:!1})},code:[{code:D,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},k=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,K={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.aT,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",tooltipAnimationDuration:200})},code:[{code:k,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},T=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,P={type:"code",component:function(){return(0,n.jsx)(i.G,{h:350,data:s.aT,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",scatterProps:{shape:(0,n.jsx)("circle",{r:3})}})},code:[{code:T,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},G=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
