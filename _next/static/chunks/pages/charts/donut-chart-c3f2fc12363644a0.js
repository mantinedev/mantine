...
`,language:"tsx"},{fileName:"data.ts",code:i.o,language:"tsx"}],centered:!0,controls:[{type:"boolean",prop:"withLabelsLine",initialValue:!0,libraryValue:"__"}]},d={type:"configurator",component:function(e){return(0,o.jsx)(l.Y,{...e,data:i.a,mih:300})},code:[{fileName:"Demo.tsx",code:`
import { DonutChart } from '@mantine/charts';
import { data } from './data';
...
`},50425:function(e,t,a){"use strict";a.d(t,{h:function(){return f},X:function(){return u}});var o=a(52322),n=a(82027),r=a(38483),l=a(68755),i=a(46690),s=a(27009),d=a(13588),c=a(28559),m=a(64438),h={tooltip:"m_e4d36c9b",tooltipLabel:"m_7f4bcb19",tooltipBody:"m_3de554dd",tooltipItem:"m_3de8964e",tooltipItemColor:"m_b30369b5",tooltipItemBody:"m_50186d10",tooltipItemName:"m_501dadf9",tooltipItemData:"m_50192318"};function u(e,t){let a=e.filter(e=>"none"!==e.fill||!e.color).map(e=>{let t=e.name.search(/\./);if(t>=0){let a=e.name.substring(0,t),o={...e.payload[a]},n=Object.entries(e.payload).reduce((e,t)=>{let[o,n]=t;return o===a?e:{...e,[o]:n}},{});return{...e,name:e.name.substring(t+1),payload:{...n,...o}}}return e});return t?a.filter(e=>e.name===t):a}function p(e,t){return"radial"===t||"scatter"===t?Array.isArray(e.value)?e.value[1]-e.value[0]:e.value:Array.isArray(e.payload[e.dataKey])?e.payload[e.dataKey][1]-e.payload[e.dataKey][0]:e.payload[e.name]}let x={type:"area",showColor:!0},f=(0,n.d5)((e,t)=>{let a=(0,r.w)("ChartTooltip",x,e),{classNames:n,className:f,style:g,styles:j,unstyled:y,vars:b,payload:v,label:D,unit:C,type:N,segmentId:_,mod:k,series:w,valueFormatter:A,showColor:S,...T}=a,Y=(0,l.rZ)(),I=(0,i.y)({name:"ChartTooltip",classes:h,props:a,className:f,style:g,classNames:n,styles:j,unstyled:y});if(!v)return null;let L=u(v,_),z="scatter"===N?v[0]?.payload?.name:null,V=(0,m.v)(w),U=D||z,B=L.map(e=>(0,o.jsxs)("div",{"data-type":N,...I("tooltipItem"),children:[(0,o.jsxs)("div",{...I("tooltipItemBody"),children:[S&&(0,o.jsx)(s.b,{color:(0,d.p)(e.color,Y),size:12,...I("tooltipItemColor"),withShadow:!1}),(0,o.jsx)("div",{...I("tooltipItemName"),children:V[e.name]||e.name})]}),(0,o.jsxs)("div",{...I("tooltipItemData"),children:["function"==typeof A?A(p(e,N)):p(e,N),C||e.unit]})]},e?.key??e.name));return(0,o.jsxs)(c.x,{...I("tooltip"),mod:[{type:N},k],ref:t,...T,children:[U&&(0,o.jsx)("div",{...I("tooltipLabel"),children:U}),(0,o.jsx)("div",{...I("tooltipBody"),children:B})]})});f.displayName="@mantine/charts/ChartTooltip"},27472:function(e,t,a){"use strict";a.d(t,{Y:function(){return D}});var o=a(52322),n=a(11011),r=a(18205),l=a(43454),i=a(79941),s=a(21154),d=a(11200),c=a(13588),m=a(58898),h=a(82027),u=a(38483),p=a(68755),x=a(46690),f=a(51477),g=a(28559),j=a(50425),y={root:"m_a410e613",label:"m_ddb0bfe3"};let b={withTooltip:!0,withLabelsLine:!0,paddingAngle:0,thickness:20,size:160,strokeWidth:1,startAngle:0,endAngle:360,tooltipDataSource:"all"},v=(0,d.Z)((e,{strokeColor:t,labelColor:a,withLabels:o,size:n})=>({root:{"--chart-stroke-color":t?(0,c.p)(t,e):void 0,"--chart-labels-color":a?(0,c.p)(a,e):void 0,"--chart-size":o?(0,m.h)(n+80):(0,m.h)(n)}})),D=(0,h.d5)((e,t)=>{let a=(0,u.w)("DonutChart",b,e),{classNames:d,className:m,style:h,styles:D,unstyled:C,vars:N,data:_,withTooltip:k,tooltipAnimationDuration:w,tooltipProps:A,pieProps:S,paddingAngle:T,withLabels:Y,withLabelsLine:I,size:L,thickness:z,strokeWidth:V,startAngle:U,endAngle:B,tooltipDataSource:E,chartLabel:O,children:P,pieChartProps:W,valueFormatter:K,strokeColor:Z,...F}=a,G=(0,p.rZ)(),X=(0,x.y)({name:"DonutChart",classes:y,props:a,className:m,style:h,classNames:d,styles:D,unstyled:C,vars:N,varsResolver:v}),{resolvedClassNames:J,resolvedStyles:R}=(0,f.h)({classNames:d,styles:D,props:a}),$=_.map((e,t)=>(0,o.jsx)(n.b,{fill:(0,c.p)(e.color,G),stroke:"var(--chart-stroke-color, var(--mantine-color-body))",strokeWidth:V},t));return(0,o.jsx)(g.x,{ref:t,size:L,...X("root"),...F,children:(0,o.jsx)(r.h,{children:(0,o.jsxs)(l.u,{...W,children:[(0,o.jsx)(i.b,{data:_,innerRadius:L/2-z,outerRadius:L/2,dataKey:"value",isAnimationActive:!1,paddingAngle:T,startAngle:U,endAngle:B,label:!!Y&&{fill:"var(--chart-labels-color, var(--mantine-color-dimmed))",fontSize:12,fontFamily:"var(--mantine-font-family)"},labelLine:!!I&&{stroke:"var(--chart-label-color, var(--mantine-color-dimmed))",strokeWidth:1},...S,children:$}),O&&(0,o.jsx)("text",{x:"50%",y:"50%",textAnchor:"middle",dominantBaseline:"middle",...X("label"),children:O}),k&&(0,o.jsx)(s.u,{animationDuration:w,isAnimationActive:!1,content:({payload:e})=>(0,o.jsx)(j.h,{payload:_,classNames:J,styles:R,type:"radial",segmentId:"segment"===E?e?.[0]?.name:void 0,valueFormatter:K}),...A}),P]})})})});D.displayName="@mantine/charts/DonutChart",D.classes=y},64438:function(e,t,a){"use strict";function o(e){return e?e.reduce((e,t)=>{let a=t.name.search(/\./);return a>=0?e[t.name.substring(a+1)]=t.label:e[t.name]=t.label,e},{}):{}}a.d(t,{v:function(){return o}})}},function(e){e.O(0,[61177,16717,59966,43454,66748,11340,92888,49774,40179],function(){return e(e.s=92833)}),_N_E=e.O()}]);