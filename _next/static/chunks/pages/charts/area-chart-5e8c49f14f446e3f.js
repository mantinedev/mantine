(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[26418],{29881:function(e,t,a){(window.__NEXT_P=window.__NEXT_P||[]).push(["/charts/area-chart",function(){return a(24614)}])},24614:function(e,t,a){"use strict";a.r(t),a.d(t,{default:function(){return eh}});var r=a(24246),o=a(71670),n=a(27378),i=a(44432),s=a(61566);let l=`
...
`,x={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",withLegend:!0,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:y,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},b=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,T={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",tickLine:"xy",yAxisProps:{tickMargin:15,orientation:"right"},xAxisProps:{tickMargin:15,orientation:"top"},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:k,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},C=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,P={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.xo,dataKey:"date",yAxisProps:{domain:[0,100]},series:[{name:"Apples",color:"indigo.6"}]})},code:[{code:O,language:"tsx",fileName:"Demo.tsx"},{code:s.Mm,language:"tsx",fileName:"data.ts"}]},D={type:"configurator",component:function(e){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",series:[{name:"Apples",color:e.color}],...e})},code:[{code:e=>`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}],controls:[{type:"color",prop:"color",initialValue:"blue",libraryValue:!0},{type:"boolean",prop:"withGradient",initialValue:!0,libraryValue:!0}]},N=`.root {
  @mixin light {
...
`,K={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",className:"m-13521d26",series:[{name:"Apples",color:"var(--area-color)"}]})},code:[{code:E,language:"tsx",fileName:"Demo.tsx"},{code:N,language:"scss",fileName:"Demo.module.css"},{code:s.op,language:"tsx",fileName:"data.ts"}]},S=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,V={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",strokeDasharray:"15 15",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:S,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},W=`
.root {
  @mixin light {
...
`,L={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",className:"m-3587e220",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:W,language:"scss",fileName:"Demo.module.css"},{code:z,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},_=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,U={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",tooltipAnimationDuration:200,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:_,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},I=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,F={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",unit:"$",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:I,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]};var B=a(96688),R=a(98477),Text=a(26569);let M=`
...
`;function Y({label:e,payload:t}){return t?n.createElement(R.X,{px:"md",py:"sm",withBorder:!0,shadow:"md",radius:"md"},n.createElement(Text.x,{fw:500,mb:5},e),(0,B.X)(t).map(e=>n.createElement(Text.x,{key:e.name,c:e.color,fz:"sm"},e.name,": ",e.value))):null}let G={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",tooltipProps:{content:({label:e,payload:t})=>n.createElement(Y,{label:e,payload:t})},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:M,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},X=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,H={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",withTooltip:!1,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:X,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},$=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,q={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",dotProps:{r:6,strokeWidth:2,stroke:"#fff"},activeDotProps:{r:8,strokeWidth:1,fill:"#fff"},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:$,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},J=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,Q={type:"configurator",component:function(e){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}],...e})},code:[{code:J,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}],controls:[{type:"number",prop:"strokeWidth",initialValue:2,libraryValue:null,step:.1,min:.5,max:5}]},Z=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,ee={type:"configurator",component:function(e){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"},{name:"Tomatoes",color:"teal.6"},{name:"Oranges",color:"blue.6"}],...e})},code:[{code:Z,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}],controls:[{type:"segmented",prop:"type",initialValue:"default",libraryValue:"default",transformLabel:!1,data:[{value:"default",label:"default"},{value:"stacked",label:"stacked"}]},{type:"number",prop:"fillOpacity",initialValue:.2,libraryValue:null,step:.01,min:0,max:1},{type:"boolean",prop:"withGradient",initialValue:!0,libraryValue:!0}]},et=`
...
`,ea={type:"code",component:function(){return n.createElement(n.Fragment,null,n.createElement(Text.x,{mb:"md",pl:"md"},"Apples sales:"),n.createElement(i.T,{h:180,data:s.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"}],areaChartProps:{syncId:"groceries"}}),n.createElement(Text.x,{mb:"md",pl:"md",mt:"xl"},"Tomatoes sales:"),n.createElement(i.T,{h:180,data:s.aT,dataKey:"date",areaChartProps:{syncId:"groceries"},series:[{name:"Tomatoes",color:"teal.6"}]}))},code:[{code:et,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},er=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,eo={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",orientation:"vertical",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:er,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},en=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,ei={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",strokeWidth:1,dotProps:{r:2},activeDotProps:{r:3,strokeWidth:1},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6",strokeDasharray:"5 5"}]})},code:[{code:en,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},es=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
