...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},C={type:"configurator",component:function(e){return(0,o.jsx)(n.E,{h:300,data:s.p,dataKey:"month",series:[{name:"Smartphones",color:e.color}],...e})},code:[{code:e=>`
import { BarChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"scss",fileName:"Demo.module.css"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},k={type:"code",component:function(){return(0,o.jsx)(n.E,{h:300,data:s.p,dataKey:"month",strokeDasharray:"15 15",series:[{name:"Smartphones",color:"violet.6"},{name:"Laptops",color:"blue.6"},{name:"Tablets",color:"teal.6"}]})},code:[{code:`
import { BarChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:n.Kk,language:"tsx",fileName:"data.ts"}]}}},e=>{var a=a=>e(e.s=a);e.O(0,[67456,53417,28054,39699,68831,17650,25883,90636,46593,38792],()=>a(51045)),_N_E=e.O()}]);