...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},x={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",xAxisLabel:"Date",yAxisLabel:"Amount",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},g={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",xAxisProps:{padding:{left:30,right:30}},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},f={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.xo,dataKey:"date",yAxisProps:{domain:[0,100]},series:[{name:"Apples",color:"indigo.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},b={type:"configurator",component:function(e){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",series:[{name:"Apples",color:e.color}],...e})},code:[{code:e=>`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}],controls:[{type:"color",prop:"color",initialValue:"blue",libraryValue:!0}]},A={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",className:"m_91e7a08d",series:[{name:"Apples",color:"var(--line-color)"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"scss",fileName:"Demo.module.css"},{code:i.op,language:"tsx",fileName:"data.ts"}]},v={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",strokeDasharray:"15 15",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},T={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",className:"m_8fdc5499",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
.root {
  @mixin light {
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},C={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",tooltipAnimationDuration:200,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},L={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",unit:"$",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},P={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",withTooltip:!1,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},O={type:"configurator",component:function(e){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}],...e})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}],controls:[{type:"number",prop:"strokeWidth",initialValue:2,libraryValue:null,step:.1,min:.5,max:5}]},M={type:"code",component:function(){return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(D.x,{mb:"md",pl:"md",children:"Apples sales:"}),(0,o.jsx)(n.w,{h:180,data:i.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"}],lineChartProps:{syncId:"groceries"}}),(0,o.jsx)(D.x,{mb:"md",pl:"md",mt:"xl",children:"Tomatoes sales:"}),(0,o.jsx)(n.w,{h:180,data:i.aT,dataKey:"date",lineChartProps:{syncId:"groceries"},series:[{name:"Tomatoes",color:"teal.6"}]})]})},code:[{code:`
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},S={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.aT,dataKey:"date",orientation:"vertical",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.op,language:"tsx",fileName:"data.ts"}]},_={type:"code",component:function(){return(0,o.jsx)(n.w,{h:300,data:i.xo,dataKey:"date",yAxisProps:{domain:[0,100]},referenceLines:[{y:40,label:"Average sales",color:"red.6"},{x:"Mar 25",label:"Report out"}],series:[{name:"Apples",color:"indigo.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:n.op,language:"tsx",fileName:"data.ts"}]}},33828:function(e,a,t){"use strict";t.d(a,{y:function(){return i}});var o=t(52322),r=t(67893),n=t(16690);let i={type:"code",component:function(){return(0,o.jsx)(r.w,{h:300,data:n.aT,dataKey:"date",withLegend:!0,withPointLabels:!0,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`},46293:function(e,a,t){"use strict";t.d(a,{Q:function(){return m}});var o=t(52322),r=t(82027),n=t(38483),i=t(46690),s=t(27009),l=t(28559),d=t(64438),c={legend:"m_847eaf",legendItem:"m_17da7e62",legendItemColor:"m_6e236e21",legendItemName:"m_8ff56c0d"};let p={},m=(0,r.d5)((e,a)=>{let t=(0,n.w)("ChartLegend",p,e),{classNames:r,className:m,style:h,styles:u,unstyled:x,vars:g,payload:f,onHighlight:y,legendPosition:j,mod:b,series:A,showColor:v,centered:T,...C}=t,L=(0,i.y)({name:"ChartLegend",classes:c,props:t,className:m,style:h,classNames:r,styles:u,unstyled:x});if(!f)return null;let w=f.filter(e=>"none"!==e.color).map(e=>{let a=e.dataKey?.split(".").pop();return{...e,dataKey:a,payload:{...e.payload,name:a,dataKey:a}}}),D=(0,d.v)(A),N=w.map((e,a)=>(0,o.jsxs)("div",{...L("legendItem"),onMouseEnter:()=>y(e.dataKey),onMouseLeave:()=>y(null),"data-without-color":!1===v||void 0,children:[(0,o.jsx)(s.b,{color:e.color,size:12,...L("legendItemColor"),withShadow:!1}),(0,o.jsx)("p",{...L("legendItemName"),children:D[e.dataKey]||e.dataKey})]},a));return(0,o.jsx)(l.x,{ref:a,mod:[{position:j,centered:T},b],...L("legend"),...C,children:N})});m.displayName="@mantine/charts/ChartLegend"},50425:function(e,a,t){"use strict";t.d(a,{h:function(){return x},X:function(){return m}});var o=t(52322),r=t(82027),n=t(38483),i=t(68755),s=t(46690),l=t(13588),d=t(28559),c=t(64438),p={tooltip:"m_e4d36c9b",tooltipLabel:"m_7f4bcb19",tooltipBody:"m_3de554dd",tooltipItemColor:"m_b30369b5",tooltipItem:"m_3de8964e",tooltipItemBody:"m_50186d10",tooltipItemName:"m_501dadf9",tooltipItemData:"m_50192318"};function m(e,a){let t=e.filter(e=>"none"!==e.fill||!e.color).map(e=>{if(!e.payload||e.payload[e.name])return e;let a=e.name.search(/\./);if(a>=0){let t=e.name.substring(0,a),o={...e.payload[t]},r=Object.entries(e.payload).reduce((e,a)=>{let[o,r]=a;return o===t?e:{...e,[o]:r}},{});return{...e,name:e.name.substring(a+1),payload:{...r,...o}}}return e});return a?t.filter(e=>e.name===a):t}function h(e,a){return"radial"===a||"scatter"===a?Array.isArray(e.value)?e.value[1]-e.value[0]:e.value:Array.isArray(e.payload[e.dataKey])?e.payload[e.dataKey][1]-e.payload[e.dataKey][0]:e.payload[e.name]}let u={type:"area",showColor:!0},x=(0,r.d5)((e,a)=>{let t=(0,n.w)("ChartTooltip",u,e),{classNames:r,className:x,style:g,styles:f,unstyled:y,vars:j,payload:b,label:A,unit:v,type:T,segmentId:C,mod:L,series:w,valueFormatter:D,showColor:N,...k}=t,P=(0,i.rZ)(),K=(0,s.y)({name:"ChartTooltip",classes:p,props:t,className:x,style:g,classNames:r,styles:f,unstyled:y});if(!b)return null;let O=m(b,C),M="scatter"===T?b[0]?.payload?.name:null,S=(0,c.v)(w),I=A||M,_=O.map(e=>(0,o.jsxs)("div",{"data-type":T,...K("tooltipItem"),children:[(0,o.jsxs)("div",{...K("tooltipItemBody"),children:[N&&(0,o.jsx)("svg",{...K("tooltipItemColor"),children:(0,o.jsx)("circle",{r:6,fill:(0,l.p)(e.color,P),width:12,height:12,cx:6,cy:6})}),(0,o.jsx)("div",{...K("tooltipItemName"),children:S[e.name]||e.name})]}),(0,o.jsxs)("div",{...K("tooltipItemData"),children:["function"==typeof D?D(h(e,T)):h(e,T),v||e.unit]})]},e?.key??e.name));return(0,o.jsxs)(d.x,{...K("tooltip"),mod:[{type:T},L],ref:a,...k,children:[I&&(0,o.jsx)("div",{...K("tooltipLabel"),children:I}),(0,o.jsx)("div",{...K("tooltipBody"),children:_})]})});x.displayName="@mantine/charts/ChartTooltip"},67893:function(e,a,t){"use strict";t.d(a,{w:function(){return O}});var o=t(52322),r=t(2784),n=t(63004),i=t(30840),s=t(18205),l=t(71572),d=t(25556),c=t(3131),p=t(69524),m=(0,l.z)({chartName:"LineChart",GraphicalChild:n.x,axisComponents:[{axisType:"xAxis",AxisComp:d.K},{axisType:"yAxis",AxisComp:c.B}],formatAxisMap:p.t9}),h=t(55734),u=t(81224),x=t(55484),g=t(21154),f=t(11200),y=t(13588),j=t(82027),b=t(38483),A=t(68755),v=t(51477),T=t(46690),C=t(28559),L=t(66178),w=t(46293),D=t(50425),N=t(13069),k=t(7064);let P={withXAxis:!0,withYAxis:!0,withTooltip:!0,tooltipAnimationDuration:0,fillOpacity:1,tickLine:"y",strokeDasharray:"5 5",gridAxis:"x",withDots:!0,connectNulls:!0,strokeWidth:2,curveType:"monotone",gradientStops:[{offset:0,color:"red"},{offset:100,color:"blue"}]},K=(0,f.Z)((e,{textColor:a,gridColor:t})=>({root:{"--chart-text-color":a?(0,y.p)(a,e):void 0,"--chart-grid-color":t?(0,y.p)(t,e):void 0}})),O=(0,j.d5)((e,a)=>{let t=(0,b.w)("LineChart",P,e),{classNames:l,className:p,style:f,styles:j,unstyled:O,vars:M,data:S,withLegend:I,legendProps:_,series:F,onMouseLeave:Y,dataKey:V,withTooltip:B,withXAxis:U,withYAxis:W,gridAxis:z,tickLine:E,xAxisProps:R,yAxisProps:$,unit:X,tooltipAnimationDuration:Z,strokeDasharray:G,gridProps:J,tooltipProps:H,referenceLines:q,withDots:Q,dotProps:ee,activeDotProps:ea,strokeWidth:et,lineChartProps:eo,connectNulls:er,fillOpacity:en,curveType:ei,orientation:es,dir:el,valueFormatter:ed,children:ec,lineProps:ep,xAxisLabel:em,yAxisLabel:eh,type:eu,gradientStops:ex,withRightYAxis:eg,rightYAxisLabel:ef,rightYAxisProps:ey,withPointLabels:ej,...eb}=t,eA=(0,A.rZ)(),[ev,eT]=(0,r.useState)(null),eC=null!==ev,{resolvedClassNames:eL,resolvedStyles:ew}=(0,v.h)({classNames:l,styles:j,props:t}),eD=(0,T.y)({name:"LineChart",classes:k.Z,props:t,className:p,style:f,classNames:l,styles:j,unstyled:O,vars:M,varsResolver:K}),eN=(0,L.M)(),ek=`line-chart-gradient-${eN}`,eP=ex?.map(e=>o.jsx("stop",{offset:`${e.offset}%`,stopColor:y.p(e.color,eA)},e.color)),eK=F.map(e=>{let a=(0,y.p)(e.color,eA),t=eC&&ev!==e.name;return(0,r.createElement)(n.x,{...eD("line"),key:e.name,name:e.name,dataKey:e.name,dot:!!Q&&{fillOpacity:t?0:1,strokeOpacity:t?0:1,strokeWidth:1,fill:"gradient"===eu?"var(--mantine-color-gray-7)":a,stroke:"gradient"===eu?"white":a,...ee},activeDot:!!Q&&{fill:"gradient"===eu?"var(--mantine-color-gray-7)":a,stroke:"gradient"===eu?"white":a,...ea},fill:a,stroke:"gradient"===eu?`url(#${ek})`:a,strokeWidth:et,isAnimationActive:!1,fillOpacity:t?0:en,strokeOpacity:t?.5:en,connectNulls:er,type:ei,strokeDasharray:e.strokeDasharray,yAxisId:e.yAxisId||"left",label:ej?(0,o.jsx)(N.S,{valueFormatter:ed}):void 0,..."function"==typeof ep?ep(e):ep})}),eO=q?.map((e,a)=>{let t=y.p(e.color,eA);return o.jsx(i.d,{stroke:e.color?t:"var(--chart-grid-color)",strokeWidth:1,yAxisId:e.yAxisId||"left",...e,label:{value:e.label,fill:e.color?t:"currentColor",fontSize:12,position:e.labelPosition??"insideBottomLeft"},...eD("referenceLine")},a)}),eM={axisLine:!1,..."vertical"===es?{dataKey:V,type:"category"}:{type:"number"},tickLine:!!("none"!==z&&("y"===E||"xy"===E))&&{stroke:"currentColor"},allowDecimals:!0,unit:X,tickFormatter:"vertical"===es?void 0:ed,...eD("axis")};return(0,o.jsx)(C.x,{ref:a,...eD("root"),onMouseLeave:e=>{eT(null),Y?.(e)},dir:el||"ltr",...eb,children:(0,o.jsx)(s.h,{...eD("container"),children:(0,o.jsxs)(m,{data:S,layout:es,margin:{bottom:em?30:void 0,left:eh?10:void 0,right:eh?5:void 0},...eo,children:["gradient"===eu&&(0,o.jsx)("defs",{children:(0,o.jsx)("linearGradient",{id:ek,x1:"0",y1:"0",x2:"0",y2:"1",children:eP})}),I&&(0,o.jsx)(h.D,{verticalAlign:"top",content:e=>(0,o.jsx)(w.Q,{payload:e.payload,onHighlight:eT,legendPosition:_?.verticalAlign||"top",classNames:eL,styles:ew,series:F,showColor:"gradient"!==eu}),..._}),(0,o.jsxs)(d.K,{hide:!U,..."vertical"===es?{type:"number"}:{dataKey:V},tick:{transform:"translate(0, 10)",fontSize:12,fill:"currentColor"},stroke:"",interval:"preserveStartEnd",tickLine:!!("none"!==z&&("x"===E||"xy"===E))&&{stroke:"currentColor"},minTickGap:5,tickFormatter:"vertical"===es?ed:void 0,...eD("axis"),...R,children:[em&&(0,o.jsx)(u._,{position:"insideBottom",offset:-20,fontSize:12,...eD("axisLabel"),children:em}),R?.children]}),(0,o.jsxs)(c.B,{yAxisId:"left",orientation:"left",tick:{transform:"translate(-10, 0)",fontSize:12,fill:"currentColor"},hide:!W,...eM,...$,children:[eh&&(0,o.jsx)(u._,{position:"insideLeft",angle:-90,textAnchor:"middle",fontSize:12,offset:-5,...eD("axisLabel"),children:eh}),$?.children]}),(0,o.jsxs)(c.B,{yAxisId:"right",orientation:"right",tick:{transform:"translate(10, 0)",fontSize:12,fill:"currentColor"},hide:!eg,...eM,...ey,children:[ef&&(0,o.jsx)(u._,{position:"insideRight",angle:90,textAnchor:"middle",fontSize:12,offset:-5,...eD("axisLabel"),children:ef}),$?.children]}),(0,o.jsx)(x.q,{strokeDasharray:G,vertical:"y"===z||"xy"===z,horizontal:"x"===z||"xy"===z,...eD("grid"),...J}),B&&(0,o.jsx)(g.u,{animationDuration:Z,isAnimationActive:0!==Z,position:"vertical"===es?{}:{y:0},cursor:{stroke:"var(--chart-grid-color)",strokeWidth:1,strokeDasharray:G},content:({label:e,payload:a})=>(0,o.jsx)(D.h,{label:e,payload:a,unit:X,classNames:eL,styles:ew,series:F,valueFormatter:ed,showColor:"gradient"!==eu}),...H}),eK,eO,ec]})})})});O.displayName="@mantine/charts/LineChart",O.classes=k.Z},13069:function(e,a,t){"use strict";t.d(a,{S:function(){return r}});var o=t(52322);function r({x:e,y:a,value:t,valueFormatter:r}){return(0,o.jsx)("g",{transform:`translate(${e},${a})`,children:(0,o.jsx)("text",{x:0,y:0,dy:-8,dx:-10,textAnchor:"top",fill:"var(--chart-text-color, var(--mantine-color-dimmed))",fontSize:8,children:r?r(t):t})})}},7064:function(e,a,t){"use strict";t.d(a,{Z:function(){return o}});var o={root:"m_a50f3e58",container:"m_af9188cb",grid:"m_a50a48bc",axis:"m_a507a517",axisLabel:"m_2293801d",tooltip:"m_92b296cd"}},64438:function(e,a,t){"use strict";function o(e){return e?e.reduce((e,a)=>{let t=a.name.search(/\./);return t>=0?e[a.name.substring(t+1)]=a.label:e[a.name]=a.label,e},{}):{}}t.d(a,{v:function(){return o}})}},function(e){e.O(0,[61177,5248,90160,91097,66748,11340,92888,49774,40179],function(){return e(e.s=77042)}),_N_E=e.O()}]);