(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[26418],{36399:function(e,a,t){(window.__NEXT_P=window.__NEXT_P||[]).push(["/charts/area-chart",function(){return t(43928)}])},43928:function(e,a,t){"use strict";t.r(a),t.d(a,{default:function(){return ey}});var r=t(52322),o=t(45392),n=t(2784),i=t(24634),s=t(99803);let l=`
...
`,D={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",xAxisProps:{padding:{left:30,right:30}},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:w,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},P=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,N={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.xo,dataKey:"date",yAxisProps:{domain:[0,100]},series:[{name:"Apples",color:"indigo.6"}]})},code:[{code:P,language:"tsx",fileName:"Demo.tsx"},{code:s.Mm,language:"tsx",fileName:"data.ts"}]},E=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,K={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",tickLine:"xy",xAxisProps:{angle:-20},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:E,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]};var S=t(19055);let V={type:"configurator",component:function(e){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",series:[{name:"Apples",color:e.color}],...e})},code:[{code:e=>`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,z={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",className:"m-13521d26",series:[{name:"Apples",color:"var(--area-color)"}]})},code:[{code:W,language:"tsx",fileName:"Demo.tsx"},{code:L,language:"scss",fileName:"Demo.module.css"},{code:s.op,language:"tsx",fileName:"data.ts"}]},_=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,U={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",strokeDasharray:"15 15",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:_,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},F=`
.root {
  @mixin light {
...
`,B={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",className:"m-3587e220",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:F,language:"scss",fileName:"Demo.module.css"},{code:I,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},R=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,M={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",tooltipAnimationDuration:200,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:R,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},Y=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,G={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",unit:"$",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:Y,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]};var X=t(50425),H=t(1198),Text=t(8582);let $=`
...
`;function q({label:e,payload:a}){return a?n.createElement(H.X,{px:"md",py:"sm",withBorder:!0,shadow:"md",radius:"md"},n.createElement(Text.x,{fw:500,mb:5},e),(0,X.X)(a).map(e=>n.createElement(Text.x,{key:e.name,c:e.color,fz:"sm"},e.name,": ",e.value))):null}let Z={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",tooltipProps:{content:({label:e,payload:a})=>n.createElement(q,{label:e,payload:a})},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:$,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},J=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,Q={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",withTooltip:!1,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:J,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},ee=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,ea={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",dotProps:{r:6,strokeWidth:2,stroke:"#fff"},activeDotProps:{r:8,strokeWidth:1,fill:"#fff"},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:ee,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},et=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,er={type:"configurator",component:function(e){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}],...e})},code:[{code:et,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}],controls:[{type:"number",prop:"strokeWidth",initialValue:2,libraryValue:null,step:.1,min:.5,max:5}]},eo=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,en={type:"configurator",component:function(e){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"},{name:"Tomatoes",color:"teal.6"},{name:"Oranges",color:"blue.6"}],...e})},code:[{code:eo,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}],controls:[{type:"segmented",prop:"type",initialValue:"default",libraryValue:"default",transformLabel:!1,data:[{value:"default",label:"default"},{value:"stacked",label:"stacked"}]},{type:"number",prop:"fillOpacity",initialValue:.2,libraryValue:null,step:.01,min:0,max:1},{type:"boolean",prop:"withGradient",initialValue:!0,libraryValue:!0}]},ei=`
...
`,es={type:"code",component:function(){return n.createElement(n.Fragment,null,n.createElement(Text.x,{mb:"md",pl:"md"},"Apples sales:"),n.createElement(i.T,{h:180,data:s.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"}],areaChartProps:{syncId:"groceries"}}),n.createElement(Text.x,{mb:"md",pl:"md",mt:"xl"},"Tomatoes sales:"),n.createElement(i.T,{h:180,data:s.aT,dataKey:"date",areaChartProps:{syncId:"groceries"},series:[{name:"Tomatoes",color:"teal.6"}]}))},code:[{code:ei,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},el=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,ec={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",orientation:"vertical",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:el,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},ed=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,ep={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",strokeWidth:1,dotProps:{r:2},activeDotProps:{r:3,strokeWidth:1},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6",strokeDasharray:"5 5"}]})},code:[{code:ed,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},em=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,s={type:"code",component:function(){return r.createElement(o.T,{h:300,data:n.aT,dataKey:"date",type:"stacked",xAxisLabel:"Date",yAxisLabel:"Amount",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:i,language:"tsx",fileName:"Demo.tsx"},{code:n.op,language:"tsx",fileName:"data.ts"}]}},94884:function(e,a,t){"use strict";t.d(a,{Z:function(){return s}});var r=t(2784),o=t(24634),n=t(99803);let i=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,s={type:"code",component:function(){return r.createElement(o.T,{h:300,data:n.aT,dataKey:"date",type:"stacked",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:i,language:"tsx",fileName:"Demo.tsx"},{code:n.op,language:"tsx",fileName:"data.ts"}]}},19055:function(e,a,t){"use strict";t.d(a,{w:function(){return s}});var r=t(2784),o=t(24634),n=t(99803);let i=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
