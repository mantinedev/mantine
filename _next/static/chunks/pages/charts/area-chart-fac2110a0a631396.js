...
`,_={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",className:"m_13521d26",series:[{name:"Apples",color:"var(--area-color)"}]})},code:[{code:W,language:"tsx",fileName:"Demo.tsx"},{code:L,language:"scss",fileName:"Demo.module.css"},{code:s.op,language:"tsx",fileName:"data.ts"}]},z=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,U={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",strokeDasharray:"15 15",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:z,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},F=`
.root {
  @mixin light {
