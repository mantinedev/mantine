(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[56635],{71129:(e,a,t)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/charts/line-chart",function(){return t(30686)}])},30686:(e,a,t)=>{"use strict";t.r(a),t.d(a,{default:()=>B});var o=t(31085),r=t(71184),n=t(14080),s=t(83562);let i={type:"configurator",component:function(e){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}],...e})},code:[{code:`
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},p={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",withLegend:!0,legendProps:{verticalAlign:"bottom"},series:[{name:"Apples",label:"Apples sales",color:"indigo.6"},{name:"Oranges",label:"Oranges sales",color:"blue.6"},{name:"Tomatoes",label:"Tomatoes sales",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},m={type:"configurator",component:function(e){return(0,o.jsx)(n.b,{h:300,data:s.v1,dataKey:"date",series:[{name:"Apples",color:"indigo.6"}],...e})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},x={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",xAxisLabel:"Date",yAxisLabel:"Amount",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},g={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",xAxisProps:{padding:{left:30,right:30}},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},f={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.sC,dataKey:"date",yAxisProps:{domain:[0,100]},series:[{name:"Apples",color:"indigo.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.dX,language:"tsx",fileName:"data.ts"}]};var y=t(75892);let b={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",valueFormatter:e=>new Intl.NumberFormat("en-US").format(e),series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},j={type:"configurator",component:function(e){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",series:[{name:"Apples",color:e.color}],...e})},code:[{code:e=>`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"scss",fileName:"Demo.module.css"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},C={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",strokeDasharray:"15 15",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]};var L={root:"m_8fdc5499"};let k={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",className:L.root,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
.root {
  @mixin light {
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},T={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",tooltipAnimationDuration:200,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},D={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",unit:"$",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},O={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",withTooltip:!1,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},S={type:"configurator",component:function(e){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}],...e})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}],controls:[{type:"number",prop:"strokeWidth",initialValue:2,libraryValue:null,step:.1,min:.5,max:5}]},I={type:"code",component:function(){return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(w.E,{mb:"md",pl:"md",children:"Apples sales:"}),(0,o.jsx)(n.b,{h:180,data:s.p,dataKey:"date",series:[{name:"Apples",color:"indigo.6"}],lineChartProps:{syncId:"groceries"}}),(0,o.jsx)(w.E,{mb:"md",pl:"md",mt:"xl",children:"Tomatoes sales:"}),(0,o.jsx)(n.b,{h:180,data:s.p,dataKey:"date",lineChartProps:{syncId:"groceries"},series:[{name:"Tomatoes",color:"teal.6"}]})]})},code:[{code:`
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},_={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",orientation:"vertical",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},Y={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.p,dataKey:"date",dotProps:{r:2},activeDotProps:{r:3,strokeWidth:1},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6",strokeDasharray:"5 5"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.kZ,language:"tsx",fileName:"data.ts"}]},Z={type:"code",component:function(){return(0,o.jsx)(n.b,{h:300,data:s.sC,dataKey:"date",yAxisProps:{domain:[0,100]},referenceLines:[{y:40,label:"Average sales",color:"red.6"},{x:"Mar 25",label:"Report out"}],series:[{name:"Apples",color:"indigo.6"}]})},code:[{code:`
import { LineChart } from '@mantine/charts';
import { data } from './data';
...
`,n=[{date:"Mar 22",Apples:110},{date:"Mar 23",Apples:60},{date:"Mar 24",Apples:80},{date:"Mar 25",Apples:null},{date:"Mar 26",Apples:null},{date:"Mar 27",Apples:40},{date:"Mar 28",Apples:120},{date:"Mar 29",Apples:80}],s=`
export const data = [
  {
    date: 'Mar 22',
    Apples: 110,
...
`},50571:(e,a,t)=>{"use strict";t.d(a,{_:()=>m});var o=t(31085),r=t(6754),n=t(29686),s=t(69564),i=t(14318),l=t(34056),d=t(88500),c={legend:"m_847eaf",legendItem:"m_17da7e62",legendItemColor:"m_6e236e21",legendItemName:"m_8ff56c0d"};let p={},m=(0,r.P9)((e,a)=>{let t=(0,n.Y)("ChartLegend",p,e),{classNames:r,className:m,style:h,styles:u,unstyled:x,vars:g,payload:f,onHighlight:y,legendPosition:b,mod:j,series:A,showColor:v,centered:C,...L}=t,k=(0,s.I)({name:"ChartLegend",classes:c,props:t,className:m,style:h,classNames:r,styles:u,unstyled:x});if(!f)return null;let T=f.filter(e=>"none"!==e.color).map(e=>{let a=e.dataKey?.split(".").pop();return{...e,dataKey:a,payload:{...e.payload,name:a,dataKey:a}}}),D=(0,d.J)(A),N=T.map((e,a)=>(0,o.jsxs)("div",{...k("legendItem"),onMouseEnter:()=>y(e.dataKey),onMouseLeave:()=>y(null),"data-without-color":!1===v||void 0,children:[(0,o.jsx)(i.q,{color:e.color,size:12,...k("legendItemColor"),withShadow:!1}),(0,o.jsx)("p",{...k("legendItemName"),children:D[e.dataKey]||e.dataKey})]},a));return(0,o.jsx)(l.a,{ref:a,mod:[{position:b,centered:C},j],...k("legend"),...L,children:N})});m.displayName="@mantine/charts/ChartLegend"},93581:(e,a,t)=>{"use strict";t.d(a,{I:()=>x,r:()=>m});var o=t(31085),r=t(6754),n=t(29686),s=t(92408),i=t(69564),l=t(51606),d=t(34056),c=t(88500),p={tooltip:"m_e4d36c9b",tooltipLabel:"m_7f4bcb19",tooltipBody:"m_3de554dd",tooltipItemColor:"m_b30369b5",tooltipItem:"m_3de8964e",tooltipItemBody:"m_50186d10",tooltipItemName:"m_501dadf9",tooltipItemData:"m_50192318"};function m(e,a){let t=e.filter(e=>"none"!==e.fill||!e.color).map(e=>{if(!e.payload||e.payload[e.name])return e;let a=e.name.search(/\./);if(a>=0){let t=e.name.substring(0,a),o={...e.payload[t]},r=Object.entries(e.payload).reduce((e,a)=>{let[o,r]=a;return o===t?e:{...e,[o]:r}},{});return{...e,name:e.name.substring(a+1),payload:{...r,...o}}}return e});return a?t.filter(e=>e.name===a):t}function h(e,a){return"radial"===a||"scatter"===a?Array.isArray(e.value)?e.value[1]-e.value[0]:e.value:Array.isArray(e.payload[e.dataKey])?e.payload[e.dataKey][1]-e.payload[e.dataKey][0]:e.payload[e.name]}let u={type:"area",showColor:!0},x=(0,r.P9)((e,a)=>{let t=(0,n.Y)("ChartTooltip",u,e),{classNames:r,className:x,style:g,styles:f,unstyled:y,vars:b,payload:j,label:A,unit:v,type:C,segmentId:L,mod:k,series:T,valueFormatter:D,showColor:N,...w}=t,P=(0,s.xd)(),K=(0,i.I)({name:"ChartTooltip",classes:p,props:t,className:x,style:g,classNames:r,styles:f,unstyled:y});if(!j)return null;let O=m(j,L),M="scatter"===C?j[0]?.payload?.name:null,S=(0,c.J)(T),I=A||M,_=O.map(e=>(0,o.jsxs)("div",{"data-type":C,...K("tooltipItem"),children:[(0,o.jsxs)("div",{...K("tooltipItemBody"),children:[N&&(0,o.jsx)("svg",{...K("tooltipItemColor"),children:(0,o.jsx)("circle",{r:6,fill:(0,l.r)(e.color,P),width:12,height:12,cx:6,cy:6})}),(0,o.jsx)("div",{...K("tooltipItemName"),children:S[e.name]||e.name})]}),(0,o.jsxs)("div",{...K("tooltipItemData"),children:["function"==typeof D?D(h(e,C)):h(e,C),v||e.unit]})]},e?.key??e.name));return(0,o.jsxs)(d.a,{...K("tooltip"),mod:[{type:C},k],ref:a,...w,children:[I&&(0,o.jsx)("div",{...K("tooltipLabel"),children:I}),(0,o.jsx)("div",{...K("tooltipBody"),children:_})]})});x.displayName="@mantine/charts/ChartTooltip"},14080:(e,a,t)=>{"use strict";t.d(a,{b:()=>O});var o=t(31085),r=t(14041),n=t(64174),s=t(67393),i=t(79874),l=t(20904),d=t(98331),c=t(51492),p=t(14713),m=(0,l.gu)({chartName:"LineChart",GraphicalChild:n.N,axisComponents:[{axisType:"xAxis",AxisComp:d.W},{axisType:"yAxis",AxisComp:c.h}],formatAxisMap:p.pr}),h=t(23361),u=t(94437),x=t(12012),g=t(37662),f=t(7098),y=t(51606),b=t(6754),j=t(29686),A=t(92408),v=t(36456),C=t(69564),L=t(34056),k=t(97567),T=t(50571),D=t(93581),N=t(6804),w=t(94563);let P={withXAxis:!0,withYAxis:!0,withTooltip:!0,tooltipAnimationDuration:0,fillOpacity:1,tickLine:"y",strokeDasharray:"5 5",gridAxis:"x",withDots:!0,connectNulls:!0,strokeWidth:2,curveType:"monotone",gradientStops:[{offset:0,color:"red"},{offset:100,color:"blue"}]},K=(0,f.V)((e,{textColor:a,gridColor:t})=>({root:{"--chart-text-color":a?(0,y.r)(a,e):void 0,"--chart-grid-color":t?(0,y.r)(t,e):void 0}})),O=(0,b.P9)((e,a)=>{let t=(0,j.Y)("LineChart",P,e),{classNames:l,className:p,style:f,styles:b,unstyled:O,vars:M,data:S,withLegend:I,legendProps:_,series:Y,onMouseLeave:Z,dataKey:V,withTooltip:F,withXAxis:U,withYAxis:E,gridAxis:B,tickLine:W,xAxisProps:z,yAxisProps:J,unit:R,tooltipAnimationDuration:X,strokeDasharray:$,gridProps:G,tooltipProps:H,referenceLines:q,withDots:Q,dotProps:ee,activeDotProps:ea,strokeWidth:et,lineChartProps:eo,connectNulls:er,fillOpacity:en,curveType:es,orientation:ei,dir:el,valueFormatter:ed,children:ec,lineProps:ep,xAxisLabel:em,yAxisLabel:eh,type:eu,gradientStops:ex,withRightYAxis:eg,rightYAxisLabel:ef,rightYAxisProps:ey,withPointLabels:eb,...ej}=t,eA=(0,A.xd)(),[ev,eC]=(0,r.useState)(null),eL=null!==ev,{resolvedClassNames:ek,resolvedStyles:eT}=(0,v.Y)({classNames:l,styles:b,props:t}),eD=(0,C.I)({name:"LineChart",classes:w.A,props:t,className:p,style:f,classNames:l,styles:b,unstyled:O,vars:M,varsResolver:K}),eN=(0,k.B)(),ew=`line-chart-gradient-${eN}`,eP=ex?.map(e=>o.jsx("stop",{offset:`${e.offset}%`,stopColor:y.r(e.color,eA)},e.color)),eK=Y.map(e=>{let a=(0,y.r)(e.color,eA),t=eL&&ev!==e.name;return(0,r.createElement)(n.N,{...eD("line"),key:e.name,name:e.name,dataKey:e.name,dot:!!Q&&{fillOpacity:t?0:1,strokeOpacity:t?0:1,strokeWidth:1,fill:"gradient"===eu?"var(--mantine-color-gray-7)":a,stroke:"gradient"===eu?"white":a,...ee},activeDot:!!Q&&{fill:"gradient"===eu?"var(--mantine-color-gray-7)":a,stroke:"gradient"===eu?"white":a,...ea},fill:a,stroke:"gradient"===eu?`url(#${ew})`:a,strokeWidth:et,isAnimationActive:!1,fillOpacity:t?0:en,strokeOpacity:t?.5:en,connectNulls:er,type:es,strokeDasharray:e.strokeDasharray,yAxisId:e.yAxisId||"left",label:eb?(0,o.jsx)(N.x,{valueFormatter:ed}):void 0,..."function"==typeof ep?ep(e):ep})}),eO=q?.map((e,a)=>{let t=y.r(e.color,eA);return o.jsx(s.e,{stroke:e.color?t:"var(--chart-grid-color)",strokeWidth:1,yAxisId:e.yAxisId||"left",...e,label:{value:e.label,fill:e.color?t:"currentColor",fontSize:12,position:e.labelPosition??"insideBottomLeft"},...eD("referenceLine")},a)}),eM={axisLine:!1,..."vertical"===ei?{dataKey:V,type:"category"}:{type:"number"},tickLine:!!("none"!==B&&("y"===W||"xy"===W))&&{stroke:"currentColor"},allowDecimals:!0,unit:R,tickFormatter:"vertical"===ei?void 0:ed,...eD("axis")};return(0,o.jsx)(L.a,{ref:a,...eD("root"),onMouseLeave:e=>{eC(null),Z?.(e)},dir:el||"ltr",...ej,children:(0,o.jsx)(i.u,{...eD("container"),children:(0,o.jsxs)(m,{data:S,layout:ei,margin:{bottom:em?30:void 0,left:eh?10:void 0,right:eh?5:void 0},...eo,children:["gradient"===eu&&(0,o.jsx)("defs",{children:(0,o.jsx)("linearGradient",{id:ew,x1:"0",y1:"0",x2:"0",y2:"1",children:eP})}),I&&(0,o.jsx)(h.s,{verticalAlign:"top",content:e=>(0,o.jsx)(T._,{payload:e.payload,onHighlight:eC,legendPosition:_?.verticalAlign||"top",classNames:ek,styles:eT,series:Y,showColor:"gradient"!==eu}),..._}),(0,o.jsxs)(d.W,{hide:!U,..."vertical"===ei?{type:"number"}:{dataKey:V},tick:{transform:"translate(0, 10)",fontSize:12,fill:"currentColor"},stroke:"",interval:"preserveStartEnd",tickLine:!!("none"!==B&&("x"===W||"xy"===W))&&{stroke:"currentColor"},minTickGap:5,tickFormatter:"vertical"===ei?ed:void 0,...eD("axis"),...z,children:[em&&(0,o.jsx)(u.J,{position:"insideBottom",offset:-20,fontSize:12,...eD("axisLabel"),children:em}),z?.children]}),(0,o.jsxs)(c.h,{yAxisId:"left",orientation:"left",tick:{transform:"translate(-10, 0)",fontSize:12,fill:"currentColor"},hide:!E,...eM,...J,children:[eh&&(0,o.jsx)(u.J,{position:"insideLeft",angle:-90,textAnchor:"middle",fontSize:12,offset:-5,...eD("axisLabel"),children:eh}),J?.children]}),(0,o.jsxs)(c.h,{yAxisId:"right",orientation:"right",tick:{transform:"translate(10, 0)",fontSize:12,fill:"currentColor"},hide:!eg,...eM,...ey,children:[ef&&(0,o.jsx)(u.J,{position:"insideRight",angle:90,textAnchor:"middle",fontSize:12,offset:-5,...eD("axisLabel"),children:ef}),J?.children]}),(0,o.jsx)(x.d,{strokeDasharray:$,vertical:"y"===B||"xy"===B,horizontal:"x"===B||"xy"===B,...eD("grid"),...G}),F&&(0,o.jsx)(g.m,{animationDuration:X,isAnimationActive:0!==X,position:"vertical"===ei?{}:{y:0},cursor:{stroke:"var(--chart-grid-color)",strokeWidth:1,strokeDasharray:$},content:({label:e,payload:a})=>(0,o.jsx)(D.I,{label:e,payload:a,unit:R,classNames:ek,styles:eT,series:Y,valueFormatter:ed,showColor:"gradient"!==eu}),...H}),eK,eO,ec]})})})});O.displayName="@mantine/charts/LineChart",O.classes=w.A},6804:(e,a,t)=>{"use strict";t.d(a,{x:()=>r});var o=t(31085);function r({x:e,y:a,value:t,valueFormatter:r}){return(0,o.jsx)("g",{transform:`translate(${e},${a})`,children:(0,o.jsx)("text",{x:0,y:0,dy:-8,dx:-10,textAnchor:"top",fill:"var(--chart-text-color, var(--mantine-color-dimmed))",fontSize:8,children:r?r(t):t})})}},94563:(e,a,t)=>{"use strict";t.d(a,{A:()=>o});var o={root:"m_a50f3e58",container:"m_af9188cb",grid:"m_a50a48bc",axis:"m_a507a517",axisLabel:"m_2293801d",tooltip:"m_92b296cd"}},88500:(e,a,t)=>{"use strict";function o(e){return e?e.reduce((e,a)=>{let t=a.name.search(/\./);return t>=0?e[a.name.substring(t+1)]=a.label:e[a.name]=a.label,e},{}):{}}t.d(a,{J:()=>o})}},e=>{var a=a=>e(e.s=a);e.O(0,[67456,53417,28054,55231,39699,68831,90636,46593,38792],()=>a(71129)),_N_E=e.O()}]);