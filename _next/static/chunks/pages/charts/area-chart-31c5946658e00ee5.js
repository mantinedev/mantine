...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.kZ,language:"tsx",fileName:"data.ts"}]};var u=t(57447);let x={type:"configurator",component:function(e){return(0,r.jsx)(n.Q,{h:300,data:i.v1,dataKey:"date",series:[{name:"Apples",color:"indigo.6"}],...e})},code:[{code:`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:i.kZ,language:"tsx",fileName:"data.ts"}]};var k=t(32062);let C={type:"configurator",component:function(e){return(0,r.jsx)(n.Q,{h:300,data:i.p,dataKey:"date",series:[{name:"Apples",color:e.color}],...e})},code:[{code:e=>`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
