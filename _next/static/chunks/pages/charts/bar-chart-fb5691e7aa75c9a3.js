(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[14778],{20256:function(e,t,a){(window.__NEXT_P=window.__NEXT_P||[]).push(["/charts/bar-chart",function(){return a(96363)}])},96363:function(e,t,a){"use strict";a.r(t),a.d(t,{default:function(){return ea}});var r=a(24246),o=a(71670),n=a(27378),i=a(95829),l=a(35105);let s=`
...
`,w={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",xAxisProps:{padding:{left:30,right:30}},series:[{name:"Smartphones",color:"violet.6"},{name:"Laptops",color:"blue.6"},{name:"Tablets",color:"teal.6"}]})},code:[{code:S,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}]},C=`
import { BarChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}],controls:[{type:"color",prop:"color",initialValue:"blue",libraryValue:!0},{type:"number",prop:"fillOpacity",initialValue:1,libraryValue:"__",min:0,max:1,step:.01}]},N=`.root {
  @mixin light {
...
`,D={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",className:"m-ad75446c",series:[{name:"Smartphones",color:"var(--bar-color)"}]})},code:[{code:P,language:"tsx",fileName:"Demo.tsx"},{code:N,language:"scss",fileName:"Demo.module.css"},{code:l.o,language:"tsx",fileName:"data.ts"}]},B=`
import { BarChart } from '@mantine/charts';
import { data } from './data';
...
`,O={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",strokeDasharray:"15 15",series:[{name:"Smartphones",color:"violet.6"},{name:"Laptops",color:"blue.6"},{name:"Tablets",color:"teal.6"}]})},code:[{code:B,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}]},A=`
.root {
  @mixin light {
...
`,I={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",className:"m-cb37bd9a",series:[{name:"Smartphones",color:"violet.6"},{name:"Laptops",color:"blue.6"},{name:"Tablets",color:"teal.6"}]})},code:[{code:A,language:"scss",fileName:"Demo.module.css"},{code:K,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}]},z=`
import { BarChart } from '@mantine/charts';
import { data } from './data';
...
`,_={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",tooltipAnimationDuration:200,series:[{name:"Smartphones",color:"violet.6"},{name:"Laptops",color:"blue.6"},{name:"Tablets",color:"teal.6"}]})},code:[{code:z,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}]},F=`
import { BarChart } from '@mantine/charts';
import { data } from './data';
...
`,V={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",unit:"$",series:[{name:"Smartphones",color:"violet.6"},{name:"Laptops",color:"blue.6"},{name:"Tablets",color:"teal.6"}]})},code:[{code:F,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}]};var U=a(98477),Text=a(26569);let M=`
import { BarChart } from '@mantine/charts';
...
`;function R({label:e,payload:t}){return t?n.createElement(U.X,{px:"md",py:"sm",withBorder:!0,shadow:"md",radius:"md"},n.createElement(Text.x,{fw:500,mb:5},e),t.map(e=>n.createElement(Text.x,{key:e.name,c:e.color,fz:"sm"},e.name,": ",e.value))):null}let Y={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",tooltipProps:{content:({label:e,payload:t})=>n.createElement(R,{label:e,payload:t})},series:[{name:"Smartphones",color:"violet.6"},{name:"Laptops",color:"blue.6"},{name:"Tablets",color:"teal.6"}]})},code:[{code:M,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}]},X=`
import { BarChart } from '@mantine/charts';
import { data } from './data';
...
`,G={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",withTooltip:!1,series:[{name:"Smartphones",color:"violet.6"},{name:"Laptops",color:"blue.6"},{name:"Tablets",color:"teal.6"}]})},code:[{code:X,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}]},H=`
...
`,W={type:"code",component:function(){return n.createElement(n.Fragment,null,n.createElement(Text.x,{mb:"md",pl:"md"},"Smartphones sales:"),n.createElement(i.v,{h:180,data:l.a,dataKey:"month",series:[{name:"Smartphones",color:"violet.6"}],barChartProps:{syncId:"tech"}}),n.createElement(Text.x,{mb:"md",pl:"md",mt:"xl"},"Laptops sales:"),n.createElement(i.v,{h:180,data:l.a,dataKey:"month",barChartProps:{syncId:"tech"},series:[{name:"Laptops",color:"teal.6"}]}))},code:[{code:H,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}]};var Z=a(3278);let $=`
import { BarChart } from '@mantine/charts';
import { data } from './data';
...
`},95829:function(e,t,a){"use strict";a.d(t,{v:function(){return N}});var r=a(27378),o=a(88058),n=a(97879),i=a(9911),l=a(24849),s=a(32529),c=a(26299),d=a(69972),m=(0,l.z)({chartName:"BarChart",GraphicalChild:o.$,defaultTooltipEventType:"axis",validateTooltipEventTypes:["axis","item"],axisComponents:[{axisType:"xAxis",AxisComp:s.K},{axisType:"yAxis",AxisComp:c.B}],formatAxisMap:d.t9}),p=a(46246),h=a(38616),u=a(44460),f=a(83453),y=a(89738),x=a(20410),g=a(96739),b=a(2256),v=a(5564),j=a(6231),S=a(56589),w=a(3525),C=a(96688),k=a(51010);function T(e){return`${(100*e).toFixed(0)}%`}let L={withXAxis:!0,withYAxis:!0,withTooltip:!0,tooltipAnimationDuration:0,fillOpacity:1,tickLine:"y",strokeDasharray:"5 5",gridAxis:"x",type:"default"},E=(0,f.Z)((e,{textColor:t,gridColor:a,cursorFill:r})=>({root:{"--chart-text-color":t?(0,y.p)(t,e):void 0,"--chart-grid-color":a?(0,y.p)(a,e):void 0,"--chart-cursor-fill":r?(0,y.p)(r,e):void 0}})),N=(0,x.d)((e,t)=>{let a=(0,g.w)("BarChart",L,e),{classNames:l,className:d,style:f,styles:x,unstyled:N,vars:P,data:D,withLegend:B,legendProps:O,series:A,onMouseLeave:K,dataKey:I,withTooltip:z,withXAxis:_,withYAxis:F,gridAxis:V,tickLine:U,xAxisProps:M,yAxisProps:R,unit:Y,tooltipAnimationDuration:X,strokeDasharray:G,gridProps:H,tooltipProps:W,referenceLines:Z,fillOpacity:$,barChartProps:J,type:q,orientation:Q,dir:ee,valueFormatter:et,...ea}=a,er=(0,b.rZ)(),[eo,en]=(0,r.useState)(null),ei=null!==eo,el="stacked"===q||"percent"===q,{resolvedClassNames:es,resolvedStyles:ec}=(0,v.h)({classNames:l,styles:x,props:a}),ed=(0,j.y)({name:"BarChart",classes:k.Z,props:a,className:d,style:f,classNames:l,styles:x,unstyled:N,vars:P,varsResolver:E}),em=A.map(e=>{let t=(0,y.p)(e.color,er),a=ei&&eo!==e.name;return r.createElement(o.$,{...ed("bar"),key:e.name,name:e.name,dataKey:e.name,fill:t,stroke:t,isAnimationActive:!1,fillOpacity:a?.1:$,strokeOpacity:a?.2:0,stackId:el?"stack":void 0})}),ep=Z?.map((e,t)=>{let a=y.p(e.color,er);return r.createElement(n.d,{key:t,stroke:e.color?a:"var(--chart-grid-color)",strokeWidth:1,...e,label:{value:e.label,fill:e.color?a:"currentColor",fontSize:12,position:e.labelPosition??"insideBottomLeft"},...ed("referenceLine")})});return r.createElement(S.x,{ref:t,...ed("root"),onMouseLeave:e=>{en(null),K?.(e)},dir:ee||"ltr",...ea},r.createElement(i.h,{...ed("container")},r.createElement(m,{data:D,stackOffset:"percent"===q?"expand":void 0,layout:Q,...J},B&&r.createElement(p.D,{verticalAlign:"top",content:e=>r.createElement(w.Q,{payload:e.payload,onHighlight:en,legendPosition:O?.verticalAlign||"top",classNames:es,styles:ec,series:A}),height:44,...O}),r.createElement(s.K,{hide:!_,..."vertical"===Q?{type:"number"}:{dataKey:I},tick:{transform:"translate(0, 10)",fontSize:12,fill:"currentColor"},stroke:"",interval:"preserveStartEnd",tickLine:!!("none"!==V&&("x"===U||"xy"===U))&&{stroke:"currentColor"},minTickGap:5,...ed("axis"),...M}),r.createElement(c.B,{hide:!F,axisLine:!1,..."vertical"===Q?{dataKey:I,type:"category"}:{type:"number"},tickLine:!!("none"!==V&&("y"===U||"xy"===U))&&{stroke:"currentColor"},tick:{transform:"translate(-10, 0)",fontSize:12,fill:"currentColor"},allowDecimals:!0,unit:Y,tickFormatter:"percent"===q?T:et,...ed("axis"),...R}),r.createElement(h.q,{strokeDasharray:G,vertical:"y"===V||"xy"===V,horizontal:"x"===V||"xy"===V,...ed("grid"),...H}),z&&r.createElement(u.u,{animationDuration:X,isAnimationActive:0!==X,position:{y:0},cursor:{stroke:"var(--chart-grid-color)",strokeWidth:1,strokeDasharray:G,fill:"var(--chart-cursor-fill)"},content:({label:e,payload:t})=>r.createElement(C.h,{label:e,payload:t,unit:Y,classNames:es,styles:ec,series:A,valueFormatter:et}),...W}),em,ep)))});N.displayName="@mantine/charts/BarChart",N.classes=k.Z},3525:function(e,t,a){"use strict";a.d(t,{Q:function(){return p}});var r=a(27378),o=a(20410),n=a(96739),i=a(6231),l=a(16202),s=a(56589),c=a(3671),d={legend:"m-847eaf",legendItem:"m-17da7e62",legendItemName:"m-8ff56c0d"};let m={},p=(0,o.d)((e,t)=>{let a=(0,n.w)("ChartLegend",m,e),{classNames:o,className:p,style:h,styles:u,unstyled:f,vars:y,payload:x,onHighlight:g,legendPosition:b,mod:v,series:j,...S}=a,w=(0,i.y)({name:"ChartLegend",classes:d,props:a,className:p,style:h,classNames:o,styles:u,unstyled:f});if(!x)return null;let C=x.filter(e=>"none"!==e.color),k=(0,c.v)(j),T=C.map((e,t)=>r.createElement("div",{key:t,...w("legendItem"),onMouseEnter:()=>g(e.dataKey),onMouseLeave:()=>g(null)},r.createElement(l.b,{color:e.color,size:12,...w("legendItemColor"),withShadow:!1}),r.createElement("p",{...w("legendItemName")},k[e.dataKey]||e.dataKey)));return r.createElement(s.x,{ref:t,mod:[{position:b},v],...w("legend"),...S},T)});p.displayName="@mantine/charts/ChartLegend"},96688:function(e,t,a){"use strict";a.d(t,{h:function(){return y},X:function(){return h}});var r=a(27378),o=a(20410),n=a(96739),i=a(2256),l=a(6231),s=a(16202),c=a(89738),d=a(56589),m=a(3671),p={tooltip:"m-e4d36c9b",tooltipLabel:"m-7f4bcb19",tooltipBody:"m-3de554dd",tooltipItem:"m-3de8964e",tooltipItemBody:"m-50186d10",tooltipItemName:"m-501dadf9",tooltipItemData:"m-50192318"};function h(e,t){let a=e.filter(e=>"none"!==e.fill||!e.color);return t?a.filter(e=>e.name===t):a}function u(e,t){return"radial"===t?e.value:e.payload[e.dataKey]}let f={type:"area"},y=(0,o.d)((e,t)=>{let a=(0,n.w)("ChartTooltip",f,e),{classNames:o,className:y,style:x,styles:g,unstyled:b,vars:v,payload:j,label:S,unit:w,type:C,segmentId:k,mod:T,series:L,valueFormatter:E,...N}=a,P=(0,i.rZ)(),D=(0,l.y)({name:"ChartTooltip",classes:p,props:a,className:y,style:x,classNames:o,styles:g,unstyled:b});if(!j)return null;let B=h(j,k),O=(0,m.v)(L),A=B.map(e=>r.createElement("div",{key:e.name,...D("tooltipItem")},r.createElement("div",{...D("tooltipItemBody")},r.createElement(s.b,{color:(0,c.p)(e.color,P),size:12,...D("tooltipItemColor"),withShadow:!1}),r.createElement("div",{...D("tooltipItemName")},O[e.name]||e.name)),r.createElement("div",{...D("tooltipItemData")},"function"==typeof E?E(u(e,C)):u(e,C),w)));return r.createElement(d.x,{...D("tooltip"),mod:[{type:C},T],ref:t,...N},S&&r.createElement("div",{...D("tooltipLabel")},S),r.createElement("div",{...D("tooltipBody")},A))});y.displayName="@mantine/charts/ChartTooltip"},51010:function(e,t,a){"use strict";a.d(t,{Z:function(){return r}});var r={root:"m-a50f3e58",container:"m-af9188cb",grid:"m-a50a48bc",axis:"m-a507a517"}},3671:function(e,t,a){"use strict";function r(e){return e?e.reduce((e,t)=>(e[t.name]=t.label,e),{}):{}}a.d(t,{v:function(){return r}})}},function(e){e.O(0,[30370,60898,15819,2775,49774,92888,40179],function(){return e(e.s=20256)}),_N_E=e.O()}]);