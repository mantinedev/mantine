(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[26418],{29881:function(e,t,a){(window.__NEXT_P=window.__NEXT_P||[]).push(["/charts/area-chart",function(){return a(24614)}])},24614:function(e,t,a){"use strict";a.r(t),a.d(t,{default:function(){return ef}});var r=a(24246),o=a(71670),n=a(27378),i=a(44432),s=a(61566);let l=`
...
`,O={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",xAxisProps:{padding:{left:30,right:30}},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:w,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},D=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}],controls:[{type:"color",prop:"color",initialValue:"blue",libraryValue:!0},{type:"boolean",prop:"withGradient",initialValue:!0,libraryValue:!0}]},K=`.root {
  @mixin light {
...
`,V={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",className:"m-13521d26",series:[{name:"Apples",color:"var(--area-color)"}]})},code:[{code:S,language:"tsx",fileName:"Demo.tsx"},{code:K,language:"scss",fileName:"Demo.module.css"},{code:s.op,language:"tsx",fileName:"data.ts"}]},W=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,L={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",strokeDasharray:"15 15",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:W,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},z=`
.root {
  @mixin light {
...
`,F={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",className:"m-3587e220",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:z,language:"scss",fileName:"Demo.module.css"},{code:_,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},U=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,I={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",tooltipAnimationDuration:200,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:U,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},B=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,R={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",unit:"$",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:B,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]};var M=a(96688),Y=a(98477),Text=a(26569);let G=`
...
`;function X({label:e,payload:t}){return t?n.createElement(Y.X,{px:"md",py:"sm",withBorder:!0,shadow:"md",radius:"md"},n.createElement(Text.x,{fw:500,mb:5},e),(0,M.X)(t).map(e=>n.createElement(Text.x,{key:e.name,c:e.color,fz:"sm"},e.name,": ",e.value))):null}let H={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",tooltipProps:{content:({label:e,payload:t})=>n.createElement(X,{label:e,payload:t})},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:G,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},$=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,q={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",withTooltip:!1,series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:$,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},Z=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,J={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",dotProps:{r:6,strokeWidth:2,stroke:"#fff"},activeDotProps:{r:8,strokeWidth:1,fill:"#fff"},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:Z,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},Q=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,ee={type:"configurator",component:function(e){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}],...e})},code:[{code:Q,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}],controls:[{type:"number",prop:"strokeWidth",initialValue:2,libraryValue:null,step:.1,min:.5,max:5}]},et=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,ea={type:"configurator",component:function(e){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"},{name:"Tomatoes",color:"teal.6"},{name:"Oranges",color:"blue.6"}],...e})},code:[{code:et,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}],controls:[{type:"segmented",prop:"type",initialValue:"default",libraryValue:"default",transformLabel:!1,data:[{value:"default",label:"default"},{value:"stacked",label:"stacked"}]},{type:"number",prop:"fillOpacity",initialValue:.2,libraryValue:null,step:.01,min:0,max:1},{type:"boolean",prop:"withGradient",initialValue:!0,libraryValue:!0}]},er=`
...
`,eo={type:"code",component:function(){return n.createElement(n.Fragment,null,n.createElement(Text.x,{mb:"md",pl:"md"},"Apples sales:"),n.createElement(i.T,{h:180,data:s.aT,dataKey:"date",series:[{name:"Apples",color:"indigo.6"}],areaChartProps:{syncId:"groceries"}}),n.createElement(Text.x,{mb:"md",pl:"md",mt:"xl"},"Tomatoes sales:"),n.createElement(i.T,{h:180,data:s.aT,dataKey:"date",areaChartProps:{syncId:"groceries"},series:[{name:"Tomatoes",color:"teal.6"}]}))},code:[{code:er,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},en=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,ei={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",orientation:"vertical",series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6"}]})},code:[{code:en,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},es=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
...
`,el={type:"code",component:function(){return n.createElement(i.T,{h:300,data:s.aT,dataKey:"date",type:"stacked",strokeWidth:1,dotProps:{r:2},activeDotProps:{r:3,strokeWidth:1},series:[{name:"Apples",color:"indigo.6"},{name:"Oranges",color:"blue.6"},{name:"Tomatoes",color:"teal.6",strokeDasharray:"5 5"}]})},code:[{code:es,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},ec=`
import { AreaChart } from '@mantine/charts';
import { data } from './data';
