...
`,f={type:"code",component:function(){return i.createElement(l.G,{h:350,data:s.aT,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",className:"m-f09a294f"})},code:[{code:B,language:"scss",fileName:"Demo.module.css"},{code:M,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},v=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
...
`,_={type:"code",component:function(){return i.createElement(l.G,{h:350,data:s.aT,dataKey:{x:"age",y:"BMI"},xAxisLabel:"Age",yAxisLabel:"BMI",strokeDasharray:"15 15"})},code:[{code:v,language:"tsx",fileName:"Demo.tsx"},{code:s.op,language:"tsx",fileName:"data.ts"}]},b=`
import { ScatterChart } from '@mantine/charts';
import { data } from './data';
