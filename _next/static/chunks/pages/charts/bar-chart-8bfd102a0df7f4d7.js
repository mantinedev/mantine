...
`,O={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",className:"m_ad75446c",series:[{name:"Smartphones",color:"var(--bar-color)"}]})},code:[{code:A,language:"tsx",fileName:"Demo.tsx"},{code:B,language:"scss",fileName:"Demo.module.css"},{code:l.o,language:"tsx",fileName:"data.ts"}]},K=`
import { BarChart } from '@mantine/charts';
import { data } from './data';
...
`,_={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",strokeDasharray:"15 15",series:[{name:"Smartphones",color:"violet.6"},{name:"Laptops",color:"blue.6"},{name:"Tablets",color:"teal.6"}]})},code:[{code:K,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}]},I=`
.root {
  @mixin light {
...
`,F={type:"code",component:function(){return n.createElement(i.v,{h:300,data:l.a,dataKey:"month",className:"m_cb37bd9a",series:[{name:"Smartphones",color:"violet.6"},{name:"Laptops",color:"blue.6"},{name:"Tablets",color:"teal.6"}]})},code:[{code:I,language:"scss",fileName:"Demo.module.css"},{code:z,language:"tsx",fileName:"Demo.tsx"},{code:l.o,language:"tsx",fileName:"data.ts"}]},V=`
import { BarChart } from '@mantine/charts';
import { data } from './data';
...
`},8132:function(e,t,a){"use strict";a.d(t,{v:function(){return E}});var o=a(2784),r=a(171),n=a(30840),i=a(18205),l=a(80739),s=a(55734),c=a(25556),d=a(81224),m=a(3131),p=a(55484),h=a(21154),u=a(11200),f=a(13588),x=a(82027),y=a(38483),g=a(68755),b=a(51477),v=a(62378),j=a(28559),S=a(46293),w=a(50425),C=a(7064);function k(e){return`${(100*e).toFixed(0)}%`}let L={withXAxis:!0,withYAxis:!0,withTooltip:!0,tooltipAnimationDuration:0,fillOpacity:1,tickLine:"y",strokeDasharray:"5 5",gridAxis:"x",type:"default"},T=(0,u.Z)((e,{textColor:t,gridColor:a,cursorFill:o})=>({root:{"--chart-text-color":t?(0,f.p)(t,e):void 0,"--chart-grid-color":a?(0,f.p)(a,e):void 0,"--chart-cursor-fill":o?(0,f.p)(o,e):void 0}})),E=(0,x.d)((e,t)=>{let a=(0,y.w)("BarChart",L,e),{classNames:u,className:x,style:E,styles:N,unstyled:P,vars:D,data:B,withLegend:A,legendProps:O,series:K,onMouseLeave:_,dataKey:I,withTooltip:z,withXAxis:F,withYAxis:V,gridAxis:U,tickLine:M,xAxisProps:Y,yAxisProps:R,unit:X,tooltipAnimationDuration:G,strokeDasharray:H,gridProps:W,tooltipProps:Z,referenceLines:$,fillOpacity:J,barChartProps:q,type:Q,orientation:ee,dir:et,valueFormatter:ea,children:eo,barProps:er,xAxisLabel:en,yAxisLabel:ei,...el}=a,es=(0,g.rZ)(),[ec,ed]=(0,o.useState)(null),em=null!==ec,ep="stacked"===Q||"percent"===Q,{resolvedClassNames:eh,resolvedStyles:eu}=(0,b.h)({classNames:u,styles:N,props:a}),ef=(0,v.y)({name:"BarChart",classes:C.Z,props:a,className:x,style:E,classNames:u,styles:N,unstyled:P,vars:D,varsResolver:T}),ex=K.map(e=>{let t=(0,f.p)(e.color,es),a=em&&ec!==e.name;return o.createElement(r.$,{...ef("bar"),key:e.name,name:e.name,dataKey:e.name,fill:t,stroke:t,isAnimationActive:!1,fillOpacity:a?.1:J,strokeOpacity:a?.2:0,stackId:ep?"stack":void 0,..."function"==typeof er?er(e):er})}),ey=$?.map((e,t)=>{let a=f.p(e.color,es);return o.createElement(n.d,{key:t,stroke:e.color?a:"var(--chart-grid-color)",strokeWidth:1,...e,label:{value:e.label,fill:e.color?a:"currentColor",fontSize:12,position:e.labelPosition??"insideBottomLeft"},...ef("referenceLine")})});return o.createElement(j.x,{ref:t,...ef("root"),onMouseLeave:e=>{ed(null),_?.(e)},dir:et||"ltr",...el},o.createElement(i.h,{...ef("container")},o.createElement(l.v,{data:B,stackOffset:"percent"===Q?"expand":void 0,layout:ee,margin:{bottom:en?30:void 0,left:ei?10:void 0,right:ei?5:void 0},...q},A&&o.createElement(s.D,{verticalAlign:"top",content:e=>o.createElement(S.Q,{payload:e.payload,onHighlight:ed,legendPosition:O?.verticalAlign||"top",classNames:eh,styles:eu,series:K}),...O}),o.createElement(c.K,{hide:!F,..."vertical"===ee?{type:"number"}:{dataKey:I},tick:{transform:"translate(0, 10)",fontSize:12,fill:"currentColor"},stroke:"",interval:"preserveStartEnd",tickLine:!!("none"!==U&&("x"===M||"xy"===M))&&{stroke:"currentColor"},minTickGap:5,...ef("axis"),...Y},en&&o.createElement(d._,{position:"insideBottom",offset:-20,fontSize:12,...ef("axisLabel")},en),Y?.children),o.createElement(m.B,{hide:!V,axisLine:!1,..."vertical"===ee?{dataKey:I,type:"category"}:{type:"number"},tickLine:!!("none"!==U&&("y"===M||"xy"===M))&&{stroke:"currentColor"},tick:{transform:"translate(-10, 0)",fontSize:12,fill:"currentColor"},allowDecimals:!0,unit:X,tickFormatter:"percent"===Q?k:ea,...ef("axis"),...R},ei&&o.createElement(d._,{position:"insideLeft",angle:-90,textAnchor:"middle",fontSize:12,offset:-5,...ef("axisLabel")},ei),R?.children),o.createElement(p.q,{strokeDasharray:H,vertical:"y"===U||"xy"===U,horizontal:"x"===U||"xy"===U,...ef("grid"),...W}),z&&o.createElement(h.u,{animationDuration:G,isAnimationActive:0!==G,position:{y:0},cursor:{stroke:"var(--chart-grid-color)",strokeWidth:1,strokeDasharray:H,fill:"var(--chart-cursor-fill)"},content:({label:e,payload:t})=>o.createElement(w.h,{label:e,payload:t,unit:X,classNames:eh,styles:eu,series:K,valueFormatter:ea}),...Z}),ex,ey,eo)))});E.displayName="@mantine/charts/BarChart",E.classes=C.Z},46293:function(e,t,a){"use strict";a.d(t,{Q:function(){return p}});var o=a(2784),r=a(82027),n=a(38483),i=a(62378),l=a(27009),s=a(28559),c=a(64438),d={legend:"m_847eaf",legendItem:"m_17da7e62",legendItemName:"m_8ff56c0d"};let m={},p=(0,r.d)((e,t)=>{let a=(0,n.w)("ChartLegend",m,e),{classNames:r,className:p,style:h,styles:u,unstyled:f,vars:x,payload:y,onHighlight:g,legendPosition:b,mod:v,series:j,...S}=a,w=(0,i.y)({name:"ChartLegend",classes:d,props:a,className:p,style:h,classNames:r,styles:u,unstyled:f});if(!y)return null;let C=y.filter(e=>"none"!==e.color),k=(0,c.v)(j),L=C.map((e,t)=>o.createElement("div",{key:t,...w("legendItem"),onMouseEnter:()=>g(e.dataKey),onMouseLeave:()=>g(null)},o.createElement(l.b,{color:e.color,size:12,...w("legendItemColor"),withShadow:!1}),o.createElement("p",{...w("legendItemName")},k[e.dataKey]||e.dataKey)));return o.createElement(s.x,{ref:t,mod:[{position:b},v],...w("legend"),...S},L)});p.displayName="@mantine/charts/ChartLegend"},50425:function(e,t,a){"use strict";a.d(t,{h:function(){return x},X:function(){return h}});var o=a(2784),r=a(82027),n=a(38483),i=a(68755),l=a(62378),s=a(27009),c=a(13588),d=a(28559),m=a(64438),p={tooltip:"m_e4d36c9b",tooltipLabel:"m_7f4bcb19",tooltipBody:"m_3de554dd",tooltipItem:"m_3de8964e",tooltipItemColor:"m_b30369b5",tooltipItemBody:"m_50186d10",tooltipItemName:"m_501dadf9",tooltipItemData:"m_50192318"};function h(e,t){let a=e.filter(e=>"none"!==e.fill||!e.color);return t?a.filter(e=>e.name===t):a}function u(e,t){return"radial"===t||"scatter"===t?e.value:e.payload[e.dataKey]}let f={type:"area"},x=(0,r.d)((e,t)=>{let a=(0,n.w)("ChartTooltip",f,e),{classNames:r,className:x,style:y,styles:g,unstyled:b,vars:v,payload:j,label:S,unit:w,type:C,segmentId:k,mod:L,series:T,valueFormatter:E,...N}=a,P=(0,i.rZ)(),D=(0,l.y)({name:"ChartTooltip",classes:p,props:a,className:x,style:y,classNames:r,styles:g,unstyled:b});if(!j)return null;let B=h(j,k),A="scatter"===C?j[0]?.payload?.name:null,O=(0,m.v)(T),K=S||A,_=B.map(e=>o.createElement("div",{key:e.name,"data-type":C,...D("tooltipItem")},o.createElement("div",{...D("tooltipItemBody")},o.createElement(s.b,{color:(0,c.p)(e.color,P),size:12,...D("tooltipItemColor"),withShadow:!1}),o.createElement("div",{...D("tooltipItemName")},O[e.name]||e.name)),o.createElement("div",{...D("tooltipItemData")},"function"==typeof E?E(u(e,C)):u(e,C),w||e.unit)));return o.createElement(d.x,{...D("tooltip"),mod:[{type:C},L],ref:t,...N},K&&o.createElement("div",{...D("tooltipLabel")},K),o.createElement("div",{...D("tooltipBody")},_))});x.displayName="@mantine/charts/ChartTooltip"},7064:function(e,t,a){"use strict";a.d(t,{Z:function(){return o}});var o={root:"m_a50f3e58",container:"m_af9188cb",grid:"m_a50a48bc",axis:"m_a507a517",axisLabel:"m_2293801d"}},64438:function(e,t,a){"use strict";function o(e){return e?e.reduce((e,t)=>(e[t.name]=t.label,e),{}):{}}a.d(t,{v:function(){return o}})}},function(e){e.O(0,[57938,16717,17454,47747,49774,92888,40179],function(){return e(e.s=39717)}),_N_E=e.O()}]);