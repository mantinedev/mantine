...
`},93581:(e,t,a)=>{"use strict";a.d(t,{I:()=>x,r:()=>h});var o=a(31085),r=a(6754),n=a(29686),i=a(92408),l=a(69564),s=a(51606),d=a(34056),c=a(88500),m={tooltip:"m_e4d36c9b",tooltipLabel:"m_7f4bcb19",tooltipBody:"m_3de554dd",tooltipItemColor:"m_b30369b5",tooltipItem:"m_3de8964e",tooltipItemBody:"m_50186d10",tooltipItemName:"m_501dadf9",tooltipItemData:"m_50192318"};function h(e,t){let a=e.filter(e=>"none"!==e.fill||!e.color).map(e=>{if(!e.payload||e.payload[e.name])return e;let t=e.name.search(/\./);if(t>=0){let a=e.name.substring(0,t),o={...e.payload[a]},r=Object.entries(e.payload).reduce((e,t)=>{let[o,r]=t;return o===a?e:{...e,[o]:r}},{});return{...e,name:e.name.substring(t+1),payload:{...r,...o}}}return e});return t?a.filter(e=>e.name===t):a}function p(e,t){return"radial"===t||"scatter"===t?Array.isArray(e.value)?e.value[1]-e.value[0]:e.value:Array.isArray(e.payload[e.dataKey])?e.payload[e.dataKey][1]-e.payload[e.dataKey][0]:e.payload[e.name]}let u={type:"area",showColor:!0},x=(0,r.P9)((e,t)=>{let a=(0,n.Y)("ChartTooltip",u,e),{classNames:r,className:x,style:f,styles:g,unstyled:j,vars:y,payload:v,label:b,unit:C,type:P,segmentId:k,mod:w,series:D,valueFormatter:N,showColor:_,...A}=a,S=(0,i.xd)(),T=(0,l.I)({name:"ChartTooltip",classes:m,props:a,className:x,style:f,classNames:r,styles:g,unstyled:j});if(!v)return null;let I=h(v,k),V="scatter"===P?v[0]?.payload?.name:null,z=(0,c.J)(D),L=b||V,E=I.map(e=>(0,o.jsxs)("div",{"data-type":P,...T("tooltipItem"),children:[(0,o.jsxs)("div",{...T("tooltipItemBody"),children:[_&&(0,o.jsx)("svg",{...T("tooltipItemColor"),children:(0,o.jsx)("circle",{r:6,fill:(0,s.r)(e.color,S),width:12,height:12,cx:6,cy:6})}),(0,o.jsx)("div",{...T("tooltipItemName"),children:z[e.name]||e.name})]}),(0,o.jsxs)("div",{...T("tooltipItemData"),children:["function"==typeof N?N(p(e,P)):p(e,P),C||e.unit]})]},e?.key??e.name));return(0,o.jsxs)(d.a,{...T("tooltip"),mod:[{type:P},w],ref:t,...A,children:[L&&(0,o.jsx)("div",{...T("tooltipLabel"),children:L}),(0,o.jsx)("div",{...T("tooltipBody"),children:E})]})});x.displayName="@mantine/charts/ChartTooltip"},22118:(e,t,a)=>{"use strict";a.d(t,{r:()=>w});var o=a(31085),r=a(87183),n=a(79874),i=a(65340),l=a(4206),s=a(37662),d=a(7098),c=a(51606),m=a(39735),h=a(6754),p=a(29686),u=a(92408),x=a(69564),f=a(36456),g=a(34056),j=a(93581),y={root:"m_cd8943fd"};let v={withTooltip:!1,withLabelsLine:!0,paddingAngle:0,size:160,strokeWidth:1,startAngle:0,endAngle:360,tooltipDataSource:"all",labelsPosition:"outside",labelsType:"value"},b=(0,d.V)((e,{strokeColor:t,labelColor:a,withLabels:o,size:r,labelsPosition:n})=>({root:{"--chart-stroke-color":t?(0,c.r)(t,e):void 0,"--chart-labels-color":a?(0,c.r)(a,e):void 0,"--chart-size":o&&"outside"===n?(0,m.D)(r+80):(0,m.D)(r)}})),C=(e,t,a,o)=>"percent"===e?`${(100*a).toFixed(0)}%`:"function"==typeof o?o(t):t,P=(e,t)=>({cx:a,cy:r,midAngle:n,innerRadius:i,outerRadius:l,value:s,percent:d})=>{let c=Math.PI/180,m=i+(l-i)*.5,h=a+m*Math.cos(-n*c),p=r+m*Math.sin(-n*c);return(0,o.jsx)("text",{x:h,y:p,textAnchor:h>a?"start":"end",dominantBaseline:"central",className:y.label,children:C(e,s,d,t)})},k=(e,t)=>({x:a,y:r,cx:n,cy:i,percent:l,value:s})=>(0,o.jsx)("text",{x:a,y:r,cx:n,cy:i,textAnchor:a>n?"start":"end",fill:"var(--chart-labels-color, var(--mantine-color-dimmed))",fontFamily:"var(--mantine-font-family)",fontSize:12,children:(0,o.jsx)("tspan",{x:a,children:C(e,s,l,t)})}),w=(0,h.P9)((e,t)=>{let a=(0,p.Y)("PieChart",v,e),{classNames:d,className:m,style:h,styles:C,unstyled:w,vars:D,data:N,withTooltip:_,tooltipAnimationDuration:A,tooltipProps:S,pieProps:T,paddingAngle:I,withLabels:V,withLabelsLine:z,size:L,strokeWidth:E,startAngle:U,endAngle:B,tooltipDataSource:O,children:Y,pieChartProps:F,labelsPosition:J,valueFormatter:K,labelsType:W,strokeColor:G,...M}=a,R=(0,u.xd)(),X=(0,x.I)({name:"PieChart",classes:y,props:a,className:m,style:h,classNames:d,styles:C,unstyled:w,vars:D,varsResolver:b}),{resolvedClassNames:$,resolvedStyles:Z}=(0,f.Y)({classNames:d,styles:C,props:a}),q=N.map((e,t)=>(0,o.jsx)(r.f,{fill:(0,c.r)(e.color,R),stroke:"var(--chart-stroke-color, var(--mantine-color-body))",strokeWidth:E},t));return(0,o.jsx)(g.a,{ref:t,size:L,...X("root"),...M,children:(0,o.jsx)(n.u,{children:(0,o.jsxs)(i.r,{...F,children:[(0,o.jsx)(l.F,{data:N,innerRadius:0,outerRadius:L/2,dataKey:"value",isAnimationActive:!1,paddingAngle:I,startAngle:U,endAngle:B,label:!!V&&("inside"===J?P(W||"value",K):k(W||"value",K)),labelLine:!!z&&"outside"===J&&{stroke:"var(--chart-label-color, var(--mantine-color-dimmed))",strokeWidth:1},...T,children:q}),_&&(0,o.jsx)(s.m,{animationDuration:A,isAnimationActive:!1,content:({payload:e})=>(0,o.jsx)(j.I,{payload:N,classNames:$,styles:Z,type:"radial",segmentId:"segment"===O?e?.[0]?.name:void 0,valueFormatter:K}),...S}),Y]})})})});w.displayName="@mantine/charts/PieChart",w.classes=y},88500:(e,t,a)=>{"use strict";function o(e){return e?e.reduce((e,t)=>{let a=t.name.search(/\./);return a>=0?e[t.name.substring(a+1)]=t.label:e[t.name]=t.label,e},{}):{}}a.d(t,{J:()=>o})}},e=>{var t=t=>e(e.s=t);e.O(0,[67456,53417,46828,65340,39699,68831,90636,46593,38792],()=>t(36975)),_N_E=e.O()}]);