...
`,a={type:"code",code:l,component:function(){let{ref:e,x:n,y:t}=d();return s.createElement(s.Fragment,null,s.createElement(i.Z,{justify:"center"},s.createElement(c.x,{ref:e,w:300,h:180,bg:"var(--mantine-color-blue-light)"})),s.createElement(Text.x,{ta:"center",mt:"sm"},"Mouse coordinates ",s.createElement(u.E,null,`{ x: ${n}, y: ${t} }`)))}},m=`
