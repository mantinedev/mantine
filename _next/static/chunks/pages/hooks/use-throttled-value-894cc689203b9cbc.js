...
`,c={type:"code",component:function(){let[e,t]=(0,r.useState)(""),n=function(e,t){let[n,u]=(0,r.useState)(e),o=(0,r.useRef)(e),c=(0,r.useRef)(!0),l=(0,r.useRef)(-1);return(0,r.useEffect)(()=>{c.current&&o.current!==e&&(u(e),o.current=e,window.clearTimeout(l.current),c.current=!1,l.current=window.setTimeout(()=>{c.current=!0},1e3))},[e]),(0,r.useEffect)(()=>()=>window.clearTimeout(l.current),[]),n}(e,0);return r.createElement(r.Fragment,null,r.createElement(u.o,{placeholder:"Search",onChange:e=>t(e.currentTarget.value)}),r.createElement(Text.x,null,"Throttled value: ",n||"–"))},code:o}}},function(e){e.O(0,[57938,17454,47747,49774,92888,40179],function(){return e(e.s=66962)}),_N_E=e.O()}]);