...
`,l={type:"code",component:function(){let[e,t]=(0,r.useState)(""),[n,u]=(0,r.useState)([]),[l,d]=(0,r.useState)(!1),h=(0,c.y)(async e=>{d(!0),u(await new Promise(t=>{setTimeout(()=>{t(""===e.trim()?[]:[,,,,,].fill(0).map((t,n)=>({id:n,title:`${e} ${n+1}`})))},1e3)})),d(!1)},500);return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(s.o,{value:e,onChange:e=>{t(e.currentTarget.value),h(e.currentTarget.value)},placeholder:"Search...",rightSection:l&&(0,a.jsx)(i.a,{size:20})}),n.map(e=>(0,a.jsx)(o.x,{size:"sm",children:e.title},e.id))]})},code:u,centered:!0,maxWidth:340}}},function(e){e.O(0,[57938,17454,47747,49774,92888,40179],function(){return e(e.s=23187)}),_N_E=e.O()}]);