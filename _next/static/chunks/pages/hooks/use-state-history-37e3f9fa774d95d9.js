...
`,u={type:"code",component:function(){let[e,t,n]=function(e){let[t,n]=(0,a.useState)({history:[1],current:0}),r=(0,a.useCallback)(e=>n(t=>{let n=[...t.history.slice(0,t.current+1),e];return{history:n,current:n.length-1}}),[]),o=(0,a.useCallback)((e=1)=>n(t=>({history:t.history,current:Math.max(0,t.current-e)})),[]),s=(0,a.useCallback)((e=1)=>n(t=>({history:t.history,current:Math.min(t.history.length-1,t.current+e)})),[]),i=(0,a.useMemo)(()=>({set:r,forward:s,back:o}),[]);return[t.history[t.current],i,t]}(0);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(Text.x,{children:["Current value: ",e]}),(0,r.jsxs)(o.Z,{my:"md",children:[(0,r.jsx)(s.z,{onClick:()=>t.set(Math.ceil(100*Math.random())+1),children:"Set value"}),(0,r.jsx)(s.z,{onClick:()=>t.back(),children:"Back"}),(0,r.jsx)(s.z,{onClick:()=>t.forward(),children:"Forward"})]}),(0,r.jsx)(i.E,{block:!0,children:JSON.stringify(n,null,2)})]})},code:c}}},function(e){e.O(0,[57938,17454,47747,49774,92888,40179],function(){return e(e.s=35853)}),_N_E=e.O()}]);