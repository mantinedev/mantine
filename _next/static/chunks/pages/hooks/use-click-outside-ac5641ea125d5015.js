...
`,h={type:"code",component:function(){let[e,n]=(0,i.useState)(!1),t=(0,u.O)(()=>n(!1));return(0,o.jsx)(o.Fragment,{children:(0,o.jsxs)("div",{style:{position:"relative"},children:[(0,o.jsx)(d.Z,{justify:"center",children:(0,o.jsx)(l.z,{onClick:()=>n(!0),children:"Open dropdown"})}),e&&(0,o.jsx)(r.X,{ref:t,shadow:"sm",style:{width:(0,c.h)(300),height:(0,c.h)(60),position:"absolute",top:0,left:`calc(50% - ${(0,c.h)(150)})`,display:"flex",alignItems:"center",justifyContent:"center",zIndex:1},children:(0,o.jsx)("span",{children:"Click outside to close"})})]})})},code:a,dimmed:!0},p=`
import { useState } from 'react';
import { Paper, Button } from '@mantine/core';
import { useClickOutside } from '@mantine/hooks';
