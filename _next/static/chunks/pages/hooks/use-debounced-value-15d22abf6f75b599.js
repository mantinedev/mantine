...
`,i={type:"code",component:function(){let[e,n]=(0,a.useState)(""),[t]=(0,l.c)(e,200,{leading:!0});return(0,o.jsxs)(s.x,{maw:400,mx:"auto",children:[(0,o.jsx)(r.o,{label:"Enter value to see debounce effect",placeholder:"Enter value to see debounce effect",value:e,onChange:e=>n(e.currentTarget.value)}),(0,o.jsxs)(Text.x,{mt:"sm",children:[(0,o.jsx)(Text.x,{component:"span",c:"dimmed",size:"sm",children:"Value:"})," ",e.trim()||"[empty string]"]}),(0,o.jsxs)(Text.x,{children:[(0,o.jsx)(Text.x,{component:"span",c:"dimmed",size:"sm",children:"Debounced value:"})," ",t.trim()||"[empty string]"]})]})},code:d};var m=t(93010),x=t(17115);let h=`
import { useState } from 'react';
import { useDebouncedValue } from '@mantine/hooks';
...
`,d={type:"code",component:function(){let[e,n]=(0,u.useState)(""),[t]=(0,r.c)(e,200);return(0,o.jsxs)(c.x,{maw:400,mx:"auto",children:[(0,o.jsx)(a.o,{label:"Enter value to see debounce effect",placeholder:"Enter value to see debounce effect",value:e,onChange:e=>n(e.currentTarget.value)}),(0,o.jsxs)(s.x,{mt:"sm",children:[(0,o.jsx)(s.x,{component:"span",c:"dimmed",size:"sm",children:"Value:"})," ",e.trim()||"[empty string]"]}),(0,o.jsxs)(s.x,{children:[(0,o.jsx)(s.x,{component:"span",c:"dimmed",size:"sm",children:"Debounced value:"})," ",t.trim()||"[empty string]"]})]})},code:l}},34089:function(e,n,t){"use strict";t.d(n,{c:function(){return u}});var o=t(2784);function u(e,n,t={leading:!1}){let[u,c]=(0,o.useState)(e),a=(0,o.useRef)(!1),s=(0,o.useRef)(null),r=(0,o.useRef)(!1),l=()=>window.clearTimeout(s.current);return(0,o.useEffect)(()=>{a.current&&(!r.current&&t.leading?(r.current=!0,c(e)):(l(),s.current=window.setTimeout(()=>{r.current=!1,c(e)},n)))},[e,t.leading,n]),(0,o.useEffect)(()=>(a.current=!0,l),[]),[u,l]}}},function(e){e.O(0,[57938,17454,47747,49774,92888,40179],function(){return e(e.s=90460)}),_N_E=e.O()}]);