...
.demo {
  ...
  font-size: 20px;
  font-weight: 500;
}`,language:"scss",fileName:"Demo.module.css"}],component:function(){let[e,t]=(0,i.w)();return(0,s.jsxs)("div",{className:a.root,children:[(0,s.jsx)(r.Y,{justify:"center",children:(0,s.jsx)("div",{ref:e,className:a.demo,children:"Resize me!"})}),(0,s.jsx)(o.X,{captionSide:"top",data:{caption:"Resize element by dragging its right bottom corner",head:["Property","Value"],body:[["width",t.width],["height",t.height]]}})]})}}},40003:(e,t,n)=>{"use strict";n.d(t,{L:()=>i,w:()=>o});var s=n(14041);let r={x:0,y:0,width:0,height:0,top:0,left:0,bottom:0,right:0};function o(e){let t=(0,s.useRef)(0),n=(0,s.useRef)(null),[o,i]=(0,s.useState)(r),a=(0,s.useMemo)(()=>"undefined"!=typeof window?new ResizeObserver(e=>{let s=e[0];s&&(cancelAnimationFrame(t.current),t.current=requestAnimationFrame(()=>{if(n.current){let e=s.borderBoxSize?.[0]||s.contentBoxSize?.[0];e?i({width:e.inlineSize,height:e.blockSize,x:s.contentRect.x,y:s.contentRect.y,top:s.contentRect.top,left:s.contentRect.left,bottom:s.contentRect.bottom,right:s.contentRect.right}):i(s.contentRect)}}))}):null,[]);return(0,s.useEffect)(()=>(n.current&&a?.observe(n.current,e),()=>{a?.disconnect(),t.current&&cancelAnimationFrame(t.current)}),[n.current]),[n,o]}function i(e){let[t,{width:n,height:s}]=o(e);return{ref:t,width:n,height:s}}}},e=>{var t=t=>e(e.s=t);e.O(0,[18675,90636,46593,38792],()=>t(58149)),_N_E=e.O()}]);