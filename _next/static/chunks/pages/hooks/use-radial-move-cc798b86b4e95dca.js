...
}`,language:"scss"}],centered:!0}},28994:function(e,n,t){"use strict";t.d(n,{M:function(){return s},w:function(){return i}});var o=t(2784),r=t(82692);function i(e,n){var t,o;let i=(0,r.u)(e,0,360),s=Math.ceil(i/n);return t=s>=i/n?s*n==360?0:s*n:Math.round(i/n)*n,o=n.toString().split(".")[1]?.length||0,parseFloat(t.toFixed(o))}function s(e,{step:n=.01,onChangeEnd:t,onScrubStart:r,onScrubEnd:s}={}){let a=(0,o.useRef)(null),l=(0,o.useRef)(!1),[c,d]=(0,o.useState)(!1);return(0,o.useEffect)(()=>{l.current=!0},[]),(0,o.useEffect)(()=>{let o=a.current,l=(r,s=!1)=>{if(o){o.style.userSelect="none";let a=i(function(e,n){let t=function(e){let n=e.getBoundingClientRect();return[n.left+n.width/2,n.top+n.height/2]}(n);return 360-(180/Math.PI*Math.atan2(e[0]-t[0],e[1]-t[1])+180)}([r.clientX,r.clientY],o),n||1);e(a),s&&t?.(a)}},c=()=>{r?.(),d(!0),document.addEventListener("mousemove",m,!1),document.addEventListener("mouseup",v,!1),document.addEventListener("touchmove",f,{passive:!1}),document.addEventListener("touchend",p,!1)},u=()=>{s?.(),d(!1),document.removeEventListener("mousemove",m,!1),document.removeEventListener("mouseup",v,!1),document.removeEventListener("touchmove",f,!1),document.removeEventListener("touchend",p,!1)},h=e=>{c(),l(e)},m=e=>{l(e)},v=e=>{l(e,!0),u()},f=e=>{e.preventDefault(),l(e.touches[0])},p=e=>{l(e.changedTouches[0],!0),u()},g=e=>{e.preventDefault(),c(),l(e.touches[0])};return o?.addEventListener("mousedown",h),o?.addEventListener("touchstart",g,{passive:!1}),()=>{o&&(o.removeEventListener("mousedown",h),o.removeEventListener("touchstart",g))}},[e]),{ref:a,active:c}}}},function(e){e.O(0,[61177,66748,61639,92888,49774,40179],function(){return e(e.s=20519)}),_N_E=e.O()}]);