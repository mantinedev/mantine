(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[85285],{95199:(e,n,t)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/hooks/use-scroll-into-view",function(){return t(6092)}])},6092:(e,n,t)=>{"use strict";t.r(n),t.d(n,{default:()=>I});var r=t(31085),l=t(71184),o=t(56051),i=t(52022),s=t(34056),c=t(93065),a=t(14041),d=t(56447),h=t(93739);let u=e=>e<.5?2*e*e:-1+(4-2*e)*e,p=({axis:e,target:n,parent:t,alignment:r,offset:l,isList:o})=>{if(!n||!t&&"undefined"==typeof document)return 0;let i=!!t,s=(t||document.body).getBoundingClientRect(),c=n.getBoundingClientRect(),a=e=>c[e]-s[e];if("y"===e){let e=a("top");if(0===e)return 0;if("start"===r){let n=e-l;return n<=c.height*(o?0:1)||!o?n:0}let n=i?s.height:window.innerHeight;if("end"===r){let t=e+l-n+c.height;return t>=-c.height*(o?0:1)||!o?t:0}return"center"===r?e-n/2+c.height/2:0}if("x"===e){let e=a("left");if(0===e)return 0;if("start"===r){let n=e-l;return n<=c.width||!o?n:0}let n=i?s.width:window.innerWidth;if("end"===r){let t=e+l-n+c.width;return t>=-c.width||!o?t:0}if("center"===r)return e-n/2+c.width/2}return 0},f=({axis:e,parent:n})=>{if(!n&&"undefined"==typeof document)return 0;let t="y"===e?"scrollTop":"scrollLeft";if(n)return n[t];let{body:r,documentElement:l}=document;return r[t]+l[t]},g=({axis:e,parent:n,distance:t})=>{if(!n&&"undefined"==typeof document)return;let r="y"===e?"scrollTop":"scrollLeft";if(n)n[r]=t;else{let{body:e,documentElement:n}=document;e[r]=t,n[r]=t}};function m({duration:e=1250,axis:n="y",onScrollFinish:t,easing:r=u,offset:l=0,cancelable:o=!0,isList:i=!1}={}){let s=(0,a.useRef)(0),c=(0,a.useRef)(0),x=(0,a.useRef)(!1),v=(0,a.useRef)(null),j=(0,a.useRef)(null),w=(0,d.I)(),y=()=>{s.current&&cancelAnimationFrame(s.current)},k=(0,a.useCallback)(({alignment:o="start"}={})=>{x.current=!1,s.current&&y();let a=f({parent:v.current,axis:n})??0,d=p({parent:v.current,target:j.current,axis:n,alignment:o,offset:l,isList:i})-(v.current?0:a);!function l(){0===c.current&&(c.current=performance.now());let o=performance.now()-c.current,i=w||0===e?1:o/e,h=a+d*r(i);g({parent:v.current,axis:n,distance:h}),!x.current&&i<1?s.current=requestAnimationFrame(l):("function"==typeof t&&t(),c.current=0,s.current=0,y())}()},[n,e,r,i,l,t,w]),b=()=>{o&&(x.current=!0)};return(0,h.M)("wheel",b,{passive:!0}),(0,h.M)("touchmove",b,{passive:!0}),(0,a.useEffect)(()=>y,[]),{scrollableRef:v,targetRef:j,scrollIntoView:k,cancel:y}}let x={type:"code",code:`
...
`,component:function(){let{scrollIntoView:e,targetRef:n,scrollableRef:t}=m();return(0,r.jsxs)(o.Y,{justify:"center",children:[(0,r.jsx)(v.t,{ref:t,h:300,style:{overflowY:"scroll",flex:1},children:(0,r.jsx)(s.a,{pt:260,pb:450,children:(0,r.jsx)(v.t,{ref:n,p:"xl",style:{backgroundColor:"var(--mantine-color-blue-light)",width:"100%"},children:(0,r.jsx)(c.E,{children:"Scroll me into view"})})})}),(0,r.jsx)(i.$,{onClick:()=>e(),children:"Scroll to target"})]})}},w={type:"code",code:`
import { useScrollIntoView } from '@mantine/hooks';
import { Button, Text, Group, Paper, Box } from '@mantine/core';
