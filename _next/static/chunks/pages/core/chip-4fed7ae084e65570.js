(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[6781],{86171:function(e,t,i){"use strict";i.d(t,{Z:function(){return n}});var n=(0,i(54764).Z)("x","IconX",[["path",{d:"M18 6l-12 12",key:"svg-0"}],["path",{d:"M6 6l12 12",key:"svg-1"}]])},29077:function(e,t,i){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/chip",function(){return i(43564)}])},43564:function(e,t,i){"use strict";i.r(t),i.d(t,{default:function(){return X}});var n=i(24246),l=i(71670),a=i(27378),c=i(31002),r=i(58675),o=i(92082),p=i(83453),d=i(96739),h=i(6231),u=i(55934),s=i(56589),m=i(20410),C=i(38765),f=i(89871);let[v,g]=(0,f.V)(),b={};function k(e){let{value:t,defaultValue:i,onChange:n,multiple:l,children:c}=(0,d.w)("ChipGroup",b,e),[o,p]=(0,r.C)({value:t,defaultValue:i,finalValue:l?[]:null,onChange:n});return a.createElement(v,{value:{isChipSelected:e=>Array.isArray(o)?o.includes(e):e===o,onChange:e=>{let t=e.currentTarget.value;Array.isArray(o)?p(o.includes(t)?o.filter(e=>e!==t):[...o,t]):p(t)},multiple:l}},c)}k.displayName="@mantine/core/ChipGroup";var E={root:"m-f59ffda3",label:"m-be049a53","label--outline":"m-3904c1af","label--filled":"m-fa109255","label--light":"m-f7e165c3",iconWrapper:"m-9ac86df9",checkIcon:"m-d6d72580",input:"m-bde07329"};let y={type:"checkbox"},x=(0,p.Z)((e,{size:t,radius:i,variant:n,color:l})=>{let a=e.variantColorResolver({color:l||e.primaryColor,theme:e,variant:n||"filled"});return{root:{"--chip-fz":(0,o.yv)(t),"--chip-size":(0,o.ap)(t,"chip-size"),"--chip-radius":void 0===i?void 0:(0,o.H5)(i),"--chip-checked-padding":(0,o.ap)(t,"chip-checked-padding"),"--chip-padding":(0,o.ap)(t,"chip-padding"),"--chip-icon-size":(0,o.ap)(t,"chip-icon-size"),"--chip-bg":l||n?a.background:void 0,"--chip-hover":l||n?a.hover:void 0,"--chip-color":l||n?a.color:void 0,"--chip-bd":l||n?a.border:void 0,"--chip-spacing":(0,o.ap)(t,"chip-spacing")}}}),j=(0,m.d)((e,t)=>{let i=(0,d.w)("Chip",y,e),{classNames:n,className:l,style:o,styles:p,unstyled:m,vars:f,id:v,checked:b,defaultChecked:k,onChange:j,value:w,wrapperProps:G,type:V,disabled:A,children:S,size:_,variant:T,icon:F,rootRef:N,...Z}=i,z=(0,h.y)({name:"Chip",classes:E,props:i,className:l,style:o,classNames:n,styles:p,unstyled:m,vars:f,varsResolver:x}),M=g(),D=(0,c.M)(v),{styleProps:O,rest:P}=(0,u.c)(Z),[R,I]=(0,r.C)({value:b,defaultValue:k,finalValue:!1,onChange:j}),X=M?{checked:M.isChipSelected(w),onChange:e=>{M.onChange(e),j?.(e.currentTarget.checked)},type:M.multiple?"checkbox":"radio"}:{},L=X.checked||R;return a.createElement(s.x,{size:_,variant:T,ref:N,...z("root"),...O,...G},a.createElement("input",{type:V,...z("input"),checked:L,onChange:e=>I(e.currentTarget.checked),id:D,disabled:A,ref:t,value:w,...X,...P}),a.createElement("label",{htmlFor:D,"data-checked":L||void 0,"data-disabled":A||void 0,...z("label",{variant:T||"filled"})},L&&a.createElement("span",{...z("iconWrapper")},F||a.createElement(C.n,{...z("checkIcon")})),S))});j.classes=E,j.displayName="@mantine/core/Chip",j.Group=k;let w=`
