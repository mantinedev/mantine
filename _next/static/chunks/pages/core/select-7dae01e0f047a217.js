...
`,c={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"]})},code:i,maxWidth:340,centered:!0},d=`
import { Select } from '@mantine/core';
...
`,s={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],defaultValue:"React",clearable:!0})},code:d,maxWidth:340,centered:!0},u=`
import { Select } from '@mantine/core';
...
`,p={type:"code",component:function(){return a.createElement(a.Fragment,null,a.createElement(l.P,{label:"Option can NOT be deselected",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],defaultValue:"React",allowDeselect:!1}),a.createElement(l.P,{label:"Option can be deselected",description:"This is default behavior, click 'React' in the dropdown",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],defaultValue:"React",allowDeselect:!0,mt:"md"}))},code:u,maxWidth:340,centered:!0},h=`
import { Select } from '@mantine/core';
...
`,m={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],searchable:!0})},code:h,maxWidth:340,centered:!0},f=`
import { Select } from '@mantine/core';
...
`,b={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],searchable:!0,nothingFoundMessage:"Nothing found..."})},code:f,maxWidth:340,centered:!0},v=`
import { Select } from '@mantine/core';
...
`,g={type:"configurator",component:function(e){return a.createElement(l.P,{...e,data:["React","Angular","Svelte","Vue"],dropdownOpened:!0,pb:150,label:"Control check icon",placeholder:"Pick value",defaultValue:"React"})},code:v,centered:!0,maxWidth:340,controls:[{type:"boolean",prop:"withCheckIcon",initialValue:!0,libraryValue:!0},{type:"segmented",prop:"checkIconPosition",initialValue:"left",libraryValue:null,data:["left","right"]}]},x=`
...
`,j=({options:e,search:t})=>{let o=e.filter(e=>e.label.toLowerCase().trim().includes(t.toLowerCase().trim()));return o.sort((e,t)=>e.label.localeCompare(t.label)),o},P={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["4 – React","1 – Angular","3 – Vue","2 – Svelte"],filter:j,nothingFoundMessage:"Nothing found...",searchable:!0})},code:w,maxWidth:340,centered:!0},V=`
import { Select } from '@mantine/core';
...
`,k=Array(1e5).fill(0).map((e,t)=>`Option ${t}`),E={type:"code",component:function(){return a.createElement(l.P,{label:"100 000 options autocomplete",placeholder:"Use limit to optimize performance",limit:5,data:k,searchable:!0})},code:V,maxWidth:340,centered:!0},A=`
import { Select } from '@mantine/core';
...
`,D=Array(100).fill(0).map((e,t)=>`Option ${t}`),R={type:"code",component:function(){return a.createElement(a.Fragment,null,a.createElement(l.P,{label:"With scroll area (default)",placeholder:"Pick value",data:D,maxDropdownHeight:200}),a.createElement(l.P,{label:"With native scroll",placeholder:"Pick value",data:D,withScrollArea:!1,styles:{dropdown:{maxHeight:200,overflowY:"auto"}},mt:"md"}))},code:A,maxWidth:340,centered:!0},C=`
import { Select } from '@mantine/core';
...
`,Y={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:[{group:"Frontend",items:["React","Angular"]},{group:"Backend",items:["Express","Django"]}]})},code:C,maxWidth:340,centered:!0},O=`
import { Select } from '@mantine/core';
...
`,W={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:[{value:"react",label:"React"},{value:"ng",label:"Angular"},{value:"vue",label:"Vue",disabled:!0},{value:"svelte",label:"Svelte",disabled:!0}]})},code:O,maxWidth:340,centered:!0};var F=o(63433),I=o(8671);let N=`
...
`,T={type:"code",code:N,centered:!0,component:function(){return a.createElement(F.J,{width:300,position:"bottom",withArrow:!0,shadow:"md"},a.createElement(F.J.Target,null,a.createElement(I.z,null,"Toggle popover")),a.createElement(F.J.Dropdown,null,a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],comboboxProps:{withinPortal:!1}})))}};var B=o(87921);let _=`
...
`,z={type:"code",component:function(){let[e,{toggle:t}]=(0,B.q)();return a.createElement(a.Fragment,null,a.createElement(I.z,{onClick:t,mb:"md"},"Toggle dropdown"),a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],dropdownOpened:e}))},code:_,maxWidth:340,centered:!0},M=`
import { Select } from '@mantine/core';
...
`,L={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],comboboxProps:{position:"top",middlewares:{flip:!1,shift:!1}}})},code:M,maxWidth:340,centered:!0};var Z={dropdown:"m-f33bcc41",input:"m-37973d9a"};let $=`.dropdown {
...
`,H={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],comboboxProps:{transitionProps:{transition:"pop",duration:200}}})},code:G,maxWidth:340,centered:!0},J=`
import { Select } from '@mantine/core';
...
`,Q={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],comboboxProps:{shadow:"md"}})},code:K,maxWidth:340,centered:!0};var ee=o(94503),et=o(71078);let eo=`
...
`,en={type:"code",component:function(){let e=a.createElement(ee.Z,{style:{width:(0,et.h)(16),height:(0,et.h)(16)}});return a.createElement(a.Fragment,null,a.createElement(l.P,{data:["React","Angular","Vue"],leftSectionPointerEvents:"none",leftSection:e,label:"Your favorite library",placeholder:"Your favorite library"}),a.createElement(l.P,{mt:"md",data:["React","Angular","Vue"],rightSectionPointerEvents:"none",rightSection:e,label:"Your favorite library",placeholder:"Your favorite library"}))},maxWidth:340,centered:!0,code:eo};var er=o(77481);let ea=`
import { Select } from '@mantine/core';
...
`,el={type:"configurator",component:function(e){return a.createElement(l.P,{...e,placeholder:"Select placeholder",data:["React","Angular","Vue","Svelte"]})},code:ea,centered:!0,maxWidth:340,controls:er.pc},ei=`
import { Select } from '@mantine/core';
...
`,ec={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],readOnly:!0})},code:ei,maxWidth:340,centered:!0},ed=`
import { Select } from '@mantine/core';
...
`,es={type:"code",component:function(){return a.createElement(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],disabled:!0})},code:ed,maxWidth:340,centered:!0},eu=`
import { Select } from '@mantine/core';
