...
`,b={type:"code",component:function(){return(0,r.jsx)(a.Y,{label:"Negative number are not allowed",placeholder:"Do not enter negative numbers",allowNegative:!1})},code:h,centered:!0,maxWidth:340},f=`
import { NumberInput } from '@mantine/core';
...
`,x={type:"code",component:function(){return(0,r.jsx)(a.Y,{label:"Decimals are not allowed",placeholder:"Do not enter decimal numbers",allowDecimal:!1})},code:f,centered:!0,maxWidth:340},j=`
import { NumberInput } from '@mantine/core';
...
`,H={type:"code",component:function(){let e=(0,R.useRef)(null);return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(a.Y,{label:"Click buttons to change value",placeholder:"Click the buttons",handlersRef:e,step:2,min:10,max:20,defaultValue:15}),(0,r.jsxs)(T.Z,{mt:"md",justify:"center",children:[(0,r.jsx)(F.z,{onClick:()=>e.current?.decrement(),variant:"default",children:"Decrement by 2"}),(0,r.jsx)(F.z,{onClick:()=>e.current?.increment(),variant:"default",children:"Increment by 2"})]})]})},code:A,centered:!0,maxWidth:340},z=`
import { NumberInput } from '@mantine/core';
