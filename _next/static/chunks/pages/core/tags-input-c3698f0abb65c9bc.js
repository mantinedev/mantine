...
`,E=Array(1e5).fill(0).map((e,t)=>`Option ${t}`),V={type:"code",component:function(){return r.createElement(l.B,{label:"100 000 options tags input",placeholder:"Use limit to optimize performance",limit:5,data:E})},code:I,maxWidth:340,centered:!0};var P=n(51712);let S=`
import { TagsInput } from '@mantine/core';
...
`,R={type:"code",component:function(){return r.createElement(l.B,{label:"Enter tags",placeholder:"Some tags are disabled",data:[{value:"React"},{value:"Angular"},{value:"Vue",disabled:!0},{value:"Svelte",disabled:!0}]})},code:C,maxWidth:340,centered:!0};var W=n(63433),F=n(8671);let O=`
...
`,q={type:"code",component:function(){return r.createElement(l.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{shadow:"md"}})},code:$,maxWidth:340,centered:!0};var J=n(94503),X=n(71078);let K=`
...
`,es={type:"code",component:function(){return r.createElement(r.Fragment,null,r.createElement(l.B,{label:"Boolean error",placeholder:"Boolean error",error:!0,defaultValue:["React","Angular"]}),r.createElement(l.B,{mt:"md",label:"With error message",placeholder:"With error message",error:"Invalid name",defaultValue:["React","Angular"]}))},maxWidth:340,centered:!0,code:ei};var ed=n(93693),ec=n(73811);let eu=`
...
`,l={type:"code",component:function(){return a.createElement(o.B,{label:"Press Enter to submit a tag",placeholder:"Pick tag from list",data:["React","Angular","Svelte"]})},code:r,maxWidth:340,centered:!0}},51712:function(e,t,n){"use strict";n.d(t,{z:function(){return c}});var a=n(27378),o=n(22971),r=n(26569),l=n(16161);let i=`
