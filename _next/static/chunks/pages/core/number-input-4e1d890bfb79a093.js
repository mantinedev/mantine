...
`,z={type:"code",component:function(){let e=(0,o.useRef)(null);return o.createElement(o.Fragment,null,o.createElement(l.Y,{label:"Click buttons to change value",placeholder:"Click the buttons",handlersRef:e,step:2,min:10,max:20,defaultValue:15}),o.createElement(A.Z,{mt:"md",justify:"center"},o.createElement(M.z,{onClick:()=>e.current?.decrement(),variant:"default"},"Decrement by 2"),o.createElement(M.z,{onClick:()=>e.current?.increment(),variant:"default"},"Increment by 2")))},code:T,centered:!0,maxWidth:340},P=`
import { NumberInput } from '@mantine/core';
