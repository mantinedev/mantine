...
`,g={type:"code",component:function(){return o.createElement(l.Y,{label:"You can enter only 2 digits after decimal point",placeholder:"Do not enter more that 2",decimalScale:2})},code:y,centered:!0,maxWidth:340},I=`
import { NumberInput } from '@mantine/core';
...
`,l={type:"code",component:function(){return r.createElement(r.Fragment,null,r.createElement(a.Y,{label:"With prefix",placeholder:"Dollars",prefix:"$",defaultValue:100,mb:"md"}),r.createElement(a.Y,{label:"With suffix",placeholder:"Percents",suffix:"%",defaultValue:100,mt:"md"}))},code:o,centered:!0,maxWidth:340}},76528:function(e,t,n){"use strict";n.d(t,{Mt:function(){return r},nW:function(){return a},pc:function(){return o}});let r=[{type:"segmented",prop:"variant",data:["default","filled","unstyled"],initialValue:"default",libraryValue:"default"},{type:"size",prop:"size",initialValue:"sm",libraryValue:"sm"},{type:"size",prop:"radius",initialValue:"sm",libraryValue:"sm"},{type:"boolean",prop:"disabled",initialValue:!1,libraryValue:!1},{type:"boolean",prop:"error",initialValue:!1,libraryValue:!1}],a=[{type:"string",prop:"label",initialValue:"Input label",libraryValue:null},{type:"boolean",prop:"withAsterisk",initialValue:!1,libraryValue:!1},{type:"string",prop:"description",initialValue:"Input description",libraryValue:null},{type:"string",prop:"error",initialValue:"Input error",libraryValue:null},{type:"size",prop:"size",initialValue:"sm",libraryValue:"sm"}],o=[{type:"segmented",prop:"variant",data:["default","filled","unstyled"],initialValue:"default",libraryValue:"default"},{type:"size",prop:"size",initialValue:"sm",libraryValue:"sm"},{type:"size",prop:"radius",initialValue:"sm",libraryValue:"sm"},{type:"string",prop:"label",initialValue:"Input label",libraryValue:""},{type:"boolean",prop:"withAsterisk",initialValue:!1,libraryValue:!1},{type:"string",prop:"description",initialValue:"Input description",libraryValue:""},{type:"string",prop:"error",initialValue:"",libraryValue:""}]},42697:function(e,t,n){"use strict";n.d(t,{Y:function(){return N}});var r=n(2784),a=n(40489),o=n(9462),l=n(9341),i=n(82692),c=n(70837),u=n(91482),d=n(11200),s=n(51477),m=n(62378),p=n(38483),h=n(82027),b=n(73063),f=n(63409);function x({direction:e,style:t,...n}){return r.createElement("svg",{style:{width:"var(--ni-chevron-size)",height:"var(--ni-chevron-size)",transform:"up"===e?"rotate(180deg)":void 0,...t},viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n},r.createElement("path",{d:"M3.13523 6.15803C3.3241 5.95657 3.64052 5.94637 3.84197 6.13523L7.5 9.56464L11.158 6.13523C11.3595 5.94637 11.6759 5.95657 11.8648 6.15803C12.0536 6.35949 12.0434 6.67591 11.842 6.86477L7.84197 10.6148C7.64964 10.7951 7.35036 10.7951 7.15803 10.6148L3.15803 6.86477C2.95657 6.67591 2.94637 6.35949 3.13523 6.15803Z",fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd"}))}var v={root:"m_e2f5cd4e",controls:"m_95e17d22",control:"m_80b4b171"};let y=/^-0(\.0*)?$/,g=/^-?0\d+$/;function I(e,t,n){return void 0===e||(void 0===t||e>=t)&&(void 0===n||e<=n)}let w={step:1,clampBehavior:"blur",allowDecimal:!0,allowNegative:!0,startValue:0},j=(0,d.Z)((e,{size:t})=>({controls:{"--ni-chevron-size":(0,u.ap)(t,"ni-chevron-size")}})),N=(0,h.d)((e,t)=>{let n=(0,p.w)("NumberInput",w,e),{className:u,classNames:d,styles:h,unstyled:N,vars:D,onChange:E,onValueChange:V,value:S,defaultValue:C,max:k,min:Y,step:W,hideControls:M,rightSection:B,isAllowed:_,clampBehavior:R,onBlur:T,allowDecimal:F,decimalScale:H,onKeyDown:A,handlersRef:z,startValue:P,disabled:L,rightSectionPointerEvents:Z,allowNegative:G,readOnly:$,size:U,rightSectionWidth:X,stepHoldInterval:O,stepHoldDelay:K,allowLeadingZeros:q,...J}=n,Q=(0,m.y)({name:"NumberInput",classes:v,props:n,classNames:d,styles:h,unstyled:N,vars:D,varsResolver:j}),{resolvedClassNames:ee,resolvedStyles:et}=(0,s.h)({classNames:d,styles:h,props:n}),[en,er]=(0,l.C)({value:S,defaultValue:C,onChange:E}),ea=void 0!==K&&void 0!==O,eo=(0,r.useRef)(null),el=(0,r.useRef)(null),ei=(0,r.useRef)(0),ec=e=>{let t=String(e).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);return t?Math.max(0,(t[1]?t[1].length:0)-(t[2]?+t[2]:0)):0},eu=e=>{eo.current&&e&&eo.current.setSelectionRange(e,e)},ed=(0,r.useRef)();ed.current=()=>{let e;let t=ec(en),n=ec(W),r=Math.max(t,n),a=10**r;if("number"!=typeof en||Number.isNaN(en))e=(0,i.u)(P,Y,k);else if(void 0!==k){let t=(Math.round(en*a)+Math.round(W*a))/a;e=t<=k?t:k}else e=(Math.round(en*a)+Math.round(W*a))/a;let o=e.toFixed(r);er(parseFloat(o)),V?.({floatValue:parseFloat(o),formattedValue:o,value:o},{source:"increment"}),setTimeout(()=>eu(eo.current?.value.length),0)};let es=(0,r.useRef)();es.current=()=>{let e;let t=ec(en),n=ec(W),r=Math.max(t,n),a=10**r;if("number"!=typeof en||Number.isNaN(en))e=(0,i.u)(P,Y,k);else{let t=(Math.round(en*a)-Math.round(W*a))/a;e=void 0!==Y&&t<Y?Y:t}let o=e.toFixed(r);er(parseFloat(o)),V?.({floatValue:parseFloat(o),formattedValue:o,value:o},{source:"decrement"}),setTimeout(()=>eu(eo.current?.value.length),0)},(0,c.kR)(z,{increment:ed.current,decrement:es.current});let em=e=>{e?ed.current():es.current(),ei.current+=1},ep=e=>{if(em(e),ea){let t="number"==typeof O?O:O(ei.current);el.current=window.setTimeout(()=>ep(e),t)}},eh=(e,t)=>{e.preventDefault(),eo.current?.focus(),em(t),ea&&(el.current=window.setTimeout(()=>ep(t),K))},eb=()=>{el.current&&window.clearTimeout(el.current),el.current=null,ei.current=0},ef=r.createElement("div",{...Q("controls")},r.createElement(f.k,{...Q("control"),tabIndex:-1,"aria-hidden":!0,disabled:L||"number"==typeof en&&void 0!==k&&en>=k,mod:{direction:"up"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{eh(e,!0)},onPointerUp:eb,onPointerLeave:eb},r.createElement(x,{direction:"up"})),r.createElement(f.k,{...Q("control"),tabIndex:-1,"aria-hidden":!0,disabled:L||"number"==typeof en&&void 0!==Y&&en<=Y,mod:{direction:"down"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{eh(e,!1)},onPointerUp:eb,onPointerLeave:eb},r.createElement(x,{direction:"down"})));return r.createElement(b.M,{component:o.h3,allowNegative:G,className:(0,a.Z)(v.root,u),size:U,...J,readOnly:$,disabled:L,value:en,getInputRef:(0,c.Yx)(t,eo),onValueChange:(e,t)=>{if("event"===t.source){var n;er(!(("number"==typeof(n=e.floatValue)?n<Number.MAX_SAFE_INTEGER:!Number.isNaN(Number(n)))&&!Number.isNaN(n))||y.test(e.value)||q&&g.test(e.value)?e.value:e.floatValue)}V?.(e,t)},rightSection:M||$?B:B||ef,classNames:ee,styles:et,unstyled:N,__staticSelector:"NumberInput",decimalScale:F?H:0,onKeyDown:e=>{A?.(e),$||("ArrowUp"===e.key&&(e.preventDefault(),ed.current()),"ArrowDown"===e.key&&(e.preventDefault(),es.current()))},rightSectionPointerEvents:Z??(L?"none":void 0),rightSectionWidth:X??`var(--ni-right-section-width-${U||"sm"})`,allowLeadingZeros:q,onBlur:e=>{if(T?.(e),"blur"===R&&"number"==typeof en){let e=(0,i.u)(en,Y,k);e!==en&&er((0,i.u)(en,Y,k))}},isAllowed:e=>"strict"===R?_?_(e)&&I(e.floatValue,Y,k):I(e.floatValue,Y,k):!_||_(e)})});N.classes={...b.M.classes,...v},N.displayName="@mantine/core/NumberInput"}},function(e){e.O(0,[57938,9462,17454,47747,49774,92888,40179],function(){return e(e.s=6062)}),_N_E=e.O()}]);