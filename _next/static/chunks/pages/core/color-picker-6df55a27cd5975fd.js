...
`,u={type:"code",component:function(){let[e,t]=(0,l.useState)("rgba(47, 119, 150, 0.7)");return l.createElement(l.Fragment,null,l.createElement(i.z,{format:"rgba",value:e,onChange:t}),l.createElement(s.x,{mt:"md"},e))},code:d,centered:!0};var h=r(75253),p=Object.defineProperty,f=Object.getOwnPropertySymbols,m=Object.prototype.hasOwnProperty,b=Object.prototype.propertyIsEnumerable,y=(e,t,r)=>t in e?p(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,g=(e,t)=>{for(var r in t||(t={}))m.call(t,r)&&y(e,r,t[r]);if(f)for(var r of f(t))b.call(t,r)&&y(e,r,t[r]);return e};let v=`
import { ColorPicker } from '@mantine/core';

function Demo() {
  return <ColorPicker{{props}} />;
}
`,x={type:"configurator",component:function(e){let[t,r]=(0,l.useState)("#C5D899");return l.createElement(h.K,{align:"center"},l.createElement(i.z,g({value:t,onChange:r},e)),l.createElement(s.x,null,t))},code:v,controls:[{prop:"format",type:"select",initialValue:"hex",libraryValue:"hex",data:[{value:"hex",label:"HEX"},{value:"hexa",label:"HEXA"},{value:"rgb",label:"RGB"},{value:"rgba",label:"RGBA"},{value:"hsl",label:"HSL"},{value:"hsla",label:"HSLA"}]}]};var j=r(38621);let k=`
import { ColorPicker } from '@mantine/core';
...
`,w={type:"code",component:function(){return l.createElement(h.K,{align:"center"},l.createElement(i.z,{format:"hex",defaultValue:"rgba(50, 151, 194, 1)",swatches:Object.keys(j.t.colors).map(e=>j.t.colors[e][6])}))},code:k};var P=r(75941);let E=`
import { useState } from 'react';
...
`,C={type:"code",component:function(){let[e,t]=(0,l.useState)("#fff");return l.createElement(l.Fragment,null,l.createElement(i.z,{format:"hex",value:e,onChange:t,withPicker:!1,fullWidth:!0,swatches:[...j.t.colors.red.slice(0,7),...j.t.colors.green.slice(0,7),...j.t.colors.blue.slice(0,7)]}),l.createElement(s.x,{ta:"center",mt:5},e))},code:E,centered:!0,maxWidth:220};var O=Object.defineProperty,M=Object.getOwnPropertySymbols,S=Object.prototype.hasOwnProperty,z=Object.prototype.propertyIsEnumerable,T=(e,t,r)=>t in e?O(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,L=(e,t)=>{for(var r in t||(t={}))S.call(t,r)&&T(e,r,t[r]);if(M)for(var r of M(t))z.call(t,r)&&T(e,r,t[r]);return e};let _=`
import { ColorPicker } from '@mantine/core';

function Demo() {
  return <ColorPicker{{props}} />;
}
`,D={type:"configurator",component:function(e){return l.createElement(i.z,L({mx:"auto",format:"rgba",defaultValue:"rgba(50, 151, 194, 1)",swatches:Object.keys(j.t.colors).map(e=>j.t.colors[e][6])},e))},code:_,controls:[{prop:"size",type:"size",initialValue:"sm",libraryValue:"sm"}]},A=`
import { ColorPicker } from '@mantine/core';

function Demo() {
  return <ColorPicker fullWidth size="lg" format="rgba" />;
}
`,Z={type:"code",component:function(){return l.createElement(i.z,{fullWidth:!0,size:"lg",format:"rgba"})},code:A};var I=r(99059),W=Object.defineProperty,H=Object.getOwnPropertySymbols,V=Object.prototype.hasOwnProperty,F=Object.prototype.propertyIsEnumerable,N=(e,t,r)=>t in e?W(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,R=(e,t)=>{for(var r in t||(t={}))V.call(t,r)&&N(e,r,t[r]);if(H)for(var r of H(t))F.call(t,r)&&N(e,r,t[r]);return e};let U=`
import { ColorPicker } from '@mantine/core';
...
`,p={type:"configurator",component:function(e){return o.createElement(n.z,u({mx:"auto",format:"hex",defaultValue:"rgba(50, 151, 194, 1)",swatches:Object.keys(a.t.colors).map(e=>a.t.colors[e][6])},e))},code:h,controls:[{prop:"swatchesPerRow",type:"number",initialValue:7,libraryValue:7,min:5,max:12}]}}},function(e){e.O(0,[8992,178,9774,2888,179],function(){return e(e.s=59140)}),_N_E=e.O()}]);