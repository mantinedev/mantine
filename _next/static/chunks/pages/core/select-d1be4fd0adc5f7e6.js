...
`,maxWidth:340,centered:!0};var i=o(42081);let c={type:"code",component:function(){return(0,n.jsx)(r.l,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],defaultValue:"React",clearable:!0})},code:`
import { Select } from '@mantine/core';
...
`,g=Array(1e5).fill(0).map((e,t)=>`Option ${t}`),v={type:"code",component:function(){return(0,n.jsx)(r.l,{label:"100 000 options autocomplete",placeholder:"Use limit to optimize performance",limit:5,data:g,searchable:!0})},code:f,maxWidth:340,centered:!0};var j=o(31019);let y=`
import { Select } from '@mantine/core';
...
`,maxWidth:340,centered:!0},A={type:"code",component:function(){return(0,n.jsx)(r.l,{label:"Your favorite library",placeholder:"Pick value",data:[{value:"react",label:"React"},{value:"ng",label:"Angular"},{value:"vue",label:"Vue",disabled:!0},{value:"svelte",label:"Svelte",disabled:!0}]})},code:`
import { Select } from '@mantine/core';
...
`,maxWidth:340,centered:!0};var P=o(35764),V=o(52022);let R={type:"code",code:`
...
`,maxWidth:340,centered:!0},B={type:"code",component:function(){return(0,n.jsx)(r.l,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],comboboxProps:{shadow:"md"}})},code:`
import { Select } from '@mantine/core';
...
`},z={type:"configurator",component:function(e){return(0,n.jsx)(r.l,{...e,placeholder:"Select placeholder",data:["React","Angular","Vue","Svelte"]})},code:`
import { Select } from '@mantine/core';
...
`,centered:!0,maxWidth:340,controls:o(23232).$7},E={type:"code",component:function(){return(0,n.jsx)(r.l,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],readOnly:!0})},code:`
import { Select } from '@mantine/core';
...
`,maxWidth:340,centered:!0},_={type:"code",component:function(){return(0,n.jsx)(r.l,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],disabled:!0})},code:`
import { Select } from '@mantine/core';
