...
`,centered:!0};var s=l(86103),u=l(2784),d=l(8582);let c={type:"code",component:function(){let[e,n]=(0,u.useState)(0),[l,r]=(0,u.useState)(0);return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(t.r,{value:e,onChange:n,onChangeEnd:r}),(0,a.jsxs)(d.x,{mt:"md",children:["Current value: ",e]}),(0,a.jsxs)(d.x,{children:["End value: ",l]})]})},code:`
...
`,centered:!0}},6004:function(e,n,l){"use strict";l.d(n,{r:function(){return g}});var a=l(52322),r=l(2784),t=l(82692),o=l(9341),i=l(70837),s=l(58898),u=l(86411),d=l(11200),c=l(38483),m=l(46690),h=l(28559),b=l(82027),v={root:"m_48204f9b",marks:"m_bb9cdbad",mark:"m_481dd586",thumb:"m_bc02ba3d",label:"m_bb8e875b"};function p(e,n){let l=(0,t.u)(e,0,360),a=Math.ceil(l/n);return a>=l/n?a*n==360?0:a*n:Math.round(l/n)*n}let x={step:1,withLabel:!0},f=(0,d.Z)((e,{size:n,thumbSize:l})=>({root:{"--slider-size":(0,s.h)(n),"--thumb-size":(0,s.h)(l)}})),g=(0,b.d5)((e,n)=>{let l=(0,c.w)("AngleSlider",x,e),{classNames:t,className:s,style:d,styles:b,unstyled:g,vars:j,step:k,value:A,defaultValue:y,onChange:S,onMouseDown:E,withLabel:w,marks:_,thumbSize:L,restrictToMarks:C,formatLabel:T,onChangeEnd:V,disabled:D,onTouchStart:M,name:z,hiddenInputProps:N,"aria-label":$,tabIndex:R,...G}=l,I=(0,r.useRef)(null),[P,U]=(0,o.C)({value:A,defaultValue:y,finalValue:0,onChange:S}),X=(0,m.y)({name:"AngleSlider",classes:v,props:l,className:s,style:d,classNames:t,styles:b,unstyled:g,vars:j,varsResolver:f}),Y=(e,n=!1)=>{if(I.current){let l=p(function(e,n){let l=function(e){let n=e.getBoundingClientRect();return[n.left+n.width/2,n.top+n.height/2]}(n);return 360-(180/Math.PI*Math.atan2(e[0]-l[0],e[1]-l[1])+180)}([e.clientX,e.clientY],I.current),k||1),a=C&&Array.isArray(_)?(0,u.s)(l,_.map(e=>e.value)):l;U(a),n&&V?.(a)}},q=(0,r.useCallback)(e=>{Y(e)},[]),F=(0,r.useCallback)(e=>{Y(e,!0),B()},[]),H=(0,r.useCallback)(e=>{e.preventDefault(),Y(e.touches[0])},[]),O=(0,r.useCallback)(e=>{Y(e.changedTouches[0],!0),B()},[]),Z=()=>{document.addEventListener("mousemove",q,!1),document.addEventListener("mouseup",F,!1),document.addEventListener("touchmove",H,{passive:!1}),document.addEventListener("touchend",O,!1)},B=()=>{document.removeEventListener("mousemove",q,!1),document.removeEventListener("mouseup",F,!1),document.removeEventListener("touchmove",H,!1),document.removeEventListener("touchend",O,!1)},K=_?.map((e,n)=>r.createElement("div",{...X("mark",{style:{"--angle":`${e.value}deg`}}),"data-label":e.label||void 0,key:n}));return(0,a.jsxs)(h.x,{ref:(0,i.Yx)(n,I),...X("root",{focusable:!0}),onMouseDown:e=>{E?.(e),Z()},onTouchStart:e=>{e.preventDefault(),M?.(e),Z()},...G,children:[K&&K.length>0&&(0,a.jsx)("div",{...X("marks"),children:K}),w&&(0,a.jsx)("div",{...X("label"),children:"function"==typeof T?T(P):P}),(0,a.jsx)("div",{tabIndex:R??(D?-1:0),role:"slider","aria-valuemax":360,"aria-valuemin":0,"aria-valuenow":P,onKeyDown:e=>{if(!D){if("ArrowLeft"===e.key||"ArrowDown"===e.key){let e=p(P-k,k);U(e),V?.(e)}if("ArrowRight"===e.key||"ArrowUp"===e.key){let e=p(P+k,k);U(e),V?.(e)}"Home"===e.key&&(U(0),V?.(0)),"End"===e.key&&(U(359),V?.(359))}},"aria-label":$,...X("thumb",{style:{transform:`rotate(${P}deg)`}})}),(0,a.jsx)("input",{type:"hidden",name:z,value:P,...N})]})});g.displayName="@mantine/core/AngleSlider",g.classes=v}},function(e){e.O(0,[61177,66748,11340,92888,49774,40179],function(){return e(e.s=89421)}),_N_E=e.O()}]);