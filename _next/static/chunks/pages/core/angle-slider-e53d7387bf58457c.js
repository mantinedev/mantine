(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[83925],{66409:(e,a,t)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/angle-slider",function(){return t(37982)}])},37982:(e,a,t)=>{"use strict";t.r(a),t.d(a,{default:()=>x});var l=t(31085),r=t(71184),n=t(91401);let o={type:"configurator",component:function(e){return(0,l.jsx)(n.P,{"aria-label":"Angle slider",...e})},code:`
import { AngleSlider } from '@mantine/core';

function Demo() {
  return <AngleSlider aria-label="Angle slider"{{props}} />;
}
`,centered:!0,controls:[{type:"number",prop:"size",initialValue:60,libraryValue:"__",min:50,max:200},{type:"number",prop:"thumbSize",initialValue:8,libraryValue:"__",min:1,max:100},{type:"boolean",prop:"withLabel",initialValue:!0,libraryValue:!0}]},s={type:"code",component:function(){return(0,l.jsx)(n.P,{"aria-label":"Angle slider",formatLabel:e=>`${e}\xb0`})},code:`
import { AngleSlider } from '@mantine/core';

function Demo() {
  return <AngleSlider aria-label="Angle slider" formatLabel={(value) => \`\${value}\xb0\`} />;
}
`,centered:!0};var i=t(31460),d=t(14041),c=t(93065);let u={type:"code",component:function(){let[e,a]=(0,d.useState)(0),[t,r]=(0,d.useState)(0);return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(n.P,{value:e,onChange:a,onChangeEnd:r}),(0,l.jsxs)(c.E,{mt:"md",children:["Current value: ",e]}),(0,l.jsxs)(c.E,{children:["End value: ",t]})]})},code:`
...
`,centered:!0}},55100:(e,a,t)=>{"use strict";t.d(a,{P:()=>i});var l=t(31085),r=t(14041),n=t(34056),o=t(4235),s={root:"m_7cf02604",value:"m_2146908f",thumb:"m_212db0f4"};let i={type:"code",component:function(){let[e,a]=(0,r.useState)(115),{ref:t}=(0,o.R)(a);return(0,l.jsxs)(n.a,{className:s.root,ref:t,style:{"--angle":`${e}deg`},children:[(0,l.jsxs)("div",{className:s.value,children:[e,"\xb0"]}),(0,l.jsx)("div",{className:s.thumb})]})},code:[{fileName:"Demo.tsx",code:`
import { useState } from 'react';
...
}`,language:"scss"}],centered:!0}},91401:(e,a,t)=>{"use strict";t.d(a,{P:()=>x});var l=t(31085),r=t(14041),n=t(82307),o=t(4235),s=t(34321),i=t(39735),d=t(96532),c=t(7098),u=t(29686),v=t(69564),h=t(34056),m=t(6754),p={root:"m_48204f9b",marks:"m_bb9cdbad",mark:"m_481dd586",thumb:"m_bc02ba3d",label:"m_bb8e875b"};let g={step:1,withLabel:!0},b=(0,c.V)((e,{size:a,thumbSize:t})=>({root:{"--slider-size":(0,i.D)(a),"--thumb-size":(0,i.D)(t)}})),x=(0,m.P9)((e,a)=>{let t=(0,u.Y)("AngleSlider",g,e),{classNames:i,className:c,style:m,styles:x,unstyled:f,vars:y,step:k,value:A,defaultValue:j,onChange:M,onMouseDown:w,withLabel:S,marks:E,thumbSize:L,restrictToMarks:D,formatLabel:_,onChangeEnd:V,disabled:C,onTouchStart:N,name:T,hiddenInputProps:I,"aria-label":P,tabIndex:R,onScrubStart:z,onScrubEnd:$,mod:U,attributes:B,...F}=t,X=(0,r.useRef)(null),[G,Y]=(0,n.Z)({value:A,defaultValue:j,finalValue:0,onChange:M}),{ref:Z}=(0,o.R)(e=>{X.current&&!C&&Y(D&&Array.isArray(E)?(0,d.k)(e,E.map(e=>e.value)):e)},{step:k,onChangeEnd:V,onScrubStart:z,onScrubEnd:$}),q=(0,v.I)({name:"AngleSlider",classes:p,props:t,className:c,style:m,classNames:i,styles:x,unstyled:f,attributes:B,vars:y,varsResolver:b}),K=E?.map((e,a)=>r.createElement("div",{...q("mark",{style:{"--angle":`${e.value}deg`}}),"data-label":e.label||void 0,key:a}));return(0,l.jsxs)(h.a,{ref:(0,s.pc)(a,X,Z),...q("root",{focusable:!0}),mod:[{disabled:C},U],...F,children:[K&&K.length>0&&(0,l.jsx)("div",{...q("marks"),children:K}),S&&(0,l.jsx)("div",{...q("label"),children:"function"==typeof _?_(G):G}),(0,l.jsx)("div",{tabIndex:R??(C?-1:0),role:"slider","aria-valuemax":360,"aria-valuemin":0,"aria-valuenow":G,onKeyDown:e=>{if(C)return;let a=G;if(("ArrowLeft"===e.key||"ArrowDown"===e.key)&&(e.preventDefault(),a=(0,o.i)(G-k,k)),("ArrowRight"===e.key||"ArrowUp"===e.key)&&(e.preventDefault(),a=(0,o.i)(G+k,k)),"Home"===e.key&&(a=0),"End"===e.key&&(a=359),D&&Array.isArray(E)){let t=E.map(e=>e.value),l=t.indexOf(G);a=-1!==l?"ArrowLeft"===e.key||"ArrowDown"===e.key?t[Math.max(0,l-1)]:"ArrowRight"===e.key||"ArrowUp"===e.key?t[Math.min(t.length-1,l+1)]:(0,d.k)(a,t):(0,d.k)(a,t)}Y(a),V?.(a)},"aria-label":P,...q("thumb",{style:{transform:`rotate(${G}deg)`}})}),(0,l.jsx)("input",{type:"hidden",name:T,value:G,...I})]})});x.displayName="@mantine/core/AngleSlider",x.classes=p},4235:(e,a,t)=>{"use strict";t.d(a,{R:()=>o,i:()=>n});var l=t(14041),r=t(68193);function n(e,a){var t,l;let n=(0,r.q)(e,0,360),o=Math.ceil(n/a),s=Math.round(n/a);return t=o>=n/a?o*a==360?0:o*a:s*a,l=a.toString().split(".")[1]?.length||0,parseFloat(t.toFixed(l))}function o(e,{step:a=.01,onChangeEnd:t,onScrubStart:r,onScrubEnd:s}={}){let i=(0,l.useRef)(!1),[d,c]=(0,l.useState)(!1);return(0,l.useEffect)(()=>{i.current=!0},[]),{ref:(0,l.useCallback)(l=>{let o=(r,o=!1)=>{if(l){l.style.userSelect="none";let s=n(function(e,a){let t=function(e){let a=e.getBoundingClientRect();return[a.left+a.width/2,a.top+a.height/2]}(a);return 360-(180/Math.PI*Math.atan2(e[0]-t[0],e[1]-t[1])+180)}([r.clientX,r.clientY],l),a||1);e(s),o&&t?.(s)}},i=()=>{r?.(),c(!0),document.addEventListener("mousemove",v,!1),document.addEventListener("mouseup",h,!1),document.addEventListener("touchmove",m,{passive:!1}),document.addEventListener("touchend",p,!1)},d=()=>{s?.(),c(!1),document.removeEventListener("mousemove",v,!1),document.removeEventListener("mouseup",h,!1),document.removeEventListener("touchmove",m,!1),document.removeEventListener("touchend",p,!1)},u=e=>{i(),o(e)},v=e=>{o(e)},h=e=>{o(e,!0),d()},m=e=>{e.preventDefault(),o(e.touches[0])},p=e=>{o(e.changedTouches[0],!0),d()},g=e=>{e.preventDefault(),i(),o(e.touches[0])};return l?.addEventListener("mousedown",u),l?.addEventListener("touchstart",g,{passive:!1}),()=>{l&&(l.removeEventListener("mousedown",u),l.removeEventListener("touchstart",g))}},[e]),active:d}}}},e=>{var a=a=>e(e.s=a);e.O(0,[18675,90636,46593,38792],()=>a(66409)),_N_E=e.O()}]);