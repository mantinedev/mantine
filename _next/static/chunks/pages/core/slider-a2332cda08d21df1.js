(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[57919],{19709:(e,a,l)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/slider",function(){return l(28244)}])},28244:(e,a,l)=>{"use strict";l.r(a),l.d(a,{default:()=>R});var t=l(31085),r=l(71184),n=l(84281);let s={type:"configurator",component:function(e){return(0,t.jsx)(n.A,{defaultValue:40,marks:[{value:20,label:"20%"},{value:50,label:"50%"},{value:80,label:"80%"}],...e})},code:`
...
`,centered:!0,maxWidth:400};var p=l(51002);let x={type:"code",component:function(){return(0,t.jsx)(n.A,{min:0,max:1,step:5e-4,defaultValue:.5535})},code:`
import { Slider } from '@mantine/core';
...
`,centered:!0,maxWidth:400};var f=l(24377);let g={type:"configurator",component:function(e){return(0,t.jsx)(n.A,{...e,defaultValue:20})},code:`
import { Slider } from '@mantine/core';

function Demo() {
  return <Slider{{props}} defaultValue={20} />;
}
`,maxWidth:400,centered:!0,controls:[{prop:"thumbSize",type:"number",min:16,max:32,initialValue:14,libraryValue:null}]};var y=l(45854),j=(0,l(73366).A)("outline","heart-broken","IconHeartBroken",[["path",{d:"M19.5 12.572l-7.5 7.428l-7.5 -7.428a5 5 0 1 1 7.5 -6.566a5 5 0 1 1 7.5 6.572",key:"svg-0"}],["path",{d:"M12 6l-2 4l4 3l-2 4v3",key:"svg-1"}]]),k=l(1784);let w={type:"code",component:function(){return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.A,{thumbChildren:(0,t.jsx)(y.A,{size:16,stroke:1.5}),color:"red",label:null,defaultValue:40,thumbSize:26,styles:{thumb:{borderWidth:2,padding:3}}}),(0,t.jsx)(k.F,{mt:"xl",styles:{thumb:{borderWidth:2,padding:3}},color:"red",label:null,defaultValue:[20,60],thumbSize:26,thumbChildren:[(0,t.jsx)(y.A,{size:16,stroke:1.5},"1"),(0,t.jsx)(j,{size:16,stroke:1.5},"2")]})]})},code:`
...
`,centered:!0,maxWidth:400};var T=l(38607);let z=`
import { Slider } from '@mantine/core';
...
`,language:"scss"}],maxWidth:500,centered:!0}},51002:(e,a,l)=>{"use strict";l.d(a,{b:()=>n});var t=l(31085),r=l(84281);let n={type:"code",component:function(){return(0,t.jsx)(r.A,{domain:[0,100],min:10,max:90,defaultValue:25,mb:40,marks:[{value:10,label:"min"},{value:90,label:"max"}]})},code:`
import { Slider } from '@mantine/core';
...
`,centered:!0,maxWidth:400}},1784:(e,a,l)=>{"use strict";l.d(a,{F:()=>D});var t=l(31085),r=l(14041),n=l(82307),s=l(68193),i=l(7235),o=l(34321),d=l(39735),c=l(33450),u=l(96532),m=l(7098),h=l(51606),v=l(29686),p=l(69564),x=l(6754),b=l(46746),f=l(96448),g=l(5861),y=l(60881),j=l(36247),k=l(7139),w=l(27064),S=l(48093),A=l(46315),M=l(94023),V=l(85212);let T=(0,m.V)((e,{size:a,color:l,thumbSize:t,radius:r})=>({root:{"--slider-size":(0,c.YC)(a,"slider-size"),"--slider-color":l?(0,h.r)(l,e):void 0,"--slider-radius":void 0===r?void 0:(0,c.nJ)(r),"--slider-thumb-size":void 0!==t?(0,d.D)(t):"calc(var(--slider-size) * 2)"}})),z={min:0,max:100,minRange:10,step:1,marks:[],label:e=>e,labelTransitionProps:{transition:"fade",duration:0},labelAlwaysOn:!1,showLabelOnHover:!0,disabled:!1,pushOnOverlap:!0,scale:e=>e,size:"md",maxRange:1/0},D=(0,x.P9)((e,a)=>{let l=(0,v.Y)("RangeSlider",z,e),{classNames:d,styles:c,value:m,onChange:h,onChangeEnd:x,size:D,min:C,max:E,domain:N,minRange:I,maxRange:F,step:_,precision:L,defaultValue:R,name:W,marks:B,label:O,labelTransitionProps:H,labelAlwaysOn:$,thumbFromLabel:q,thumbToLabel:P,showLabelOnHover:X,thumbChildren:Y,disabled:K,unstyled:G,scale:U,inverted:Z,className:J,style:Q,vars:ee,hiddenInputProps:ea,restrictToMarks:el,thumbProps:et,pushOnOverlap:er,attributes:en,...es}=l,ei=(0,p.I)({name:"Slider",props:l,classes:V.A,classNames:d,className:J,styles:c,style:Q,attributes:en,vars:ee,varsResolver:T,unstyled:G}),eo=(0,r.useRef)(null),{dir:ed}=(0,b.jH)(),[ec,eu]=(0,r.useState)(-1),[em,eh]=(0,r.useState)(!1),[ev,ep]=(0,n.Z)({value:m,defaultValue:R,finalValue:[C,E],onChange:h}),ex=(0,r.useRef)(ev),eb=(0,r.useRef)([]),ef=(0,r.useRef)(null),eg=(0,r.useRef)(void 0),[ey,ej]=N||[C,E],ek=[(0,S.E)({value:ev[0],min:ey,max:ej}),(0,S.E)({value:ev[1],min:ey,max:ej})],ew=L??(0,A.X)(_),eS=e=>{ep(e),ex.current=e};(0,r.useEffect)(()=>{Array.isArray(m)&&(ex.current=m)},Array.isArray(m)?[m[0],m[1]]:[null,null]);let eA=(e,a,l)=>{if(-1===a)return;let t=[...ex.current];if(el&&B){let l=(0,u.k)(e,B.map(e=>e.value)),r=t[a];t[a]=l;let n=0===a?1:0,s=(0,M.rq)(B),i=(0,M.HE)(B);l===s&&t[n]===s?t[a]=r:l===i&&t[n]===i?t[a]=r:l===t[n]&&(r>t[n]?t[n]=(0,M.Mh)(l,B):t[n]=(0,M.C8)(l,B))}else{let l=(0,s.q)(e,C,E);t[a]=l,0===a&&(l>t[1]-(I-1e-9)&&(er?t[1]=Math.min(e+I,E):t[a]=ex.current[a]),l>(E-(I-1e-9)||C)&&(t[a]=ex.current[a]),t[1]-e>F&&(er?t[1]=e+F:t[a]=ex.current[a])),1===a&&(l<t[0]+I&&(er?t[0]=Math.max(e-I,C):t[a]=ex.current[a]),l<t[0]+I&&(t[a]=ex.current[a]),l-t[0]>F&&(er?t[0]=e-F:t[a]=ex.current[a]))}if(t[0]=(0,w.q)(t[0],ew),t[1]=(0,w.q)(t[1],ew),t[0]>t[1]){let e=t[0];t[0]=t[1],t[1]=e}eS(t),l&&x?.(ex.current)},eM=e=>{K||void 0===eg.current||eA((0,k.c)({value:e,min:ey,max:ej,step:_,precision:ew}),eg.current,!1)},{ref:eV,active:eT}=(0,i.f)(({x:e})=>eM(e),{onScrubEnd:()=>!K&&x?.(ex.current)},ed),ez=e=>{if(eo.current){eo.current.focus();let a=eo.current.getBoundingClientRect(),l=function(e){return"TouchEvent"in window&&e instanceof window.TouchEvent?e.touches[0].clientX:e.clientX}(e.nativeEvent),t=(0,k.c)({value:l-a.left,max:E,min:C,step:_,containerWidth:a.width}),r=Math.abs(ev[0]-t)>Math.abs(ev[1]-t)?1:0,n="ltr"===ed?r:1===r?0:1;eg.current=n}},eD=()=>1!==ec&&0!==ec?(eu(0),0):ec,eC={max:E,min:C,size:D,labelTransitionProps:H,labelAlwaysOn:$,onBlur:()=>eu(-1)},eE=Array.isArray(Y);return(0,t.jsx)(f.h,{value:{getStyles:ei},children:(0,t.jsxs)(g.g,{...es,size:D,ref:(0,o.pc)(a,ef),disabled:K,onMouseDownCapture:()=>ef.current?.focus(),onKeyDownCapture:()=>{eb.current[0]?.parentElement?.contains(document.activeElement)||eb.current[0]?.focus()},children:[(0,t.jsxs)(j.C,{offset:ek[0],marksOffset:ev[0],filled:ek[1]-ek[0],marks:B,inverted:Z,min:ey,max:ej,value:ev[1],disabled:K,containerProps:{ref:(0,o.pc)(eo,eV),onMouseEnter:X?()=>eh(!0):void 0,onMouseLeave:X?()=>eh(!1):void 0,onTouchStartCapture:ez,onTouchEndCapture:()=>{eg.current=-1},onMouseDownCapture:ez,onMouseUpCapture:()=>{eg.current=-1},onKeyDownCapture:e=>{if(!K)switch(e.key){case"ArrowUp":{e.preventDefault();let a=eD();eb.current[a].focus();let l=el&&B?(0,M.C8)(ex.current[a],B):Math.min(Math.max(ex.current[a]+_,C),E);eA((0,w.q)(l,ew),a,!0);break}case"ArrowRight":{e.preventDefault();let a=eD();eb.current[a].focus();let l=el&&B?("rtl"===ed?M.Mh:M.C8)(ex.current[a],B):Math.min(Math.max("rtl"===ed?ex.current[a]-_:ex.current[a]+_,C),E);eA((0,w.q)(l,ew),a,!0);break}case"ArrowDown":{e.preventDefault();let a=eD();eb.current[a].focus();let l=el&&B?(0,M.Mh)(ex.current[a],B):Math.min(Math.max(ex.current[a]-_,C),E);eA((0,w.q)(l,ew),a,!0);break}case"ArrowLeft":{e.preventDefault();let a=eD();eb.current[a].focus();let l=el&&B?("rtl"===ed?M.C8:M.Mh)(ex.current[a],B):Math.min(Math.max("rtl"===ed?ex.current[a]+_:ex.current[a]-_,C),E);eA((0,w.q)(l,ew),a,!0)}}}},children:[(0,t.jsx)(y.z,{...eC,value:U(ev[0]),position:ek[0],dragging:eT,label:"function"==typeof O?O((0,w.q)(U(ev[0]),ew)):O,ref:e=>{e&&(eb.current[0]=e)},thumbLabel:q,onMouseDown:()=>void(eg.current=0),onFocus:()=>eu(0),showLabelOnHover:X,isHovered:em,disabled:K,...et?.(0),children:eE?Y[0]:Y}),(0,t.jsx)(y.z,{...eC,thumbLabel:P,value:U(ev[1]),position:ek[1],dragging:eT,label:"function"==typeof O?O((0,w.q)(U(ev[1]),ew)):O,ref:e=>{e&&(eb.current[1]=e)},onMouseDown:()=>void(eg.current=1),onFocus:()=>eu(1),showLabelOnHover:X,isHovered:em,disabled:K,...et?.(1),children:eE?Y[1]:Y})]}),(0,t.jsx)("input",{type:"hidden",name:`${W}_from`,value:ev[0],...ea}),(0,t.jsx)("input",{type:"hidden",name:`${W}_to`,value:ev[1],...ea})]})})});D.classes=V.A,D.displayName="@mantine/core/RangeSlider"}},e=>{var a=a=>e(e.s=a);e.O(0,[18675,90636,46593,38792],()=>a(19709)),_N_E=e.O()}]);