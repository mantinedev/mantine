...
`,P={type:"code",code:C,centered:!0,component:function(){return s.createElement(b,{size:170,thickness:16,label:s.createElement(Text.x,{size:"xs",ta:"center",px:"xs",style:{pointerEvents:"none"}},"Hover sections to see tooltips"),sections:[{value:40,color:"cyan",tooltip:"Documents – 40 Gb"},{value:25,color:"orange",tooltip:"Apps – 25 Gb"},{value:15,color:"grape",tooltip:"Other – 15 Gb"}]})}},k=`
import { RingProgress } from '@mantine/core';

function Demo() {
  return <RingProgress sections={[{ value: 40, color: 'yellow' }]} rootColor="red" />;
}
`,z={type:"code",code:k,centered:!0,component:function(){return s.createElement(b,{sections:[{value:40,color:"yellow"}],rootColor:"red"})}},M=`
