(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[55686],{72394:function(e,t,r){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/color-picker",function(){return r(52265)}])},52265:function(e,t,r){"use strict";r.r(t),r.d(t,{default:function(){return D}});var n=r(52322),o=r(45392),l=r(2784),c=r(37574),Text=r(8582);let a=`
...
`,p={type:"code",component:function(){return l.createElement(s.K,{align:"center"},l.createElement(c.z,{format:"hex",defaultValue:"rgba(50, 151, 194, 1)",swatches:Object.keys(h.t.colors).map(e=>h.t.colors[e][6])}))},code:m};var f=r(96464);let x=`
import { useState } from 'react';
...
`,k={type:"code",component:function(){return l.createElement(c.z,{fullWidth:!0,size:"lg",format:"rgba"})},code:w};var E=r(46008);let v=`
import { ColorPicker } from '@mantine/core';
...
`,a={type:"code",component:function(){let[e,t]=(0,n.useState)(250);return n.createElement(n.Fragment,null,n.createElement(o.x,null,"Hue value: ",e),n.createElement(l.Q,{value:e,onChange:t}))},code:c,centered:!0,maxWidth:300}},96464:function(e,t,r){"use strict";r.d(t,{h:function(){return a}});var n=r(2784),o=r(37574),l=r(87744);let c=`
import { ColorPicker } from '@mantine/core';
