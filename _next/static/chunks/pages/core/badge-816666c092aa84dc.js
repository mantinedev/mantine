...
`,centered:!0,controls:c.P};var g=n(93693),s=n(71078),p=n(22971);let m=`
...
`,f={type:"code",component:function(){let e=i.createElement(g.Z,{style:{width:(0,s.h)(12),height:(0,s.h)(12)}});return i.createElement(p.Z,null,i.createElement(a.C,{leftSection:e},"With left section"),i.createElement(a.C,{rightSection:e},"With right section"))},centered:!0,code:m},h=`
import { Badge } from '@mantine/core';

function Demo() {
  return <Badge fullWidth>Full width badge</Badge>;
}
`,b={type:"code",component:function(){return i.createElement(a.C,{fullWidth:!0},"Full width badge")},code:h};var y=n(68738);let B=`
