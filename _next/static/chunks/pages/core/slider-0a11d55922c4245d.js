...
`,centered:!0,maxWidth:400,controls:[{prop:"color",type:"color",initialValue:"blue",libraryValue:"__none__"},{prop:"size",type:"size",initialValue:"md",libraryValue:"md"},{prop:"radius",type:"size",initialValue:"xl",libraryValue:"xl"},{prop:"showLabelOnHover",type:"boolean",initialValue:!0,libraryValue:!0},{prop:"labelAlwaysOn",type:"boolean",initialValue:!1,libraryValue:!1}]};var i=l(1784);let o={type:"configurator",component:function(e){return(0,t.jsx)(i.F,{defaultValue:[20,60],marks:[{value:20,label:"20%"},{value:50,label:"50%"},{value:80,label:"80%"}],...e})},code:`
...
`,centered:!0,maxWidth:400},b={type:"code",component:function(){return(0,t.jsx)(n.A,{min:0,max:1,step:5e-4,defaultValue:.5535})},code:`
import { Slider } from '@mantine/core';

function Demo() {
  return <Slider min={0} max={1} step={0.0005} defaultValue={0.5535} />;
}
`,centered:!0,maxWidth:340},f={type:"code",component:function(){return(0,t.jsx)(i.F,{minRange:.2,min:0,max:1,step:5e-4,defaultValue:[.1245,.5535]})},code:`
import { RangeSlider } from '@mantine/core';
...
`,centered:!0,maxWidth:340},g={type:"code",component:function(){let e=[{value:20,label:"20%"},{value:50,label:"50%"},{value:80,label:"80%"}];return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.A,{defaultValue:40,marks:[{value:10},{value:40},{value:95}],mb:32}),(0,t.jsx)(n.A,{defaultValue:40,marks:e,mb:32}),(0,t.jsx)(i.F,{defaultValue:[20,80],marks:e,mb:32})]})},code:`
import { Slider, RangeSlider } from '@mantine/core';
...
`,centered:!0,maxWidth:400};var y=l(24377);let j={type:"configurator",component:function(e){return(0,t.jsx)(n.A,{...e,defaultValue:20})},code:`
import { Slider } from '@mantine/core';

function Demo() {
  return <Slider{{props}} defaultValue={20} />;
}
`,maxWidth:400,centered:!0,controls:[{prop:"thumbSize",type:"number",min:16,max:32,initialValue:14,libraryValue:null}]};var k=l(45854),w=(0,l(73366).A)("outline","heart-broken","IconHeartBroken",[["path",{d:"M19.5 12.572l-7.5 7.428l-7.5 -7.428a5 5 0 1 1 7.5 -6.566a5 5 0 1 1 7.5 6.572",key:"svg-0"}],["path",{d:"M12 6l-2 4l4 3l-2 4v3",key:"svg-1"}]]);let S={type:"code",component:function(){return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.A,{thumbChildren:(0,t.jsx)(k.A,{size:16,stroke:1.5}),color:"red",label:null,defaultValue:40,thumbSize:26,styles:{thumb:{borderWidth:2,padding:3}}}),(0,t.jsx)(i.F,{mt:"xl",styles:{thumb:{borderWidth:2,padding:3}},color:"red",label:null,defaultValue:[20,60],thumbSize:26,thumbChildren:[(0,t.jsx)(k.A,{size:16,stroke:1.5},"1"),(0,t.jsx)(w,{size:16,stroke:1.5},"2")]})]})},code:`
import { Slider, RangeSlider } from '@mantine/core';
...
`,maxWidth:400,centered:!0};function V(e){let a=["KB","MB","GB","TB"],l=0,t=e;for(;t>=1024&&l<a.length-1;)l+=1,t/=1024;return`${t} ${a[l]}`}let A=e=>2**e,M={type:"code",component:function(){return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.A,{scale:A,step:1,min:2,max:30,labelAlwaysOn:!0,defaultValue:10,label:V}),(0,t.jsx)(i.F,{mt:50,scale:A,step:1,min:2,max:30,labelAlwaysOn:!0,defaultValue:[10,20],label:V})]})},code:`
...
`,centered:!0,maxWidth:400},T={type:"code",component:function(){return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(n.A,{inverted:!0,defaultValue:80}),(0,t.jsx)(i.F,{inverted:!0,defaultValue:[40,80],mt:"xl"})]})},code:`
import { RangeSlider, Slider } from '@mantine/core';
...
`,centered:!0,maxWidth:400}},1784:(e,a,l)=>{"use strict";l.d(a,{F:()=>z});var t=l(31085),r=l(14041),n=l(82307),s=l(7235),i=l(34321),o=l(39735),d=l(33450),u=l(96532),c=l(7098),m=l(51606),h=l(29686),p=l(69564),v=l(6754),x=l(46746),b=l(96448),f=l(5861),g=l(60881),y=l(36247),j=l(7139),k=l(27064),w=l(48093),S=l(46315),V=l(94023),A=l(85212);let M=(0,c.V)((e,{size:a,color:l,thumbSize:t,radius:r})=>({root:{"--slider-size":(0,d.YC)(a,"slider-size"),"--slider-color":l?(0,m.r)(l,e):void 0,"--slider-radius":void 0===r?void 0:(0,d.nJ)(r),"--slider-thumb-size":void 0!==t?(0,o.D)(t):"calc(var(--slider-size) * 2)"}})),T={min:0,max:100,minRange:10,step:1,marks:[],label:e=>e,labelTransitionProps:{transition:"fade",duration:0},labelAlwaysOn:!1,showLabelOnHover:!0,disabled:!1,scale:e=>e},z=(0,v.P9)((e,a)=>{let l=(0,h.Y)("RangeSlider",T,e),{classNames:o,styles:d,value:c,onChange:m,onChangeEnd:v,size:z,min:D,max:R,minRange:C,maxRange:E,step:F,precision:N,defaultValue:_,name:I,marks:L,label:W,labelTransitionProps:B,labelAlwaysOn:O,thumbFromLabel:H,thumbToLabel:$,showLabelOnHover:q,thumbChildren:P,disabled:X,unstyled:Y,scale:K,inverted:G,className:U,style:Z,vars:J,hiddenInputProps:Q,restrictToMarks:ee,thumbProps:ea,...el}=l,et=(0,p.I)({name:"Slider",props:l,classes:A.A,classNames:o,className:U,styles:d,style:Z,vars:J,varsResolver:M,unstyled:Y}),{dir:er}=(0,x.jH)(),[en,es]=(0,r.useState)(-1),[ei,eo]=(0,r.useState)(!1),[ed,eu]=(0,n.Z)({value:c,defaultValue:_,finalValue:[D,R],onChange:m}),ec=(0,r.useRef)(ed),em=(0,r.useRef)([]),eh=(0,r.useRef)(null),ep=(0,r.useRef)(void 0),ev=[(0,w.E)({value:ed[0],min:D,max:R}),(0,w.E)({value:ed[1],min:D,max:R})],ex=N??(0,S.X)(F),eb=e=>{eu(e),ec.current=e};(0,r.useEffect)(()=>{Array.isArray(c)&&(ec.current=c)},Array.isArray(c)?[c[0],c[1]]:[null,null]);let ef=(e,a,l)=>{if(-1===a)return;let t=[...ec.current];if(ee&&L){let l=(0,u.k)(e,L.map(e=>e.value)),r=t[a];t[a]=l;let n=0===a?1:0,s=(0,V.rq)(L),i=(0,V.HE)(L);l===s&&t[n]===s?t[a]=r:l===i&&t[n]===i?t[a]=r:l===t[n]&&(r>t[n]?t[n]=(0,V.Mh)(l,L):t[n]=(0,V.C8)(l,L))}else t[a]=e,0===a&&(e>t[1]-(C-1e-9)&&(t[1]=Math.min(e+C,R)),e>(R-(C-1e-9)||D)&&(t[a]=ec.current[a]),t[1]-e>E&&(t[1]=e+E)),1===a&&(e<t[0]+C&&(t[0]=Math.max(e-C,D)),e<t[0]+C&&(t[a]=ec.current[a]),e-t[0]>E&&(t[0]=e-E));if(t[0]=(0,k.q)(t[0],ex),t[1]=(0,k.q)(t[1],ex),t[0]>t[1]){let e=t[0];t[0]=t[1],t[1]=e}eb(t),l&&v?.(ec.current)},eg=e=>{X||ef((0,j.c)({value:e,min:D,max:R,step:F,precision:ex}),ep.current,!1)},{ref:ey,active:ej}=(0,s.f)(({x:e})=>eg(e),{onScrubEnd:()=>!X&&v?.(ec.current)},er),ek=e=>{ey.current.focus();let a=ey.current.getBoundingClientRect(),l=function(e){return"TouchEvent"in window&&e instanceof window.TouchEvent?e.touches[0].clientX:e.clientX}(e.nativeEvent),t=(0,j.c)({value:l-a.left,max:R,min:D,step:F,containerWidth:a.width}),r=Math.abs(ed[0]-t)>Math.abs(ed[1]-t)?1:0,n="ltr"===er?r:1===r?0:1;ep.current=n},ew=()=>1!==en&&0!==en?(es(0),0):en,eS={max:R,min:D,size:z,labelTransitionProps:B,labelAlwaysOn:O,onBlur:()=>es(-1)},eV=Array.isArray(P);return(0,t.jsx)(b.h,{value:{getStyles:et},children:(0,t.jsxs)(f.g,{...el,size:z,ref:(0,i.pc)(a,eh),disabled:X,onMouseDownCapture:()=>eh.current?.focus(),onKeyDownCapture:()=>{em.current[0]?.parentElement?.contains(document.activeElement)||em.current[0]?.focus()},children:[(0,t.jsxs)(y.C,{offset:ev[0],marksOffset:ed[0],filled:ev[1]-ev[0],marks:L,inverted:G,min:D,max:R,value:ed[1],disabled:X,containerProps:{ref:ey,onMouseEnter:q?()=>eo(!0):void 0,onMouseLeave:q?()=>eo(!1):void 0,onTouchStartCapture:ek,onTouchEndCapture:()=>{ep.current=-1},onMouseDownCapture:ek,onMouseUpCapture:()=>{ep.current=-1},onKeyDownCapture:e=>{if(!X)switch(e.key){case"ArrowUp":{e.preventDefault();let a=ew();em.current[a].focus();let l=ee&&L?(0,V.C8)(ec.current[a],L):Math.min(Math.max(ec.current[a]+F,D),R);ef((0,k.q)(l,ex),a,!0);break}case"ArrowRight":{e.preventDefault();let a=ew();em.current[a].focus();let l=ee&&L?("rtl"===er?V.Mh:V.C8)(ec.current[a],L):Math.min(Math.max("rtl"===er?ec.current[a]-F:ec.current[a]+F,D),R);ef((0,k.q)(l,ex),a,!0);break}case"ArrowDown":{e.preventDefault();let a=ew();em.current[a].focus();let l=ee&&L?(0,V.Mh)(ec.current[a],L):Math.min(Math.max(ec.current[a]-F,D),R);ef((0,k.q)(l,ex),a,!0);break}case"ArrowLeft":{e.preventDefault();let a=ew();em.current[a].focus();let l=ee&&L?("rtl"===er?V.C8:V.Mh)(ec.current[a],L):Math.min(Math.max("rtl"===er?ec.current[a]+F:ec.current[a]-F,D),R);ef((0,k.q)(l,ex),a,!0)}}}},children:[(0,t.jsx)(g.z,{...eS,value:K(ed[0]),position:ev[0],dragging:ej,label:"function"==typeof W?W((0,k.q)(K(ed[0]),ex)):W,ref:e=>{em.current[0]=e},thumbLabel:H,onMouseDown:()=>void(ep.current=0),onFocus:()=>es(0),showLabelOnHover:q,isHovered:ei,disabled:X,...ea?.(0),children:eV?P[0]:P}),(0,t.jsx)(g.z,{...eS,thumbLabel:$,value:K(ed[1]),position:ev[1],dragging:ej,label:"function"==typeof W?W((0,k.q)(K(ed[1]),ex)):W,ref:e=>{em.current[1]=e},onMouseDown:()=>void(ep.current=1),onFocus:()=>es(1),showLabelOnHover:q,isHovered:ei,disabled:X,...ea?.(1),children:eV?P[1]:P})]}),(0,t.jsx)("input",{type:"hidden",name:`${I}_from`,value:ed[0],...Q}),(0,t.jsx)("input",{type:"hidden",name:`${I}_to`,value:ed[1],...Q})]})})});z.classes=A.A,z.displayName="@mantine/core/RangeSlider"}},e=>{var a=a=>e(e.s=a);e.O(0,[18675,90636,46593,38792],()=>a(19709)),_N_E=e.O()}]);