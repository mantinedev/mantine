...
`,p={type:"code",code:u,centered:!0,component:function(){let[e,{close:t,open:o}]=(0,d.q)(!1);return i.createElement(s.J,{width:200,position:"bottom",withArrow:!0,shadow:"md",opened:e},i.createElement(s.J.Target,null,i.createElement(a.z,{onMouseEnter:o,onMouseLeave:t},"Hover to see popover")),i.createElement(s.J.Dropdown,{style:{pointerEvents:"none"}},i.createElement(Text.x,{size:"sm"},"This popover is shown when user hovers the target element")))}};var h=o(74770);let f=`
...
`,m={type:"code",code:f,centered:!0,component:function(){return i.createElement(s.J,{width:300,trapFocus:!0,position:"bottom",withArrow:!0,shadow:"md"},i.createElement(s.J.Target,null,i.createElement(a.z,null,"Toggle popover")),i.createElement(s.J.Dropdown,null,i.createElement(h.o,{label:"Name",placeholder:"Name",size:"xs"}),i.createElement(h.o,{label:"Email",placeholder:"john@doe.com",size:"xs",mt:"xs"})))}};var v=o(20368);let w=`
...
`,g={type:"code",component:function(){return i.createElement(Text.x,null,"Stantler’s magnificent antlers were traded at high prices as works of art. As a result, this Pok\xe9mon was hunted close to extinction by those who were after the priceless antlers."," ",i.createElement(s.J,{middlewares:{flip:!0,shift:!0,inline:!0},position:"top"},i.createElement(s.J.Target,null,i.createElement(v.v,null,"When visiting a junkyard")),i.createElement(s.J.Dropdown,null,"Inline dropdown")),", you may catch sight of it having an intense fight with Murkrow over shiny objects.Ho-Oh’s feathers glow in seven colors depending on the angle at which they are struck by light. These feathers are said to bring happiness to the bearers. This Pok\xe9mon is said to live at the foot of a rainbow.")},code:w},x=`
import { Popover, Text, Button } from '@mantine/core';
...
`,b={type:"code",code:x,centered:!0,component:function(){return i.createElement(s.J,{width:"target",position:"bottom",withArrow:!0,shadow:"md"},i.createElement(s.J.Target,null,i.createElement(a.z,{w:280},"Toggle popover")),i.createElement(s.J.Dropdown,null,i.createElement(Text.x,{size:"sm"},"This popover has same width as target, it is useful when you are building input dropdowns")))}};var y=o(19282);let P=`
...
`,j={type:"configurator",component:function(e){return i.createElement(s.J,{width:200,opened:!0,...e},i.createElement(s.J.Target,null,i.createElement(a.z,null,"Popover target")),i.createElement(s.J.Dropdown,null,i.createElement(Text.x,{size:"xs"},"Change position and offset to configure dropdown offset relative to target")))},code:P,centered:!0,controls:[{type:"select",prop:"position",initialValue:"bottom",data:y.c,libraryValue:null},{type:"number",prop:"offset",initialValue:0,libraryValue:null,min:-50,max:50}]},D={type:"configurator",component:function(e){return i.createElement(s.J,{width:200,position:e.position,opened:!0,offset:{mainAxis:e.mainAxis,crossAxis:e.crossAxis}},i.createElement(s.J.Target,null,i.createElement(a.z,null,"Popover target")),i.createElement(s.J.Dropdown,null,i.createElement(Text.x,{size:"xs"},"Change position and offset to configure dropdown offset relative to target")))},code:e=>`
import { Popover, Button, Text } from '@mantine/core';
...
`,centered:!0,controls:[{type:"select",prop:"position",initialValue:"bottom",data:y.c,libraryValue:null},{type:"number",prop:"mainAxis",initialValue:0,libraryValue:null,min:-50,max:50},{type:"number",prop:"crossAxis",initialValue:0,libraryValue:null,min:-50,max:50}]},$=`
import { Popover, Button, Text } from '@mantine/core';
...
`,T={type:"configurator",component:function(e){return i.createElement(s.J,{width:200,opened:!0,position:"bottom-start",withArrow:!0,...e},i.createElement(s.J.Target,null,i.createElement(a.z,null,"Target element")),i.createElement(s.J.Dropdown,null,i.createElement(Text.x,{size:"xs"},"Arrow position can be changed for *-start and *-end positions")))},code:$,centered:!0,controls:[{type:"segmented",prop:"arrowPosition",initialValue:"center",libraryValue:"center",data:["center","side"]},{type:"number",prop:"arrowOffset",initialValue:10,libraryValue:10,min:5,max:50},{type:"number",prop:"arrowSize",initialValue:7,libraryValue:7,min:5,max:12},{type:"number",prop:"arrowRadius",initialValue:0,libraryValue:0,min:0,max:10}]},E=`
import { Popover, Text, Button } from '@mantine/core';
...
`,S={type:"configurator",component:function(e){return i.createElement(s.J,{width:200,...e},i.createElement(s.J.Target,null,i.createElement(a.z,null,"Toggle popover")),i.createElement(s.J.Dropdown,null,i.createElement(Text.x,{size:"xs"},"Disabled popover dropdown is always hidden")))},code:E,centered:!0,controls:[{type:"boolean",prop:"disabled",initialValue:!1,libraryValue:!1}]},O=`
import { Popover, Text, Button } from '@mantine/core';
...
`,M={type:"code",component:function(){return i.createElement(s.J,{width:200,position:"bottom",clickOutsideEvents:["mouseup","touchend"]},i.createElement(s.J.Target,null,i.createElement(a.z,null,"Toggle popover")),i.createElement(s.J.Dropdown,null,i.createElement(Text.x,{size:"xs"},"Popover will be closed with mouseup and touchend events")))},code:O,centered:!0};var k=o(79649),z=o(18738);let A=`
