(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[46887],{21194:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/tags-input",function(){return n(22483)}])},22483:function(e,t,n){"use strict";n.r(t),n.d(t,{default:function(){return q}});var o=n(52322),a=n(45392),r=n(77413);let i={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Press Enter to submit a tag",placeholder:"Enter tag"})},code:`
...
`,maxWidth:340,centered:!0},d={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Press Enter to submit a tag",placeholder:"Duplicates are allowed",allowDuplicates:!0})},code:`
import { TagsInput } from '@mantine/core';
...
`,maxWidth:340,centered:!0},c={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Press Enter to submit a tag",placeholder:"Enter tag",splitChars:[","," ","|"]})},code:`
import { TagsInput } from '@mantine/core';
...
`,maxWidth:340,centered:!0},m=({options:e,search:t})=>{let n=e.filter(e=>e.label.toLowerCase().trim().includes(t.toLowerCase().trim()));return n.sort((e,t)=>e.label.localeCompare(t.label)),n},g={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Your favorite libraries",placeholder:"Pick value or enter anything",data:["4 – React","1 – Angular","3 – Vue","2 – Svelte"],filter:m})},code:`
import { TagsInput, ComboboxItem, OptionsFilter } from '@mantine/core';
...
`,b=Array(1e5).fill(0).map((e,t)=>`Option ${t}`),f={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"100 000 options tags input",placeholder:"Use limit to optimize performance",limit:5,data:b})},code:x,maxWidth:340,centered:!0};var j=n(19970);let y=`
import { TagsInput } from '@mantine/core';
...
`,v=Array(100).fill(0).map((e,t)=>`Option ${t}`),w={type:"code",component:function(){return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(r.B,{label:"With scroll area (default)",placeholder:"Pick value or enter anything",data:v,maxDropdownHeight:200}),(0,o.jsx)(r.B,{label:"With native scroll",placeholder:"Pick value or enter anything",data:v,withScrollArea:!1,styles:{dropdown:{maxHeight:200,overflowY:"auto"}},mt:"md"})]})},code:y,maxWidth:340,centered:!0},T={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Enter tags",placeholder:"Enter tags",data:[{group:"Frontend",items:["React","Angular"]},{group:"Backend",items:["Express","Django"]}]})},code:`
import { TagsInput } from '@mantine/core';
...
`,maxWidth:340,centered:!0},I={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Enter tags",placeholder:"Some tags are disabled",data:[{value:"React"},{value:"Angular"},{value:"Vue",disabled:!0},{value:"Svelte",disabled:!0}]})},code:`
import { TagsInput } from '@mantine/core';
...
`,maxWidth:340,centered:!0};var V=n(50205),P=n(17115);let S={type:"code",code:`
...
`,centered:!0,component:function(){return(0,o.jsxs)(V.J,{width:300,position:"bottom",withArrow:!0,shadow:"md",children:[(0,o.jsx)(V.J.Target,{children:(0,o.jsx)(P.z,{children:"Toggle popover"})}),(0,o.jsx)(V.J.Dropdown,{children:(0,o.jsx)(r.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{withinPortal:!1}})})]})}};var A=n(3900);let B={type:"code",component:function(){let[e,{toggle:t}]=(0,A.q)();return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(P.z,{onClick:t,mb:"md",children:"Toggle dropdown"}),(0,o.jsx)(r.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],dropdownOpened:e})]})},code:`
...
`,maxWidth:340,centered:!0},D={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{position:"top",middlewares:{flip:!1,shift:!1}}})},code:`
import { TagsInput } from '@mantine/core';
...
`,maxWidth:340,centered:!0},k={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{transitionProps:{transition:"pop",duration:200}}})},code:`
import { TagsInput } from '@mantine/core';
...
`,maxWidth:340,centered:!0},C={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{shadow:"md"}})},code:`
import { TagsInput } from '@mantine/core';
...
`},O={type:"configurator",component:function(e){return(0,o.jsx)(r.B,{...e,placeholder:"TagsInput placeholder",value:["First","Second"],data:["React","Angular","Vue","Svelte"]})},code:`
import { TagsInput } from '@mantine/core';
...
`,centered:!0,maxWidth:340,controls:n(76528).pc},Y={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Read only",placeholder:"Enter tag",readOnly:!0,defaultValue:["First","Second"]})},code:`
import { TagsInput } from '@mantine/core';
...
`,maxWidth:340,centered:!0},z={type:"code",component:function(){return(0,o.jsx)(r.B,{label:"Disabled",placeholder:"Enter tag",disabled:!0,defaultValue:["First","Second"]})},code:`
import { TagsInput } from '@mantine/core';
