...
`,d=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate"],b={type:"code",component:function(){let e=(0,c.K)(),[o,t]=(0,s.useState)(""),n=!d.some(e=>e===o),r=n?d.filter(e=>e.toLowerCase().includes(o.toLowerCase().trim())):d,l=r.map(e=>s.createElement(p.h.Option,{value:e,key:e},e));return s.createElement(p.h,{onOptionSubmit:o=>{t(o),e.closeDropdown()},store:e},s.createElement(p.h.Target,null,s.createElement(u.o,{label:"Pick value or type anything",placeholder:"Pick value or type anything",value:o,onChange:o=>{t(o.currentTarget.value),e.openDropdown(),e.updateSelectedOptionIndex()},onClick:()=>e.openDropdown(),onFocus:()=>e.openDropdown(),onBlur:()=>e.closeDropdown()})),s.createElement(p.h.Dropdown,null,s.createElement(p.h.Options,null,0===l.length?s.createElement(p.h.Empty,null,"Nothing found"):l)))},centered:!0,maxWidth:340,defaultExpanded:!1,code:m};var h=t(56589),Text=t(26569),x=t(8671);let C=`
import { useState } from 'react';
...
`,g=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate"],v={type:"code",component:function(){let[e,o]=(0,s.useState)(null),t=(0,c.K)({onDropdownClose:()=>t.resetSelectedOption()}),n=g.map(e=>s.createElement(p.h.Option,{value:e,key:e},e));return s.createElement(s.Fragment,null,s.createElement(h.x,{mb:"xs"},s.createElement(Text.x,{span:!0,size:"sm",c:"dimmed"},"Selected item:"," "),s.createElement(Text.x,{span:!0,size:"sm"},e||"Nothing selected")),s.createElement(p.h,{store:t,width:250,position:"bottom-start",withArrow:!0,onOptionSubmit:e=>{o(e),t.closeDropdown()}},s.createElement(p.h.Target,null,s.createElement(x.z,{onClick:()=>t.toggleDropdown()},"Pick item")),s.createElement(p.h.Dropdown,null,s.createElement(p.h.Options,null,n))))},maxWidth:340,centered:!0,defaultExpanded:!1,code:C};var w=t(81320),f=t(23163);let O=`
import { useState } from 'react';
...
`,E=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate"],S={type:"code",component:function(){let e=(0,c.K)({onDropdownClose:()=>e.resetSelectedOption()}),[o,t]=(0,s.useState)(null),[n,r]=(0,s.useState)(""),l=E.every(e=>e!==n),a=l?E.filter(e=>e.toLowerCase().includes(n.toLowerCase().trim())):E,i=a.map(e=>s.createElement(p.h.Option,{value:e,key:e},e));return s.createElement(p.h,{store:e,onOptionSubmit:o=>{t(o),r(o),e.closeDropdown()}},s.createElement(p.h.Target,null,s.createElement(f.M,{rightSection:s.createElement(p.h.Chevron,null),rightSectionPointerEvents:"none",onClick:()=>e.openDropdown(),onFocus:()=>e.openDropdown(),onBlur:()=>{e.closeDropdown(),r(o||"")},placeholder:"Search value",value:n,onChange:o=>{e.updateSelectedOptionIndex(),r(o.currentTarget.value)}})),s.createElement(p.h.Dropdown,null,s.createElement(p.h.Options,null,i.length>0?i:s.createElement(p.h.Empty,null,"Nothing found"))))},maxWidth:340,centered:!0,defaultExpanded:!1,code:O},D=`
import { useState } from 'react';
import { Button, Combobox, useCombobox, Text, Box } from '@mantine/core';
...
`,F=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate"],y={type:"code",component:function(){let[e,o]=(0,s.useState)(""),[t,n]=(0,s.useState)(null),r=(0,c.K)({onDropdownClose:()=>{r.resetSelectedOption(),r.focusTarget(),o("")},onDropdownOpen:()=>{r.focusSearchInput()}}),l=F.filter(o=>o.toLowerCase().includes(e.toLowerCase().trim())).map(e=>s.createElement(p.h.Option,{value:e,key:e},e));return s.createElement(s.Fragment,null,s.createElement(h.x,{mb:"xs"},s.createElement(Text.x,{span:!0,size:"sm",c:"dimmed"},"Selected item:"," "),s.createElement(Text.x,{span:!0,size:"sm"},t||"Nothing selected")),s.createElement(p.h,{store:r,width:250,position:"bottom-start",withArrow:!0,onOptionSubmit:e=>{n(e),r.closeDropdown()}},s.createElement(p.h.Target,{withAriaAttributes:!1},s.createElement(x.z,{onClick:()=>r.toggleDropdown()},"Pick item")),s.createElement(p.h.Dropdown,null,s.createElement(p.h.Search,{value:e,onChange:e=>o(e.currentTarget.value),placeholder:"Search groceries"}),s.createElement(p.h.Options,null,l.length>0?l:s.createElement(p.h.Empty,null,"Nothing found")))))},maxWidth:340,centered:!0,defaultExpanded:!1,code:D},j=`
...
`,k=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate"],B={type:"code",component:function(){let e=(0,c.K)({onDropdownClose:()=>e.resetSelectedOption()}),[o,t]=(0,s.useState)(""),n=!k.some(e=>e===o),r=n?k.filter(e=>e.toLowerCase().includes(o.toLowerCase().trim())):k,l=r.map(e=>s.createElement(p.h.Option,{value:e,key:e},e));return(0,s.useEffect)(()=>{e.selectFirstOption()},[o]),s.createElement(p.h,{onOptionSubmit:o=>{t(o),e.closeDropdown()},store:e},s.createElement(p.h.Target,null,s.createElement(u.o,{label:"Pick value or type anything",placeholder:"Pick value or type anything",value:o,onChange:o=>{t(o.currentTarget.value),e.openDropdown()},onClick:()=>e.openDropdown(),onFocus:()=>e.openDropdown(),onBlur:()=>e.closeDropdown()})),s.createElement(p.h.Dropdown,null,s.createElement(p.h.Options,null,0===l.length?s.createElement(p.h.Empty,null,"Nothing found"):l)))},centered:!0,maxWidth:340,defaultExpanded:!1,code:j};var T=t(22971),I=t(38765),P=t(42487);let A=`
import { useState } from 'react';
...
`,V=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate"],L={type:"code",component:function(){let e=(0,c.K)({onDropdownClose:()=>e.resetSelectedOption(),onDropdownOpen:o=>{"keyboard"===o?e.selectActiveOption():e.updateSelectedOptionIndex("active")}}),[o,t]=(0,s.useState)("\uD83E\uDD66 Broccoli"),n=V.map(e=>s.createElement(p.h.Option,{value:e,key:e,active:e===o},s.createElement(T.Z,{gap:"xs"},e===o&&s.createElement(I.n,{size:12}),s.createElement("span",null,e))));return s.createElement(p.h,{store:e,resetSelectionOnOptionHover:!0,onOptionSubmit:o=>{t(o),e.updateSelectedOptionIndex("active")}},s.createElement(p.h.Target,{targetType:"button"},s.createElement(f.M,{component:"button",type:"button",pointer:!0,rightSection:s.createElement(p.h.Chevron,null),rightSectionPointerEvents:"none",onClick:()=>e.toggleDropdown()},o||s.createElement(P.I.Placeholder,null,"Pick value"))),s.createElement(p.h.Dropdown,null,s.createElement(p.h.Options,null,n)))},maxWidth:340,centered:!0,defaultExpanded:!1,code:A},G=`
import { useState } from 'react';
...
`,z={type:"code",component:function(){let e=(0,c.K)({onDropdownClose:()=>e.resetSelectedOption()}),[o,t]=(0,s.useState)(null);return s.createElement(p.h,{store:e,onOptionSubmit:o=>{t(o),e.closeDropdown()}},s.createElement(p.h.Target,null,s.createElement(f.M,{component:"button",type:"button",pointer:!0,rightSection:s.createElement(p.h.Chevron,null),rightSectionPointerEvents:"none",onClick:()=>e.toggleDropdown()},o||s.createElement(P.I.Placeholder,null,"Pick value"))),s.createElement(p.h.Dropdown,null,s.createElement(p.h.Options,null,s.createElement(p.h.Group,{label:"Fruits"},s.createElement(p.h.Option,{value:"\uD83C\uDF4E Apples"},"\uD83C\uDF4E Apples"),s.createElement(p.h.Option,{value:"\uD83C\uDF4C Bananas"},"\uD83C\uDF4C Bananas"),s.createElement(p.h.Option,{value:"\uD83C\uDF47 Grape"},"\uD83C\uDF47 Grape")),s.createElement(p.h.Group,{label:"Vegetables"},s.createElement(p.h.Option,{value:"\uD83E\uDD66 Broccoli"},"\uD83E\uDD66 Broccoli"),s.createElement(p.h.Option,{value:"\uD83E\uDD55 Carrots"},"\uD83E\uDD55 Carrots"),s.createElement(p.h.Option,{value:"\uD83E\uDD6C Lettuce"},"\uD83E\uDD6C Lettuce")))))},maxWidth:340,centered:!0,defaultExpanded:!1,code:G},N=`
import { useState } from 'react';
import { Input, InputBase, Combobox, useCombobox } from '@mantine/core';
...
`,M=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate","\uD83C\uDF47 Grapes","\uD83C\uDF4B Lemon","\uD83E\uDD6C Lettuce","\uD83C\uDF44 Mushrooms","\uD83C\uDF4A Oranges","\uD83E\uDD54 Potatoes","\uD83C\uDF45 Tomatoes","\uD83E\uDD5A Eggs","\uD83E\uDD5B Milk","\uD83C\uDF5E Bread","\uD83C\uDF57 Chicken","\uD83C\uDF54 Hamburger","\uD83E\uDDC0 Cheese","\uD83E\uDD69 Steak","\uD83C\uDF5F French Fries","\uD83C\uDF55 Pizza","\uD83E\uDD66 Cauliflower","\uD83E\uDD5C Peanuts","\uD83C\uDF66 Ice Cream","\uD83C\uDF6F Honey","\uD83E\uDD56 Baguette","\uD83C\uDF63 Sushi","\uD83E\uDD5D Kiwi","\uD83C\uDF53 Strawberries"],R={type:"code",component:function(){let e=(0,c.K)({onDropdownClose:()=>e.resetSelectedOption()}),[o,t]=(0,s.useState)(null),n=M.map(e=>s.createElement(p.h.Option,{value:e,key:e},e));return s.createElement(p.h,{store:e,onOptionSubmit:o=>{t(o),e.closeDropdown()}},s.createElement(p.h.Target,null,s.createElement(f.M,{component:"button",type:"button",pointer:!0,rightSection:s.createElement(p.h.Chevron,null),rightSectionPointerEvents:"none",onClick:()=>e.toggleDropdown()},o||s.createElement(P.I.Placeholder,null,"Pick value"))),s.createElement(p.h.Dropdown,null,s.createElement(p.h.Options,{mah:200,style:{overflowY:"auto"}},n)))},maxWidth:340,centered:!0,defaultExpanded:!1,code:N};var K=t(49849);let H=`
import { useState } from 'react';
...
`,Y=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate","\uD83C\uDF47 Grapes","\uD83C\uDF4B Lemon","\uD83E\uDD6C Lettuce","\uD83C\uDF44 Mushrooms","\uD83C\uDF4A Oranges","\uD83E\uDD54 Potatoes","\uD83C\uDF45 Tomatoes","\uD83E\uDD5A Eggs","\uD83E\uDD5B Milk","\uD83C\uDF5E Bread","\uD83C\uDF57 Chicken","\uD83C\uDF54 Hamburger","\uD83E\uDDC0 Cheese","\uD83E\uDD69 Steak","\uD83C\uDF5F French Fries","\uD83C\uDF55 Pizza","\uD83E\uDD66 Cauliflower","\uD83E\uDD5C Peanuts","\uD83C\uDF66 Ice Cream","\uD83C\uDF6F Honey","\uD83E\uDD56 Baguette","\uD83C\uDF63 Sushi","\uD83E\uDD5D Kiwi","\uD83C\uDF53 Strawberries"],W={type:"code",component:function(){let e=(0,c.K)({onDropdownClose:()=>e.resetSelectedOption()}),[o,t]=(0,s.useState)(null),n=Y.map(e=>s.createElement(p.h.Option,{value:e,key:e},e));return s.createElement(p.h,{store:e,onOptionSubmit:o=>{t(o),e.closeDropdown()}},s.createElement(p.h.Target,null,s.createElement(f.M,{component:"button",type:"button",pointer:!0,rightSection:s.createElement(p.h.Chevron,null),rightSectionPointerEvents:"none",onClick:()=>e.toggleDropdown()},o||s.createElement(P.I.Placeholder,null,"Pick value"))),s.createElement(p.h.Dropdown,null,s.createElement(p.h.Options,null,s.createElement(K.x.Autosize,{type:"scroll",mah:200},n))))},maxWidth:340,centered:!0,defaultExpanded:!1,code:H},_=`
import { useState } from 'react';
import { Combobox, TextInput, useCombobox } from '@mantine/core';
...
`,U=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate"],q={type:"code",component:function(){let e=(0,c.K)(),[o,t]=(0,s.useState)(""),n=!U.some(e=>e===o),r=n?U.filter(e=>e.toLowerCase().includes(o.toLowerCase().trim())):U,l=r.map(e=>s.createElement(p.h.Option,{value:e,key:e},e));return s.createElement(p.h,{onOptionSubmit:o=>{t(o),e.closeDropdown()},store:e},s.createElement(p.h.Target,null,s.createElement(u.o,{label:"Pick value or type anything",placeholder:"Pick value or type anything",value:o,onChange:o=>{t(o.currentTarget.value),e.openDropdown()},onClick:()=>e.openDropdown(),onFocus:()=>e.openDropdown(),onBlur:()=>e.closeDropdown()})),s.createElement(p.h.Dropdown,{hidden:0===l.length},s.createElement(p.h.Options,null,l)))},centered:!0,maxWidth:340,defaultExpanded:!1,code:_},Z=`
import { useState } from 'react';
...
`,X=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate"],$={type:"code",component:function(){let[e,o]=(0,s.useState)(!1),t=(0,c.K)({opened:e}),n=X.map(e=>s.createElement(p.h.Option,{value:e,key:e},e));return s.createElement(s.Fragment,null,s.createElement(x.z,{mb:"md",onClick:()=>o(e=>!e)},"Toggle dropdown"),s.createElement(p.h,{store:t},s.createElement(p.h.Target,null,s.createElement(u.o,{label:"Autocomplete",description:"Dropdown is opened/closed when button is clicked",placeholder:"Click button to toggle dropdown"})),s.createElement(p.h.Dropdown,null,s.createElement(p.h.Options,null,n))))},code:Z,maxWidth:340,centered:!0,defaultExpanded:!1},J=`
import { useState } from 'react';
...
`,Q={type:"code",component:function(){let[e,o]=(0,s.useState)("");return s.createElement(p.h,{onOptionSubmit:o},s.createElement(p.h.EventsTarget,null,s.createElement(u.o,{placeholder:"Pick value",value:e,onChange:e=>o(e.currentTarget.value)})),s.createElement(p.h.Options,{mt:"sm"},s.createElement(p.h.Option,{value:"First"},"First"),s.createElement(p.h.Option,{value:"Second"},"Second"),s.createElement(p.h.Option,{value:"Third"},"Third")))},code:J,centered:!0,maxWidth:340,defaultExpanded:!1};var ee=t(92511);let eo=`
import { Combobox, TextInput, useCombobox } from '@mantine/core';
...
`,c=["\uD83C\uDF4E Apples","\uD83C\uDF4C Bananas","\uD83E\uDD66 Broccoli","\uD83E\uDD55 Carrots","\uD83C\uDF6B Chocolate"],p={type:"code",component:function(){let e=(0,r.K)({onDropdownClose:()=>e.resetSelectedOption()}),[o,t]=(0,n.useState)(null),s=c.map(e=>n.createElement(l.h.Option,{value:e,key:e},e));return n.createElement(l.h,{store:e,onOptionSubmit:o=>{t(o),e.closeDropdown()}},n.createElement(l.h.Target,null,n.createElement(a.M,{component:"button",type:"button",pointer:!0,rightSection:n.createElement(l.h.Chevron,null),rightSectionPointerEvents:"none",onClick:()=>e.toggleDropdown()},o||n.createElement(i.I.Placeholder,null,"Pick value"))),n.createElement(l.h.Dropdown,null,n.createElement(l.h.Options,null,s)))},maxWidth:340,centered:!0,defaultExpanded:!1,code:s}},39394:function(e,o,t){"use strict";t.d(o,{D:function(){return f}});var n=t(27378),r=t(92082),l=t(83453),a=t(96739),i=t(6231),s=t(56589),c=t(20410),p=t(96217),u=t(89871);let[m,d]=(0,u.V)();var b=t(33),h={root:"m-7cda1cd6","root--default":"m-44da308b","root--contrast":"m-e3a01f8",label:"m-1e0e6180",remove:"m-ae386778",group:"m-1dcfd90b"};let x={},C=(0,l.Z)((e,{gap:o},{size:t})=>({group:{"--pg-gap":void 0!==o?(0,r.ap)(o):(0,r.ap)(t,"pg-gap")}})),g=(0,c.d)((e,o)=>{let t=(0,a.w)("PillGroup",x,e),{classNames:r,className:l,style:c,styles:p,unstyled:u,vars:d,size:g,disabled:v,...w}=t,f=(0,b.D)(),O=f?.size||g||void 0,E=(0,i.y)({name:"PillGroup",classes:h,props:t,className:l,style:c,classNames:r,styles:p,unstyled:u,vars:d,varsResolver:C,stylesCtx:{size:O},rootSelector:"group"});return n.createElement(m,{value:{size:O,disabled:v}},n.createElement(s.x,{ref:o,size:O,...E("group"),...w}))});g.classes=h,g.displayName="@mantine/core/PillGroup";let v={variant:"default"},w=(0,l.Z)((e,{radius:o},{size:t})=>({root:{"--pill-fz":(0,r.ap)(t,"pill-fz"),"--pill-height":(0,r.ap)(t,"pill-height"),"--pill-radius":void 0===o?void 0:(0,r.H5)(o)}})),f=(0,c.d)((e,o)=>{let t=(0,a.w)("Pill",v,e),{classNames:r,className:l,style:c,styles:u,unstyled:m,vars:x,variant:C,children:g,withRemoveButton:f,onRemove:O,removeButtonProps:E,radius:S,size:D,disabled:F,...y}=t,j=d(),k=(0,b.D)(),B=D||j?.size||void 0,T=k?.variant==="filled"?"contrast":C||"default",I=(0,i.y)({name:"Pill",classes:h,props:t,className:l,style:c,classNames:r,styles:u,unstyled:m,vars:x,varsResolver:w,stylesCtx:{size:B}});return n.createElement(s.x,{component:"span",ref:o,variant:T,size:B,...I("root",{variant:T}),mod:{"with-remove":f,disabled:F||j?.disabled},...y},n.createElement("span",{...I("label")},g),f&&n.createElement(p.P,{variant:"transparent",radius:S,tabIndex:-1,"aria-hidden":!0,unstyled:m,...E,...I("remove",{className:E?.className,style:E?.style}),onMouseDown:e=>{e.preventDefault(),e.stopPropagation(),E?.onMouseDown?.(e)},onClick:e=>{e.stopPropagation(),O?.(),E?.onClick?.(e)}}))});f.classes=h,f.displayName="@mantine/core/Pill",f.Group=g},33:function(e,o,t){"use strict";t.d(o,{D:function(){return l},H:function(){return r}}),t(27378);var n=t(89871);let[r,l]=(0,n.V)()},28639:function(e,o,t){"use strict";t.d(o,{d:function(){return x}});var n=t(27378),r=t(96739),l=t(20410),a=t(23163),i=t(33),s=t(72840),c=t(6231),p=t(56589),u=t(5739),m={field:"m-45c4369d"};let d={type:"visible"},b=(0,l.d)((e,o)=>{let t=(0,r.w)("PillsInputField",d,e),{classNames:l,className:a,style:b,styles:h,unstyled:x,vars:C,type:g,disabled:v,id:w,pointer:f,...O}=t,E=(0,i.D)(),S=(0,u.D)(),D=(0,c.y)({name:"PillsInputField",classes:m,props:t,className:a,style:b,classNames:l,styles:h,unstyled:x,rootSelector:"field"}),F=v||E?.disabled;return n.createElement(p.x,{component:"input",ref:(0,s.Yx)(o,E?.fieldRef),"data-type":g,disabled:F,mod:{disabled:F,pointer:f},...D("field"),...O,id:S?.inputId||w,"aria-invalid":E?.hasError,"aria-describedby":S?.describedBy})});b.classes=m,b.displayName="@mantine/core/PillsInputField";let h={},x=(0,l.d)((e,o)=>{let t=(0,r.w)("PillsInput",h,e),{children:l,onMouseDown:s,onClick:c,size:p,disabled:u,__staticSelector:m,error:d,variant:b,...x}=t,C=(0,n.useRef)();return n.createElement(i.H,{value:{fieldRef:C,size:p,disabled:u,hasError:!!d,variant:b}},n.createElement(a.M,{size:p,error:d,variant:b,component:"div",ref:o,onMouseDown:e=>{e.preventDefault(),s?.(e),C.current?.focus()},onClick:e=>{e.preventDefault(),c?.(e),C.current?.focus()},...x,multiline:!0,disabled:u,__staticSelector:m||"PillsInput",withAria:!1},l))});x.displayName="@mantine/core/PillsInput",x.Field=b}},function(e){e.O(0,[370,5819,2775,5608,9774,2888,179],function(){return e(e.s=90342)}),_N_E=e.O()}]);