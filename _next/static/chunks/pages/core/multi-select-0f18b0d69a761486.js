(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[59353],{93693:function(e,t,a){"use strict";a.d(t,{Z:function(){return o}});var o=(0,a(54764).Z)("at","IconAt",[["path",{d:"M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0",key:"svg-0"}],["path",{d:"M16 12v1.5a2.5 2.5 0 0 0 5 0v-1.5a9 9 0 1 0 -5.5 8.28",key:"svg-1"}]])},67361:function(e,t,a){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/multi-select",function(){return a(61739)}])},61739:function(e,t,a){"use strict";a.r(t),a.d(t,{default:function(){return eE}});var o=a(24246),n=a(71670),r=a(27378),l=a(67415);let i=`
...
`,A=Array(1e5).fill(0).map((e,t)=>`Option ${t}`),E={type:"code",component:function(){return r.createElement(l.N,{label:"100 000 options autocomplete",placeholder:"Use limit to optimize performance",limit:5,data:A,searchable:!0})},code:k,maxWidth:340,centered:!0};var R=a(22971),D=a(30770),Text=a(26569);let N=`
...
`,F={type:"code",component:function(){return r.createElement(l.N,{label:"Your favorite libraries",placeholder:"Pick value",data:[{group:"Frontend",items:["React","Angular"]},{group:"Backend",items:["Express","Django"]}]})},code:B,maxWidth:340,centered:!0},z=`
import { MultiSelect } from '@mantine/core';
...
`,_={type:"code",component:function(){return r.createElement(l.N,{label:"Your favorite libraries",placeholder:"Pick value",data:[{value:"react",label:"React"},{value:"ng",label:"Angular"},{value:"vue",label:"Vue",disabled:!0},{value:"svelte",label:"Svelte",disabled:!0}]})},code:z,maxWidth:340,centered:!0};var L=a(63433),H=a(8671);let q=`
...
`,X={type:"code",component:function(){return r.createElement(l.N,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{position:"top",middlewares:{flip:!1,shift:!1}}})},code:$,maxWidth:340,centered:!0};var K={dropdown:"m-a9824888",input:"m-f5487eb3"};let Q=`.dropdown {
...
`,ei={type:"code",component:function(){return r.createElement(l.N,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{shadow:"md"}})},code:el,maxWidth:340,centered:!0};var ec=a(94503),ed=a(71078);let es=`
...
`,eS={type:"code",component:function(){return r.createElement(r.Fragment,null,r.createElement(l.N,{label:"Boolean error",placeholder:"Boolean error",error:!0,data:["React","Angular","Vue","Svelte"]}),r.createElement(l.N,{mt:"md",label:"With error message",placeholder:"With error message",error:"Invalid name",data:["React","Angular","Vue","Svelte"]}))},maxWidth:340,centered:!0,code:ex};var ey=a(93693),ew=a(7634);let ej=`
