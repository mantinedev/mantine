...
`,A={type:"code",component:function(){return i.createElement(i.Fragment,null,i.createElement(r.t,{total:10,withEdges:!0,nextIcon:v.Z,previousIcon:I.Z,firstIcon:T,lastIcon:w,dotsIcon:V}),i.createElement(r.t.Root,{total:10},i.createElement(P.Z,{gap:7,mt:"xl"},i.createElement(r.t.First,{icon:T}),i.createElement(r.t.Previous,{icon:I.Z}),i.createElement(r.t.Items,{dotsIcon:V}),i.createElement(r.t.Next,{icon:v.Z}),i.createElement(r.t.Last,{icon:w}))))},code:C},R=`
import { Pagination, Text } from '@mantine/core';
