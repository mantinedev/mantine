...
`};var c=l(14041),u=l(93065);let m={type:"code",component:function(){let[e,a]=(0,c.useState)(50),[l,n]=(0,c.useState)(50);return(0,t.jsxs)(s.a,{maw:400,mx:"auto",children:[(0,t.jsx)(r.A,{value:e,onChange:a,onChangeEnd:n}),(0,t.jsxs)(u.E,{mt:"md",size:"sm",children:["onChange value: ",(0,t.jsx)("b",{children:e})]}),(0,t.jsxs)(u.E,{mt:5,size:"sm",children:["onChangeEnd value: ",(0,t.jsx)("b",{children:l})]})]})},code:`
...
`},h={type:"code",component:function(){return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(u.E,{size:"sm",children:"No label"}),(0,t.jsx)(r.A,{defaultValue:40,label:null}),(0,t.jsx)(u.E,{size:"sm",mt:"xl",children:"Formatted label"}),(0,t.jsx)(r.A,{defaultValue:40,label:e=>`${e} \xb0C`}),(0,t.jsx)(u.E,{size:"sm",mt:"xl",children:"Label always visible"}),(0,t.jsx)(r.A,{defaultValue:40,labelAlwaysOn:!0}),(0,t.jsx)(u.E,{size:"sm",mt:"xl",children:"Custom label transition"}),(0,t.jsx)(r.A,{defaultValue:40,labelTransitionProps:{transition:"skew-down",duration:150,timingFunction:"linear"}})]})},code:`
...
`,centered:!0,maxWidth:400},p={type:"code",component:function(){return(0,t.jsx)(r.A,{min:0,max:1,step:5e-4,defaultValue:.5535})},code:`
import { Slider } from '@mantine/core';
...
`,centered:!0,maxWidth:340},f={type:"code",component:function(){let e=[{value:20,label:"20%"},{value:50,label:"50%"},{value:80,label:"80%"}];return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(r.A,{defaultValue:40,marks:[{value:10},{value:40},{value:95}],mb:32}),(0,t.jsx)(r.A,{defaultValue:40,marks:e,mb:32}),(0,t.jsx)(o.F,{defaultValue:[20,80],marks:e,mb:32})]})},code:`
import { Slider, RangeSlider } from '@mantine/core';
...
`,centered:!0,maxWidth:400},T={type:"code",component:function(){return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(r.A,{inverted:!0,defaultValue:80}),(0,t.jsx)(o.F,{inverted:!0,defaultValue:[40,80],mt:"xl"})]})},code:`
import { RangeSlider, Slider } from '@mantine/core';
...
`,centered:!0,maxWidth:400}},1784:(e,a,l)=>{"use strict";l.d(a,{F:()=>M});var t=l(31085),n=l(14041),r=l(82307),i=l(7235),s=l(34321),o=l(39735),d=l(33450),c=l(96532),u=l(7098),m=l(51606),h=l(29686),x=l(69564),b=l(6754),p=l(46746),v=l(96448),f=l(5861),j=l(60881),g=l(36247),y=l(7139),k=l(27064),S=l(48093),w=l(46315),V=l(94023),A=l(85212);let T=(0,u.V)((e,{size:a,color:l,thumbSize:t,radius:n})=>({root:{"--slider-size":(0,d.YC)(a,"slider-size"),"--slider-color":l?(0,m.r)(l,e):void 0,"--slider-radius":void 0===n?void 0:(0,d.nJ)(n),"--slider-thumb-size":void 0!==t?(0,o.D)(t):"calc(var(--slider-size) * 2)"}})),D={min:0,max:100,minRange:10,step:1,marks:[],label:e=>e,labelTransitionProps:{transition:"fade",duration:0},labelAlwaysOn:!1,showLabelOnHover:!0,disabled:!1,scale:e=>e},M=(0,b.P9)((e,a)=>{let l=(0,h.Y)("RangeSlider",D,e),{classNames:o,styles:d,value:u,onChange:m,onChangeEnd:b,size:M,min:z,max:C,minRange:R,maxRange:E,step:F,precision:N,defaultValue:_,name:I,marks:L,label:W,labelTransitionProps:B,labelAlwaysOn:O,thumbFromLabel:H,thumbToLabel:$,showLabelOnHover:q,thumbChildren:P,disabled:X,unstyled:Y,scale:K,inverted:G,className:U,style:Z,vars:J,hiddenInputProps:Q,restrictToMarks:ee,thumbProps:ea,...el}=l,et=(0,x.I)({name:"Slider",props:l,classes:A.A,classNames:o,className:U,styles:d,style:Z,vars:J,varsResolver:T,unstyled:Y}),{dir:en}=(0,p.jH)(),[er,ei]=(0,n.useState)(-1),[es,eo]=(0,n.useState)(!1),[ed,ec]=(0,r.Z)({value:u,defaultValue:_,finalValue:[z,C],onChange:m}),eu=(0,n.useRef)(ed),em=(0,n.useRef)([]),eh=(0,n.useRef)(null),ex=(0,n.useRef)(void 0),eb=[(0,S.E)({value:ed[0],min:z,max:C}),(0,S.E)({value:ed[1],min:z,max:C})],ep=N??(0,w.X)(F),ev=e=>{ec(e),eu.current=e};(0,n.useEffect)(()=>{Array.isArray(u)&&(eu.current=u)},Array.isArray(u)?[u[0],u[1]]:[null,null]);let ef=(e,a,l)=>{if(-1===a)return;let t=[...eu.current];if(ee&&L){let l=(0,c.k)(e,L.map(e=>e.value)),n=t[a];t[a]=l;let r=0===a?1:0,i=(0,V.rq)(L),s=(0,V.HE)(L);l===i&&t[r]===i?t[a]=n:l===s&&t[r]===s?t[a]=n:l===t[r]&&(n>t[r]?t[r]=(0,V.Mh)(l,L):t[r]=(0,V.C8)(l,L))}else t[a]=e,0===a&&(e>t[1]-(R-1e-9)&&(t[1]=Math.min(e+R,C)),e>(C-(R-1e-9)||z)&&(t[a]=eu.current[a]),t[1]-e>E&&(t[1]=e+E)),1===a&&(e<t[0]+R&&(t[0]=Math.max(e-R,z)),e<t[0]+R&&(t[a]=eu.current[a]),e-t[0]>E&&(t[0]=e-E));if(t[0]=(0,k.q)(t[0],ep),t[1]=(0,k.q)(t[1],ep),t[0]>t[1]){let e=t[0];t[0]=t[1],t[1]=e}ev(t),l&&b?.(eu.current)},ej=e=>{X||ef((0,y.c)({value:e,min:z,max:C,step:F,precision:ep}),ex.current,!1)},{ref:eg,active:ey}=(0,i.f)(({x:e})=>ej(e),{onScrubEnd:()=>!X&&b?.(eu.current)},en),ek=e=>{eg.current.focus();let a=eg.current.getBoundingClientRect(),l=function(e){return"TouchEvent"in window&&e instanceof window.TouchEvent?e.touches[0].clientX:e.clientX}(e.nativeEvent),t=(0,y.c)({value:l-a.left,max:C,min:z,step:F,containerWidth:a.width}),n=Math.abs(ed[0]-t)>Math.abs(ed[1]-t)?1:0,r="ltr"===en?n:1===n?0:1;ex.current=r},eS=()=>1!==er&&0!==er?(ei(0),0):er,ew={max:C,min:z,size:M,labelTransitionProps:B,labelAlwaysOn:O,onBlur:()=>ei(-1)},eV=Array.isArray(P);return(0,t.jsx)(v.h,{value:{getStyles:et},children:(0,t.jsxs)(f.g,{...el,size:M,ref:(0,s.pc)(a,eh),disabled:X,onMouseDownCapture:()=>eh.current?.focus(),onKeyDownCapture:()=>{em.current[0]?.parentElement?.contains(document.activeElement)||em.current[0]?.focus()},children:[(0,t.jsxs)(g.C,{offset:eb[0],marksOffset:ed[0],filled:eb[1]-eb[0],marks:L,inverted:G,min:z,max:C,value:ed[1],disabled:X,containerProps:{ref:eg,onMouseEnter:q?()=>eo(!0):void 0,onMouseLeave:q?()=>eo(!1):void 0,onTouchStartCapture:ek,onTouchEndCapture:()=>{ex.current=-1},onMouseDownCapture:ek,onMouseUpCapture:()=>{ex.current=-1},onKeyDownCapture:e=>{if(!X)switch(e.key){case"ArrowUp":{e.preventDefault();let a=eS();em.current[a].focus();let l=ee&&L?(0,V.C8)(eu.current[a],L):Math.min(Math.max(eu.current[a]+F,z),C);ef((0,k.q)(l,ep),a,!0);break}case"ArrowRight":{e.preventDefault();let a=eS();em.current[a].focus();let l=ee&&L?("rtl"===en?V.Mh:V.C8)(eu.current[a],L):Math.min(Math.max("rtl"===en?eu.current[a]-F:eu.current[a]+F,z),C);ef((0,k.q)(l,ep),a,!0);break}case"ArrowDown":{e.preventDefault();let a=eS();em.current[a].focus();let l=ee&&L?(0,V.Mh)(eu.current[a],L):Math.min(Math.max(eu.current[a]-F,z),C);ef((0,k.q)(l,ep),a,!0);break}case"ArrowLeft":{e.preventDefault();let a=eS();em.current[a].focus();let l=ee&&L?("rtl"===en?V.C8:V.Mh)(eu.current[a],L):Math.min(Math.max("rtl"===en?eu.current[a]+F:eu.current[a]-F,z),C);ef((0,k.q)(l,ep),a,!0)}}}},children:[(0,t.jsx)(j.z,{...ew,value:K(ed[0]),position:eb[0],dragging:ey,label:"function"==typeof W?W((0,k.q)(K(ed[0]),ep)):W,ref:e=>{em.current[0]=e},thumbLabel:H,onMouseDown:()=>void(ex.current=0),onFocus:()=>ei(0),showLabelOnHover:q,isHovered:es,disabled:X,...ea?.(0),children:eV?P[0]:P}),(0,t.jsx)(j.z,{...ew,thumbLabel:$,value:K(ed[1]),position:eb[1],dragging:ey,label:"function"==typeof W?W((0,k.q)(K(ed[1]),ep)):W,ref:e=>{em.current[1]=e},onMouseDown:()=>void(ex.current=1),onFocus:()=>ei(1),showLabelOnHover:q,isHovered:es,disabled:X,...ea?.(1),children:eV?P[1]:P})]}),(0,t.jsx)("input",{type:"hidden",name:`${I}_from`,value:ed[0],...Q}),(0,t.jsx)("input",{type:"hidden",name:`${I}_to`,value:ed[1],...Q})]})})});M.classes=A.A,M.displayName="@mantine/core/RangeSlider"}},e=>{var a=a=>e(e.s=a);e.O(0,[67456,39699,68831,90636,46593,38792],()=>a(19709)),_N_E=e.O()}]);