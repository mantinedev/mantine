(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[68781],{62727:function(e,o,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/ring-progress",function(){return n(96503)}])},96503:function(e,o,n){"use strict";n.r(o),n.d(o,{default:function(){return I}});var t=n(52322),r=n(45392),s=n(2784),i=n(58898),l=n(11200),c=n(38483),a=n(46690),u=n(28559),d=n(82027),p=n(13588),h=n(68755),x=n(893);function m({size:e,value:o,offset:n,sum:r,thickness:s,root:i,color:l,lineRoundCaps:c,tooltip:a,getStyles:d,display:m,...v}){let g=(0,h.rZ)();return(0,t.jsx)(x.u.Floating,{disabled:!a,label:a,children:(0,t.jsx)(u.x,{component:"circle",...v,...d("curve"),__vars:{"--curve-color":l?(0,p.p)(l,g):void 0},fill:"none",strokeLinecap:c?"round":"butt",...function({size:e,thickness:o,sum:n,value:t,root:r,offset:s}){let i=(.9*e-2*o)/2,l=Math.PI*i*2/100,c=r||void 0===t?`${(100-n)*l}, ${n*l}`:`${t*l}, ${(100-t)*l}`;return{strokeWidth:Number.isNaN(o)?12:o,cx:e/2||0,cy:e/2||0,r:i||0,transform:r?`scale(1, -1) translate(0, -${e})`:void 0,strokeDasharray:c,strokeDashoffset:r?0:s||0}}({sum:r,size:e,thickness:s,value:o,offset:n,root:i})})})}m.displayName="@mantine/core/Curve";var v={root:"m_b32e4812",svg:"m_d43b5134",curve:"m_b1ca1fbf",label:"m_b23f9dc4"};let g={size:120,thickness:12},f=(0,l.Z)((e,{size:o,thickness:n,transitionDuration:t})=>({root:{"--rp-size":(0,i.h)(o),"--rp-label-offset":(0,i.h)(2*n),"--rp-transition-duration":t?`${t}ms`:void 0}})),j=(0,d.d5)((e,o)=>{let n=(0,c.w)("RingProgress",g,e),{classNames:r,className:i,style:l,styles:d,unstyled:p,vars:h,label:x,sections:j,size:b,thickness:y,roundCaps:R,rootColor:k,transitionDuration:C,...P}=n,M=(0,a.y)({name:"RingProgress",classes:v,props:n,className:i,style:l,classNames:r,styles:d,unstyled:p,vars:h,varsResolver:f}),_=Math.min(y||12,(b||120)/4),z=(function({size:e,thickness:o,sections:n,renderRoundedLineCaps:t,rootColor:r}){let s=n.reduce((e,o)=>e+o.value,0),i=(.9*e-2*o)/2*Math.PI*2,l=i,c=[],a=[];for(let e=0;e<n.length;e+=1)c.push({sum:s,offset:l,data:n[e],root:!1}),l-=n[e].value/100*i;if(c.push({sum:s,offset:l,data:{color:r},root:!0}),a.push({...c[c.length-1],lineRoundCaps:!1}),c.length>2){a.push({...c[0],lineRoundCaps:t}),a.push({...c[c.length-2],lineRoundCaps:t});for(let e=1;e<=c.length-3;e+=1)a.push({...c[e],lineRoundCaps:!1})}else a.push({...c[0],lineRoundCaps:t});return a})({size:b,thickness:_,sections:j,renderRoundedLineCaps:R,rootColor:k}).map(({data:e,sum:o,root:n,lineRoundCaps:t,offset:r},i)=>(0,s.createElement)(m,{...e,key:i,size:b,thickness:_,sum:o,offset:r,color:e?.color,root:n,lineRoundCaps:t,getStyles:M}));return(0,t.jsxs)(u.x,{...M("root"),size:b,ref:o,...P,children:[(0,t.jsx)("svg",{...M("svg"),children:z}),x&&(0,t.jsx)("div",{...M("label"),children:x})]})});j.classes=v,j.displayName="@mantine/core/RingProgress";var b=n(8582);let y={type:"code",code:`
...
`};var M=n(9705),_=n(93010),z=n(16438),T=n(54813);let w={type:"code",code:`
...
`,component:function(){return(0,t.jsxs)(_.Z,{justify:"center",children:[(0,t.jsx)(j,{sections:[{value:40,color:"blue"}],label:(0,t.jsx)(b.x,{c:"blue",fw:700,ta:"center",size:"xl",children:"40%"})}),(0,t.jsx)(j,{sections:[{value:100,color:"teal"}],label:(0,t.jsx)(z.M,{children:(0,t.jsx)(T.A,{color:"teal",variant:"light",radius:"xl",size:"xl",children:(0,t.jsx)(M.Z,{style:{width:(0,i.h)(22),height:(0,i.h)(22)}})})})})]})}};var E=n(65438),S=n(17115);let D={type:"code",component:function(){let[e,o]=(0,s.useState)(30);return(0,t.jsxs)(E.K,{align:"center",children:[(0,t.jsx)(j,{sections:[{value:e,color:"blue"}],transitionDuration:250,label:(0,t.jsxs)(b.x,{ta:"center",children:[e,"%"]})}),(0,t.jsx)(S.z,{onClick:()=>o(Math.floor(100*Math.random())),children:"Set random value"})]})},code:`
import { useState } from 'react';
