(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[42671],{85085:(e,n,r)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/drawer",function(){return r(4763)}])},4763:(e,n,r)=>{"use strict";r.r(n),r.d(n,{default:()=>P});var o=r(31085),t=r(71184),s=r(47436),i=r(52022),a=r(92051),c=r(86934);let l={type:"code",code:`
...
`,centered:!0,component:function(){let[e,{open:n,close:r}]=(0,a.j)(!1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(s._,{opened:e,onClose:r,title:"Authentication",children:(0,o.jsx)(c.d,{noShadow:!0,noPadding:!0})}),(0,o.jsx)(i.$,{variant:"default",onClick:n,children:"Open Drawer"})]})}};var d=r(14041),u=r(56051);let h={type:"code",component:function(){let[e,n]=(0,d.useState)(!1),[r,t]=(0,d.useState)("top"),a=e=>{t(e),n(!0)};return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(s._,{opened:e,onClose:()=>n(!1),padding:"md",position:r,withCloseButton:!1,children:"Press escape to close the drawer"}),(0,o.jsxs)(u.Y,{justify:"center",children:[(0,o.jsx)(i.$,{variant:"default",onClick:()=>a("left"),children:"Left"}),(0,o.jsx)(i.$,{variant:"default",onClick:()=>a("right"),children:"Right"}),(0,o.jsx)(i.$,{variant:"default",onClick:()=>a("top"),children:"Top"}),(0,o.jsx)(i.$,{variant:"default",onClick:()=>a("bottom"),children:"Bottom"})]})]})}};var p=r(14275);let m={type:"code",code:`
import { useDisclosure } from '@mantine/hooks';
import { Drawer, Button } from '@mantine/core';
...
`,centered:!0,component:function(){let[e,{open:n,close:r}]=(0,a.j)(!1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(s._,{opened:e,onClose:r,title:"Authentication",overlayProps:{backgroundOpacity:.5,blur:4},children:(0,o.jsx)(c.d,{noShadow:!0,noPadding:!0})}),(0,o.jsx)(i.$,{variant:"default",onClick:n,children:"Open Drawer"})]})}},x={type:"code",component:function(){let[e,n]=(0,d.useState)(!1),[r,t]=(0,d.useState)("top"),a=e=>{t(e),n(!0)},c=["xs","sm","md","lg","xl","100%","40rem","25%"].map(e=>(0,o.jsx)(i.$,{variant:"default",onClick:()=>a(e),children:e},e));return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(s._,{opened:e,onClose:()=>n(!1),padding:"md",size:r,withCloseButton:!1,children:"Press escape to close the drawer"}),(0,o.jsx)(u.Y,{justify:"center",children:c})]})}},w={type:"code",code:`
import { useDisclosure } from '@mantine/hooks';
import { Drawer, Button } from '@mantine/core';
...
`,centered:!0,component:function(){let[e,{open:n,close:r}]=(0,a.j)(!1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(s._,{opened:e,onClose:r,withCloseButton:!1,children:"Drawer without header, press escape or click on overlay to close"}),(0,o.jsx)(i.$,{variant:"default",onClick:n,children:"Open Drawer"})]})}},f={type:"code",code:`
import { useDisclosure } from '@mantine/hooks';
import { Drawer, Button } from '@mantine/core';
...
`,centered:!0,component:function(){let[e,{open:n,close:r}]=(0,a.j)(!1),t=Array(100).fill(0).map((e,n)=>(0,o.jsx)("p",{children:"Drawer with scroll"},n));return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(s._,{opened:e,onClose:r,title:"Header is sticky",children:t}),(0,o.jsx)(i.$,{variant:"default",onClick:n,children:"Open Drawer"})]})}};var j=r(37950);let D={type:"code",code:`
import { useDisclosure } from '@mantine/hooks';
...
`,centered:!0,component:function(){let[e,{open:n,close:r}]=(0,a.j)(!1),t=Array(100).fill(0).map((e,n)=>(0,o.jsx)("p",{children:"Drawer with scroll"},n));return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(s._,{opened:e,onClose:r,title:"Header is sticky",scrollAreaComponent:j.F.Autosize,children:t}),(0,o.jsx)(i.$,{variant:"default",onClick:n,children:"Open Drawer"})]})}},g={type:"code",code:`
import { useDisclosure } from '@mantine/hooks';
import { Drawer, Button } from '@mantine/core';
...
`,centered:!0,component:function(){let[e,{open:n,close:r}]=(0,a.j)(!1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(s._,{opened:e,onClose:r,title:"Authentication",transitionProps:{transition:"rotate-left",duration:150,timingFunction:"linear"},children:(0,o.jsx)(c.d,{noShadow:!0,noPadding:!0})}),(0,o.jsx)(i.$,{variant:"default",onClick:n,children:"Open Drawer"})]})}},k={type:"code",code:`
...
`,centered:!0,component:function(){let[e,n]=(0,a.j)(!1),[r,t]=(0,a.j)(!1),[c,l]=(0,d.useState)({title:"",message:""});return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(s._,{opened:e,onClose:()=>{n.close(),l({title:"",message:""})},transitionProps:{duration:300,exitDuration:1e3},title:c.title,children:c.message}),(0,o.jsx)(s._,{opened:r,onClose:t.close,transitionProps:{duration:300,exitDuration:1e3},onExitTransitionEnd:()=>l({title:"",message:""}),title:c.title,children:c.message}),(0,o.jsxs)(u.Y,{children:[(0,o.jsx)(i.$,{onClick:()=>{n.open(),l({title:"Edit your profile",message:"Imagine a form here"})},variant:"default",children:"Clear data in onClose"}),(0,o.jsx)(i.$,{onClick:()=>{t.open(),l({title:"Edit your profile",message:"Imagine a form here"})},variant:"default",children:"Clear data in onExitTransitionEnd"})]})]})},defaultExpanded:!1};var C=r(90275);let y={type:"code",code:`
import { useDisclosure } from '@mantine/hooks';
...
`,centered:!0,component:function(){let[e,{open:n,close:r}]=(0,a.j)(!1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(s._,{opened:e,onClose:r,title:"Focus demo",children:[(0,o.jsx)(C.k,{label:"First input",placeholder:"First input"}),(0,o.jsx)(C.k,{"data-autofocus":!0,label:"Input with initial focus",placeholder:"It has data-autofocus attribute",mt:"md"})]}),(0,o.jsx)(i.$,{variant:"default",onClick:n,children:"Open Drawer"})]})}};var v=r(4203);let b={type:"code",code:`
import { useDisclosure } from '@mantine/hooks';
...
`,centered:!0,component:function(){let[e,{open:n,close:r}]=(0,a.j)(!1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(s._,{opened:e,onClose:r,title:"Focus demo",children:[(0,o.jsx)(v.s.InitialFocus,{}),(0,o.jsx)(C.k,{label:"First input",placeholder:"First input"}),(0,o.jsx)(C.k,{"data-autofocus":!0,label:"Input with initial focus",placeholder:"It has data-autofocus attribute",mt:"md"})]}),(0,o.jsx)(i.$,{variant:"default",onClick:n,children:"Open Drawer"})]})}};var B=r(86483);let T={type:"code",code:`
...
`,centered:!0,component:function(){let[e,{open:n,close:r}]=(0,a.j)(!1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(s._,{opened:e,onClose:r,title:"Authentication",closeButtonProps:{icon:(0,o.jsx)(B.A,{size:20,stroke:1.5})},children:(0,o.jsx)(c.d,{noShadow:!0,noPadding:!0})}),(0,o.jsx)(i.$,{variant:"default",onClick:n,children:"Open Drawer"})]})}},A={type:"code",code:`
import { useDisclosure } from '@mantine/hooks';
import { Drawer, Button } from '@mantine/core';
...
`,centered:!0,component:function(){let[e,{open:n,close:r}]=(0,a.j)(!1);return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(s._.Root,{opened:e,onClose:r,children:[(0,o.jsx)(s._.Overlay,{}),(0,o.jsxs)(s._.Content,{children:[(0,o.jsxs)(s._.Header,{children:[(0,o.jsx)(s._.Title,{children:"Drawer title"}),(0,o.jsx)(s._.CloseButton,{})]}),(0,o.jsx)(s._.Body,{children:"Drawer content"})]})]}),(0,o.jsx)(i.$,{variant:"default",onClick:n,children:"Open Drawer"})]})}};var F=r(97915);let O={type:"code",code:`
