(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[17014],{19437:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/text",function(){return n(91484)}])},91484:function(e,t,n){"use strict";n.r(t),n.d(t,{default:function(){return S}});var i=n(24246),r=n(71670),a=n(27378),Text=n(26569);let o=`
...
`,centered:!0,controls:s.P};var p=n(56589);let m=`
import { Text } from '@mantine/core';
...
`,x={type:"configurator",component:function(e){return a.createElement(p.x,{maw:400,mx:"auto"},a.createElement(Text.x,{...e},"From Bulbapedia: Bulbasaur is a small, quadrupedal Pok\xe9mon that has blue-green skin with darker patches. It has red eyes with white pupils, pointed, ear-like structures on top of its head, and a short, blunt snout with a wide mouth. A pair of small, pointed teeth are visible in the upper jaw when its mouth is open. Each of its thick legs ends with three sharp claws. On Bulbasaur's back is a green plant bulb, which is grown from a seed planted there at birth. The bulb also conceals two slender, tentacle-like vines and provides it with energy through photosynthesis as well as from the nutrient-rich seeds contained within."))},code:d,controls:[{prop:"size",type:"size",libraryValue:"md",initialValue:"md"},{prop:"lineClamp",type:"number",initialValue:4,libraryValue:null,min:1,max:10,step:1}]};var h=n(94993);let T=`
