...
`;function k({meets:e,label:t}){return i.createElement(Text.x,{c:e?"teal":"red",style:{display:"flex",alignItems:"center"},mt:7,size:"sm"},e?i.createElement(f.Z,{style:{width:(0,x.h)(14),height:(0,x.h)(14)}}):i.createElement(w.Z,{style:{width:(0,x.h)(14),height:(0,x.h)(14)}})," ",i.createElement(I.x,{ml:10},t))}let V=[{re:/[0-9]/,label:"Includes number"},{re:/[a-z]/,label:"Includes lowercase letter"},{re:/[A-Z]/,label:"Includes uppercase letter"},{re:/[$&+,:;=?@#|'<>.^*()%!-]/,label:"Includes special symbol"}],j={type:"code",code:E,component:function(){let e;let[t,r]=(0,i.useState)(!1),[n,o]=(0,i.useState)(""),s=V.map((e,t)=>i.createElement(k,{key:t,label:e.label,meets:e.re.test(n)})),a=(e=n.length>5?0:1,V.forEach(t=>{t.re.test(n)||(e+=1)}),Math.max(100-100/(V.length+1)*e,10));return i.createElement(P.J,{opened:t,position:"bottom",width:"target",transitionProps:{transition:"pop"}},i.createElement(P.J.Target,null,i.createElement("div",{onFocusCapture:()=>r(!0),onBlurCapture:()=>r(!1)},i.createElement(l.W,{withAsterisk:!0,label:"Your password",placeholder:"Your password",value:n,onChange:e=>o(e.currentTarget.value)}))),i.createElement(P.J.Dropdown,null,i.createElement(C.E,{color:100===a?"teal":a>50?"yellow":"red",value:a,size:5,mb:"xs"}),i.createElement(k,{label:"Includes at least 6 characters",meets:n.length>5}),s))},centered:!0,maxWidth:340};var S=r(38956);let W=`
