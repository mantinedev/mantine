...
`,x=Array(1e5).fill(0).map((e,t)=>`Option ${t}`),v={type:"code",component:function(){return(0,n.jsx)(l.P,{label:"100 000 options autocomplete",placeholder:"Use limit to optimize performance",limit:5,data:x,searchable:!0})},code:b,maxWidth:340,centered:!0};var g=o(94091);let j=`
import { Select } from '@mantine/core';
...
`,maxWidth:340,centered:!0};var k=o(26972),V=o(39629);let A={type:"code",code:`
...
`},_={type:"configurator",component:function(e){return(0,n.jsx)(l.P,{...e,placeholder:"Select placeholder",data:["React","Angular","Vue","Svelte"]})},code:`
import { Select } from '@mantine/core';
...
`,centered:!0,maxWidth:340,controls:o(76528).pc},B={type:"code",component:function(){return(0,n.jsx)(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],readOnly:!0})},code:`
import { Select } from '@mantine/core';
...
`,maxWidth:340,centered:!0},M={type:"code",component:function(){return(0,n.jsx)(l.P,{label:"Your favorite library",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],disabled:!0})},code:`
import { Select } from '@mantine/core';
