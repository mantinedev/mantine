...
`,p={type:"code",component:function(){return i.createElement(c.x,{w:300,h:200},i.createElement(s.x,{w:600},i.createElement(u,null)))},centered:!0,code:h},f=`
import { ScrollArea, Box } from '@mantine/core';
...
`,x={type:"code",component:function(){return i.createElement(c.x,{w:300,h:200,scrollbars:"y"},i.createElement(s.x,{w:600},i.createElement(u,null)))},centered:!0,code:f};var w=r(27884),v=r(94998);let g=`
...
`,b={type:"code",component:function(){let[e,t]=(0,i.useState)({x:0,y:0});return i.createElement(w.K,{align:"center"},i.createElement(c.x,{w:300,h:200,onScrollPositionChange:t},i.createElement(s.x,{w:600},i.createElement(u,null))),i.createElement(Text.x,null,"Scroll position: ",i.createElement(v.E,null,`{ x: ${e.x}, y: ${e.y} }`)))},code:g};var y=r(22971),S=r(8671);let k=`
...
`,A={type:"code",component:function(){let e=(0,i.useRef)(null);return i.createElement(w.K,{align:"center"},i.createElement(c.x,{w:300,h:200,viewportRef:e},i.createElement(u,null)),i.createElement(y.Z,{justify:"center"},i.createElement(S.z,{onClick:()=>e.current.scrollTo({top:e.current.scrollHeight,behavior:"smooth"})},"Scroll to bottom"),i.createElement(S.z,{onClick:()=>e.current.scrollTo({top:e.current.scrollHeight/2,behavior:"smooth"})},"Scroll to center"),i.createElement(S.z,{onClick:()=>e.current.scrollTo({top:0,behavior:"smooth"})},"Scroll to top")))},code:k};var C={scrollbar:"m-3dc2e23a",thumb:"m-b848b7ea",corner:"m-342d2ec1"};let j=`
import { ScrollArea, Box } from '@mantine/core';
...
`,B={type:"code",component:function(){return i.createElement(c.x,{w:300,h:200,type:"always",offsetScrollbars:!0,classNames:C},i.createElement(s.x,{w:600},i.createElement(u,null)))},centered:!0,code:[{fileName:"Demo.tsx",code:j,language:"tsx"},{fileName:"Demo.module.css",code:E,language:"scss"}]};var T=r(19397),D=r(7033);let z=`
...
`,I=["Apples","Bananas","Oranges","Milk","Bread","Eggs","Chicken","Beef","Pasta","Rice","Potatoes","Onions","Tomatoes","Cucumbers","Carrots","Lettuce","Spinach","Broccoli","Cheese","Yogurt","Butter","Sugar","Salt","Pepper","Coffee","Tea","Juice","Water","Cookies","Chocolate"],P={type:"code",component:function(){let e=(0,i.useRef)(null),[t,r]=(0,i.useState)(""),[o,n]=(0,i.useState)(-1),l=I.filter(e=>e.toLowerCase().includes(t.toLowerCase())),a=l.map((e,t)=>i.createElement(T.k,{"data-list-item":!0,key:e,display:"block",bg:t===o?"var(--mantine-color-blue-light)":void 0,w:"100%",p:5},e));return i.createElement(i.Fragment,null,i.createElement(D.o,{value:t,onChange:e=>{r(e.currentTarget.value),n(-1)},onKeyDown:t=>{"ArrowDown"===t.key&&(t.preventDefault(),n(t=>{let r=t+1>=l.length?t:t+1;return e.current?.querySelectorAll("[data-list-item]")?.[r]?.scrollIntoView({block:"nearest"}),r})),"ArrowUp"===t.key&&(t.preventDefault(),n(t=>{let r=t-1<0?t:t-1;return e.current?.querySelectorAll("[data-list-item]")?.[r]?.scrollIntoView({block:"nearest"}),r}))},placeholder:"Search groceries"}),i.createElement(c.x,{h:150,type:"always",mt:"md",viewportRef:e},a))},code:z,centered:!0,maxWidth:340};var R=r(72048);let q=`
...
`,H={type:"code",component:function(){let[e,t]=(0,R.C)(3,{min:0,max:10}),r=Array(e).fill(0).map((e,t)=>i.createElement("p",{key:t},"Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dicta perspiciatis reiciendis voluptate eaque itaque quos. Natus iure tenetur libero, reprehenderit ad, sequi, in aliquam eos necessitatibus expedita delectus veniam culpa!"));return i.createElement(i.Fragment,null,i.createElement(c.x.Autosize,{mah:300,maw:400,mx:"auto"},r),i.createElement(y.Z,{justify:"center",mt:"md"},i.createElement(S.z,{color:"red",onClick:t.decrement},"Remove paragraph"),i.createElement(S.z,{onClick:t.increment},"Add paragraph")))},code:q};var L=r(63433);let V=`
import { useState, useRef } from 'react';
