(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[59353],{92020:function(e,t,o){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/multi-select",function(){return o(43445)}])},43445:function(e,t,o){"use strict";o.r(t),o.d(t,{default:function(){return ea}});var a=o(52322),n=o(45392),r=o(8511);let l={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"]})},code:`
...
`,maxWidth:340,centered:!0},i={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],defaultValue:["React"],clearable:!0})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},c={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],searchable:!0})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},s={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],searchable:!0,nothingFoundMessage:"Nothing found..."})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},d={type:"configurator",component:function(e){return(0,a.jsx)(r.N,{...e,data:["React","Angular","Svelte","Vue"],dropdownOpened:!0,pb:150,label:"Control check icon",placeholder:"Pick value",defaultValue:["React"]})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},p={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],hidePickedOptions:!0})},code:`
import { MultiSelect } from '@mantine/core';
...
`,k=Array(100).fill(0).map((e,t)=>`Option ${t}`),A={type:"code",component:function(){return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(r.N,{label:"With scroll area (default)",placeholder:"Pick value",data:k,maxDropdownHeight:200}),(0,a.jsx)(r.N,{label:"With native scroll",placeholder:"Pick value",data:k,withScrollArea:!1,styles:{dropdown:{maxHeight:200,overflowY:"auto"}},mt:"md"})]})},code:P,maxWidth:340,centered:!0},R={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick value",data:[{group:"Frontend",items:["React","Angular"]},{group:"Backend",items:["Express","Django"]}]})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},D={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick value",data:[{value:"react",label:"React"},{value:"ng",label:"Angular"},{value:"vue",label:"Vue",disabled:!0},{value:"svelte",label:"Svelte",disabled:!0}]})},code:`
import { MultiSelect } from '@mantine/core';
...
`,centered:!0,component:function(){return(0,a.jsxs)(N.J,{width:300,position:"bottom",withArrow:!0,shadow:"md",children:[(0,a.jsx)(N.J.Target,{children:(0,a.jsx)(Y.z,{children:"Toggle popover"})}),(0,a.jsx)(N.J.Dropdown,{children:(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{withinPortal:!1}})})]})}};var W=o(3900);let O={type:"code",component:function(){let[e,{toggle:t}]=(0,W.q)();return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(Y.z,{onClick:t,mb:"md",children:"Toggle dropdown"}),(0,a.jsx)(r.N,{label:"Your favorite library",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],dropdownOpened:e})]})},code:`
...
`,maxWidth:340,centered:!0},T={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{position:"top",middlewares:{flip:!1,shift:!1}}})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0};var I={dropdown:"m_a9824888",input:"m_f5487eb3"};let E={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite library",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],classNames:I,comboboxProps:{position:"bottom",middlewares:{flip:!1,shift:!1},offset:0}})},code:[{fileName:"Demo.tsx",code:`
import { MultiSelect } from '@mantine/core';
...
`,language:"scss"}],maxWidth:340,centered:!0},B={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{transitionProps:{transition:"pop",duration:200}}})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},F={type:"code",component:function(){return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(r.N,{label:"Zero padding",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{dropdownPadding:0}}),(0,a.jsx)(r.N,{mt:"md",label:"10px padding",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{dropdownPadding:10}})]})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},_={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{shadow:"md"}})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0};var z=o(43300),L=o(58898);let H={type:"code",component:function(){let e=(0,a.jsx)(z.Z,{style:{width:(0,L.h)(16),height:(0,L.h)(16)}});return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(r.N,{data:["React","Angular","Vue"],leftSectionPointerEvents:"none",leftSection:e,label:"Your favorite libraries",placeholder:"Your favorite libraries"}),(0,a.jsx)(r.N,{mt:"md",data:["React","Angular","Vue"],rightSectionPointerEvents:"none",rightSection:e,label:"Your favorite libraries",placeholder:"Your favorite libraries"})]})},maxWidth:340,centered:!0,code:`
...
`},q={type:"configurator",component:function(e){return(0,a.jsx)(r.N,{...e,placeholder:"MultiSelect placeholder",data:["React","Angular","Vue","Svelte"]})},code:`
import { MultiSelect } from '@mantine/core';
...
`,centered:!0,maxWidth:340,controls:o(76528).pc},G={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],readOnly:!0})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},J={type:"code",component:function(){return(0,a.jsx)(r.N,{label:"Your favorite libraries",placeholder:"Pick value",data:["React","Angular","Vue","Svelte"],disabled:!0})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},Z={type:"code",component:function(){return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(r.N,{label:"Boolean error",placeholder:"Boolean error",error:!0,data:["React","Angular","Vue","Svelte"]}),(0,a.jsx)(r.N,{mt:"md",label:"With error message",placeholder:"With error message",error:"Invalid name",data:["React","Angular","Vue","Svelte"]})]})},maxWidth:340,centered:!0,code:`
import { MultiSelect } from '@mantine/core';
