...
`,z=(0,D.j)({components:{Checkbox:c.X.extend({classNames:{root:"m_4308addd",label:"m_1db1f159"}})}}),I={type:"code",centered:!0,component:function(){return l.createElement(N.M2,{theme:z},l.createElement(c.X,{size:"xxs",label:"Extra small checkbox"}),l.createElement(c.X,{size:"xxl",label:"Extra large checkbox",mt:"md"}))},code:[{fileName:"Demo.tsx",code:X,language:"tsx"},{fileName:"Demo.module.css",code:S,language:"scss"}]};var P=n(93010);let R=`
