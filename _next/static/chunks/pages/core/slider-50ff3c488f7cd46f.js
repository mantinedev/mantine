...
`,language:"scss"}],maxWidth:500,centered:!0}},41949:(e,a,l)=>{"use strict";l.d(a,{A:()=>t});let t=(0,l(41495).A)("outline","calendar","Calendar",[["path",{d:"M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z",key:"svg-0"}],["path",{d:"M16 3v4",key:"svg-1"}],["path",{d:"M8 3v4",key:"svg-2"}],["path",{d:"M4 11h16",key:"svg-3"}],["path",{d:"M11 15h1",key:"svg-4"}],["path",{d:"M12 15v3",key:"svg-5"}]])},49386:(e,a,l)=>{"use strict";l.d(a,{F:()=>D});var t=l(6029),r=l(55729),n=l(7798),s=l(38744),i=l(24854),o=l(28136),d=l(26082),c=l(14163),u=l(78297),m=l(33987),h=l(21351),p=l(38919),v=l(15583),x=l(8411),b=l(90851),f=l(99341),g=l(68884),y=l(97832),j=l(29056),k=l(13494),w=l(31861),S=l(42268),A=l(51662),M=l(73778),V=l(97233);let T=(0,m.V)((e,{size:a,color:l,thumbSize:t,radius:r})=>({root:{"--slider-size":(0,c.YC)(a,"slider-size"),"--slider-color":l?(0,h.r)(l,e):void 0,"--slider-radius":void 0===r?void 0:(0,c.nJ)(r),"--slider-thumb-size":void 0!==t?(0,d.D)(t):"calc(var(--slider-size) * 2)"}})),z={min:0,max:100,minRange:10,step:1,marks:[],label:e=>e,labelTransitionProps:{transition:"fade",duration:0},labelAlwaysOn:!1,showLabelOnHover:!0,disabled:!1,pushOnOverlap:!0,scale:e=>e,size:"md",maxRange:1/0},D=(0,x.P9)((e,a)=>{let l=(0,p.Y)("RangeSlider",z,e),{classNames:d,styles:c,value:m,onChange:h,onChangeEnd:x,size:D,min:C,max:E,domain:N,minRange:F,maxRange:_,step:L,precision:R,defaultValue:W,name:B,marks:I,label:O,labelTransitionProps:H,labelAlwaysOn:$,thumbFromLabel:q,thumbToLabel:P,showLabelOnHover:X,thumbChildren:Y,disabled:K,unstyled:G,scale:U,inverted:Z,className:J,style:Q,vars:ee,hiddenInputProps:ea,restrictToMarks:el,thumbProps:et,pushOnOverlap:er,attributes:en,...es}=l,ei=(0,v.I)({name:"Slider",props:l,classes:V.A,classNames:d,className:J,styles:c,style:Q,attributes:en,vars:ee,varsResolver:T,unstyled:G}),eo=(0,r.useRef)(null),{dir:ed}=(0,b.jH)(),[ec,eu]=(0,r.useState)(-1),[em,eh]=(0,r.useState)(!1),[ep,ev]=(0,n.Z)({value:m,defaultValue:W,finalValue:[C,E],onChange:h}),ex=(0,r.useRef)(ep),eb=(0,r.useRef)([]),ef=(0,r.useRef)(null),eg=(0,r.useRef)(void 0),[ey,ej]=N||[C,E],ek=[(0,S.E)({value:ep[0],min:ey,max:ej}),(0,S.E)({value:ep[1],min:ey,max:ej})],ew=R??(0,A.X)(L);(0,r.useEffect)(()=>{Array.isArray(m)&&(ex.current=m)},Array.isArray(m)?[m[0],m[1]]:[null,null]);let eS=(e,a,l)=>{if(-1===a)return;let t=[...ex.current];if(el&&I){let l=(0,u.k)(e,I.map(e=>e.value)),r=t[a];t[a]=l;let n=+(0===a),s=(0,M.rq)(I),i=(0,M.HE)(I);l===s&&t[n]===s||l===i&&t[n]===i?t[a]=r:l===t[n]&&(r>t[n]?t[n]=(0,M.Mh)(l,I):t[n]=(0,M.C8)(l,I))}else{let l=(0,s.q)(e,C,E);t[a]=l,0===a&&(l>t[1]-(F-1e-9)&&(er?t[1]=Math.min(e+F,E):t[a]=ex.current[a]),l>(E-(F-1e-9)||C)&&(t[a]=ex.current[a]),t[1]-e>_&&(er?t[1]=e+_:t[a]=ex.current[a])),1===a&&(l<t[0]+F&&(er?t[0]=Math.max(e-F,C):t[a]=ex.current[a]),l<t[0]+F&&(t[a]=ex.current[a]),l-t[0]>_&&(er?t[0]=e-_:t[a]=ex.current[a]))}if(t[0]=(0,w.q)(t[0],ew),t[1]=(0,w.q)(t[1],ew),t[0]>t[1]){let e=t[0];t[0]=t[1],t[1]=e}(e=>{ev(e),ex.current=e})(t),l&&x?.(ex.current)},{ref:eA,active:eM}=(0,i.f)(({x:e})=>{!K&&void 0!==eg.current&&eS((0,k.c)({value:e,min:ey,max:ej,step:L,precision:ew}),eg.current,!1)},{onScrubEnd:()=>!K&&x?.(ex.current)},ed),eV=e=>{if(eo.current){eo.current.focus();let a=eo.current.getBoundingClientRect(),l=function(e){return"TouchEvent"in window&&e instanceof window.TouchEvent?e.touches[0].clientX:e.clientX}(e.nativeEvent),t=(0,k.c)({value:l-a.left,max:E,min:C,step:L,containerWidth:a.width}),r=+(Math.abs(ep[0]-t)>Math.abs(ep[1]-t));eg.current="ltr"===ed?r:+(1!==r)}},eT=()=>1!==ec&&0!==ec?(eu(0),0):ec,ez={max:E,min:C,size:D,labelTransitionProps:H,labelAlwaysOn:$,onBlur:()=>eu(-1)},eD=Array.isArray(Y);return(0,t.jsx)(f.h,{value:{getStyles:ei},children:(0,t.jsxs)(g.g,{...es,size:D,ref:(0,o.pc)(a,ef),disabled:K,onMouseDownCapture:()=>ef.current?.focus(),onKeyDownCapture:()=>{eb.current[0]?.parentElement?.contains(document.activeElement)||eb.current[0]?.focus()},children:[(0,t.jsxs)(j.C,{offset:ek[0],marksOffset:ep[0],filled:ek[1]-ek[0],marks:I,inverted:Z,min:ey,max:ej,value:ep[1],disabled:K,containerProps:{ref:(0,o.pc)(eo,eA),onMouseEnter:X?()=>eh(!0):void 0,onMouseLeave:X?()=>eh(!1):void 0,onTouchStartCapture:eV,onTouchEndCapture:()=>{eg.current=-1},onMouseDownCapture:eV,onMouseUpCapture:()=>{eg.current=-1},onKeyDownCapture:e=>{if(!K)switch(e.key){case"ArrowUp":{e.preventDefault();let a=eT();eb.current[a].focus();let l=el&&I?(0,M.C8)(ex.current[a],I):Math.min(Math.max(ex.current[a]+L,C),E);eS((0,w.q)(l,ew),a,!0);break}case"ArrowRight":{e.preventDefault();let a=eT();eb.current[a].focus();let l=el&&I?("rtl"===ed?M.Mh:M.C8)(ex.current[a],I):Math.min(Math.max("rtl"===ed?ex.current[a]-L:ex.current[a]+L,C),E);eS((0,w.q)(l,ew),a,!0);break}case"ArrowDown":{e.preventDefault();let a=eT();eb.current[a].focus();let l=el&&I?(0,M.Mh)(ex.current[a],I):Math.min(Math.max(ex.current[a]-L,C),E);eS((0,w.q)(l,ew),a,!0);break}case"ArrowLeft":{e.preventDefault();let a=eT();eb.current[a].focus();let l=el&&I?("rtl"===ed?M.C8:M.Mh)(ex.current[a],I):Math.min(Math.max("rtl"===ed?ex.current[a]+L:ex.current[a]-L,C),E);eS((0,w.q)(l,ew),a,!0)}}}},children:[(0,t.jsx)(y.z,{...ez,value:U(ep[0]),position:ek[0],dragging:eM,label:"function"==typeof O?O((0,w.q)(U(ep[0]),ew)):O,ref:e=>{e&&(eb.current[0]=e)},thumbLabel:q,onMouseDown:()=>void(eg.current=0),onFocus:()=>eu(0),showLabelOnHover:X,isHovered:em,disabled:K,...et?.(0),children:eD?Y[0]:Y}),(0,t.jsx)(y.z,{...ez,thumbLabel:P,value:U(ep[1]),position:ek[1],dragging:eM,label:"function"==typeof O?O((0,w.q)(U(ep[1]),ew)):O,ref:e=>{e&&(eb.current[1]=e)},onMouseDown:()=>void(eg.current=1),onFocus:()=>eu(1),showLabelOnHover:X,isHovered:em,disabled:K,...et?.(1),children:eD?Y[1]:Y})]}),(0,t.jsx)("input",{type:"hidden",name:`${B}_from`,value:ep[0],...ea}),(0,t.jsx)("input",{type:"hidden",name:`${B}_to`,value:ep[1],...ea})]})})});D.classes=V.A,D.displayName="@mantine/core/RangeSlider"},65433:(e,a,l)=>{"use strict";l.d(a,{A:()=>t});let t=(0,l(41495).A)("outline","switch-2","Switch2",[["path",{d:"M3 17h5l1.67 -2.386m3.66 -5.227l1.67 -2.387h6",key:"svg-0"}],["path",{d:"M18 4l3 3l-3 3",key:"svg-1"}],["path",{d:"M3 7h5l7 10h6",key:"svg-2"}],["path",{d:"M18 20l3 -3l-3 -3",key:"svg-3"}]])},72607:(e,a,l)=>{"use strict";l.d(a,{A:()=>t});let t=(0,l(41495).A)("outline","heart","Heart",[["path",{d:"M19.5 12.572l-7.5 7.428l-7.5 -7.428a5 5 0 1 1 7.5 -6.566a5 5 0 1 1 7.5 6.572",key:"svg-0"}]])},84276:(e,a,l)=>{"use strict";l.d(a,{A:()=>t});let t=(0,l(41495).A)("outline","file-text","FileText",[["path",{d:"M14 3v4a1 1 0 0 0 1 1h4",key:"svg-0"}],["path",{d:"M17 21h-10a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h7l5 5v11a2 2 0 0 1 -2 2z",key:"svg-1"}],["path",{d:"M9 9l1 0",key:"svg-2"}],["path",{d:"M9 13l6 0",key:"svg-3"}],["path",{d:"M9 17l6 0",key:"svg-4"}]])},88992:(e,a,l)=>{"use strict";l.d(a,{A:()=>t});let t=(0,l(41495).A)("outline","arrow-right","ArrowRight",[["path",{d:"M5 12l14 0",key:"svg-0"}],["path",{d:"M13 18l6 -6",key:"svg-1"}],["path",{d:"M13 6l6 6",key:"svg-2"}]])},94845:(e,a,l)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/slider",function(){return l(29544)}])},98403:(e,a,l)=>{"use strict";l.d(a,{b:()=>n});var t=l(6029),r=l(68992);let n={type:"code",component:function(){return(0,t.jsx)(r.A,{domain:[0,100],min:10,max:90,defaultValue:25,mb:40,marks:[{value:10,label:"min"},{value:90,label:"max"}]})},code:`
import { Slider } from '@mantine/core';
