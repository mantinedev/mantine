(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[58096],{95887:function(e,o,t){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/tooltip",function(){return t(36327)}])},36327:function(e,o,t){"use strict";t.r(o),t.d(o,{default:function(){return F}});var n=t(52322),i=t(45392),r=t(893),l=t(17115);let s=`
...
`,a={type:"code",component:function(){return(0,n.jsx)(r.u,{label:"Tooltip",children:(0,n.jsx)(l.z,{children:"Button with tooltip"})})},centered:!0,code:s},c=`
import { Tooltip, Button } from '@mantine/core';
...
`,d={type:"configurator",component:function(e){return(0,n.jsx)(r.u,{label:"Tooltip",...e,children:(0,n.jsx)(l.z,{children:"With tooltip"})})},code:c,centered:!0,controls:[{prop:"color",type:"color",initialValue:"blue",libraryValue:"__none__"}]};var p=t(19282);let u=`
import { Tooltip, Button } from '@mantine/core';
...
`,h={type:"configurator",component:function(e){return(0,n.jsx)(r.u,{label:"Tooltip",opened:!0,...e,children:(0,n.jsx)(l.z,{children:"Button with tooltip"})})},code:u,centered:!0,controls:[{type:"select",prop:"position",initialValue:"top",data:p.c,libraryValue:null},{type:"number",prop:"offset",initialValue:5,libraryValue:null,min:-50,max:50}]},m={type:"configurator",component:function(e){return(0,n.jsx)(r.u,{position:e.position,opened:!0,label:"Tooltip",offset:{mainAxis:e.mainAxis,crossAxis:e.crossAxis},children:(0,n.jsx)(l.z,{children:"Button with tooltip"})})},code:e=>`
import { Tooltip, Button } from '@mantine/core';
...
`,centered:!0,controls:[{type:"select",prop:"position",initialValue:"top",data:p.c,libraryValue:null},{type:"number",prop:"mainAxis",initialValue:5,libraryValue:null,min:-50,max:50},{type:"number",prop:"crossAxis",initialValue:0,libraryValue:null,min:-50,max:50}]},f=`
import { Tooltip, Button } from '@mantine/core';
...
`,x={type:"configurator",component:function(e){return(0,n.jsx)(r.u,{label:"Tooltip",withArrow:!0,opened:!0,position:"top-start",...e,children:(0,n.jsx)(l.z,{children:"Button with tooltip"})})},code:f,centered:!0,controls:[{type:"segmented",prop:"arrowPosition",initialValue:"center",libraryValue:"center",data:["center","side"]},{type:"number",prop:"arrowOffset",initialValue:10,libraryValue:null,min:5,max:50},{type:"number",prop:"arrowSize",initialValue:4,libraryValue:null,min:2,max:8},{type:"number",prop:"arrowRadius",initialValue:0,libraryValue:0,min:0,max:10}]};var b=t(2784);let j=`
...
}`,g={type:"code",centered:!0,code:j,component:function(){let[e,o]=(0,b.useState)(!1);return(0,n.jsx)(r.u,{label:"Ctrl + J",opened:e,children:(0,n.jsx)(l.z,{onClick:()=>o(e=>!e),children:"Toggle color scheme"})})}},T=`
import { Tooltip, Button } from '@mantine/core';
...
`,w={type:"code",code:T,centered:!0,component:function(){return(0,n.jsx)(r.u,{multiline:!0,w:220,withArrow:!0,transitionProps:{duration:200},label:"Use this button to save this information in your profile, after that you will be able to access it any time and share it via email.",children:(0,n.jsx)(l.z,{children:"Multiline tooltip"})})}};var Text=t(8582),y=t(20368);let v=`
...
`,B={type:"code",component:function(){return(0,n.jsxs)(Text.x,{children:["Stantler’s magnificent antlers were traded at high prices as works of art. As a result, this Pok\xe9mon was hunted close to extinction by those who were after the priceless antlers."," ",(0,n.jsx)(r.u,{inline:!0,label:"Inline tooltip",children:(0,n.jsx)(y.v,{children:"When visiting a junkyard"})}),", you may catch sight of it having an intense fight with Murkrow over shiny objects.Ho-Oh’s feathers glow in seven colors depending on the angle at which they are struck by light. These feathers are said to bring happiness to the bearers. This Pok\xe9mon is said to live at the foot of a rainbow."]})},code:v};var D=t(4124),k=t(93010);let A=`
...
`,C={type:"code",code:A,component:function(){return(0,n.jsxs)(k.Z,{justify:"center",children:[(0,n.jsx)(r.u,{label:"Opened after 500ms",openDelay:500,children:(0,n.jsx)(l.z,{children:"Delay open - 500ms"})}),(0,n.jsx)(r.u,{label:"Closes after 500ms",closeDelay:500,children:(0,n.jsx)(l.z,{children:"Delay close - 500ms"})})]})}},M=`
...
`,O={type:"code",component:function(){return(0,n.jsx)(r.u.Group,{openDelay:500,closeDelay:100,children:(0,n.jsxs)(k.Z,{justify:"center",children:[(0,n.jsx)(r.u,{label:"Tooltip 1",children:(0,n.jsx)(l.z,{children:"Button 1"})}),(0,n.jsx)(r.u,{label:"Tooltip 2",children:(0,n.jsx)(l.z,{children:"Button 2"})}),(0,n.jsx)(r.u,{label:"Tooltip 3",children:(0,n.jsx)(l.z,{children:"Button 3"})})]})})},code:M};var N=t(28559);let R=`
