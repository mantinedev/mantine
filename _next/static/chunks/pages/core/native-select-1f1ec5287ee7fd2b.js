(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[74958],{93061:(e,n,t)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/native-select",function(){return t(52523)}])},52523:(e,n,t)=>{"use strict";t.r(n),t.d(n,{default:()=>S});var a=t(31085),r=t(71184),l=t(73199);let i={type:"configurator",component:function(e){return(0,a.jsx)(l.m,{...e,data:["React","Angular","Vue"]})},code:`
import { NativeSelect } from '@mantine/core';

function Demo() {
  return <NativeSelect{{props}} data={['React', 'Angular', 'Vue']} />;
}
`,centered:!0,maxWidth:340,controls:t(23232).$7},o={type:"code",component:function(){return(0,a.jsx)(l.m,{data:[{group:"Frontend libraries",items:[{label:"React",value:"react"},{label:"Angular",value:"angular"},{label:"Vue",value:"vue",disabled:!0}]},{group:"Backend libraries",items:[{label:"Express",value:"express"},{label:"Koa",value:"koa"},{label:"Django",value:"django"}]}]})},maxWidth:340,centered:!0,code:`
import { NativeSelect } from '@mantine/core';
...
`},c={type:"code",component:function(){return(0,a.jsxs)(l.m,{label:"With dividers",children:[(0,a.jsx)("option",{children:"Select library"}),(0,a.jsx)("hr",{}),(0,a.jsxs)("optgroup",{label:"Frontend libraries",children:[(0,a.jsx)("option",{value:"react",children:"React"}),(0,a.jsx)("option",{value:"angular",children:"Angular"}),(0,a.jsx)("option",{value:"vue",children:"Vue"})]}),(0,a.jsx)("hr",{}),(0,a.jsxs)("optgroup",{label:"Backend libraries",children:[(0,a.jsx)("option",{value:"express",children:"Express"}),(0,a.jsx)("option",{value:"koa",children:"Koa"}),(0,a.jsx)("option",{value:"django",children:"Django"})]})]})},maxWidth:340,centered:!0,code:`
import { NativeSelect } from '@mantine/core';
...
`};var d=(0,t(73366).A)("outline","hash","IconHash",[["path",{d:"M5 9l14 0",key:"svg-0"}],["path",{d:"M5 15l14 0",key:"svg-1"}],["path",{d:"M11 4l-4 16",key:"svg-2"}],["path",{d:"M17 4l-4 16",key:"svg-3"}]]),u=t(24551);let p={type:"code",component:function(){return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(l.m,{leftSection:(0,a.jsx)(d,{size:16}),leftSectionPointerEvents:"none",label:"Left section",data:["React","Angular"]}),(0,a.jsx)(l.m,{rightSection:(0,a.jsx)(u.A,{size:16}),label:"Right section",data:["React","Angular"],mt:"md"})]})},maxWidth:340,centered:!0,code:`
import { NativeSelect } from '@mantine/core';
...
`},h={type:"code",component:function(){return(0,a.jsx)(l.m,{disabled:!0,data:["React","Angular"],label:"Disabled NativeSelect"})},maxWidth:340,centered:!0,code:`
import { NativeSelect } from '@mantine/core';

function Demo() {
  return <NativeSelect disabled data={['React', 'Angular']} label="Disabled NativeSelect" />;
}
`},m={type:"code",component:function(){return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(l.m,{error:!0,label:"Boolean error",data:["React","Angular"]}),(0,a.jsx)(l.m,{error:"Error message",label:"React node error",data:["React","Angular"],mt:"md"})]})},maxWidth:340,centered:!0,code:`
import { NativeSelect } from '@mantine/core';
