...
}`,h={type:"configurator",component:function(e){let{dir:a}=(0,u.gm)(),t="vertical"===e.orientation?{["rtl"===a?"pr":"pl"]:"xs"}:{pt:"xs"},n={width:(0,d.h)(12),height:(0,d.h)(12)};return o.createElement(T.m,{defaultValue:"gallery",...e},o.createElement(T.m.List,null,o.createElement(T.m.Tab,{value:"gallery",leftSection:o.createElement(i.Z,{style:n})},"Gallery"),o.createElement(T.m.Tab,{value:"messages",leftSection:o.createElement(c.Z,{style:n})},"Messages"),o.createElement(T.m.Tab,{value:"settings",leftSection:o.createElement(b.Z,{style:n})},"Settings")),o.createElement(T.m.Panel,{value:"gallery",...t},"Gallery tab content"),o.createElement(T.m.Panel,{value:"messages",...t},"Messages tab content"),o.createElement(T.m.Panel,{value:"settings",...t},"Settings tab content"))},code:m,centered:!0,maxWidth:"100%",controls:[{prop:"color",type:"color",initialValue:"blue",libraryValue:"blue"},{prop:"variant",type:"segmented",initialValue:"default",libraryValue:"default",data:[{value:"default",label:"Default"},{value:"outline",label:"Outline"},{value:"pills",label:"Pills"}]},{prop:"radius",type:"size",initialValue:"sm",libraryValue:"sm"},{prop:"orientation",type:"segmented",initialValue:"horizontal",libraryValue:"horizontal",data:[{value:"horizontal",label:"Horizontal"},{value:"vertical",label:"Vertical"}]}]},p=`
...
`,v={type:"code",code:p,component:function(){return o.createElement(T.m,{color:"teal",defaultValue:"first"},o.createElement(T.m.List,null,o.createElement(T.m.Tab,{value:"first"},"Teal tab"),o.createElement(T.m.Tab,{value:"second",color:"blue"},"Blue tab")),o.createElement(T.m.Panel,{value:"first",pt:"xs"},"First tab color is teal, it gets this value from context"),o.createElement(T.m.Panel,{value:"second",pt:"xs"},"Second tab color is blue, it gets this value from props, props have the priority and will override context value"))}},f=`
import { Tabs } from '@mantine/core';
...
`,g={type:"configurator",component:function(e){return o.createElement(T.m,{defaultValue:"first"},o.createElement(T.m.List,{...e},o.createElement(T.m.Tab,{value:"first"},"First tab"),o.createElement(T.m.Tab,{value:"second"},"Second tab"),o.createElement(T.m.Tab,{value:"third"},"Third tab")))},code:f,centered:!0,maxWidth:"100%",controls:[{prop:"grow",type:"boolean",initialValue:!1,libraryValue:!1},{prop:"justify",type:"select",initialValue:"flex-start",libraryValue:"flex-start",data:["flex-start","center","flex-end","space-between"]}]},y=`
import { Tabs } from '@mantine/core';
...
`,x={type:"code",component:function(){return o.createElement(T.m,{defaultValue:"chat"},o.createElement(T.m.List,null,o.createElement(T.m.Tab,{value:"chat"},"Chat"),o.createElement(T.m.Tab,{value:"gallery"},"Gallery"),o.createElement(T.m.Tab,{value:"settings"},"Settings"),o.createElement(T.m.Tab,{value:"account",ml:"auto"},"Account")))},code:y},j=`
import { Tabs } from '@mantine/core';
...
`,E={type:"code",component:function(){return o.createElement(T.m,{defaultValue:"chat",inverted:!0},o.createElement(T.m.Panel,{value:"chat",pb:"xs"},"Chat panel"),o.createElement(T.m.Panel,{value:"gallery",pb:"xs"},"Gallery panel"),o.createElement(T.m.Panel,{value:"account",pb:"xs"},"Account panel"),o.createElement(T.m.List,null,o.createElement(T.m.Tab,{value:"chat"},"Chat"),o.createElement(T.m.Tab,{value:"gallery"},"Gallery"),o.createElement(T.m.Tab,{value:"account"},"Account")))},code:j},P=`
import { Tabs } from '@mantine/core';
...
`,S={type:"configurator",component:function(e){let a="left"===e.placement?{pl:"xs"}:{pr:"xs"};return o.createElement(T.m,{defaultValue:"gallery",orientation:"vertical",...e},o.createElement(T.m.List,null,o.createElement(T.m.Tab,{value:"gallery"},"Gallery"),o.createElement(T.m.Tab,{value:"messages"},"Messages"),o.createElement(T.m.Tab,{value:"settings"},"Settings")),o.createElement(T.m.Panel,{value:"gallery",...a},"Gallery tab content"),o.createElement(T.m.Panel,{value:"messages",...a},"Messages tab content"),o.createElement(T.m.Panel,{value:"settings",...a},"Settings tab content"))},code:P,controls:[{prop:"placement",type:"segmented",initialValue:"left",libraryValue:"left",data:["left","right"]}]},w=`
import { Tabs } from '@mantine/core';
...
`,V={type:"code",component:function(){return o.createElement(T.m,{defaultValue:"chat"},o.createElement(T.m.List,null,o.createElement(T.m.Tab,{value:"chat"},"Chat"),o.createElement(T.m.Tab,{value:"gallery"},"Gallery"),o.createElement(T.m.Tab,{value:"settings",disabled:!0},"Settings"),o.createElement(T.m.Tab,{value:"account"},"Account")))},code:w},L=`
import { Tabs } from '@mantine/core';
...
`,k={type:"code",component:function(){return o.createElement(T.m,{defaultValue:"chat",activateTabWithKeyboard:!1},o.createElement(T.m.List,null,o.createElement(T.m.Tab,{value:"chat"},"Chat"),o.createElement(T.m.Tab,{value:"gallery"},"Gallery"),o.createElement(T.m.Tab,{value:"account"},"Account")),o.createElement(T.m.Panel,{value:"chat",pt:"xs"},"Chat panel"),o.createElement(T.m.Panel,{value:"gallery",pt:"xs"},"Gallery panel"),o.createElement(T.m.Panel,{value:"account",pt:"xs"},"Account panel"))},code:L},C=`
import { Tabs } from '@mantine/core';
...
`,D={type:"code",component:function(){return o.createElement(T.m,{defaultValue:"chat",allowTabDeactivation:!0},o.createElement(T.m.List,null,o.createElement(T.m.Tab,{value:"chat"},"Chat"),o.createElement(T.m.Tab,{value:"gallery"},"Gallery"),o.createElement(T.m.Tab,{value:"account"},"Account")),o.createElement(T.m.Panel,{value:"chat",pt:"xs"},"Chat panel"),o.createElement(T.m.Panel,{value:"gallery",pt:"xs"},"Gallery panel"),o.createElement(T.m.Panel,{value:"account",pt:"xs"},"Account panel"))},code:C};var M=t(49235);let G=`
import { Tabs, rem } from '@mantine/core';
...
`,A={type:"styles-api",data:M.Y,component:function(e){let a={width:(0,d.h)(12),height:(0,d.h)(12)};return o.createElement(T.m,{defaultValue:"gallery",...e},o.createElement(T.m.List,null,o.createElement(T.m.Tab,{value:"gallery",leftSection:o.createElement(i.Z,{style:a})},"Gallery"),o.createElement(T.m.Tab,{value:"messages",leftSection:o.createElement(c.Z,{style:a})},"Messages"),o.createElement(T.m.Tab,{value:"settings",rightSection:o.createElement(b.Z,{style:a})},"Settings")),o.createElement(T.m.Panel,{value:"gallery",pt:"xs"},"Gallery tab content"),o.createElement(T.m.Panel,{value:"messages",pt:"xs"},"Messages tab content"),o.createElement(T.m.Panel,{value:"settings",pt:"xs"},"Settings tab content"))},centered:!0,maxWidth:"100%",code:G};var I={tab:"m-3a996e90"};let N=`
import { Tabs, rem } from '@mantine/core';
import { IconPhoto, IconMessageCircle, IconSettings } from '@tabler/icons-react';
