(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[15752],{22702:function(e,a,l){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/slider",function(){return l(52718)}])},52718:function(e,a,l){"use strict";l.r(a),l.d(a,{default:function(){return er}});var n=l(52322),t=l(45392),r=l(69633);let i={type:"configurator",component:function(e){return(0,n.jsx)(r.i,{defaultValue:40,mb:40,marks:[{value:20,label:"20%"},{value:50,label:"50%"},{value:80,label:"80%"}],...e})},code:`
...
`,centered:!0,maxWidth:400,controls:[{prop:"color",type:"color",initialValue:"blue",libraryValue:"__none__"},{prop:"size",type:"size",initialValue:"md",libraryValue:"md"},{prop:"radius",type:"size",initialValue:"xl",libraryValue:"xl"},{prop:"showLabelOnHover",type:"boolean",initialValue:!0,libraryValue:!0},{prop:"labelAlwaysOn",type:"boolean",initialValue:!1,libraryValue:!1}]};var s=l(28559),o=l(2784),d=l(9341),c=l(51438),u=l(58898),m=l(91482),h=l(11200),x=l(13588),b=l(38483),p=l(46690),f=l(82027),v=l(89027),j=l(56867),g=l(10497),y=l(39172),k=l(77970),w=l(37748),S=l(81515),V=l(49514),T=l(40148),D=l(40908);let z=(0,h.Z)((e,{size:a,color:l,thumbSize:n,radius:t})=>({root:{"--slider-size":(0,m.ap)(a,"slider-size"),"--slider-color":l?(0,x.p)(l,e):void 0,"--slider-radius":void 0===t?void 0:(0,m.H5)(t),"--slider-thumb-size":void 0!==n?(0,u.h)(n):"calc(var(--slider-size) * 2)"}})),M={min:0,max:100,minRange:10,step:1,marks:[],label:e=>e,labelTransitionProps:{transition:"fade",duration:0},labelAlwaysOn:!1,showLabelOnHover:!0,disabled:!1,scale:e=>e},R=(0,f.d5)((e,a)=>{let l=(0,b.w)("RangeSlider",M,e),{classNames:t,styles:r,value:i,onChange:s,onChangeEnd:u,size:m,min:h,max:x,minRange:f,maxRange:R,step:N,precision:C,defaultValue:A,name:_,marks:F,label:E,labelTransitionProps:I,labelAlwaysOn:L,thumbFromLabel:W,thumbToLabel:B,showLabelOnHover:O,thumbChildren:H,disabled:$,unstyled:Z,scale:J,inverted:P,className:X,style:Y,vars:G,hiddenInputProps:K,thumbProps:U,...q}=l,Q=(0,p.y)({name:"Slider",props:l,classes:D.Z,classNames:t,className:X,styles:r,style:Y,vars:G,varsResolver:z,unstyled:Z}),{dir:ee}=(0,v.gm)(),[ea,el]=(0,o.useState)(-1),[en,et]=(0,o.useState)(!1),[er,ei]=(0,d.C)({value:i,defaultValue:A,finalValue:[h,x],onChange:s}),es=(0,o.useRef)(er),eo=(0,o.useRef)([]),ed=(0,o.useRef)(void 0),ec=[(0,V.b)({value:er[0],min:h,max:x}),(0,V.b)({value:er[1],min:h,max:x})],eu=C??(0,T.p)(N),em=e=>{ei(e),es.current=e};(0,o.useEffect)(()=>{Array.isArray(i)&&(es.current=i)},Array.isArray(i)?[i[0],i[1]]:[null,null]);let eh=(e,a,l)=>{let n=[...es.current];n[a]=e,0===a&&(e>n[1]-(f-1e-9)&&(n[1]=Math.min(e+f,x)),e>(x-(f-1e-9)||h)&&(n[a]=es.current[a]),n[1]-e>R&&(n[1]=e+R)),1===a&&(e<n[0]+f&&(n[0]=Math.max(e-f,h)),e<n[0]+f&&(n[a]=es.current[a]),e-n[0]>R&&(n[0]=e-R)),n[0]=(0,S.J)(n[0],eu),n[1]=(0,S.J)(n[1],eu),em(n),l&&u?.(es.current)},ex=e=>{$||eh((0,w.i)({value:e,min:h,max:x,step:N,precision:eu}),ed.current,!1)},{ref:eb,active:ep}=(0,c.r)(({x:e})=>ex(e),{onScrubEnd:()=>u?.(es.current)},ee),ef=e=>{var a;eb.current.focus();let l=eb.current.getBoundingClientRect(),n=(a=e.nativeEvent,"TouchEvent"in window&&a instanceof window.TouchEvent?a.touches[0].clientX:a.clientX),t=(0,w.i)({value:n-l.left,max:x,min:h,step:N,containerWidth:l.width}),r=Math.abs(er[0]-t)>Math.abs(er[1]-t)?1:0,i="ltr"===ee?r:1===r?0:1;ed.current=i},ev=()=>1!==ea&&0!==ea?(el(0),0):ea,ej={max:x,min:h,size:m,labelTransitionProps:I,labelAlwaysOn:L,onBlur:()=>el(-1)},eg=Array.isArray(H);return(0,n.jsx)(j.Y,{value:{getStyles:Q},children:(0,n.jsxs)(g.l,{...q,size:m,ref:a,disabled:$,children:[(0,n.jsxs)(k.f,{offset:ec[0],marksOffset:er[0],filled:ec[1]-ec[0],marks:F,inverted:P,min:h,max:x,value:er[1],disabled:$,containerProps:{ref:eb,onMouseEnter:O?()=>et(!0):void 0,onMouseLeave:O?()=>et(!1):void 0,onTouchStartCapture:ef,onTouchEndCapture:()=>{ed.current=-1},onMouseDownCapture:ef,onMouseUpCapture:()=>{ed.current=-1},onKeyDownCapture:e=>{if(!$)switch(e.key){case"ArrowUp":{e.preventDefault();let a=ev();eo.current[a].focus(),eh((0,S.J)(Math.min(Math.max(es.current[a]+N,h),x),eu),a,!0);break}case"ArrowRight":{e.preventDefault();let a=ev();eo.current[a].focus(),eh((0,S.J)(Math.min(Math.max("rtl"===ee?es.current[a]-N:es.current[a]+N,h),x),eu),a,!0);break}case"ArrowDown":{e.preventDefault();let a=ev();eo.current[a].focus(),eh((0,S.J)(Math.min(Math.max(es.current[a]-N,h),x),eu),a,!0);break}case"ArrowLeft":{e.preventDefault();let a=ev();eo.current[a].focus(),eh((0,S.J)(Math.min(Math.max("rtl"===ee?es.current[a]+N:es.current[a]-N,h),x),eu),a,!0)}}}},children:[(0,n.jsx)(y.b,{...ej,value:J(er[0]),position:ec[0],dragging:ep,label:"function"==typeof E?E((0,S.J)(J(er[0]),eu)):E,ref:e=>{eo.current[0]=e},thumbLabel:W,onMouseDown:()=>void(ed.current=0),onFocus:()=>el(0),showLabelOnHover:O,isHovered:en,disabled:$,...U?.(0),children:eg?H[0]:H}),(0,n.jsx)(y.b,{...ej,thumbLabel:B,value:J(er[1]),position:ec[1],dragging:ep,label:"function"==typeof E?E((0,S.J)(J(er[1]),eu)):E,ref:e=>{eo.current[1]=e},onMouseDown:()=>void(ed.current=1),onFocus:()=>el(1),showLabelOnHover:O,isHovered:en,disabled:$,...U?.(1),children:eg?H[1]:H})]}),(0,n.jsx)("input",{type:"hidden",name:`${_}_from`,value:er[0],...K}),(0,n.jsx)("input",{type:"hidden",name:`${_}_to`,value:er[1],...K})]})})});R.classes=D.Z,R.displayName="@mantine/core/RangeSlider";let N={type:"code",component:function(){return(0,n.jsxs)(s.x,{maw:400,mx:"auto",children:[(0,n.jsx)(r.i,{defaultValue:60,disabled:!0}),(0,n.jsx)(R,{mt:"xl",mb:"xl",disabled:!0,defaultValue:[25,75],marks:[{value:0,label:"xs"},{value:25,label:"sm"},{value:50,label:"md"},{value:75,label:"lg"},{value:100,label:"xl"}]})]})},code:`
...
`,centered:!0,maxWidth:340},L={type:"code",component:function(){return(0,n.jsx)(R,{minRange:.2,min:0,max:1,step:5e-4,defaultValue:[.1245,.5535]})},code:`
...
`,centered:!0,maxWidth:340},W={type:"code",component:function(){let e=[{value:20,label:"20%"},{value:50,label:"50%"},{value:80,label:"80%"}];return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.i,{defaultValue:40,marks:[{value:10},{value:40},{value:95}],mb:32}),(0,n.jsx)(r.i,{defaultValue:40,marks:e,mb:32}),(0,n.jsx)(R,{defaultValue:[20,80],marks:e,mb:32})]})},code:`
import { Slider, RangeSlider } from '@mantine/core';
...
`,centered:!0,maxWidth:400};var B=l(47838);let O={type:"configurator",component:function(e){return(0,n.jsx)(r.i,{...e,defaultValue:20})},code:`
import { Slider } from '@mantine/core';

function Demo() {
  return <Slider{{props}} defaultValue={20} />;
}
`,maxWidth:400,centered:!0,controls:[{prop:"thumbSize",type:"number",min:14,max:32,initialValue:14,libraryValue:null}]};var H=l(35913),$=(0,l(73681).Z)("outline","heart-broken","IconHeartBroken",[["path",{d:"M19.5 12.572l-7.5 7.428l-7.5 -7.428a5 5 0 1 1 7.5 -6.566a5 5 0 1 1 7.5 6.572",key:"svg-0"}],["path",{d:"M12 6l-2 4l4 3l-2 4v3",key:"svg-1"}]]);let Z={type:"code",component:function(){return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.i,{thumbChildren:(0,n.jsx)(H.Z,{size:"1rem",stroke:1.5}),color:"red",label:null,defaultValue:40,thumbSize:26,styles:{thumb:{borderWidth:(0,u.h)(2),padding:(0,u.h)(3)}}}),(0,n.jsx)(R,{mt:"xl",styles:{thumb:{borderWidth:(0,u.h)(2),padding:(0,u.h)(3)}},color:"red",label:null,defaultValue:[20,60],thumbSize:26,thumbChildren:[(0,n.jsx)(H.Z,{size:"1rem",stroke:1.5},"1"),(0,n.jsx)($,{size:"1rem",stroke:1.5},"2")]})]})},code:`
...
`,maxWidth:400,centered:!0};function J(e){let a=["KB","MB","GB","TB"],l=0,n=e;for(;n>=1024&&l<a.length-1;)l+=1,n/=1024;return`${n} ${a[l]}`}let P=e=>2**e,X={type:"code",component:function(){return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.i,{scale:P,step:1,min:2,max:30,labelAlwaysOn:!0,defaultValue:10,label:J}),(0,n.jsx)(R,{mt:50,scale:P,step:1,min:2,max:30,labelAlwaysOn:!0,defaultValue:[10,20],label:J})]})},code:`
...
`,centered:!0,maxWidth:400},Y={type:"code",component:function(){return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.i,{inverted:!0,defaultValue:80}),(0,n.jsx)(R,{inverted:!0,defaultValue:[40,80],mt:"xl"})]})},code:`
import { RangeSlider, Slider } from '@mantine/core';
...
`,centered:!0,maxWidth:400};var G=l(24727);let K=`
import { Slider } from '@mantine/core';

function Demo() {
  return <Slider{{props}} marks={[{ value: 20, label: '20%' }, { value: 80, label: '80%' }]} labelAlwaysOn />;
}
`,U={type:"styles-api",data:G.a,component:function(e){return(0,n.jsx)(r.i,{marks:[{value:20,label:"20%"},{value:80,label:"80%"}],defaultValue:40,labelAlwaysOn:!0,mb:40,...e})},code:K,centered:!0,maxWidth:400};var q={track:"m_7b015c03",mark:"m_88156515",markLabel:"m_beb40edf",thumb:"m_7afd1c8e"};let Q={type:"code",component:function(){return(0,n.jsx)(s.x,{maw:400,pt:15,pb:20,mx:"auto",children:(0,n.jsx)(r.i,{defaultValue:40,marks:[{value:20,label:"20%"},{value:50,label:"50%"},{value:80,label:"80%"}],size:2,classNames:q})})},code:[{fileName:"Demo.tsx",code:`
import { Slider } from '@mantine/core';
...
`,language:"scss"}],maxWidth:500,centered:!0}},47838:function(e,a,l){"use strict";l.d(a,{Z:function(){return r}});var n=l(52322),t=l(69633);let r={type:"code",component:function(){return(0,n.jsx)(t.i,{restrictToMarks:!0,defaultValue:25,marks:Array.from({length:5}).map((e,a)=>({value:25*a}))})},code:`
import { Slider } from '@mantine/core';
...
`,centered:!0,maxWidth:400}}},function(e){e.O(0,[61177,66748,11340,92888,49774,40179],function(){return e(e.s=22702)}),_N_E=e.O()}]);