...
`,controls:[{type:"segmented",prop:"justify",data:["center","space-between"],initialValue:"center",libraryValue:"__none__"}]},x={type:"configurator",component:function(e){return(0,o.jsxs)(h.Z,{justify:"center",children:[(0,o.jsxs)(a.z,{size:e.size,children:["Regular ",e.size]}),(0,o.jsxs)(a.z,{size:`compact-${e.size}`,children:["Compact ",e.size]})]})},code:e=>`
...
`,centered:!0,controls:[{type:"size",prop:"size",initialValue:"md",libraryValue:"__none__"}]};var j=n(63048);let b={type:"configurator",component:function(e){return(0,o.jsx)(a.z,{variant:"gradient",gradient:{from:e.gradientFrom,to:e.gradientTo,deg:e.gradientDegree},children:"Gradient button"})},code:e=>`
import { Button } from '@mantine/core';
...
`,centered:!0,controls:j.P},g=`
import { Button } from '@mantine/core';

function Demo() {
  return <Button disabled>Disabled button</Button>;
}
`,v={type:"code",component:function(){return(0,o.jsx)(a.z,{disabled:!0,children:"Disabled button"})},centered:!0,code:g},y=`
import { Button } from '@mantine/core';
...
`,B={type:"code",component:function(){return(0,o.jsx)(a.z,{component:"a",href:"https://mantine.dev","data-disabled":!0,onClick:e=>e.preventDefault(),children:"Disabled link"})},centered:!0,code:y},w=`
import { Button } from '@mantine/core';
...
`,D={type:"code",component:function(){return(0,o.jsx)(a.z,{className:"m_13d58bb2",disabled:!0,children:"Disabled with styles"})},centered:!0,code:[{fileName:"Demo.module.css",code:z,language:"scss"},{fileName:"Demo.tsx",code:w,language:"tsx"}]};var k=n(893);let S=`
...
`,C={type:"code",component:function(){return(0,o.jsx)(k.u,{label:"Tooltip for disabled button",children:(0,o.jsx)(a.z,{"data-disabled":!0,onClick:e=>e.preventDefault(),children:"Disabled button with tooltip"})})},centered:!0,code:S};var _=n(57914);let G=`
import { Button } from '@mantine/core';
...
`,T={type:"code",component:function(){return(0,o.jsx)(a.z,{loading:!0,loaderProps:{type:"dots"},children:"Loading button"})},centered:!0,code:G};var V=n(35661),P=n(58898),N=n(28621);let I=`
...
`,R={type:"styles-api",data:N.B,component:function(e){return(0,o.jsx)(a.z,{leftSection:(0,o.jsx)(V.Z,{style:{width:(0,P.h)(16),height:(0,P.h)(16)}}),...e,children:"Your email"})},code:I,centered:!0};var F=n(31408),M=n(60231),Z=n(68755);let L=`
...
`,$=(0,M.j)({components:{Button:a.z.extend({classNames:{root:"m_3abb4e8a"}})}}),W={type:"code",component:function(){return(0,o.jsx)(Z.M2,{theme:$,children:(0,o.jsxs)(h.Z,{children:[(0,o.jsx)(a.z,{variant:"danger",children:"Danger variant"}),(0,o.jsx)(a.z,{variant:"primary",children:"Primary variant"})]})})},centered:!0,code:[{fileName:"Demo.tsx",code:L,language:"tsx"},{fileName:"Demo.module.css",code:A,language:"scss"}]};var E=n(2498);let O=`
import { Button, Group } from '@mantine/core';
...
`,Y={type:"code",component:function(){return(0,o.jsxs)(h.Z,{children:[(0,o.jsx)(a.z,{color:"lime.4",children:"Default"}),(0,o.jsx)(a.z,{color:"lime.4",autoContrast:!0,children:"Auto contrast"})]})},code:O,centered:!0},q=`
import { Button } from '@mantine/core';
...
`;function u(e){return(0,o.jsx)(i.z,{...e,radius:"md",classNames:d})}let h={type:"code",component:function(){return(0,o.jsxs)(a.Z,{children:[(0,o.jsx)(u,{leftSection:"12",rightSection:(0,o.jsx)(r.Z,{style:{width:(0,l.h)(18)}}),children:"Send files"}),(0,o.jsx)(u,{leftSection:"3",rightSection:(0,o.jsx)(r.Z,{style:{width:(0,l.h)(18)}}),disabled:!0,children:"Send files"})]})},centered:!0,code:[{fileName:"Demo.module.css",code:c,language:"scss"},{fileName:"Demo.tsx",code:s,language:"tsx"}]}},2498:function(e,t,n){"use strict";n.d(t,{D:function(){return m}});var o=n(52322),r=n(9197),i=n(46403),a=n(20754),l=n(58898),d=n(8943),s=n(68755),c=n(93010),u=n(17115);let h=`
import {
  Button,
  Group,
  MantineProvider,
...
`,p=e=>{let t=(0,r.B)(e),n=(0,i.E)({color:e.color||e.theme.primaryColor,theme:e.theme});return n.isThemeColor&&"lime"===n.color&&"filled"===e.variant?{...t,color:"var(--mantine-color-black)",hoverColor:"var(--mantine-color-black)"}:"light"===e.variant?{background:(0,a.m)(n.value,.1),hover:(0,a.m)(n.value,.15),border:`${(0,l.h)(1)} solid ${n.value}`,color:(0,d._)(n.value,.1)}:"danger"===e.variant?{background:"var(--mantine-color-red-9)",hover:"var(--mantine-color-red-8)",color:"var(--mantine-color-white)",border:"none"}:t},m={type:"code",component:function(){return(0,o.jsx)(s.M2,{theme:{variantColorResolver:p},children:(0,o.jsxs)(c.Z,{children:[(0,o.jsx)(u.z,{color:"lime.4",variant:"filled",children:"Lime filled button"}),(0,o.jsx)(u.z,{color:"orange",variant:"light",children:"Orange light button"}),(0,o.jsx)(u.z,{variant:"danger",children:"Danger button"})]})})},centered:!0,code:h}},63048:function(e,t,n){"use strict";n.d(t,{P:function(){return o}});let o=[{type:"color",prop:"gradientFrom",initialValue:"blue",libraryValue:"__none__"},{type:"color",prop:"gradientTo",initialValue:"cyan",libraryValue:"__none__"},{type:"number",prop:"gradientDegree",initialValue:90,min:0,max:360,libraryValue:"__none__"}]},50327:function(e,t,n){"use strict";n.d(t,{cH:function(){return o},d_:function(){return r}});let o={type:"select",prop:"variant",data:["default","filled","light","outline","subtle","transparent","white"],initialValue:"filled",libraryValue:"__none__"},r={type:"select",prop:"variant",data:["filled","light","outline","transparent","white","default"],initialValue:"filled",libraryValue:"__none__"}},3900:function(e,t,n){"use strict";n.d(t,{q:function(){return r}});var o=n(2784);function r(e=!1,t){let{onOpen:n,onClose:r}=t||{},[i,a]=(0,o.useState)(e),l=(0,o.useCallback)(()=>{a(e=>e||(n?.(),!0))},[n]),d=(0,o.useCallback)(()=>{a(e=>e?(r?.(),!1):e)},[r]),s=(0,o.useCallback)(()=>{i?d():l()},[d,l,i]);return[i,{open:l,close:d,toggle:s}]}}},function(e){e.O(0,[57938,17454,47747,49774,92888,40179],function(){return e(e.s=59937)}),_N_E=e.O()}]);