...
`,m={type:"code",code:h,component:function(){return(0,r.jsx)(f,{maw:400,mx:"auto",label:"Your package.json",placeholder:"Textarea will autosize to fit the content",validationError:"Invalid JSON",formatOnBlur:!0,autosize:!0,minRows:4})}};var b=n(76528);let g=`
import { JsonInput } from '@mantine/core';
...
`,y={type:"configurator",component:function(e){return(0,r.jsx)(f,{...e,placeholder:"Input placeholder"})},code:g,centered:!0,maxWidth:340,controls:b.pc},x=`
import { JsonInput } from '@mantine/core';
...
`,v={type:"code",code:x,component:function(){return(0,r.jsx)(f,{disabled:!0,defaultValue:'{ "a": 1, "B": 2 }',label:"Disabled",placeholder:"Disabled"})},centered:!0,maxWidth:340};var V=n(35661),j=n(58898),w=n(84380);let I=`
