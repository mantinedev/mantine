(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[96781],{5858:function(e,t,i){"use strict";i.d(t,{Z:function(){return n}});var n=(0,i(99882).Z)("x","IconX",[["path",{d:"M18 6l-12 12",key:"svg-0"}],["path",{d:"M6 6l12 12",key:"svg-1"}]])},83838:function(e,t,i){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/chip",function(){return i(97189)}])},97189:function(e,t,i){"use strict";i.r(t),i.d(t,{default:function(){return X}});var n=i(52322),l=i(45392),a=i(2784),r=i(66178),c=i(9341),o=i(91482),p=i(11200),d=i(38483),h=i(62378),u=i(97072),s=i(28559),m=i(82027),C=i(40284),f=i(75336);let[v,g]=(0,f.V)(),b={};function k(e){let{value:t,defaultValue:i,onChange:n,multiple:l,children:r}=(0,d.w)("ChipGroup",b,e),[o,p]=(0,c.C)({value:t,defaultValue:i,finalValue:l?[]:null,onChange:n});return a.createElement(v,{value:{isChipSelected:e=>Array.isArray(o)?o.includes(e):e===o,onChange:e=>{let t=e.currentTarget.value;Array.isArray(o)?p(o.includes(t)?o.filter(e=>e!==t):[...o,t]):p(t)},multiple:l}},r)}k.displayName="@mantine/core/ChipGroup";var E={root:"m_f59ffda3",label:"m_be049a53","label--outline":"m_3904c1af","label--filled":"m_fa109255","label--light":"m_f7e165c3",iconWrapper:"m_9ac86df9",checkIcon:"m_d6d72580",input:"m_bde07329"};let y={type:"checkbox"},x=(0,p.Z)((e,{size:t,radius:i,variant:n,color:l,autoContrast:a})=>{let r=e.variantColorResolver({color:l||e.primaryColor,theme:e,variant:n||"filled",autoContrast:a});return{root:{"--chip-fz":(0,o.yv)(t),"--chip-size":(0,o.ap)(t,"chip-size"),"--chip-radius":void 0===i?void 0:(0,o.H5)(i),"--chip-checked-padding":(0,o.ap)(t,"chip-checked-padding"),"--chip-padding":(0,o.ap)(t,"chip-padding"),"--chip-icon-size":(0,o.ap)(t,"chip-icon-size"),"--chip-bg":l||n?r.background:void 0,"--chip-hover":l||n?r.hover:void 0,"--chip-color":l||n?r.color:void 0,"--chip-bd":l||n?r.border:void 0,"--chip-spacing":(0,o.ap)(t,"chip-spacing")}}}),j=(0,m.d)((e,t)=>{let i=(0,d.w)("Chip",y,e),{classNames:n,className:l,style:o,styles:p,unstyled:m,vars:f,id:v,checked:b,defaultChecked:k,onChange:j,value:G,wrapperProps:w,type:_,disabled:V,children:A,size:S,variant:T,icon:F,rootRef:N,autoContrast:Z,mod:z,...M}=i,D=(0,h.y)({name:"Chip",classes:E,props:i,className:l,style:o,classNames:n,styles:p,unstyled:m,vars:f,varsResolver:x}),O=g(),P=(0,r.M)(v),{styleProps:R,rest:I}=(0,u.c)(M),[X,L]=(0,c.C)({value:b,defaultValue:k,finalValue:!1,onChange:j}),W=O?{checked:O.isChipSelected(G),onChange:e=>{O.onChange(e),j?.(e.currentTarget.checked)},type:O.multiple?"checkbox":"radio"}:{},H=W.checked||X;return a.createElement(s.x,{size:S,variant:T,ref:N,mod:z,...D("root"),...R,...w},a.createElement("input",{type:_,...D("input"),checked:H,onChange:e=>L(e.currentTarget.checked),id:P,disabled:V,ref:t,value:G,...W,...I}),a.createElement("label",{htmlFor:P,"data-checked":H||void 0,"data-disabled":V||void 0,...D("label",{variant:T||"filled"})},H&&a.createElement("span",{...D("iconWrapper")},F||a.createElement(C.n,{...D("checkIcon")})),a.createElement("span",null,A)))});j.classes=E,j.displayName="@mantine/core/Chip",j.Group=k;let G=`
import { Chip } from '@mantine/core';

function Demo() {
  return <Chip defaultChecked{{props}}>Awesome chip</Chip>
}
`,w={type:"configurator",component:function(e){return a.createElement(j,{defaultChecked:!0,...e},"Awesome chip")},code:G,centered:!0,controls:[{prop:"color",type:"color",initialValue:"blue",libraryValue:"blue"},{prop:"variant",type:"segmented",data:[{value:"filled",label:"Filled"},{value:"outline",label:"Outline"},{value:"light",label:"Light"}],initialValue:"filled",libraryValue:"filled"},{prop:"size",type:"size",initialValue:"sm",libraryValue:"sm"},{prop:"radius",type:"size",initialValue:"xl",libraryValue:"xl"}]};var _=i(5858),V=i(58898);let A=`
