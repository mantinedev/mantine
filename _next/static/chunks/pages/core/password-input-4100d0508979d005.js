...
`,T={type:"code",component:function(){return i.createElement(i.Fragment,null,i.createElement(l.W,{label:"Boolean error",placeholder:"Boolean error",error:!0}),i.createElement(l.W,{mt:"md",label:"With error message",placeholder:"With error message",error:"Invalid name"}))},maxWidth:340,centered:!0,code:D},_=`
import { PasswordInput } from '@mantine/core';
...
`,M={type:"code",component:function(){return i.createElement(l.W,{disabled:!0,label:"Disabled password input",placeholder:"Disabled password input"})},code:_,centered:!0,maxWidth:340};var Z=r(58869);let N=`
import { IconLock } from '@tabler/icons-react';
import { PasswordInput, rem } from '@mantine/core';
