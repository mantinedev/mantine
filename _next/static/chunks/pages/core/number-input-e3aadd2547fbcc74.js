...
`,centered:!0,maxWidth:340}},76528:function(e,t,n){"use strict";n.d(t,{Mt:function(){return r},nW:function(){return a},pc:function(){return o}});let r=[{type:"segmented",prop:"variant",data:["default","filled","unstyled"],initialValue:"default",libraryValue:"default"},{type:"size",prop:"size",initialValue:"sm",libraryValue:"sm"},{type:"size",prop:"radius",initialValue:"sm",libraryValue:"sm"},{type:"boolean",prop:"disabled",initialValue:!1,libraryValue:!1},{type:"boolean",prop:"error",initialValue:!1,libraryValue:!1}],a=[{type:"string",prop:"label",initialValue:"Input label",libraryValue:null},{type:"boolean",prop:"withAsterisk",initialValue:!1,libraryValue:!1},{type:"string",prop:"description",initialValue:"Input description",libraryValue:null},{type:"string",prop:"error",initialValue:"Input error",libraryValue:null},{type:"size",prop:"size",initialValue:"sm",libraryValue:"sm"}],o=[{type:"segmented",prop:"variant",data:["default","filled","unstyled"],initialValue:"default",libraryValue:"default"},{type:"size",prop:"size",initialValue:"sm",libraryValue:"sm"},{type:"size",prop:"radius",initialValue:"sm",libraryValue:"sm"},{type:"string",prop:"label",initialValue:"Input label",libraryValue:""},{type:"boolean",prop:"withAsterisk",initialValue:!1,libraryValue:!1},{type:"string",prop:"description",initialValue:"Input description",libraryValue:""},{type:"string",prop:"error",initialValue:"",libraryValue:""}]},42697:function(e,t,n){"use strict";n.d(t,{Y:function(){return V}});var r=n(52322),a=n(2784),o=n(40489),l=n(9462),i=n(9341),c=n(82692),s=n(70837),d=n(91482),u=n(11200),m=n(51477),p=n(46690),h=n(38483),b=n(82027),f=n(73063),x=n(63409);function j({direction:e,style:t,...n}){return(0,r.jsx)("svg",{style:{width:"var(--ni-chevron-size)",height:"var(--ni-chevron-size)",transform:"up"===e?"rotate(180deg)":void 0,...t},viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n,children:(0,r.jsx)("path",{d:"M3.13523 6.15803C3.3241 5.95657 3.64052 5.94637 3.84197 6.13523L7.5 9.56464L11.158 6.13523C11.3595 5.94637 11.6759 5.95657 11.8648 6.15803C12.0536 6.35949 12.0434 6.67591 11.842 6.86477L7.84197 10.6148C7.64964 10.7951 7.35036 10.7951 7.15803 10.6148L3.15803 6.86477C2.95657 6.67591 2.94637 6.35949 3.13523 6.15803Z",fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd"})})}var v={root:"m_e2f5cd4e",controls:"m_95e17d22",control:"m_80b4b171"};let y=/^(0\.0*|-0(\.0*)?)$/,g=/^-?0\d+(\.\d+)?\.?$/;function N(e){return"string"==typeof e&&""!==e&&!Number.isNaN(Number(e))}function I(e){return"number"==typeof e?e<Number.MAX_SAFE_INTEGER:""===e}function w(e,t,n){return void 0===e||(void 0===t||e>=t)&&(void 0===n||e<=n)}let D={step:1,clampBehavior:"blur",allowDecimal:!0,allowNegative:!0,withKeyboardEvents:!0,allowLeadingZeros:!0,trimLeadingZeroesOnBlur:!0,startValue:0},S=(0,u.Z)((e,{size:t})=>({controls:{"--ni-chevron-size":(0,d.ap)(t,"ni-chevron-size")}})),V=(0,b.d5)((e,t)=>{let n=(0,h.w)("NumberInput",D,e),{className:d,classNames:u,styles:b,unstyled:V,vars:C,onChange:k,onValueChange:E,value:Y,defaultValue:W,max:_,min:M,step:B,hideControls:A,rightSection:R,isAllowed:T,clampBehavior:F,onBlur:H,allowDecimal:z,decimalScale:P,onKeyDown:G,onKeyDownCapture:L,handlersRef:Z,startValue:X,disabled:$,rightSectionPointerEvents:U,allowNegative:K,readOnly:O,size:q,rightSectionWidth:J,stepHoldInterval:Q,stepHoldDelay:ee,allowLeadingZeros:et,withKeyboardEvents:en,trimLeadingZeroesOnBlur:er,...ea}=n,eo=(0,p.y)({name:"NumberInput",classes:v,props:n,classNames:u,styles:b,unstyled:V,vars:C,varsResolver:S}),{resolvedClassNames:el,resolvedStyles:ei}=(0,m.h)({classNames:u,styles:b,props:n}),[ec,es]=(0,i.C)({value:Y,defaultValue:W,finalValue:"",onChange:k}),ed=void 0!==ee&&void 0!==Q,eu=(0,a.useRef)(null),em=(0,a.useRef)(null),ep=(0,a.useRef)(0),eh=e=>{let t=String(e).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);return t?Math.max(0,(t[1]?t[1].length:0)-(t[2]?+t[2]:0)):0},eb=e=>{eu.current&&void 0!==e&&eu.current.setSelectionRange(e,e)},ef=(0,a.useRef)();ef.current=()=>{let e;if(!I(ec))return;let t=Math.max(eh(ec),eh(B)),n=10**t;if(!N(ec)&&("number"!=typeof ec||Number.isNaN(ec)))e=(0,c.u)(X,M,_);else if(void 0!==_){let t=(Math.round(Number(ec)*n)+Math.round(B*n))/n;e=t<=_?t:_}else e=(Math.round(Number(ec)*n)+Math.round(B*n))/n;let r=e.toFixed(t);es(parseFloat(r)),E?.({floatValue:parseFloat(r),formattedValue:r,value:r},{source:"increment"}),setTimeout(()=>eb(eu.current?.value.length),0)};let ex=(0,a.useRef)();ex.current=()=>{let e;if(!I(ec))return;let t=void 0!==M?M:K?Number.MIN_SAFE_INTEGER:0,n=Math.max(eh(ec),eh(B)),r=10**n;if(!N(ec)&&"number"!=typeof ec||Number.isNaN(ec))e=(0,c.u)(X,t,_);else{let n=(Math.round(Number(ec)*r)-Math.round(B*r))/r;e=void 0!==t&&n<t?t:n}let a=e.toFixed(n);es(parseFloat(a)),E?.({floatValue:parseFloat(a),formattedValue:a,value:a},{source:"decrement"}),setTimeout(()=>eb(eu.current?.value.length),0)},(0,s.kR)(Z,{increment:ef.current,decrement:ex.current});let ej=e=>{e?ef.current():ex.current(),ep.current+=1},ev=e=>{if(ej(e),ed){let t="number"==typeof Q?Q:Q(ep.current);em.current=window.setTimeout(()=>ev(e),t)}},ey=(e,t)=>{e.preventDefault(),eu.current?.focus(),ej(t),ed&&(em.current=window.setTimeout(()=>ev(t),ee))},eg=()=>{em.current&&window.clearTimeout(em.current),em.current=null,ep.current=0},eN=(0,r.jsxs)("div",{...eo("controls"),children:[(0,r.jsx)(x.k,{...eo("control"),tabIndex:-1,"aria-hidden":!0,disabled:$||"number"==typeof ec&&void 0!==_&&ec>=_,mod:{direction:"up"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{ey(e,!0)},onPointerUp:eg,onPointerLeave:eg,children:(0,r.jsx)(j,{direction:"up"})}),(0,r.jsx)(x.k,{...eo("control"),tabIndex:-1,"aria-hidden":!0,disabled:$||"number"==typeof ec&&void 0!==M&&ec<=M,mod:{direction:"down"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{ey(e,!1)},onPointerUp:eg,onPointerLeave:eg,children:(0,r.jsx)(j,{direction:"down"})})]});return(0,r.jsx)(f.M,{component:l.h3,allowNegative:K,className:(0,o.Z)(v.root,d),size:q,...ea,readOnly:O,disabled:$,value:ec,getInputRef:(0,s.Yx)(t,eu),onValueChange:(e,t)=>{var n,r;"event"===t.source&&es((n=e.floatValue,r=e.value,("number"==typeof n?!(n<Number.MAX_SAFE_INTEGER):!!Number.isNaN(Number(n)))||Number.isNaN(n)||!(14>r.toString().replace(".","").length)||""===r||y.test(e.value)||et&&g.test(e.value))?e.value:e.floatValue),E?.(e,t)},rightSection:A||O||!I(ec)?R:R||eN,classNames:el,styles:ei,unstyled:V,__staticSelector:"NumberInput",decimalScale:z?P:0,onKeyDown:e=>{G?.(e),!O&&en&&("ArrowUp"===e.key&&(e.preventDefault(),ef.current()),"ArrowDown"===e.key&&(e.preventDefault(),ex.current()))},onKeyDownCapture:e=>{if(L?.(e),"Backspace"===e.key){let t=eu.current;0===t.selectionStart&&t.selectionStart===t.selectionEnd&&(e.preventDefault(),window.setTimeout(()=>eb(0),0))}},rightSectionPointerEvents:U??($?"none":void 0),rightSectionWidth:J??`var(--ni-right-section-width-${q||"sm"})`,allowLeadingZeros:et,onBlur:e=>{if(H?.(e),"blur"===F&&"number"==typeof ec&&(0,c.u)(ec,M,_)!==ec&&es((0,c.u)(ec,M,_)),er&&"string"==typeof ec&&15>eh(ec)){let e=ec.replace(/^0+/,""),t=parseFloat(e);es(Number.isNaN(t)||t>Number.MAX_SAFE_INTEGER?e:(0,c.u)(t,M,_))}},isAllowed:e=>"strict"===F?T?T(e)&&w(e.floatValue,M,_):w(e.floatValue,M,_):!T||T(e)})});V.classes={...f.M.classes,...v},V.displayName="@mantine/core/NumberInput"}},function(e){e.O(0,[61177,9462,66748,11340,92888,49774,40179],function(){return e(e.s=6062)}),_N_E=e.O()}]);