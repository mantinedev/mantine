...
`};var c=i(58898),d=i(60231),l=i(68755);let m=`
...
`,h={xxs:(0,c.h)(300),xs:(0,c.h)(400),sm:(0,c.h)(500),md:(0,c.h)(600),lg:(0,c.h)(700),xl:(0,c.h)(800),xxl:(0,c.h)(900)},x=(0,d.j)({components:{Container:r.W.extend({vars:(e,{size:n,fluid:i})=>({root:{"--container-size":i?"100%":void 0!==n&&n in h?h[n]:(0,c.h)(n)}})})}}),u={type:"code",component:function(){return(0,t.jsx)(l.M2,{theme:x,children:(0,t.jsx)(r.W,{size:"xxs",bg:"var(--mantine-color-blue-light)",children:"Container with custom size"})})},code:m};var p=i(40489);let f=`
import cx from 'clsx';
