...
`,maxWidth:340,centered:!0},p={type:"code",component:function(){return(0,a.jsx)(r.u,{label:"Press Enter to submit a tag",placeholder:"Enter tag",splitChars:[","," ","|"]})},code:`
import { TagsInput } from '@mantine/core';
...
`,v=Array(1e5).fill(0).map((e,t)=>`Option ${t}`),f={type:"code",component:function(){return(0,a.jsx)(r.u,{label:"100 000 options tags input",placeholder:"Use limit to optimize performance",limit:5,data:v})},code:b,maxWidth:340,centered:!0};var y=n(25457);let j=`
import { TagsInput } from '@mantine/core';
...
`,maxWidth:340,centered:!0};var A=n(35764),V=n(52022);let P={type:"code",code:`
...
`,centered:!0,component:function(){return(0,a.jsxs)(A.A,{width:300,position:"bottom",withArrow:!0,shadow:"md",children:[(0,a.jsx)(A.A.Target,{children:(0,a.jsx)(V.$,{children:"Toggle popover"})}),(0,a.jsx)(A.A.Dropdown,{children:(0,a.jsx)(r.u,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{withinPortal:!1}})})]})}};var S=n(92051);let D={type:"code",component:function(){let[e,{toggle:t}]=(0,S.j)();return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(V.$,{onClick:t,mb:"md",children:"Toggle dropdown"}),(0,a.jsx)(r.u,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],dropdownOpened:e})]})},code:`
...
`,maxWidth:340,centered:!0},E={type:"code",component:function(){return(0,a.jsx)(r.u,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{position:"top",middlewares:{flip:!1,shift:!1}}})},code:`
import { TagsInput } from '@mantine/core';
...
`},O={type:"configurator",component:function(e){return(0,a.jsx)(r.u,{...e,placeholder:"TagsInput placeholder",value:["First","Second"],data:["React","Angular","Vue","Svelte"]})},code:`
import { TagsInput } from '@mantine/core';
...
`,centered:!0,maxWidth:340,controls:n(23232).$7},Y={type:"code",component:function(){return(0,a.jsx)(r.u,{label:"Read only",placeholder:"Enter tag",readOnly:!0,defaultValue:["First","Second"]})},code:`
import { TagsInput } from '@mantine/core';
...
`,maxWidth:340,centered:!0},z={type:"code",component:function(){return(0,a.jsx)(r.u,{label:"Disabled",placeholder:"Enter tag",disabled:!0,defaultValue:["First","Second"]})},code:`
import { TagsInput } from '@mantine/core';
