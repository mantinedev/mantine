...
`,h={type:"code",code:m,component:function(){return o.createElement(f,{maw:400,mx:"auto",label:"Your package.json",placeholder:"Textarea will autosize to fit the content",validationError:"Invalid JSON",formatOnBlur:!0,autosize:!0,minRows:4})}};var b=n(76528);let g=`
import { JsonInput } from '@mantine/core';
...
`,x={type:"code",code:v,component:function(){return o.createElement(f,{disabled:!0,defaultValue:'{ "a": 1, "B": 2 }',label:"Disabled",placeholder:"Disabled"})},centered:!0,maxWidth:340};var V=n(35661),w=n(58898),I=n(84380);let z=`
