...
`,z={type:"configurator",component:function(e){let t=d.createElement(p.Z,{size:14});return d.createElement(d.Fragment,null,d.createElement(s.z,w({fullWidth:!0,leftSection:t,rightSection:t,variant:"default"},e),"Button label"),d.createElement(s.z,w({fullWidth:!0,leftSection:t,variant:"default",mt:"md"},e),"Button label"),d.createElement(s.z,w({fullWidth:!0,rightSection:t,variant:"default",mt:"md"},e),"Button label"),d.createElement(s.z,w({fullWidth:!0,rightSection:t,leftSection:d.createElement("span",null),variant:"default",mt:"md"},e),"Button label"))},code:k,controls:[{type:"segmented",prop:"justify",data:["center","space-between"],initialValue:"center",libraryValue:"__none__"}]},E=e=>`
...
`,D={type:"configurator",component:function(e){return d.createElement(h.Z,{justify:"center"},d.createElement(s.z,{size:e.size},"Regular ",e.size),d.createElement(s.z,{size:`compact-${e.size}`},"Compact ",e.size))},code:E,centered:!0,controls:[{type:"size",prop:"size",initialValue:"md",libraryValue:"__none__"}]};var S=n(69137);let O=e=>`
import { Button } from '@mantine/core';
...
`,P={type:"configurator",component:function(e){return d.createElement(s.z,{variant:"gradient",gradient:{from:e.gradientFrom,to:e.gradientTo,deg:e.gradientDegree}},"Gradient button")},code:O,centered:!0,controls:S.P},M=`
import { Button } from '@mantine/core';

function Demo() {
  return <Button disabled>Disabled button</Button>;
}
`,C={type:"code",component:function(){return d.createElement(s.z,{disabled:!0},"Disabled button")},centered:!0,code:M},_=`
import { Button } from '@mantine/core';
...
`,I={type:"code",component:function(){return d.createElement(s.z,{component:"a",href:"https://mantine.dev","data-disabled":!0,onClick:e=>e.preventDefault()},"Disabled link")},centered:!0,code:_};var Z={button:"m-13d58bb2"};let G=`
import { Button } from '@mantine/core';
...
`,V={type:"code",component:function(){return d.createElement(s.z,{className:Z.button,disabled:!0},"Disabled with styles")},centered:!0,code:[{fileName:"Demo.module.css",code:T,language:"css"},{fileName:"Demo.tsx",code:G,language:"tsx"}]};var N=n(46842);let R=`
...
`,F={type:"code",component:function(){return d.createElement(N.u,{label:"Tooltip for disabled button"},d.createElement(s.z,{"data-disabled":!0,onClick:e=>e.preventDefault()},"Disabled button with tooltip"))},centered:!0,code:R},L=`
import { Button, Group } from '@mantine/core';
...
`,A={type:"code",component:function(){return d.createElement(h.Z,null,d.createElement(s.z,{loading:!0},"Filled button"),d.createElement(s.z,{variant:"light",loading:!0},"Light button"),d.createElement(s.z,{variant:"outline",loading:!0},"Outline button"))},centered:!0,code:L},$=`
import { Button } from '@mantine/core';
...
`,W={type:"code",component:function(){return d.createElement(s.z,{loading:!0,loaderProps:{type:"dots"}},"Loading button")},centered:!0,code:$};var Y=n(72622),H=n(5878),U=n(93693),X=Object.defineProperty,q=Object.getOwnPropertySymbols,J=Object.prototype.hasOwnProperty,K=Object.prototype.propertyIsEnumerable,Q=(e,t,n)=>t in e?X(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,ee=(e,t)=>{for(var n in t||(t={}))J.call(t,n)&&Q(e,n,t[n]);if(q)for(var n of q(t))K.call(t,n)&&Q(e,n,t[n]);return e};let et=`
...
`,en={type:"styles-api",data:H.B,component:function(e){return d.createElement(s.z,ee({leftSection:d.createElement(U.Z,{style:{width:(0,Y.h)(16),height:(0,Y.h)(16)}})},e),"Your email")},code:et,centered:!0};var eo=n(87321),er=n(28120),ei=n(43440);let ea=`
...
`,ed=(0,er.j)({components:{Button:s.z.extend({classNames:{root:"m-3abb4e8a"}})}}),es={type:"code",component:function(){return d.createElement(ei.M2,{theme:ed},d.createElement(h.Z,null,d.createElement(s.z,{variant:"danger"},"Danger variant"),d.createElement(s.z,{variant:"primary"},"Primary variant")))},centered:!0,code:[{fileName:"Demo.tsx",code:ea,language:"tsx"},{fileName:"Demo.module.css",code:el,language:"css"}]};var ec=n(53029),eu=Object.defineProperty,eh=Object.getOwnPropertySymbols,ep=Object.prototype.hasOwnProperty,em=Object.prototype.propertyIsEnumerable,ef=(e,t,n)=>t in e?eu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,eb=(e,t)=>{for(var n in t||(t={}))ep.call(t,n)&&ef(e,n,t[n]);if(eh)for(var n of eh(t))em.call(t,n)&&ef(e,n,t[n]);return e};let ev=`
import { Button } from '@mantine/core';
