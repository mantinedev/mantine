...
`,s={type:"configurator",component:function(e){return(0,n.jsx)(i.g,{...e,placeholder:"Input placeholder"})},code:l,centered:!0,maxWidth:340,controls:o.pc},u=`
import { Textarea } from '@mantine/core';
...
`,c={type:"code",code:u,component:function(){return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(i.g,{placeholder:"Autosize with no rows limit",label:"Autosize with no rows limit",autosize:!0,minRows:2}),(0,n.jsx)(i.g,{label:"Autosize with 4 rows max",placeholder:"Autosize with 4 rows max",autosize:!0,minRows:2,maxRows:4,mt:"md"})]})},maxWidth:340,centered:!0},d=`
import { Textarea } from '@mantine/core';

function Demo() {
  return <Textarea resize="vertical" label="Disabled" placeholder="Your comment" />;
}
`,p={type:"code",code:d,component:function(){return(0,n.jsx)(i.g,{resize:"vertical",label:"Disabled",placeholder:"Your comment"})},centered:!0,maxWidth:340},m=`
import { Textarea } from '@mantine/core';
...
`,h={type:"code",component:function(){return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(i.g,{label:"Boolean error",placeholder:"Boolean error",error:!0}),(0,n.jsx)(i.g,{mt:"md",label:"With error message",placeholder:"With error message",error:"Invalid name"})]})},maxWidth:340,centered:!0,code:m},f=`
import { Textarea } from '@mantine/core';

function Demo() {
  return <Textarea label="Disabled" placeholder="Your comment" disabled />;
}
`,x={type:"code",code:f,component:function(){return(0,n.jsx)(i.g,{label:"Disabled",placeholder:"Your comment",disabled:!0})},centered:!0,maxWidth:340};var b=r(35661),g=r(58898),y=r(10629);let v=`
