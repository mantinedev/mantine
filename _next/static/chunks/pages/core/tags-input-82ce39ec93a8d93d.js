(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[46887],{93693:function(e,t,n){"use strict";n.d(t,{Z:function(){return a}});var a=(0,n(54764).Z)("at","IconAt",[["path",{d:"M12 12m-4 0a4 4 0 1 0 8 0a4 4 0 1 0 -8 0",key:"svg-0"}],["path",{d:"M16 12v1.5a2.5 2.5 0 0 0 5 0v-1.5a9 9 0 1 0 -5.5 8.28",key:"svg-1"}]])},42259:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/tags-input",function(){return n(30568)}])},30568:function(e,t,n){"use strict";n.r(t),n.d(t,{default:function(){return eb}});var a=n(24246),o=n(71670),r=n(27378),l=n(16161);let i=`
...
`,b={type:"code",component:function(){return r.createElement(l.B,{label:"Press Enter to submit a tag",placeholder:"Enter tag",splitChars:[","," ","|"]})},code:g,maxWidth:340,centered:!0};var f=n(16584);let x=`
...
`,w=({options:e,search:t})=>{let n=e.filter(e=>e.label.toLowerCase().trim().includes(t.toLowerCase().trim()));return n.sort((e,t)=>e.label.localeCompare(t.label)),n},I={type:"code",component:function(){return r.createElement(l.B,{label:"Your favorite libraries",placeholder:"Pick value or enter anything",data:["4 – React","1 – Angular","3 – Vue","2 – Svelte"],filter:w})},code:j,maxWidth:340,centered:!0},T=`
import { TagsInput } from '@mantine/core';
...
`,E=Array(1e5).fill(0).map((e,t)=>`Option ${t}`),V={type:"code",component:function(){return r.createElement(l.B,{label:"100 000 options tags input",placeholder:"Use limit to optimize performance",limit:5,data:E})},code:T,maxWidth:340,centered:!0},P=`
import { TagsInput } from '@mantine/core';
...
`,S=Array(100).fill(0).map((e,t)=>`Option ${t}`),D={type:"code",component:function(){return r.createElement(r.Fragment,null,r.createElement(l.B,{label:"With scroll area (default)",placeholder:"Pick value or enter anything",data:S,maxDropdownHeight:200}),r.createElement(l.B,{label:"With native scroll",placeholder:"Pick value or enter anything",data:S,withScrollArea:!1,styles:{dropdown:{maxHeight:200,overflowY:"auto"}},mt:"md"}))},code:P,maxWidth:340,centered:!0},A=`
import { TagsInput } from '@mantine/core';
...
`,B={type:"code",component:function(){return r.createElement(l.B,{label:"Enter tags",placeholder:"Enter tags",data:[{group:"Frontend",items:["React","Angular"]},{group:"Backend",items:["Express","Django"]}]})},code:A,maxWidth:340,centered:!0},k=`
import { TagsInput } from '@mantine/core';
...
`,Y={type:"code",code:F,centered:!0,component:function(){return r.createElement(R.J,{width:300,position:"bottom",withArrow:!0,shadow:"md"},r.createElement(R.J.Target,null,r.createElement(W.z,null,"Toggle popover")),r.createElement(R.J.Dropdown,null,r.createElement(l.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{withinPortal:!1}})))}};var O=n(87921);let _=`
...
`,z={type:"code",component:function(){let[e,{toggle:t}]=(0,O.q)();return r.createElement(r.Fragment,null,r.createElement(W.z,{onClick:t,mb:"md"},"Toggle dropdown"),r.createElement(l.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],dropdownOpened:e}))},code:_,maxWidth:340,centered:!0},N=`
import { TagsInput } from '@mantine/core';
...
`,L={type:"code",component:function(){return r.createElement(l.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{position:"top",middlewares:{flip:!1,shift:!1}}})},code:N,maxWidth:340,centered:!0},M=`
import { TagsInput } from '@mantine/core';
...
`,Z={type:"code",component:function(){return r.createElement(l.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{transitionProps:{transition:"pop",duration:200}}})},code:M,maxWidth:340,centered:!0},H=`
import { TagsInput } from '@mantine/core';
...
`,U={type:"code",component:function(){return r.createElement(r.Fragment,null,r.createElement(l.B,{label:"Zero padding",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{dropdownPadding:0}}),r.createElement(l.B,{mt:"md",label:"10px padding",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{dropdownPadding:10}}))},code:H,maxWidth:340,centered:!0},G=`
import { TagsInput } from '@mantine/core';
...
`,$={type:"code",component:function(){return r.createElement(l.B,{label:"Your favorite library",placeholder:"Pick value or enter anything",data:["React","Angular","Vue","Svelte"],comboboxProps:{shadow:"md"}})},code:G,maxWidth:340,centered:!0};var q=n(94503),J=n(71078);let X=`
...
`,K={type:"code",component:function(){let e=r.createElement(q.Z,{style:{width:(0,J.h)(16),height:(0,J.h)(16)}});return r.createElement(r.Fragment,null,r.createElement(l.B,{data:["React","Angular","Vue"],leftSectionPointerEvents:"none",leftSection:e,label:"Your favorite library",placeholder:"Your favorite library"}),r.createElement(l.B,{mt:"md",data:["React","Angular","Vue"],rightSectionPointerEvents:"none",rightSection:e,label:"Your favorite library",placeholder:"Your favorite library"}))},maxWidth:340,centered:!0,code:X};var Q=n(77481);let ee=`
import { TagsInput } from '@mantine/core';
...
`,et={type:"configurator",component:function(e){return r.createElement(l.B,{...e,placeholder:"TagsInput placeholder",value:["First","Second"],data:["React","Angular","Vue","Svelte"]})},code:ee,centered:!0,maxWidth:340,controls:Q.pc},en=`
import { TagsInput } from '@mantine/core';
...
`,ea={type:"code",component:function(){return r.createElement(l.B,{label:"Read only",placeholder:"Enter tag",readOnly:!0,defaultValue:["First","Second"]})},code:en,maxWidth:340,centered:!0},eo=`
import { TagsInput } from '@mantine/core';
...
`,er={type:"code",component:function(){return r.createElement(l.B,{label:"Disabled",placeholder:"Enter tag",disabled:!0,defaultValue:["First","Second"]})},code:eo,maxWidth:340,centered:!0},el=`
import { TagsInput } from '@mantine/core';
...
`,ei={type:"code",component:function(){return r.createElement(r.Fragment,null,r.createElement(l.B,{label:"Boolean error",placeholder:"Boolean error",error:!0,defaultValue:["React","Angular"]}),r.createElement(l.B,{mt:"md",label:"With error message",placeholder:"With error message",error:"Invalid name",defaultValue:["React","Angular"]}))},maxWidth:340,centered:!0,code:el};var es=n(93693),ed=n(73811);let ec=`
