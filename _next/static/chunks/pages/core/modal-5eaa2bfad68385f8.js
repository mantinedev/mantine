...
`,D={type:"code",code:F,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,c.q)(!1),t=Array(100).fill(0).map((e,o)=>s.createElement("p",{key:o},"Modal with scroll"));return s.createElement(s.Fragment,null,s.createElement(a.u,{opened:e,onClose:n,title:"Header is sticky"},t),s.createElement(i.z,{onClick:o},"Open modal"))}};var T=n(40200);let S=`
import { useDisclosure } from '@mantine/hooks';
