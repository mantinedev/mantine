(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[71639],{25680:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/checkbox",function(){return n(89011)}])},89011:function(e,t,n){"use strict";n.r(t),n.d(t,{default:function(){return $}});var o=n(52322),a=n(45392),l=n(2784),c=n(56159);let r=`
...
`,C={type:"code",component:function(){return l.createElement(c.X,{defaultChecked:!0,color:"lime.4",iconColor:"dark.8",size:"md",label:"Bright lime checkbox"})},code:f,centered:!0};var v=n(78309),g=n(71873);let y=`
...
`,T={type:"code",component:function(){return l.createElement(c.X,{label:l.createElement(l.Fragment,null,"I accept"," ",l.createElement(g.e,{href:"https://mantine.dev",target:"_blank",inherit:!0},"terms and conditions"))})},code:y};var E=n(893);let j=`
...
`,z=(0,V.j)({components:{Checkbox:c.X.extend({classNames:{root:"m_4308addd",label:"m_1db1f159"}})}}),I={type:"code",centered:!0,component:function(){return l.createElement(D.M2,{theme:z},l.createElement(c.X,{size:"xxs",label:"Extra small checkbox"}),l.createElement(c.X,{size:"xxl",label:"Extra large checkbox",mt:"md"}))},code:[{fileName:"Demo.tsx",code:X,language:"tsx"},{fileName:"Demo.module.css",code:N,language:"scss"}]};var P=n(93010);let R=`
...
`,A={type:"styles-api",data:B.B,component:function(e){return l.createElement(c.X,{label:"Checkbox",description:"Checkbox description",error:"Checkbox error",defaultChecked:!0,...e})},code:M,centered:!0};var G=n(76204),O=n(63409),Text=n(8582);let W=`.root {
  position: relative;
}
...
`,F={type:"code",centered:!0,maxWidth:320,component:function(){let[e,t]=(0,l.useState)(!1);return l.createElement("div",{className:"m_2cb8989f"},l.createElement(c.X,{classNames:{root:"m_aa376f73",input:"m_dd220d00"},checked:e,onChange:e=>t(e.currentTarget.checked),tabIndex:-1,size:"md","aria-label":"Checkbox example"}),l.createElement(O.k,{className:"m_241ed880","data-checked":e||void 0,onClick:()=>t(e=>!e)},l.createElement(Text.x,{className:"m_69ff5ed7"},"@mantine/core"),l.createElement(Text.x,{className:"m_cf98ad9f"},"Core components library: inputs, buttons, overlays, etc.")))},defaultExpanded:!1,code:[{fileName:"Demo.tsx",language:"tsx",code:Y},{fileName:"Demo.module.css",language:"scss",code:W}]};var L={root:"m_43bfb50c"};let U=`
.root {
  border: 1px solid light-dark(var(--mantine-color-gray-3), var(--mantine-color-dark-4));
