...
`,w={type:"code",component:function(){return a.createElement(o.s,{readOnly:!0,defaultValue:"Angular",data:["React","Angular","Vue"]})},centered:!0,code:C};var S=t(31641);let V=`
import { SegmentedControl } from '@mantine/core';

function Demo() {
  return <SegmentedControl{{props}} data={['React', 'Angular', 'Vue']} />;
}
`,A={type:"styles-api",data:S.o,component:function(e){return a.createElement(o.s,{data:["React","Angular","Vue"],...e})},code:V,centered:!0};var k=t(1767);let D=`
