...
`,g={type:"code",component:function(){return o.createElement(l.Y,{label:"You can enter only 2 digits after decimal point",placeholder:"Do not enter more that 2",decimalScale:2})},code:v,centered:!0,maxWidth:340},N=`
import { NumberInput } from '@mantine/core';
...
`,I={type:"code",component:function(){return o.createElement(l.Y,{label:"Always show 2 digits after decimal point",placeholder:"Do not enter more that 2",decimalScale:2,fixedDecimalScale:!0,defaultValue:2.2})},code:N,centered:!0,maxWidth:340},j=`
import { NumberInput } from '@mantine/core';
...
`,w={type:"code",component:function(){return o.createElement(l.Y,{label:"Custom decimal separator",placeholder:"You can change it",decimalSeparator:",",defaultValue:20.573})},code:j,centered:!0,maxWidth:340},D=`
import { NumberInput } from '@mantine/core';
...
`,E={type:"code",component:function(){return o.createElement(l.Y,{label:"With thousands separator",placeholder:"Thousands are separated with coma",thousandSeparator:",",defaultValue:1e6})},code:D,centered:!0,maxWidth:340};var V=n(54764),S=(0,V.Z)("currency-dram","IconCurrencyDram",[["path",{d:"M4 10a6 6 0 1 1 12 0v10",key:"svg-0"}],["path",{d:"M12 16h8",key:"svg-1"}],["path",{d:"M12 12h8",key:"svg-2"}]]),C=n(71078);let W=`
...
`,k={type:"code",component:function(){let e=o.createElement(S,{style:{width:(0,C.h)(20),height:(0,C.h)(20)},stroke:1.5});return o.createElement(o.Fragment,null,o.createElement(l.Y,{leftSection:e,label:"With left section",placeholder:"With left section"}),o.createElement(l.Y,{rightSection:e,label:"With right section",placeholder:"With right section",mt:"md"}))},code:W,centered:!0,maxWidth:340};var Y=(0,V.Z)("chart-bubble","IconChartBubble",[["path",{d:"M6 16m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0",key:"svg-0"}],["path",{d:"M16 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0",key:"svg-1"}],["path",{d:"M14.5 7.5m-4.5 0a4.5 4.5 0 1 0 9 0a4.5 4.5 0 1 0 -9 0",key:"svg-2"}]]);let B=`
import { NumberInput } from '@mantine/core';
...
`,_={type:"code",component:function(){return o.createElement(o.Fragment,null,o.createElement(l.Y,{label:"Hide controls",placeholder:"Hide controls",hideControls:!0}),o.createElement(l.Y,{label:"Custom right section",placeholder:"Custom right section",mt:"md",rightSection:o.createElement(Y,null),rightSectionPointerEvents:"none"}))},code:B,centered:!0,maxWidth:340};var A=n(22971),z=n(8671);let M=`
...
`,R={type:"code",component:function(){let e=(0,o.useRef)(null);return o.createElement(o.Fragment,null,o.createElement(l.Y,{label:"Click buttons to change value",placeholder:"Click the buttons",handlersRef:e,step:2,min:10,max:20,defaultValue:15}),o.createElement(A.Z,{mt:"md",justify:"center"},o.createElement(z.z,{onClick:()=>e.current?.decrement(),variant:"default"},"Decrement by 2"),o.createElement(z.z,{onClick:()=>e.current?.increment(),variant:"default"},"Increment by 2")))},code:M,centered:!0,maxWidth:340},P=`
import { NumberInput } from '@mantine/core';
...
`,Z={type:"code",component:function(){return o.createElement(o.Fragment,null,o.createElement(l.Y,{label:"Boolean error",placeholder:"Boolean error",error:!0}),o.createElement(l.Y,{mt:"md",label:"With error message",placeholder:"With error message",error:"Invalid name"}))},maxWidth:340,centered:!0,code:P},F=`
import { NumberInput } from '@mantine/core';

function Demo() {
  return <NumberInput disabled label="Disabled input" placeholder="Disabled input" />;
}
`,L={type:"code",component:function(){return o.createElement(l.Y,{disabled:!0,label:"Disabled input",placeholder:"Disabled input"})},maxWidth:340,centered:!0,code:F};var T=n(93693),H=n(68170);let G=`
