(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[98588],{55305:function(e,o,n){"use strict";n.d(o,{Z:function(){return t}});var t=(0,n(99882).Z)("xbox-x","IconXboxX",[["path",{d:"M12 21a9 9 0 0 0 9 -9a9 9 0 0 0 -9 -9a9 9 0 0 0 -9 9a9 9 0 0 0 9 9z",key:"svg-0"}],["path",{d:"M9 8l6 8",key:"svg-1"}],["path",{d:"M15 8l-6 8",key:"svg-2"}]])},46042:function(e,o,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/modal",function(){return n(33263)}])},33263:function(e,o,n){"use strict";n.r(o),n.d(o,{default:function(){return L}});var t=n(52322),s=n(45392),l=n(63644),i=n(78222),r=n(17115),d=n(3900),c=n(3789);let a=`
...
`,u={type:"code",code:a,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,d.q)(!1);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(i.u,{opened:e,onClose:n,title:"Authentication",centered:!0,children:(0,t.jsx)(c._,{noPadding:!0,noShadow:!0})}),(0,t.jsx)(r.z,{onClick:o,children:"Open centered Modal"})]})}},h=`
import { useDisclosure } from '@mantine/hooks';
import { Modal, Button } from '@mantine/core';
...
`,p={type:"code",code:h,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,d.q)(!1);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(i.u,{opened:e,onClose:n,withCloseButton:!1,children:"Modal without header, press escape or click on overlay to close"}),(0,t.jsx)(r.z,{onClick:o,children:"Open Modal"})]})}};var m=n(2784),x=n(93010);let f=["xs","sm","md","lg","xl","55rem","70%","100%"],j={type:"code",component:function(){let[e,o]=(0,m.useState)(!1),[n,s]=(0,m.useState)("md"),l=f.map(e=>(0,t.jsx)(r.z,{onClick:()=>{s(e),o(!0)},children:e},e));return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(i.u,{opened:e,onClose:()=>o(!1),title:"Introduce yourself!",size:n,children:(0,t.jsx)(c._,{noPadding:!0,noShadow:!0})}),(0,t.jsx)(x.Z,{justify:"center",children:l})]})}};var M=n(32581),Text=n(8582),g=n(43647);let y=`
...
`,C={type:"code",component:function(){let[e,{close:o,open:n}]=(0,d.q)(!1),[s,{increment:l,decrement:c}]=(0,g.C)(3,{min:0}),a=Array(s).fill(0).map((e,o)=>(0,t.jsxs)(M.C,{children:["Badge ",o]},o));return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(i.u,{opened:e,onClose:o,size:"auto",title:"Modal size auto",children:[(0,t.jsx)(Text.x,{children:"Modal with size auto will fits its content"}),(0,t.jsx)(x.Z,{wrap:"nowrap",mt:"md",children:a}),(0,t.jsxs)(x.Z,{mt:"xl",children:[(0,t.jsx)(r.z,{onClick:l,children:"Add badge"}),(0,t.jsx)(r.z,{onClick:c,children:"Remove badge"})]})]}),(0,t.jsx)(r.z,{onClick:n,children:"Open modal"})]})},centered:!0,code:y},b=`
import { useDisclosure } from '@mantine/hooks';
import { Modal, Button } from '@mantine/core';
...
`,v={type:"code",code:b,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,d.q)(!1);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(i.u,{opened:e,onClose:n,title:"This is a fullscreen modal",fullScreen:!0,radius:0,transitionProps:{transition:"fade",duration:200},children:[(0,t.jsx)(Text.x,{mb:"xl",children:"It takes the entire screen and does not not have overlay and border-radius, you can use it small screens to save up some space. It also has fade transition by default, but you can change that with transition prop. Now here is an authentication form used in previous examples to see the difference."}),(0,t.jsx)(c._,{noPadding:!0,noShadow:!0})]}),(0,t.jsx)(r.z,{onClick:o,children:"Open Modal"})]})}};var w=n(58898),k=n(27780);let B=`
...
`,O={type:"code",code:B,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,d.q)(!1),s=(0,k.a)(`(max-width: ${(0,w.em)(800)})`);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(i.u,{opened:e,onClose:n,title:"This is a fullscreen modal",fullScreen:s,transitionProps:{transition:"fade",duration:200},children:"The Modal will be full screen only on mobile"}),(0,t.jsx)(r.z,{onClick:o,children:"Open Modal"})]})}},z=`
import { useDisclosure } from '@mantine/hooks';
import { Modal, Button } from '@mantine/core';
...
`,F={type:"code",code:z,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,d.q)(!1);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(i.u,{opened:e,onClose:n,title:"Authentication",overlayProps:{backgroundOpacity:.55,blur:3},children:(0,t.jsx)(c._,{noShadow:!0,noPadding:!0})}),(0,t.jsx)(r.z,{onClick:o,children:"Open modal"})]})}},D=`
import { useDisclosure } from '@mantine/hooks';
import { Modal, Button } from '@mantine/core';
...
`,T={type:"code",code:D,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,d.q)(!1),s=Array(100).fill(0).map((e,o)=>(0,t.jsx)("p",{children:"Modal with scroll"},o));return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(i.u,{opened:e,onClose:n,title:"Header is sticky",children:s}),(0,t.jsx)(r.z,{onClick:o,children:"Open modal"})]})}};var S=n(38405);let A=`
import { useDisclosure } from '@mantine/hooks';
...
`,I={type:"code",code:A,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,d.q)(!1),s=Array(100).fill(0).map((e,o)=>(0,t.jsx)("p",{children:"Modal with scroll"},o));return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(i.u,{opened:e,onClose:n,title:"Header is sticky",scrollAreaComponent:S.x.Autosize,children:s}),(0,t.jsx)(r.z,{onClick:o,children:"Open modal"})]})}},P=`
import { useDisclosure } from '@mantine/hooks';
import { Modal, Button } from '@mantine/core';
...
`,_={type:"code",code:P,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,d.q)(!1);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(i.u,{opened:e,onClose:n,title:"Authentication",yOffset:"1vh",xOffset:0,children:(0,t.jsx)(c._,{noPadding:!0,noShadow:!0})}),(0,t.jsx)(r.z,{onClick:o,children:"Open modal"})]})}},N=`
...
`,R={type:"code",code:N,component:function(){let[e,o]=(0,m.useState)(!1),[n,s]=(0,m.useState)(!1);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(i.u,{opened:n,onClose:()=>s(!1),title:"Please consider this",transitionProps:{transition:"rotate-left"},children:"rotate-left transition"}),(0,t.jsx)(i.u,{opened:e,onClose:()=>o(!1),title:"Please consider this",transitionProps:{transition:"fade",duration:600,timingFunction:"linear"},children:"fade transition 600ms linear transition"}),(0,t.jsxs)(x.Z,{justify:"center",children:[(0,t.jsx)(r.z,{onClick:()=>s(!0),variant:"default",children:"Rotate left transition"}),(0,t.jsx)(r.z,{onClick:()=>o(!0),variant:"default",children:"Fade transition"})]})]})}};var q=n(74770);let H=`
import { useDisclosure } from '@mantine/hooks';
...
`,E={type:"code",code:H,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,d.q)(!1);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsxs)(i.u,{opened:e,onClose:n,title:"Focus demo",children:[(0,t.jsx)(q.o,{label:"First input",placeholder:"First input"}),(0,t.jsx)(q.o,{"data-autofocus":!0,label:"Input with initial focus",placeholder:"It has data-autofocus attribute",mt:"md"})]}),(0,t.jsx)(r.z,{onClick:o,children:"Open modal"})]})}};var Z=n(35221),G=n(55305);let X=`
...
`,U={type:"code",code:X,centered:!0,component:function(){let[e,{open:o,close:n}]=(0,d.q)(!1);return(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)(i.u,{opened:e,onClose:n,title:"Authentication",closeButtonProps:{icon:(0,t.jsx)(G.Z,{size:20,stroke:1.5})},children:(0,t.jsx)(c._,{noShadow:!0,noPadding:!0})}),(0,t.jsx)(r.z,{onClick:o,children:"Open modal"})]})}},K=`
import { useDisclosure } from '@mantine/hooks';
import { Modal, Button } from '@mantine/core';
