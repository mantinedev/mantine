(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[9354],{600:function(e,t,n){(window.__NEXT_P=window.__NEXT_P||[]).push(["/core/input",function(){return n(30350)}])},30350:function(e,t,n){"use strict";n.r(t),n.d(t,{default:function(){return ea}});var r=n(24246),o=n(71670),l=n(27378),i=n(42487),a=n(77481);let p=`
import { Input } from '@mantine/core';

function Demo() {
  return <Input{{props}} placeholder="Input component" />;
}
`,c={type:"configurator",component:function(e){return l.createElement(i.I,{placeholder:"Input component",...e})},code:p,centered:!0,maxWidth:340,controls:a.Mt};var s=n(93693),u=n(96217);let d=`
...
`,m={type:"code",component:function(){let[e,t]=(0,l.useState)("Clear me");return l.createElement(l.Fragment,null,l.createElement(i.I,{placeholder:"Your email",leftSection:l.createElement(s.Z,{size:16})}),l.createElement(i.I,{placeholder:"Clearable input",value:e,onChange:e=>t(e.currentTarget.value),rightSectionPointerEvents:"all",mt:"md",rightSection:l.createElement(u.P,{"aria-label":"Clear input",onClick:()=>t(""),style:{display:e?void 0:"none"}})}))},maxWidth:340,centered:!0,code:d};var h=n(62283);let x=`
import { Input } from '@mantine/core';
...
`,I={type:"code",component:function(){return l.createElement(l.Fragment,null,l.createElement(i.I,{component:"button",pointer:!0},"Button input"),l.createElement(i.I,{component:"select",rightSection:l.createElement(h.Z,{size:14,stroke:1.5}),pointer:!0,mt:"md"},l.createElement("option",{value:"1"},"1"),l.createElement("option",{value:"2"},"2")))},code:x};var f=n(62229);let b=`
import { Input } from '@mantine/core';
...
`,j={type:"code",component:function(){return l.createElement(i.I,{component:f.oc,mask:"+7 (000) 000-00-00",placeholder:"Your phone"})},maxWidth:340,centered:!0,code:b},y=`
import { Input } from '@mantine/core';
...
`,g={type:"configurator",component:function(e){return l.createElement(i.I.Wrapper,{...e},l.createElement(i.I,{placeholder:"Input inside Input.Wrapper"}))},code:y,centered:!0,maxWidth:440,controls:a.nW};var v=n(7033);let E=`
...
`,w={type:"code",component:function(){return l.createElement(l.Fragment,null,l.createElement(v.o,{label:"Custom layout",placeholder:"Custom layout",description:"Description below the input",inputWrapperOrder:["label","error","input","description"]}),l.createElement(v.o,{mt:"md",label:"Custom layout",placeholder:"Custom layout",description:"Error and description are",error:"both below the input",inputWrapperOrder:["label","input","description","error"]}))},maxWidth:340,centered:!0,code:E};var W=n(99684);let T=`
import { useState } from 'react';
...
`,S={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,l.useState)(!1);return l.createElement(v.o,{label:"TextInput with tooltip",description:"Tooltip will be relative to the input",placeholder:"Focus me to see tooltip",onFocus:()=>t(!0),onBlur:()=>t(!1),inputContainer:t=>l.createElement(W.u,{label:"Additional information",position:"top-start",opened:e},t)})},code:T};var k=n(62144);let D=`
import { Input } from '@mantine/core';
...
`,N={type:"code",component:function(){return l.createElement(l.Fragment,null,l.createElement(i.I.Label,{required:!0},"Input label"),l.createElement(i.I.Description,null,"Input description"),l.createElement(i.I.Error,null,"Input error"))},code:D},V=`
import { Input } from '@mantine/core';
...
`,C={type:"code",component:function(){return l.createElement(i.I,{component:"button",pointer:!0},l.createElement(i.I.Placeholder,null,"Placeholder content"))},maxWidth:340,centered:!0,code:V};var A=n(74369),P=n(2256),F=n(28764);let M=`
...
`,Y=(0,A.j)({components:{Input:i.I.extend({defaultProps:{variant:"filled"}}),InputWrapper:i.I.Wrapper.extend({defaultProps:{inputWrapperOrder:["label","input","description","error"]}})}}),q={type:"code",component:function(){return l.createElement(P.M2,{theme:Y},l.createElement(v.o,{label:"Text input",placeholder:"Text input",description:"Description below the input"}),l.createElement(F.p,{mt:"md",label:"Native select",placeholder:"Native select",data:["React","Angular","Vue","Svelte"],description:"Description below the input"}))},centered:!0,maxWidth:340,code:M};var z={label:"m-8ccacaf5",input:"m-8ca6a3cb"};let B=`
...
`,_=(0,A.j)({components:{Input:i.I.extend({classNames:{input:z.input}}),InputWrapper:i.I.Wrapper.extend({classNames:{label:z.label}})}}),O={type:"code",component:function(){return l.createElement(P.M2,{theme:_},l.createElement(v.o,{label:"Text input",placeholder:"Text input"}),l.createElement(F.p,{mt:"md",label:"Native select",placeholder:"Native select",data:["React","Angular","Vue","Svelte"]}))},centered:!0,maxWidth:340,code:[{fileName:"Demo.tsx",code:B,language:"tsx"},{fileName:"Demo.module.css",code:R,language:"scss"}]};var L={input:"m-4ba3a790"};let U=`
...
`,X={type:"code",component:function(){return l.createElement(l.Fragment,null,l.createElement(i.I,{placeholder:"Regular Input component",classNames:L}),l.createElement(v.o,{placeholder:"TextInput component",label:"TextInput component",mt:"md",classNames:L}))},maxWidth:340,centered:!0,code:[{fileName:"Demo.module.css",code:Z,language:"scss"},{fileName:"Demo.tsx",code:U,language:"tsx"}]};var G=n(23163);let H=`
...
`,J={type:"code",component:function(){return l.createElement(l.Fragment,null,l.createElement(G.M,{label:"Your phone",component:f.oc,mask:"+7 (000) 000-0000",placeholder:"Your phone"}),l.createElement(G.M,{label:"Custom native select",component:"select",mt:"md"},l.createElement("option",{value:"react"},"React"),l.createElement("option",{value:"react"},"Angular"),l.createElement("option",{value:"svelte"},"Svelte")))},maxWidth:340,centered:!0,code:H};var K=n(71078),Q=n(50352);let $=`
