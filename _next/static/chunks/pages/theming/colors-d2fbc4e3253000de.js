...
`,C=e=>{let r=(0,t.B)(e),o=(0,l.E)({color:e.color||e.theme.primaryColor,theme:e.theme});return o.isThemeColor&&"lime"===o.color&&"filled"===e.variant?b(j({},r),{color:"var(--mantine-color-black)",hoverColor:"var(--mantine-color-white)"}):"light"===e.variant?{background:(0,a.m)(o.value,.1),hover:(0,a.m)(o.value,.15),border:`${(0,c.h)(1)} solid ${o.value}`,color:(0,i._)(o.value,.1)}:"danger"===e.variant?{background:"var(--mantine-color-red-9)",hover:"var(--mantine-color-red-8)",color:"var(--mantine-color-white)",border:"none"}:r},w={type:"code",component:function(){return n.createElement(s.M2,{theme:{variantColorResolver:C}},n.createElement(d.Z,null,n.createElement(h.z,{color:"lime.4",variant:"filled"},"Lime filled button"),n.createElement(h.z,{color:"orange",variant:"light"},"Orange light button"),n.createElement(h.z,{variant:"danger"},"Danger button")))},centered:!0,code:y}}},function(e){e.O(0,[8992,178,9774,2888,179],function(){return e(e.s=94171)}),_N_E=e.O()}]);