(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[9709],{75269:(e,n,t)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/theming/default-props",function(){return t(97342)}])},97342:(e,n,t)=>{"use strict";t.r(n),t.d(n,{default:()=>P});var o=t(31085),r=t(71184),s=t(12616),a=t(52022),p=t(92408),i=t(56051);let d=`
...
`,c=(0,s.a)({components:{Button:a.$.extend({defaultProps:{color:"cyan",variant:"outline"}})}}),l={type:"code",component:function(){return(0,o.jsx)(p.nW,{theme:c,children:(0,o.jsxs)(i.Y,{children:[(0,o.jsx)(a.$,{children:"Default button"}),(0,o.jsx)(a.$,{color:"red",variant:"filled",children:"Button with props"})]})})},centered:!0,code:d};var h=t(29686);let u=`
