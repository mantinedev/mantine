...
`,p={type:"code",component:function(){return a.createElement(h.M2,{inherit:!0,theme:{focusClassName:"m_f1cdba19"}},a.createElement(d.z,null,"Click button to see custom focus ring"))},centered:!0,code:[{fileName:"Demo.tsx",language:"tsx",code:m},{fileName:"focus.module.css",language:"scss",code:f}]},x=`
import { MantineProvider, Button } from '@mantine/core';
...
`,g={type:"code",component:function(){return a.createElement(h.M2,{theme:{activeClassName:"m_32801db9"}},a.createElement(d.z,null,"Press me to see active styles"))},centered:!0,code:[{fileName:"Demo.tsx",language:"tsx",code:x},{fileName:"active.module.css",language:"scss",code:j}]},b=`
import { MantineProvider, Button } from '@mantine/core';
...
`,controls:[{type:"size",prop:"defaultRadius",initialValue:"sm",libraryValue:"__none__"}]};var T=t(17757),C=t(60231);let M=`
