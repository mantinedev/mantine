...
`};var s=r(29351),a=r(92997);let d={type:"code",component:function(){return(0,n.jsxs)(l.Y,{children:[(0,n.jsx)(c.$,{color:"bright-pink",children:"Primary button"}),(0,n.jsx)(c.$,{color:"blue",children:"Blue button"})]})},centered:!0,code:`
import { Group, Button, MantineProvider, createTheme } from '@mantine/core';
...
`,centered:!0,controls:[{type:"number",prop:"primaryShade",initialValue:6,libraryValue:"__none__",min:0,max:9}]};var x=r(88416),j=r(93065);let f={type:"configurator",component:function(e){return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(j.E,{c:`blue.${e.index}`,children:["Text with blue.",e.index," color"]}),(0,n.jsx)(c.$,{color:`cyan.${e.index}`,mt:"sm",children:"Button"})]})},code:e=>`
...
`,controls:[{type:"number",prop:"index",initialValue:6,libraryValue:"__none__",min:0,max:9}]},v={type:"code",component:function(){return(0,n.jsx)(c.$,{color:"#C3FF36",c:"black",children:"Button with color and c props"})},centered:!0,code:`
...
`,centered:!0}},40975:(e,o,r)=>{"use strict";r.d(o,{_:()=>u});var n=r(31085),t=r(26762),l=r(81754),c=r(16560),i=r(69842),s=r(92408),a=r(56051),d=r(52022);let h=e=>{let o=(0,t.v)(e),r=(0,l.g)({color:e.color||e.theme.primaryColor,theme:e.theme});return r.isThemeColor&&"lime"===r.color&&"filled"===e.variant?{...o,color:"var(--mantine-color-black)",hoverColor:"var(--mantine-color-black)"}:"light"===e.variant?{background:(0,c.B)(r.value,.1),hover:(0,c.B)(r.value,.15),border:`1px solid ${r.value}`,color:(0,i.e)(r.value,.1)}:"danger"===e.variant?{background:"var(--mantine-color-red-9)",hover:"var(--mantine-color-red-8)",color:"var(--mantine-color-white)",border:"none"}:o},u={type:"code",component:function(){return(0,n.jsx)(s.nW,{theme:{variantColorResolver:h},children:(0,n.jsxs)(a.Y,{children:[(0,n.jsx)(d.$,{color:"lime.4",variant:"filled",children:"Lime filled button"}),(0,n.jsx)(d.$,{color:"orange",variant:"light",children:"Orange light button"}),(0,n.jsx)(d.$,{variant:"danger",children:"Danger button"})]})})},centered:!0,code:`
import {
  Button,
  Group,
  MantineProvider,
...
`,language:"tsx"}]}}},e=>{var o=o=>e(e.s=o);e.O(0,[67456,39699,68831,90636,46593,38792],()=>o(93143)),_N_E=e.O()}]);