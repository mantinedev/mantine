(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[8989],{72708:function(e,o,r){(window.__NEXT_P=window.__NEXT_P||[]).push(["/theming/colors",function(){return r(3e3)}])},3e3:function(e,o,r){"use strict";r.r(o),r.d(o,{default:function(){return B}});var n=r(24246),t=r(71670),l=r(27378),c=r(22971),a=r(8671);let i=`
...
`,s={type:"code",component:function(){return l.createElement(c.Z,null,l.createElement(a.z,{color:"ocean-blue"},"Ocean blue button"),l.createElement(a.z,{color:"bright-pink",variant:"filled"},"Bright pink button"))},centered:!0,code:i},d=`
import { Group, Button, MantineProvider } from '@mantine/core';
...
`,u={type:"code",component:function(){return l.createElement(c.Z,null,l.createElement(a.z,{color:"bright-pink"},"Primary button"),l.createElement(a.z,{color:"blue"},"Blue button"))},centered:!0,code:d};var h=r(27650),m=r(50221);let p={type:"configurator",component:function(e){let[o,r]=(0,l.useState)(void 0),{colorScheme:n}=(0,h.X)();return(0,l.useEffect)(()=>{r(n)},[n]),l.createElement("div",{id:"primary-color-demo-root","data-mantine-color-scheme":o},l.createElement(m.M,{cssVariablesSelector:"#primary-color-demo-root",getRootElement:()=>document.createElement("div"),theme:{primaryShade:e.primaryShade}},l.createElement(c.Z,null,l.createElement(a.z,null,"Filled"),l.createElement(a.z,{variant:"light"},"Light"),l.createElement(a.z,{variant:"outline"},"Outline"))))},code:e=>`
...
`,centered:!0,controls:[{type:"number",prop:"primaryShade",initialValue:6,libraryValue:"__none__",min:0,max:9}]};var x=r(70774),Text=r(26569);let j={type:"configurator",component:function(e){return l.createElement(l.Fragment,null,l.createElement(Text.x,{c:`blue.${e.index}`},"Text with blue.",e.index," color"),l.createElement(a.z,{color:`cyan.${e.index}`,mt:"sm"},"Button"))},code:e=>`
...
`,controls:[{type:"number",prop:"index",initialValue:6,libraryValue:"__none__",min:0,max:9}]},f=`
...
`,m=e=>{let o=(0,t.B)(e),r=(0,l.E)({color:e.color||e.theme.primaryColor,theme:e.theme});return r.isThemeColor&&"lime"===r.color&&"filled"===e.variant?{...o,color:"var(--mantine-color-black)",hoverColor:"var(--mantine-color-black)"}:"light"===e.variant?{background:(0,c.m)(r.value,.1),hover:(0,c.m)(r.value,.15),border:`${(0,a.h)(1)} solid ${r.value}`,color:(0,i._)(r.value,.1)}:"danger"===e.variant?{background:"var(--mantine-color-red-9)",hover:"var(--mantine-color-red-8)",color:"var(--mantine-color-white)",border:"none"}:o},p={type:"code",component:function(){return n.createElement(s.M2,{theme:{variantColorResolver:m}},n.createElement(d.Z,null,n.createElement(u.z,{color:"lime.4",variant:"filled"},"Lime filled button"),n.createElement(u.z,{color:"orange",variant:"light"},"Orange light button"),n.createElement(u.z,{variant:"danger"},"Danger button")))},centered:!0,code:h}}},function(e){e.O(0,[370,5819,2775,9774,2888,179],function(){return e(e.s=72708)}),_N_E=e.O()}]);