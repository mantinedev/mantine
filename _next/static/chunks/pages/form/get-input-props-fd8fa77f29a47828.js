...
`,centered:!0,maxWidth:340}},43084:function(e,n,t){"use strict";t.d(n,{w:function(){return a}});var o=t(52322),r=t(2784),s=t(74770),i=t(42697),c=t(405);let a={type:"code",component:function(){let e=(0,c.c)({mode:"uncontrolled",initialValues:{name:"",age:""},enhanceGetInputProps:e=>"name"===e.options.fieldType?{label:"Your name",placeholder:"Your name",withAsterisk:!0,description:"Your personal information is stored securely. (Just kidding!)"}:{}});return(0,o.jsxs)(o.Fragment,{children:[(0,r.createElement)(s.o,{...e.getInputProps("name",{fieldType:"name"}),key:e.key("name")}),(0,r.createElement)(i.Y,{...e.getInputProps("age"),key:e.key("age"),label:"Age",placeholder:"Age",mt:"md"})]})},code:`
import { NumberInput, TextInput } from '@mantine/core';
import { useForm } from '@mantine/form';
...
`,centered:!0,maxWidth:340}}},function(e){e.O(0,[61177,9462,66748,11340,405,74736,92888,49774,40179],function(){return e(e.s=26941)}),_N_E=e.O()}]);