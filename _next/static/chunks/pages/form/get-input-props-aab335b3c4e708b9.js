...
`,l={type:"code",component:function(){let e=(0,c.c)({mode:"uncontrolled",initialValues:{name:"",age:""},enhanceGetInputProps:e=>({disabled:"name"===e.field})});return(0,o.jsxs)(o.Fragment,{children:[(0,r.createElement)(s.o,{...e.getInputProps("name"),key:e.key("name"),label:"Name",placeholder:"Name"}),(0,r.createElement)(i.Y,{...e.getInputProps("age"),key:e.key("age"),label:"Age",placeholder:"Age",mt:"md"})]})},code:a,centered:!0,maxWidth:340}},43084:function(e,n,t){"use strict";t.d(n,{w:function(){return l}});var o=t(52322),r=t(2784),s=t(74770),i=t(42697),c=t(79510);let a=`
import { NumberInput, TextInput } from '@mantine/core';
import { useForm } from '@mantine/form';
...
`,l={type:"code",component:function(){let e=(0,c.c)({mode:"uncontrolled",initialValues:{name:"",age:""},enhanceGetInputProps:e=>"name"===e.options.fieldType?{label:"Your name",placeholder:"Your name",withAsterisk:!0,description:"Your personal information is stored securely. (Just kidding!)"}:{}});return(0,o.jsxs)(o.Fragment,{children:[(0,r.createElement)(s.o,{...e.getInputProps("name",{fieldType:"name"}),key:e.key("name")}),(0,r.createElement)(i.Y,{...e.getInputProps("age"),key:e.key("age"),label:"Age",placeholder:"Age",mt:"md"})]})},code:a,centered:!0,maxWidth:340}}},function(e){e.O(0,[57938,9462,17454,47747,79510,74736,49774,92888,40179],function(){return e(e.s=26941)}),_N_E=e.O()}]);