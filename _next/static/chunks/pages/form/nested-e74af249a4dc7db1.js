...
`,u={type:"code",component:function(){let e=(0,c.c)({mode:"uncontrolled",initialValues:{terms:!1,user:{firstName:"",lastName:""}}});return s.createElement(a.x,{maw:340,mx:"auto"},s.createElement(i.o,{label:"First name",placeholder:"First name",key:e.key("user.firstName"),...e.getInputProps("user.firstName")}),s.createElement(i.o,{label:"Last name",placeholder:"Last name",mt:"md",key:e.key("user.lastName"),...e.getInputProps("user.lastName")}),s.createElement(l.X,{label:"I accepts terms & conditions",mt:"sm",key:e.key("terms"),...e.getInputProps("terms",{type:"checkbox"})}))},code:m};var d=n(64278),p=n(93010),f=n(950),h=n(54813),Text=n(8582),y=n(17115),x=n(73533);let g=`
import { useForm } from '@mantine/form';
