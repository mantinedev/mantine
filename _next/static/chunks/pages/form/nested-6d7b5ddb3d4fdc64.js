...
`};var m=n(47813),u=n(93010),d=n(950),p=n(15981),f=n(8582),h=n(39629),x=n(73533);let y={type:"code",component:function(){let e=(0,l.c)({mode:"uncontrolled",initialValues:{employees:[{name:"",active:!1,key:(0,x.k)()}]}}),t=e.getValues().employees.map((t,n)=>(0,r.jsxs)(u.Z,{mt:"xs",children:[(0,r.jsx)(i.o,{placeholder:"John Doe",withAsterisk:!0,style:{flex:1},...e.getInputProps(`employees.${n}.name`)},e.key(`employees.${n}.name`)),(0,r.jsx)(d.r,{label:"Active",...e.getInputProps(`employees.${n}.active`,{type:"checkbox"})},e.key(`employees.${n}.active`)),(0,r.jsx)(p.A,{color:"red",onClick:()=>e.removeListItem("employees",n),children:(0,r.jsx)(m.Z,{size:16})})]},t.key));return(0,r.jsxs)(s.x,{maw:500,mx:"auto",children:[t.length>0?(0,r.jsxs)(u.Z,{mb:"xs",children:[(0,r.jsx)(f.x,{fw:500,size:"sm",style:{flex:1},children:"Name"}),(0,r.jsx)(f.x,{fw:500,size:"sm",pr:90,children:"Status"})]}):(0,r.jsx)(f.x,{c:"dimmed",ta:"center",children:"No one here..."}),t,(0,r.jsx)(u.Z,{justify:"center",mt:"md",children:(0,r.jsx)(h.z,{onClick:()=>e.insertListItem("employees",{name:"",active:!1,key:(0,x.k)()}),children:"Add employee"})})]})},code:`
import { useForm } from '@mantine/form';
