...
`,eG={type:"code",component:function(){let e=(0,m.c)({clearInputErrorOnChange:!1,initialValues:{email:"",termsOfService:!1},validate:{email:e=>/^\S+@\S+$/.test(e)?null:"Invalid email"}});return i.createElement(s.x,{maw:340,mx:"auto"},i.createElement("form",{onSubmit:e.onSubmit(e=>console.log(e))},i.createElement(u.o,eR({withAsterisk:!0,label:"Email",placeholder:"your@email.com"},e.getInputProps("email"))),i.createElement(eV.X,eR({mt:"md",label:"I agree to sell my privacy"},e.getInputProps("termsOfService",{type:"checkbox"}))),i.createElement(I.Z,{justify:"flex-end",mt:"md"},i.createElement(p.z,{type:"submit"},"Submit"))))},code:eM};var e$=o(57041),eZ=Object.defineProperty,eX=Object.getOwnPropertySymbols,eL=Object.prototype.hasOwnProperty,eW=Object.prototype.propertyIsEnumerable,eq=(e,t,o)=>t in e?eZ(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,eK=(e,t)=>{for(var o in t||(t={}))eL.call(t,o)&&eq(e,o,t[o]);if(eX)for(var o of eX(t))eW.call(t,o)&&eq(e,o,t[o]);return e};let eU=`
import { useForm } from '@mantine/form';
