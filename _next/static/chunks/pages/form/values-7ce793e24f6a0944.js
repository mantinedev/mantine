...
`,v={type:"code",component:function(){let e=(0,u.c)({initialValues:{name:"",email:""}});return o.createElement(l.x,{maw:340,mx:"auto"},o.createElement(i.o,{label:"Name",placeholder:"Name",...e.getInputProps("name")}),o.createElement(i.o,{mt:"md",label:"Email",placeholder:"Email",...e.getInputProps("email")}),o.createElement(s.Z,{justify:"center",mt:"xl"},o.createElement(m.z,{onClick:()=>e.reset()},"Reset to initial values")))},code:x};var y=n(45909);let j=`
