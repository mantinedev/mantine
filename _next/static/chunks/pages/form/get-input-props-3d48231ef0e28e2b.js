...
`,c={type:"code",component:function(){let e=(0,i.c)({mode:"uncontrolled",initialValues:{name:"",age:""},enhanceGetInputProps:e=>({disabled:"name"===e.field})});return o.createElement(o.Fragment,null,o.createElement(r.o,{...e.getInputProps("name"),key:e.key("name"),label:"Name",placeholder:"Name"}),o.createElement(s.Y,{...e.getInputProps("age"),key:e.key("age"),label:"Age",placeholder:"Age",mt:"md"}))},code:a,centered:!0,maxWidth:340}},43084:function(e,n,t){"use strict";t.d(n,{w:function(){return c}});var o=t(2784),r=t(74770),s=t(42697),i=t(59259);let a=`
import { NumberInput, TextInput } from '@mantine/core';
import { useForm } from '@mantine/form';
...
`,c={type:"code",component:function(){let e=(0,i.c)({mode:"uncontrolled",initialValues:{name:"",age:""},enhanceGetInputProps:e=>"name"===e.options.fieldType?{label:"Your name",placeholder:"Your name",withAsterisk:!0,description:"Your personal information is stored securely. (Just kidding!)"}:{}});return o.createElement(o.Fragment,null,o.createElement(r.o,{...e.getInputProps("name",{fieldType:"name"}),key:e.key("name")}),o.createElement(s.Y,{...e.getInputProps("age"),key:e.key("age"),label:"Age",placeholder:"Age",mt:"md"}))},code:a,centered:!0,maxWidth:340}}},function(e){e.O(0,[57938,9462,17454,47747,59259,74736,49774,92888,40179],function(){return e(e.s=26941)}),_N_E=e.O()}]);