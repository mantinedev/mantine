...
`,c={type:"code",component:function(){let e=(0,i.c)({initialValues:{name:"",age:0},validate:{name:(0,s.U)("Name is required"),age:(0,m.m)({min:18},"You must be at least 18 to register")}});return r.createElement(r.Fragment,null,r.createElement(a.o,{...e.getInputProps("name"),label:"Name",placeholder:"Name"}),r.createElement(o.Y,{...e.getInputProps("age"),label:"Age",placeholder:"Age",mt:"md"}),r.createElement(l.z,{onClick:()=>new Promise(e=>{setTimeout(()=>{e({name:"John Doe",age:25})},1e3)}).then(t=>e.initialize(t)),mt:"md"},"Initialize form"))},code:u,centered:!0,maxWidth:340}},42697:function(e,t,n){"use strict";n.d(t,{Y:function(){return w}});var r=n(2784),a=n(40489),o=n(9462),l=n(9341),i=n(82692),s=n(70837),m=n(91482),u=n(11200),c=n(51477),d=n(62378),f=n(38483),p=n(82027),h=n(73063),g=n(63409);function x({direction:e,style:t,...n}){return r.createElement("svg",{style:{width:"var(--ni-chevron-size)",height:"var(--ni-chevron-size)",transform:"up"===e?"rotate(180deg)":void 0,...t},viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n},r.createElement("path",{d:"M3.13523 6.15803C3.3241 5.95657 3.64052 5.94637 3.84197 6.13523L7.5 9.56464L11.158 6.13523C11.3595 5.94637 11.6759 5.95657 11.8648 6.15803C12.0536 6.35949 12.0434 6.67591 11.842 6.86477L7.84197 10.6148C7.64964 10.7951 7.35036 10.7951 7.15803 10.6148L3.15803 6.86477C2.95657 6.67591 2.94637 6.35949 3.13523 6.15803Z",fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd"}))}var b={root:"m_e2f5cd4e",controls:"m_95e17d22",control:"m_80b4b171"};let v=/^-0(\.0*)?$/,y=/^-?0\d+$/;function j(e,t,n){return void 0===e||(void 0===t||e>=t)&&(void 0===n||e<=n)}let N={step:1,clampBehavior:"blur",allowDecimal:!0,allowNegative:!0,startValue:0},I=(0,u.Z)((e,{size:t})=>({controls:{"--ni-chevron-size":(0,m.ap)(t,"ni-chevron-size")}})),w=(0,p.d)((e,t)=>{let n=(0,f.w)("NumberInput",N,e),{className:m,classNames:u,styles:p,unstyled:w,vars:V,onChange:E,onValueChange:F,value:P,defaultValue:S,max:k,min:D,step:T,hideControls:B,rightSection:z,isAllowed:A,clampBehavior:O,onBlur:_,allowDecimal:C,decimalScale:R,onKeyDown:G,handlersRef:M,startValue:q,disabled:J,rightSectionPointerEvents:$,allowNegative:Y,readOnly:L,size:U,rightSectionWidth:W,stepHoldInterval:Z,stepHoldDelay:Q,allowLeadingZeros:X,...K}=n,H=(0,d.y)({name:"NumberInput",classes:b,props:n,classNames:u,styles:p,unstyled:w,vars:V,varsResolver:I}),{resolvedClassNames:ee,resolvedStyles:et}=(0,c.h)({classNames:u,styles:p,props:n}),[en,er]=(0,l.C)({value:P,defaultValue:S,onChange:E}),ea=void 0!==Q&&void 0!==Z,eo=(0,r.useRef)(null),el=(0,r.useRef)(null),ei=(0,r.useRef)(0),es=e=>{let t=String(e).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);return t?Math.max(0,(t[1]?t[1].length:0)-(t[2]?+t[2]:0)):0},em=(0,r.useRef)();em.current=()=>{let e;let t=es(en),n=es(T),r=Math.max(t,n),a=10**r;if("number"!=typeof en||Number.isNaN(en))e=(0,i.u)(q,D,k);else if(void 0!==k){let t=(Math.round(en*a)+Math.round(T*a))/a;e=t<=k?t:k}else e=(Math.round(en*a)+Math.round(T*a))/a;let o=e.toFixed(r);er(parseFloat(o)),F?.({floatValue:parseFloat(o),formattedValue:o,value:o},{source:"increment"})};let eu=(0,r.useRef)();eu.current=()=>{let e;let t=es(en),n=es(T),r=Math.max(t,n),a=10**r;if("number"!=typeof en||Number.isNaN(en))e=(0,i.u)(q,D,k);else{let t=(Math.round(en*a)-Math.round(T*a))/a;e=void 0!==D&&t<D?D:t}let o=e.toFixed(r);er(parseFloat(o)),F?.({floatValue:parseFloat(o),formattedValue:o,value:o},{source:"decrement"})},(0,s.kR)(M,{increment:em.current,decrement:eu.current});let ec=e=>{e?em.current():eu.current(),ei.current+=1},ed=e=>{if(ec(e),ea){let t="number"==typeof Z?Z:Z(ei.current);el.current=window.setTimeout(()=>ed(e),t)}},ef=(e,t)=>{e.preventDefault(),eo.current?.focus(),ec(t),ea&&(el.current=window.setTimeout(()=>ed(t),Q))},ep=()=>{el.current&&window.clearTimeout(el.current),el.current=null,ei.current=0},eh=r.createElement("div",{...H("controls")},r.createElement(g.k,{...H("control"),tabIndex:-1,"aria-hidden":!0,disabled:J||"number"==typeof en&&void 0!==k&&en>=k,mod:{direction:"up"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{ef(e,!0)},onPointerUp:ep,onPointerLeave:ep},r.createElement(x,{direction:"up"})),r.createElement(g.k,{...H("control"),tabIndex:-1,"aria-hidden":!0,disabled:J||"number"==typeof en&&void 0!==D&&en<=D,mod:{direction:"down"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{ef(e,!1)},onPointerUp:ep,onPointerLeave:ep},r.createElement(x,{direction:"down"})));return r.createElement(h.M,{component:o.h3,allowNegative:Y,className:(0,a.Z)(b.root,m),size:U,...K,readOnly:L,disabled:J,value:en,getInputRef:(0,s.Yx)(t,eo),onValueChange:(e,t)=>{if("event"===t.source){var n;er(!(("number"==typeof(n=e.floatValue)?n<Number.MAX_SAFE_INTEGER:!Number.isNaN(Number(n)))&&!Number.isNaN(n))||v.test(e.value)||X&&y.test(e.value)?e.value:e.floatValue)}F?.(e,t)},rightSection:B||L?z:z||eh,classNames:ee,styles:et,unstyled:w,__staticSelector:"NumberInput",decimalScale:C?R:0,onKeyDown:e=>{G?.(e),L||("ArrowUp"===e.key&&(e.preventDefault(),em.current()),"ArrowDown"===e.key&&(e.preventDefault(),eu.current()))},rightSectionPointerEvents:$??(J?"none":void 0),rightSectionWidth:W??`var(--ni-right-section-width-${U||"sm"})`,allowLeadingZeros:X,onBlur:e=>{if(_?.(e),"blur"===O&&"number"==typeof en){let e=(0,i.u)(en,D,k);e!==en&&er((0,i.u)(en,D,k))}},isAllowed:e=>"strict"===O?A?A(e)&&j(e.floatValue,D,k):j(e.floatValue,D,k):!A||A(e)})});w.classes={...h.M.classes,...b},w.displayName="@mantine/core/NumberInput"},73846:function(e,t,n){"use strict";function r({min:e,max:t},n){let r=n||!0;return n=>{if("number"!=typeof n)return r;let a=!0;return"number"==typeof e&&n<e&&(a=!1),"number"==typeof t&&n>t&&(a=!1),a?null:r}}n.d(t,{m:function(){return r}})},3095:function(e,t,n){"use strict";function r(e){let t=e||!0;return e=>"string"==typeof e?e.trim().length>0?null:t:Array.isArray(e)?e.length>0?null:t:null==e||!1===e?t:null}n.d(t,{U:function(){return r}})}},function(e){e.O(0,[57938,9462,17454,47747,88320,49774,92888,40179],function(){return e(e.s=11086)}),_N_E=e.O()}]);