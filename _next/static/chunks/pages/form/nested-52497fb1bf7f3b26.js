...
`,d={type:"code",component:function(){let e=(0,m.c)({initialValues:{terms:!1,user:{firstName:"",lastName:""}}});return s.createElement(a.x,{maw:340,mx:"auto"},s.createElement(i.o,{label:"First name",placeholder:"First name",...e.getInputProps("user.firstName")}),s.createElement(i.o,{label:"Last name",placeholder:"Last name",mt:"md",...e.getInputProps("user.lastName")}),s.createElement(l.X,{label:"I accepts terms & conditions",mt:"sm",...e.getInputProps("terms",{type:"checkbox"})}),s.createElement(Text.x,{size:"sm",fw:500,mt:"xl"},"Form values:"),s.createElement(c.E,{block:!0,mt:5},JSON.stringify(e.values,null,2)))},code:u};var f=n(64278),p=n(93010),h=n(950),x=n(54813),y=n(17115),v=n(73533);let g=`
import { useForm } from '@mantine/form';
