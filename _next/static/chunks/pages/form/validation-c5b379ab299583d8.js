...
`,b={type:"code",component:function(){let e=(0,u.c)({initialValues:{password:"secret",confirmPassword:"sevret"},validate:{confirmPassword:(e,t)=>e!==t.password?"Passwords did not match":null}});return l.createElement(r.x,{maw:340,mx:"auto"},l.createElement("form",{onSubmit:e.onSubmit(e=>console.log(e))},l.createElement(p.W,{label:"Password",placeholder:"Password",...e.getInputProps("password")}),l.createElement(p.W,{mt:"sm",label:"Confirm password",placeholder:"Confirm password",...e.getInputProps("confirmPassword")}),l.createElement(f.Z,{justify:"flex-end",mt:"md"},l.createElement(s.z,{type:"submit"},"Submit"))))},code:g},h=`
import { useForm } from '@mantine/form';
...
`,O={type:"code",component:function(){let e=(0,u.c)({clearInputErrorOnChange:!1,initialValues:{email:"",termsOfService:!1},validate:{email:e=>/^\S+@\S+$/.test(e)?null:"Invalid email"}});return l.createElement(r.x,{maw:340,mx:"auto"},l.createElement("form",{onSubmit:e.onSubmit(e=>console.log(e))},l.createElement(i.o,{withAsterisk:!0,label:"Email",placeholder:"your@email.com",...e.getInputProps("email")}),l.createElement(B.X,{mt:"md",label:"I agree to sell my privacy",...e.getInputProps("termsOfService",{type:"checkbox"})}),l.createElement(f.Z,{justify:"flex-end",mt:"md"},l.createElement(s.z,{type:"submit"},"Submit"))))},code:C};var F=n(60048);let D=`
import { useForm } from '@mantine/form';
