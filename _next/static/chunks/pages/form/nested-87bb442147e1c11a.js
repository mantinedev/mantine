...
`};var d=n(13660),m=n(56051),u=n(26975),p=n(22962),h=n(93065),f=n(52022),v=n(63297);let y={type:"code",component:function(){let e=(0,l.m)({mode:"uncontrolled",initialValues:{employees:[{name:"",active:!1,key:(0,v.z)()}]}}),t=e.getValues().employees.map((t,n)=>(0,r.jsxs)(m.Y,{mt:"xs",children:[(0,r.jsx)(a.k,{placeholder:"John Doe",withAsterisk:!0,style:{flex:1},...e.getInputProps(`employees.${n}.name`)},e.key(`employees.${n}.name`)),(0,r.jsx)(u.d,{label:"Active",...e.getInputProps(`employees.${n}.active`,{type:"checkbox"})},e.key(`employees.${n}.active`)),(0,r.jsx)(p.M,{color:"red",onClick:()=>e.removeListItem("employees",n),children:(0,r.jsx)(d.A,{size:16})})]},t.key));return(0,r.jsxs)(o.a,{maw:500,mx:"auto",children:[t.length>0?(0,r.jsxs)(m.Y,{mb:"xs",children:[(0,r.jsx)(h.E,{fw:500,size:"sm",style:{flex:1},children:"Name"}),(0,r.jsx)(h.E,{fw:500,size:"sm",pr:90,children:"Status"})]}):(0,r.jsx)(h.E,{c:"dimmed",ta:"center",children:"No one here..."}),t,(0,r.jsx)(m.Y,{justify:"center",mt:"md",children:(0,r.jsx)(f.$,{onClick:()=>e.insertListItem("employees",{name:"",active:!1,key:(0,v.z)()}),children:"Add employee"})})]})},code:`
import { useForm } from '@mantine/form';
