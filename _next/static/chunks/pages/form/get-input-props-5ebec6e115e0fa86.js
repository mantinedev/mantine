...
`,centered:!0,maxWidth:340}},72182:(e,n,t)=>{"use strict";t.d(n,{F:()=>d});var r=t(31085),o=t(14041),s=t(90275),a=t(1169),i=t(23719);let d={type:"code",component:function(){let e=(0,i.m)({mode:"uncontrolled",initialValues:{name:"",age:""},enhanceGetInputProps:e=>"name"===e.options.fieldType?{label:"Your name",placeholder:"Your name",withAsterisk:!0,description:"Your personal information is stored securely. (Just kidding!)"}:{}});return(0,r.jsxs)(r.Fragment,{children:[(0,o.createElement)(s.k,{...e.getInputProps("name",{fieldType:"name"}),key:e.key("name")}),(0,o.createElement)(a.Q,{...e.getInputProps("age"),key:e.key("age"),label:"Age",placeholder:"Age",mt:"md"})]})},code:`
import { NumberInput, TextInput } from '@mantine/core';
import { useForm } from '@mantine/form';
...
`,centered:!0,maxWidth:340}}},e=>{var n=n=>e(e.s=n);e.O(0,[57715,18675,23719,45040,90636,46593,38792],()=>n(47831)),_N_E=e.O()}]);