...
`};var d=o(94756),u=o(18064),f=o(93010),h=o(16438),v=o(17115),y=o(73533);let x={type:"code",component:function(){let e=(0,i.c)({mode:"uncontrolled",initialValues:{employees:[{name:"John Doe",email:"john@mantine.dev",key:(0,y.k)()},{name:"Bill Love",email:"bill@mantine.dev",key:(0,y.k)()},{name:"Nancy Eagle",email:"nanacy@mantine.dev",key:(0,y.k)()},{name:"Lim Notch",email:"lim@mantine.dev",key:(0,y.k)()},{name:"Susan Seven",email:"susan@mantine.dev",key:(0,y.k)()}]}}),t=e.getValues().employees.map((t,o)=>(0,r.jsx)(d._l,{index:o,draggableId:t.key,children:t=>(0,r.jsxs)(f.Z,{ref:t.innerRef,mt:"xs",...t.draggableProps,children:[(0,r.jsx)(h.M,{...t.dragHandleProps,children:(0,r.jsx)(u.Z,{size:"1.2rem"})}),(0,r.jsx)(s.o,{placeholder:"John Doe",...e.getInputProps(`employees.${o}.name`)},e.key(`employees.${o}.name`)),(0,r.jsx)(s.o,{placeholder:"example@mail.com",...e.getInputProps(`employees.${o}.email`)},e.key(`employees.${o}.email`))]})},t.key));return(0,r.jsxs)("div",{children:[(0,r.jsx)(d.Z5,{onDragEnd:({destination:t,source:o})=>t?.index!==void 0&&e.reorderListItem("employees",{from:o.index,to:t?.index}),children:(0,r.jsx)(d.bK,{droppableId:"dnd-list",direction:"vertical",children:e=>(0,r.jsxs)("div",{...e.droppableProps,ref:e.innerRef,children:[t,e.placeholder]})})}),(0,r.jsx)(f.Z,{justify:"center",mt:"md",children:(0,r.jsx)(v.z,{onClick:()=>e.insertListItem("employees",{name:"",email:"",key:(0,y.k)()}),children:"Add employee"})})]})},code:`
