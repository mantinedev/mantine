(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[63420],{22695:(e,n,t)=>{"use strict";t.d(n,{rU:()=>p});var o=t(26668),r=t(26082),s=t(49643),i=t(8974),c=t(97248),a=t(50212),l=t(19492),d=t(55729);let{cssFactory:m}={cssFactory:function(e){let{cache:n}=e,t=(...e)=>{let{ref:t,args:o}=function(e){let n;if(1!==e.length)return{args:e,ref:n};let[t]=e;if(!(t instanceof Object)||!("ref"in t))return{args:e,ref:n};n=t.ref;let o={...t};return delete o.ref,{args:[o],ref:n}}(e),r=(0,i.J)(o,n.registered);return(0,c.sk)(n,r,!1),`${n.key}-${r.name}${void 0===t?"":` ${t}`}`};return{css:t,cx:(...e)=>(function(e,n,t){let o=[],r=(0,c.Rk)(e,o,t);return o.length<2?t:r+n(o)})(n.registered,t,(0,a.A)(e))}}};function h(e){return`___ref-${e||""}`}function u(e,n){return n in e.breakpoints&&"number"!=typeof n?(0,o.px)(e.breakpoints[n]):(0,o.px)(n)}function p(e){let n="function"==typeof e?e:()=>e;return function(e){let t=(0,s.xd)(),o={light:'[data-mantine-color-scheme="light"] &',dark:'[data-mantine-color-scheme="dark"] &',rtl:'[dir="rtl"] &',ltr:'[dir="ltr"] &',notRtl:'[dir="ltr"] &',notLtr:'[dir="rtl"] &',ref:h,smallerThan:e=>`@media (max-width: ${(0,r.em)(u(t,e)-.1)})`,largerThan:e=>`@media (min-width: ${(0,r.em)(u(t,e))})`},i=n(t,e,o),{css:c,cx:a}=function(){let e=(0,l.ZO)();return function(e,n){let t=(0,d.useRef)(null);return(!t.current||n.length!==t.current.prevDeps.length||t.current.prevDeps.map((e,t)=>e===n[t]).indexOf(!1)>=0)&&(t.current={v:e(),prevDeps:[...n]}),t.current.v}(()=>m({cache:e}),[e])}();return{classes:Object.keys(i).reduce((e,n)=>(e[n]=c(i[n]),e),{}),cx:a,theme:t}}}},48141:(e,n,t)=>{(window.__NEXT_P=window.__NEXT_P||[]).push(["/styles/emotion",function(){return t(61179)}])},61179:(e,n,t)=>{"use strict";t.r(n),t.d(n,{default:()=>I});var o=t(6029),r=t(16285),s=t(81498),i=t(22695);let c=`
