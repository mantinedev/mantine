...
`,l={type:"code",component:function(){return s.createElement(o.x,{className:"m-3b7b8cc2"},"Box component with ",s.createElement("span",{className:"m-b0c0466b"},"some styles"))},code:[{fileName:"Demo.tsx",language:"tsx",code:r},{fileName:"Demo.module.css",language:"scss",code:a}]}},76550:function(e,n,t){"use strict";t.d(n,{A:function(){return l}});var s=t(2784),o=t(74770);let r=`
...
`,l={type:"code",component:function(){let e="linear-gradient(45deg, var(--mantine-color-pink-filled) 0%, var(--mantine-color-orange-filled) 50%, var(--mantine-color-yellow-filled) 100%)";return s.createElement(o.z,{radius:"md",styles:{root:{padding:(0,r.h)(2),border:0,backgroundImage:e},inner:{background:"var(--mantine-color-body)",color:"var(--mantine-color-text)",borderRadius:"calc(var(--button-radius) - 2px)",paddingLeft:"var(--mantine-spacing-md)",paddingRight:"var(--mantine-spacing-md)"},label:{backgroundImage:e,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}},"Gradient button")},centered:!0,code:a}}},function(e){e.O(0,[57938,17454,47747,49774,92888,40179],function(){return e(e.s=71685)}),_N_E=e.O()}]);