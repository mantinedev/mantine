...
`,l={type:"code",component:function(){let[e,n]=(0,s.useState)(""),[t,a]=(0,s.useState)(!1),i=t||e.length>0||void 0;return(0,o.jsx)(r.o,{label:"Floating label input",labelProps:{"data-floating":i},classNames:{root:"m_bf550b40",input:"m_2acd192c",label:"m_2af14056"},onFocus:()=>a(!0),onBlur:()=>a(!1),value:e,onChange:e=>n(e.currentTarget.value)})},maxWidth:360,centered:!0,code:[{fileName:"Demo.tsx",language:"tsx",code:a},{fileName:"Demo.module.css",language:"scss",code:i}]}},10069:function(e,n,t){"use strict";t.d(n,{B:function(){return u}});var o=t(52322),s=t(40489),r=t(60231),a=t(74770),i=t(68755);let l=`
import cx from 'clsx';
...
`,i={type:"code",component:function(){let e="linear-gradient(45deg, var(--mantine-color-pink-filled) 0%, var(--mantine-color-orange-filled) 50%, var(--mantine-color-yellow-filled) 100%)";return(0,o.jsx)(s.z,{radius:"md",styles:{root:{padding:(0,r.h)(2),border:0,backgroundImage:e},inner:{background:"var(--mantine-color-body)",color:"var(--mantine-color-text)",borderRadius:"calc(var(--button-radius) - 2px)",paddingLeft:"var(--mantine-spacing-md)",paddingRight:"var(--mantine-spacing-md)"},label:{backgroundImage:e,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}},children:"Gradient button"})},centered:!0,code:a}},23344:function(e,n,t){"use strict";t.d(n,{g:function(){return d}});var o=t(52322),s=t(58898),r=t(17115),a=t(93010);let i=`
