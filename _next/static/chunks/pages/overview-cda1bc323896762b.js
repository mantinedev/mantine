...
`,m={type:"code",component:function(){let{setColorScheme:e}=(0,l.X)(),n=(0,i.l)("light",{getInitialValueInEffect:!0});return s.createElement(c.A,{onClick:()=>e("light"===n?"dark":"light"),variant:"default",size:"xl","aria-label":"Toggle color scheme"},s.createElement(o.Z,{className:(0,a.Z)(d.icon,d.light),stroke:1.5}),s.createElement(r.Z,{className:(0,a.Z)(d.icon,d.dark),stroke:1.5}))},centered:!0,code:[{fileName:"Demo.tsx",language:"tsx",code:h},{fileName:"Demo.module.css",language:"scss",code:u}]}}},function(e){e.O(0,[370,5819,2775,9774,2888,179],function(){return e(e.s=3464)}),_N_E=e.O()}]);