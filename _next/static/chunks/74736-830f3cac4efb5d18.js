...
`,centered:!0,maxWidth:340}},42697:function(e,t,r){r.d(t,{Y:function(){return x}});var n=r(52322),o=r(2784),a=r(40489),u=r(9462),i=r(9341),l=r(82692),c=r(70837),m=r(91482),s=r(11200),f=r(51477),d=r(46690),p=r(38483),g=r(82027),b=r(73063),h=r(63409);function y({direction:e,style:t,...r}){return(0,n.jsx)("svg",{style:{width:"var(--ni-chevron-size)",height:"var(--ni-chevron-size)",transform:"up"===e?"rotate(180deg)":void 0,...t},viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",...r,children:(0,n.jsx)("path",{d:"M3.13523 6.15803C3.3241 5.95657 3.64052 5.94637 3.84197 6.13523L7.5 9.56464L11.158 6.13523C11.3595 5.94637 11.6759 5.95657 11.8648 6.15803C12.0536 6.35949 12.0434 6.67591 11.842 6.86477L7.84197 10.6148C7.64964 10.7951 7.35036 10.7951 7.15803 10.6148L3.15803 6.86477C2.95657 6.67591 2.94637 6.35949 3.13523 6.15803Z",fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd"})})}var v={root:"m_e2f5cd4e",controls:"m_95e17d22",control:"m_80b4b171"};let w=/^(0\.0*|-0(\.0*)?)$/,N=/^-?0\d+(\.\d+)?\.?$/;function j(e,t,r){return void 0===e||(void 0===t||e>=t)&&(void 0===r||e<=r)}let I={step:1,clampBehavior:"blur",allowDecimal:!0,allowNegative:!0,withKeyboardEvents:!0,allowLeadingZeros:!0,trimLeadingZeroesOnBlur:!0,startValue:0},k=(0,s.Z)((e,{size:t})=>({controls:{"--ni-chevron-size":(0,m.ap)(t,"ni-chevron-size")}})),x=(0,g.d)((e,t)=>{let r=(0,p.w)("NumberInput",I,e),{className:m,classNames:s,styles:g,unstyled:x,vars:P,onChange:O,onValueChange:D,value:E,defaultValue:A,max:_,min:F,step:R,hideControls:S,rightSection:M,isAllowed:V,clampBehavior:z,onBlur:C,allowDecimal:T,decimalScale:B,onKeyDown:Y,onKeyDownCapture:L,handlersRef:U,startValue:Z,disabled:q,rightSectionPointerEvents:G,allowNegative:J,readOnly:W,size:$,rightSectionWidth:K,stepHoldInterval:X,stepHoldDelay:H,allowLeadingZeros:Q,withKeyboardEvents:ee,trimLeadingZeroesOnBlur:et,...er}=r,en=(0,d.y)({name:"NumberInput",classes:v,props:r,classNames:s,styles:g,unstyled:x,vars:P,varsResolver:k}),{resolvedClassNames:eo,resolvedStyles:ea}=(0,f.h)({classNames:s,styles:g,props:r}),[eu,ei]=(0,i.C)({value:E,defaultValue:A,onChange:O}),el=void 0!==H&&void 0!==X,ec=(0,o.useRef)(null),em=(0,o.useRef)(null),es=(0,o.useRef)(0),ef=e=>{let t=String(e).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);return t?Math.max(0,(t[1]?t[1].length:0)-(t[2]?+t[2]:0)):0},ed=e=>{ec.current&&void 0!==e&&ec.current.setSelectionRange(e,e)},ep=(0,o.useRef)();ep.current=()=>{let e;let t=Math.max(ef(eu),ef(R)),r=10**t;if("number"!=typeof eu||Number.isNaN(eu))e=(0,l.u)(Z,F,_);else if(void 0!==_){let t=(Math.round(eu*r)+Math.round(R*r))/r;e=t<=_?t:_}else e=(Math.round(eu*r)+Math.round(R*r))/r;let n=e.toFixed(t);ei(parseFloat(n)),D?.({floatValue:parseFloat(n),formattedValue:n,value:n},{source:"increment"}),setTimeout(()=>ed(ec.current?.value.length),0)};let eg=(0,o.useRef)();eg.current=()=>{let e;let t=void 0!==F?F:J?Number.MIN_SAFE_INTEGER:0,r=Math.max(ef(eu),ef(R)),n=10**r;if("number"!=typeof eu||Number.isNaN(eu))e=(0,l.u)(Z,t,_);else{let r=(Math.round(eu*n)-Math.round(R*n))/n;e=void 0!==t&&r<t?t:r}let o=e.toFixed(r);ei(parseFloat(o)),D?.({floatValue:parseFloat(o),formattedValue:o,value:o},{source:"decrement"}),setTimeout(()=>ed(ec.current?.value.length),0)},(0,c.kR)(U,{increment:ep.current,decrement:eg.current});let eb=e=>{e?ep.current():eg.current(),es.current+=1},eh=e=>{if(eb(e),el){let t="number"==typeof X?X:X(es.current);em.current=window.setTimeout(()=>eh(e),t)}},ey=(e,t)=>{e.preventDefault(),ec.current?.focus(),eb(t),el&&(em.current=window.setTimeout(()=>eh(t),H))},ev=()=>{em.current&&window.clearTimeout(em.current),em.current=null,es.current=0},ew=(0,n.jsxs)("div",{...en("controls"),children:[(0,n.jsx)(h.k,{...en("control"),tabIndex:-1,"aria-hidden":!0,disabled:q||"number"==typeof eu&&void 0!==_&&eu>=_,mod:{direction:"up"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{ey(e,!0)},onPointerUp:ev,onPointerLeave:ev,children:(0,n.jsx)(y,{direction:"up"})}),(0,n.jsx)(h.k,{...en("control"),tabIndex:-1,"aria-hidden":!0,disabled:q||"number"==typeof eu&&void 0!==F&&eu<=F,mod:{direction:"down"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{ey(e,!1)},onPointerUp:ev,onPointerLeave:ev,children:(0,n.jsx)(y,{direction:"down"})})]});return(0,n.jsx)(b.M,{component:u.h3,allowNegative:J,className:(0,a.Z)(v.root,m),size:$,...er,readOnly:W,disabled:q,value:eu,getInputRef:(0,c.Yx)(t,ec),onValueChange:(e,t)=>{if("event"===t.source){var r;ei(!(("number"==typeof(r=e.floatValue)?r<Number.MAX_SAFE_INTEGER:!Number.isNaN(Number(r)))&&!Number.isNaN(r))||w.test(e.value)||Q&&N.test(e.value)?e.value:e.floatValue)}D?.(e,t)},rightSection:S||W?M:M||ew,classNames:eo,styles:ea,unstyled:x,__staticSelector:"NumberInput",decimalScale:T?B:0,onKeyDown:e=>{Y?.(e),!W&&ee&&("ArrowUp"===e.key&&(e.preventDefault(),ep.current()),"ArrowDown"===e.key&&(e.preventDefault(),eg.current()))},onKeyDownCapture:e=>{if(L?.(e),"Backspace"===e.key){let t=ec.current;0===t.selectionStart&&t.selectionStart===t.selectionEnd&&(e.preventDefault(),window.setTimeout(()=>ed(0),0))}},rightSectionPointerEvents:G??(q?"none":void 0),rightSectionWidth:K??`var(--ni-right-section-width-${$||"sm"})`,allowLeadingZeros:Q,onBlur:e=>{if(C?.(e),"blur"===z&&"number"==typeof eu&&(0,l.u)(eu,F,_)!==eu&&ei((0,l.u)(eu,F,_)),et&&"string"==typeof eu){let e=eu.replace(/^0+/,""),t=parseFloat(e);ei(Number.isNaN(t)?e:t)}},isAllowed:e=>"strict"===z?V?V(e)&&j(e.floatValue,F,_):j(e.floatValue,F,_):!V||V(e)})});x.classes={...b.M.classes,...v},x.displayName="@mantine/core/NumberInput"},73846:function(e,t,r){r.d(t,{m:function(){return n}});function n({min:e,max:t},r){let n=r||!0;return r=>{if("number"!=typeof r)return n;let o=!0;return"number"==typeof e&&r<e&&(o=!1),"number"==typeof t&&r>t&&(o=!1),o?null:n}}},3095:function(e,t,r){r.d(t,{U:function(){return n}});function n(e){let t=e||!0;return e=>"string"==typeof e?e.trim().length>0?null:t:Array.isArray(e)?e.length>0?null:t:null==e||!1===e?t:null}}}]);