...
`),component:()=>{let[a,n]=(0,r.useState)([]);return(0,t.jsx)(e,{type:"multiple",label:"Pick dates",placeholder:"Pick dates",value:a,onChange:n})}},range:{type:"code",centered:!0,maxWidth:400,code:(d=e.displayName.replace("@mantine/dates/",""),`
import { useState } from 'react';
...
`,maxWidth:340,centered:!0},d={type:"code",centered:!0,maxWidth:400,component:function(){return(0,l.jsx)(o.DatePickerInput,{valueFormat:"YYYY MMM DD",type:"multiple",label:"Pick date",placeholder:"Pick date"})},code:`
import { DatePickerInput } from '@mantine/dates';
...
`},c={type:"code",centered:!0,maxWidth:400,component:function(){return(0,l.jsx)(o.DatePickerInput,{valueFormat:"YYYY MMM DD",type:"multiple",label:"Disabled",placeholder:"Pick date",disabled:!0})},code:`
import { DatePickerInput } from '@mantine/dates';
...
`};var k=e.i(393353);let g=e=>{let t=(0,s.default)(e).date();return(0,l.jsx)(k.Indicator,{size:6,color:"red",offset:-5,disabled:16!==t,children:(0,l.jsx)("div",{children:t})})},P={type:"code",centered:!0,maxWidth:400,component:function(){return(0,l.jsx)(o.DatePickerInput,{label:"Pick date",placeholder:"Pick date",renderDay:g})},code:`
import dayjs from 'dayjs';
...
`},b={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,m.useState)(null);return(0,l.jsx)(o.DatePickerInput,{label:"Pick date",placeholder:"Pick date",value:e,onChange:t,excludeDate:e=>0===new Date(e).getDay()||6===new Date(e).getDay()})},code:`
import { useState } from 'react';
import { DatePickerInput } from '@mantine/dates';
...
`},j={type:"code",centered:!0,maxWidth:400,component:function(){return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(o.DatePickerInput,{defaultLevel:"decade",label:"Decade level",placeholder:"Decade level",mb:"md"}),(0,l.jsx)(o.DatePickerInput,{defaultLevel:"year",label:"Year level",placeholder:"Year level"})]})},code:`
import { DatePickerInput } from '@mantine/dates';
...
`},Y={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,m.useState)(null);return(0,l.jsx)(o.DatePickerInput,{hideOutsideDates:!0,label:"Pick date",placeholder:"Pick date",value:e,onChange:t})},code:`
import { useState } from 'react';
import { DatePickerInput } from '@mantine/dates';
...
`},I={type:"code",centered:!0,maxWidth:400,component:function(){let[e,t]=(0,m.useState)(null);return(0,l.jsx)(o.DatePickerInput,{defaultLevel:"decade",decadeLabelFormat:"YY",yearLabelFormat:"YYYY [year]",monthLabelFormat:"MM/YY",label:"Pick date",placeholder:"Pick date",value:e,onChange:t})},code:`
import { useState } from 'react';
import { DatePickerInput } from '@mantine/dates';
...
`},V={type:"code",centered:!0,maxWidth:400,component:function(){return(0,l.jsx)(o.DatePickerInput,{weekendDays:[1,2],label:"Weekend days are Monday and Tuesday",placeholder:"Pick date"})},code:`
import { DatePickerInput } from '@mantine/dates';
...
`},C={type:"code",centered:!0,maxWidth:400,component:function(){return(0,l.jsx)(o.DatePickerInput,{withWeekNumbers:!0,label:"With week numbers",placeholder:"Pick date"})},code:`
import { DatePickerInput } from '@mantine/dates';
...
`},H={type:"code",centered:!0,maxWidth:400,component:function(){return(0,l.jsx)(o.DatePickerInput,{defaultDate:new Date(2022,1),headerControlsOrder:["level","previous","next"],styles:{calendarHeaderLevel:{justifyContent:"flex-start",paddingInlineStart:8}},label:"Header controls order",placeholder:"Header controls order"})},code:`
import { DatePickerInput } from '@mantine/dates';
