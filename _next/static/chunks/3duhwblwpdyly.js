...
`};var D=(0,e.__exportAll)({autoContrast:()=>I,boundaries:()=>l,composition:()=>p,configurator:()=>o,icons:()=>y,links:()=>V,responsive:()=>S,siblings:()=>r,size:()=>F,startValue:()=>R,stylesApi:()=>u,usage:()=>s,withContent:()=>C,withPages:()=>T});t.s(["PaginationDemos",0,D],302252)}]);