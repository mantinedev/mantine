...
`,language:"tsx",fileName:"Demo.tsx"}]};var ef=(0,t.__exportAll)({allDayEvents:()=>v,businessHours:()=>$,currentTimeIndicator:()=>Q,dragDrop:()=>g,eventForm:()=>w,eventResize:()=>S,firstDayOfWeek:()=>et,localization:()=>A,maxEventsPerTimeSlot:()=>en,multiHourIntervals:()=>K,radius:()=>P,recurringEvents:()=>ec,renderEvent:()=>H,renderResourceLabel:()=>j,renderWeekLabel:()=>eo,resourceGroups:()=>eD,scrollAreaProps:()=>z,startScrollDateTime:()=>F,staticMode:()=>h,timeRange:()=>O,timezone:()=>ee,usage:()=>D,withoutWeekendDays:()=>T});e.s(["ResourcesWeekViewDemos",0,ef],259072)}]);