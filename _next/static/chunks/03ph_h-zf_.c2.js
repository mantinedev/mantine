...
`},P={type:"code",centered:!0,component:function(){return(0,n.jsx)(r.DatePicker,{hideOutsideDates:!0})},code:`
import { DatePicker } from '@mantine/dates';
...
`,centered:!0};var M=e.i(79897),j=e.i(141806),T=e.i(725695),P=e.i(671640),k=e.i(284629);let S={type:"code",component:function(){return(0,r.jsxs)(a.Popover,{width:320,shadow:"md",withArrow:!0,withOverlay:!0,overlayProps:{zIndex:1e4,blur:"8px"},zIndex:10001,children:[(0,r.jsx)(a.Popover.Target,{children:(0,r.jsx)(k.UnstyledButton,{style:{zIndex:10001,position:"relative"},children:(0,r.jsx)(j.Avatar,{src:"https://avatars.githubusercontent.com/u/79146003?s=200&v=4",radius:"xl"})})}),(0,r.jsxs)(a.Popover.Dropdown,{children:[(0,r.jsxs)(T.Group,{children:[(0,r.jsx)(j.Avatar,{src:"https://avatars.githubusercontent.com/u/79146003?s=200&v=4",radius:"xl"}),(0,r.jsxs)(P.Stack,{gap:5,children:[(0,r.jsx)(n.Text,{size:"sm",fw:700,style:{lineHeight:1},children:"Mantine"}),(0,r.jsx)(M.Anchor,{href:"https://x.com/mantinedev",c:"dimmed",size:"xs",style:{lineHeight:1},children:"@mantinedev"})]})]}),(0,r.jsx)(n.Text,{size:"sm",mt:"md",children:"Customizable React components and hooks library with focus on usability, accessibility and developer experience"}),(0,r.jsxs)(T.Group,{mt:"md",gap:"xl",children:[(0,r.jsxs)(n.Text,{size:"sm",children:[(0,r.jsx)("b",{children:"0"})," Following"]}),(0,r.jsxs)(n.Text,{size:"sm",children:[(0,r.jsx)("b",{children:"1,174"})," Followers"]})]})]})]})},code:`
...
`,centered:!0,maxWidth:340};var w=e.i(301388),D=e.i(883364);let M=/^(1[0-2]|0?[1-9]):[0-5][0-9](?::[0-5][0-9])?\s?(AM|PM)$/,j=({time:e})=>{if(!M.test(e))return{hours:null,minutes:null,seconds:null,amPm:null};let[t,o,a]=e.split(":").map(e=>e.replace(/AM|PM/g,"")),n=e.toLowerCase().includes("pm");return{hours:"string"==typeof t?Number(t):null,minutes:"string"==typeof o?Number(o):null,seconds:"string"==typeof a?Number(a):0,amPm:n?"PM":"AM"}},T={type:"code",component:function(){return(0,o.jsxs)("div",{children:[(0,o.jsx)(a.TimePicker,{label:"Paste time here",format:"12h",withSeconds:!0,pasteSplit:j}),(0,o.jsxs)(D.Text,{mt:"md",children:["Try pasting time in 12h format in any input. For example, try pasting ",(0,o.jsx)(w.Code,{children:"12:34 PM"})," ","or ",(0,o.jsx)(w.Code,{children:"8:56:45 AM"})]})]})},code:`
...
`,centered:!0,maxWidth:340},P={type:"configurator",component:function(e){return(0,o.jsx)(a.TimePicker,{withDropdown:!0,...e})},code:`
import { TimePicker } from '@mantine/dates';
