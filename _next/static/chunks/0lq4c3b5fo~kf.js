...
`,component:function(){return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(n.Text,{mb:"xs",children:"Pages 5–15 (startValue=5, total=15)"}),(0,o.jsx)(a.Pagination,{total:15,startValue:5,defaultValue:5})]})}};var P=(0,t.__exportAll)({autoContrast:()=>T,boundaries:()=>i,composition:()=>p,configurator:()=>r,icons:()=>M,links:()=>j,siblings:()=>l,size:()=>L,startValue:()=>Y,stylesApi:()=>u,usage:()=>s,withContent:()=>V,withPages:()=>H});e.s(["PaginationDemos",0,P],806205)},975419,e=>{"use strict";var t=e.i(648863),a=e.i(37541),o=e.i(391398);let r={type:"configurator",component:e=>(0,o.jsx)(a.Checkbox,{...e,defaultChecked:!0}),code:`
...
`};var v=(0,t.__exportAll)({horizontal:()=>x,nested:()=>h,transition:()=>d,usage:()=>c});e.s(["CollapseDemos",0,v],608373)},643125,e=>{"use strict";var t=e.i(648863),a=e.i(391398),o=e.i(164036);let r={type:"code",centered:!0,component:function(){return(0,a.jsx)(o.Calendar,{})},code:`
...
`};var h=(0,t.__exportAll)({fullWidth:()=>p,isStatic:()=>i,picker:()=>c,usage:()=>r,weekPicker:()=>m});e.s(["CalendarDemos",0,h],643125)},550218,e=>{"use strict";var t=e.i(648863),a=e.i(960831),o=e.i(841209),r=e.i(391398);let n={type:"configurator",component:function(e){return(0,r.jsx)(o.TextInput,{...e,placeholder:"Input placeholder"})},code:`
...
`};var S=(0,t.__exportAll)({configurator:()=>h,fadeEdges:()=>w,multipleRows:()=>b,pauseOnHover:()=>x,usage:()=>g,vertical:()=>f});e.s(["MarqueeDemos",0,S],895791)},130096,e=>{"use strict";var t=e.i(648863);let a=["Apple","Banana","Cherry","Date","Elderberry","Fig","Grape","Honeydew","Indian Fig","Jackfruit","Kiwi","Lemon","Mango","Nectarine","Orange","Papaya"],o=`export const data = [
  'Apple',
  'Banana',
  'Cherry',
  'Date',
...
`,language:"tsx"},{fileName:"data.ts",code:o,language:"tsx"}]};var D=(0,t.__exportAll)({hoverCard:()=>C,maxRows:()=>S,maxVisibleItems:()=>k,usage:()=>w});e.s(["OverflowListDemos",0,D],130096)},80267,e=>{"use strict";var t=e.i(191788);let a={x:0,y:0,width:0,height:0,top:0,left:0,bottom:0,right:0};function o(e){let o=(0,t.useRef)(0),[r,n]=(0,t.useState)(a),l=(0,t.useRef)(null);return[(0,t.useCallback)(t=>{l.current&&(l.current.disconnect(),l.current=null),o.current&&cancelAnimationFrame(o.current),t&&(l.current=new ResizeObserver(e=>{let t=e[0];t&&(cancelAnimationFrame(o.current),o.current=requestAnimationFrame(()=>{let e=t.borderBoxSize?.[0]||t.contentBoxSize?.[0];e?n({width:e.inlineSize,height:e.blockSize,x:t.contentRect.x,y:t.contentRect.y,top:t.contentRect.top,left:t.contentRect.left,bottom:t.contentRect.bottom,right:t.contentRect.right}):n(t.contentRect)}))}),l.current.observe(t,e))},[e]),r]}e.s(["useElementSize",0,function(e){let[t,{width:a,height:r}]=o(e);return{ref:t,width:a,height:r}},"useResizeObserver",0,o])},417693,412563,e=>{"use strict";var t=e.i(779177),a=e.i(481178),o=e.i(317477),r=e.i(44091),n=e.i(391466),l=e.i(275519),i=e.i(232471),s=e.i(284629),c=e.i(462138),d={root:"m_bc8f275",container:"m_ee44dece",content:"m_53e4f606",chevron:"m_47754fc8",control:"m_53e526ea"},u=e.i(332977),m=e.i(80267),p=e.i(191788);function h(e={}){let{scrollAmount:t=200,draggable:a=!0,onScrollStateChange:o}=e,r=(0,p.useRef)(null),[n]=(0,m.useResizeObserver)(),[l,i]=(0,p.useState)(!1),[s,c]=(0,p.useState)(!1),[d,g]=(0,p.useState)(!1),f=(0,p.useRef)(!1),x=(0,p.useRef)(!1),v=(0,p.useRef)(0),b=(0,p.useRef)(0),y=(0,p.useRef)(o);y.current=o;let w=(0,p.useCallback)(()=>{let e=r.current;if(e){let t,a,{scrollLeft:o,scrollWidth:r,clientWidth:n}=e;"rtl"===getComputedStyle(e).direction?(t=o<0,a=o>-(r-n)):(t=o>0,a=o<r-n-1),i(t),c(a),y.current?.({canScrollStart:t,canScrollEnd:a})}},[]);(0,p.useEffect)(()=>{w();let e=r.current;if(e)return e.addEventListener("scroll",w),()=>e.removeEventListener("scroll",w)},[w]);let S=(0,p.useCallback)(e=>{let a=r.current;if(a){let o="rtl"===getComputedStyle(a).direction,r="end"===e?t:-t;a.scrollBy({left:o?-r:r,behavior:"smooth"})}},[t]),k=(0,p.useCallback)(()=>S("start"),[S]),M=(0,p.useCallback)(()=>S("end"),[S]),j=(0,p.useCallback)(e=>{if(!a)return;let t=r.current;t&&(f.current=!0,x.current=!1,g(!0),v.current=e.pageX-t.offsetLeft,b.current=t.scrollLeft,t.style.cursor="grabbing",t.style.userSelect="none")},[a]),C=(0,p.useCallback)(e=>{if(!f.current)return;e.preventDefault();let t=r.current;if(t){let a=e.pageX-t.offsetLeft-v.current;Math.abs(a)>5&&(x.current=!0),t.scrollLeft=b.current-a}},[]),D=(0,p.useCallback)(()=>{let e=x.current;f.current=!1,x.current=!1,g(!1);let t=r.current;if(t&&(t.style.cursor="",t.style.userSelect="",e)){let e=a=>{a.stopPropagation(),a.preventDefault(),t.removeEventListener("click",e,!0)};t.addEventListener("click",e,!0)}},[]),A=(0,p.useCallback)(()=>{f.current&&D()},[D]);return{ref:(0,p.useCallback)(e=>{r.current=e,(0,u.mergeRefs)(n)(e),e&&w()},[n,w]),canScrollStart:l,canScrollEnd:s,scrollStart:k,scrollEnd:M,isDragging:d,dragHandlers:{onMouseDown:j,onMouseMove:C,onMouseUp:D,onMouseLeave:A}}}e.s(["useScroller",0,h],412563);var g=e.i(391398);let f={scrollAmount:200,draggable:!0},x=(0,a.createVarsResolver)((e,{controlSize:a,edgeGradientColor:r})=>({root:{"--scroller-control-size":(0,t.rem)(a),"--scroller-background-color":r?(0,o.getThemeColor)(r,e):void 0}})),v=(0,l.factory)(e=>{let t=(0,r.useProps)("Scroller",f,e),{classNames:a,className:o,style:l,styles:u,unstyled:m,vars:p,children:v,scrollAmount:b,controlSize:y,edgeGradientColor:w,startControlProps:S,endControlProps:k,startControlIcon:M,endControlIcon:j,showStartControl:C,showEndControl:D,draggable:A,mod:V,ref:T,attributes:B,...H}=t,E=(0,n.useStyles)({name:"Scroller",classes:d,props:t,className:o,style:l,classNames:a,styles:u,unstyled:m,vars:p,varsResolver:x,attributes:B}),I=h({scrollAmount:b,draggable:A}),L=C||I.canScrollStart,Y=D||I.canScrollEnd;return(0,g.jsxs)(i.Box,{...E("root"),ref:T,mod:V,...H,children:[(0,g.jsx)(s.UnstyledButton,{...E("control"),onClick:I.scrollStart,"data-position":"start","data-hidden":!L||void 0,"aria-label":"Scroll left",tabIndex:L?0:-1,...S,children:M||(0,g.jsx)(c.AccordionChevron,{...E("chevron")})}),(0,g.jsx)("div",{...E("container"),ref:I.ref,role:"presentation","data-draggable":A||void 0,...I.dragHandlers,children:(0,g.jsx)("div",{...E("content"),children:v})}),(0,g.jsx)(s.UnstyledButton,{...E("control"),onClick:I.scrollEnd,"data-position":"end","data-hidden":!Y||void 0,"aria-label":"Scroll right",tabIndex:Y?0:-1,...k,children:j||(0,g.jsx)(c.AccordionChevron,{...E("chevron")})})]})});v.classes=d,v.varsResolver=x,v.displayName="@mantine/core/Scroller",e.s(["Scroller",0,v],417693)},520226,e=>{"use strict";var t=e.i(648863),a=e.i(257177),o=e.i(725695),r=e.i(417693),n=e.i(391398);let l={type:"code",component:function(){return(0,n.jsx)(r.Scroller,{children:(0,n.jsx)(o.Group,{gap:"xs",wrap:"nowrap",children:Array.from({length:20}).map((e,t)=>(0,n.jsxs)(a.Badge,{variant:"light",size:"lg",miw:"fit-content",children:["Badge ",t+1]},t))})})},code:`
