...
`};var H=(0,t.__exportAll)({clearSectionMode:()=>i,clearable:()=>W,configurator:()=>E,controlProps:()=>v,defaultLevel:()=>k,disabled:()=>c,excludeDate:()=>S,firstDayOfWeek:()=>j,headerControlsOrder:()=>B,hideOutsideDates:()=>D,hideWeekdays:()=>M,icon:()=>z,labelFormat:()=>C,listFormat:()=>V,maxLevel:()=>A,minMax:()=>h,modal:()=>R,multiple:()=>T,presets:()=>u,presetsRange:()=>m,range:()=>L,renderDay:()=>w,usage:()=>P,valueFormat:()=>s,valueFormatter:()=>Z,weekendDays:()=>Y,withWeekNumbers:()=>I});let{usage:P,multiple:T,range:L,configurator:E,modal:R,icon:z,clearable:W,valueFormatter:Z}=(0,a.getSharedPickerInputDemos)(l.DatePickerInput);e.s(["DatePickerInputDemos",0,H],403360)},975419,e=>{"use strict";var t=e.i(648863),a=e.i(37541),r=e.i(391398);let o={type:"configurator",component:e=>(0,r.jsx)(a.Checkbox,{...e,defaultChecked:!0}),code:`
...
`,maxWidth:340,centered:!0};var j=e.i(123895),C=e.i(726869);let V=`
...
`,maxWidth:340,centered:!0};var I=e.i(931882),B=e.i(671640);let H={type:"code",component:function(){return(0,r.jsxs)(B.Stack,{children:[(0,r.jsx)(a.MultiSelect,{label:"clearSectionMode='both' (default)",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],defaultValue:["React"],clearable:!0,rightSection:(0,r.jsx)(I.CaretDownIcon,{size:16}),clearSectionMode:"both"}),(0,r.jsx)(a.MultiSelect,{label:"clearSectionMode='rightSection'",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],defaultValue:["React"],clearable:!0,rightSection:(0,r.jsx)(I.CaretDownIcon,{size:16}),clearSectionMode:"rightSection"}),(0,r.jsx)(a.MultiSelect,{label:"clearSectionMode='clear'",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],defaultValue:["React"],clearable:!0,rightSection:(0,r.jsx)(I.CaretDownIcon,{size:16}),clearSectionMode:"clear"})]})},code:`
import { CaretDownIcon } from '@phosphor-icons/react';
...
`,maxWidth:340,centered:!0},W={type:"code",component:function(){return(0,r.jsx)(a.MultiSelect,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{transitionProps:{transition:"pop",duration:200}}})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0},F={type:"code",component:function(){return(0,r.jsx)(a.MultiSelect,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{shadow:"md"}})},code:`
import { MultiSelect } from '@mantine/core';
...
`,centered:!0,component:function(){return(0,r.jsxs)(N.Popover,{width:300,position:"bottom",withArrow:!0,shadow:"md",children:[(0,r.jsx)(N.Popover.Target,{children:(0,r.jsx)(L.Button,{children:"Toggle popover"})}),(0,r.jsx)(N.Popover.Dropdown,{children:(0,r.jsx)(a.MultiSelect,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{withinPortal:!1}})})]})}};var O={dropdown:"m_a9824888",input:"m_f5487eb3"};let G={type:"code",component:function(){return(0,r.jsx)(a.MultiSelect,{label:"Your favorite library",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],classNames:O,comboboxProps:{position:"bottom",middlewares:{flip:!1,shift:!1},offset:0}})},code:[{fileName:"Demo.tsx",code:`
import { MultiSelect } from '@mantine/core';
import classes from './Demo.module.css';
...
`,em=Array(100).fill(0).map((e,t)=>`Option ${t}`),ep={type:"code",component:function(){return(0,r.jsx)(a.MultiSelect,{label:"Fits viewport height",placeholder:"Pick values",data:em,floatingHeight:"viewport"})},code:eu,maxWidth:340,centered:!0};var eh=(0,t.__exportAll)({checkIcon:()=>c,clearSectionMode:()=>H,clearable:()=>Y,configurator:()=>d,disabled:()=>u,disabledOptions:()=>m,dragReorder:()=>en,dropdownAnimation:()=>W,dropdownOffset:()=>G,dropdownOpened:()=>R,dropdownPadding:()=>Z,dropdownPosition:()=>z,dropdownShadow:()=>F,dropdownWidth:()=>el,error:()=>p,floatingHeight:()=>ep,fuzzySearch:()=>ec,groups:()=>h,hidePickedOptions:()=>i,limit:()=>x,loading:()=>ed,maxValues:()=>l,nothingFound:()=>s,readOnly:()=>v,renderOption:()=>K,renderPill:()=>er,scrollArea:()=>w,search:()=>k,searchable:()=>n,sections:()=>T,sort:()=>M,stylesApi:()=>A,usage:()=>o,withinPopover:()=>_});e.s(["MultiSelectDemos",0,eh],131022)},501345,e=>{"use strict";var t=e.i(648863),a=e.i(485108),r=e.i(981377),o=e.i(391398),n=e.i(556457),l=e.i(541772);let i={type:"code",component:function(){let[e,t]=(0,l.useDisclosure)(!1),{getCollapseProps:i}=(0,n.useCollapse)({expanded:e});return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(a.Button,{onClick:t.toggle,mb:"md",children:e?"Collapse":"Expand"}),(0,o.jsx)("div",{...i(),children:(0,o.jsx)(r.Typography,{bg:"var(--mantine-color-blue-light)",p:"xs",bdrs:"md",children:"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."})})]})},code:`
...
`};var c=(0,t.__exportAll)({usage:()=>s});e.s(["UseHorizontalCollapseDemos",0,c],281383)},550218,e=>{"use strict";var t=e.i(648863),a=e.i(960831),r=e.i(841209),o=e.i(391398);let n={type:"configurator",component:function(e){return(0,o.jsx)(r.TextInput,{...e,placeholder:"Input placeholder"})},code:`
...
`,centered:!0,maxWidth:340};var f=(0,t.__exportAll)({disabled:()=>d,error:()=>c,loading:()=>h,sections:()=>s,stylesApi:()=>p,type:()=>l,usage:()=>n});e.s(["TextInputDemos",0,f],550218)},608373,e=>{"use strict";var t=e.i(648863),a=e.i(232471),r=e.i(485108),o=e.i(586692),n=e.i(725695),l=e.i(883364),i=e.i(391398),s=e.i(541772);let c={type:"code",code:`
