...
`},V={defaultExpanded:!1,type:"code",component:function(){return(0,i.jsx)(g,{events:o,defaultView:"month"})},code:`
import { Schedule } from '@mantine/schedule';
import { events } from './data';
...
`},P=(0,a.default)().format("YYYY-MM-DD"),z=(0,a.default)().add(1,"day").format("YYYY-MM-DD"),L=[{id:1,title:"Morning Standup",start:`${P} 09:00:00`,end:`${P} 09:30:00`,color:"blue"},{id:2,title:"Team Meeting",start:`${P} 10:00:00`,end:`${P} 11:30:00`,color:"green"},{id:3,title:"Lunch Break",start:`${P} 12:00:00`,end:`${P} 13:00:00`,color:"orange"},{id:4,title:"Code Review",start:`${z} 14:00:00`,end:`${z} 15:00:00`,color:"violet"},{id:5,title:"Client Call",start:`${z} 15:30:00`,end:`${z} 16:30:00`,color:"cyan"}],_={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,M.useState)(L),a=({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))};return(0,i.jsx)(g,{events:e,withEventsDragAndDrop:!0,onEventDrop:a,withEventResize:!0,onEventResize:a})},code:`
import { useState } from 'react';
import dayjs from 'dayjs';
import { Schedule, ScheduleEventData } from '@mantine/schedule';
...
`},J=(0,a.default)().format("YYYY-MM-DD"),K=[{id:"lunch-block",title:"Lunch break",start:`${J} 12:00:00`,end:`${J} 13:00:00`,color:"gray",display:"background"},{id:"focus-time",title:"Focus time",start:`${J} 14:00:00`,end:`${J} 16:00:00`,color:"blue",display:"background"},{id:"team-meeting",title:"Team meeting",start:`${J} 10:00:00`,end:`${J} 11:00:00`,color:"violet"},{id:"code-review",title:"Code review",start:`${J} 14:30:00`,end:`${J} 15:30:00`,color:"green"}],Q={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,M.useState)(J);return(0,i.jsx)(g,{date:e,onDateChange:t,events:K})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { Schedule, ScheduleEventData } from '@mantine/schedule';
...
`};var er=(0,t.__exportAll)({backgroundEvents:()=>Q,bidirectionalDragDrop:()=>F,controlled:()=>j,customHeader:()=>X,defaultView:()=>V,dragDrop:()=>E,eventForm:()=>W,eventResize:()=>_,externalDragDrop:()=>R,recurringEvents:()=>U,responsiveLayout:()=>$,usage:()=>Y,viewProps:()=>C,withAgenda:()=>en});e.s(["ScheduleDemos",0,er],238715)}]);