...
`;var u=e.i(191788),D=e.i(391398),v=e.i(200183);let f={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,D.jsx)(v.DayView,{date:e,onDateChange:t,events:o,startTime:"08:00:00",endTime:"18:00:00"})},code:[{code:`
import dayjs from 'dayjs';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]},p={defaultExpanded:!1,type:"code",component:function(){return(0,D.jsx)(v.DayView,{date:new Date,events:o,startTime:"09:00:00",endTime:"17:00:00"})},code:[{code:`
import { DayView } from '@mantine/schedule';
import { events } from './data';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]},g=(0,a.default)().format("YYYY-MM-DD"),w=[{id:1,title:"Morning Standup",start:`${g} 09:00:00`,end:`${g} 09:30:00`,color:"blue"},{id:2,title:"Team Meeting",start:`${g} 11:15:00`,end:`${g} 12:00:00`,color:"green"},{id:3,title:"Code Review",start:`${g} 14:00:00`,end:`${g} 14:45:00`,color:"violet"}],Y={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(w);return(0,D.jsx)(v.DayView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",intervalMinutes:15,withSubHourGridLines:!1,withEventResize:!0,onEventResize:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))}})},code:`
import { useState } from 'react';
import dayjs from 'dayjs';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]},O=(0,a.default)().format("YYYY-MM-DD"),z=[{id:1,title:"Morning Standup",start:`${O} 09:00:00`,end:`${O} 09:30:00`,color:"blue"},{id:2,title:"Team Meeting",start:`${O} 11:00:00`,end:`${O} 12:00:00`,color:"green"},{id:3,title:"Code Review",start:`${O} 14:00:00`,end:`${O} 15:00:00`,color:"violet"}],R={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(z);return(0,D.jsx)(v.DayView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))}})},code:`
import { useState } from 'react';
import dayjs from 'dayjs';
import { DayView, ScheduleEventData } from '@mantine/schedule';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:s,language:"tsx",fileName:"data.ts"}]},eO=(0,a.default)().format("YYYY-MM-DD"),ez=[{id:"standup",title:"Morning Standup",start:`${eO} 09:00:00`,end:`${eO} 09:30:00`,color:"blue"},{id:"team-meeting",title:"Team Meeting",start:`${eO} 10:00:00`,end:`${eO} 11:30:00`,color:"green"},{id:"weekly-review-series",title:"Weekly review",start:`${(0,a.default)(eO).startOf("week").format("YYYY-MM-DD")} 16:00:00`,end:`${(0,a.default)(eO).startOf("week").format("YYYY-MM-DD")} 17:00:00`,color:"orange",recurrence:{rrule:"FREQ=WEEKLY;COUNT=8"}}],eR={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,u.useState)(eO);return(0,D.jsx)(v.DayView,{date:e,onDateChange:t,events:ez,withAgenda:!0})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { DayView } from '@mantine/schedule';
