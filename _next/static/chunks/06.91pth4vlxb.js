...
`},b={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.WeekView,{date:new Date,events:d,startTime:"08:00:00",endTime:"18:00:00",withHeader:!1})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},$={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.WeekView,{date:new Date,events:d,startTime:"08:00:00",endTime:"18:00:00",weekLabelFormat:"MMMM D, YYYY"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},C={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.WeekView,{date:new Date,events:d,startTime:"08:00:00",endTime:"18:00:00",slotLabelFormat:"h A"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},O={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.WeekView,{date:new Date,events:d,startTime:"08:00:00",endTime:"18:00:00",slotHeight:80,allDaySlotHeight:60})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},H={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.WeekView,{date:new Date,events:s,highlightBusinessHours:!0,businessHours:["09:00:00","17:00:00"]})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},V={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.WeekView,{date:new Date,events:s,highlightBusinessHours:!0,businessHours:{1:["09:00:00","17:00:00"],2:["09:00:00","17:00:00"],3:["09:00:00","17:00:00"],4:["09:00:00","17:00:00"],5:["09:00:00","13:00:00"]},startTime:"07:00:00",endTime:"20:00:00"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},A={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.WeekView,{date:new Date,events:i,startTime:"08:00:00",endTime:"18:00:00"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`};var I=e.i(441058);let z=(0,a.default)().format("YYYY-MM-DD"),B=(0,a.default)().add(1,"day").format("YYYY-MM-DD"),R=[{id:1,title:"Morning Standup",start:`${z} 09:00:00`,end:`${z} 09:30:00`,color:"blue"},{id:2,title:"Team Meeting",start:`${B} 11:00:00`,end:`${B} 12:00:00`,color:"green"},{id:3,title:"Code Review",start:`${z} 14:00:00`,end:`${z} 15:00:00`,color:"violet"},{id:4,title:"Company Holiday",start:(0,a.default)((0,I.getStartOfWeek)({date:z,firstDayOfWeek:1})).format("YYYY-MM-DD HH:mm:ss"),end:(0,a.default)((0,I.getStartOfWeek)({date:z,firstDayOfWeek:1})).add(2,"day").format("YYYY-MM-DD HH:mm:ss"),color:"red"},{id:5,title:"Release Day",start:(0,a.default)((0,I.getStartOfWeek)({date:z,firstDayOfWeek:1})).format("YYYY-MM-DD HH:mm:ss"),end:(0,a.default)((0,I.getStartOfWeek)({date:z,firstDayOfWeek:1})).add(2,"day").format("YYYY-MM-DD HH:mm:ss"),color:"orange"}],N={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)(R);return(0,c.jsx)(u.WeekView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))}})},code:`
import { useState } from 'react';
import dayjs from 'dayjs';
...
`},G=(0,a.default)().format("YYYY-MM-DD"),F=(0,a.default)().add(1,"day").format("YYYY-MM-DD"),L=[{id:1,title:"Morning Standup",start:`${G} 09:00:00`,end:`${G} 09:30:00`,color:"blue"},{id:2,title:"Team Meeting",start:`${F} 11:00:00`,end:`${F} 12:00:00`,color:"green"},{id:3,title:"Code Review",start:`${G} 14:00:00`,end:`${G} 15:00:00`,color:"violet"}],P={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)(L);return(0,c.jsx)(u.WeekView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventResize:!0,onEventResize:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))}})},code:`
import { useState } from 'react';
import dayjs from 'dayjs';
import { WeekView, ScheduleEventData } from '@mantine/schedule';
...
`};var U=e.i(19683),J=e.i(369974),Q=e.i(284629);let _=(0,a.default)().startOf("week"),K=[{id:1,title:"Team Standup",start:_.add(1,"day").hour(9).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:_.add(1,"day").hour(9).minute(30).format("YYYY-MM-DD HH:mm:ss"),color:"blue",payload:{description:"Daily team sync meeting",attendees:["Alice","Bob","Charlie"],location:"Conference Room A"}},{id:2,title:"Design Workshop",start:_.add(2,"day").hour(10).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:_.add(2,"day").hour(12).minute(0).format("YYYY-MM-DD HH:mm:ss"),color:"grape",payload:{description:"Collaborative design thinking session",attendees:["Diana","Eve","Frank"],location:"Creative Space"}},{id:3,title:"Client Presentation",start:_.add(3,"day").hour(14).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:_.add(3,"day").hour(15).minute(30).format("YYYY-MM-DD HH:mm:ss"),color:"green",payload:{description:"Q4 progress presentation to client",attendees:["Grace","Henry"],location:"Zoom"}},{id:4,title:"Sprint Planning",start:_.add(4,"day").hour(10).minute(0).format("YYYY-MM-DD HH:mm:ss"),end:_.add(4,"day").hour(12).minute(0).format("YYYY-MM-DD HH:mm:ss"),color:"orange",payload:{description:"Plan next sprint tasks and priorities",attendees:["Alice","Charlie","Bob"],location:"Dev Lab"}},{id:5,title:"All Day Conference",start:_.add(5,"day").format("YYYY-MM-DD 00:00:00"),end:_.add(5,"day").format("YYYY-MM-DD 23:59:59"),color:"pink",payload:{description:"Annual tech conference",attendees:["All Team"],location:"Convention Center"}}],Z={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)(K);return(0,c.jsx)(u.WeekView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:n,newEnd:r})=>{t(t=>t.map(t=>t.id===e?{...t,start:(0,a.default)(n).format("YYYY-MM-DD HH:mm:ss"),end:(0,a.default)(r).format("YYYY-MM-DD HH:mm:ss")}:t))},renderEvent:(e,t)=>(0,c.jsxs)(J.HoverCard,{width:280,position:"right",closeDelay:0,transitionProps:{duration:0},children:[(0,c.jsx)(J.HoverCard.Target,{children:(0,c.jsx)(Q.UnstyledButton,{...t})}),(0,c.jsx)(J.HoverCard.Dropdown,{children:(0,c.jsx)(U.EventDetails,{event:e})})]})})},code:[{fileName:"Demo.tsx",code:`
import { useState } from 'react';
import dayjs from 'dayjs';
...
export const eventsData: ScheduleEventData[] = ${JSON.stringify(K,null,2)};`,language:"tsx"}]},q={defaultExpanded:!1,type:"code",component:function(){return(0,c.jsx)(u.WeekView,{date:new Date,events:d,startTime:"08:00:00",endTime:"18:00:00",mode:"static"})},code:`
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
}`,language:"tsx",fileName:"Demo.tsx"},{code:X._eventFormCode,language:"tsx",fileName:"EventForm.tsx"},{code:l,language:"tsx",fileName:"events.ts"}]},et={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)(d);return(0,c.jsx)(u.WeekView,{date:new Date,events:e,startScrollTime:"09:00:00",scrollAreaProps:{mah:500},withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:a,newEnd:n})=>{t(t=>t.map(t=>t.id===e?{...t,start:a,end:n}:t))}})},code:[{code:`
import { useState } from 'react';
import { WeekView, ScheduleEventData } from '@mantine/schedule';
...
`},el=(0,a.default)((0,I.getStartOfWeek)({date:new Date,firstDayOfWeek:1})).format("YYYY-MM-DD"),em=[{id:"weekly-sync-series",title:"Weekly sync (series)",start:`${el} 10:00:00`,end:`${el} 11:00:00`,color:"blue",recurrence:{rrule:"FREQ=WEEKLY;BYDAY=MO,WE;COUNT=12",exdate:[`${(0,a.default)(el).add(2,"day").format("YYYY-MM-DD")} 10:00:00`]}},{id:"weekly-sync-override",title:"Weekly sync (moved this week)",start:`${(0,a.default)(el).add(2,"day").format("YYYY-MM-DD")} 15:00:00`,end:`${(0,a.default)(el).add(2,"day").format("YYYY-MM-DD")} 16:00:00`,color:"grape",recurringEventId:"weekly-sync-series",recurrenceId:`${(0,a.default)(el).add(2,"day").format("YYYY-MM-DD")} 10:00:00`},{id:"one-off-week",title:"One-off interview",start:`${(0,a.default)(el).add(1,"day").format("YYYY-MM-DD")} 13:00:00`,end:`${(0,a.default)(el).add(1,"day").format("YYYY-MM-DD")} 14:00:00`,color:"green"}],ec={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)(el);return(0,c.jsx)(u.WeekView,{date:e,onDateChange:t,events:em,startTime:"08:00:00",endTime:"20:00:00",intervalMinutes:60})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
...
`},eu=(0,a.default)().format("YYYY-MM-DD"),ef=[{id:"lunch-block",title:"Lunch break",start:`${eu} 12:00:00`,end:`${eu} 13:00:00`,color:"gray",display:"background"},{id:"focus-time",title:"Focus time",start:`${eu} 14:00:00`,end:`${eu} 16:00:00`,color:"blue",display:"background"},{id:"team-meeting",title:"Team meeting",start:`${eu} 10:00:00`,end:`${eu} 11:00:00`,color:"violet"},{id:"code-review",title:"Code review",start:`${eu} 14:30:00`,end:`${eu} 15:30:00`,color:"green"}],eD={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)(eu);return(0,c.jsx)(u.WeekView,{date:e,onDateChange:t,events:ef,startTime:"08:00:00",endTime:"18:00:00"})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { WeekView } from '@mantine/schedule';
...
`},ev=(0,a.default)((0,I.getStartOfWeek)({date:new Date,firstDayOfWeek:1})),ep=Array.from({length:5},(e,t)=>ev.add(t,"day").format("YYYY-MM-DD")),eY=[...ep.map((e,t)=>({id:`lunch-${t}`,title:"Lunch break",start:`${e} 12:00:00`,end:`${e} 13:00:00`,color:"red",display:"background"})),{id:"team-meeting",title:"Team meeting",start:`${ep[0]} 10:00:00`,end:`${ep[0]} 11:00:00`,color:"violet"},{id:"code-review",title:"Code review",start:`${ep[2]} 15:00:00`,end:`${ep[2]} 16:00:00`,color:"green"}],ey={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)(eY);return(0,c.jsx)(u.WeekView,{date:new Date,events:e,startTime:"08:00:00",endTime:"18:00:00",withEventsDragAndDrop:!0,onEventDrop:({eventId:a,newStart:n,newEnd:r})=>{e.some(e=>"background"===e.display&&n<e.end&&r>e.start)||t(e=>e.map(e=>e.id===a?{...e,start:n,end:r}:e))},styles:{weekViewBackgroundEvent:{background:`repeating-linear-gradient(
            -45deg,
            transparent,
            transparent 10px,
...
`}]};var eg=e.i(428127);let ew={defaultExpanded:!1,type:"code",component:function(){let e,t,[n,r]=(0,m.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,c.jsxs)("div",{children:[(0,c.jsxs)(eg.ScheduleHeader,{children:[(0,c.jsx)(eg.ScheduleHeader.Previous,{onClick:()=>r((0,a.default)(n).subtract(1,"week").format("YYYY-MM-DD"))}),(0,c.jsx)(eg.ScheduleHeader.Control,{interactive:!1,miw:200,children:(t=(e=(0,a.default)((0,I.getStartOfWeek)({date:n,firstDayOfWeek:1}))).add(6,"day"),e.month()===t.month()?`${e.format("MMM D")} – ${t.format("D, YYYY")}`:`${e.format("MMM D")} – ${t.format("MMM D, YYYY")}`)}),(0,c.jsx)(eg.ScheduleHeader.Next,{onClick:()=>r((0,a.default)(n).add(1,"week").format("YYYY-MM-DD"))}),(0,c.jsx)(eg.ScheduleHeader.Today,{onClick:()=>r((0,a.default)().format("YYYY-MM-DD"))}),(0,c.jsx)(eg.ScheduleHeader.Control,{style:{marginInlineStart:"auto"},onClick:()=>window.print(),children:"Print"})]}),(0,c.jsx)(u.WeekView,{date:n,onDateChange:r,events:d,startTime:"08:00:00",endTime:"18:00:00",withHeader:!1})]})},code:[{code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import {
  DateStringValue,
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},eh={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,c.jsx)(u.WeekView,{date:e,onDateChange:t,events:d,startTime:"08:00:00",endTime:"18:00:00",radius:0})},code:[{code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { WeekView } from '@mantine/schedule';
import { events } from './data';
...
`},eb=(0,a.default)().startOf("week").add(2,"day").format("YYYY-MM-DD"),e$=(0,a.default)(eb).add(1,"day").format("YYYY-MM-DD"),eC=(0,a.default)(eb).add(2,"day").format("YYYY-MM-DD"),eO=[{id:1,title:"Conference Day",start:`${eb} 00:00:00`,end:(0,a.default)(eb).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"red"},{id:2,title:"Holiday",start:`${e$} 00:00:00`,end:(0,a.default)(e$).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"pink"},{id:3,title:"Team Building",start:`${eb} 00:00:00`,end:(0,a.default)(eC).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"orange"},{id:4,title:"Morning Standup",start:`${eb} 09:00:00`,end:`${eb} 09:30:00`,color:"blue"},{id:5,title:"Code Review",start:`${e$} 14:00:00`,end:`${e$} 15:00:00`,color:"violet"}],eH={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,c.jsx)(u.WeekView,{date:e,onDateChange:t,events:eO,startTime:"08:00:00",endTime:"18:00:00"})},code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { WeekView, ScheduleEventData } from '@mantine/schedule';
...
`},eV=(0,a.default)().startOf("week").add(2,"day").format("YYYY-MM-DD"),eA=(0,a.default)(eV).add(1,"day").format("YYYY-MM-DD"),eI=[{id:1,title:"Draggable Event",start:`${eV} 09:00:00`,end:`${eV} 10:00:00`,color:"blue"},{id:2,title:"Locked Event",start:`${eV} 11:00:00`,end:`${eV} 12:00:00`,color:"gray",payload:{locked:!0}},{id:3,title:"Another Draggable",start:`${eA} 14:00:00`,end:`${eA} 15:00:00`,color:"green"}],ez={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)((0,a.default)().format("YYYY-MM-DD")),[n,r]=(0,m.useState)(eI);return(0,c.jsx)(u.WeekView,{date:e,onDateChange:t,events:n,startTime:"08:00:00",endTime:"18:00:00",withEventsDragAndDrop:!0,onEventDrop:({eventId:e,newStart:t,newEnd:a})=>{r(n=>n.map(n=>n.id===e?{...n,start:t,end:a}:n))},canDragEvent:e=>!e.payload?.locked})},code:`
import { useState } from 'react';
import dayjs from 'dayjs';
import { WeekView, ScheduleEventData } from '@mantine/schedule';
...
`},eB=(0,a.default)().startOf("week").add(2,"day").format("YYYY-MM-DD"),eR=(0,a.default)(eB).add(1,"day").format("YYYY-MM-DD"),eN=[{id:1,title:"Resizable Event",start:`${eB} 09:00:00`,end:`${eB} 10:00:00`,color:"blue"},{id:2,title:"Locked Event",start:`${eB} 11:00:00`,end:`${eB} 12:00:00`,color:"gray",payload:{locked:!0}},{id:3,title:"Another Resizable",start:`${eR} 14:00:00`,end:`${eR} 15:00:00`,color:"green"}],eG={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)((0,a.default)().format("YYYY-MM-DD")),[n,r]=(0,m.useState)(eN);return(0,c.jsx)(u.WeekView,{date:e,onDateChange:t,events:n,startTime:"08:00:00",endTime:"18:00:00",withEventResize:!0,onEventResize:({eventId:e,newStart:t,newEnd:a})=>{r(n=>n.map(n=>n.id===e?{...n,start:t,end:a}:n))},canResizeEvent:e=>!e.payload?.locked})},code:`
import { useState } from 'react';
import dayjs from 'dayjs';
import { WeekView, ScheduleEventData } from '@mantine/schedule';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]},eP={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,m.useState)((0,a.default)().format("YYYY-MM-DD")),[n,r]=(0,m.useState)("week");return(0,c.jsxs)("div",{children:[(0,c.jsxs)(er.Text,{mb:"md",children:["Selected view: ",n]}),(0,c.jsx)(u.WeekView,{date:e,onDateChange:t,events:d,startTime:"08:00:00",endTime:"18:00:00",onViewChange:r})]})},code:[{code:`
import { useState } from 'react';
import dayjs from 'dayjs';
...
`,language:"tsx",fileName:"Demo.tsx"},{code:l,language:"tsx",fileName:"data.ts"}]};var eJ=(0,t.__exportAll)({allDayEvents:()=>eH,backgroundEvents:()=>eD,backgroundEventsCustomStyle:()=>ey,bidirectionalDragDrop:()=>es,businessHours:()=>H,businessHoursPerDay:()=>V,canDragEvent:()=>ez,canResizeEvent:()=>eG,controlledDate:()=>eL,currentTimeIndicator:()=>k,customHeader:()=>ew,dragDrop:()=>N,eventForm:()=>ee,eventResize:()=>P,externalDragDrop:()=>ed,firstDayOfWeek:()=>p,forceCurrentTimeIndicator:()=>h,getTimeSlotProps:()=>eU,highlightToday:()=>g,intervalMinutes:()=>v,localization:()=>ek,overlappingEvents:()=>A,radius:()=>eh,recurringEvents:()=>ec,renderEvent:()=>Z,renderEventBody:()=>ej,slotHeight:()=>O,slotLabelFormat:()=>C,startScrollTime:()=>et,staticMode:()=>q,timeRange:()=>D,timezone:()=>W,usage:()=>f,viewChange:()=>eP,weekLabelFormat:()=>$,weekdayFormat:()=>Y,withoutAllDaySlots:()=>j,withoutHeader:()=>b,withoutWeekNumber:()=>w,withoutWeekendDays:()=>y});e.s(["WeekViewDemos",0,eJ],953813)}]);