...
`},N={type:"code",component:function(){return(0,r.jsx)(a.Slider,{startPointValue:-50,min:-100,max:100,defaultValue:40,mb:40,marks:[{value:-100,label:"-100"},{value:-50,label:"-50"},{value:0,label:"0"},{value:50,label:"50"},{value:100,label:"100"}]})},code:`
import { Slider } from '@mantine/core';
...
`},R={type:"code",centered:!0,maxWidth:600,component:function(){let[e,t]=(0,r.useState)(null);return(0,n.jsx)(l.DatePicker,{fullWidth:!0,value:e,onChange:t})},code:`
import { useState } from 'react';
import { DatePicker } from '@mantine/dates';
...
`},T={type:"code",centered:!0,component:function(){return(0,n.jsx)(l.DatePicker,{withNativeLevelSelect:!0,yearsSelectRange:[2020,2035]})},code:`
import { DatePicker } from '@mantine/dates';

function Demo() {
  return <DatePicker withNativeLevelSelect yearsSelectRange={[2020, 2035]} />;
}
`};var A=(0,t.__exportAll)({controlProps:()=>c,controlledDate:()=>i,defaultDate:()=>m,defaultLevel:()=>b,deselect:()=>O,excludeDate:()=>Y,firstDayOfWeek:()=>y,fullWidth:()=>R,headerControlsOrder:()=>_,hideOutsideDates:()=>w,hideWeekdays:()=>M,labelFormat:()=>p,listFormat:()=>f,locale:()=>h,maxLevel:()=>x,minMax:()=>g,multiple:()=>$,nativeLevelSelect:()=>T,numberOfColumns:()=>E,presets:()=>C,presetsRange:()=>P,range:()=>F,renderDay:()=>S,singleRange:()=>z,sizeConfigurator:()=>W,usage:()=>L,weekendDays:()=>D,withWeekNumbers:()=>V});let{usage:L,multiple:$,deselect:O,range:F,singleRange:z,numberOfColumns:E,sizeConfigurator:W}=(0,a.getSharedPickerDemos)(l.DatePicker);e.s(["DatePickerDemos",0,A],341921)},615272,e=>{"use strict";var t=e.i(648863),a=e.i(485108),r=e.i(391398),n=e.i(545614),l=e.i(200140);let o={type:"code",component:function(){return(0,r.jsx)(a.Button,{...(0,n.useLongPress)(()=>l.notifications.show({message:"Long press triggered"})),children:"Press and hold"})},code:`
...
`,centered:!0};var i=(0,t.__exportAll)({usage:()=>o});e.s(["UseLongPressDemos",0,i],615272)},49425,e=>{"use strict";var t=e.i(648863),a=e.i(328940),r=e.i(391398);let n={type:"configurator",component:function(e){return(0,r.jsx)(a.RangeSlider,{defaultValue:[20,60],marks:[{value:20,label:"20%"},{value:50,label:"50%"},{value:80,label:"80%"}],...e})},code:`
