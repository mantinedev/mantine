...
`},{fileName:"data.ts",language:"tsx",code:l}]};var A={root:"m_78f70933",leaf:"m_78f427af"},E=e.i(56206),O=e.i(271270),G=e.i(419122),L=e.i(392211);function R({name:e,isFolder:t,expanded:a}){return e.endsWith("package.json")?(0,T.jsx)(G.NpmIcon,{size:14}):e.endsWith(".ts")||e.endsWith(".tsx")||e.endsWith("tsconfig.json")?(0,T.jsx)(L.TypeScriptCircleIcon,{size:14}):e.endsWith(".css")?(0,T.jsx)(O.CssIcon,{size:14}):t?a?(0,T.jsx)(s.FolderOpenIcon,{color:"var(--mantine-color-yellow-9)",size:14}):(0,T.jsx)(i.FolderSimpleIcon,{color:"var(--mantine-color-yellow-9)",size:14}):null}function M({node:e,expanded:t,hasChildren:a,elementProps:o}){return(0,T.jsxs)(d.Group,{gap:6,...o,className:(0,E.default)(A.leaf,o.className),children:[(0,T.jsx)(R,{name:e.value,isFolder:a,expanded:t}),(0,T.jsx)("span",{children:e.label})]})}let _={type:"code",component:function(){return(0,T.jsx)(z,{classNames:A,selectOnClick:!0,clearSelectionOnOutsideClick:!0,withLines:!0,data:n,renderNode:e=>(0,T.jsx)(M,{...e})})},centered:!0,maxWidth:340,code:[{fileName:"Demo.tsx",language:"tsx",code:`
...
`};var eA=e.i(280130);let eE=[{label:"src",value:"src",children:[{label:"components",value:"src/components",children:[{label:"Accordion.tsx",value:"src/components/Accordion.tsx"},{label:"Tree.tsx",value:"src/components/Tree.tsx"},{label:"Button.tsx",value:"src/components/Button.tsx"},{label:"Input.tsx",value:"src/components/Input.tsx"}]},{label:"hooks",value:"src/hooks",children:[{label:"use-debounce.ts",value:"src/hooks/use-debounce.ts"},{label:"use-media-query.ts",value:"src/hooks/use-media-query.ts"}]}]},{label:"public",value:"public",children:[{label:"favicon.ico",value:"public/favicon.ico"},{label:"logo.svg",value:"public/logo.svg"}]},{label:"package.json",value:"package.json"},{label:"tsconfig.json",value:"tsconfig.json"}];function eO({node:e,expanded:t,hasChildren:a,elementProps:o}){return(0,T.jsxs)(d.Group,{gap:6,...o,children:[a?t?(0,T.jsx)(s.FolderOpenIcon,{size:14,style:{opacity:.75}}):(0,T.jsx)(i.FolderSimpleIcon,{size:14,style:{opacity:.75}}):(0,T.jsx)(r.FileTextIcon,{size:14,style:{opacity:.75}}),(0,T.jsx)("span",{children:e.label})]})}let eG={type:"code",component:function(){let[e,t]=(0,b.useState)(""),a=(0,j.useTree)(),o=(0,b.useMemo)(()=>{let e;return e=new eA.default(function e(t){return t.reduce((t,a)=>(t.push(a),a.children&&t.push(...e(a.children)),t),[])}(eE),{keys:["label"],threshold:.3}),(t,a)=>e.search(t).some(e=>e.item.value===a.value)},[]),n=(0,b.useMemo)(()=>(0,Q.filterTreeData)(eE,e,o),[e,o]);return(0,T.jsxs)("div",{children:[(0,T.jsx)(Y.TextInput,{placeholder:"Fuzzy search...",mb:"sm",value:e,onChange:e=>(e=>{if(t(e),e.trim()){let t=(0,Q.filterTreeData)(eE,e,o);a.setExpandedState((0,j.getTreeExpandedState)(t,"*"))}else a.collapseAllNodes()})(e.currentTarget.value)}),(0,T.jsx)(z,{data:n,tree:a,withLines:!0,renderNode:e=>(0,T.jsx)(eO,{...e})})]})},centered:!0,maxWidth:340,code:`
import { useMemo, useState } from 'react';
import { FileTextIcon, FolderOpenIcon, FolderSimpleIcon } from '@phosphor-icons/react';
