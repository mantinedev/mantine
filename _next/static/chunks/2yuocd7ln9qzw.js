...
`,H=(0,D.createTheme)({components:{Input:n.Input.extend({classNames:{input:"m_8ca6a3cb"}}),InputWrapper:n.Input.Wrapper.extend({classNames:{label:"m_8ccacaf5"}})}}),T={type:"code",component:function(){return(0,r.jsxs)(b.MantineThemeProvider,{theme:H,children:[(0,r.jsx)(m.TextInput,{label:"Text input",placeholder:"Text input"}),(0,r.jsx)(M.NativeSelect,{mt:"md",label:"Native select",data:["React","Angular","Vue","Svelte"]})]})},centered:!0,maxWidth:340,code:[{fileName:"Demo.tsx",code:A,language:"tsx"},{fileName:"Demo.module.css",code:k,language:"scss"}]};var V={input:"m_4ba3a790"};let P={type:"code",component:function(){return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(n.Input,{placeholder:"Regular Input component",classNames:V}),(0,r.jsx)(m.TextInput,{placeholder:"TextInput component",label:"TextInput component",mt:"md",classNames:V})]})},maxWidth:340,centered:!0,code:[{fileName:"Demo.module.css",code:`
.input {
  transition: none;
...
`,language:"tsx"},{fileName:"data.ts",code:n,language:"tsx"}],centered:!0,controls:[{type:"number",prop:"size",initialValue:160,min:80,max:300,step:1,libraryValue:"__"}]},V={type:"code",component:function(){return(0,r.jsx)("div",{className:"m_e00fbef3",children:(0,r.jsx)(I,{data:a,strokeColor:"var(--card-bg)"})})},code:[{code:`
import { PieChart } from '@mantine/charts';
import { data } from './data';
import classes from './Demo.module.css';
...
`,language:"scss",fileName:"Demo.module.css"},{code:n,language:"tsx",fileName:"data.ts"}],centered:!0},P={type:"configurator",component:function(e){return(0,r.jsx)(I,{...e,data:a})},code:[{fileName:"Demo.tsx",code:`
import { PieChart } from '@mantine/charts';
import { data } from './data';
...
}`,centered:!0,maxWidth:"100%"},T=["blue","teal","grape"],V=["First","Second","Third"],P={type:"code",component:function(){return(0,u.jsx)(j,{h:200,children:V.map((e,t)=>(0,u.jsx)(j.Pane,{defaultSize:1===t?50:25,min:10,bg:T[t],c:"white",fw:500,style:{display:"flex",alignItems:"center",justifyContent:"center"},children:e},e))})},code:`
import { Splitter } from '@mantine/core';
...
`},H=(0,n.default)().startOf("month").format("YYYY-MM-DD"),T=(0,n.default)().date(15).format("YYYY-MM-DD"),V=(0,n.default)().format("YYYY-MM-DD"),P=(0,n.default)().endOf("month").format("YYYY-MM-DD"),R=[{id:1,title:"Team Meeting",start:`${H} 09:00:00`,end:`${H} 10:30:00`,color:"blue"},{id:2,title:"Project Deadline",start:`${T} 00:00:00`,end:(0,n.default)(T).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"red"},{id:3,title:"Client Call",start:`${V} 14:00:00`,end:`${V} 15:00:00`,color:"green"},{id:4,title:"Monthly Review",start:`${P} 00:00:00`,end:(0,n.default)(P).add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"violet"},{id:5,title:"Workshop",start:(0,n.default)().add(3,"day").format("YYYY-MM-DD 10:00:00"),end:(0,n.default)().add(3,"day").format("YYYY-MM-DD 12:00:00"),color:"orange"},{id:6,title:"Conference",start:(0,n.default)().add(5,"day").format("YYYY-MM-DD 00:00:00"),end:(0,n.default)().add(6,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),color:"cyan"}],Z={defaultExpanded:!1,type:"code",component:function(){return(0,a.jsx)(r.AgendaView,{rangeStart:(0,n.default)().startOf("month").format("YYYY-MM-DD"),rangeEnd:(0,n.default)().endOf("month").format("YYYY-MM-DD"),events:R,mode:"static"})},centered:!0,maxWidth:500,code:[{code:`
import dayjs from 'dayjs';
import { AgendaView } from '@mantine/schedule';
...
`,centered:!0};var T=e.i(485108),V=e.i(725695),P=e.i(671640);let R={type:"code",component:function(){let[e,t]=(0,g.useState)(null);return(0,h.jsxs)(P.Stack,{children:[(0,h.jsxs)(V.Group,{children:[(0,h.jsx)(T.Button,{variant:"default",onClick:()=>t(0),children:"Open File"}),(0,h.jsx)(T.Button,{variant:"default",onClick:()=>t(1),children:"Open Edit"}),(0,h.jsx)(T.Button,{variant:"default",onClick:()=>t(null),children:"Close all"})]}),(0,h.jsxs)(C,{openIndex:e,onOpenChange:t,children:[(0,h.jsxs)(C.Menu,{width:220,children:[(0,h.jsx)(C.Target,{children:"File"}),(0,h.jsxs)(C.Dropdown,{children:[(0,h.jsx)(a.Menu.Item,{children:"New file"}),(0,h.jsx)(a.Menu.Item,{children:"Save"})]})]}),(0,h.jsxs)(C.Menu,{width:220,children:[(0,h.jsx)(C.Target,{children:"Edit"}),(0,h.jsxs)(C.Dropdown,{children:[(0,h.jsx)(a.Menu.Item,{children:"Undo"}),(0,h.jsx)(a.Menu.Item,{children:"Redo"})]})]})]})]})},code:`
import { useState } from 'react';
...
`,centered:!0},V={type:"code",component:function(){let[e,t]=(0,a.useState)([]);return(0,j.jsx)(H,{data:["React","Angular","Vue","Svelte"],value:e,onChange:t,multiple:!0,children:(0,j.jsx)(H.Target,{children:(0,j.jsx)(n.Button,{variant:"default",miw:200,children:e.length>0?e.join(", "):"Select frameworks"})})})},code:`
import { useState } from 'react';
import { Button, ComboboxPopover } from '@mantine/core';
...
`,centered:!0},P={type:"code",component:function(){let[e,t]=(0,a.useState)(null);return(0,j.jsx)(H,{data:[{group:"Frontend",items:["React","Angular","Vue"]},{group:"Backend",items:["Node.js","Django","Rails"]}],value:e,onChange:t,children:(0,j.jsx)(H.Target,{children:(0,j.jsx)(n.Button,{variant:"default",miw:200,children:e||"Select technology"})})})},code:`
import { useState } from 'react';
import { Button, ComboboxPopover } from '@mantine/core';
...
`},P={defaultExpanded:!1,type:"code",component:function(){let[e,t]=(0,d.useState)((0,a.default)().format("YYYY-MM-DD"));return(0,c.jsx)(u.ResourcesMonthView,{date:e,onDateChange:t,resources:i,events:l,dayWidth:60,rowHeight:64,startScrollDate:(0,a.default)().format("YYYY-MM-DD")})},code:[{code:`
import dayjs from 'dayjs';
import { useState } from 'react';
import { ResourcesMonthView } from '@mantine/schedule';
import { events, resources } from './data';
