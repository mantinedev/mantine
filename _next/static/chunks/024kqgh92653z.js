(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,648863,e=>{"use strict";var t=Object.defineProperty;e.s(["__exportAll",0,(e,r)=>{let n={};for(var i in e)t(n,i,{get:e[i],enumerable:!0});return r||t(n,Symbol.toStringTag,{value:"Module"}),n}])},80267,e=>{"use strict";var t=e.i(191788);let r={x:0,y:0,width:0,height:0,top:0,left:0,bottom:0,right:0};function n(e){let n=(0,t.useRef)(0),[i,o]=(0,t.useState)(r),s=(0,t.useRef)(null);return[(0,t.useCallback)(t=>{s.current&&(s.current.disconnect(),s.current=null),n.current&&cancelAnimationFrame(n.current),t&&(s.current=new ResizeObserver(e=>{let t=e[0];t&&(cancelAnimationFrame(n.current),n.current=requestAnimationFrame(()=>{let e=t.borderBoxSize?.[0]||t.contentBoxSize?.[0];e?o({width:e.inlineSize,height:e.blockSize,x:t.contentRect.x,y:t.contentRect.y,top:t.contentRect.top,left:t.contentRect.left,bottom:t.contentRect.bottom,right:t.contentRect.right}):o(t.contentRect)}))}),s.current.observe(t,e))},[e]),i]}e.s(["useElementSize",0,function(e){let[t,{width:r,height:i}]=n(e);return{ref:t,width:r,height:i}},"useResizeObserver",0,n])},560111,e=>{"use strict";var t=e.i(648863),r=e.i(725695),n=e.i(245745),i=e.i(391398),o=e.i(80267);let s={type:"code",code:[{code:`
