...
`,maxWidth:340,centered:!0};var A=e.i(123895),P=e.i(726869);let H=`
...
`,maxWidth:340,centered:!0};var Z=e.i(931882),R=e.i(671640);let k={type:"code",component:function(){return(0,l.jsxs)(R.Stack,{children:[(0,l.jsx)(a.MultiSelect,{label:"clearSectionMode='both' (default)",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],defaultValue:["React"],clearable:!0,rightSection:(0,l.jsx)(Z.CaretDownIcon,{size:16}),clearSectionMode:"both"}),(0,l.jsx)(a.MultiSelect,{label:"clearSectionMode='rightSection'",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],defaultValue:["React"],clearable:!0,rightSection:(0,l.jsx)(Z.CaretDownIcon,{size:16}),clearSectionMode:"rightSection"}),(0,l.jsx)(a.MultiSelect,{label:"clearSectionMode='clear'",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],defaultValue:["React"],clearable:!0,rightSection:(0,l.jsx)(Z.CaretDownIcon,{size:16}),clearSectionMode:"clear"})]})},code:`
...
`};var I=e.i(485108),O=e.i(541772);let z={type:"code",component:function(){let[e,{toggle:t}]=(0,O.useDisclosure)();return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(I.Button,{onClick:t,mb:"md",children:"Toggle dropdown"}),(0,l.jsx)(a.MultiSelect,{label:"Your favorite library",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],dropdownOpened:e})]})},code:`
...
`,maxWidth:340,centered:!0},T={type:"code",component:function(){return(0,l.jsx)(a.MultiSelect,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{position:"top",middlewares:{flip:!1,shift:!1}}})},code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0};var L=e.i(392862);let _={type:"code",code:`
...
`,centered:!0,component:function(){return(0,l.jsxs)(L.Popover,{width:300,position:"bottom",withArrow:!0,shadow:"md",children:[(0,l.jsx)(L.Popover.Target,{children:(0,l.jsx)(I.Button,{children:"Toggle popover"})}),(0,l.jsx)(L.Popover.Dropdown,{children:(0,l.jsx)(a.MultiSelect,{label:"Your favorite libraries",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],comboboxProps:{withinPortal:!1}})})]})}};var N={dropdown:"m_a9824888",input:"m_f5487eb3"};let G={type:"code",component:function(){return(0,l.jsx)(a.MultiSelect,{label:"Your favorite library",placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],classNames:N,comboboxProps:{position:"bottom",middlewares:{flip:!1,shift:!1},offset:0}})},code:[{fileName:"Demo.tsx",code:`
import { MultiSelect } from '@mantine/core';
...
`,maxWidth:340,centered:!0};var er=e.i(280130);let en=({options:e,search:t})=>t.trim()?new er.default(e,{keys:["label"],threshold:.3,minMatchCharLength:1}).search(t).map(e=>e.item):e,ei={type:"code",component:function(){return(0,l.jsx)(a.MultiSelect,{label:"What countries have you visited?",placeholder:"Pick values",data:["Great Britain","Russian Federation","United States","Germany","France"],filter:en,searchable:!0})},code:`
import { MultiSelect, ComboboxItem, OptionsFilter } from '@mantine/core';
...
`,maxWidth:340,centered:!0},ec={type:"code",component:function(){return(0,l.jsx)(a.MultiSelect,{placeholder:"Pick values",data:["React","Angular","Vue","Svelte"],loading:!0})},code:`
import { MultiSelect } from '@mantine/core';
