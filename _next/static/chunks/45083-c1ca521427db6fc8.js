...
`,s={type:"code",component:function(){let e=(0,l.c)({initialValues:{name:"",age:0},validate:{name:(0,i.U)("Name is required"),age:(0,m.m)({min:18},"You must be at least 18 to register")}});return r.createElement(r.Fragment,null,r.createElement(o.o,{...e.getInputProps("name"),label:"Name",placeholder:"Name"}),r.createElement(a.Y,{...e.getInputProps("age"),label:"Age",placeholder:"Age",mt:"md"}),r.createElement(u.z,{onClick:()=>new Promise(e=>{setTimeout(()=>{e({name:"John Doe",age:25})},1e3)}).then(t=>e.initialize(t)),mt:"md"},"Initialize form"))},code:c,centered:!0,maxWidth:340}},42697:function(e,t,n){n.d(t,{Y:function(){return E}});var r=n(2784),o=n(40489),a=n(9462),u=n(9341),l=n(82692),i=n(70837),m=n(91482),c=n(11200),s=n(51477),p=n(62378),f=n(38483),d=n(82027),g=n(73063),b=n(63409);function h({direction:e,style:t,...n}){return r.createElement("svg",{style:{width:"var(--ni-chevron-size)",height:"var(--ni-chevron-size)",transform:"up"===e?"rotate(180deg)":void 0,...t},viewBox:"0 0 15 15",fill:"none",xmlns:"http://www.w3.org/2000/svg",...n},r.createElement("path",{d:"M3.13523 6.15803C3.3241 5.95657 3.64052 5.94637 3.84197 6.13523L7.5 9.56464L11.158 6.13523C11.3595 5.94637 11.6759 5.95657 11.8648 6.15803C12.0536 6.35949 12.0434 6.67591 11.842 6.86477L7.84197 10.6148C7.64964 10.7951 7.35036 10.7951 7.15803 10.6148L3.15803 6.86477C2.95657 6.67591 2.94637 6.35949 3.13523 6.15803Z",fill:"currentColor",fillRule:"evenodd",clipRule:"evenodd"}))}var v={root:"m_e2f5cd4e",controls:"m_95e17d22",control:"m_80b4b171"};let y=/^-0(\.0*)?$/,I=/^-?0\d+$/;function w(e,t,n){return void 0===e||(void 0===t||e>=t)&&(void 0===n||e<=n)}let N={step:1,clampBehavior:"blur",allowDecimal:!0,allowNegative:!0,startValue:0},P=(0,c.Z)((e,{size:t})=>({controls:{"--ni-chevron-size":(0,m.ap)(t,"ni-chevron-size")}})),E=(0,d.d)((e,t)=>{let n=(0,f.w)("NumberInput",N,e),{className:m,classNames:c,styles:d,unstyled:E,vars:A,onChange:F,onValueChange:j,value:x,defaultValue:V,max:O,min:D,step:k,hideControls:T,rightSection:Y,isAllowed:_,clampBehavior:M,onBlur:R,allowDecimal:z,decimalScale:S,onKeyDown:C,handlersRef:B,startValue:G,disabled:J,rightSectionPointerEvents:L,allowNegative:W,readOnly:U,size:q,rightSectionWidth:$,stepHoldInterval:Z,stepHoldDelay:K,allowLeadingZeros:X,...H}=n,Q=(0,p.y)({name:"NumberInput",classes:v,props:n,classNames:c,styles:d,unstyled:E,vars:A,varsResolver:P}),{resolvedClassNames:ee,resolvedStyles:et}=(0,s.h)({classNames:c,styles:d,props:n}),[en,er]=(0,u.C)({value:x,defaultValue:V,onChange:F}),eo=void 0!==K&&void 0!==Z,ea=(0,r.useRef)(null),eu=(0,r.useRef)(null),el=(0,r.useRef)(0),ei=e=>{let t=String(e).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);return t?Math.max(0,(t[1]?t[1].length:0)-(t[2]?+t[2]:0)):0},em=(0,r.useRef)();em.current=()=>{let e;let t=ei(en),n=ei(k),r=Math.max(t,n),o=10**r;if("number"!=typeof en||Number.isNaN(en))e=(0,l.u)(G,D,O);else if(void 0!==O){let t=(Math.round(en*o)+Math.round(k*o))/o;e=t<=O?t:O}else e=(Math.round(en*o)+Math.round(k*o))/o;let a=e.toFixed(r);er(parseFloat(a)),j?.({floatValue:parseFloat(a),formattedValue:a,value:a},{source:"increment"})};let ec=(0,r.useRef)();ec.current=()=>{let e;let t=ei(en),n=ei(k),r=Math.max(t,n),o=10**r;if("number"!=typeof en||Number.isNaN(en))e=(0,l.u)(G,D,O);else{let t=(Math.round(en*o)-Math.round(k*o))/o;e=void 0!==D&&t<D?D:t}let a=e.toFixed(r);er(parseFloat(a)),j?.({floatValue:parseFloat(a),formattedValue:a,value:a},{source:"decrement"})},(0,i.kR)(B,{increment:em.current,decrement:ec.current});let es=e=>{e?em.current():ec.current(),el.current+=1},ep=e=>{if(es(e),eo){let t="number"==typeof Z?Z:Z(el.current);eu.current=window.setTimeout(()=>ep(e),t)}},ef=(e,t)=>{e.preventDefault(),ea.current?.focus(),es(t),eo&&(eu.current=window.setTimeout(()=>ep(t),K))},ed=()=>{eu.current&&window.clearTimeout(eu.current),eu.current=null,el.current=0},eg=r.createElement("div",{...Q("controls")},r.createElement(b.k,{...Q("control"),tabIndex:-1,"aria-hidden":!0,disabled:J||"number"==typeof en&&void 0!==O&&en>=O,mod:{direction:"up"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{ef(e,!0)},onPointerUp:ed,onPointerLeave:ed},r.createElement(h,{direction:"up"})),r.createElement(b.k,{...Q("control"),tabIndex:-1,"aria-hidden":!0,disabled:J||"number"==typeof en&&void 0!==D&&en<=D,mod:{direction:"down"},onMouseDown:e=>e.preventDefault(),onPointerDown:e=>{ef(e,!1)},onPointerUp:ed,onPointerLeave:ed},r.createElement(h,{direction:"down"})));return r.createElement(g.M,{component:a.h3,allowNegative:W,className:(0,o.Z)(v.root,m),size:q,...H,readOnly:U,disabled:J,value:en,getInputRef:(0,i.Yx)(t,ea),onValueChange:(e,t)=>{if("event"===t.source){var n;er(!(("number"==typeof(n=e.floatValue)?n<Number.MAX_SAFE_INTEGER:!Number.isNaN(Number(n)))&&!Number.isNaN(n))||y.test(e.value)||X&&I.test(e.value)?e.value:e.floatValue)}j?.(e,t)},rightSection:T||U?Y:Y||eg,classNames:ee,styles:et,unstyled:E,__staticSelector:"NumberInput",decimalScale:z?S:0,onKeyDown:e=>{C?.(e),U||("ArrowUp"===e.key&&(e.preventDefault(),em.current()),"ArrowDown"===e.key&&(e.preventDefault(),ec.current()))},rightSectionPointerEvents:L??(J?"none":void 0),rightSectionWidth:$??`var(--ni-right-section-width-${q||"sm"})`,allowLeadingZeros:X,onBlur:e=>{if(R?.(e),"blur"===M&&"number"==typeof en){let e=(0,l.u)(en,D,O);e!==en&&er((0,l.u)(en,D,O))}},isAllowed:e=>"strict"===M?_?_(e)&&w(e.floatValue,D,O):w(e.floatValue,D,O):!_||_(e)})});E.classes={...g.M.classes,...v},E.displayName="@mantine/core/NumberInput"},73846:function(e,t,n){n.d(t,{m:function(){return r}});function r({min:e,max:t},n){let r=n||!0;return n=>{if("number"!=typeof n)return r;let o=!0;return"number"==typeof e&&n<e&&(o=!1),"number"==typeof t&&n>t&&(o=!1),o?null:r}}},3095:function(e,t,n){n.d(t,{U:function(){return r}});function r(e){let t=e||!0;return e=>"string"==typeof e?e.trim().length>0?null:t:Array.isArray(e)?e.length>0?null:t:null==e||!1===e?t:null}}}]);