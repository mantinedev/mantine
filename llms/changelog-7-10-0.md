...
New [Tree](https://mantine.dev/llms/core-tree.md) component:
...
in [SimpleGrid](https://mantine.dev/llms/core-simple-grid.md) component. With container queries, grid columns and spacing
...
New [Checkbox.Indicator](https://mantine.dev/llms/core-checkbox.md#checkboxindicator) and [Radio.Indicator](https://mantine.dev/llms/core-radio.md#radioindicator)
...
New [Checkbox.Card](https://mantine.dev/llms/core-checkbox.md#checkboxcard-component) and [Radio.Card](https://mantine.dev/llms/core-radio.md#radiocard-component)
...
New [bd style prop](https://mantine.dev/llms/styles-style-props.md) can be used to set `border` CSS property.
