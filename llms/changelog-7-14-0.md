...
New [AngleSlider](https://mantine.dev/llms/core-angle-slider.md) component:
...
New [RadialBarChart](https://mantine.dev/llms/charts-radial-bar-chart.md) component:
...
New [FunnelChart](https://mantine.dev/llms/charts-funnel-chart.md) component:
...
New [Modal.Stack](https://mantine.dev/llms/core-modal.md) and [Drawer.Stack](https://mantine.dev/llms/core-drawer.md) components simplify usage of multiple modals/drawers at the same time.
...
[Slider](https://mantine.dev/llms/core-slider.md) component now supports `restrictToMarks` prop that restricts slider value to marks only.
...
[BarChart](https://mantine.dev/llms/charts-bar-chart.md) now can be used with SVG pattern fill:
...
* [useTree](https://mantine.dev/llms/core-tree.md) hook now accepts `onNodeExpand` and `onNodeCollapse` callbacks
* [useTree](https://mantine.dev/llms/core-tree.md) hook now returns additional `checkAllNodes`, `uncheckAllNodes` and `setCheckedState` handlers
* [Tree](https://mantine.dev/llms/core-tree.md) component now includes `getTreeExpandedState` to generate expanded state based on the tree data
* [use-form](https://mantine.dev/llms/form-use-form.md) now supports `form.replaceListItem` handler to replace list item at given index
