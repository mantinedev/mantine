...
New [use-scroll-spy](https://mantine.dev/llms/hooks-use-scroll-spy.md) hook tracks scroll position and returns index of the
...
New [TableOfContents](https://mantine.dev/llms/core-table-of-contents.md) component is built on top of `use-scroll-spy` hook
...
[Popover](https://mantine.dev/llms/core-popover.md) and other components based on it now support `withOverlay` prop:
...
in [Carousel](https://mantine.dev/llms/x-carousel.md) component. With container queries, all responsive values
...
[RangeSlider](https://mantine.dev/llms/core-range-slider.md) component now supports `restrictToMarks` prop:
...
[Pagination](https://mantine.dev/llms/core-pagination.md) component now supports `withPages` prop which allows hiding pages
...
[use-form](https://mantine.dev/llms/form-use-form.md) hook now supports `touchTrigger` option that allows customizing events that change touched state.
...
* [Autocomplete](https://mantine.dev/llms/core-autocomplete.md) now supports `clearable` prop
* [where-\* mixins](https://mantine.dev/llms/styles-postcss-preset.md#where--mixins) documentation has been added
* [use-local-storage](https://mantine.dev/llms/hooks-use-local-storage.md) hook now supports `sync` option which allows disabling synchronization between browser tabs
