...
To select one of the options in the [Select](https://mantine.dev/core/select) or
...
Selecting options in the [MultiSelect](https://mantine.dev/core/multi-select) and
