...
To migrate your application to Mantine 8.0, follow [7.x → 8.x migration guide](https://mantine.dev/llms/guides-7x-to-8x.md).
...
[Menu](https://mantine.dev/llms/core-menu.md) component now supports submenus:
...
[Popover](https://mantine.dev/llms/core-popover.md) component now supports `hideDetached` prop to configure how the dropdown behaves when the target
...
Follow [7.x → 8.x migration guide](https://mantine.dev/llms/guides-7x-to-8x.md) to learn how to update the code to use new string values.

Example of using [DatePicker](https://mantine.dev/llms/dates-date-picker.md) component with string values:
...
New [TimePicker](https://mantine.dev/llms/dates-time-picker.md) component is an alternative to
[TimeInput](https://mantine.dev/llms/dates-time-input.md) that offers more features. It supports 24-hour and 12-hour formats,
...
[DateTimePicker](https://mantine.dev/llms/dates-date-time-picker.md) component now uses [TimePicker](https://mantine.dev/llms/dates-time-picker.md) under
the hood instead of [TimeInput](https://mantine.dev/llms/dates-time-input.md). You can now use all [TimePicker](https://mantine.dev/llms/dates-time-picker.md)
features with [DateTimePicker](https://mantine.dev/llms/dates-date-time-picker.md) component.

Prop `timeInputProps` is no longer available, to pass props down to the underlying [TimePicker](https://mantine.dev/llms/dates-time-picker.md)
...
New [TimeValue](https://mantine.dev/llms/dates-time-value.md) component can be used to display a formatted time string
with similar formatting options to [TimePicker](https://mantine.dev/llms/dates-time-picker.md) component.
...
New [TimeGrid](https://mantine.dev/llms/dates-time-grid.md) component allows to capture time value from the user with a
...
New [Heatmap](https://mantine.dev/llms/charts-heatmap.md) component allows to display data in a calendar heatmap format:
...
[@mantine/code-highlight](https://mantine.dev/llms/x-code-highlight.md) package no longer depends on
...
updated [CodeHighlight documentation](https://mantine.dev/llms/x-code-highlight.md) and [7.x → 8.x migration guide](https://mantine.dev/llms/guides-7x-to-8x.md).

## CodeHighlight with shiki

You can now use [CodeHighlight](https://mantine.dev/llms/x-code-highlight.md) component with [shiki](https://shiki.matsu.io/).
...
[@mantine/carousel](https://mantine.dev/llms/x-carousel.md) package was updated to use the latest version of
...
Follow the [7.x → 8.x migration guide](https://mantine.dev/llms/guides-7x-to-8x.md) to update your application to use the latest version of `@mantine/carousel`.

## Switch withThumbIndicator

[Switch](https://mantine.dev/llms/core-switch.md) component styles were updated to include indicator inside the thumb.
...
and `shadows` types. To learn more about this feature, follow [this guide](https://mantine.dev/llms/guides-typescript.md#theme-object-declarations).
...
* [Kbd](https://mantine.dev/llms/core-kbd.md) component now supports `size` prop
* [DateInput](https://mantine.dev/llms/dates-date-input.md) component no longer supports `preserveTime` prop, use different component to capture time values
* [ScrollArea](https://mantine.dev/llms/core-scroll-area.md) component no longer has forced `display: table` styles on the wrapper element of the content. It also now supports `content` Styles API selector to apply styles to the content element.
* [ImageIcon](https://mantine.dev/llms/core-image.md) component no longer includes `flex: 0` styles by default
* [SegmentedControl](https://mantine.dev/llms/core-segmented-control.md) default height values were changed to match sizes of [Input](https://mantine.dev/llms/core-input.md) components
...
* [Portal](https://mantine.dev/llms/core-portal.md) component now has `reuseTargetNode` prop enabled by default
* [use-form](https://mantine.dev/llms/form-use-form.md) `setFieldValue` handler types are now stricter
* [Menu.Item](https://mantine.dev/llms/core-menu.md) no longer has `data-hovered` attribute, use `:hover` and `:focus` selectors instead to apply styles
* [use-os](https://mantine.dev/llms/hooks-use-os.md) now supports Chrome OS detection, its return type now includes `chromeos` value in the union
* The default eye dropper icon of [ColorInput](https://mantine.dev/llms/core-color-input.md) component was updated
* The default spacing of [Notification](https://mantine.dev/llms/core-notification.md) component was increased
* [CodeIcon](https://mantine.dev/llms/core-code.md) component color styles were updated
