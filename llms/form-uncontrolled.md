...
stored in React state and all components are rerendered when the form data changes.
...
Uncontrolled mode is an alternative form mode introduced in the 7.8.0 release.
...
[form.getInputProps](https://mantine.dev/llms/form-get-input-props.md) returns different props for controlled
...
In case you need to have a [list of fields](https://mantine.dev/llms/form-nested.md#nested-arrays),
...
`defaultValue` is to use the [use-uncontrolled](https://mantine.dev/llms/hooks-use-uncontrolled.md) hook:
