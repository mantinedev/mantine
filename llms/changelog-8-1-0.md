...
[DatePicker](https://mantine.dev/llms/dates-date-picker.md), [DatePickerInput](https://mantine.dev/llms/dates-date-picker-input.md)
and [DateTimePicker](https://mantine.dev/llms/dates-date-time-picker.md) now support `presets` prop
...
[Calendar](https://mantine.dev/llms/dates-calendar.md) and other components based on it now support `headerControlsOrder` prop.
...
[Popover](https://mantine.dev/llms/core-popover.md) component now handles `shift` and `flip` Floating UI
...
in the dropdown. For example, searchable [Select](https://mantine.dev/llms/core-select.md) and [DatePickerInput](https://mantine.dev/llms/dates-date-picker-input.md)
...
New [use-long-press](https://mantine.dev/llms/hooks-use-long-press.md) hook:
...
[BarChart](https://mantine.dev/llms/charts-bar-chart.md), [AreaChart](https://mantine.dev/llms/charts-area-chart.md) and [LineChart](https://mantine.dev/llms/charts-line-chart.md)
...
[use-form](https://mantine.dev/llms/form-use-form.md) now has a `resetField` method that resets field value to its initial value:
...
You can now use `isDuplicate` prop in [TagsInput](https://mantine.dev/llms/core-tags-input.md) component
...
[Slider](https://mantine.dev/llms/core-slider.md) component now supports `domain` prop that allows
...
[RangeSlider](https://mantine.dev/llms/core-range-slider.md) component now supports `pushOnOverlap` prop that defines
...
For example, you can now import [use-uncontrolled](https://mantine.dev/llms/hooks-use-uncontrolled.md) types like this:
...
You can now use zod v4 with [use-form](https://mantine.dev/llms/form-use-form.md). To use zod 4:
...
* [use-debounced-callback](https://mantine.dev/llms/hooks-use-debounced-callback.md) documentation was updated to include new `flush` and `flushOnUnmount` features
...
* [DateTimePicker](https://mantine.dev/llms/dates-date-time-picker.md) now supports `defaultTimeValue` prop
* [Tooltip](https://mantine.dev/llms/core-tooltip.md) now supports `autoContrast` prop.
* Handlers returned from [use-counter](https://mantine.dev/llms/hooks-use-counter.md) are now memoized.
* Return value of [use-event-listener](https://mantine.dev/llms/hooks-use-event-listener.md), [use-focus-within](https://mantine.dev/llms/hooks-use-focus-within.md), [use-focus-trap](https://mantine.dev/llms/hooks-use-focus-trap.md), [use-hover](https://mantine.dev/llms/hooks-use-hover.md), [use-move](https://mantine.dev/llms/hooks-use-move.md), [use-radial-move](https://mantine.dev/llms/hooks-use-radial-move.md) changed (`React.RefObject` -> `React.RefCallback`), required to fix incorrect ref handling in several cases. For more information, see the issue on GitHub – [#7406](https://github.com/mantinedev/mantine/issues/7406).
...
* `positionDependencies` prop is now deprecated in [Tooltip](https://mantine.dev/llms/core-tooltip.md), [Popover](https://mantine.dev/llms/core-popover.md) and other components based on Popover. The prop is no longer required and can be safely removed. `positionDependencies` prop will be removed in 9.0 release.
