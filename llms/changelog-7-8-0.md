...
Start from version `1.14.4` [postcss-preset-mantine](https://mantine.dev/llms/styles-postcss-preset.md)
...
[useForm](https://mantine.dev/llms/form-use-form.md) hook now supports [uncontrolled mode](https://mantine.dev/llms/form-uncontrolled.md).
...
You can now customize `middlewares` options in [Popover](https://mantine.dev/llms/core-popover.md) component and
in other components ([Menu](https://mantine.dev/llms/core-menu.md), [Select](https://mantine.dev/llms/core-select.md), [Combobox](https://mantine.dev/llms/core-combobox.md), etc.)
based on Popover.
...
New [use-fetch](https://mantine.dev/llms/hooks-use-fetch.md) hook:
...
New [use-map](https://mantine.dev/llms/hooks-use-map.md) hook:
...
New [use-set](https://mantine.dev/llms/hooks-use-set.md) hook:
...
New [use-debounced-callback](https://mantine.dev/llms/hooks-use-debounced-callback.md) hook:
...
New [use-throttled-state](https://mantine.dev/llms/hooks-use-throttled-state.md) hook:
...
New [use-throttled-value](https://mantine.dev/llms/hooks-use-throttled-value.md) hook:
...
New [use-throttled-callback](https://mantine.dev/llms/hooks-use-throttled-callback.md) hook:
...
New [use-orientation](https://mantine.dev/llms/hooks-use-orientation.md) hook:
...
New [use-is-first-render](https://mantine.dev/llms/hooks-use-is-first-render.md) hook:
...
* New [uncontrolled form](https://mantine.dev/llms/form-uncontrolled.md) guide
* [onValuesChange](https://mantine.dev/llms/form-values.md#onvalueschange) documentation has been added
* A new demo has been added to [tiptap](https://mantine.dev/llms/x-tiptap.md#typography-styles) that shows how to customize typography styles
* A new guide has been added to customize [Popover](https://mantine.dev/llms/core-popover.md#customize-middleware-options) middlewares

## Other changes

* [NumberInput](https://mantine.dev/llms/core-number-input.md) now supports `withKeyboardEvents={false}` to disable up/down arrow keys handling
* [Popover](https://mantine.dev/llms/core-popover.md) [shift](https://floating-ui.com/docs/shift) middleware now has default padding of 5px to offset dropdown near the edge of the viewport
