...
* After finalizing the issue details, you can begin working on the code.
...
* Set up the project – `npm run setup`
* Build a local version of all packages – `npm run build all`
