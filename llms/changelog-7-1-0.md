...
All [polymorphic](https://mantine.dev/llms/guides-polymorphic.md) components now support `renderRoot` prop, which
...
* Target component props are incompatible with Mantine component. For example, [Button](https://mantine.dev/llms/core-button.md) component expects `className`
...
[style](https://mantine.dev/llms/styles-style.md) prop is no longer restricted by `React.CSSProperties` type:
...
[@mantine/form](https://mantine.dev/llms/form-values.md#setinitialvalues-handler) now supports `form.setInitialValues` method
