...
export function Usage() {
  ...
  return (
    <ResourceMonthView date={date} onDateChange={setDate} resources={resources} events={events} />
  );
}
  ...
  return (
    <div style={{ padding: 40 }}>
      <Stack gap="md">
        ...
        <ResourceMonthView date={new Date()} resources={resources} events={events} mode="static" />
      </Stack>
    </div>
  );
}
