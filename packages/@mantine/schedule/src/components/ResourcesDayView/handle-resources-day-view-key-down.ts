...
export type ResourcesDayViewControlsRef = RefObject<HTMLButtonElement[][]>;
...
function getControlsSize(controlsRef: ResourcesDayViewControlsRef): number[] | null {
...
interface FocusOnNextControlInput {
  controlsRef: ResourcesDayViewControlsRef;
  direction: Direction;
  resourceIndex: number;
  slotIndex: number;
  size: number[];
...
export interface HandleResourcesDayViewKeyDownInput {
  controlsRef: ResourcesDayViewControlsRef;
  resourceIndex: number;
  slotIndex: number;
...
export function handleResourcesDayViewKeyDown({
  controlsRef,
  resourceIndex,
  slotIndex,
  event,
}: HandleResourcesDayViewKeyDownInput): void {
