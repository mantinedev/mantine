...
export type ResourceDayViewControlsRef = RefObject<HTMLButtonElement[][]>;
...
function getControlsSize(controlsRef: ResourceDayViewControlsRef): number[] | null {
...
interface FocusOnNextControlInput {
  controlsRef: ResourceDayViewControlsRef;
  direction: Direction;
  resourceIndex: number;
  slotIndex: number;
  size: number[];
...
export interface HandleResourceDayViewKeyDownInput {
  controlsRef: ResourceDayViewControlsRef;
  resourceIndex: number;
  slotIndex: number;
...
export function handleResourceDayViewKeyDown({
  controlsRef,
  resourceIndex,
  slotIndex,
  event,
}: HandleResourceDayViewKeyDownInput): void {
