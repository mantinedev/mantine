export const light = {
  ...
  colors: {
    ...
    'button.border': '#25262B00',
    'button.foreground': '#fff',
    'button.hoverBackground': '#0065FFA8',
    'button.secondaryBackground': '#25262BE5',
    ...
    'checkbox.foreground': '#25262B',
    'commandCenter.activeBackground': '#0065ff3f',
    'commandCenter.activeBorder': '#0065FF00',
    'commandCenter.activeForeground': '#535355',
    'commandCenter.background': '#EBEEF5',
    ...
    'dropdown.foreground': '#25262B',
    'dropdown.listBackground': '#F1F4FB',
    'diffEditor.diagonalFill': '#C4C7CD',
    'diffEditor.insertedTextBackground': '#45B74666',
    ...
    'editor.selectionHighlightBackground': '#1098AD59',
    'editor.selectionHighlightBorder': '#1098AD00',
    ...
    'editorIndentGuide.activeBackground1': '#FC8357CC',
    ...
    'editorOverviewRuler.selectionHighlightForeground': '#1098ADAD',
    'editorOverviewRuler.warningForeground': '#FC8357',
    'editorOverviewRuler.wordHighlightForeground': '#1098ADAD',
    ...
    'gitDecoration.untrackedResourceForeground': '#44C145',
    ...
    'list.activeSelectionBackground': '#598DEF66',
    'list.activeSelectionForeground': '#25262B',
    ...
    'mergeEditor.conflict.handledFocused.border': '#EC0000',
    'mergeEditor.conflict.handledUnfocused.border': '#EC0000',
    'mergeEditor.conflict.handled.minimapOverViewRuler': '#EC0000',
    'mergeEditor.conflict.unhandled.minimapOverViewRuler': '#EC0000',
    'mergeEditor.conflict.unhandledFocused.border': '#EC0000',
    'mergeEditor.conflict.unhandledUnfocused.border': '#EC0000',
    'mergeEditor.change.background': '#45B7462E',
    'mergeEditor.change.word.background': '#45B74666',
    ...
    'profileBadge.background': '#B3B3B4',
    ...
    'settings.checkboxForeground': '#25262B',
    'settings.dropdownBackground': '#F1F4FB',
    'settings.dropdownBorder': '#CED1D7',
    'settings.dropdownForeground': '#25262B',
    ...
    'sideBarSectionHeader.foreground': '#25262B',
    'sideBarTitle.foreground': '#25262B',
    'statusBar.background': '#E1E4EB',
    'statusBar.border': '#E1E4EB00',
    'statusBar.focusBorder': '#4480F4',
    'statusBar.foreground': '#25262B',
    'statusBar.debuggingBackground': '#a31515',
    'statusBar.debuggingForeground': '#E1E4Eb',
    'statusBar.noFolderBackground': '#E1E4EB',
    'statusBar.noFolderForeground': '#25262B',
    'statusBarItem.activeBackground': '#fff',
    'statusBarItem.compactHoverBackground': '#0065ff66',
    'statusBarItem.errorBackground': '#E1E4EB',
    'statusBarItem.errorForeground': '#ec0000',
    ...
    'tab.unfocusedActiveForeground': '#25262BBF',
    ...
    'terminal.foreground': '#25262B',
    'terminal.selectionBackground': '#0065FF3F',
    'terminal.tab.activeBorder': '#25262B',
    'terminalCommandDecoration.defaultBackground': '#25262B00',
    'terminalCommandDecoration.successBackground': '#3EC141',
    'terminalCommandDecoration.errorBackground': '#EC0000',
...
export const dark = {
  ...
  colors: {
    ...
    'button.border': '#676E9500',
    'button.foreground': '#DCDFE5',
    'button.hoverBackground': '#598DEFE6',
    'button.secondaryBackground': '#676E9599',
    'button.secondaryForeground': '#DCDFE5',
    'button.secondaryHoverBackground': '#598DEFE6',
    'charts.blue': '#6495EE',
    'charts.green': '#98C379',
    'charts.orange': '#FF9070',
    'charts.purple': '#A78CFA',
    'charts.red': '#f14c4c',
    'charts.yellow': '#E4BF7F',
    'charts.foreground': '#C1C2C5',
    'charts.lines': '#454963',
    'checkbox.background': '#21252B',
    'checkbox.border': '#181a1f',
    'checkbox.foreground': '#C1C2C5',
    'commandCenter.activeBackground': '#598def72',
    'commandCenter.activeBorder': '#598DEF00',
    'commandCenter.activeForeground': '#E1E4EA',
    'commandCenter.background': '#282c34',
    'commandCenter.border': '#282c34',
    'commandCenter.foreground': '#9DA5B3',
    'commandCenter.inactiveBorder': '#282c34',
    'commandCenter.inactiveForeground': '#676e95',
    'debugConsole.errorForeground': '#E51400',
    'debugConsole.infoForeground': '#598DEF',
    'debugConsole.warningForeground': '#FF8A4C',
    'debugExceptionWidget.background': '#a3151533',
    'debugExceptionWidget.border': '#a31515',
    'debugToolBar.background': '#21252B',
    'debugToolBar.border': '#21252B',
    descriptionForeground: '#C1C2C5BF',
    'dropdown.background': '#23272F',
    'dropdown.border': '#181A1F',
    'dropdown.foreground': '#9DA5B3',
    'dropdown.listBackground': '#23272F',
    'diffEditor.diagonalFill': '#5F668B',
    'diffEditor.insertedTextBackground': '#45B7464F',
    'diffEditor.removedTextBackground': '#f14c4c54',
    ...
    'editor.findRangeHighlightBackground': '#F8F9004C',
    'editor.foldBackground': '#32446469',
    'editor.foreground': '#9DA5B3',
    'editor.hoverHighlightBackground': '#32446499',
    'editor.lineHighlightBackground': '#2F323C',
    'editor.lineHighlightBorder': '#2F323C00',
    'editor.rangeHighlightBackground': '#2F323C',
    'editor.selectionBackground': '#598DEF59',
    'editor.selectionHighlightBackground': '#0080997F',
    'editor.selectionHighlightBorder': '#00809900',
    'editor.snippetFinalTabstopHighlightBackground': '#32446499',
    'editor.snippetFinalTabstopHighlightBorder': '#5F668B',
    'editor.snippetTabstopHighlightBackground': '#32446499',
    'editor.snippetTabstopHighlightBorder': '#32446400',
    'editor.wordHighlightBackground': '#0080997F',
    'editor.wordHighlightBorder': '#00809900',
    'editor.wordHighlightStrongBackground': '#A78CFA72',
    'editor.wordHighlightStrongBorder': '#A78CFA00',
    'editorBracketHighlight.foreground1': '#E4BF7F',
    'editorBracketHighlight.foreground2': '#CF68E1',
    'editorBracketHighlight.foreground3': '#6495EE',
    'editorBracketHighlight.foreground4': '#E4BF7F',
    'editorBracketHighlight.foreground5': '#CF68E1',
    'editorBracketHighlight.foreground6': '#6495EE',
    'editorBracketHighlight.unexpectedBracket.foreground': '#838FA7',
    'editorBracketMatch.background': '#FF90707F',
    'editorBracketMatch.border': '#FF907000',
    'editorBracketPairGuide.activeBackground1': '#E4BF7Fcc',
    'editorBracketPairGuide.activeBackground2': '#CF68E1cc',
    'editorBracketPairGuide.activeBackground3': '#6495EEcc',
    'editorBracketPairGuide.activeBackground4': '#E4BF7Fcc',
    'editorBracketPairGuide.activeBackground5': '#CF68E1cc',
    'editorBracketPairGuide.activeBackground6': '#6495EEcc',
    'editorCodeLens.foreground': '#50567C',
    'editorCursor.background': '#FFFFFF',
    ...
    'editorGroupHeader.border': '#282c3400',
    ...
    'editorHoverWidget.foreground': '#C1C2C5',
    'editorHoverWidget.statusBarBackground': '#23272F',
    'editorIndentGuide.activeBackground1': '#FF9070BF',
    'editorIndentGuide.background1': '#454963',
    'editorInfo.foreground': '#4480F4',
    'editorInlayHint.foreground': '#8A97C3',
    'editorLightBulb.foreground': '#E4BF7F',
    ...
    'editorMarkerNavigationInfo.background': '#598DEF',
    'editorMarkerNavigationWarning.background': '#FF8A4C',
    'editorOverviewRuler.addedForeground': '#40AD41',
    'editorOverviewRuler.background': '#282c34',
    'editorOverviewRuler.border': '#5F668B00',
    'editorOverviewRuler.bracketMatchForeground': '#FF90707F',
    'editorOverviewRuler.currentContentForeground': '#598DEF59',
    'editorOverviewRuler.deletedForeground': '#F14C4C',
    ...
    'editorOverviewRuler.warningForeground': '#FF8A4C',
    ...
    'editorWarning.foreground': '#FF8A4C',
    'editorWhitespace.foreground': '#60678E',
    'editorWidget.background': '#21252B',
    'editorWidget.border': '#21252B',
    'editorWidget.foreground': '#b0b7c3',
    errorForeground: '#E51400',
    'extensionButton.background': '#4b516a',
    'extensionButton.foreground': '#DCDFE5',
    'extensionBadge.remoteBackground': '#56B7C3',
    'extensionBadge.remoteForeground': '#ffffff',
    'extensionButton.prominentForeground': '#fff',
    'extensionButton.prominentBackground': '#499149',
    ...
    'gitDecoration.conflictingResourceForeground': '#E51400',
    'gitDecoration.deletedResourceForeground': '#F14C4C',
    ...
    'gitlens.trailingLineBackgroundColor': '#2F323B00',
    'gitlens.trailingLineForegroundColor': '#585D68',
    'icon.foreground': '#c5c5c5',
    'input.background': '#282c34',
    'input.border': '#21252B',
    'input.foreground': '#9DA5B3',
    'input.placeholderForeground': '#5E658B',
    ...
    'inputValidation.errorForeground': '#E51400',
    'inputValidation.infoBackground': '#21252B',
    'inputValidation.infoBorder': '#4480F4',
    'inputValidation.infoForeground': '#4480F4',
    'inputValidation.warningBackground': '#21252B',
    'inputValidation.warningBorder': '#FF8A4C',
    'inputValidation.warningForeground': '#FF8A4C',
    'list.activeSelectionBackground': '#598DEF66',
    'list.activeSelectionForeground': '#d7dae0',
    'list.activeSelectionIconForeground': '#D2D5DB',
    'list.dropBackground': '#598DEF4C',
    'list.errorForeground': '#E51400',
    'list.filterMatchBackground': '#FFF',
    'list.focusBackground': '#598DEF66',
    'list.focusForeground': '#d7dae0',
    'list.focusHighlightForeground': '#4480F4',
    'list.focusOutline': '#598DEF00',
    ...
    'list.inactiveFocusOutline': '#598DEF00',
    'list.inactiveSelectionBackground': '#30333D',
    'list.inactiveSelectionForeground': '#d7dae0',
    'list.inactiveSelectionIconForeground': '#d7dae0',
    ...
    'menu.separatorBackground': '#454963',
    ...
    'mergeEditor.conflict.handledFocused.border': '#e51400',
    'mergeEditor.conflict.handledUnfocused.border': '#e51400',
    'mergeEditor.conflict.handled.minimapOverViewRuler': '#e51400',
    'mergeEditor.conflict.unhandled.minimapOverViewRuler': '#e51400',
    'mergeEditor.conflict.unhandledFocused.border': '#e51400',
    'mergeEditor.conflict.unhandledUnfocused.border': '#e51400',
    'mergeEditor.change.background': '#45B7461A',
    'mergeEditor.change.word.background': '#45B7464D',
    'minimap.background': '#282c34',
    'minimap.errorHighlight': '#E514007F',
    'minimap.findMatchHighlight': '#D0D5E17F',
    'minimap.selectionHighlight': '#5F97FFF2',
    'minimap.warningHighlight': '#FF8A4C7F',
    ...
    'notifications.foreground': '#C1C2C5',
    'notificationCenter.border': '#181A1F',
    'notificationCenterHeader.background': '#21252b',
    'notificationCenterHeader.foreground': '#C1C2C5',
    'notificationLink.foreground': '#598DEF',
    'notificationToast.border': '#181A1F',
    'panel.background': '#282c34',
    'panel.border': '#21252B',
    'panel.dropBorder': '#4480F4',
    'panelTitle.activeForeground': '#C1C2C5',
    'panelTitle.activeBorder': '#C1C2C5',
    'panelTitle.inactiveForeground': '#676E95',
    'panelSectionHeader.background': '#21252B',
    'panelSectionHeader.foreground': '#C1C2C5',
    'panelSection.border': '#21252B',
    'panelSection.dropBackground': '#598DEF4C',
    ...
    'problemsInfoIcon.foreground': '#4480F4',
    'problemsWarningIcon.foreground': '#FF8A4C',
    'profileBadge.background': '#676E95E5',
    'profileBadge.foreground': '#CED5E1',
    'progressBar.background': '#4283F5',
    'quickInput.background': '#21252B',
    'quickInput.foreground': '#C1C2C5',
    'quickInputList.focusBackground': '#598DEF3F',
    'quickInputTitle.background': '#21252B',
    'sash.hoverBorder': '#598DEF',
    ...
    'settings.focusedRowBackground': '#598DEF66',
    'settings.focusedRowBorder': '#598DEF00',
    'settings.rowHoverBackground': '#598DEF3F',
    ...
    'statusBarItem.compactHoverBackground': '#598defB3',
    'statusBarItem.errorBackground': '#21252B',
    'statusBarItem.errorForeground': '#e51400',
    'statusBarItem.hoverBackground': '#598DEF66',
    'statusBarItem.prominentBackground': '#21252B',
    'statusBarItem.prominentHoverBackground': '#598DEF66',
    'statusBarItem.remoteBackground': '#56B7C3',
    'statusBarItem.remoteForeground': '#ffffff',
    ...
    'terminal.ansiBrightWhite': '#8A97C3',
    'terminal.background': '#282c34',
    'terminal.border': '#21252B',
    'terminal.foreground': '#C1C2C5',
    'terminal.selectionBackground': '#598DEF59',
    'terminal.tab.activeBorder': '#d7dae0',
    'terminalCommandDecoration.defaultBackground': '#C1C2C500',
    'terminalCommandDecoration.successBackground': '#3FB93F',
    ...
    'textLink.foreground': '#4283F5',
    'textPreformat.foreground': '#FF9070',
