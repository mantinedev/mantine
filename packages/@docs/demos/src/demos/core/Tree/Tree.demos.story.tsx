...
export const Demo_dragDropAllow = {
  name: '⭐ Demo: dragDropAllow',
  render: renderDemo(demos.dragDropAllow),
};

export const Demo_dragDropHandle = {
  name: '⭐ Demo: dragDropHandle',
  render: renderDemo(demos.dragDropHandle),
};
