...
export const Demo_controlledSearch = {
  name: '⭐ Demo: controlledSearch',
  render: renderDemo(demos.controlledSearch),
};
...
export const Demo_formSubmission = {
  name: '⭐ Demo: formSubmission',
  render: renderDemo(demos.formSubmission),
};
