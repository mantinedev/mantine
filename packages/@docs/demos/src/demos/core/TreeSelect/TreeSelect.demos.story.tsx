...
export const Demo_checkbox = {
  name: '⭐ Demo: checkbox',
  render: renderDemo(demos.checkbox),
};
...
export const Demo_expandOnClick = {
  name: '⭐ Demo: expandOnClick',
  render: renderDemo(demos.expandOnClick),
};
...
export const Demo_checkedStrategy = {
  name: '⭐ Demo: checkedStrategy',
  render: renderDemo(demos.checkedStrategy),
};

export const Demo_withLines = {
  name: '⭐ Demo: withLines',
  render: renderDemo(demos.withLines),
};
