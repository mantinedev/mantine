...
export const Demo_consistentWeeks = { name: '⭐ Demo: consistentWeeks', render: renderDemo(demos.consistentWeeks) };
export const Demo_highlightToday = { name: '⭐ Demo: highlightToday', render: renderDemo(demos.highlightToday) };
export const Demo_withoutOutsideDays = { name: '⭐ Demo: withoutOutsideDays', render: renderDemo(demos.withoutOutsideDays) };
export const Demo_withoutHeader = { name: '⭐ Demo: withoutHeader', render: renderDemo(demos.withoutHeader) };
export const Demo_manyEvents = { name: '⭐ Demo: manyEvents', render: renderDemo(demos.manyEvents) };
