...
[@mantine/code-highlight](https://mantine.dev/x/code-highlight) package no longer depends options
...
- [use-form](https://mantine.dev/form/use-form) `setFieldValue` handler types are now more strict
