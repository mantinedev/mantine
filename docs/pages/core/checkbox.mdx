...
import { CheckboxDemos, TableDemos, ThemingDemos } from '@mantine/demos';
...
All props passed to the component are forwarded to the input element.
If you need to add props to the root element, use `wrapperProps`.
