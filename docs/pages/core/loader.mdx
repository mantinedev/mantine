...
import { LoaderDemos, LoadingOverlayDemos } from '@mantine/demos';
...
in components that use `loaderProps`, for example [Button](/core/button/), [LoadingOverlay](/core/loading-overlay/), [Dropzone](/others/dropzone/).
