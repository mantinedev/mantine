...
import { LoadingOverlayDemos, StylesDemos, NumberFormatterDemos, TableDemos } from '@mantine/demos';
...
[Table](/core/table/) component now supports `stickyHeader` prop which can be used to make table header
