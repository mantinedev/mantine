...
- [Select](/core/select), [MultiSelect](/core/multi-select), [TagsInput](/core/tags-input), [PinInput](/core/pin-input) and [Slider](/core/slider) components now support `hiddenInputProps` prop, which allows to pass props to the hidden input element
