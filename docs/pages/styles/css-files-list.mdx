...
```tsx
import '@mantine/core/ScrollArea.css';
import '@mantine/core/UnstyledButton.css';
import '@mantine/core/VisuallyHidden.css';
import '@mantine/core/Paper.css';
import '@mantine/core/Popover.css';
import '@mantine/core/CloseButton.css';
import '@mantine/core/Group.css';
import '@mantine/core/Loader.css';
import '@mantine/core/Overlay.css';
import '@mantine/core/ModalBase.css';
import '@mantine/core/Input.css';
import '@mantine/core/Flex.css';
```
