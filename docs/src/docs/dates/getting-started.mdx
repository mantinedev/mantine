...
Returns an array of weeks of current month, used to build [Month](/dates/month/) component
...
Returns months names for given locale and format, used in [Calendar](/dates/calendar/) component to render month select
...
Returns an array of short weekdays names for given locale, used in [Month](/dates/month/) component to render weekdays row
...
Returns an array of years, which fall into given range, used in [Calendar](/dates/calendar/) component to render year select
