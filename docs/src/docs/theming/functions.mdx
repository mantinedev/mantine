...
`lighten` can be used to lighten a color by a given percentage:

```tsx
theme.fn.lighten('#228BE6', 0.1); // 10%
// -> "rgba(56, 151, 233, 1)"

theme.fn.lighten('rgb(46, 149, 11)', 0.1); // 50%
// -> "rgba(151, 202, 133, 1)"

theme.fn.lighten('rgba(219, 91, 17, 0.6)', 0.1)
// -> "rgba(223, 107, 41, 0.6)"
```

## darken

`darken` can be used to darken a color by a given percentage.

```tsx
theme.fn.darken('#12B886', 0.1); // 10%
// -> "rgba(16, 166, 121, 1)"

theme.fn.darken('rgb(245, 159, 0)', 0.5); // 50%
// -> "rgba(123, 80, 0, 1)"

theme.fn.darken('rgba(214, 51, 108, 0.6)', 0.1)
// -> "rgba(193, 46, 97, 0.6)"
```
