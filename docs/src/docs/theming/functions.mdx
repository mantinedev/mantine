...
```tsx
theme.fn.smallerThan(768); // -> `@media (max-width: 48rem)`
...
theme.fn.largerThan('sm'); // -> `@media (min-width: ${theme.breakpoints.sm + '0.0625rem'})`
theme.fn.largerThan(768); // -> `@media (min-width: 48.0625rem)`
```
