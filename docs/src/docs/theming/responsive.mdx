...
Most of the layout components support responsive features. This section includes basic responsive features,
...
[SimpleGrid](/core/simple-grid/) component creates a layout with a given number of columns which have equal width.
