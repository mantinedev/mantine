...
import { themeColorsExtend, themeFontsExtend, primaryColor } from '@docs/demos';
...
By default TypeScript will only autocomplete Mantine's standard colors when accessing the theme. To add your custom colors, you can use TypeScript module declaration:
```ts
// ./types.d.ts
...
// or if you want to "extend" default colors
