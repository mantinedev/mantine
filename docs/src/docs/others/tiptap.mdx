...
Controls that require [@tiptap/extension-link](https://www.npmjs.com/package/@tiptap/extension-link)

- `RichTextEditor.Link`
- `RichTextEditor.Unlink`

Controls that require [@tiptap/extension-text-align](https://www.npmjs.com/package/@tiptap/extension-text-align):
