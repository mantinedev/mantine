...
- [Card](https://mantine.dev/core/card/) component now uses `padding` prop to calculate offsets instead of `p` prop to avoid props types collisions
...
### [PinInput](https://mantine.dev/core/pin-input/)
...
- [@mantine/nprogress](https://mantine.dev/others/nprogress/), [@mantine/modals](https://mantine.dev/others/modals/) packages now exports `nprogress`, `modals` objects with all package methods
