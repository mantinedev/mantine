...
- [@mantine/form](https://mantine.dev/form/use-form/) now exports `superstructResolver` to allow schema based validation with [superstruct](https://github.com/ianstormtaylor/superstruct)
