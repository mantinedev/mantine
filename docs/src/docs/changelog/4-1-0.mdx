...
All components now support arrays in [sx prop](https://mantine.dev/styles/sx/). It can be to simultaneously use `sx` prop and add it from props:
...
- [Global](https://mantine.dev/styles/global-styles/#global-component) component now supports array syntax for `styles`
