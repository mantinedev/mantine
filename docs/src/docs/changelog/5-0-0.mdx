...
[@mantine/nprogress](https://mantine.dev/others/nprogress/) is a new package that allows you to add
a navigation progress bar to your application. It can be triggered programmatically from anywhere in your application:
