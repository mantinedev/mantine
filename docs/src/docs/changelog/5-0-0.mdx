...
import { TabsDemos, AccordionDemos, TooltipDemos } from '@mantine/demos';
...
[Tooltip](https://mantine.dev/core/tooltip/) component API was changed – it now requires children to be an element or a component,
