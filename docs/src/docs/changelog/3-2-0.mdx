...
- 3 new guides were added: [RTL Support](https://mantine.dev/guides/rtl/), [sx prop](https://mantine.dev/styles/sx/) and [Responsive styles](https://mantine.dev/styles/responsive/)
