...
import { PasswordInputDemos, MultiSelectDemos, StepperDemos } from '@demos/core';
...
Note that GlobalStyles and NormalizeCSS component that were previously used to add global styles will be
removed in next major version (4.0).
