...
import { useOsDemo } from '@docs/demos';
...
- [SimpleGrid](https://mantine.dev/core/simple-grid/) component now supports mobile first approach with [min-width breakpoints](https://mantine.dev/core/simple-grid/#min-width-breakpoints)
