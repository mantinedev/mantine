...
import { AccordionDemos, AvatarDemos, MediaQueryDemos, SelectDemos, MultiSelectDemos } from '@demos/core';
import {
...
[Select](https://mantine.dev/core/select) component now supports `creatable` feature.

<Demo data={SelectDemos.creatable} demoProps={{ toggle: true }} />

[Select](https://mantine.dev/core/select) component data prop now supports `disabled` and `group` properties.

<Demo data={SelectDemos.disabledItems} demoProps={{ toggle: true }} />

<Demo data={SelectDemos.groups} demoProps={{ toggle: true }} />

[MultiSelect](https://mantine.dev/core/multiselect) component now supports `creatable` feature.

<Demo data={MultiSelectDemos.creatable} demoProps={{ toggle: true }} />

[MultiSelect](https://mantine.dev/core/select) component data prop now supports `disabled` and `group` properties.

<Demo data={MultiSelectDemos.disabledItems} demoProps={{ toggle: true }} />

<Demo data={MultiSelectDemos.groups} demoProps={{ toggle: true }} />
## New hooks
...
- [Pagination](https://mantine.dev/core/pagination/) component now supports adding first and last controls
