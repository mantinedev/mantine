...
- `@mantine/core` package no longer exports react-jss `theming` context, use [createStyles](https://mantine.dev/styles/create-styles/) instead
...
[Read createStyles documentation](https://mantine.dev/styles/create-styles/)

From version 3.0 [createStyles](https://mantine.dev/styles/create-styles/) is the main way to add styles to Mantine components. Core features:
...
- [SSR with Next.js](https://mantine.dev/guides/next/)
- [SSR with Gatsby.js](https://mantine.dev/guides/gatsby/)
- [General approach to SSR](https://mantine.dev/guides/ssr/)
...
`ColorSchemeProvider` is a new component that will help you manage color scheme ([read full docs](https://mantine.dev/guides/dark-theme/)):
...
<Demo data={AvatarDemos.group} demoProps={{ toggle: true }} />
