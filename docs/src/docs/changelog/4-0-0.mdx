...
- [Dialog](https://mantine.dev/core/dialog/), [Card](https://mantine.dev/core/paper/), [Container](https://mantine.dev/core/container/), [Paper](https://mantine.dev/core/paper/), [Header and Navbar](https://mantine.dev/core/app-shell/)
  - `padding` → `p`
