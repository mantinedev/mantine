...
- Default border-radius of [Badge](https://mantine.dev/core/badge/) component is no longer defaults to `theme.radius.xl`, it was changed to support new `theme.defaultRadius`
