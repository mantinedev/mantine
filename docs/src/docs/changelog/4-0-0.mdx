...
- [Tooltip](https://mantine.dev/core/tooltip/) component `delay` prop was renamed to `closeDelay`
...
- [Tooltip](https://mantine.dev/core/tooltip/) component now support open and close delay
...
- Add additional filtering to [Group](https://mantine.dev/core/group/) component children to avoid error when it is used with elements that do not support props (numbers, string, fragments)
