...
- [Radio](https://mantine.dev/core/radio/)
  - `children` → `label`
- [RadioGroup](https://mantine.dev/core/radio/):
  - `variant` → `orientation`
...
Each component that has [Styles API](https://mantine.dev/styles/styles-api/) now exports type that can be assigned to params
...
[createStyles](https://mantine.dev/styles/create-styles/) function now works differently with references.
...
New [BackgroundImage](https://mantine.dev/core/background-image/) component
