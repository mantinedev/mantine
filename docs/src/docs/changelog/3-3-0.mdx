...
import { ScrollAreaDemos, ModalDemos, AccordionDemos, SelectDemos } from '@demos/core';
...
[Select](https://mantine.dev/core/select/) and [MultiSelect](https://mantine.dev/core/multi-select/) components now use [ScrollArea](https://mantine.dev/core/scroll-area/)
as a default dropdown element:
