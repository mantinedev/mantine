...
You can change fonts for headings, code and al other components:
...
- `theme.headings.fontFamily` – controls font family of h1-h6 tags in <GatsbyLink to="/core/title/">Title</GatsbyLink> and <GatsbyLink to="/core/inner-html/">InnerHtml</GatsbyLink> components
