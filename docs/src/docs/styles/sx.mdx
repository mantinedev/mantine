...
If you need to customize other elements within component use [Styles API](/styles/styles-api/).

## sx object

With `sx` prop, you can add inline styles to any component the same way you would do it as with [createStyles](/styles/create-styles/)
