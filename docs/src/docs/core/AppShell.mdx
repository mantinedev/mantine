...
AppShell, Header, Footer, Aside and Navbar components include bare minimum default styles to simplify customization. [View full source code](https://github.com/mantinedev/mantine/tree/master/src/mantine-demos/src/demos/packages/AppShell)
...
Navbar and Aside components can be used outside of AppShell context ([View full source code](https://github.com/mantinedev/mantine/tree/master/src/mantine-demos/src/demos/packages/AppShell)):
...
`Navbar.Section` and `Aside.Section` components can be used with [ScrollArea](/core/scroll-area/) component ([View full source code](https://github.com/mantinedev/mantine/tree/master/src/mantine-demos/src/demos/packages/AppShell)):
