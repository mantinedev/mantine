...
import { ModalCustomTransitionsDemo } from '../demos/core/Modal/modal.custom-transition-demo';
...
Modal is built with <GatsbyLink to="/core/transition">Transition</GatsbyLink> component.
See <GatsbyLink to="/guides/transitions">transitions guide</GatsbyLink> to learn everything mantine transitions.
