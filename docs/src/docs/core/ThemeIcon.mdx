...
You can use any color from <GatsbyLink to="/theming/extend-theme/#default-colors">theme.colors</GatsbyLink>,
default color is <GatsbyLink to="/theming/extend-theme/#primary-color">theme.primaryColor</GatsbyLink>:
