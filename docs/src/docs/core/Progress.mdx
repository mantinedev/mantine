...
Use the `label` prop if you want to show custom text within the progress bar. This is useful when you want to show some
metric related to the value in the progress bar.
