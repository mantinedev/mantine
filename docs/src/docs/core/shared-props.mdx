...
Mantine components work with colors defined in <GatsbyLink to="/theming/extend-theme/#default-colors">theme.colors</GatsbyLink>.
...
To add your own colors use <GatsbyLink to="/theming/theming-context/">MantineProvider</GatsbyLink>:
...
Components that have padding get values from <GatsbyLink to="/theming/extend-theme/#spacing-radius-and-shadows">theme.spacing</GatsbyLink>,
default values are:
...
To change these values set `spacing` property on <GatsbyLink to="/theming/extend-theme/">theme</GatsbyLink>:
...
Components that use box-shadow property get values from <GatsbyLink to="/theming/extend-theme/#spacing-radius-and-shadows">theme.shadows</GatsbyLink>,
default values are:
...
To change these values set `shadows` property on <GatsbyLink to="/theming/extend-theme/">theme</GatsbyLink>:
...
Components that use border-radius property get values from <GatsbyLink to="/theming/extend-theme/#spacing-radius-and-shadows">theme.radius</GatsbyLink>,
default values are:
...
To change these values set `radius` property on <GatsbyLink to="/theming/extend-theme/">theme</GatsbyLink>:
