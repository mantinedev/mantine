...
@mantine/core package exports following types associated with Burger:

- `BurgerProps` – Burger component props, extends `React.ComponentProps<'button'>`
- `BurgerStylesNames` – a union of styles names that can be used with [Styles API](/theming/styles-api/) (`classNames` and `styles` props)
