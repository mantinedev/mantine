...
## Wrap Tabs.Tab component

```tsx
import { Tabs, TabProps } from '@mantine/core';

// !important: spreading props is required
function DemoTab(props: TabProps) {
  return <Tabs.Tab label="Wrapped tab" />;
}
