...
<Demo data={TabsDemos.unstyled} />

By doing so you will be able to keep component behavior while providing your own styles with [Styles API](/theming/styles-api/):
...
```tsx
import { Tabs } from '@mantine/core';
import { MessageCircle, Coin } from 'tabler-icons-react';
