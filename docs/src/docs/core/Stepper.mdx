...
You can use `Stepper.Completed` component to add a completed step, which content will be shown once all steps are completed.

<Demo data={StepperDemos.completedStep} />
