...
Use xs, sm, md, lg, xl values to set spacing from <GatsbyLink to="/theming/extend-theme/#spacing-radius-and-shadows">theme.spacing</GatsbyLink>
...
Use the breakpoint props (`xs`, `sm`, `md`, `lg`, `xl`) to make columns respond to viewport changes.
