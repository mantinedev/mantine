...
@mantine/core package exports following types associated with Avatar:

- `AvatarProps` – Avatar component props, generic type: `AvatarProps<'a'>`
- `AvatarsGroupProps` – AvatarsGroup component props, extends `React.ComponentProps<'div'>`
- `AvatarStylesNames` and `AvatarsGroupStylesNames` – unions of styles names which can be used with [Styles API](/theming/styles-api/) (`classNames` and `styles` props)
