...
You can provide your own wrapper for list, this is most useful
if you want to use custom scrollbars. Example with [react-custom-scrollbars](https://www.npmjs.com/package/react-custom-scrollbars):

<Demo data={TransferListDemos.scrollbars} />

## Custom item component

You can replace default item component with your own to customize item appearance.
To do so:
