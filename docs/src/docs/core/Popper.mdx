...
Popper is an utility component used under the hood in <GatsbyLink to="/core/menu/">Menu</GatsbyLink>, <GatsbyLink to="/core/popover/">Popover</GatsbyLink>, <GatsbyLink to="/core/tooltip/">Tooltip</GatsbyLink>
...
Popper uses <GatsbyLink to="/core/transition/">Transition</GatsbyLink> component to animate presence.
You can choose one of premade transitions or create your own. All premade transitions demo
(<GatsbyLink to="/core/tooltip/">Tooltip</GatsbyLink> component which uses Popper):
...
In some cases Popper position will get outdated since it is rendered in <GatsbyLink to="/core/portal/">Portal</GatsbyLink>
