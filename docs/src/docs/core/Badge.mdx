...
@mantine/core package exports following types associated with Badge:

- `BadgeProps` – Badge component props, generic type: `BadgeProps<'a'>`
- `BadgeVariant` – a union of all variants
- `BadgeStylesNames` – a union of styles names that can be used with [Styles API](/theming/styles-api/) (`classNames` and `styles` props)
