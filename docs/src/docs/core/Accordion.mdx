...
- `AccordionProps` – Accordion component props, extends `React.ComponentProps<'div'>`
- `AccordionItemProps` – Accordion.Item component props, extends `React.ComponentProps<'div'>`
