...
In most cases you would want to use uncontrolled Accordion, to change initial opened item use `initialItem` prop:
...
In more advanced cases you can control Accordion state with `useAccordionState` hook:
...
- `AccordionProps` – Accordion component props, extends `React.ComponentPropsWithoutRef<'div'>`
- `AccordionItemProps` – Accordion.Item component props, extends `React.ComponentPropsWithoutRef<'div'>`
