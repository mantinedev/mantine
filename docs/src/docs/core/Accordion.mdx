...
It can be used to style component with [Styles API](/theming/styles-api/) without overriding any styles.
...
Accordion elements have `data-` attributes that can be used with [Styles API](/theming/styles-api/):
