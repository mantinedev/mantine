...
import { SpaceDemos } from '@demos/core';
...
Space component in order to skip direct theme subscription:
...
`SpaceProps` extends `React.ComponentPropsWithoutRef<'div'>`, all other props are available under _Component props_ tab.
