...
- `labelTransition`, `labelTransitionDuration`, `labelTransitionTimingFunction` – label uses <GatsbyLink to="/core/transition/">Transition</GatsbyLink> component to animate presence, you can choose any premade transition or create your own
...
You can change styles of any element in slider component with <GatsbyLink to="/theming/styles-api/">Styles API</GatsbyLink> to match your design requirements:
