...
By default Autocomplete is placed at the bottom of the input and _doesn't_ flip in contrast to Select component.
If you want to enable it change `dropdownPosition` to `flip`
