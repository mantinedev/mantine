...
@mantine/core package exports following types associated with Autocomplete:

- `AutocompleteItem` – data item type
- `AutocompleteProps` – Autocomplete component props, extends `React.ComponentProps<'input'>`
- `AutocompleteStylesNames` – a union of styles names that can be used with [Styles API](/theming/styles-api/) (`classNames` and `styles` props)
