...
Menu is rendered inside <GatsbyLink to="/core/portal/">Portal</GatsbyLink> and its position is controlled with the following props:
...
You can customize add styles to any part of Menu with <GatsbyLink to="/theming/styles-api/">Styles API</GatsbyLink>,
