...
Buttons by default contains [`:active` styles](https://github.com/mantinedev/mantine/blob/master/src/mantine-styles/src/theme/default-theme.ts#L92) of `transform: 'translateY(0.0625rem)'`.
You can [customize this](/theming/theme-object/#activestyles) by overriding the `activeStyles` property on the theme object.
