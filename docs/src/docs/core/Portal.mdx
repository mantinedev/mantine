...
Render any component or element at the end of `document.body` or at given element. <GatsbyLink to="/core/modal/">Modal</GatsbyLink> and <GatsbyLink to="/core/drawer/">Drawer</GatsbyLink> components are wrapped in Portal by default.
