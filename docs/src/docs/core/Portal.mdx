...
Wrapper component for [ReactDOM.createPortal](https://reactjs.org/docs/portals.html) API.
...
Portal is usefull when you want to prevent parent styles from interfering with child,
