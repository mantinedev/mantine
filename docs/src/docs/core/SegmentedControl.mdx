...
By default segmented control uses a horizontal orientation, this can be changed to vertical with the `vertical` prop

<Demo data={SegmentedControlDemos.vertical} />
