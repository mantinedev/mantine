...
<PageHeader
  source="mantine-hooks/src/hooks/use-queue/use-queue.ts"
...
For example, in <GatsbyLink to="/guides/notifications/">@mantine/notifications</GatsbyLink> package amount of
...
// they will be divided between queue and state acoring to limit
...
Example of use-queue hook usage in <GatsbyLink to="/guides/notifications">Mantine notifications system</GatsbyLink>. By default
