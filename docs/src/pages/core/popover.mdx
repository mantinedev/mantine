...
- [shit](https://floating-ui.com/docs/shift) middleware shifts the dropdown to keep it in view. It is enabled by default
...
In this example Popover dropdown will always be below the element – it will not
