...
[LineChart](/charts/line-chart) and [Sparkline](/charts/sparkline) components. More components will be added in next minor releases.
...
asked questions. Currently, it has 14 questions, more FAQs will be added in next releases.
...
- Examples on how to change close icon have been added to [Drawer](/core/drawer/#change-close-icon) and [Modal](/core/modal/#change-close-icon) components.
