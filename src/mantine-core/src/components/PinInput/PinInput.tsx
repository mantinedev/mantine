  ...
  (
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>, index: number) => {
      ...
      if (isValid) {
        ...
        // when pin is finished we stop managing autofocus
        // instead we proke onComplete due every other change
        // if user will remove one char it will back to managing focus
