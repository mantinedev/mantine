...
describe('@mantine/core/Slider/Marks', () => {
  ...
  it('renders correct marks labels', () => {
    ...
    expect(element.find('.mantine-slider-marks-markWrapper')).toHaveLength(2);
    expect(element.find('.mantine-slider-marks-markLabel').at(0).text()).toBe('test-1');
    expect(element.find('.mantine-slider-marks-markLabel').at(1).text()).toBe('test-2');
  });
  ...
  it('calls onChange with mark value when mark label is pressed', () => {
    ...
    element
      .find('.mantine-slider-marks-markLabel')
      .at(0)
  ...
  it('sets mark left property based on mark value', () => {
    ...
    expect(element.find('.mantine-slider-marks-markWrapper').at(0).prop('style').left).toBe('25%');
    expect(element.find('.mantine-slider-marks-markWrapper').at(1).prop('style').left).toBe('50%');
  });
