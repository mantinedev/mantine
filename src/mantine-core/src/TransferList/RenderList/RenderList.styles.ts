...
export default createStyles((theme, { reversed, native, radius }: RenderListStyles) => ({
  ...
  transferListItem: {
    ...
    marginLeft: `calc(${theme.spacing.sm}px - ${ITEM_PADDING})`,
    marginRight: `calc(${theme.spacing.sm}px - ${ITEM_PADDING})`,
    borderRadius: theme.fn.radius(radius),

    '&:first-of-type': {
      marginTop: `calc(${theme.spacing.sm}px - ${ITEM_PADDING})`,
    },

    '&:last-of-type': {
      marginBottom: `calc(${theme.spacing.sm}px - ${ITEM_PADDING})`,
    },
  },
