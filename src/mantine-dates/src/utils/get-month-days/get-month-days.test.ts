...
describe('@mantine/dates/get-month-days', () => {
  it('returns all month days for given date', () => {
    ...
    let monthDays = getMonthDays(new Date(2021, 1, 2));
    ...
    monthDays = getMonthDays(new Date(2021, 1, 2), 'sunday');
  ...
  it('returns outside days for given month', () => {
    ...
    let monthDays = getMonthDays(new Date(2021, 3, 2));
    ...
    monthDays = getMonthDays(new Date(2021, 3, 2), 'sunday');
