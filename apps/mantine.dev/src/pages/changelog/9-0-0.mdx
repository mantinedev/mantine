...
[SegmentedControl](/core/segmented-control), [Select](/core/select)
...
- [Select](/core/select) component now supports primitive value types (numbers, booleans, strings) for data and value
