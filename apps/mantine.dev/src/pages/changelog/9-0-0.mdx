...
## Checkbox.Group maxSelectedValues

[Checkbox.Group](/core/checkbox) now supports `maxSelectedValues` prop to limit the number of selected values.
...
- [Checkbox.Group](/core/checkbox/#checkboxgroup-with-formdata) can now be used in uncontrolled forms and can be accessed through `FormData`
