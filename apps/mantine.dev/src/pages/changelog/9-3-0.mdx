import { CodeHighlightDemos, ComboboxDemos, DayViewDemos, HighlightDemos, MenuDemos, OverflowListDemos, PaginationDemos, PieChartDemos, PopoverDemos, SplitterDemos, TextareaDemos, TextDemos, TooltipDemos, UseSplitterDemos } from '@docs/demos';
...
[Popover](/core/popover/) and all components built on top of it ([Combobox](/core/combobox/),
[Select](/core/select/), [MultiSelect](/core/multi-select/), [Autocomplete](/core/autocomplete/),
[TagsInput](/core/tags-input/), [Menu](/core/menu/), [HoverCard](/core/hover-card/), [Tooltip](/core/tooltip/),
[ColorInput](/core/color-input/), date pickers and others) now treat `preventPositionChangeWhenVisible`
as `true` by default.
...
[DayView](/schedule/day-view/) and [WeekView](/schedule/week-view/) components now support `getCurrentTime`
