...
import { ActionIconDemos, BarChartDemos, DatePickerDemos, FormDemos, ModalDemos, ModalsDemos, TableDemos, TipTapDemos, UseRadialMoveDemos } from '@docs/demos';
...
[TableIcon](/core/table) component now support `variant="vertical"`:

<Demo data={TableDemos.vertical} />

## TableIcon tabular numbers

[TableIcon](/core/table) component now supports `tabularNums` prop to render numbers in tabular style. It sets
