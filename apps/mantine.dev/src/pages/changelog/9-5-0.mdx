import { AccordionDemos, BulletChartDemos, CascaderDemos, DatePickerDemos, FloatingWindowDemos, HeatmapDemos, ResourcesDayViewDemos, ScrollAreaDemos, SunburstChartDemos, TableDemos, TimelineDemos, AreaChartDemos } from '@docs/demos';
