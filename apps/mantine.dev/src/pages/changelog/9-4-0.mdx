import { AgendaViewDemos, ComboboxPopoverDemos, DataListDemos, DayViewDemos, InputDemos, MonthViewDemos, ResourcesDayViewDemos, ResourcesMonthViewDemos, ResourcesScheduleDemos, ResourcesWeekViewDemos, ScheduleDemos, WeekViewDemos } from '@docs/demos';
