...
When the [MantineProvider](/theming/mantine-provider/) is mounted, it sets a `data-mantine-color-scheme`
...
for example [Next.js](/guides/next) or [React Router](/guides/react-router). Follows framework specific guides
