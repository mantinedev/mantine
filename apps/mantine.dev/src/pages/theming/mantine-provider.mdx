...
[style props](/styles/style-props). When multiple components share the same responsive
...
use the same responsive style props. See the [styles performance guide](/styles/styles-performance)
for more details.
