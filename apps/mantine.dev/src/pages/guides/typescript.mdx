...
[Polymorphic component](/guides/polymorphic) props types don't include `React.ComponentProps<'X'>`
...
All Mantine components export namespaces with related types. For example, [Button](/core/button)
