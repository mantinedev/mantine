...
This page provides access to our [LLMs.txt](https://llmstxt.org/) files, making the Mantine documentation easily accessible to large language models.

## Available Documentation

### Complete Documentation

**[📄 LLM.md - Complete Documentation](/LLM.md)**

Full Mantine documentation including all components, hooks, styles, and theming (~1.8MB)

- [View online](/LLM.md)
- [Download](https://mantine.dev/LLM.md)

### Documentation Structure

The LLM.md file includes:
...
2. Reference the Mantine documentation URL: `https://mantine.dev/LLM.md`
...
1. Reference the documentation using `@https://mantine.dev/LLM.md`
...
2. Reference the documentation URL: `https://mantine.dev/LLM.md`
...
To ensure you have the latest documentation, we regenerate the LLM.md file with each release.
