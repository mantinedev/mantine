...
Create a `pages/_document.tsx` file with the [ColorSchemeScript](/theming/color-schemes) component.
...
All Mantine components use the `useContext` hook to support [default props](/theming/default-props)
