...
Note that this guide covers only Storybook 7.0+ integration. If you're using an older version of Storybook,
...
Note that `@storybook/addon-styling-webpack` is required only if you're
not using Vite. **If you're using Vite, don't install `@storybook/addon-styling-webpack` and don't add it to the addons section in the `main.ts` file**.
...
const config: StorybookConfig = {
  ...
  addons: [
    // ... other addons
    '@storybook/addon-styling-webpack', // Add this line only if you're not using Vite
    'storybook-dark-mode',
  ],
};
