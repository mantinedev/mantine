...
<CssVariablesGroup
  data={[
    ...
    },
    {
      ...
      description: 'Controls the font-family property of code blocks',
      defaultValue: 'system monospace fonts',
    },
    {
      variable: '--mantine-font-family-headings',
      description: 'Controls the font-family property of headings',
      defaultValue: 'system sans-serif fonts',
    },
  ]}
/>
...
And in the [ff style prop](/styles/style-props):
...
And in the [fz style prop](/styles/style-props):
...
<CssVariablesGroup
  data={[
    ...
    {
      variable: '--mantine-color-success',
      description: 'Color used for success messages and states',
      defaultValue: 'var(--mantine-color-teal-8)',
    },
    {
