...
as the React `style` prop. You can use Mantine [CSS variables](/styles/css-variables) in the style object
...
You can pass a style function to the `style` prop – in this case it will be called with the [theme](/theming/theme-object/).
