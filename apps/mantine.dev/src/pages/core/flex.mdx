...
Unlike [Group](/core/group/) and [Stack](/core/stack/), `Flex` is [polymorphic](/guides/polymorphic/).
Both `Flex` and [Stack](/core/stack/) support responsive flexbox props, while [Group](/core/group/) does not.
