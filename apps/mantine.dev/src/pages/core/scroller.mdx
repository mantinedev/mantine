import { ScrollerDemos, TabsDemos } from '@docs/demos';
...
Use `Scroller` inside [Tabs.List](/core/tabs) to make the tabs list scrollable when there are too many tabs to fit in the available space:
