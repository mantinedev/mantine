...
Use the `forwardRef` function to forward ref to the root element:
...
[forwardRef](https://reactjs.org/docs/forwarding-refs.html) or another prop that will allow getting the root element ref.
