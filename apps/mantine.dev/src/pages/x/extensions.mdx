...
- [@mantine/code-highlight](/x/code-highlight) – code highlighting component used on Mantine websites
...
- [Mantine Bites Lightbox](https://rilrom.github.io/mantine-bites/lightbox/) - Community full-screen image lightbox built on top of @mantine/carousel, see also the official [@mantine/lightbox](/x/lightbox) package
- [Mantine Map](https://sarioglu.github.io/mantine-map) - Interactive maps for Mantine, powered by MapLibre GL
- [Mantine Gantt](https://wojakgra.github.io/mantine-gantt) – interactive Gantt chart with drag-to-reschedule and resizable tasks, dependency links, virtualized rows and controlled/uncontrolled modes
