...
- [Clock](https://gfazioli.github.io/mantine-clock/) - analogic clock component
...
- [Picker](https://gfazioli.github.io/mantine-picker/) – animate picker for color, date, emoji, and other pickers
- [TextAnimate](https://gfazioli.github.io/mantine-text-animate/) – text animation component
- [Window](https://gfazioli.github.io/mantine-window/) - window component with drag, resize functionalities
