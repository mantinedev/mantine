...
Some controls require the installation of additional [Tiptap extensions](https://tiptap.dev/extensions).
For example, if you want to use the `RichTextEditor.Underline` control, you will need to install the `@tiptap/extension-underline` package:
