...
The `TimePicker` component is an alternative to [TimeInput](/dates/time-input) that offers more
...
The `TimePicker` component value is a string in `hh:mm:ss` 24-hour format (for example `18:34:55`).
