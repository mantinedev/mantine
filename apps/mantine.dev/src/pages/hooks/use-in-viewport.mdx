import { UseInViewportDemos } from '@docs/demos';
...
The `use-in-viewport` hook is a simpler alternative to [use-intersection](/hooks/use-intersection) that only checks if the element
