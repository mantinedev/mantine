import { UseRadialMoveDemos } from '@docs/demos';
...
The `use-radial-move` hook can be used to create custom radial sliders. For example, the [AngleSlider](/core/angle-slider)
