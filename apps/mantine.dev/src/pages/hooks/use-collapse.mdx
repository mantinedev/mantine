...
type UseCollapseReturnValue = (input?: GetCollapsePropsInput) => GetCollapsePropsReturnValue;

function useCollapse({ transitionDuration, transitionTimingFunction, onTransitionEnd, expanded, keepMounted, }: UseCollapseInput): UseCollapseReturnValue
```
