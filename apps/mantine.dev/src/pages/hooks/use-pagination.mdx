import { PaginationDemos, HooksDemos } from '@docs/demos';
...
The `use-pagination` hook is a state management hook for the [Pagination](/core/pagination/) component;
...
<Demo data={HooksDemos.usePaginationStartValueDemo} />
