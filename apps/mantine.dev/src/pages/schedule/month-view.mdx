...
prop (or [DatesProvider](/dates/getting-started/#datesprovider), `[0, 6]` by
default).
...
span the full height of the day cell in the month view.
...
Note that an interactive background event covers the day cells underneath it: clicks and
drag-to-select in its range go to the event instead of the cells. Background events still
