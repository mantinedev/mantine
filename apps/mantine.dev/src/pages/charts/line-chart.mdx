...
by setting `yAxisId` in the `series` object. Also note that if all the data in your
series has `yAxisId` set to "right" and you use recharts 3, you will need to add
`gridProps={{ yAxisId: "right" }}` to the chart component.
