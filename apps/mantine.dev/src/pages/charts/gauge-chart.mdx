...
Set `roundCaps` to round the endpoints of the arc. With `sections`, only the outer
ends of the first and last sections are rounded – adjacent sections keep straight
edges so they do not overlap each other:
