...
because it repeats those names visually. Set `aria-label` on the chart to describe what the values
represent – it labels the chart as a whole and does not replace the generated grid label.
