...
the full opposite axis. Set `color` to any [theme color](/theming/colors/) or CSS color and
`label` to display text inside the area. Reference areas are rendered behind the chart series.

<Demo data={CompositeChartDemos.referenceAreas} />
...
<Demo data={CompositeChartDemos.referenceDots} />
...
<Demo data={CompositeChartDemos.brush} />
