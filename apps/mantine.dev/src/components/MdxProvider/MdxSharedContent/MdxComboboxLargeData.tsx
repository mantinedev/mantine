  ...
  return (
    <>
      ...
      <MdxParagraph>
        ...
        the same time. You can do this with the <MdxCode>limit</MdxCode> prop. Note that if you use
        a custom <MdxCode>filter</MdxCode> function, you need to implement your own logic to limit
        the number of options in <MdxCode>filter</MdxCode>.
      </MdxParagraph>
